...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-08-29 20:56 | 15:13 | 0/0/0 | 0/1/0 | 0/0/0 | 95,785/6,469 | ollama / qwen3.8:27b-mtp-q8_0 | 2 | 2/0 | 2/0 | 0 |
...
|---|---|---|---|
| <span class="pk-badge pk-badge--red">rejected</span> | [MaassenVanDenBrink_1998](drugs/drug_methysergide/pd_MaassenVanDenBrink_1998_unknown.md) | MaassenVanDenBrink A et al., Coronary side-effect potential of curre…, Circulation (1998) | [10.1161/01.cir.98.1.25](https://doi.org/10.1161/01.cir.98.1.25) |

## Coverage

- **PubMed hits:** 340 matched, 62 returned
...
<sub>queue written 2026-08-29T20:53:13.878319+00:00</sub>
...
| popPK | Bachy_1993 | irrelevant | 0 | 0 | The paper studies the pharmacology of SR 57227A, and methysergide is only mentioned as a non-antagonist comparator in a behavioral assay, with no PK parameters reported. |
| PD | Bachy_1993 | not_relevant | 0 | 0 | The paper focuses on the pharmacology of SR 57227A; methysergide is only mentioned as a negative control that did not block the Bezold-Jarisch reflex, with no PD parameters or exposure-response analysis provided for it. |
...
| PD | Bai_2004 | not_relevant | 3 | 2 | The paper reports receptor binding and functional assay data (EC50 for serotonin) but does not provide a pharmacokinetic-pharmacodynamic (PK/PD) model or exposure-response relationship for methysergide in a physiological context. |
...
| PD | Bischoff_1986 | not_relevant | 1 | 0 | The paper reports pharmacological data for SCH 23390, not methysergide; methysergide is only mentioned as a comparator for potency without providing its own PD parameters. |
...
| PD | Chetty_2007 | not_relevant | 0 | 0 | The study reports concentration-response parameters (pEC50, Emax, pKB) for 5-HT and 5-HT3 agonists/antagonists, but methysergide is used only as a fixed concentration (1 µM) to block non-5-HT3 receptors, and no dose- or concentration-response relationship for methysergide itself is reported. |
...
| popPK | Corsi_1991 | irrelevant | 0 | 0 | The study is a pharmacological analysis of 5-HT effects on human urinary bladder where methysergide is used only as a receptor antagonist, with no pharmacokinetic parameters reported. |
| PD | Corsi_1991 | not_relevant | 0 | 0 | The paper studies 5-HT pharmacology in isolated bladder tissue; methysergide is only mentioned as a weak antagonist in a qualitative context without specific numeric PD parameters or exposure-response analysis for methysergide. |
...
| PD | Eadie_2001 | not_relevant | 1 | 0 | The text is a qualitative review of drug interactions and mentions methysergide only in the context of pharmacodynamic mechanisms for vasoconstriction, without providing any numeric PD parameters or concentration-effect data. |
| PD | Earl_1984 | not_relevant | 0 | 0 | The paper reports that methysergide is "essentially devoid of inhibitory activity" on calmodulin-stimulated phosphodiesterase and does not provide specific numeric PD parameters (like IC50 or Emax) for methysergide, only stating it lacks significant effect compared to other compounds. |
| popPK | Eglen_1990 | irrelevant | 0 | 0 | The study is an in-vitro pharmacological characterization of 5-HT receptors in guinea-pig ileum where methysergide is used only as a receptor antagonist, not as a subject drug for pharmacokinetic analysis. |
| PD | Eglen_1990 | not_relevant | 0 | 0 | The paper characterizes 5-HT receptors using methysergide as a blocking agent, but does not report a pharmacodynamic exposure-response or dose-response relationship for methysergide itself. |
| popPK | Feldman_1994 | irrelevant | 0 | 0 | The study is an electrophysiological investigation of serotonin receptors in rat brain slices where methysergide is used only as a pharmacological antagonist, not as a subject for pharmacokinetic analysis. |
...
| popPK | Grånäs_1998 | irrelevant | 0 | 0 | The paper is a mechanistic in-vitro study on receptor binding affinities, not a pharmacokinetic study reporting disposition parameters for methysergide. |
| PD | Grånäs_1998 | not_relevant | 1 | 0 | The paper reports binding affinity changes (Kd) and one EC50 for a different ligand (8-OH-DPAT) in a mutagenesis study, but does not provide a pharmacodynamic exposure-response or dose-response relationship with numeric PD parameters for methysergide. |
...
| PD | Hayashi_1987 | not_relevant | 0 | 0 | The paper mentions methysergide only as a negative control in a pharmacological assay (it did not inhibit contraction) and does not report any exposure-response or dose-response relationship or numeric PD parameters for methysergide. |
...
| PD | Higashi_1982 | not_relevant | 0 | 0 | The paper investigates 5-HT receptor electrophysiology; methysergide is only mentioned as having no effect on 5-HT-induced depolarization, with no PD parameters or exposure-response analysis for methysergide. |
...
| popPK | Huidobro-Toro_1981 | irrelevant | 0 | 0 | The study is an in-vitro pharmacological investigation of opioid-induced colonic contraction where methysergide is used only as a diagnostic antagonist, with no pharmacokinetic parameters reported. |
...
| popPK | Huidobro-Toro_1985 | irrelevant | 0 | 0 | The study is a pharmacological investigation of neurotensin receptors in rat stomach smooth muscle, where methysergide is used only as a non-specific antagonist to rule out receptor involvement, with no pharmacokinetic parameters reported. |
| PD | Huidobro-Toro_1985 | not_relevant | 0 | 0 | The paper studies neurotensin pharmacology; methysergide is only mentioned as a pretreatment that did not modify the response, with no PD parameters reported for methysergide. |
...
| PD | Kaulen_1986 | not_relevant | 2 | 1 | The paper reports in vitro binding affinity (IC50) for methysergide in a receptor binding assay, which is a pharmacological property but not a pharmacodynamic (exposure-response) relationship in a biological system with numeric PD parameters like Emax or EC50 for a physiological effect. |
...
| popPK | Levy_1992 | irrelevant | 0 | 0 | The paper is a molecular cloning and pharmacological characterization study of a serotonin receptor, reporting binding/functional affinity (EC50) rather than pharmacokinetic disposition parameters for methysergide. |
| PD | Levy_1992 | not_relevant | 3 | 5 | The paper reports an in vitro receptor binding/functional assay EC50 for methysergide, which is a pharmacological potency parameter, but it does not report an in vivo exposure-response or dose-response relationship for the drug in a subject or population. |
...
| popPK | Martín_1993 | irrelevant | 0 | 0 | The study is an in-vitro pharmacological investigation of serotonin receptors in chicken ileum where methysergide is used only as a non-specific antagonist, not as the subject of a pharmacokinetic analysis. |
| PD | Martín_1993 | not_relevant | 1 | 0 | The paper reports an EC50 for serotonin (5-HT) and uses methysergide as a qualitative antagonist to characterize receptor subtypes, but it does not report a dose-response curve or numeric PD parameters (such as pA2 or Ki) for methysergide itself. |
| popPK | Ng_1991 | irrelevant | 0 | 0 | The study is an in-vitro pharmacological investigation of colonic smooth muscle in rabbits, not a pharmacokinetic study, and reports no disposition parameters for methysergide. |
...
| PD | Price_1993 | not_relevant | 0 | 0 | The paper investigates the electrophysiological mechanism of serotonin (5-HT) action in snail neurons; while methysergide is listed as a reagent, no dose-response or exposure-response data for methysergide is presented or analyzed. |
| PD | Raffestin_1985 | not_relevant | 1 | 0 | The paper mentions methysergide only as a qualitative blocker of 5-HT effects in isolated tissue preparations and does not report any numeric PD parameters or concentration-effect curves for methysergide itself. |
...
| PD | Ramírez_1982 | not_relevant | 3 | 1 | The paper describes qualitative dose-dependent effects and a shift in a dose-response curve for 5-HTP, but does not provide numeric PD parameters (EC50, Emax) or a quantitative concentration-effect model for methysergide. |
| popPK | Reiser_1989 | irrelevant | 0 | 0 | The study is a mechanistic in-vitro investigation of receptor interactions where methysergide is used only as a pharmacological probe/antagonist, with no pharmacokinetic parameters reported. |
...
| popPK | Schoeffter_1988 | irrelevant | 0 | 0 | The paper is a pharmacological study on 5-HT1D receptor coupling to adenylate cyclase, not a pharmacokinetic study, and methysergide is used only as a pharmacological probe. |
| PD | Schoeffter_1988 | not_relevant | 4 | 2 | The paper reports a concentration-effect relationship for 5-HT (EC50, Emax) and lists methysergide's relative potency, but does not provide specific numeric PD parameters (e.g., EC50) for methysergide itself. |
| PD | Schotte_1984 | not_relevant | 1 | 0 | The paper describes a receptor binding assay (in vitro) and mentions methysergide's potency qualitatively, but does not provide numeric PD parameters or an exposure-response relationship for the drug in a pharmacodynamic context. |
...
| popPK | Tam_1994 | irrelevant | 0 | 0 | The study is an in-vitro pharmacological characterization of 5-HT receptors in human colon, using methysergide only as a receptor antagonist, and reports no pharmacokinetic parameters. |
| PD | Tam_1994 | not_relevant | 0 | 0 | The paper reports PD parameters for 5-HT and other agonists, but methysergide is only used as a non-effective antagonist to rule out receptor subtypes, with no exposure-response or dose-response relationship reported for methysergide itself. |
...
| popPK | Undie_1990 | irrelevant | 0 | 0 | The study is an in-vitro mechanistic investigation of dopamine receptors in rat brain slices where methysergide is used only as a non-specific antagonist control, with no pharmacokinetic parameters reported. |
...
| popPK | Wu_2017 | irrelevant | 0 | 0 | The paper is a pharmacological study on an insect octopamine receptor where methysergide is used only as a non-specific antagonist, not as the subject drug for PK analysis. |
| PD | Wu_2017 | not_relevant | 1 | 0 | The paper reports a qualitative antagonistic effect of methysergide on an insect receptor but provides no numeric PD parameters (e.g., Ki, IC50) or dose-response curve for methysergide itself. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_methysergide`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
