...
> ⚠️ **STALE** — review status `model_quarantined` (reviewed 2026-09-17 23:22:39.788835+00:00) predates the upstream re-run (2026-09-24 00:18:54.716791+00:00). Current validate status: `needs_review`.
...
## Model component
<dbs-pgx drug="Levothyroxine" model-id="Levothyroxine_Inada1975_s_y" status="needs_review" stale="true" population="normal subjects and hypothyroid patients" measured-compound="levothyroxine" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
...
| C5_unit_missing_Q47 | fail | 1 / [time] | per day | not captured | not captured | ['Inada_1975_table_2:row3:col6'] |
