...
# lesion size — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.138). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.138 (4/29 fields) | 25 |
...
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 0.049 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 0.042 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 0.049 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 0.042 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 165 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 125 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 165 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 125 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 60 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 45 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 8.0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 7.9 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 31 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 26 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 8.01 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 1.6 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 1.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | not captured | 0.010 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q337]` | 0.027 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 0.39 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 0.027 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q89]` | 1.1 | not captured | only_one_extracted |
