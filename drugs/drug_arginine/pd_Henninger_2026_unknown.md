# lesion size — PD  <span class="pk-badge pk-badge--green">extracted</span>
...
| k heal — Estimate | `Q358` · not captured | 0.027 | not captured | not captured | llm (not captured) | cts70535-tbl-0002:row8:col3 |
| k heal — 95% CI a | `Q337` · not captured | 0.010 | not captured | not captured | llm (not captured) | cts70535-tbl-0002:row8:col4 |
