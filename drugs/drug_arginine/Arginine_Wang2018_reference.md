<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;B05X&quot;,&quot;href&quot;:&quot;atc/B05X.md&quot;},{&quot;label&quot;:&quot;Arginine&quot;,&quot;href&quot;:&quot;drugs/drug_arginine/&quot;},{&quot;label&quot;:&quot;Wang_2018 \u00b7 healthy Chinese volunteers&quot;}]"></div>
...
## Model component
<dbs-pgx drug="Arginine" model-id="Arginine_Wang2018_reference" status="not_modelled" stale="false" population="healthy Chinese volunteers" measured-compound="arginine, glutamate" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h) | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | review_gapfill (0.7) | Aurélie_2023:review | — | not captured |
| V | `Q61` · V | —(suppressed) | L | — | L | not captured | review_gapfill (0.7) | Camargo_2025:review | — | not captured |
| Ka * (h−1) | `Q49` · kabs | —(suppressed) | h−1 | — | 1/h | not captured | review_gapfill (0.7) | Aurélie_2023:review | — | not captured |
...
| T3_output_variable | not captured | pass | C_central (measured=arginine, glutamate) | central.C | not captured | output must be the measured/analyte compartment |
...
- scholar stages: `../../../knowledgebase/drugs/drug_arginine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Wang_2018` / `Wang_2018::healthy Chinese volunteers`)
- sim: `../../../knowledgebase/drugs/drug_arginine/models/modelica/Arginine_Wang2018_healthy_chinese_volunteers.json`
...
<img src="drugs/drug_arginine/Arginine_Wang2018_reference/Arginine_Wang2018_reference.svg" alt="Arginine_Wang2018_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_arginine/Arginine_Wang2018_reference/Arginine_Wang2018_reference_modelica.zip" download>Arginine_Wang2018_reference_modelica.zip</a> <span class="pk-size">(3.6 kB)</span></td></tr>
