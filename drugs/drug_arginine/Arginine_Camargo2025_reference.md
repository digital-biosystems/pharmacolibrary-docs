...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | 5.06 | L/h/kg | 9.838888888888887e-05 | L/h | not captured | review (0.7) | Camargo_2025:review | — | not captured |
| V | `Q61` · V | 22.4 | L | 0.0224 | L | not captured | review (0.7) | Camargo_2025:review | — | not captured |
| ka | `Q49` · kabs | 0.226 | h−1 | 6.277777777777778e-05 | 1/h | not captured | review (0.7) | Camargo_2025:review | — | not captured |
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_arginine/Arginine_Camargo2025_reference/Arginine_Camargo2025_reference_modelica.zip" download>Arginine_Camargo2025_reference_modelica.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_arginine/Arginine_Camargo2025_reference/Arginine_Camargo2025_reference.svg" alt="Arginine_Camargo2025_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Arginine_Camargo2025_reference_params.json` · controls `Arginine_Camargo2025_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
