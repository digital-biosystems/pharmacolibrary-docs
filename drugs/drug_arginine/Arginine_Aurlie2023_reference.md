...
## Citation
Aurélie L; Andréa B; Gauvind K; Olivier B; Raoul B; Dayan F; Sylvain B; Romain G et al. (2023). Pharmaceuticals (Basel, Switzerland) 16
...
- built from REVIEW reference values (Aurélie_2023) — secondary source
...
- scholar stages: `../../../knowledgebase/drugs/drug_arginine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Aurélie_2023` / `Aurélie_2023::reference`)
- model: `../../../knowledgebase/drugs/drug_arginine/models/modelica/Arginine_Aurlie2023_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_arginine/models/modelica/Arginine_Aurlie2023_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_arginine/models/modelica/Arginine_Aurlie2023_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_arginine/Arginine_Aurlie2023_reference/Arginine_Aurlie2023_reference_modelica.zip" download>Arginine_Aurlie2023_reference_modelica.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_arginine/Arginine_Aurlie2023_reference/Arginine_Aurlie2023_reference_fmi.zip" download>Arginine_Aurlie2023_reference_fmi.zip</a> <span class="pk-size">(4.2 kB)</span><br><a href="models/fmu/PK_2C_enteral.fmu" download>PK_2C_enteral.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_arginine/Arginine_Aurlie2023_reference/Arginine_Aurlie2023_reference_matlab.zip" download>Arginine_Aurlie2023_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_arginine/Arginine_Aurlie2023_reference/Arginine_Aurlie2023_reference_matlab_simbio.zip" download>Arginine_Aurlie2023_reference_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_arginine/Arginine_Aurlie2023_reference/Arginine_Aurlie2023_reference_sbml.zip" download>Arginine_Aurlie2023_reference_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_arginine/Arginine_Aurlie2023_reference/Arginine_Aurlie2023_reference_cellml.zip" download>Arginine_Aurlie2023_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_2C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_arginine/Arginine_Aurlie2023_reference/Arginine_Aurlie2023_reference.svg" alt="Arginine_Aurlie2023_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_arginine/Arginine_Aurlie2023_reference/Arginine_Aurlie2023_reference_params.json" metaurl="assets/fmu/PK_2C_enteral.vr.json" wasmurl="assets/fmu/PK_2C_enteral.js" controlsurl="drugs/drug_arginine/Arginine_Aurlie2023_reference/Arginine_Aurlie2023_reference_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_2C_enteral` · parameters `Arginine_Aurlie2023_reference_params.json` · controls `Arginine_Aurlie2023_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>

<div class="pk-tab-end"></div>

---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-19 09:26 UTC</sub>
