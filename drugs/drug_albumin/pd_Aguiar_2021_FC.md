...
# fecal calprotectin — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.538). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Aguiar Zdovc J; Hanžel J; Kurent T; Sever N; Koželj M; Smrekar N; et al. et al. (2021). Pharmaceutics 13
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | ustekinumab | unbound target (p40 subunit of IL12/IL23) | mismatch |
| `gpt-oss:120b` | `model_family` | tmdd | indirect_response_iii | mismatch |
| `gpt-oss:120b` | `parameters[Q100]` | 102 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 213 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 102 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 213 | only_one_extracted |
