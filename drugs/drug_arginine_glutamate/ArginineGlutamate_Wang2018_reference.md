...
## Model component
<dbs-pgx drug="arginine glutamate" model-id="ArginineGlutamate_Wang2018_reference" status="rejected" stale="false" population="healthy Chinese volunteers" measured-compound="arginine, glutamate" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_arginine_glutamate/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Wang_2018` / `Wang_2018::healthy Chinese volunteers`)
