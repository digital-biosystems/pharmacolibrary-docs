...
## Citation
Girgin M; Isik S; Kantarci-Carsibasi N et al. (2023). PloS one 18
...
| `gpt-oss:120b` | `parameters[Q100]` | -14.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | -8.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | -10.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | -13.4 | not captured | only_one_extracted |
...
---
<sub>← back to [etoperidone](drugs/drug_etoperidone/)</sub>
