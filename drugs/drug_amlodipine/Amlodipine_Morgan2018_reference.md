...
## Model component
<dbs-pgx drug="amlodipine" model-id="Amlodipine_Morgan2018_reference" status="extracted" stale="true" population="pregnant women with chronic hypertension" measured-compound="amlodipine" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_amlodipine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Morgan_2018` / `Morgan_2018::reference`)
- model: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Morgan2018_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Morgan2018_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Morgan2018_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_amlodipine/Amlodipine_Morgan2018_reference/Amlodipine_Morgan2018_reference_modelica.zip" download>Amlodipine_Morgan2018_reference_modelica.zip</a> <span class="pk-size">(3.8 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Morgan2018_reference/Amlodipine_Morgan2018_reference_matlab.zip" download>Amlodipine_Morgan2018_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Morgan2018_reference/Amlodipine_Morgan2018_reference_matlab_simbio.zip" download>Amlodipine_Morgan2018_reference_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Morgan2018_reference/Amlodipine_Morgan2018_reference_sbml.zip" download>Amlodipine_Morgan2018_reference_sbml.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Morgan2018_reference/Amlodipine_Morgan2018_reference_cellml.zip" download>Amlodipine_Morgan2018_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_amlodipine/Amlodipine_Morgan2018_reference/Amlodipine_Morgan2018_reference.svg" alt="Amlodipine_Morgan2018_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Amlodipine_Morgan2018_reference_params.json` · controls `Amlodipine_Morgan2018_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
