...
## Model component
<dbs-pgx drug="amlodipine" model-id="Amlodipine_Vlachou2021_parameter" status="accepted_with_caveats" stale="false" population="healthy adults" measured-compound="amlodipine, irbesartan, hydrochlorothiazide" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Kd | `Q331` · KD | 10.2 | not captured | not captured | not captured | not captured | exact (1.0) | materials-14-00555-t004:row2:col2, materials-14-00555-t004:row4:col2, materials-14-00555-t004:row6:col2, materials-14-00555-t004:row8:col2, materials-14-00555-t004:row10:col2, materials-14-00555-t004:row12:col2, materials-14-00555-t004:row14:col2, materials-14-00555-t004:row16:col2, materials-14-00555-t004:row18:col2 | — | not captured |
...
- dropped unlinked row (NIL): '4.5' — extend the ontology if this is a real PK parameter (source ['materials-14-00555-t004:row3:col2', 'materials-14-00555-t004:row9:col2', 'materials-14-00555-t004:row15:col2'])
- dropped unlinked row (NIL): '6.8' — extend the ontology if this is a real PK parameter (source ['materials-14-00555-t004:row5:col2', 'materials-14-00555-t004:row11:col2', 'materials-14-00555-t004:row17:col2'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=amlodipine, irbesartan, hydrochlorothiazide
- population split: 'parameter' subgroup of Vlachou_2021 (paper reports 4 populations: buffer, parameter, parameter 4, value)
...
- scholar stages: `../../../knowledgebase/drugs/drug_amlodipine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Vlachou_2021` / `Vlachou_2021::parameter`)
- model: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Vlachou2021_parameter.mo`
- deviation: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Vlachou2021_parameter.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Vlachou2021_parameter.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_parameter/Amlodipine_Vlachou2021_parameter_modelica.zip" download>Amlodipine_Vlachou2021_parameter_modelica.zip</a> <span class="pk-size">(3.9 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_parameter/Amlodipine_Vlachou2021_parameter_fmi.zip" download>Amlodipine_Vlachou2021_parameter_fmi.zip</a> <span class="pk-size">(4.1 kB)</span><br><a href="models/fmu/PK_1C_enteral.fmu" download>PK_1C_enteral.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_parameter/Amlodipine_Vlachou2021_parameter_matlab.zip" download>Amlodipine_Vlachou2021_parameter_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_parameter/Amlodipine_Vlachou2021_parameter_matlab_simbio.zip" download>Amlodipine_Vlachou2021_parameter_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_parameter/Amlodipine_Vlachou2021_parameter_sbml.zip" download>Amlodipine_Vlachou2021_parameter_sbml.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_parameter/Amlodipine_Vlachou2021_parameter_cellml.zip" download>Amlodipine_Vlachou2021_parameter_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_amlodipine/Amlodipine_Vlachou2021_parameter/Amlodipine_Vlachou2021_parameter.svg" alt="Amlodipine_Vlachou2021_parameter diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_amlodipine/Amlodipine_Vlachou2021_parameter/Amlodipine_Vlachou2021_parameter_params.json" metaurl="assets/fmu/PK_1C_enteral.vr.json" wasmurl="assets/fmu/PK_1C_enteral.js" controlsurl="drugs/drug_amlodipine/Amlodipine_Vlachou2021_parameter/Amlodipine_Vlachou2021_parameter_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Amlodipine_Vlachou2021_parameter_params.json` · controls `Amlodipine_Vlachou2021_parameter_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
