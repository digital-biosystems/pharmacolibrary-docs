...
## Model component
<dbs-pgx drug="amlodipine" model-id="Amlodipine_Karalis2023_reference" status="not_modelled" stale="false" population="virtual subjects" measured-compound="hydrochlorothiazide, donepezil, and amlodipine" parameterization="apparent" topology="2C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_amlodipine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Karalis_2023` / `Karalis_2023::virtual subjects`)
