...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[half-life]` (76 vs not captured) — not a structural parameter.
**How to address:** not a curation fix — the pipeline is the limit here (fulltext: the record was built from the abstract alone, so reported summary statistics stood in for a fitted model).
<sub>owner: **curator**</sub>

> ⚠️ **STALE** — review status `curated_candidate` (reviewed 2026-09-17 22:47:41.680055+00:00) predates the upstream re-run (2026-09-23 22:45:00.068591+00:00). Current validate status: `extracted`.

## Citation
Jeppesen P; Bruun J; Nielsen-Kudsk F et al. (1998). Pharmacology & toxicology 82
  ·  DOI: [10.1111/j.1600-0773.1998.tb01433.x](https://doi.org/10.1111/j.1600-0773.1998.tb01433.x)

## Model component
<dbs-pgx drug="amlodipine" model-id="Amlodipine_Jeppesen1998_reference" status="extracted" stale="true" population="isolated guinea-pig hearts" measured-compound="amlodipine" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| half-life | `Q57` · t1/2z | 76 | min | 4560.0 | [min] | not captured | llm (0.6) | Jeppesen_1998:abstract | — | not captured |
...
- dropped PD-category row 'Observed Emax-values' → Q320 (Emax, category G11) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['Jeppesen_1998:abstract', 'Jeppesen_1998:abstract', 'Jeppesen_1998:abstract'])
- dropped PD-category row 'curve-fitted EC50-values' → Q321 (EC50, category G11) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['Jeppesen_1998:abstract', 'Jeppesen_1998:abstract', 'Jeppesen_1998:abstract'])
...
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Jeppesen_1998:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_amlodipine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Jeppesen_1998` / `Jeppesen_1998::reference`)
- model: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Jeppesen1998_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Jeppesen1998_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Jeppesen1998_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_amlodipine/Amlodipine_Jeppesen1998_reference/Amlodipine_Jeppesen1998_reference_modelica.zip" download>Amlodipine_Jeppesen1998_reference_modelica.zip</a> <span class="pk-size">(4.1 kB)</span></td></tr>
