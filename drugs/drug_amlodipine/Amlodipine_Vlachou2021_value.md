...
## Model component
<dbs-pgx drug="amlodipine" model-id="Amlodipine_Vlachou2021_value" status="needs_review" stale="false" population="healthy adults" measured-compound="amlodipine, irbesartan, hydrochlorothiazide" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- model: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Vlachou2021_value.mo`
- deviation: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Vlachou2021_value.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_amlodipine/models/modelica/Amlodipine_Vlachou2021_value.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_value/Amlodipine_Vlachou2021_value_modelica.zip" download>Amlodipine_Vlachou2021_value_modelica.zip</a> <span class="pk-size">(4.6 kB)</span></td></tr>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_value/Amlodipine_Vlachou2021_value_matlab.zip" download>Amlodipine_Vlachou2021_value_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_value/Amlodipine_Vlachou2021_value_matlab_simbio.zip" download>Amlodipine_Vlachou2021_value_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_value/Amlodipine_Vlachou2021_value_sbml.zip" download>Amlodipine_Vlachou2021_value_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_amlodipine/Amlodipine_Vlachou2021_value/Amlodipine_Vlachou2021_value_cellml.zip" download>Amlodipine_Vlachou2021_value_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_amlodipine/Amlodipine_Vlachou2021_value/Amlodipine_Vlachou2021_value.svg" alt="Amlodipine_Vlachou2021_value diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_amlodipine/Amlodipine_Vlachou2021_value/Amlodipine_Vlachou2021_value_params.json" metaurl="assets/fmu/PK_1C_enteral.vr.json" wasmurl="assets/fmu/PK_1C_enteral.js" controlsurl="drugs/drug_amlodipine/Amlodipine_Vlachou2021_value/Amlodipine_Vlachou2021_value_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Amlodipine_Vlachou2021_value_params.json` · controls `Amlodipine_Vlachou2021_value_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
