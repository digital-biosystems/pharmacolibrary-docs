...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[area under the curve]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[biological half-life of pirenzepine]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[cmax-values]` | not captured | not captured | only_one_extracted |
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-18 06:21 UTC</sub>
