...
|---|---|---|---|
| area under the curve (AUC 0-32, AUC 0-infinity, resp.) | Q88 | not captured | exact |
| Cmax-values | Q32 | not captured | llm_confirmed |
| biological half-life of pirenzepine | Q57 | not captured | llm |

## Departures & gaps

**Interpretation flags:**
- unit_dimension_mismatch: 'area under the curve (AUC 0-32, AUC 0-infinity, resp.)' → Q88 (unit 'dimensionless' vs ontology '[mass] * [time] / [length] ** 3') — route to review
- unit_dimension_mismatch: 'Cmax-values' → Q32 (unit 'dimensionless' vs ontology '[mass] / [length] ** 3') — route to review
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Vergin_1989_metadata.yaml (3 record(s)); values are summary statistics, not a fitted model
...
| C5_dimension_Q32 | fail | dimensionless | % | not captured | not captured | ['Vergin_1989:abstract'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Vergin_1989:abstract'] |
| C5_dimension_Q88 | fail | dimensionless | % | not captured | not captured | ['Vergin_1989:abstract'] |
