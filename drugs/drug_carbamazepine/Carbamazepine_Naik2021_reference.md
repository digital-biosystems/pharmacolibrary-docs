...
|---|---|---|---|---|---|---|---|---|---|---|
| apparent clearance (CL/F) | `Q27` · CL/F | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | Naik_2021:review | — | not captured |
| volume of distribution (V d /F) | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Naik_2021:review | — | not captured |
