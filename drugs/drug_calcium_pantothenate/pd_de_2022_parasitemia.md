...
# name — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.2). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q322]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | not captured | 0.8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | not captured | 0.4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | not captured | 0.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | not captured | 0.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | not captured | 0.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | not captured | 0.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | 0.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | 0.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | 0.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | 0.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | 0.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q3]` | 0.2 | not captured | only_one_extracted |
...
---
<sub>← back to [calcium pantothenate](drugs/drug_calcium_pantothenate/)</sub>
