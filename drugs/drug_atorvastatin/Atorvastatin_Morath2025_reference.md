...
## Model component
<dbs-pgx drug="atorvastatin" model-id="Atorvastatin_Morath2025_reference" status="extracted" stale="true" population="" measured-compound="atorvastatin" parameterization="apparent" topology="1C"></dbs-pgx>
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_atorvastatin/Atorvastatin_Morath2025_reference/Atorvastatin_Morath2025_reference_matlab.zip" download>Atorvastatin_Morath2025_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_atorvastatin/Atorvastatin_Morath2025_reference/Atorvastatin_Morath2025_reference.svg" alt="Atorvastatin_Morath2025_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Atorvastatin_Morath2025_reference_params.json` · controls `Atorvastatin_Morath2025_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
