...
<sub>Template `PK_1C_enteral` · parameters `Atorvastatin_Morath2025_reference_params.json` · controls `Atorvastatin_Morath2025_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
