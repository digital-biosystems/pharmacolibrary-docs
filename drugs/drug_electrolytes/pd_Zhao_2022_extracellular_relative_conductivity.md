...
## Citation
Zhao Y; Wang X; Zhang L; Wang K; Wu Y; Yao J; et al. et al. (2022). ACS omega 7
  ·  DOI: [10.1021/acsomega.2c06150](https://doi.org/10.1021/acsomega.2c06150)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | Moutan cortex petroleum ether extract | not captured | mismatch |
