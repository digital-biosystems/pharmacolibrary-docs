...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-11 01:21 | 10:28 | 0/0/0 | 1/0/0 | 0/0/0 | 82,032/5,058 | ollama / qwen3.8:27b-mtp-q8_0 | 8 | 1/7 | 8/0 | 0 |
...
- **PubMed hits:** 15 matched, 34 returned
...
<sub>queue written 2026-09-11T01:20:50.243982+00:00</sub>
...
| popPK | Kaai_2021 | irrelevant | 0 | 0 | The study measures gastric emptying rates using a 13C breath test, not pharmacokinetic disposition parameters (CL, V, ka) for acotiamide. |
...
| popPK | Napthali_2016 | irrelevant | 0 | 0 | The paper is a review of functional dyspepsia in women and mentions acotiamide only as a promising prokinetic agent without reporting any pharmacokinetic parameters. |
| popPK | Patel_2016 | irrelevant | 2 | 0 | The paper describes a bioanalytical method for quantifying acotiamide in rat plasma but does not report any quantitative pharmacokinetic parameters (e.g., CL, V, t1/2) in the provided evidence. |
...
| popPK | Qi_2023 | irrelevant | 0 | 0 | The paper is a systematic review and network meta-analysis of clinical efficacy and safety, containing no pharmacokinetic parameters for acotiamide. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_acotiamide`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
