...
## Citation
Nielsen-Kudsk F; Quist S et al. (1980). Acta pharmacologica et toxicologica 46
...
- scholar stages: `../../../knowledgebase/drugs/drug_clomipramine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Nielsen-Kudsk_1980` / `Nielsen-Kudsk_1980::reference`)
