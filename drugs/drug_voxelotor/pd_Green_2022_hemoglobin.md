...
## Citation
Green ML; Savic RM; Tonda M; Jorga K; Washington CB et al. (2022). CPT: pharmacometrics & systems pharmacology 11
  ·  DOI: [10.1002/psp4.12780](https://doi.org/10.1002/psp4.12780)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | voxelotor | not captured | mismatch |
...
---
<sub>← back to [voxelotor](drugs/drug_voxelotor/)</sub>
