...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F (L/h) | `Q27` · CL/F | 6.14 | L/h | 1.7055555555555554e-06 | [l] / [h] | not captured | exact (1.0) | psp412731-tbl-0002:row1:col1 | — | 0.1 (None% RSE) |
| V c/F (L) | `Q290` · V1/F | 333 | L | 0.333 | [l] | not captured | space_fold (0.95) | psp412731-tbl-0002:row2:col1 | — | not captured |
| Q/F (L/h) | `Q69` · Q/F | 0.39 | L/h | 1.0833333333333335e-07 | [l] / [h] | not captured | exact (1.0) | psp412731-tbl-0002:row3:col1 | — | not captured |
| V p/F (L) | `Q82` · V2/F | 72.3 | L | 0.0723 | [l] | not captured | space_fold (0.95) | psp412731-tbl-0002:row4:col1 | — | not captured |
| K bp (1/h) | `Q410` · Kp | 0.43 | not captured | not captured | not captured | not captured | llm (0.6) | psp412731-tbl-0002:row5:col1 | — | not captured |
...
| cyp3a4_inducer_on_cl_f_expth | `Q900` · cyp3a4_inducer_on_cl_f_expth | 0.39 | not captured | not captured | not captured | not captured | not captured (not captured) | psp412731-tbl-0002:row10:col1 | — | not captured |
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_voxelotor/Voxelotor_Savic2022_estimate_rse_a_b/Voxelotor_Savic2022_estimate_rse_a_b.svg" alt="Voxelotor_Savic2022_estimate_rse_a_b diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_2C_enteral` · parameters `Voxelotor_Savic2022_estimate_rse_a_b_params.json` · controls `Voxelotor_Savic2022_estimate_rse_a_b_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
