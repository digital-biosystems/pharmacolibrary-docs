...
# H2O2 scavenging activity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Heo JH; Kim EA; Kang N; Heo SY; Ahn G; Heo SJ et al. (2024). Marine drugs 22
...
|---|---|---|---|
| `gpt-oss:120b` | secondary_empty | 0.0 (0/10 fields) | 10 |

<details><summary>10 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | bioactive peptides (e.g., QLQFPVGR, VTPGLQY) | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 0.213 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.297 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.289 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.363 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.303 | not captured | only_one_extracted |
