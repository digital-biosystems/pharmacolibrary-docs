...
# per-4-week normalized HAE attack rate — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.714). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Singh P; Witjes H; Kleijn HJ; Diep JK; Bordone L; Newman KB; Gao X; Cohn DM et al. (2025). Clinical and translational science 18
...
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 0.13 | only_one_extracted |
