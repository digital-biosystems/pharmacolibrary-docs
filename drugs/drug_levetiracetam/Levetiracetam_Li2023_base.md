...
- model-stage split: 'base model shrinkage (%)' is the base model of Li_2023 (paper reports 4 stages: base model estimate, base model shrinkage (%), final model estimate, final model shrinkage (%)); same population, different model-building step
...
- scholar stages: `../../../knowledgebase/drugs/drug_levetiracetam/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Li_2023` / `Li_2023::base`)
