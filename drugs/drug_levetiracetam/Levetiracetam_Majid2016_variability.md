...
- population split: 'variability' subgroup of Majid_2016 (paper reports 3 populations: aed apparent clearance (l h −1 ), number of subjects, variability)
...
- scholar stages: `../../../knowledgebase/drugs/drug_levetiracetam/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Majid_2016` / `Majid_2016::variability`)
