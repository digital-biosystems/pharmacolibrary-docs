...
# bretylium tosilate — `BretyliumTosilate_Rapeport1985_reference`
...
## Model component
<dbs-pgx drug="bretylium tosilate" model-id="BretyliumTosilate_Rapeport1985_reference" status="rejected" stale="false" population="adults with ventricular tachyarrhythmias" measured-compound="bretylium" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_bretylium_tosilate/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Rapeport_1985` / `Rapeport_1985::reference`)
