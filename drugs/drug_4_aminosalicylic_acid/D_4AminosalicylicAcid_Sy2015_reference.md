...
## Model component
<dbs-pgx drug="4-aminosalicylic acid" model-id="D_4AminosalicylicAcid_Sy2015_reference" status="extracted" stale="false" population="tuberculosis patients" measured-compound="para-aminosalicylic acid" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| effect of efavirenz on oral clearance | `Q27` · CL/F | 25 | % | not captured | % | not captured | boundary (0.8) | Sy_2015:results_prose | — | not captured |
