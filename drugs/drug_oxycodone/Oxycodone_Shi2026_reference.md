...
Shi S; Zheng Y; Wang Y; Li S; Feng R; Li L et al. (2026). Frontiers in medicine 13
  ·  DOI: [10.3389/fmed.2026.1834903](https://doi.org/10.3389/fmed.2026.1834903)

## Model component
<dbs-pgx drug="oxycodone" model-id="Oxycodone_Shi2026_reference" status="curated_candidate" stale="false" population="perioperative patients with liver cancer" measured-compound="oxycodone" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | 38.03 | L/h | 1.056388888888889e-05 | L/h | not captured | review (0.7) | Shi_2026:review | — | not captured |
| V d | `Q61` · V | 250.75 | L | 0.25075000000000003 | L | not captured | review (0.7) | Shi_2026:review | — | not captured |
...
| C9_phys_window_Q61 | pass | volume within physiological range | 251 L | not captured | not captured | ['Shi_2026:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_oxycodone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Shi_2026` / `Shi_2026::reference`)
- model: `../../../knowledgebase/drugs/drug_oxycodone/models/modelica/Oxycodone_Shi2026_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_oxycodone/models/modelica/Oxycodone_Shi2026_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_oxycodone/models/modelica/Oxycodone_Shi2026_reference.json`
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_oxycodone/Oxycodone_Shi2026_reference/Oxycodone_Shi2026_reference_matlab.zip" download>Oxycodone_Shi2026_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_oxycodone/Oxycodone_Shi2026_reference/Oxycodone_Shi2026_reference_matlab_simbio.zip" download>Oxycodone_Shi2026_reference_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_oxycodone/Oxycodone_Shi2026_reference/Oxycodone_Shi2026_reference.svg" alt="Oxycodone_Shi2026_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
