# palonosetron — `Palonosetron_Li2026_healthy_control`
...
- scholar stages: `../../../knowledgebase/drugs/drug_palonosetron/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Li_2026` / `Li_2026::healthy_control`)
