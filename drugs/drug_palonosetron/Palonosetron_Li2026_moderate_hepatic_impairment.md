...
## Model component
<dbs-pgx drug="palonosetron" model-id="Palonosetron_Li2026_moderate_hepatic_impairment" status="rejected" stale="false" population="Chinese subjects with impaired or normal liver function" measured-compound="fosrolapitant" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
- population split: 'moderate hepatic impairment' subgroup of Li_2026 (paper reports 3 populations: healthy control, moderate hepatic impairment, palonosetron)
...
- scholar stages: `../../../knowledgebase/drugs/drug_palonosetron/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Li_2026` / `Li_2026::moderate_hepatic_impairment`)
