...
## Model component
<dbs-pgx drug="palonosetron" model-id="Palonosetron_Li2026_palonosetron" status="rejected" stale="false" population="Chinese subjects with impaired or normal liver function" measured-compound="fosrolapitant" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (ng/mL) | `Q32` · Cmax | —(suppressed) | ng/mL | — | [ng] / [ml] | not captured | exact (1.0) | T2:row2:col5, T2:row2:col6 | — | not captured |
| AUC0-t (h × ng/mL) | `Q19` · AUCt | —(suppressed) | h × ng/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | T2:row4:col5, T2:row4:col6 | — | not captured |
| AUC0−∞ (h × ng/mL) | `Q17` · AUC∞ | —(suppressed) | h × ng/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | T2:row5:col5, T2:row5:col6 | — | not captured |
| t1/2 (hour) | `Q57` · t1/2z | —(suppressed) | hour | — | [h] | not captured | exact (1.0) | T2:row6:col5, T2:row6:col6 | — | not captured |
| V (L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | exact (1.0) | T2:row7:col5, T2:row7:col6 | — | not captured |
| CL (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | T2:row8:col5, T2:row8:col6 | — | not captured |
