...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl].rse_percent` | not captured | 4.58 | mismatch |
| `gpt-oss:120b` | `parameters[cl].value` | not captured | 17.8 | mismatch |
| `gpt-oss:120b` | `parameters[v].rse_percent` | not captured | 5.08 | mismatch |
| `gpt-oss:120b` | `parameters[v].value` | not captured | 20.4 | mismatch |
