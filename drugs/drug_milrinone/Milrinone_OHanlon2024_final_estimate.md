...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | 17.6 | not captured | not captured | not captured | not captured | exact (1.0) | Tab2:row1:col2 | — | not captured |
| V | `Q61` · V | 20.8 | not captured | not captured | not captured | not captured | exact (1.0) | Tab2:row2:col2 | — | not captured |
...
| `gpt-oss:120b` | `parameters[cl].value` | 17.6 | 17.8 | mismatch |
| `gpt-oss:120b` | `parameters[v].rse_percent` | not captured | 5.08 | mismatch |
| `gpt-oss:120b` | `parameters[v].value` | 20.8 | 20.4 | mismatch |
