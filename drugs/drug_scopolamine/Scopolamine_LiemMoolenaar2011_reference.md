...
|---|---|---|---|---|---|---|---|---|---|---|
| Clearance(lmin-1) | `Q22` · CL | 2.53 | lmin-1 | not captured | [1] / [[min] · [l]] | not captured | exact (1.0) | Liem-Moolenaar_2011:abstract | — | not captured |
| Centralvolume(l) | `Q61` · V | 66.3 | l | 0.0663 | [l] | not captured | llm_confirmed (0.6) | Liem-Moolenaar_2011:abstract | — | not captured |
| Intercompartmentalclearance(lmin-1) | `Q30` · Q | 4.78 | lmin-1 | not captured | [1] / [[min] · [l]] | not captured | llm_confirmed (0.6) | Liem-Moolenaar_2011:abstract | — | not captured |
| Steady-stateVd(l) | `Q65` · Vss | 250 | l | 0.25 | [l] | not captured | llm (0.6) | Liem-Moolenaar_2011:abstract | — | not captured |
...
- unit_dimension_unknown: 'lmin-1' (CL)
- unit_dimension_unknown: 'lmin-1' (Q)
...
- 1C volume normalization: Q63→Q61 (single-compartment model has no central/peripheral split; 'Centralvolume(l)' is the general volume)
- status held at route_to_review — not promoted
- abstract-only: no full text was available, so these values were read from the abstract's prose — reported summary statistics, not a fitted model
- skipped review gap-fill of V2: primary is 1C (peripheral family needs ≥2C)

**Extraction notes:**
- no GROBID TEI available — transcribed from cached Liem-Moolenaar_2011_extracted.txt (5 record(s)); values are summary statistics, not a fitted model
...
| C9_phys_window_Q61 | pass | volume within physiological range | 66.3 L | not captured | not captured | ['Liem-Moolenaar_2011:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_scopolamine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Liem-Moolenaar_2011` / `Liem-Moolenaar_2011::reference`)
- model: `../../../knowledgebase/drugs/drug_scopolamine/models/modelica/_needs_review/Scopolamine_LiemMoolenaar2011_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_scopolamine/models/modelica/_needs_review/Scopolamine_LiemMoolenaar2011_reference.deviation.json`
