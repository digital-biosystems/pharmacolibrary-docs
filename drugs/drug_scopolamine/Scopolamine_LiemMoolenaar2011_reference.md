...
|---|---|---|---|---|---|---|---|---|---|---|
| Clearance(lmin-1) | `Q22` · CL | —(suppressed) | lmin-1 | — | [1] / [[min] · [l]] | not captured | exact (1.0) | Liem-Moolenaar_2011:abstract | — | not captured |
| Centralvolume(l) | `Q61` · V | —(suppressed) | l | — | [l] | not captured | llm_confirmed (0.6) | Liem-Moolenaar_2011:abstract | — | not captured |
| Intercompartmentalclearance(lmin-1) | `Q30` · Q | —(suppressed) | lmin-1 | — | [1] / [[min] · [l]] | not captured | llm_confirmed (0.6) | Liem-Moolenaar_2011:abstract | — | not captured |
| Steady-stateVd(l) | `Q65` · Vss | —(suppressed) | l | — | [l] | not captured | llm (0.6) | Liem-Moolenaar_2011:abstract | — | not captured |
