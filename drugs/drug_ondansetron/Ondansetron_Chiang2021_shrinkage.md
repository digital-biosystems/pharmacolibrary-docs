...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h) | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | exact (1.0) | Chiang_2021:results_prose | — | not captured |
| V C (L) | `Q61` · V | —(suppressed) | L | — | L | not captured | space_fold (0.95) | Chiang_2021:results_prose | — | not captured |
| Q (L/h) | `Q30` · Q | —(suppressed) | L/h | — | L/h | not captured | exact (1.0) | Chiang_2021:results_prose | — | not captured |
