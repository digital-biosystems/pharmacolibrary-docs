...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax | `Q32` · Cmax | 11.5 | ng/mL | not captured | [ng] / [ml] | not captured | exact (1.0) | Baek_2015:abstract | — | not captured |
| time curve from time zero to the last measurable concentration | `Q74` · AUClast | 15.9 | ng·h/mL | not captured | [[h] · [ng]] / [ml] | not captured | llm (0.6) | Baek_2015:abstract | — | not captured |
| half-life calculated from the terminal phase | `Q57` · t1/2z | 1.3 | h | 4680.0 | [h] | not captured | llm (0.6) | Baek_2015:abstract | — | not captured |
| CL (mL⋅h -1 ) | `Q22` · CL | 525.0 | mL⋅h -1 | 1.4583333333333332e-07 | L/h | not captured | review_gapfill (0.7) | Chiang_2024:review | — | not captured |
| V brain | `Q61` · V | 1.8 | mL | 1.8e-06 | L | not captured | review_gapfill (0.7) | Chiang_2024:review | — | not captured |
...
- dropped unlinked row (NIL): 'time' — extend the ontology if this is a real PK parameter (source ['Baek_2015:abstract'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=ondansetron
- abstract-only: no full text was available, so these values were read from the abstract's prose — reported summary statistics, not a fitted model
- gap-filled Q22 (CL) from Chiang_2024's review values (primary lacked it)
- gap-filled Q61 (V) from Chiang_2024's review values (primary lacked it)
- skipped review gap-fill of V2: primary is 1C (peripheral family needs ≥2C)
- skipped review gap-fill of Q: primary is 1C (peripheral family needs ≥2C)

**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Baek_2015_metadata.yaml (4 record(s)); values are summary statistics, not a fitted model
...
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Chiang_2024:review'] |
| C5_dimension_Q74 | pass | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['Baek_2015:abstract'] |
| C6_cl_magnitude | fail | &lt;= 90.0 L/h | 525.0 | not captured | not captured | ['Chiang_2024:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.525 L/h | not captured | not captured | ['Chiang_2024:review'] |
| C9_phys_window_Q61 | fail | volume within physiological range | 0.0018 L | not captured | not captured | ['Chiang_2024:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_ondansetron/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Baek_2015` / `Baek_2015::reference`)
