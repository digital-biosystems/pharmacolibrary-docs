...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-11 04:12 | 27:50 | 0/0/0 | 1/0/0 | 0/0/0 | 354,624/7,343 | ollama / qwen3.8:27b-mtp-q8_0 | 23 | 0/0 | 23/0 | 0 |
...
- **PubMed hits:** 220 matched, 103 returned
...
<sub>queue written 2026-09-11T04:06:03.536991+00:00</sub>
...
| popPK | Carlson-Stevermer_2020 | irrelevant | 0 | 0 | The paper focuses on genome editing strategies for Pompe disease and does not involve the drug hymecromone or report its pharmacokinetic parameters. |
| PD | Carlson-Stevermer_2020 | not_relevant | 0 | 0 | The paper focuses on genome editing strategies for Pompe disease and does not contain any pharmacodynamic or exposure-response data for hymecromone. |
| PGx | Chen_2018 | not_relevant | 0 | 0 | The paper studies the inhibition of UGT enzymes by thyroid hormones (T3/T4) and does not mention hymecromone or any gene variants affecting its pharmacokinetics or pharmacodynamics. |
...
| popPK | Gao_2019 | irrelevant | 0 | 0 | The paper focuses on UGT inhibition by parthenolide and micheliolide, not the pharmacokinetics of hymecromone. |
...
| popPK | Haron_2014 | irrelevant | 0 | 0 | The paper is an in-vitro study on UGT inhibition by mitragynine and other compounds, and does not mention hymecromone or report any pharmacokinetic parameters for it. |
| PD | Haron_2014 | not_relevant | 0 | 0 | The paper investigates the in vitro inhibitory effects of mitragynine and 7-hydroxymitragynine on UGT enzymes, not the pharmacodynamics of hymecromone. |
| PGx | Haron_2014 | not_relevant | 0 | 0 | The paper investigates the inhibitory effects of mitragynine and other compounds on UGT enzymes, not the pharmacokinetics or pharmacodynamics of hymecromone. |
| popPK | Hasibuan_2020 | irrelevant | 0 | 0 | The paper investigates the anticancer activity of Vernonia amygdalina on breast cancer cells and does not mention hymecromone or report any pharmacokinetic parameters. |
| PD | Hasibuan_2020 | not_relevant | 0 | 0 | The paper studies the anticancer activity of Vernonia amygdalina fractions, not hymecromone. |
...
| popPK | Ismail_2010 | irrelevant | 0 | 0 | The paper is an in-vitro study on UGT inhibition by herbal extracts and does not involve hymecromone or report any pharmacokinetic parameters for it. |
| PD | Ismail_2010 | not_relevant | 0 | 0 | The paper studies the in vitro inhibition of UGT isoforms by herbal extracts (Andrographis paniculata and Orthosiphon stamineus) and does not mention or analyze hymecromone. |
| PGx | Ismail_2010 | not_relevant | 0 | 0 | The paper studies the inhibition of UGT enzymes by herbal extracts using 4-methylumbelliferone as a substrate; it does not involve the drug hymecromone or pharmacogenomic variants. |
| popPK | Jeong_2024 | irrelevant | 0 | 0 | The paper is a mechanistic study on tyrosinase inhibition by dihydrocoumarins and does not involve hymecromone or pharmacokinetic parameters. |
| PD | Jeong_2024 | not_relevant | 0 | 0 | The paper reports in vitro enzyme inhibition (IC50) for novel radiolytic coumarin derivatives, not a pharmacokinetic/pharmacodynamic (exposure-response) relationship for the drug hymecromone. |
...
| popPK | Kandil_2026 | irrelevant | 0 | 0 | The paper is a medicinal chemistry study on coumarin-stavudine ProTides, and hymecromone (4MU) is used only as a structural component or reference, with no pharmacokinetic parameters reported. |
| PD | Kandil_2026 | not_relevant | 0 | 0 | The paper reports in vitro antiviral activity (IC50) of novel stavudine ProTides, not a pharmacodynamic or exposure-response relationship for hymecromone. |
...
| popPK | Lewis_2007 | irrelevant | 0 | 0 | The paper focuses on UGT enzyme domains and substrate selectivity, not hymecromone pharmacokinetics. |
...
| popPK | Li_2019 | irrelevant | 0 | 0 | The paper studies the pharmacokinetics of XueBiJing compounds and antibiotics, not hymecromone. |
| PD | Li_2019 | not_relevant | 0 | 0 | The paper focuses on pharmacokinetic compatibility and drug-drug interactions (DDI) between XueBiJing and antibiotics, reporting PK parameters and in vitro enzyme/transporter data, but contains no pharmacodynamic (PD) or exposure-response analysis for hymecromone or any other drug. |
...
| popPK | Liu_2016_2 | irrelevant | 0 | 0 | The study investigates the in-vitro UGT inhibition potential of hesperetin and naringenin, not the pharmacokinetics of hymecromone. |
| PD | Liu_2016_2 | not_relevant | 0 | 0 | The paper investigates the inhibitory effects of hesperetin and naringenin on UGT enzymes, not the pharmacodynamics of hymecromone. |
| PGx | Liu_2016_2 | not_relevant | 0 | 0 | The paper investigates the inhibitory effects of hesperetin and naringenin on UGT enzymes, not the pharmacogenomics of hymecromone. |
...
| PGx | Lokman_2019 | not_relevant | 0 | 0 | The paper investigates the anticancer mechanism of 4-methylumbelliferone (hymecromone) in ovarian cancer cells and does not report any pharmacogenomic effects on its pharmacokinetic or pharmacodynamic parameters. |
...
| popPK | Nakamura_2021 | irrelevant | 0 | 0 | The paper focuses on UGT modulation by adenine-related compounds in mouse liver microsomes and does not report pharmacokinetic parameters for hymecromone. |
...
| popPK | Nishimura_2007 | irrelevant | 0 | 0 | The paper focuses on the inhibitory effects of adenine nucleotides on UDP-glucuronosyltransferase and does not report pharmacokinetic parameters for hymecromone. |
...
| popPK | Pattanawongsa_2015 | irrelevant | 0 | 0 | The paper focuses on UGT inhibition by canagliflozin and dapagliflozin and does not report pharmacokinetic parameters for hymecromone. |
...
| PGx | Qi_2015 | not_relevant | 0 | 0 | The paper investigates the inhibition of UGT enzymes by podophyllotoxin analogues and does not mention hymecromone or any pharmacogenomic effects. |
...
| popPK | Rosser_2022 | irrelevant | 2 | 0 | The study measures drug concentrations (4-MU/4-MUG) and HA levels but does not report quantitative PK parameters (CL, V, ka) or a compartmental model for hymecromone. |
...
| popPK | Salleh_2017 | irrelevant | 0 | 0 | The study is an in-vitro enzyme inhibition assay using p-nitrophenol and 4-methylumbelliferone as probe substrates, and does not involve the drug hymecromone. |
| PD | Salleh_2017 | not_relevant | 0 | 0 | The paper investigates in vitro enzyme inhibition (UGT) by lignin compounds and does not mention hymecromone or report any pharmacodynamic exposure-response relationship for it. |
| popPK | Sancenon_2015 | irrelevant | 0 | 0 | The paper describes the development of an in-vitro enzymatic assay for alkaline phosphatase and does not involve hymecromone or pharmacokinetic parameters. |
| PD | Sancenon_2015 | not_relevant | 0 | 0 | The paper describes the development of an enzymatic assay for alkaline phosphatase and does not mention hymecromone or report any pharmacodynamic data for it. |
...
| PGx | Shan_2014 | not_relevant | 0 | 0 | The paper studies UGT inhibition by bavachalcone and corylin, not the pharmacokinetics or pharmacodynamics of hymecromone. |
...
| popPK | Tian_2018 | irrelevant | 0 | 0 | The study focuses on green tea catechins as inhibitors of UGTs using raloxifene as a probe drug, and does not report pharmacokinetic parameters for hymecromone. |
| PD | Tian_2018 | not_relevant | 0 | 0 | The paper focuses on green tea catechins as UGT inhibitors and does not mention or analyze hymecromone. |
| popPK | Tsitrina_2021 | irrelevant | 0 | 0 | The paper is a mechanistic study on hyaluronan synthesis inhibition and does not report pharmacokinetic parameters (CL, V, etc.) for hymecromone. |
| popPK | Uchaipichat_2025 | irrelevant | 0 | 0 | The paper investigates the in-vitro inhibitory effects of Kratom constituents on UGT enzymes and does not report pharmacokinetic parameters for hymecromone. |
| PD | Uchaipichat_2025 | not_relevant | 0 | 0 | The paper investigates the inhibitory effects of Kratom constituents (mitragynine and 7-hydroxymitragynine) on UGT enzymes, not the pharmacodynamics of hymecromone. |
| PGx | Uchaipichat_2025 | not_relevant | 0 | 0 | The paper investigates the inhibitory effects of Kratom constituents on UGT enzymes, not the pharmacogenomics of hymecromone. |
...
| popPK | Weiz_2024 | irrelevant | 0 | 0 | The paper is a study on fungal enzymes and their anti-tumoral activity in cancer cells, and does not involve the drug hymecromone or its pharmacokinetics. |
| PD | Weiz_2024 | not_relevant | 0 | 0 | The paper does not mention hymecromone; it reports in vitro IC50 values for novel rutinoside derivatives (phloroglucinol, resorcinol, 4-methylumbelliferone) in cancer cells. |
| popPK | Xie_2017 | irrelevant | 0 | 0 | The paper focuses on in vitro inhibition of UGT enzymes by ursolic and oleanolic acid, with no mention of hymecromone or its pharmacokinetic parameters. |
...
| PGx | Xu_2014 | not_relevant | 0 | 0 | The paper studies the inhibition of UGT2B7 by bakuchiol, not the pharmacogenomics of hymecromone. |
...
| PGx | Xu_2023 | not_relevant | 0 | 0 | The paper investigates the effect of dietary flavonoids on UGT2B7 enzyme activity and does not mention hymecromone or any gene variant affecting its pharmacokinetics or pharmacodynamics. |
...
| popPK | Zhang_2017 | irrelevant | 0 | 0 | The paper investigates the inhibitory effects of tanshinones on UGT enzymes in vitro and does not report pharmacokinetic parameters for hymecromone. |
| PD | Zhang_2017 | not_relevant | 0 | 0 | The paper investigates the inhibitory effects of tanshinones on UGT enzymes and does not mention or analyze hymecromone. |
| PGx | Zhang_2021 | not_relevant | 0 | 0 | The paper investigates the in vitro inhibitory effects of quercetin and its metabolite on UGT enzymes, not the pharmacogenomic effects on hymecromone. |
| popPK | unknown_1991 | irrelevant | 0 | 0 | The provided evidence is only a conference header with no study data, parameters, or mention of hymecromone. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_hymecromone`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
