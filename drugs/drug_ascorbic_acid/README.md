...
- **DrugBank:** [DB00126](https://go.drugbank.com/drugs/DB00126)
...
|---|---|---|---|---|---|---|---|---|---|---|
| not captured | not captured | 0/1/0 | 0/0/0 | 0/0/0 | not captured | not captured | 36 | 38/0 | 23/13 | 0 |
...
<sub>queue written 2026-08-02T12:56:01.797363+00:00</sub>
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_ascorbic_acid`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
