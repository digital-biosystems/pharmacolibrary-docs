...
|---|---|---|---|---|---|---|---|---|---|---|
| Elimination half-life | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Hampton_2024:abstract | — | not captured |
| mean residence time | `Q53` · MRT | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Hampton_2024:abstract | — | not captured |
| apparent volume of distribution | `Q76` · V/F | —(suppressed) | L/kg | — | [l] / [kg] | not captured | exact (1.0) | Hampton_2024:abstract | — | not captured |
