...
## Model component
<dbs-pgx drug="clonazepam" model-id="Clonazepam_Kruizinga2022_estimate_shrinkage" status="curated_candidate" stale="false" population="healthy adults" measured-compound="clonazepam" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
- model: `../../../knowledgebase/drugs/drug_clonazepam/models/modelica/Clonazepam_Kruizinga2022_estimate_shrinkage.mo`
- deviation: `../../../knowledgebase/drugs/drug_clonazepam/models/modelica/Clonazepam_Kruizinga2022_estimate_shrinkage.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_clonazepam/models/modelica/Clonazepam_Kruizinga2022_estimate_shrinkage.json`
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_clonazepam/Clonazepam_Kruizinga2022_estimate_shrinkage/Clonazepam_Kruizinga2022_estimate_shrinkage.svg" alt="Clonazepam_Kruizinga2022_estimate_shrinkage diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_clonazepam/Clonazepam_Kruizinga2022_estimate_shrinkage/Clonazepam_Kruizinga2022_estimate_shrinkage_params.json" metaurl="assets/fmu/PK_2C.vr.json" wasmurl="assets/fmu/PK_2C.js" controlsurl="drugs/drug_clonazepam/Clonazepam_Kruizinga2022_estimate_shrinkage/Clonazepam_Kruizinga2022_estimate_shrinkage_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_2C` · parameters `Clonazepam_Kruizinga2022_estimate_shrinkage_params.json` · controls `Clonazepam_Kruizinga2022_estimate_shrinkage_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
