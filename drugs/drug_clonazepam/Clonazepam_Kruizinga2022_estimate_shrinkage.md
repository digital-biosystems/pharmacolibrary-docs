...
<img src="drugs/drug_clonazepam/Clonazepam_Kruizinga2022_estimate_shrinkage/Clonazepam_Kruizinga2022_estimate_shrinkage.svg" alt="Clonazepam_Kruizinga2022_estimate_shrinkage diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_2C` · parameters `Clonazepam_Kruizinga2022_estimate_shrinkage_params.json` · controls `Clonazepam_Kruizinga2022_estimate_shrinkage_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
