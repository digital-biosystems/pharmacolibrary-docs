...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-21 17:32 | 6:24 | 1/2/1 | 0/0/0 | 0/0/2 | 134,865/10,963 | ollama / qwen3.8:27b-mtp-q8_0 | 10 | 3/7 | 10/0 | 0 |
...
| excretion | bile duct | <sub>“…dose is excreted in the urine and 10-30% is excreted in the feces as metabolites [F3763, F…”</sub> | prose |
| excretion | kidney | <sub>“…pproximately 50-70% of a clonazepam dose is excreted in the urine and 10-30% is excreted i…”</sub> | prose |
...
<sub>queue written 2026-09-21T17:27:32.795194+00:00</sub>
...
| PGx | Charasson_2002 | not_relevant | 0 | 0 | The paper studies drug-drug interactions involving irinotecan metabolism and does not report pharmacogenomic effects on clonazepam PK/PD. |
| PGx | Cokley_2022 | not_relevant | 0 | 0 | The paper discusses drug-drug interactions between Paxlovid and clonazepam, not pharmacogenomic effects of gene variants on clonazepam PK/PD. |
...
| PGx | Ho_2019 | not_relevant | 5 | 2 | The paper reports a qualitative case study of prolonged withdrawal symptoms (PD) in an NAT2 ultraslow acetylator but lacks quantitative PK/PD parameters or fitted effect sizes. |
| popPK | Hoogerkamp_1996 | irrelevant | 2 | 0 | The study focuses on pharmacodynamic concentration-effect relationships (EC50) in a rat model rather than reporting quantitative pharmacokinetic disposition parameters (CL, V, t1/2) for clonazepam. |
...
| popPK | Kecskeméti_2005 | irrelevant | 0 | 0 | The study is a pharmacological investigation of anticonvulsant effects and calcium channel blocking, using clonazepam only as a comparator agent, with no pharmacokinetic parameters reported. |
...
| PGx | Majid_2016 | not_relevant | 0 | 0 | The paper investigates the impact of perampanel on the pharmacokinetics of concomitant antiepileptics (including clonazepam) but does not report any pharmacogenomic effects (gene variants/genotypes) on these parameters. |
| PGx | Marvanova_2019 | not_relevant | 0 | 0 | The paper reports a case of perampanel-induced food aversion and does not investigate the impact of genetic variants on the pharmacokinetics or pharmacodynamics of clonazepam. |
...
| PGx | Nakashima_2015 | not_relevant | 0 | 0 | The study focuses on the pharmacogenomics of valproic acid (VPA), not clonazepam; clonazepam is only listed as a co-administered covariate. |
...
| PGx | Park_2023 | not_relevant | 0 | 0 | The paper reports a drug-drug interaction involving rifampin, not a pharmacogenomic effect of a gene variant on clonazepam. |
...
| PGx | Tanwir_2022 | not_relevant | 0 | 0 | The paper is a case report on a drug-drug interaction (cannabidiol and tiagabine/clonazepam) causing NCSE, with no mention of genetic variants or pharmacogenomics. |
| popPK | Uges_2009 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of levetiracetam, with clonazepam serving only as a co-administered standard treatment agent. |
...
| popPK | dos_2009 | relevant | 9 | 0 | The study is a population PK/PD modeling study for clonazepam, but the specific numeric parameter values (CL, V, etc.) are not present in the provided evidence text. |

---
<sub>Generated by `docs.py` (scholarv2) · newest extraction 2026-09-21 17:27 UTC</sub>
