...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-16 13:19 | 1:40 | 2/3/0 | 0/0/0 | 0/0/2 | 15,619/2,227 | ollama / qwen3.8:27b-mtp-q8_0 | 10 | 3/7 | 10/0 | 0 |

## popPK records

| status | detail | citation | doi |
|---|---|---|---|
| <span class="pk-badge pk-badge--green">reviewed — candidate</span> | [Kruizinga_2022](drugs/drug_clonazepam/Clonazepam_Kruizinga2022_estimate_shrinkage.md) | Kruizinga MD et al., Population pharmacokinetics of clonazep…, British journal of clinical… (2022) | [10.1111/bcp.15152](https://doi.org/10.1111/bcp.15152) |
| <span class="pk-badge pk-badge--green">reviewed — candidate</span> | [Kruizinga_2022](drugs/drug_clonazepam/Clonazepam_Kruizinga2022_estimate_shrinkage.md) | Kruizinga MD et al., Population pharmacokinetics of clonazep…, British journal of clinical… (2022) | [10.1111/bcp.15152](https://doi.org/10.1111/bcp.15152) |
| <span class="pk-badge pk-badge--orange">built, not shipped</span><br><sub>blocking: model_quarantined: Cl left at base-class defaults</sub><br><sub>route_to: `scholar`</sub> | [Hampton_2024](drugs/drug_clonazepam/Clonazepam_Hampton2024_reference.md) | Hampton CE et al., Pharmacokinetics of oral clonazepam in…, Journal of veterinary pharm… (2024) | [10.1111/jvp.13451](https://doi.org/10.1111/jvp.13451) |
| <span class="pk-badge pk-badge--red">rejected</span><br><sub>blocking: split column 'parameter' is a table statistic/structure column, not a study pop…</sub><br><sub>route_to: `human_review`</sub> | [Kruizinga_2022](drugs/drug_clonazepam/Clonazepam_Kruizinga2022_parameter.md) | Kruizinga MD et al., Population pharmacokinetics of clonazep…, British journal of clinical… (2022) | [10.1111/bcp.15152](https://doi.org/10.1111/bcp.15152) |
| <span class="pk-badge pk-badge--red">rejected</span><br><sub>blocking: split column 'parameter' is a table statistic/structure column, not a study pop…</sub><br><sub>route_to: `human_review`</sub> | [Kruizinga_2022](drugs/drug_clonazepam/Clonazepam_Kruizinga2022_parameter.md) | Kruizinga MD et al., Population pharmacokinetics of clonazep…, British journal of clinical… (2022) | [10.1111/bcp.15152](https://doi.org/10.1111/bcp.15152) |
...
<sub>queue written 2026-09-16T13:18:10.322139+00:00</sub>
