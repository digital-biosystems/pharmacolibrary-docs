...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-21 23:11 | 27:44 | 0/0/0 | 4/2/0 | 0/0/0 | 831,296/14,247 | ollama / qwen3.8:27b-mtp-q8_0 | 43 | 9/34 | 41/2 | 0 |
...
| <span class="pk-badge pk-badge--green">extracted</span> | [Gökçe_2012](drugs/drug_sodium_phosphate/pd_G_k_e_2012_hCA_I.md) | Gökçe B et al., Evaluation of in vitro effects of some…, Journal of enzyme inhibitio… (2012) | [10.3109/14756366.2011.574130](https://doi.org/10.3109/14756366.2011.574130) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Gökçe_2012](drugs/drug_sodium_phosphate/pd_G_k_e_2012_hCA_II.md) | Gökçe B et al., Evaluation of in vitro effects of some…, Journal of enzyme inhibitio… (2012) | [10.3109/14756366.2011.574130](https://doi.org/10.3109/14756366.2011.574130) |
...
| <span class="pk-badge pk-badge--red">rejected</span> | [Araújo_2017](drugs/drug_sodium_phosphate/pd_Ara_jo_2017_egg_hatching.md) | Araújo SA et al., In vitro anthelmintic effects of Spigel…, PloS one (2017) | [10.1371/journal.pone.0189803](https://doi.org/10.1371/journal.pone.0189803) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Araújo_2017](drugs/drug_sodium_phosphate/pd_Ara_jo_2017_larval_exsheathment_inhibition.md) | Araújo SA et al., In vitro anthelmintic effects of Spigel…, PloS one (2017) | [10.1371/journal.pone.0189803](https://doi.org/10.1371/journal.pone.0189803) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Araújo_2017](drugs/drug_sodium_phosphate/pd_Ara_jo_2017_larval_migration_inhibition.md) | Araújo SA et al., In vitro anthelmintic effects of Spigel…, PloS one (2017) | [10.1371/journal.pone.0189803](https://doi.org/10.1371/journal.pone.0189803) |
...
| <span class="pk-badge pk-badge--red">rejected</span> | [Swaih_2025](drugs/drug_sodium_phosphate/pd_Swaih_2025_EGFR_phosphorylation.md) | Swaih AM et al., AZ14289671 is a highly selective and bl…, Cell reports. Medicine (2025) | [10.1016/j.xcrm.2025.102305](https://doi.org/10.1016/j.xcrm.2025.102305) |
...
<sub>queue written 2026-09-21T23:03:51.723345+00:00</sub>

## Screened and excluded

| domain | paper | verdict | relevance | extractability | reason |
|---|---|---|---|---|---|
| popPK | Abbas_2026 | irrelevant | 0 | 0 | The paper describes the synthesis and characterization of iron oxide nanoparticles, not the pharmacokinetics of sodium phosphate. |
...
| popPK | Ahlqvist_2025 | irrelevant | 0 | 0 | The paper is a metabolite identification study for 120 experimental compounds and does not report pharmacokinetic parameters for sodium phosphate. |
...
| popPK | Algov_2026 | irrelevant | 0 | 0 | The paper describes a protease substrate discovery platform (PSurf) for tumor detection and does not involve sodium phosphate or report any pharmacokinetic parameters. |
...
| popPK | Araújo_2017 | irrelevant | 0 | 0 | The paper is an in-vitro anthelmintic study where sodium phosphate is used only as a buffer, not as the subject drug for pharmacokinetic analysis. |
...
| PGx | Bi_2024 | not_relevant | 0 | 0 | The paper investigates the effects of a probiotic on uric acid levels and transporter expression in rats, not the pharmacogenomics of sodium phosphate. |
...
| popPK | Brandon_2026 | irrelevant | 0 | 0 | The study reports population pharmacokinetic parameters for mitoxantrone, not sodium phosphate (which is only mentioned as a buffer component in the HPLC method). |
...
| popPK | Camargo_2025 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of linalool (a monoterpene), not sodium phosphate. |
...
| popPK | Castro-Suárez_2020 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for nimotuzumab, not sodium phosphate. |
...
| popPK | Cruz_2018 | irrelevant | 0 | 0 | The paper is an in-vitro enzymatic kinetics study on a tick pyrophosphatase, not a pharmacokinetic study of sodium phosphate as a drug. |
...
| popPK | Draveny_2025 | irrelevant | 0 | 0 | The paper studies the intracellular accumulation of ciprofloxacin and its copper complex in E. coli, not the pharmacokinetics of sodium phosphate. |
...
| popPK | Fajana_2026 | irrelevant | 0 | 0 | The paper is an in vitro and in silico study on plant extracts for hypertension and does not involve sodium phosphate pharmacokinetics. |
...
| PGx | Felber_1988 | not_relevant | 0 | 0 | The paper investigates the pharmacological effects of tin-protoporphyrin on bilirubin levels in rats and does not report any pharmacogenomic effects on the PK or PD of sodium phosphate. |
...
| popPK | Groenendaal_2005 | irrelevant | 0 | 0 | The paper describes an HPLC method for opioids where sodium phosphate is used only as a mobile phase buffer, not as the subject drug. |
...
| popPK | Jusko_2025 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of dexamethasone and betamethasone released from erythrocytes, where sodium phosphate is merely the prodrug form (DSP/BSP) and not the subject drug for which disposition parameters are reported. |
| PGx | Kasahara_2021 | not_relevant | 0 | 0 | The paper studies the effect of protein engineering (supercharging mutations) on antibody stability and binding, not the effect of human gene variants on the pharmacokinetics or pharmacodynamics of sodium phosphate. |
...
| PGx | Li_2016 | not_relevant | 0 | 0 | The paper studies renal physiology and transporter expression in response to diet and genetic knockout, not the pharmacokinetics or pharmacodynamics of the drug sodium phosphate. |
...
| PGx | Lu_2010 | not_relevant | 0 | 0 | The paper reports changes in mRNA expression of the sodium phosphate cotransporter due to HNF4a knockout, but does not report pharmacokinetic or pharmacodynamic parameters of sodium phosphate as a drug. |
...
| PGx | McMurrough_1996 | not_relevant | 0 | 0 | The paper studies DPD enzyme activity and sample storage methods, not the pharmacokinetics or pharmacodynamics of sodium phosphate. |
...
| popPK | Mim_2026 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of mefloquine and artesunate, not sodium phosphate. |
| PGx | Miyagawa_2014 | not_relevant | 0 | 0 | The paper studies gene expression in a mouse model of hypophosphatemia and does not report pharmacokinetic or pharmacodynamic effects of a drug (sodium phosphate) modified by a gene variant. |
...
| popPK | Othman_2026 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of linagliptin and cefixime, using sodium phosphate only as a component of the HPLC mobile phase buffer, not as the subject drug. |
...
| popPK | Ozdin_2025 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for dexamethasone (the active metabolite of dexamethasone sodium phosphate), not for sodium phosphate itself. |
...
| PGx | Pathare_2018 | not_relevant | 0 | 0 | The paper studies the effect of NCC gene knockout on FGF23 levels and mineral metabolism, not the pharmacokinetics or pharmacodynamics of the drug sodium phosphate. |
...
| popPK | Pozo_2026 | irrelevant | 0 | 0 | The paper is a mechanistic study on glycine metabolism in hepatocytes and does not report pharmacokinetic parameters for sodium phosphate. |
...
| PGx | Rodrigues_2022 | not_relevant | 0 | 0 | The study investigates pharmacokinetics in twin pregnancies (physiological state) and does not report any gene variants or pharmacogenomic effects. |
...
| popPK | Soares_2015 | irrelevant | 0 | 0 | The paper is a parasitology study on plant extracts against nematodes, where sodium phosphate is used only as a buffer, not as a subject drug for pharmacokinetic analysis. |
...
| popPK | Sullivan_2026 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of betamethasone (specifically betamethasone sodium phosphate/acetate), not sodium phosphate as a subject drug. |
| popPK | Swaih_2025 | irrelevant | 0 | 0 | The paper reports pharmacokinetic parameters for the drug AZ14289671 (and comparators), not for sodium phosphate. |
...
| popPK | WHO_2025 | irrelevant | 0 | 0 | The paper is a protocol for a study on antenatal corticosteroids (dexamethasone and betamethasone), not sodium phosphate, and contains no PK parameters for the target drug. |
...
| popPK | Wen_2026 | irrelevant | 0 | 0 | The paper focuses on developing a liver distribution model for drugs like diclofenac and tolbutamide, and sodium phosphate is only listed as a reagent, not the subject drug. |
...
| popPK | Wyns_2013 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of dexamethasone (DEX), where sodium phosphate is merely the salt form/prodrug, not the subject drug. |
