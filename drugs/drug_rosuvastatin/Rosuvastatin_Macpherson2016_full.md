...
## Model component
<dbs-pgx drug="rosuvastatin" model-id="Rosuvastatin_Macpherson2016_full" status="needs_review" stale="false" population="pediatric patients with heterozygous familial hypercholesterolemia" measured-compound="rosuvastatin" parameterization="apparent" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka (h-1) | `Q49` · kabs | —(suppressed) | h-1 | — | [1] / [h] | not captured | exact (1.0) | Macpherson_2016_table_p6_1:row0:col2 | — | not captured |
| CL/F (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | Macpherson_2016_table_p6_1:row1:col2 | — | 43.7 (None% RSE) |
| Vc/F (L) | `Q290` · V1/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Macpherson_2016_table_p6_1:row2:col2 | — | 106 (None% RSE) |
| Q/F (L/h) | `Q69` · Q/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | Macpherson_2016_table_p6_1:row3:col2 | — | 65.1 (None% RSE) |
| Vp/F (L) | `Q82` · V2/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Macpherson_2016_table_p6_1:row4:col2 | — | not captured |
| theta_cl_f_weight_power | `Q900` · theta_cl_f_weight_power | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Macpherson_2016_table_p6_1:row5:col2 | — | not captured |
