...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl (L·h−1) | `Q22` · CL | —(suppressed) | L·h−1 | — | L/h | not captured | review (0.7) | Courlet_2021:review | — | not captured |
| Vc (L) | `Q63` · V1 | —(suppressed) | L | — | L | not captured | review (0.7) | Courlet_2021:review | — | not captured |
| Vp (L) | `Q64` · V2 | —(suppressed) | L | — | L | not captured | review (0.7) | Courlet_2021:review | — | not captured |
| Q (L·h−1) | `Q30` · Q | —(suppressed) | L·h−1 | — | L/h | not captured | review (0.7) | Courlet_2021:review | — | not captured |
| ka (h−1) | `Q49` · kabs | —(suppressed) | h−1 | — | 1/h | not captured | review (0.7) | Courlet_2021:review | — | not captured |
