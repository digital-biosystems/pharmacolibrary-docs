...
Courlet P; Guidi M; Alves Saldanha S; Stader F; Traytel A; Cavassini M; et al. et al. (2021). Clinical pharmacokinetics 60
  ·  DOI: [10.1007/s40262-020-00946-3](https://doi.org/10.1007/s40262-020-00946-3)
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl (L·h−1) | `Q22` · CL | 122.0 | L·h−1 | 3.388888888888889e-05 | L/h | not captured | review (0.7) | Courlet_2021:review | — | not captured |
| Vc (L) | `Q63` · V1 | 144.0 | L | 0.14400000000000002 | L | not captured | review (0.7) | Courlet_2021:review | — | not captured |
| Vp (L) | `Q64` · V2 | 1610.0 | L | 1.61 | L | not captured | review (0.7) | Courlet_2021:review | — | not captured |
| Q (L·h−1) | `Q30` · Q | 69.0 | L·h−1 | 1.9166666666666667e-05 | L/h | not captured | review (0.7) | Courlet_2021:review | — | not captured |
| ka (h−1) | `Q49` · kabs | 0.306 | h−1 | 8.499999999999999e-05 | 1/h | not captured | review (0.7) | Courlet_2021:review | — | not captured |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Courlet_2021:review'] |
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Courlet_2021:review'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Courlet_2021:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Courlet_2021:review'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Courlet_2021:review'] |
| C6_cl_magnitude | fail | &lt;= 90.0 L/h | 122.0 | not captured | not captured | ['Courlet_2021:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 122 L/h | not captured | not captured | ['Courlet_2021:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 144 L | not captured | not captured | ['Courlet_2021:review'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 1.61e+03 L | not captured | not captured | ['Courlet_2021:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_rosuvastatin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Courlet_2021` / `Courlet_2021::reference`)
