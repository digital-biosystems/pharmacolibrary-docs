...
Tzeng TB; Schneck DW; Birmingham BK; Mitchell PD; Zhang H; Martin PD; et al. et al. (2008). Current medical research and opinion 24
  ·  DOI: [10.1185/03007990802312807](https://doi.org/10.1185/03007990802312807)
...
|---|---|---|---|---|---|---|---|---|---|---|
| apparent oral clearance (CL/F) | `Q27` · CL/F | 257 | L/h | 7.138888888888889e-05 | [l] / [h] | not captured | exact (1.0) | Tzeng_2008:abstract | — | not captured |
| ka,R (h−1) | `Q49` · kabs | 0.21 | h−1 | 5.833333333333333e-05 | 1/h | not captured | review_gapfill (0.7) | An_2025:review | — | not captured |
...
- covariate creatinine for CL/F from footnote/prose kept as documentation only (['Tzeng_2008:abstract'])
- unit_dimension_mismatch: 'CL/F in subjects with dyslipidaemia' → Q27 (unit 'dimensionless' vs ontology '[length] ** 3 / [time]') — route to review
- dropped duplicate Q27 ('CL/F in subjects with dyslipidaemia', value 71.1) — already have one for this compound
- unit_dimension_mismatch: 'CL/F in Asian subjects' → Q27 (unit 'dimensionless' vs ontology '[length] ** 3 / [time]') — route to review
- dropped duplicate Q27 ('CL/F in Asian subjects', value 43.7) — already have one for this compound
...
- gap-filled Q49 (kabs) from An_2025's review values (primary lacked it)

**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Tzeng_2008_metadata.yaml (5 record(s)); values are summary statistics, not a fitted model
...
| `gpt-oss:120b` | `parameters[ka,r]` | 0.21 | not captured | only_one_extracted |
...
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tzeng_2008:abstract'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['An_2025:review'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q27 | pass | clearance within physiological range | 257 L/h | not captured | not captured | ['Tzeng_2008:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_rosuvastatin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Tzeng_2008` / `Tzeng_2008::reference`)
