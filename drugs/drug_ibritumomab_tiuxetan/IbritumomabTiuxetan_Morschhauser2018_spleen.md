...
## Model component
<dbs-pgx drug="ibritumomab tiuxetan" model-id="IbritumomabTiuxetan_Morschhauser2018_spleen" status="rejected" stale="false" population="patients with follicular lymphoma" measured-compound="ibritumomab_tiuxetan" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- dropped unlinked row (NIL): 'Blood in corresponding volume* (mL)' — extend the ontology if this is a real PK parameter (source ['Tab2:row1:col3'])
...
- scholar stages: `../../../knowledgebase/drugs/drug_ibritumomab_tiuxetan/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Morschhauser_2018` / `Morschhauser_2018::spleen`)
