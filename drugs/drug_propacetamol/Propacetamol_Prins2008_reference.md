...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Prins_2008_metadata.yaml (6 record(s)); values are summary statistics, not a fitted model
...
| `gpt-oss:120b` | `parameters[absorption half-life from the rectum]` | 4.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[central and peripheral volume of distribution]` | 7.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[clearance]` | 12 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[intercompartmental clearance]` | 116 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[propacetamol hydrolysis half-life]` | 0.028 | not captured | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_propacetamol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Prins_2008` / `Prins_2008::reference`)
- model: `../../../knowledgebase/drugs/drug_propacetamol/models/modelica/Propacetamol_Prins2008_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_propacetamol/models/modelica/Propacetamol_Prins2008_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_propacetamol/models/modelica/Propacetamol_Prins2008_reference.json`
...
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_propacetamol/Propacetamol_Prins2008_reference/Propacetamol_Prins2008_reference_cellml.zip" download>Propacetamol_Prins2008_reference_cellml.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
</tbody></table>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C` · parameters `Propacetamol_Prins2008_reference_params.json` · controls `Propacetamol_Prins2008_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
