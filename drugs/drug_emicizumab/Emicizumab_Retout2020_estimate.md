...
## Model component
<dbs-pgx drug="emicizumab" model-id="Emicizumab_Retout2020_estimate" status="" stale="false" population="adult and pediatric persons with hemophilia A" measured-compound="emicizumab" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F | `Q27` · CL/F | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Tab4:row2:col2, Tab4:row6:col2 | — | not captured |
| V/F | `Q76` · V/F | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Tab4:row3:col2, Tab4:row7:col2 | — | not captured |
| KA | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Tab4:row4:col2, Tab4:row8:col2 | — | not captured |
