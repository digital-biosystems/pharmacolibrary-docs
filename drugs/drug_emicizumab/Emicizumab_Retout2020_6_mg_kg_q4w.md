...
|---|---|---|---|---|---|---|---|---|---|---|
| t1/2 (day) | `Q57` · t1/2z | —(suppressed) | day | — | [d] | not captured | exact (1.0) | Retout_2020_table_5:row1:col5 | — | not captured |
| Cmax,SS (μg/mL) | `Q32` · Cmax | —(suppressed) | μg/mL | — | [µg] / [ml] | not captured | llm_confirmed (0.6) | Retout_2020_table_5:row3:col5 | — | not captured |
| tmax,SS (day) | `Q56` · tmax | —(suppressed) | day | — | [d] | not captured | llm_confirmed (0.6) | Retout_2020_table_5:row4:col5 | — | not captured |
| Ctrough,SS (μg/mL) | `Q37` · Ctrough | —(suppressed) | μg/mL | — | [µg] / [ml] | not captured | llm_confirmed (0.6) | Retout_2020_table_5:row5:col5 | — | not captured |
| AUCss,τ (μg × day/mL) | `Q18` · AUCSS | —(suppressed) | μg × day/mL | — | [[d] · [µg]] / [ml] | not captured | llm_confirmed (0.6) | Retout_2020_table_5:row7:col5 | — | not captured |
| Cav,SS (μg/mL) | `Q71` · Cavg | —(suppressed) | μg/mL | — | [µg] / [ml] | not captured | llm_confirmed (0.6) | Retout_2020_table_5:row8:col5 | — | not captured |
...
- population split: '6 mg/kg q4w' subgroup of Retout_2020 (paper reports 6 populations: 1.5 mg/kg qw, 3 mg/kg q2w, 6 mg/kg q4w, estimate, shrinkage (%), unit)
...
| C5_dimension_Q37 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Retout_2020_table_5:row5:col5'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_emicizumab/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Retout_2020` / `Retout_2020::6_mg_kg_q4w`)
- model: `../../../knowledgebase/drugs/drug_emicizumab/models/modelica/_needs_review/Emicizumab_Retout2020_6_mg_kg_q4w.mo`
- deviation: `../../../knowledgebase/drugs/drug_emicizumab/models/modelica/_needs_review/Emicizumab_Retout2020_6_mg_kg_q4w.deviation.json`
