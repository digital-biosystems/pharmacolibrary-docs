...
|---|---|---|---|---|---|---|---|---|---|---|
| V/F clozapine | `Q76` · V/F | —(suppressed) | L | — | L | not captured | boundary (0.8) | Reeves_2024:results_prose | — | not captured |
| βSmoker CL/F clozapine | `Q27` · CL/F | —(suppressed) | not captured | — | L/h | not captured | boundary (0.8) | Reeves_2024:other_prose | — | not captured |
