...
## Citation
Cuny G; Royer RJ; Mur JM; Serot JM; Faure G; Netter P; et al. et al. (1979). Gerontology 25
...
|---|---|---|---|---|---|---|---|---|---|---|
| elimination half-time | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Cuny_1979:abstract, Cuny_1979:abstract | — | not captured |
| volume of distribution | `Q61` · V | —(suppressed) | liters | — | [l] | not captured | exact (1.0) | Cuny_1979:abstract, Cuny_1979:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Cuny_1979_metadata.yaml (4 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_acetylsalicylic_acid/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Cuny_1979` / `Cuny_1979::reference`)
