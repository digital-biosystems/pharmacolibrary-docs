<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;A01A&quot;,&quot;href&quot;:&quot;atc/A01A.md&quot;},{&quot;label&quot;:&quot;acetylsalicylic acid&quot;,&quot;href&quot;:&quot;drugs/drug_acetylsalicylic_acid/&quot;},{&quot;label&quot;:&quot;Koh_2025 \u00b7 review reference&quot;}]"></div>
...
> **Dose compound ≠ measured compound:** dosed `enteric-coated aspirin`, measured `acetylsalicylic_acid`.
...
## Model component
<dbs-pgx drug="acetylsalicylic acid" model-id="AcetylsalicylicAcid_Koh2025_reference" status="not_modelled" stale="false" population="healthy Korean subjects" measured-compound="acetylsalicylic_acid" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL m /F (L/h) | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | acetylsalicylic_acid:review | — | not captured |
| V 4 /F (L) | `Q76` · V/F | —(suppressed) | L | — | L | not captured | review (0.7) | acetylsalicylic_acid:review | — | not captured |
| Q/F (L/h) | `Q69` · Q/F | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | acetylsalicylic_acid:review | — | not captured |
| Lag 0 (h) | `Q83` · tlag | —(suppressed) | h | — | h | not captured | review (0.7) | acetylsalicylic_acid:review | — | not captured |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['acetylsalicylic_acid:review'] |
| C5_dimension_Q69 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['acetylsalicylic_acid:review'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['acetylsalicylic_acid:review'] |
| C5_dimension_Q83 | pass | [time] | not captured | not captured | not captured | ['acetylsalicylic_acid:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 2.76 | not captured | not captured | ['acetylsalicylic_acid:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_acetylsalicylic_acid/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Koh_2025` / `Koh_2025::review reference`)
...
<img src="drugs/drug_acetylsalicylic_acid/AcetylsalicylicAcid_Koh2025_reference/AcetylsalicylicAcid_Koh2025_reference.svg" alt="AcetylsalicylicAcid_Koh2025_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
