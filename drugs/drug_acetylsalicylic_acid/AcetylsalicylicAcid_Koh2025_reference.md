...
## Model component
<dbs-pgx drug="acetylsalicylic acid" model-id="AcetylsalicylicAcid_Koh2025_reference" status="extracted" stale="false" population="healthy Korean subjects" measured-compound="acetylsalicylic_acid" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL m /F (L/h) | `Q22` · CL | 2.76 | L/h | 7.666666666666666e-07 | L/h | not captured | review (0.7) | acetylsalicylic_acid:review | — | not captured |
| V 4 /F (L) | `Q76` · V/F | 7.5 | L | 0.0075 | L | not captured | review (0.7) | acetylsalicylic_acid:review | — | not captured |
| Q/F (L/h) | `Q69` · Q/F | 0.08 | L/h | 2.2222222222222224e-08 | L/h | not captured | review (0.7) | acetylsalicylic_acid:review | — | not captured |
| Lag 0 (h) | `Q83` · tlag | 2.81 | h | 10116.0 | h | not captured | review (0.7) | acetylsalicylic_acid:review | — | not captured |
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_acetylsalicylic_acid/AcetylsalicylicAcid_Koh2025_reference/AcetylsalicylicAcid_Koh2025_reference_fmi.zip" download>AcetylsalicylicAcid_Koh2025_reference_fmi.zip</a> <span class="pk-size">(1.2 MB)</span></td></tr>
