...
<sub>Template `PK_2C` · parameters `AcetylsalicylicAcid_Koh2025_reference_params.json` · controls `AcetylsalicylicAcid_Koh2025_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
