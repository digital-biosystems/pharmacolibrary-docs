...
# activated partial thromboplastin time — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.727). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q306]` | 47.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q338]` | not captured | 47.5 | only_one_extracted |
