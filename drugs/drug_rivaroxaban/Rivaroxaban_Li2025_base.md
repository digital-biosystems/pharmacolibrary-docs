...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[tvcl].rse_percent` (not captured vs 2.40) and 2 more field(s) — a structural parameter, so the record is disputed.
...
## Model component
<dbs-pgx drug="rivaroxaban" model-id="Rivaroxaban_Li2025_base" status="model_quarantined" stale="false" population="elderly Chinese patients with non-valvular atrial fibrillation" measured-compound="rivaroxaban" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| tvV(L) | `Q61` · V | 30.703 | L | 0.030703 | [l] | not captured | tv_prefix (0.95) | Li_2025_table_p6_1:row1:col1 | — | not captured |
| tvCL | `Q900` · tvCL | 4.165 | L/h | 1.1569444444444445e-06 | not captured | not captured | not captured (not captured) | Li_2025_table_p6_1:row2:col1 | — | not captured |
...
- model-stage split: 'base model results estimate (rse %)' is the base model of Li_2025 (paper reports 2 stages: base model results estimate (rse %), final model results estimate (rse %) [shrinkage]); same population, different model-building step
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[tvcl].rse_percent` | not captured | 2.40 | mismatch |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Li_2025_table_p6_1:row2:col1'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Li_2025:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Li_2025_table_p6_1:row1:col1'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q61 | pass | volume within physiological range | 30.7 L | not captured | not captured | ['Li_2025_table_p6_1:row1:col1'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_rivaroxaban/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Li_2025` / `Li_2025::base`)
- model: `../../../knowledgebase/drugs/drug_rivaroxaban/models/modelica/_needs_review/Rivaroxaban_Li2025_base.mo`
- deviation: `../../../knowledgebase/drugs/drug_rivaroxaban/models/modelica/_needs_review/Rivaroxaban_Li2025_base.deviation.json`
