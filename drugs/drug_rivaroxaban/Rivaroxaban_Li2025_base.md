...
|---|---|---|---|---|---|---|---|---|---|---|
| tvV(L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | tv_prefix (0.95) | Li_2025_table_p6_1:row1:col1 | — | not captured |
| tvCL | `Q900` · tvCL | —(suppressed) | L/h | — | not captured | not captured | not captured (not captured) | Li_2025_table_p6_1:row2:col1 | — | not captured |
