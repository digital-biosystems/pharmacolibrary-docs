...
|---|---|---|---|---|---|---|---|---|---|---|
| tvV(L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | tv_prefix (0.95) | Li_2025_table_p6_1:row1:col2 | — | not captured |
| dCLamiodarone | `Q900` · equation variable | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Li_2025_table_p6_1:row4:col2 | — | not captured |
