...
## Citation
Cheng A; Peng Z; Hong Z et al. (1999). Hua xi yi ke da xue xue bao = Journal of West China University of Medical Sciences = Huaxi yike daxue xuebao 30

## Model component
<dbs-pgx drug="teniposide" model-id="Teniposide_Cheng1999_patients_with_ovarian_cancer" status="rejected" stale="false" population="patients with ovarian cancer" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_teniposide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Cheng_1999` / `Cheng_1999::patients with ovarian cancer`)
