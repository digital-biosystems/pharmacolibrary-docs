...
## Citation
Chan P; Ding HT; Liederer BM; Mao J; Belloni P; Chen L; Gao SS; Joseph V; Yang X; Lin JS; Mitra MS; Putnam WS; Quartino A; Bauer RN; Pan L et al. (2021). Clinical and translational science 14
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | GDC-0334 | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q19]` | 9140 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 2030 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 849 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 1480 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 568 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 291 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 270 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q44]` | 80.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q44]` | 68.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q44]` | 85.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 6.00 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 0.417 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 0.833 | not captured | only_one_extracted |
...
---
<sub>← back to [erenumab](drugs/drug_erenumab/)</sub>
