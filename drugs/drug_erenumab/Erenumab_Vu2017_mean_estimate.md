...
| Absorption rate (ka) | `Q49` · kabs | 0.432 | ka | not captured | [ka] | not captured | exact (1.0) | Tab3:row5:col2 | — | 59.5 (None% RSE) |
...
| Internalization rate (kint) | `Q334` · kint | 0.0345 | kint | not captured | [kint] | not captured | llm (0.6) | Tab3:row10:col2 | — | 42.3 (None% RSE) |
