...
**Why:** the simulated model does not reproduce a value the paper reports. Evidence: T1_cmax — expected 2.8769999999999997e-05 — got 6.434983266294248e-05 — ratio 2.2367; T1_cmax — expected 0.00011395999999999999 — got 6.434983266294248e-05 — ratio 0.5647; T1_t_half_terminal — expected 6.77 — got 2.9552303606533266 — ratio 0.4365; T1_cmax — expected 2.8769999999999997e-05 — got 6.434983266294248e-05 — ratio 2.2367
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl/f].value` | 292 | 281 | mismatch |
| `gpt-oss:120b` | `parameters[ka].value` | 1.83 | 1.89 | mismatch |
| `gpt-oss:120b` | `parameters[q/f].value` | 73.2 | 64.8 | mismatch |
| `gpt-oss:120b` | `parameters[vc/f].value` | 1056 | 1009 | mismatch |
| `gpt-oss:120b` | `parameters[vp/f].value` | 1061 | 914 | mismatch |
...
- model: `../../../knowledgebase/drugs/drug_simvastatin/models/modelica/Simvastatin_Kim2021_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_simvastatin/models/modelica/Simvastatin_Kim2021_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_simvastatin/models/modelica/Simvastatin_Kim2021_reference.json`
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_simvastatin/Simvastatin_Kim2021_reference/Simvastatin_Kim2021_reference.svg" alt="Simvastatin_Kim2021_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_2C_enteral` · parameters `Simvastatin_Kim2021_reference_params.json` · controls `Simvastatin_Kim2021_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
