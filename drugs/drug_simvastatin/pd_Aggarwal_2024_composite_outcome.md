...
# ASCVD events and all-cause mortality — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Aggarwal SK; Jiang L; Liu G; Grabowska ME; Ong HH; Wilke RA; et al. et al. (2024). JACC. Advances 3
  ·  DOI: [10.1016/j.jacadv.2024.100894](https://doi.org/10.1016/j.jacadv.2024.100894)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | atorvastatin, simvastatin, rosuvastatin | not captured | mismatch |
