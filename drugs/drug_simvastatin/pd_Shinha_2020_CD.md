...
# Cell density — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Shinha K; Nihei W; Ono T; Nakazato R; Kimura H et al. (2020). Biomicrofluidics 14
  ·  DOI: [10.1063/5.0011545](https://doi.org/10.1063/5.0011545)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | SN-38 | not captured | mismatch |
