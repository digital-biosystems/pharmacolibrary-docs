<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;A10B&quot;,&quot;href&quot;:&quot;atc/A10B.md&quot;},{&quot;label&quot;:&quot;simvastatin&quot;,&quot;href&quot;:&quot;drugs/drug_simvastatin/&quot;},{&quot;label&quot;:&quot;Ogungbenro_2019 \u00b7 base&quot;}]"></div>
...
|---|---|---|---|---|---|---|---|---|---|---|
| D2 (h−1) | `Q310` · D1 | 0.34 | h−1 | not captured | [1] / [h] | not captured | llm (0.6) | Tab1:row3:col2 | — | not captured |
| ka1 (h−1) | `Q49` · kabs | 0.027 | h−1 | 7.5e-06 | [1] / [h] | not captured | llm (0.6) | Tab1:row4:col2 | — | not captured |
| ka2 (h−1) | `Q302` · k21 | 0.38 | h−1 | 0.00010555555555555555 | [1] / [h] | not captured | llm (0.6) | Tab1:row5:col2 | — | not captured |
| BA* | `Q900` · equation variable | 0.70 | not captured | not captured | not captured | not captured | llm (0.6) | Tab1:row6:col2 | — | not captured |
| ALAG (h) | `Q83` · tlag | 0.17 | h | 612.0 | [h] | not captured | exact (1.0) | Tab1:row7:col2 | — | not captured |
| CLSLe/F (L/h) | `Q27` · CL/F | 1210 | L/h | 0.0003361111111111111 | [l] / [h] | not captured | llm (0.6) | Tab1:row8:col2 | — | not captured |
| VSL/F (L) | `Q76` · V/F | 98.7 | L | 0.09870000000000001 | [l] | not captured | llm (0.6) | Tab1:row9:col2 | — | not captured |
| SVA | `Q61` · V | 0.043 | not captured | not captured | not captured | not captured | llm (0.6) | Tab1:row10:col2, Tab1:row10:col3, Tab1:row32:col2, Tab1:row32:col3 | — | not captured |
| CLHSVHSVA/VHSVA (h−1) | `Q22` · CL | 0.52 | h−1 | not captured | [1] / [h] | not captured | llm (0.6) | Tab1:row20:col2 | — | not captured |
| CLDHSe/VDHSV (h−1) | `Q47` · kel | 12.3 | h−1 | 0.003416666666666667 | [1] / [h] | not captured | llm (0.6) | Tab1:row24:col2 | — | not captured |
| age3_age_fra_on_cldhse | `Q900` · age3_age_fra_on_cldhse | 0.83 | not captured | not captured | not captured | not captured | not captured (not captured) | Tab1:row25:col2 | — | not captured |
