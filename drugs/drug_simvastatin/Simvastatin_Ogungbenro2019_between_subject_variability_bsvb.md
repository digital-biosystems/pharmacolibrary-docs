...
## Model component
<dbs-pgx drug="simvastatin" model-id="Simvastatin_Ogungbenro2019_between_subject_variability_bsvb" status="rejected" stale="false" population="children and adolescents" measured-compound="simvastatin" parameterization="apparent" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| D2 (h−1) | `Q310` · D1 | 1.75 | h−1 | not captured | [1] / [h] | not captured | llm (0.6) | Tab1:row3:col4 | — | not captured |
| ka2 (h−1) | `Q302` · k21 | 0.38 | h−1 | 0.00010555555555555555 | [1] / [h] | not captured | llm (0.6) | Tab1:row5:col4 | — | not captured |
| ALAG (h) | `Q83` · tlag | 1.40 | h | 5040.0 | [h] | not captured | exact (1.0) | Tab1:row7:col4 | — | not captured |
| CLSLe/F (L/h) | `Q27` · CL/F | 0.53 | L/h | 1.4722222222222225e-07 | [l] / [h] | not captured | llm (0.6) | Tab1:row8:col4 | — | not captured |
| VSL/F (L) | `Q76` · V/F | 1.59 | L | 0.00159 | [l] | not captured | llm (0.6) | Tab1:row9:col4 | — | not captured |
| SVA | `Q61` · V | 0.76 | BSVb | not captured | [bsvb] | not captured | llm (0.6) | Tab1:row10:col5 | — | not captured |
| CLHSVHSVA/VHSVA (h−1) | `Q22` · CL | 0.45 | h−1 | not captured | [1] / [h] | not captured | llm (0.6) | Tab1:row20:col4 | — | not captured |
| CLDHSe/VDHSV (h−1) | `Q47` · kel | 0.22 | h−1 | 6.111111111111111e-05 | [1] / [h] | not captured | llm (0.6) | Tab1:row24:col4 | — | not captured |
...
- dropped duplicate Q27 ('CLSVAe/VSVA (h−1)', value '0.60') — already have one for this compound
- dropped unlinked row (NIL): 'HMSV' — extend the ontology if this is a real PK parameter (source ['Tab1:row14:col5'])
- dropped unlinked row (NIL): 'CLEC50 (nM)' — extend the ontology if this is a real PK parameter (source ['Tab1:row16:col4'])
- dropped unlinked row (NIL): 'HMSVA' — extend the ontology if this is a real PK parameter (source ['Tab1:row18:col5'])
- unit_dimension_mismatch: 'CLHSVAe/VHSVA (h−1)' → Q27 (unit '1 / [time]' vs ontology '[length] ** 3 / [time]') — route to review
- dropped duplicate Q27 ('CLHSVAe/VHSVA (h−1)', value '0.12') — already have one for this compound
- unit_dimension_mismatch: 'CLHSVHSVA/VHSVA (h−1)' → Q22 (unit '1 / [time]' vs ontology '[length] ** 3 / [time]') — route to review
- dropped unlinked row (NIL): 'DHSV' — extend the ontology if this is a real PK parameter (source ['Tab1:row23:col5'])
- dropped unlinked row (NIL): 'SV' — extend the ontology if this is a real PK parameter (source ['Tab1:row28:col4', 'Tab1:row28:col5'])
...
- population split: 'between subject variability (bsvb)' subgroup of Ogungbenro_2019 (paper reports 3 populations: between subject variability (bsvb), parameters, structural model)
...
| C5_dimension_Q22 | fail | 1 / [time] | h−1 | not captured | not captured | ['Tab1:row20:col4'] |
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tab1:row8:col4'] |
| C5_dimension_Q302 | pass | 1 / [time] | not captured | not captured | not captured | ['Tab1:row5:col4'] |
| C5_dimension_Q310 | fail | 1 / [time] | h−1 | not captured | not captured | ['Tab1:row3:col4'] |
| C5_dimension_Q47 | pass | 1 / [time] | not captured | not captured | not captured | ['Tab1:row24:col4'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Jadhav_2023:review'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Tab1:row9:col4'] |
| C5_dimension_Q83 | pass | [time] | not captured | not captured | not captured | ['Tab1:row7:col4'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q27 | pass | clearance within physiological range | 0.53 L/h | not captured | not captured | ['Tab1:row8:col4'] |
| C9_phys_window_Q76 | pass | volume within physiological range | 1.59 L | not captured | not captured | ['Tab1:row9:col4'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_simvastatin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ogungbenro_2019` / `Ogungbenro_2019::between_subject_variability_bsvb`)
