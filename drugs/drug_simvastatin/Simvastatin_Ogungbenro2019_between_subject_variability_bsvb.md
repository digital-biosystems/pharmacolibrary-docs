...
|---|---|---|---|---|---|---|---|---|---|---|
| D2 (h−1) | `Q310` · D1 | —(suppressed) | h−1 | — | [1] / [h] | not captured | llm (0.6) | Tab1:row3:col4 | — | not captured |
| ka2 (h−1) | `Q302` · k21 | —(suppressed) | h−1 | — | [1] / [h] | not captured | llm (0.6) | Tab1:row5:col4 | — | not captured |
| ALAG (h) | `Q83` · tlag | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Tab1:row7:col4 | — | not captured |
| CLSLe/F (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | [l] / [h] | not captured | llm (0.6) | Tab1:row8:col4 | — | not captured |
| VSL/F (L) | `Q76` · V/F | —(suppressed) | L | — | [l] | not captured | llm (0.6) | Tab1:row9:col4 | — | not captured |
| SVA | `Q61` · V | —(suppressed) | BSVb | — | [bsvb] | not captured | llm (0.6) | Tab1:row10:col5 | — | not captured |
| CLHSVHSVA/VHSVA (h−1) | `Q22` · CL | —(suppressed) | h−1 | — | [1] / [h] | not captured | llm (0.6) | Tab1:row20:col4 | — | not captured |
| CLDHSe/VDHSV (h−1) | `Q47` · kel | —(suppressed) | h−1 | — | [1] / [h] | not captured | llm (0.6) | Tab1:row24:col4 | — | not captured |
