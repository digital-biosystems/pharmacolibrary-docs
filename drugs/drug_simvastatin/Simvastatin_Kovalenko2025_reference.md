...
- built from REVIEW reference values (Kovalenko_2025) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Kovalenko_2025:review'] |
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Kovalenko_2025:review'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Kovalenko_2025:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Kovalenko_2025:review'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Kovalenko_2025:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 0.131 | not captured | not captured | ['Kovalenko_2025:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.00546 L/h | not captured | not captured | ['Kovalenko_2025:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 1.64 L | not captured | not captured | ['Kovalenko_2025:review'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 1.14 L | not captured | not captured | ['Kovalenko_2025:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_simvastatin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kovalenko_2025` / `Kovalenko_2025::reference`)
- model: `../../../knowledgebase/drugs/drug_simvastatin/models/modelica/Simvastatin_Kovalenko2025_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_simvastatin/models/modelica/Simvastatin_Kovalenko2025_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_simvastatin/models/modelica/Simvastatin_Kovalenko2025_reference.json`
...
<img src="drugs/drug_simvastatin/Simvastatin_Kovalenko2025_reference/Simvastatin_Kovalenko2025_reference.svg" alt="Simvastatin_Kovalenko2025_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_simvastatin/Simvastatin_Kovalenko2025_reference/Simvastatin_Kovalenko2025_reference_sbml.zip" download>Simvastatin_Kovalenko2025_reference_sbml.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_simvastatin/Simvastatin_Kovalenko2025_reference/Simvastatin_Kovalenko2025_reference_cellml.zip" download>Simvastatin_Kovalenko2025_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
...
<sub>Template `PK_2C_enteral` · parameters `Simvastatin_Kovalenko2025_reference_params.json` · controls `Simvastatin_Kovalenko2025_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
