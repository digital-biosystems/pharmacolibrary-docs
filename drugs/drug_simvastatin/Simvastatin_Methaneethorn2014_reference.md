...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka(N) | `Q49` · kabs | 0.7 | h -1 | 0.00019444444444444443 | 1/h | not captured | exact (1.0) | Methaneethorn_2014:results_prose | — | not captured |
| VD(N) | `Q61` · V | 161.12 | L | 0.16112 | L | not captured | exact (1.0) | Methaneethorn_2014:results_prose | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_simvastatin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Methaneethorn_2014` / `Methaneethorn_2014::reference`)
