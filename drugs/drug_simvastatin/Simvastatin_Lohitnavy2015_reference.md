...
**Second reading:** `gpt-oss:120b` read this paper differently on `screen.dose_compound` (simvastatin, itraconazole vs simvastatin) — a structural parameter, so the record is disputed.
**How to address:** Check _transcribev2.yaml for the parameter: if the paper's table carries the number, the interpret stage dropped it — re-run interpret and validate for the drug, then the engineer.
<sub>owner: **scholar**</sub>

## Citation
Lohitnavy M; Methaneethorn J; Chiang-Ngernthanyakool R; Tongpeng W; Chan-Im D; Phaohorm S et al. (2015). Annual International Conference of the IEEE Engineering in Medicine and Biology Society. IEEE Engineering in Medicine and Biology Society. Annual International Conference 2015
  ·  DOI: [10.1109/EMBC.2015.7319084](https://doi.org/10.1109/EMBC.2015.7319084)

## Model component
<dbs-pgx drug="simvastatin" model-id="Simvastatin_Lohitnavy2015_reference" status="model_quarantined" stale="false" population="healthy adults" measured-compound="simvastatin" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
...
- dropped unlinked row (NIL): 'Itraconazole' — extend the ontology if this is a real PK parameter (source ['Lohitnavy_2015_table_p3_1:row0:col2', 'Lohitnavy_2015_table_p3_1:row1:col2', 'Lohitnavy_2015_table_p3_1:row2:col2', 'Lohitnavy_2015_table_p3_1:row3:col2', 'Lohitnavy_2015_table_p3_1:row4:col2', 'Lohitnavy_2015_table_p3_1:row5:col2', 'Lohitnavy_2015_table_p3_1:row6:col2', 'Lohitnavy_2015_table_p3_1:row7:col2', 'Lohitnavy_2015_table_p3_1:row8:col2', 'Lohitnavy_2015_table_p3_1:row9:col2'])
- dropped unlinked row (NIL): 'Simvastatin' — extend the ontology if this is a real PK parameter (source ['Lohitnavy_2015_table_p3_1:row10:col2', 'Lohitnavy_2015_table_p3_1:row11:col2', 'Lohitnavy_2015_table_p3_1:row12:col2', 'Lohitnavy_2015_table_p3_1:row13:col2', 'Lohitnavy_2015_table_p3_1:row14:col2', 'Lohitnavy_2015_table_p3_1:row15:col2', 'Lohitnavy_2015_table_p3_1:row16:col2', 'Lohitnavy_2015_table_p3_1:row17:col2'])
- dropped unlinked row (NIL): 'Itraconazole + Simvastatin' — extend the ontology if this is a real PK parameter (source ['Lohitnavy_2015_table_p3_1:row19:col2'])
...
**Extraction notes:**
- unparsed cell Lohitnavy_2015_table_p3_1:row1:col1 = 'K10 (h⁻¹)'
- unparsed cell Lohitnavy_2015_table_p3_1:row2:col1 = 'K12 (h⁻¹)'
- unparsed cell Lohitnavy_2015_table_p3_1:row3:col1 = 'K21 (h⁻¹)'
- unparsed cell Lohitnavy_2015_table_p3_1:row4:col1 = 'VD1(ITZ) (L)'
- unparsed cell Lohitnavy_2015_table_p3_1:row5:col1 = 'VD2(ITZ) (L)'
- unparsed cell Lohitnavy_2015_table_p3_1:row6:col1 = 'KGI1 (h⁻¹)'
- unparsed cell Lohitnavy_2015_table_p3_1:row7:col1 = 'KGI2 (h⁻¹)'
- unparsed cell Lohitnavy_2015_table_p3_1:row8:col1 = 'KGI12 (h⁻¹)'
- unparsed cell Lohitnavy_2015_table_p3_1:row9:col1 = 'KGI20 (h⁻¹)'
...
|---|---|---|---|---|
| `gpt-oss:120b` | `screen.dose_compound` | simvastatin, itraconazole | simvastatin | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_simvastatin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Lohitnavy_2015` / `Lohitnavy_2015::reference`)
- model: `../../../knowledgebase/drugs/drug_simvastatin/models/modelica/_needs_review/Simvastatin_Lohitnavy2015_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_simvastatin/models/modelica/_needs_review/Simvastatin_Lohitnavy2015_reference.deviation.json`
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_simvastatin/Simvastatin_Lohitnavy2015_reference/Simvastatin_Lohitnavy2015_reference_matlab.zip" download>Simvastatin_Lohitnavy2015_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_simvastatin/Simvastatin_Lohitnavy2015_reference/Simvastatin_Lohitnavy2015_reference_matlab_simbio.zip" download>Simvastatin_Lohitnavy2015_reference_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_simvastatin/Simvastatin_Lohitnavy2015_reference/Simvastatin_Lohitnavy2015_reference_sbml.zip" download>Simvastatin_Lohitnavy2015_reference_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_simvastatin/Simvastatin_Lohitnavy2015_reference/Simvastatin_Lohitnavy2015_reference_cellml.zip" download>Simvastatin_Lohitnavy2015_reference_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-23 03:51 UTC</sub>
