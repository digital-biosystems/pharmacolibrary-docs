...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka (h -1 ) | `Q49` · kabs | 0.6 | h -1 | 0.00016666666666666666 | 1/h | not captured | exact (1.0) | Methaneethorn_2014_2:results_prose | — | not captured |
| VD(S) (L) | `Q61` · V | 150 | L | 0.15 | L | not captured | space_fold (0.95) | Methaneethorn_2014_2:results_prose | — | not captured |
...
- dropped unlinked row (NIL): 'SIMVASTATIN (S)' — extend the ontology if this is a real PK parameter (source ['Methaneethorn_2014_2_table_1:row0:col2', 'Methaneethorn_2014_2_table_1:row1:col2', 'Methaneethorn_2014_2_table_1:row2:col2', 'Methaneethorn_2014_2_table_1:row3:col2', 'Methaneethorn_2014_2_table_1:row4:col2', 'Methaneethorn_2014_2_table_1:row5:col2', 'Methaneethorn_2014_2_table_1:row6:col2', 'Methaneethorn_2014_2_table_1:row7:col2'])
- dropped unlinked row (NIL): 'S + V' — extend the ontology if this is a real PK parameter (source ['Methaneethorn_2014_2_table_1:row8:col2', 'Methaneethorn_2014_2_table_1:row9:col2', 'Methaneethorn_2014_2_table_1:row10:col2'])
- dropped unlinked row (NIL): 'VERAPAMIL (V)' — extend the ontology if this is a real PK parameter (source ['Methaneethorn_2014_2_table_1:row11:col2', 'Methaneethorn_2014_2_table_1:row12:col2', 'Methaneethorn_2014_2_table_1:row13:col2', 'Methaneethorn_2014_2_table_1:row14:col2', 'Methaneethorn_2014_2_table_1:row15:col2', 'Methaneethorn_2014_2_table_1:row16:col2', 'Methaneethorn_2014_2_table_1:row17:col2', 'Methaneethorn_2014_2_table_1:row18:col2', 'Methaneethorn_2014_2_table_1:row19:col2', 'Methaneethorn_2014_2_table_1:row20:col2', 'Methaneethorn_2014_2_table_1:row21:col2', 'Methaneethorn_2014_2_table_1:row22:col2', 'Methaneethorn_2014_2_table_1:row23:col2', 'Methaneethorn_2014_2_table_1:row24:col2'])
- salvaged Q49 ('Ka (h -1 )'=0.6) from results prose — parameter table was unreadable
- salvaged Q61 ('VD(S) (L)'=150) from results prose — parameter table was unreadable
- apparent-by-design (ADVISORY, codes unchanged): extravascular dosing with no identifiable F, so these reported disposition parameters are likely apparent unless the model puts first-pass in its structure — Q61 (VD(S) (L))
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model.links` | [['simvastatin', 'simvastatin hydroxy acid', 'metabolism'], ['verapamil', 'norverapamil', 'metabolism']] | [['verapamil', 'norverapamil', 'metabolism'], ['simvastatin', 'simvastatin hydroxy acid', 'hydrolysis']] | mismatch |
...
| `gpt-oss:120b` | `screen.dose_compound` | simvastatin | verapamil and simvastatin | mismatch |
| `gpt-oss:120b` | `screen.primary_analyte` | simvastatin | simvastatin hydroxy acid | mismatch |
...
| C9_phys_window_Q61 | pass | volume within physiological range | 150 L | not captured | not captured | ['Methaneethorn_2014_2:results_prose'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_simvastatin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Methaneethorn_2014_2` / `Methaneethorn_2014_2::reference`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-23 03:54 UTC</sub>
