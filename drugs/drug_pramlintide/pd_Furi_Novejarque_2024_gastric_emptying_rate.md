...
## Citation
Furió-Novejarque C; Sala-Mira I; Díez JL; Bondia J et al. (2024). Computer methods and programs in biomedicine 244
...
| `gpt-oss:120b` | `parameters[Q301]` | 0.1667 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 0.0974 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | 0.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | 0.0322 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 31.549 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q99]` | 0.0109 | not captured | only_one_extracted |
...
---
<sub>← back to [pramlintide](drugs/drug_pramlintide/)</sub>
