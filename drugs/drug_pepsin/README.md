...
**Description.** Pepsin is a potent enzyme in gastric juice that digests proteins such as those in meat, eggs, seeds, and dairy products [L2358].

Studies on gastric digestion from 1820-1840 led to the discovery of pepsin as the substance which, in the presence of stomach acid, causes nutrients including meat or coagulated egg whites to dissolve. Soon afterward, it was shown that these protein nutrients were cleaved by pepsin to products called _peptones_ [A32603].

Pepsin is often used as a replacement enzyme for those with pancreatic insufficiency [L2357]. Stimulation of the pancreas and therefore enzymatic digestion of food is a tightly controlled and is a hormonally mediated process. Any changes or conditions affecting metabolic steps for successful digestion and absorption negatively affect pancreatic enzymatic secretion, entry into the intestine, functionality once inside the intestine, and appropriate mixing with foods/nutrients. Many causes of pancreatic insufficiency require that enzyme replacement therapy is started, including cystic fibrosis, pancreatic cancer, acute and chronic pancreatitis, as well as pancreatic surgery [L2357].

Pepsin is approved by the FDA and is used in food at levels not to exceed current good manufacturing practice [L2363].
Interestingly, it has been used as a marker for laryngopharyngeal reflux (LPR), which is a common illness of otolaryngology (ear, nose and throat specialist) visits [A32604].

Interestingly, recent research has suggested that pepsin participates in the digestion of nucleic acids [L2391].

**Indication.** Used as a pancreatic enzyme replacement in pancreatic insufficiency [L2357].  It is intended to mimic naturally produced human pepsin [L2360].

Pepsin powder is prepared from the gastric mucosa of pigs, cattle or sheep [L2367]. In the laboratory, it is primarily used for the unspecific hydrolysis of proteins and peptides in acidic media. In addition, it provides limited hydrolysis of native immunoglobulins, yielding biologically active fragments [L2353].

In certain supplements, pepsin may be combined with betaine and HCl (hydrochloric acid) to aid in digestion in various gastrointestinal conditions [L2360], [L2352].

## Extraction summary

| extracted at | time | popPK e/r/o | PD e/r/o (paper) | PGx e/r/o | tokens in/out | LLM | papers | GROBID/JATS | OA/non-OA | NONMEM |
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-14 17:32 | 43:49 | 0/0/0 | 7/2/0 | 0/0/0 | 531,512/10,304 | ollama / qwen3.8:27b-mtp-q8_0 | 34 | 0/0 | 33/1 | 0 |
...
|---|---|---|---|
| <span class="pk-badge pk-badge--green">extracted</span> | [Azhagesan_2025](drugs/drug_pepsin/pd_Azhagesan_2025_pancreatic_amylase_activity.md) | Azhagesan A et al., Exposure of Polystyrene Micro- and Nano…, ACS omega (2025) | [10.1021/acsomega.4c07974](https://doi.org/10.1021/acsomega.4c07974) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Azhagesan_2025](drugs/drug_pepsin/pd_Azhagesan_2025_pancreatic_protease_activity.md) | Azhagesan A et al., Exposure of Polystyrene Micro- and Nano…, ACS omega (2025) | [10.1021/acsomega.4c07974](https://doi.org/10.1021/acsomega.4c07974) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Azhagesan_2025](drugs/drug_pepsin/pd_Azhagesan_2025_pepsin_activity.md) | Azhagesan A et al., Exposure of Polystyrene Micro- and Nano…, ACS omega (2025) | [10.1021/acsomega.4c07974](https://doi.org/10.1021/acsomega.4c07974) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Azhagesan_2025](drugs/drug_pepsin/pd_Azhagesan_2025_salivary_amylase_activity.md) | Azhagesan A et al., Exposure of Polystyrene Micro- and Nano…, ACS omega (2025) | [10.1021/acsomega.4c07974](https://doi.org/10.1021/acsomega.4c07974) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Hu_2020](drugs/drug_pepsin/pd_Hu_2020_catalase.md) | Hu XM et al., Antioxidant Peptides from the Protein H…, Marine drugs (2020) | [10.3390/md18030153](https://doi.org/10.3390/md18030153) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Hu_2020](drugs/drug_pepsin/pd_Hu_2020_cell_viability.md) | Hu XM et al., Antioxidant Peptides from the Protein H…, Marine drugs (2020) | [10.3390/md18030153](https://doi.org/10.3390/md18030153) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Hu_2020](drugs/drug_pepsin/pd_Hu_2020_glutathione_peroxidase.md) | Hu XM et al., Antioxidant Peptides from the Protein H…, Marine drugs (2020) | [10.3390/md18030153](https://doi.org/10.3390/md18030153) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Hu_2020](drugs/drug_pepsin/pd_Hu_2020_malondialdehyde.md) | Hu XM et al., Antioxidant Peptides from the Protein H…, Marine drugs (2020) | [10.3390/md18030153](https://doi.org/10.3390/md18030153) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Hu_2020](drugs/drug_pepsin/pd_Hu_2020_reactive_oxygen_species.md) | Hu XM et al., Antioxidant Peptides from the Protein H…, Marine drugs (2020) | [10.3390/md18030153](https://doi.org/10.3390/md18030153) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Hu_2020](drugs/drug_pepsin/pd_Hu_2020_superoxide_dismutase.md) | Hu XM et al., Antioxidant Peptides from the Protein H…, Marine drugs (2020) | [10.3390/md18030153](https://doi.org/10.3390/md18030153) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Lingham_1992](drugs/drug_pepsin/pd_Lingham_1992_unknown.md) | Lingham RB et al., L-696,474, a novel cytochalasin as an i…, The Journal of antibiotics (1992) | [10.7164/antibiotics.45.686](https://doi.org/10.7164/antibiotics.45.686) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Mandalari_2019](drugs/drug_pepsin/pd_Mandalari_2019_plaque_reduction.md) | Mandalari G et al., Simulated human digestion of N1-aryl-2-…, PloS one (2019) | [10.1371/journal.pone.0216384](https://doi.org/10.1371/journal.pone.0216384) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Mandalari_2019](drugs/drug_pepsin/pd_Mandalari_2019_viral_DNA_load.md) | Mandalari G et al., Simulated human digestion of N1-aryl-2-…, PloS one (2019) | [10.1371/journal.pone.0216384](https://doi.org/10.1371/journal.pone.0216384) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Petruk_2023](drugs/drug_pepsin/pd_Petruk_2023_Hemolysis.md) | Petruk G et al., Targeting Toll-like receptor-driven sys…, Nature communications (2023) | [10.1038/s41467-023-41702-y](https://doi.org/10.1038/s41467-023-41702-y) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Petruk_2023](drugs/drug_pepsin/pd_Petruk_2023_IL_1.md) | Petruk G et al., Targeting Toll-like receptor-driven sys…, Nature communications (2023) | [10.1038/s41467-023-41702-y](https://doi.org/10.1038/s41467-023-41702-y) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Petruk_2023](drugs/drug_pepsin/pd_Petruk_2023_NF_B.md) | Petruk G et al., Targeting Toll-like receptor-driven sys…, Nature communications (2023) | [10.1038/s41467-023-41702-y](https://doi.org/10.1038/s41467-023-41702-y) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Petruk_2023](drugs/drug_pepsin/pd_Petruk_2023_TNF.md) | Petruk G et al., Targeting Toll-like receptor-driven sys…, Nature communications (2023) | [10.1038/s41467-023-41702-y](https://doi.org/10.1038/s41467-023-41702-y) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Sulyman_2023](drugs/drug_pepsin/pd_Sulyman_2023_PfPMV.md) | Sulyman AO et al., Bioprospection of Selected Plant Second…, BioMed research internation… (2023) | [10.1155/2023/6229503](https://doi.org/10.1155/2023/6229503) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Wang_2022](drugs/drug_pepsin/pd_Wang_2022_DPP_IV_inhibition.md) | Wang W et al., Identification and Characterization of…, Foods (Basel, Switzerland) (2022) | [10.3390/foods11101406](https://doi.org/10.3390/foods11101406) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Cígler_2005](drugs/drug_pepsin/pd_C_gler_2005_EC50.md) | Cígler P et al., From nonpeptide toward noncarbon protea…, Proceedings of the National… (2005) | [10.1073/pnas.0507577102](https://doi.org/10.1073/pnas.0507577102) |
...
<sub>queue written 2026-09-14T17:21:14.262819+00:00</sub>
...
| popPK | Alashi_2014 | irrelevant | 0 | 0 | The paper concerns antioxidant properties of canola meal protein hydrolysates and does not report pharmacokinetic parameters for pepsin. |
...
| popPK | Amer_2025 | irrelevant | 0 | 0 | The paper is a review on peptide delivery technologies and does not report any quantitative pharmacokinetic parameters for pepsin. |
...
| popPK | Arav_2024 | irrelevant | 0 | 0 | The paper is a review of modeling approaches for oral drug delivery and mentions pepsin only as a digestive enzyme involved in drug degradation, not as the subject drug for PK parameter estimation. |
...
| popPK | Arimboor_2011 | irrelevant | 0 | 0 | The paper describes an in vitro study on sea buckthorn proanthocyanidins inhibiting protein hydrolysis, not a pharmacokinetic study of pepsin. |
...
| popPK | Berends_2019 | irrelevant | 0 | 0 | The study focuses on infliximab pharmacokinetics and dried blood spot validation, not pepsin. |
...
| popPK | Busby_2010 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics and stability of linaclotide, using pepsin only as a reagent to test stability, not as the subject drug. |
...
| popPK | Charbonneau_2021 | irrelevant | 0 | 0 | The paper focuses on the pharmacokinetics of phenylalanine and the synthetic biotic SYNB1618, mentioning pepsin only as a physiological factor in gastric simulations, not as the subject drug. |
...
| PGx | Chernin_2004 | not_relevant | 0 | 0 | The paper describes clinicopathogenetic variants of chronic gastritis and measures pepsin levels as a biomarker of disease severity, but it does not report any pharmacogenomic effects (gene variants) on the pharmacokinetics or pharmacodynamics of pepsin as a drug. |
| popPK | Chi_2015 | irrelevant | 0 | 0 | The paper concerns the purification of antioxidant peptides from fish muscle and does not involve pepsin pharmacokinetics. |
...
| popPK | Chi_2015_2 | irrelevant | 0 | 0 | The paper is a food science study on antioxidant peptides from tuna hydrolysates where pepsin is used only as a hydrolyzing enzyme, not as a subject drug for pharmacokinetic analysis. |
...
| popPK | Cígler_2005 | irrelevant | 0 | 0 | The paper is a structural and mechanistic study of HIV protease inhibitors, and pepsin is only used as a comparator enzyme for selectivity testing, not as the subject drug for pharmacokinetic analysis. |
...
| popPK | EFSA_2020 | irrelevant | 0 | 0 | The paper is a risk assessment regarding post-mortem inspection delays in ungulates and does not contain any pharmacokinetic data or parameters for pepsin. |
...
| PGx | Geib_2021 | not_relevant | 0 | 0 | The paper describes an analytical method for quantifying acetaminophen protein binding and does not report pharmacogenomic effects on pepsin PK/PD parameters. |
| popPK | Gespach_1983 | irrelevant | 0 | 0 | The paper is a mechanistic study on cAMP regulation in gastric glands and does not report pharmacokinetic parameters for pepsin. |
...
| PGx | Geus_2000 | not_relevant | 0 | 0 | The paper discusses the clinical use of acid-inhibiting drugs for GI bleeding and mentions CYP2C19 dependence of PPIs, but it does not report a pharmacogenomic effect on the PK or PD parameters of pepsin. |
| popPK | Golombek_2020 | irrelevant | 0 | 0 | The paper is a review on the degradation of cannabidiol (CBD) into THC and does not involve pepsin or report any pharmacokinetic parameters. |
...
| popPK | Hagemeyer_2026 | irrelevant | 0 | 0 | The paper studies the pharmacokinetics and conformational behavior of griselimycin, not pepsin (which is only mentioned as a component of simulated gastric fluid). |
...
| popPK | Hoelzen_2025 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of niclosamide and its analogs, not pepsin, which is only mentioned as a component of the simulated gastric fluid. |
...
| popPK | Howden_2025 | irrelevant | 0 | 0 | The paper focuses on the relationship between gastric pH holding time and esophagitis healing rates for acid-suppressing drugs (PPIs, H2RAs, P-CABs), not the pharmacokinetics of pepsin. |
| popPK | Hu_2020 | irrelevant | 0 | 0 | The paper is a food science study on antioxidant peptides from monkfish muscle where pepsin is used only as a hydrolysis enzyme, not as the subject drug for pharmacokinetic analysis. |
| popPK | Iafelice_2007 | irrelevant | 0 | 0 | The paper is a biochemical study on haemoglobin PEGylation where pepsin is used only as a proteolytic enzyme for digestion, not as the subject drug for pharmacokinetic analysis. |
...
| popPK | Jin_2019 | irrelevant | 0 | 0 | The paper focuses on the preparation of antioxidant peptides from collagen, not the pharmacokinetics of the drug pepsin. |
...
| popPK | Kang_2023 | irrelevant | 0 | 0 | The paper focuses on glioblastoma radioresistance mechanisms involving DGKB and DGAT1, and does not involve pepsin or pharmacokinetic parameters. |
...
| popPK | Kao_1977 | irrelevant | 0 | 0 | The study focuses on the secretion kinetics of procollagen in tendon cells, using pepsin only as a diagnostic reagent for digestion, not as the subject drug for PK analysis. |
...
| popPK | Koush_2025 | irrelevant | 0 | 0 | The study focuses on indomethacin pharmacokinetics and pepsin is not the subject drug. |
...
| popPK | Lanas_1994 | irrelevant | 0 | 0 | The study focuses on the secretion of pepsinogen by isolated cells (in-vitro mechanism) rather than the pharmacokinetic disposition of pepsin as a drug. |
...
| popPK | Li_2024 | irrelevant | 0 | 0 | The study focuses on the chemical profiling and metabolite identification of the traditional Chinese medicine HuanShaoDan, using pepsin only as a reagent in artificial gastric juice, and does not report pharmacokinetic parameters for pepsin. |
...
| popPK | Liang_2019 | irrelevant | 0 | 0 | The paper is a food science study on the nutritional composition and antioxidant activity of Moringa oleifera seed polypeptides, using pepsin only as a hydrolysis enzyme, and contains no pharmacokinetic parameters for pepsin. |
...
| popPK | Lubkowicz_2022 | irrelevant | 0 | 0 | The paper studies an engineered bacterial therapeutic (SYNB8802) for hyperoxaluria and does not report pharmacokinetic parameters for the drug pepsin. |
| popPK | Ma_2023 | irrelevant | 0 | 0 | The study focuses on the diagnostic utility of salivary pepsin concentrations for GERD, not on the pharmacokinetic disposition parameters (CL, V, etc.) of pepsin as a drug. |
...
| popPK | Malamas_2010_2 | irrelevant | 0 | 0 | The paper focuses on the design of BACE1 inhibitors and mentions pepsin only as a selectivity comparator, containing no pharmacokinetic data for pepsin. |
...
| popPK | Malamas_2010_3 | irrelevant | 0 | 0 | The paper is a medicinal chemistry study on BACE1 inhibitors where pepsin is only mentioned as a comparator enzyme for selectivity, with no pharmacokinetic data reported. |
...
| popPK | Mandalari_2019 | irrelevant | 0 | 0 | The study investigates the in-vitro stability of synthetic compounds (NAABs) using pepsin as a digestive enzyme, rather than reporting pharmacokinetic parameters for pepsin itself. |
| popPK | Miljak_2026 | irrelevant | 0 | 0 | The study focuses on the formulation and stability of alpha lipoic acid, not pepsin, and contains no pharmacokinetic parameters for pepsin. |
...
| popPK | Orth_2025 | irrelevant | 0 | 0 | The paper investigates the ubiquitination of small molecule inhibitors by the ligase HUWE1 and does not involve the drug pepsin or report any pharmacokinetic parameters. |
| popPK | Papadopoulou_2025 | irrelevant | 0 | 0 | The paper is a review on marine bioactives for cosmetics and does not contain any pharmacokinetic data or parameters for pepsin. |
...
| popPK | Pappalardo_2024 | irrelevant | 0 | 0 | The paper is a review of in silico computational methods for receptor mutations and does not contain any pharmacokinetic data or parameters for pepsin. |
...
| popPK | Petruk_2023 | irrelevant | 0 | 0 | The paper studies the peptide sHVF18 (a thrombin-derived peptide mimic) for anti-inflammatory effects, not the drug pepsin, and contains no pharmacokinetic parameters for pepsin. |
...
| popPK | Qiu_2019 | irrelevant | 0 | 0 | The paper is a food science study on gelatin and antioxidant peptides from fish scales, where pepsin is used only as a protease for hydrolysis, not as a subject drug for pharmacokinetic analysis. |
...
| popPK | Roth_1986 | irrelevant | 0 | 0 | The paper concerns von Willebrand factor and collagen binding, not pepsin pharmacokinetics. |
...
| popPK | Schuligoi_2007 | irrelevant | 0 | 0 | The study focuses on the metabolism of Prostaglandin D2 (PGD2), and pepsin is only mentioned as a reagent used to digest serum, not as the subject drug for pharmacokinetic analysis. |
...
| popPK | Seed_2024 | irrelevant | 0 | 0 | The paper investigates PARP inhibitor resistance in prostate cancer via genomic sequencing and does not study the pharmacokinetics of pepsin. |
...
| popPK | Somasundaram_1987 | irrelevant | 0 | 0 | The study focuses on gastric mucosal defense mechanisms and mucus glycoproteins in rats, with pepsin mentioned only as an aggressive factor in the context of ulceration, not as a subject for pharmacokinetic analysis. |
...
| popPK | Wang_2013 | irrelevant | 0 | 0 | The paper is a food science study on antioxidant peptides where pepsin is used only as a hydrolysis enzyme, not as the subject drug for pharmacokinetic analysis. |
...
| popPK | Wu_2004 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of insulin-liposomes, with pepsin serving only as a digestive enzyme in the stability assessment, not as the subject drug. |
...
| popPK | Xu_2025 | irrelevant | 0 | 0 | The study focuses on the in silico and in vitro identification of hyperuricemia-inhibiting peptides from fish, not the pharmacokinetics of the drug pepsin. |
...
| popPK | Yang_2019 | irrelevant | 0 | 0 | The paper is a food science study on gelatin and antioxidant peptides from skipjack tuna bone, where pepsin is used only as an enzyme in an in-vitro digestion model, not as a subject drug for pharmacokinetic analysis. |
...
| popPK | Zhang_2019 | irrelevant | 0 | 0 | The paper is a food science study on antioxidant peptides from tuna, using pepsin only as a reagent for in-vitro hydrolysis, and reports no pharmacokinetic parameters for pepsin. |
...
| popPK | Zhang_2021 | irrelevant | 0 | 0 | The paper concerns antioxidant peptides from Antarctic Krill, not the pharmacokinetics of the drug pepsin. |
...
| popPK | Zhang_2024 | irrelevant | 0 | 0 | The study investigates alveolar nitric oxide in gastroesophageal reflux-associated cough and uses sputum pepsin concentration only as a biomarker for aspiration, not as a subject drug for pharmacokinetic analysis. |
...
| popPK | Zhou_2021 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of enrofloxacin, and pepsin is only mentioned as a reagent used in the in-vitro dissolution medium. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_pepsin`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
