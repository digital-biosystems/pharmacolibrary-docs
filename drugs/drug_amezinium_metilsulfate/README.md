...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-09 12:34 | 4:09 | 0/0/0 | 0/0/0 | 0/0/0 | 26,024/3,926 | ollama / qwen3.8:27b-mtp-q8_0 | 1 | 1/0 | 1/0 | 0 |
...
- **PubMed hits:** 8 matched, 20 returned
...
<sub>queue written 2026-09-09T12:34:31.110694+00:00</sub>
...
| popPK | Ishigooka_1999 | irrelevant | 0 | 0 | The study is an in-vitro pharmacodynamic investigation of bladder contractility and does not report any pharmacokinetic parameters. |
...
| popPK | Starke_1981 | irrelevant | 0 | 0 | The paper studies noradrenaline metabolism in guinea-pig atria and uses amezinium only as a tool compound to block uptake, not as the subject of a pharmacokinetic study. |
...
| popPK | Wilsmann_1981 | irrelevant | 2 | 0 | The study focuses on hemodynamic and pharmacodynamic effects (blood pressure, heart rate) rather than quantitative pharmacokinetic disposition parameters like clearance or volume of distribution. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_amezinium_metilsulfate`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
