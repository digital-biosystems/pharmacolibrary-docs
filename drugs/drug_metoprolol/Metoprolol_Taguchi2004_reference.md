...
- scholar stages: `../../../knowledgebase/drugs/drug_metoprolol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Taguchi_2004` / `Taguchi_2004::reference`)
- model: `../../../knowledgebase/drugs/drug_metoprolol/models/modelica/_needs_review/Metoprolol_Taguchi2004_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_metoprolol/models/modelica/_needs_review/Metoprolol_Taguchi2004_reference.deviation.json`
