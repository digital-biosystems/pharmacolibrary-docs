...
Quarfordt SH; Greenfield MF et al. (1973). The Journal of clinical investigation 52
  ·  DOI: [10.1172/JCI107378](https://doi.org/10.1172/JCI107378)
...
**Extraction notes:**
- no GROBID TEI available — transcribed from cached Quarfordt_1973_extracted.txt (0 record(s)); values are summary statistics, not a fitted model
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model.links` | [['cholesterol', 'cholic acid', 'metabolism'], ['cholesterol', 'chenodeoxycholic acid', 'metabolism'], ['cholic acid', 'deoxycholic acid', 'metabolism']] | [['cholesterol', 'cholic_acid', 'metabolism'], ['cholesterol', 'chenodeoxycholate', 'metabolism'], ['cholic_acid', 'deoxycholate', 'metabolism']] | mismatch |
| `gpt-oss:120b` | `screen.primary_analyte` | cholic acid | cholic_acid | mismatch |
...
| C8_topology | fail | ontology-linked transfer parameter on every edge | ['X31', 'X51', 'X43'] | not captured | not captured | not captured |
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-18 13:36 UTC</sub>
