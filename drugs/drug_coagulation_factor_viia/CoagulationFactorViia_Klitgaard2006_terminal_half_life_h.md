...
## Model component
<dbs-pgx drug="coagulation factor VIIa" model-id="CoagulationFactorViia_Klitgaard2006_terminal_half_life_h" status="model_quarantined" stale="false" population="trauma patients with severe bleeding" measured-compound="factor VII coagulant activity" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| mean clearance | `Q22` · CL | —(suppressed) | ml.kg-1.h-1 | — | L/h | not captured | boundary (0.8) | Klitgaard_2006:discussion_prose | — | not captured |
...
- dropped unlinked row (NIL): 'Hemophiliaa' — extend the ontology if this is a real PK parameter (source ['Klitgaard_2006_table_3:row0:col3'])
- dropped unlinked row (NIL): 'Trauma' — extend the ontology if this is a real PK parameter (source ['Klitgaard_2006_table_3:row1:col3'])
...
- population split: 'terminal half-life (h)' subgroup of Klitgaard_2006 (paper reports 2 populations: estimated clearance (ml.kg-1.h-1), terminal half-life (h))
...
- scholar stages: `../../../knowledgebase/drugs/drug_coagulation_factor_viia/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Klitgaard_2006` / `Klitgaard_2006::terminal_half_life_h`)
- model: `../../../knowledgebase/drugs/drug_coagulation_factor_viia/models/modelica/_needs_review/CoagulationFactorViia_Klitgaard2006_terminal_half_life_h.mo`
- deviation: `../../../knowledgebase/drugs/drug_coagulation_factor_viia/models/modelica/_needs_review/CoagulationFactorViia_Klitgaard2006_terminal_half_life_h.deviation.json`
