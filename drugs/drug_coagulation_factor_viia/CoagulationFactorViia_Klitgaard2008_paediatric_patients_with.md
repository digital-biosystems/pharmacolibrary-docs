...
| t1/2(h) ( t1/2β[h])‡ | `Q57` · t1/2z | 1.32 | h | 4752.0 | [h] | not captured | space_fold (0.95) | tbl1:row6:col17, tbl1:row6:col33 | — | not captured |
...
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['tbl1:row6:col17', 'tbl1:row6:col33'] |
