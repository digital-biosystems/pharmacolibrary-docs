...
## Model component
<dbs-pgx drug="coagulation factor VIIa" model-id="CoagulationFactorViia_Klitgaard2008_patients_undergoing_olt" status="not_modelled" stale="false" population="mixed patient populations (haemophilia, liver surgery, trauma, etc.)" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_coagulation_factor_viia/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Klitgaard_2008` / `Klitgaard_2008::patients_undergoing_olt_single_dose_study_17_jansen_data_on_file_2001::mixed patient populations (haemophilia, liver surgery, trauma, etc.)`)
