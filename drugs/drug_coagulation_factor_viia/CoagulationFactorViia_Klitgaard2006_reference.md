...
## Model component
<dbs-pgx drug="coagulation factor VIIa" model-id="CoagulationFactorViia_Klitgaard2006_reference" status="extracted" stale="false" population="trauma patients with severe bleeding" measured-compound="coagulation_factor_viia" parameterization="mechanistic" topology="2C"></dbs-pgx>
