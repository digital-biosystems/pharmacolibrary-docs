...
|---|---|---|---|---|---|---|---|---|---|---|
| θCLCR | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | t5-dddt-10-3995:row4:col2 | — | not captured |
| V2/F | `Q82` · V2/F | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | t5-dddt-10-3995:row5:col2 | — | not captured |
| Q/F | `Q69` · Q/F | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | t5-dddt-10-3995:row6:col2 | — | not captured |
| V3/F | `Q78` · V3/F | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | t5-dddt-10-3995:row7:col2 | — | not captured |
| MTTfed | `Q81` · MTT | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | t5-dddt-10-3995:row9:col2 | — | not captured |
| NN | `Q311` · n_transit | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | t5-dddt-10-3995:row10:col2 | — | not captured |
| ωKa | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | t5-dddt-10-3995:row21:col2 | — | not captured |
| CLt/F | `Q900` · CLt/F | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | t5-dddt-10-3995:row3:col2 | — | not captured |
