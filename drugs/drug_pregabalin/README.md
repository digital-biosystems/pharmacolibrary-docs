...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-21 16:55 | 11:51 | 1/4/2 | 2/0/0 | 1/0/0 | 305,546/18,306 | ollama / qwen3.8:27b-mtp-q8_0 | 20 | 2/18 | 20/0 | 0 |

## popPK records

| status | detail | citation | doi |
|---|---|---|---|
| <span class="pk-badge pk-badge--green">accepted (caveats)</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span><br><sub>caveat: the record defines covariate effects (weight on clearance, renal function …) but the engineer simulated only…</sub> | [Bae_2016_reference](drugs/drug_pregabalin/Pregabalin_Bae2016_reference.md) | Bae EK et al., Factors influencing topiramate clearanc…, Seizure (2016) | [10.1016/j.seizure.2016.02.002](https://doi.org/10.1016/j.seizure.2016.02.002) |
| <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.389). The first reading is what the record holds.">cross-check: disputed</span><br><sub>blocking: disposition incomplete — only volume extracted — the engineer needs both; the m…</sub><br><sub>blocking: C5 dimensioned parameter(s) without a unit: Q76, Q49, Q83 — no SI value to buil…</sub><br><sub>route_to: `human_review`</sub> | [Chan_2021_reference](drugs/drug_pregabalin/Pregabalin_Chan2021_reference.md) | Chan PLS et al., Pregabalin Population Pharmacokinetic a…, Clinical pharmacology and t… (2021) | [10.1002/cpt.2132](https://doi.org/10.1002/cpt.2132) |
| <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.667). The first reading is what the record holds.">cross-check: disputed</span><br><sub>blocking: C5 dimensioned parameter(s) without a unit: Q22, Q82, Q69, Q78 — no SI value to…</sub><br><sub>route_to: `human_review`</sub> | [Hong_2016_reference](drugs/drug_pregabalin/Pregabalin_Hong2016_reference.md) | Hong T et al., Comparison of oral absorption models fo…, Drug design, development an… (2016) | [10.2147/DDDT.S123318](https://doi.org/10.2147/DDDT.S123318) |
| <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.692). The first reading is what the record holds.">cross-check: disputed</span><br><sub>blocking: C9 clearance/volume outside physiological window (implausible magnitude — unit/…</sub><br><sub>route_to: `human_review`</sub> | [Bender_2009_reference](drugs/drug_pregabalin/Pregabalin_Bender2009_reference.md) | Bender G et al., Population pharmacokinetic model of the…, Pharmaceutical research (2009) | [10.1007/s11095-009-9942-y](https://doi.org/10.1007/s11095-009-9942-y) |
| <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (partly confirmed, agreement 0.667). The first reading is what the record holds.">cross-check: partial</span><br><sub>blocking: no distribution volume and no clearance/elimination — not a compartmental popPK…</sub><br><sub>route_to: `human_review`</sub> | [Feng_2001_reference](drugs/drug_pregabalin/Pregabalin_Feng2001_reference.md) | Feng MR et al., Brain microdialysis and PK/PD correlati…, European journal of drug me… (2001) | [10.1007/BF03190385](https://doi.org/10.1007/BF03190385) |
| <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="a second model re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: partial</span><br><sub>blocking: no distribution volume and no clearance/elimination — not a compartmental popPK…</sub><br><sub>route_to: `human_review`</sub> | [Park_2023_reference](drugs/drug_pregabalin/Pregabalin_Park2023_reference.md) | Park M et al., Pharmacokinetic properties of a new sus…, Translational and clinical… (2023) | [10.12793/tcp.2023.31.e20](https://doi.org/10.12793/tcp.2023.31.e20) |
| <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (partly confirmed, agreement 0.667). The first reading is what the record holds.">cross-check: partial</span><br><sub>blocking: no distribution volume and no clearance/elimination — not a compartmental popPK…</sub><br><sub>route_to: `human_review`</sub> | [van_2018_reference](drugs/drug_pregabalin/Pregabalin_van2018_reference.md) | van Esdonk MJ et al., Population Pharmacokinetic/Pharmacodyna…, CPT: pharmacometrics & syst… (2018) | [10.1002/psp4.12318](https://doi.org/10.1002/psp4.12318) |

## Pharmacodynamics (PD)

| status | detail | citation | doi |
|---|---|---|---|
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Chan_2021](drugs/drug_pregabalin/pd_Chan_2021_log_transformed_28_day_seizure_rate.md) | Chan PLS et al., Pregabalin Population Pharmacokinetic a…, Clinical pharmacology and t… (2021) | [10.1002/cpt.2132](https://doi.org/10.1002/cpt.2132) |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.833). The first reading is what the record holds.">cross-check: disputed</span> | [van_2018](drugs/drug_pregabalin/pd_van_2018_CP_PTT.md) | van Esdonk MJ et al., Population Pharmacokinetic/Pharmacodyna…, CPT: pharmacometrics & syst… (2018) | [10.1002/psp4.12318](https://doi.org/10.1002/psp4.12318) |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.833). The first reading is what the record holds.">cross-check: disputed</span> | [van_2018](drugs/drug_pregabalin/pd_van_2018_ES_PTT.md) | van Esdonk MJ et al., Population Pharmacokinetic/Pharmacodyna…, CPT: pharmacometrics & syst… (2018) | [10.1002/psp4.12318](https://doi.org/10.1002/psp4.12318) |
...
|---|---|---|---|
| metabolism | kidney | <sub>“…s metabolized and it is excreted virtually unchanged in the urine.[A31165,L7066]…”</sub> | prose |
| metabolism | liver | `NAT2` metabolism | paper PGx gene |
| metabolism | small intestine | `NAT2` metabolism | paper PGx gene |
| excretion | kidney | <sub>“…Pregabalin is almost exclusively eliminated in the urine.[A187093,A187096] Further, based…”</sub> | prose |
...
<sub>queue written 2026-09-21T16:44:58.730438+00:00</sub>
...
| PGx | Alcantara-Montero_2017 | not_relevant | 0 | 0 | The paper discusses desvenlafaxine pharmacology and mentions pregabalin only as a standard treatment for neuropathic pain, without reporting any pharmacogenomic effects on pregabalin's PK or PD parameters. |
...
| PGx | Aylón_2026 | not_relevant | 0 | 0 | The paper is a review that explicitly states there is not enough information to determine if pregabalin is a P-gp substrate, and it does not report specific pharmacogenomic effect sizes for pregabalin. |
...
| PGx | Bollinger_2025 | not_relevant | 0 | 0 | The paper explicitly states that the genetic profile (CYP2D6/COMT) does not explain the failure of pregabalin therapy, as pregabalin is not metabolized by these enzymes. |
| PGx | Chan_2014 | not_relevant | 0 | 0 | The study investigates P-glycoprotein substrate status in vitro and does not report any pharmacogenomic effects of gene variants on PK or PD parameters. |
| PGx | Chesler_2003 | not_relevant | 4 | 2 | The paper reports heritability and strain-dependence of pharmacodynamic response (analgesia) in mice but does not identify specific gene variants or genotypes associated with the effect. |
...
| PGx | Cheung_2026_2 | not_relevant | 0 | 0 | The paper is a clinical case report describing the management of post-TBI bipolar disorder and does not report pharmacogenomic effects on the PK or PD of pregabalin. |
| PGx | Cheung_2026_3 | not_relevant | 0 | 0 | The paper is a case report on a glutamatergic regimen for bipolar depression and does not report pharmacogenomic effects on the PK or PD of pregabalin. |
| PGx | Cheung_2026_4 | not_relevant | 0 | 0 | The paper is a clinical case report on OCD treatment and does not report pharmacogenomic effects on the PK or PD of pregabalin. |
...
| PGx | Desmarais_2010 | not_relevant | 0 | 0 | The paper is a review of drug interactions for tamoxifen and does not report pharmacogenomic effects on pregabalin PK/PD parameters. |
| PGx | Galgani_2018 | not_relevant | 0 | 0 | The paper is a review of drug-drug interactions between DOACs and AEDs, not a study on pharmacogenomic effects of gene variants on pregabalin PK/PD. |
...
| PGx | Karroum_2008 | not_relevant | 0 | 0 | The text is a general review of Restless Legs Syndrome and mentions pregabalin only as a treatment option, without reporting any pharmacogenomic effects on its PK or PD parameters. |
| popPK | Kumar_2020 | irrelevant | 0 | 0 | The study is a pharmacodynamic/efficacy investigation in an animal model where pregabalin is used only as a test drug to assess resistance, with no quantitative pharmacokinetic parameters (CL, V, etc.) reported for it. |
...
| popPK | Miller_2003 | irrelevant | 0 | 0 | The paper describes an exposure-response (pharmacodynamic) analysis of seizure frequency rather than a pharmacokinetic study, and no PK parameters (CL, V, ka, etc.) are reported. |
| PGx | Muhn_2022 | not_relevant | 0 | 0 | The paper is a case report focusing on opioid therapy and drug interactions; while pregabalin is mentioned as being optimized, no pharmacogenomic effect on its PK or PD parameters is reported. |
| PGx | Raccah-Tebeka_2021 | not_relevant | 0 | 0 | The paper is a clinical practice guideline review on the efficacy of various drugs for menopausal hot flushes and does not report any pharmacogenomic effects on the PK or PD of pregabalin. |
| PGx | Regland_2015 | not_relevant | 0 | 0 | The paper discusses MTHFR genotypes affecting folic acid dosing for ME/FM, and mentions pregabalin only as a concomitant medication in a subgroup, without reporting any pharmacogenomic effect on pregabalin's PK or PD parameters. |
...
| PGx | Sharma_2026 | not_relevant | 0 | 0 | The paper is a general review of cancer pain management trends and mentions pharmacogenomics conceptually but does not report specific gene variants or their effects on pregabalin PK/PD parameters. |
| PGx | Sideras_2010 | not_relevant | 0 | 0 | The paper is a review of nonhormonal therapies for hot flashes and does not report specific pharmacogenomic effects on pregabalin PK/PD parameters. |
...
---
<sub>Generated by `docs.py` (scholarv2) · newest extraction 2026-09-21 16:45 UTC</sub>
