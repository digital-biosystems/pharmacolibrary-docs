...
|---|---|---|---|---|---|---|---|---|---|---|
| body_weight_on_cl_fd | `Q900` · body_weight_on_cl_fd | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | cpt2132-tbl-0002:row3:col2 | — | not captured |
| sex_on_cl_fe | `Q900` · sex_on_cl_fe | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | cpt2132-tbl-0002:row4:col2 | — | not captured |
| V/F | `Q76` · V/F | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | cpt2132-tbl-0002:row6:col2, cpt2132-tbl-0002:row15:col2 | — | not captured |
| sex_on_v_fe | `Q900` · sex_on_v_fe | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | cpt2132-tbl-0002:row7:col2 | — | not captured |
| body_weight_on_v_fd | `Q900` · body_weight_on_v_fd | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | cpt2132-tbl-0002:row8:col2 | — | not captured |
| ka fastedf | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | cpt2132-tbl-0002:row9:col2 | — | not captured |
| T lag | `Q83` · tlag | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | cpt2132-tbl-0002:row12:col2 | — | not captured |
| u 1 Typical value of apparent clearance (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | L/h | not captured | review_gapfill (0.7) | Bae_2016:review | — | not captured |
