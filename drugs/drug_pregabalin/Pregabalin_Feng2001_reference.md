...
Feng MR; Turluck D; Burleigh J; Lister R; Fan C; Middlebrook A; et al. et al. (2001). European journal of drug metabolism and pharmacokinetics 26
  ·  DOI: [10.1007/BF03190385](https://doi.org/10.1007/BF03190385)
...
**Extraction notes:**
- no GROBID TEI available; abstract in Feng_2001_metadata.yaml carries no parameter-bearing sentence
...
- scholar stages: `../../../knowledgebase/drugs/drug_pregabalin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Feng_2001` / `Feng_2001::reference`)
