...
# name — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.054). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.054 (4/74 fields) | 70 |

<details><summary>70 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 34.9 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 793 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q301]` | not captured | 0.429 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 0.0116 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q327]` | not captured | 0.527 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q327]` | not captured | 55.7 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q328]` | not captured | 5.68 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q335]` | not captured | 223 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 12.4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 7.97 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 390 | only_one_extracted |
