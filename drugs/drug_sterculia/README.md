...
**Description.** Karaya gum allergenic extract is used in allergenic testing.

## Extraction summary

| extracted at | time | popPK e/r/o | PD e/r/o (paper) | PGx e/r/o | tokens in/out | LLM | papers | GROBID/JATS | OA/non-OA | NONMEM |
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-22 00:29 | 19:49 | 0/0/0 | 6/2/0 | 0/0/0 | 615,193/8,564 | ollama / qwen3.8:27b-mtp-q8_0 | 21 | 3/18 | 20/1 | 0 |
...
|---|---|---|---|
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Das_2017_2](drugs/drug_sterculia/pd_Das_2017_2_Cytotoxicity_in_RAW_264_7_macrophages.md) | Das (2017) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Das_2017_2](drugs/drug_sterculia/pd_Das_2017_2_Cytotoxicity_in_murine_RBCs.md) | Das (2017) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Das_2017_2](drugs/drug_sterculia/pd_Das_2017_2_Cytotoxicity_in_murine_peritoneal_macrophages.md) | Das (2017) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Das_2017_2](drugs/drug_sterculia/pd_Das_2017_2_DNA_fragmentation.md) | Das (2017) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Das_2017_2](drugs/drug_sterculia/pd_Das_2017_2_Leishmania_donovani_promastigote_viability.md) | Das (2017) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Das_2017_2](drugs/drug_sterculia/pd_Das_2017_2_Lipid_peroxidation.md) | Das (2017) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Das_2017_2](drugs/drug_sterculia/pd_Das_2017_2_Reactive_oxygen_species_ROS.md) | Das (2017) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Das_2017_2](drugs/drug_sterculia/pd_Das_2017_2_Superoxide_generation.md) | Das (2017) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.071). The first reading is what the record holds.">cross-check: disputed</span> | [Khairi_2025](drugs/drug_sterculia/pd_Khairi_2025_unknown.md) | Khairi N et al., Phytochemical profiling and enzyme inhi…, Narra J (2025) | [10.52225/narra.v5i3.1778](https://doi.org/10.52225/narra.v5i3.1778) |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Prastiwi_2022](drugs/drug_sterculia/pd_Prastiwi_2022_IC50.md) | Prastiwi R et al., The chemical constituents of Sterculia…, Heliyon (2022) | [10.1016/j.heliyon.2022.e08798](https://doi.org/10.1016/j.heliyon.2022.e08798) |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.118). The first reading is what the record holds.">cross-check: disputed</span> | [Prastiwi_2022](drugs/drug_sterculia/pd_Prastiwi_2022_unknown.md) | Prastiwi R et al., The chemical constituents of Sterculia…, Heliyon (2022) | [10.1016/j.heliyon.2022.e08798](https://doi.org/10.1016/j.heliyon.2022.e08798) |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Reolon_2023](drugs/drug_sterculia/pd_Reolon_2023_cell_viability.md) | Reolon JB et al., Karaya/Gellan-Gum-Based Bilayer Films C…, Pharmaceutics (2023) | [10.3390/pharmaceutics15092234](https://doi.org/10.3390/pharmaceutics15092234) |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Susanto_2026](drugs/drug_sterculia/pd_Susanto_2026_MCF_7.md) | Susanto Y et al., Nanovesicle-formulated Sterculia coccin…, Journal of advanced pharmac… (2026) | [10.4103/JAPTR.JAPTR_345_25](https://doi.org/10.4103/JAPTR.JAPTR_345_25) |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Susanto_2026](drugs/drug_sterculia/pd_Susanto_2026_MTT.md) | Susanto Y et al., Nanovesicle-formulated Sterculia coccin…, Journal of advanced pharmac… (2026) | [10.4103/JAPTR.JAPTR_345_25](https://doi.org/10.4103/JAPTR.JAPTR_345_25) |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Thabet_2018_2](drugs/drug_sterculia/pd_Thabet_2018_2_elastase_release.md) | Thabet (2018) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Thabet_2018_2](drugs/drug_sterculia/pd_Thabet_2018_2_hexosaminidase_release.md) | Thabet (2018) | — |
| <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Thabet_2018_2](drugs/drug_sterculia/pd_Thabet_2018_2_superoxide_anion_production.md) | Thabet (2018) | — |
| <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.118). The first reading is what the record holds.">cross-check: disputed</span> | [Lyzu_2022](drugs/drug_sterculia/pd_Lyzu_2022_DPPH.md) | Lyzu C et al., Phytochemical Profiling, Antioxidant Ac…, Evidence-based complementar… (2022) | [10.1155/2022/3190496](https://doi.org/10.1155/2022/3190496) |
| <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Waiganjo_2020](drugs/drug_sterculia/pd_Waiganjo_2020_antiplasmodial_activity.md) | Waiganjo B et al., Antiplasmodial and Cytotoxic Activities…, Journal of parasitology res… (2020) | [10.1155/2020/8871375](https://doi.org/10.1155/2020/8871375) |
| <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span> | [Waiganjo_2020](drugs/drug_sterculia/pd_Waiganjo_2020_cytotoxicity.md) | Waiganjo B et al., Antiplasmodial and Cytotoxic Activities…, Journal of parasitology res… (2020) | [10.1155/2020/8871375](https://doi.org/10.1155/2020/8871375) |
...
<sub>queue written 2026-09-22T00:20:38.207865+00:00</sub>

## Screened and excluded

| domain | paper | verdict | relevance | extractability | reason |
|---|---|---|---|---|---|
| popPK | Ahmad_2024 | irrelevant | 1 | 0 | The study is in vitro/in silico only and lacks quantitative in vivo PK parameters (CL, V, ka) for the subject compound. |
...
| popPK | Babu_2003 | irrelevant | 0 | 0 | The study focuses on theophylline as a model drug to evaluate polysaccharide matrices, not sterculia. |
...
| popPK | Freitas_2020 | irrelevant | 0 | 0 | The study focuses on the formulation and in vitro characterization of a Sterculia striata gum-based delivery system for insulin, not on the pharmacokinetics of sterculia itself. |
| popPK | Getyala_2013 | irrelevant | 0 | 0 | The study focuses on the formulation of Losartan potassium floating tablets and does not involve the drug sterculia or report any pharmacokinetic parameters for it. |
...
| popPK | Kr_2017 | irrelevant | 0 | 0 | The study focuses on albendazole microcrystals and does not involve the drug sterculia or report any pharmacokinetic parameters for it. |
| popPK | Kumari_2025 | irrelevant | 0 | 0 | The paper is a review of polysaccharide-based drug delivery systems where sterculia gum is discussed as a polymer excipient, not as the subject drug for pharmacokinetic analysis. |
...
| popPK | Moin_2020 | irrelevant | 0 | 0 | The study investigates diltiazem as the subject drug, with sterculia (karaya gum) serving only as a formulation excipient, not as the drug being pharmacokinetically characterized. |
| popPK | Murali_2002 | irrelevant | 0 | 0 | The study focuses on nimodipine as the subject drug, not sterculia, and does not report population pharmacokinetic parameters for sterculia. |
| popPK | Nath_2013 | irrelevant | 1 | 0 | The study focuses on the formulation of a drug delivery system for azathioprine using Sterculia gum as an excipient, not on the pharmacokinetics of Sterculia itself, and no quantitative PK parameters for Sterculia are reported. |
...
| popPK | Oppong_2018 | irrelevant | 0 | 0 | The paper is a review of ethnopharmacology and phytochemistry that explicitly notes pharmacokinetic studies are a scientific gap, containing no original quantitative PK parameters. |
| popPK | Papadopoulou_2025 | irrelevant | 0 | 0 | The paper is a review on marine by-products for cosmetics and does not mention sterculia or report any pharmacokinetic parameters. |
...
| popPK | Patil_2015 | irrelevant | 0 | 0 | The study focuses on lafutidine formulation, and sterculia (karaya gum) is only an excipient, not the subject drug for PK analysis. |
...
| popPK | Singh_2007 | irrelevant | 0 | 0 | The study focuses on metoclopramide hydrochloride, not sterculia, and reports only in vitro release data without pharmacokinetic parameters. |
...
| popPK | Troches-Mafla_2025 | irrelevant | 0 | 0 | The paper is a review of diltiazem hydrochloride formulations and does not study sterculia or report any pharmacokinetic parameters for it. |
...
| popPK | Vats_2025 | irrelevant | 0 | 0 | The paper is a review of the plant Tecomella undulata (desert teak), not the drug sterculia, and contains no pharmacokinetic parameters. |
...
| popPK | Zahiruddin_2021 | irrelevant | 0 | 0 | The paper is a metabolomic and immunomodulatory study of a polyherbal combination (Phyllanthus, Piper, Withania, Tinospora) and does not involve the drug sterculia or report any pharmacokinetic parameters. |
...
| popPK | Zhou_2024 | irrelevant | 0 | 0 | The paper focuses on the formulation of Pickering emulsions for beta-carotene and does not involve the drug sterculia or report any pharmacokinetic parameters. |
