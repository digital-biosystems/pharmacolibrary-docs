...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-09 07:14 | 18:14 | 0/0/0 | 0/0/0 | 0/0/0 | 149,800/4,297 | ollama / qwen3.8:27b-mtp-q8_0 | 17 | 5/12 | 16/1 | 0 |
...
- **PubMed hits:** 2098970 matched, 71 returned
...
<sub>queue written 2026-09-09T07:13:43.445740+00:00</sub>
...
| popPK | Beveridge_1973 | irrelevant | 0 | 0 | The paper title indicates the subject drug is digoxin, not lanatoside_c, and no PK parameters for lanatoside_c are present. |
...
| PD | Broni_2023 | not_relevant | 0 | 0 | The paper is an in silico study identifying potential Ebola VP40 inhibitors; lanatoside C is only listed as a repurposed drug candidate with no experimental pharmacodynamic or exposure-response data. |
...
| popPK | Drinnan_1991 | irrelevant | 0 | 0 | The paper discusses G(olf) protein expression in the basal ganglia and is unrelated to lanatoside_c pharmacokinetics. |
...
| popPK | Fukami_2011 | irrelevant | 0 | 0 | The study focuses on the biliary excretion of penicillin G and other compounds in rats, with no mention of lanatoside_c or its pharmacokinetic parameters. |
| popPK | Ganie_2024 | irrelevant | 0 | 0 | The paper is a mathematical study on spectral graph theory (distance energies of graphs) and contains no pharmacokinetic data or mention of lanatoside_c. |
...
| popPK | Gong_2019 | irrelevant | 0 | 0 | The paper is a review of chemical components of Ganoderma fungi and does not contain any pharmacokinetic data for lanatoside_c. |
...
| popPK | Hammarström_1979 | irrelevant | 0 | 0 | The paper is an immunological study on lymphocyte activation and does not report any pharmacokinetic parameters for lanatoside C. |
...
| popPK | Holt_1978 | irrelevant | 0 | 0 | The evidence indicates the study is about digoxin, not lanatoside_c. |
...
| popPK | Jounela_1973 | irrelevant | 0 | 0 | The paper title indicates the subject drug is digoxin, not lanatoside_c, and no PK parameters for lanatoside_c are present. |
...
| popPK | Liu_2024 | irrelevant | 0 | 0 | The paper is a mechanistic study on ZDHHC21 and FASN in lymphoma where lanatoside C is used only as a tool compound to probe protein stability, with no pharmacokinetic parameters reported. |
...
| popPK | Nagao_2023 | irrelevant | 0 | 0 | The study is a mechanistic oncology investigation identifying lanatoside C as a therapeutic candidate, with no pharmacokinetic parameters reported. |
...
| popPK | Smer-Barreto_2023 | irrelevant | 0 | 0 | The paper is a machine learning study on senolytic drug discovery and does not report pharmacokinetic parameters for lanatoside_c. |
...
| popPK | Urtizberea_1990 | irrelevant | 0 | 0 | The provided evidence contains only the title of a study on digitalis poisoning and lacks any quantitative pharmacokinetic parameters or specific data for lanatoside_c. |
| popPK | Vince_1973 | irrelevant | 0 | 0 | The paper title indicates the subject drug is digoxin, not lanatoside_c, and no PK parameters for lanatoside_c are present. |
| popPK | Vitti_1971 | irrelevant | 0 | 0 | The paper title indicates the subject drug is digoxin, not lanatoside_c, and no PK parameters for lanatoside_c are present. |
| popPK | WILLCOX_1962 | irrelevant | 0 | 0 | The paper title indicates a clinical treatment study for syphilis, with no evidence of pharmacokinetic analysis or lanatoside_c as the subject drug. |
...
| popPK | unknown_1969 | irrelevant | 0 | 0 | The evidence contains only the drug name with no pharmacokinetic data, study details, or numeric parameters. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_lanatoside_c`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
