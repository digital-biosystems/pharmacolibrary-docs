...
|---|---|---|---|---|---|---|---|---|---|---|
| t1/2HbA1c (day) | `Q57` · t1/2z | —(suppressed) | day | — | [d] | not captured | llm (0.6) | T3:row3:col1, T3:row3:col2, T3:row3:col4, T3:row3:col5 | — | not captured |
| ka (1/day) | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Kobuchi_2025_table_2:row2:col1, Kobuchi_2025_table_2:row2:col4 | — | not captured |
| V/F (L) | `Q76` · V/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Kobuchi_2025_table_2:row6:col1, Kobuchi_2025_table_2:row6:col4 | — | not captured |
| θBW | `Q900` · θBW | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | not captured | — | not captured |
| θCL/F | `Q900` · θCL/F | —(suppressed) | L/day | — | not captured | not captured | not captured (not captured) | Kobuchi_2025_table_2:row4:col1, Kobuchi_2025_table_2:row4:col2, Kobuchi_2025_table_2:row4:col4, Kobuchi_2025_table_2:row4:col5 | — | not captured |
