...
## Model component
<dbs-pgx drug="warfarin" model-id="Warfarin_Hirai2024_median" status="model_quarantined" stale="false" population="Japanese adult patients" measured-compound="warfarin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| ke, /h | `Q47` · kel | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Hirai_2024_table_2:row1:col3 | — | not captured |
...
- dropped unlinked row (NIL): 'ωke' — extend the ontology if this is a real PK parameter (source ['Hirai_2024_table_2:row4:col3'])
...
- dropped unlinked row (NIL): 'MTT1, h' — extend the ontology if this is a real PK parameter (source ['Hirai_2024_table_2:row9:col3'])
...
- dropped PD-category row 'ωEDR50' → Q321 (EC50, category G11) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['Hirai_2024_table_2:row16:col3'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=warfarin
- population split: 'median' subgroup of Hirai_2024 (paper reports 2 populations: estimates, median)
