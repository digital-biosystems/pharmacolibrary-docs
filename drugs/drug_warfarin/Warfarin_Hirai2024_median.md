...
## Model component
<dbs-pgx drug="warfarin" model-id="Warfarin_Hirai2024_median" status="model_quarantined" stale="false" population="Japanese adults" measured-compound="warfarin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| ke, /h | `Q47` · kel | —(suppressed) | /h | — | [1] / [h] | not captured | exact (1.0) | Hirai_2024_table_2:row1:col3 | — | 0.860 (None% RSE) |
| MTT1, h | `Q81` · MTT | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Hirai_2024_table_2:row9:col3 | — | not captured |
| egfr_on_edr50 | `Q900` · egfr_on_edr50 | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Hirai_2024_table_2:row14:col3 | — | not captured |
| Vd | `Q61` · V | —(suppressed) | L | — | L | not captured | review_gapfill (0.7) | Aoyama_2022:review | — | not captured |
| ka (1/h) | `Q49` · kabs | —(suppressed) | 1/h | — | 1/h | not captured | review_gapfill (0.7) | Gomeni_2026:review | — | not captured |
| Lag (h) | `Q83` · tlag | —(suppressed) | h | — | h | not captured | review_gapfill (0.7) | Gomeni_2026:review | — | not captured |
...
- dropped unlinked row (NIL): 'γ' — extend the ontology if this is a real PK parameter (source ['Hirai_2024_table_2:row7:col3'])
- dropped unlinked row (NIL): 'EDR50, mg/h' — extend the ontology if this is a real PK parameter (source ['Hirai_2024_table_2:row8:col3'])
- dropped unlinked row (NIL): 'MTT2 − MTT1, h' — extend the ontology if this is a real PK parameter (source ['Hirai_2024_table_2:row10:col3'])
- dropped unlinked row (NIL): 'BSA on EDR50' — extend the ontology if this is a real PK parameter (source ['Hirai_2024_table_2:row12:col3'])
- dropped unlinked row (NIL): 'Alb on EDR50' — extend the ontology if this is a real PK parameter (source ['Hirai_2024_table_2:row13:col3'])
- covariate level 'eGFR on EDR50' → Q900:egfr_on_edr50 = 0.124 (linear_fractional on the model)
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=warfarin
- population split: 'median' subgroup of Hirai_2024 (paper reports 3 populations: estimates, median, prior values)
...
| C5_dimension_Q47 | pass | 1 / [time] | not captured | not captured | not captured | ['Hirai_2024_table_2:row1:col3'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_warfarin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Hirai_2024` / `Hirai_2024::median`)
- model: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/_needs_review/Warfarin_Hirai2024_median.mo`
- deviation: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/_needs_review/Warfarin_Hirai2024_median.deviation.json`
