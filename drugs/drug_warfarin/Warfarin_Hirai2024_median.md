...
|---|---|---|---|---|---|---|---|---|---|---|
| ke, /h | `Q47` · kel | 0.0283 | /h | 7.86111111111111e-06 | [1] / [h] | not captured | exact (1.0) | Hirai_2024_table_2:row1:col3 | — | 0.860 (None% RSE) |
| MTT1, h | `Q81` · MTT | 28.2 | h | not captured | [h] | not captured | llm (0.6) | Hirai_2024_table_2:row9:col3 | — | not captured |
| egfr_on_edr50 | `Q900` · egfr_on_edr50 | 0.124 | not captured | not captured | not captured | not captured | not captured (not captured) | Hirai_2024_table_2:row14:col3 | — | not captured |
