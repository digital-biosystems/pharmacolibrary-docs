...
## Citation
Neff-Davis CA; Davis LE; Gillette EL et al. (1981). Journal of veterinary pharmacology and therapeutics 4
  ·  DOI: [10.1111/j.1365-2885.1981.tb00722.x](https://doi.org/10.1111/j.1365-2885.1981.tb00722.x)

## Model component
<dbs-pgx drug="warfarin" model-id="Warfarin_NeffDavis1981_reference" status="curated_candidate" stale="false" population="healthy dogs" measured-compound="warfarin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| elimination half-life | `Q57` · t1/2z | 14.5 | h | 52200.0 | [h] | not captured | llm (0.6) | Neff-Davis_1981:abstract | — | not captured |
| apparent specific volume of distribution | `Q61` · V | 0.22 | litre/kg | 0.0154 | [l] / [kg] | not captured | llm_confirmed (0.6) | Neff-Davis_1981:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Neff-Davis_1981_metadata.yaml (2 record(s)); values are summary statistics, not a fitted model
...
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Neff-Davis_1981:abstract'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Neff-Davis_1981:abstract'] |
...
| C9_phys_window_Q61 | pass | volume within physiological range | 15.4 L | not captured | not captured | ['Neff-Davis_1981:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_warfarin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Neff-Davis_1981` / `Neff-Davis_1981::reference`)
- model: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/Warfarin_NeffDavis1981_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/Warfarin_NeffDavis1981_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/Warfarin_NeffDavis1981_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_warfarin/Warfarin_NeffDavis1981_reference/Warfarin_NeffDavis1981_reference_modelica.zip" download>Warfarin_NeffDavis1981_reference_modelica.zip</a> <span class="pk-size">(3.8 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_warfarin/Warfarin_NeffDavis1981_reference/Warfarin_NeffDavis1981_reference_matlab.zip" download>Warfarin_NeffDavis1981_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_warfarin/Warfarin_NeffDavis1981_reference/Warfarin_NeffDavis1981_reference_matlab_simbio.zip" download>Warfarin_NeffDavis1981_reference_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_warfarin/Warfarin_NeffDavis1981_reference/Warfarin_NeffDavis1981_reference_sbml.zip" download>Warfarin_NeffDavis1981_reference_sbml.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_warfarin/Warfarin_NeffDavis1981_reference/Warfarin_NeffDavis1981_reference_cellml.zip" download>Warfarin_NeffDavis1981_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_warfarin/Warfarin_NeffDavis1981_reference/Warfarin_NeffDavis1981_reference.svg" alt="Warfarin_NeffDavis1981_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Warfarin_NeffDavis1981_reference_params.json` · controls `Warfarin_NeffDavis1981_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
