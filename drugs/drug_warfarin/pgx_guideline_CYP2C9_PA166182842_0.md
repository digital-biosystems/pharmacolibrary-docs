...
# CYP2C9 — PGx  <span class="pk-badge pk-badge--neutral">guideline_estimate</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.2). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|
| `gpt-oss:120b` | secondary_empty | 0.2 (1/5 fields) | 4 |
...
| `gpt-oss:120b` | `theta[IM]` | -0.5 | not captured | only_one_extracted |
