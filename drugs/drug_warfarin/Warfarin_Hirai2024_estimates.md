...
## Model component
<dbs-pgx drug="warfarin" model-id="Warfarin_Hirai2024_estimates" status="model_quarantined" stale="false" population="Japanese adults" measured-compound="warfarin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| ke, /h | `Q47` · kel | —(suppressed) | /h | — | [1] / [h] | not captured | exact (1.0) | Hirai_2024_table_2:row1:col1 | — | 0.850 (None% RSE) |
| ka, /h | `Q49` · kabs | —(suppressed) | /h | — | [1] / [h] | not captured | exact (1.0) | Hirai_2024_table_2:row2:col1 | — | not captured |
| MTT1, h | `Q81` · MTT | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Hirai_2024_table_2:row9:col1 | — | not captured |
| egfr_on_edr50 | `Q900` · egfr_on_edr50 | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Hirai_2024_table_2:row14:col1 | — | not captured |
...
- population split: 'estimates' subgroup of Hirai_2024 (paper reports 3 populations: estimates, median, prior values)
...
| C5_dimension_Q47 | pass | 1 / [time] | not captured | not captured | not captured | ['Hirai_2024_table_2:row1:col1'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Hirai_2024_table_2:row2:col1'] |
...
- model: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/_needs_review/Warfarin_Hirai2024_estimates.mo`
- deviation: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/_needs_review/Warfarin_Hirai2024_estimates.deviation.json`
