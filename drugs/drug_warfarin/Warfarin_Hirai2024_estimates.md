...
## Model component
<dbs-pgx drug="warfarin" model-id="Warfarin_Hirai2024_estimates" status="model_quarantined" stale="false" population="Japanese adult patients" measured-compound="warfarin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| ke, /h | `Q47` · kel | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Hirai_2024_table_2:row1:col1 | — | not captured |
| ka, /h | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Hirai_2024_table_2:row2:col1 | — | not captured |
