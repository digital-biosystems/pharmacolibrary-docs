...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[absorption rate constant]` (47 vs not captured) — a structural parameter, so the record is disputed.
**How to address:** not a curation fix — the pipeline is the limit here (fulltext: the record was built from the abstract alone, so reported summary statistics stood in for a fitted model).
<sub>owner: **curator**</sub>

> ⚠️ **STALE** — review status `accepted_with_caveats` (reviewed 2026-09-17 22:23:49.247375+00:00) predates the upstream re-run (2026-09-23 12:18:27.915224+00:00). Current validate status: `extracted`.
...
## Model component
<dbs-pgx drug="warfarin" model-id="Warfarin_Mungall1985_reference" status="extracted" stale="true" population="adult patients" measured-compound="warfarin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_warfarin/Warfarin_Mungall1985_reference/Warfarin_Mungall1985_reference_matlab.zip" download>Warfarin_Mungall1985_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_warfarin/Warfarin_Mungall1985_reference/Warfarin_Mungall1985_reference.svg" alt="Warfarin_Mungall1985_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
