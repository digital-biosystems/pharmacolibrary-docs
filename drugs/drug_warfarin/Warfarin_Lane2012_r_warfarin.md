...
## Model component
<dbs-pgx drug="warfarin" model-id="Warfarin_Lane2012_r_warfarin" status="needs_review" stale="true" population="patients on long-term warfarin therapy" measured-compound="R-warfarin, S-warfarin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[missing]` | not captured | 0.804 | only_one_extracted |
...
| C5_unit_missing_Q49 | fail | 1 / [time] | not captured | not captured | not captured | ['tab_2:row5:col4', 'Lane_2012_table_2:row4:col4'] |
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_warfarin/Warfarin_Lane2012_r_warfarin/Warfarin_Lane2012_r_warfarin_matlab.zip" download>Warfarin_Lane2012_r_warfarin_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_warfarin/Warfarin_Lane2012_r_warfarin/Warfarin_Lane2012_r_warfarin.svg" alt="Warfarin_Lane2012_r_warfarin diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
