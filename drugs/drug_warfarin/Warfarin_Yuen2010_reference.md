...
**Second reading:** `gpt-oss:120b` read this paper differently on `screen.primary_analyte` (S-warfarin vs warfarin) and 1 more field(s) — a structural parameter, so the record is disputed.
**How to address:** not a curation fix — the pipeline is the limit here (fulltext: the record was built from the abstract alone, so reported summary statistics stood in for a fitted model).
<sub>owner: **curator**</sub>

> ⚠️ **STALE** — review status `curated_candidate` (reviewed 2026-09-17 22:23:49.334560+00:00) predates the upstream re-run (2026-09-23 12:18:40.843049+00:00). Current validate status: `extracted`.
...
## Model component
<dbs-pgx drug="warfarin" model-id="Warfarin_Yuen2010_reference" status="extracted" stale="true" population="healthy Chinese and Indian volunteers" measured-compound="S-warfarin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Yuen_2010_metadata.yaml (2 record(s)); values are summary statistics, not a fitted model
...
| T3_output_variable | not captured | pass | C_central (measured=S-warfarin) | C_central | not captured | output must be the measured/analyte compartment |
...
- scholar stages: `../../../knowledgebase/drugs/drug_warfarin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Yuen_2010` / `Yuen_2010::reference`)
- model: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/Warfarin_Yuen2010_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/Warfarin_Yuen2010_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_warfarin/models/modelica/Warfarin_Yuen2010_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_warfarin/Warfarin_Yuen2010_reference/Warfarin_Yuen2010_reference_modelica.zip" download>Warfarin_Yuen2010_reference_modelica.zip</a> <span class="pk-size">(3.8 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_warfarin/Warfarin_Yuen2010_reference/Warfarin_Yuen2010_reference_matlab.zip" download>Warfarin_Yuen2010_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_warfarin/Warfarin_Yuen2010_reference/Warfarin_Yuen2010_reference_matlab_simbio.zip" download>Warfarin_Yuen2010_reference_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_warfarin/Warfarin_Yuen2010_reference/Warfarin_Yuen2010_reference_sbml.zip" download>Warfarin_Yuen2010_reference_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_warfarin/Warfarin_Yuen2010_reference/Warfarin_Yuen2010_reference_cellml.zip" download>Warfarin_Yuen2010_reference_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_warfarin/Warfarin_Yuen2010_reference/Warfarin_Yuen2010_reference.svg" alt="Warfarin_Yuen2010_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_warfarin/Warfarin_Yuen2010_reference/Warfarin_Yuen2010_reference_params.json" metaurl="assets/fmu/PK_1C_enteral.vr.json" wasmurl="assets/fmu/PK_1C_enteral.js" controlsurl="drugs/drug_warfarin/Warfarin_Yuen2010_reference/Warfarin_Yuen2010_reference_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Warfarin_Yuen2010_reference_params.json` · controls `Warfarin_Yuen2010_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
