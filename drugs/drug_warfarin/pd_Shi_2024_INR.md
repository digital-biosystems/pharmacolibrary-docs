...
# name — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.5). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Shi K; Deng J et al. (2024). Pharmacogenetics and genomics 34
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 0.0725 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q34]` | not captured | 0.24 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.0725 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q75]` | 0.24 | not captured | only_one_extracted |
