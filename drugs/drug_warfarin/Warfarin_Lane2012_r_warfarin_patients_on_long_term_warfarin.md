...
## Model component
<dbs-pgx drug="warfarin" model-id="Warfarin_Lane2012_r_warfarin_patients_on_long_term_warfarin" status="not_modelled" stale="false" population="patients on long-term warfarin therapy" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_warfarin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Lane_2012` / `Lane_2012::r_warfarin::patients on long-term warfarin therapy`)
