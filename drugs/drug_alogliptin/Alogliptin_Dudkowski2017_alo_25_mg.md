...
|---|---|---|---|---|---|---|---|---|---|---|
| AUEC0–24 (%·hr) | `Q19` · AUCt | —(suppressed) | %·hr | — | [h] · [%] | not captured | llm (0.6) | Tab3:row4:col5 | — | not captured |
| Cmax (ng/mL) | `Q32` · Cmax | —(suppressed) | ng/mL | — | [ng] / [ml] | not captured | exact (1.0) | Dudkowski_2017_table_2:row3:col3 | — | not captured |
| AUC0-inf (ng·hr./mL) | `Q17` · AUC∞ | —(suppressed) | ng·hr./mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Dudkowski_2017_table_2:row5:col3 | — | not captured |
| CL/F (L/hr) | `Q27` · CL/F | —(suppressed) | L/hr | — | [l] / [h] | not captured | exact (1.0) | Dudkowski_2017_table_2:row6:col3 | — | not captured |
| Vz/F (L) | `Q76` · V/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Dudkowski_2017_table_2:row7:col3 | — | not captured |
| T1/2 (hr) | `Q57` · t1/2z | —(suppressed) | hr | — | [h] | not captured | exact (1.0) | Dudkowski_2017_table_2:row8:col3 | — | not captured |
| CLr (L/hr) | `Q26` · CLR | —(suppressed) | L/hr | — | [l] / [h] | not captured | exact (1.0) | Dudkowski_2017_table_2:row9:col3 | — | not captured |
| Fe (%) | `Q44` · fe | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Dudkowski_2017_table_2:row10:col3 | — | not captured |
...
- dropped unlinked row (NIL): 'Number' — extend the ontology if this is a real PK parameter (source ['Tab3:row1:col5', 'Dudkowski_2017_table_2:row1:col3'])
- dropped PD-category row 'Emax (%)' → Q320 (Emax, category G11) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['Tab3:row3:col5'])
- unit_dimension_unknown: '%·hr' (AUCt)
- dropped unlinked row (NIL): 'E24 (%)' — extend the ontology if this is a real PK parameter (source ['Tab3:row5:col5'])
...
- scholar stages: `../../../knowledgebase/drugs/drug_alogliptin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Dudkowski_2017` / `Dudkowski_2017::alo_25_mg`)
