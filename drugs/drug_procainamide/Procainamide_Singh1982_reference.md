...
| elimination half-life | `Q57` · t1/2z | 1.7 | hr | 6120.0 | [h] | not captured | llm (0.6) | Singh_1982:abstract | — | not captured |
| elimination constant | `Q47` · kel | 1.2 | hr-1 | 0.0003333333333333333 | [1] / [h] | not captured | llm (0.6) | Singh_1982:abstract | — | not captured |
| plasma clearance | `Q22` · CL | 19.4 | ml/min/kg | 2.263333333333333e-05 | [ml] / [[min] · [kg]] | not captured | llm_confirmed (0.6) | Singh_1982:abstract | — | not captured |
| steady-state volume of distribution | `Q65` · Vss | 2.2 | l/kg | 0.154 | [l] / [kg] | not captured | llm_corrected (0.6) | Singh_1982:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Singh_1982_metadata.yaml (6 record(s)); values are summary statistics, not a fitted model
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[distribution half-life]` | 10.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[elimination constant]` | 1.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[elimination half-life]` | 1.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[plasma clearance]` | 19.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[steady-state volume of distribution]` | 2.2 | not captured | only_one_extracted |
...
| C5_dimension_Q59 | pass | [time] | not captured | not captured | not captured | ['Singh_1982:abstract'] |
| C5_dimension_Q65 | pass | [length] ** 3 | not captured | not captured | not captured | ['Singh_1982:abstract'] |
