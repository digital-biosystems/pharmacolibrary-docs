...
| T3_output_variable | not captured | pass | C_central (measured=procainamide) | central.C | not captured | output must be the measured/analyte compartment |
...
- scholar stages: `../../../knowledgebase/drugs/drug_procainamide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Grasela_1984` / `Grasela_1984::reference`)
- model: `../../../knowledgebase/drugs/drug_procainamide/models/modelica/Procainamide_Grasela1984_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_procainamide/models/modelica/Procainamide_Grasela1984_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_procainamide/models/modelica/Procainamide_Grasela1984_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_procainamide/Procainamide_Grasela1984_reference/Procainamide_Grasela1984_reference_modelica.zip" download>Procainamide_Grasela1984_reference_modelica.zip</a> <span class="pk-size">(3.6 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_procainamide/Procainamide_Grasela1984_reference/Procainamide_Grasela1984_reference_matlab.zip" download>Procainamide_Grasela1984_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C` · parameters `Procainamide_Grasela1984_reference_params.json` · controls `Procainamide_Grasela1984_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
