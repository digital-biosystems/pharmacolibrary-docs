...
| E max (%HbA1c @ steady-state) | `Q320` · not captured | -0.738 | %HbA1c @ steady-state | not captured | llm (not captured) | tab_1:row9:col1 |
| E max (%HbA1c @ steady-state) — Estimate Std. Error | `Q320` · not captured | 0.070 | %HbA1c @ steady-state | not captured | llm (not captured) | tab_1:row9:col2 |
