...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F (L/h/70 kg) | `Q27` · CL/F | —(suppressed) | L/h/70 kg | — | [l] / [[h] · [70kg]] | not captured | exact (1.0) | tab_3:row3:col1, tab_3:row3:col4, tab_3:row3:col5, tab_3:row3:col6 | — | not captured |
| V/F (L) | `Q76` · V/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | tab_3:row4:col1, tab_3:row4:col4, tab_3:row4:col5, tab_3:row4:col6 | — | not captured |
| Ka (1/h) | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | tab_3:row5:col1, tab_3:row5:col4, tab_3:row5:col5, tab_3:row5:col6 | — | not captured |
| egfr_on_cl_f | `Q900` · egfr_on_cl_f | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | tab_3:row7:col1, tab_3:row7:col4, tab_3:row7:col5, tab_3:row7:col6 | — | not captured |
...
| T1_cmax | reference | fail | 0.0007866 | 0.00010374968018917292 | 0.1319 | μg/L→SI vs simulated kg/m3 |
| T1_cmax | reference | fail | 0.0012439999999999999 | 0.00010374968018917292 | 0.0834 | μg/L→SI vs simulated kg/m3 |
...
- model: `../../../knowledgebase/drugs/drug_metformin/models/modelica/Metformin_Ailabouni2026_final_model_estimate.mo`
- deviation: `../../../knowledgebase/drugs/drug_metformin/models/modelica/Metformin_Ailabouni2026_final_model_estimate.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_metformin/models/modelica/Metformin_Ailabouni2026_final_model_estimate.json`
...
<img src="drugs/drug_metformin/Metformin_Ailabouni2026_final_model_estimate/Metformin_Ailabouni2026_final_model_estimate.svg" alt="Metformin_Ailabouni2026_final_model_estimate diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_1C_enteral` · parameters `Metformin_Ailabouni2026_final_model_estimate_params.json` · controls `Metformin_Ailabouni2026_final_model_estimate_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
