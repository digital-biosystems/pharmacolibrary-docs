...
## Model component
<dbs-pgx drug="metformin" model-id="Metformin_Ailabouni2026_850_mg" status="extracted" stale="false" population="pediatric patients with type 2 diabetes" measured-compound="metformin" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|
| AUC (0-12 h) (µg*h/L) | Q19 | not captured | llm_corrected |
| C max (µg/L) | Q32 | not captured | llm |
...
| C5_dimension_Q19 | pass | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['Ailabouni_2026_table_2:row0:col3'] |
