...
## Model component
<dbs-pgx drug="metformin" model-id="Metformin_Chae2012_reference" status="extracted" stale="false" population="healthy humans" measured-compound="metformin" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (l h -1 ) Apparent clearance | `Q27` · CL/F | 52.6 | l h -1 | 1.4611111111111112e-05 | L/h | not captured | review (0.7) | Chae_2012:review | — | not captured |
| V (l) Apparent volume of distribution | `Q76` · V/F | 113.0 | l | 0.113 | L | not captured | review (0.7) | Chae_2012:review | — | not captured |
| Ka (h -1 ) Absorption rate constant | `Q49` · kabs | 0.41 | h -1 | 0.00011388888888888888 | 1/h | not captured | review (0.7) | Chae_2012:review | — | not captured |
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_metformin/Metformin_Chae2012_reference/Metformin_Chae2012_reference_fmi.zip" download>Metformin_Chae2012_reference_fmi.zip</a> <span class="pk-size">(1.2 MB)</span></td></tr>
