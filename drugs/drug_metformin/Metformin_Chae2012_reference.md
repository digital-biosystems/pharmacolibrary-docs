<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;A10B&quot;,&quot;href&quot;:&quot;atc/A10B.md&quot;},{&quot;label&quot;:&quot;metformin&quot;,&quot;href&quot;:&quot;drugs/drug_metformin/&quot;},{&quot;label&quot;:&quot;Chae_2012 \u00b7 review reference&quot;}]"></div>
...
## Model component
<dbs-pgx drug="metformin" model-id="Metformin_Chae2012_reference" status="not_modelled" stale="false" population="healthy humans" measured-compound="metformin" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (l h -1 ) Apparent clearance | `Q27` · CL/F | —(suppressed) | l h -1 | — | L/h | not captured | review (0.7) | Chae_2012:review | — | not captured |
| V (l) Apparent volume of distribution | `Q76` · V/F | —(suppressed) | l | — | L | not captured | review (0.7) | Chae_2012:review | — | not captured |
| Ka (h -1 ) Absorption rate constant | `Q49` · kabs | —(suppressed) | h -1 | — | 1/h | not captured | review (0.7) | Chae_2012:review | — | not captured |
...
- built from REVIEW reference values (Chae_2012) — secondary source
...
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Chae_2012:review'] |
...
| C9_phys_window_Q76 | pass | volume within physiological range | 113 L | not captured | not captured | ['Chae_2012:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_metformin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Chae_2012` / `Chae_2012::review reference`)
- sim: `../../../knowledgebase/drugs/drug_metformin/models/modelica/Metformin_Chae2012_review_reference.json`
...
<img src="drugs/drug_metformin/Metformin_Chae2012_reference/Metformin_Chae2012_reference.svg" alt="Metformin_Chae2012_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_metformin/Metformin_Chae2012_reference/Metformin_Chae2012_reference_modelica.zip" download>Metformin_Chae2012_reference_modelica.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_metformin/Metformin_Chae2012_reference/Metformin_Chae2012_reference_matlab.zip" download>Metformin_Chae2012_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_metformin/Metformin_Chae2012_reference/Metformin_Chae2012_reference_sbml.zip" download>Metformin_Chae2012_reference_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
