...
|---|---|---|---|---|---|---|---|---|---|---|
| T max (h) | `Q56` · tmax | —(suppressed) | h | — | [h] | not captured | space_fold (0.95) | T4:row1:col4 | — | not captured |
| T 1/2 (h) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | space_fold (0.95) | T4:row3:col4 | — | not captured |
