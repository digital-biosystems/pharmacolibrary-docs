...
|---|---|---|---|---|---|---|
| A (mcg/min) | `Q900` · not captured | 1.89e+04 | mcg/min | not captured | llm (not captured) | T1:row1:col1 |
| A (mcg/min) | `Q900` · not captured | 0.1 | mcg/min | not captured | llm (not captured) | T1:row1:col3 |
