...
|---|---|---|---|---|---|---|---|---|---|---|
| θCLNR/F (L h-1) | `Q79` · CLNR | —(suppressed) | L h-1 | — | [l] / [h] | not captured | llm_confirmed (0.6) | Sinnappah_2020_table_p4_1:row0:col1 | — | not captured |
| θCLR/F (L h-1) | `Q26` · CLR | —(suppressed) | L h-1 | — | [l] / [h] | not captured | llm_confirmed (0.6) | Sinnappah_2020_table_p4_1:row1:col1 | — | not captured |
| θQ/F (L h-1) | `Q69` · Q/F | —(suppressed) | L h-1 | — | [l] / [h] | not captured | llm_confirmed (0.6) | Sinnappah_2020_table_p4_1:row3:col1 | — | not captured |
| θV2/F (L) | `Q290` · V1/F | —(suppressed) | L | — | [l] | not captured | caption_compartment (0.9) | Sinnappah_2020_table_p4_1:row4:col1 | — | not captured |
| θV3/F (L) | `Q82` · V2/F | —(suppressed) | L | — | [l] | not captured | caption_compartment (0.9) | Sinnappah_2020_table_p4_1:row5:col1 | — | not captured |
| θka (h-1) | `Q49` · kabs | —(suppressed) | h-1 | — | [1] / [h] | not captured | llm_confirmed (0.6) | Sinnappah_2020_table_p4_1:row6:col1 | — | not captured |
| θF1 | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Sinnappah_2020_table_p4_1:row8:col1 | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_metformin/models/modelica/Metformin_Sinnappah2020_duong_et_al4.mo`
- deviation: `../../../knowledgebase/drugs/drug_metformin/models/modelica/Metformin_Sinnappah2020_duong_et_al4.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_metformin/models/modelica/Metformin_Sinnappah2020_duong_et_al4.json`
...
<img src="drugs/drug_metformin/Metformin_Sinnappah2020_duong_et_al4/Metformin_Sinnappah2020_duong_et_al4.svg" alt="Metformin_Sinnappah2020_duong_et_al4 diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_metformin/Metformin_Sinnappah2020_duong_et_al4/Metformin_Sinnappah2020_duong_et_al4_fmi.zip" download>Metformin_Sinnappah2020_duong_et_al4_fmi.zip</a> <span class="pk-size">(4.2 kB)</span><br><a href="models/fmu/PK_2C_enteral.fmu" download>PK_2C_enteral.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
...
<dbs-fmusim paramsurl="drugs/drug_metformin/Metformin_Sinnappah2020_duong_et_al4/Metformin_Sinnappah2020_duong_et_al4_params.json" metaurl="assets/fmu/PK_2C_enteral.vr.json" wasmurl="assets/fmu/PK_2C_enteral.js" controlsurl="drugs/drug_metformin/Metformin_Sinnappah2020_duong_et_al4/Metformin_Sinnappah2020_duong_et_al4_sim_controls.json"></dbs-fmusim>

<sub>Template `PK_2C_enteral` · parameters `Metformin_Sinnappah2020_duong_et_al4_params.json` · controls `Metformin_Sinnappah2020_duong_et_al4_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
