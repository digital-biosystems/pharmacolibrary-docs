...
## Model component
<dbs-pgx drug="metformin" model-id="Metformin_Patel2019_met" status="rejected" stale="false" population="Wistar rats" measured-compound="atorvastatin, metformin" parameterization="apparent" topology="3C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| T max (h) | `Q56` · tmax | —(suppressed) | h | — | [h] | not captured | llm (0.6) | T4:row1:col3 | — | not captured |
| T 1/2 (h) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | llm (0.6) | T4:row3:col3 | — | not captured |
