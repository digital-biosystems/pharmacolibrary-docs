...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (ng/mL) | `Q32` · Cmax | —(suppressed) | ng/mL | — | [ng] / [ml] | not captured | exact (1.0) | Jacobs_2026_table_2:row2:col3 | — | not captured |
| Tmax (h) | `Q56` · tmax | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Jacobs_2026_table_2:row3:col3 | — | not captured |
| AUCinf (h * ng/mL) | `Q17` · AUC∞ | —(suppressed) | h * ng/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Jacobs_2026_table_2:row4:col3 | — | not captured |
| AUC % extrap | `Q84` · AUC%ext | —(suppressed) | not captured | — | not captured | not captured | llm_corrected (0.6) | Jacobs_2026_table_2:row5:col3 | — | not captured |
| Bioavailability (%) | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Jacobs_2026_table_2:row6:col3 | — | not captured |
| Terminal t1/2 (h) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Jacobs_2026_table_2:row9:col3 | — | not captured |
| CL | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | review_gapfill (0.7) | Choi_2025:review | — | not captured |
...
<img src="drugs/drug_metformin/Metformin_Jacobs2026_oral/Metformin_Jacobs2026_oral.svg" alt="Metformin_Jacobs2026_oral diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
