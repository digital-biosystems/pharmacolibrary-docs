...
## Model component
<dbs-pgx drug="metformin" model-id="Metformin_Pentikinen1979_reference" status="model_quarantined" stale="false" population="healthy subjects" measured-compound="metformin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| elimination half-life from plasma | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Pentikäinen_1979:abstract | — | not captured |
| renal clearance | `Q26` · CLR | —(suppressed) | ml/min | — | [ml] / [min] | not captured | exact (1.0) | Pentikäinen_1979:abstract | — | not captured |
...
- dropped duplicate Q57 ('terminal elimination phase with a half-life', value 8.9) — already have one for this compound
...
- model: `../../../knowledgebase/drugs/drug_metformin/models/modelica/_needs_review/Metformin_Pentikinen1979_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_metformin/models/modelica/_needs_review/Metformin_Pentikinen1979_reference.deviation.json`
