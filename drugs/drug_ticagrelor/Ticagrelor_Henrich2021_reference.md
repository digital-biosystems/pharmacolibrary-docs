...
## Model component
<dbs-pgx drug="ticagrelor" model-id="Ticagrelor_Henrich2021_reference" status="not_modelled" stale="false" population="" measured-compound="ticagrelor" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_ticagrelor/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Henrich_2021` / `Henrich_2021::review reference`)
- sim: `../../../knowledgebase/drugs/drug_ticagrelor/models/modelica/Ticagrelor_Henrich2021_review_reference.json`
