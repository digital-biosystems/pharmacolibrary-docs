...
## Model component
<dbs-pgx drug="eltrombopag" model-id="Eltrombopag_Farrell2014_reference" status="not_modelled" stale="false" population="healthy volunteers and subjects with chronic liver disease" measured-compound="eltrombopag" parameterization="apparent" topology="2C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_eltrombopag/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Farrell_2014` / `Farrell_2014::healthy volunteers and subjects with chronic liver disease`)
- sim: `../../../knowledgebase/drugs/drug_eltrombopag/models/modelica/Eltrombopag_Farrell2014_healthy_volunteers_and_subjects_with.json`
