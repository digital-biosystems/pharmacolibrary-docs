...
|---|---|---|---|---|---|---|---|---|---|---|
| estimated mean half-life | `Q57` · t1/2z | 32.7 | hours | 117720.00000000001 | [h] | not captured | llm (0.6) | Bernstein_2010:abstract | — | not captured |
| estimated mean clearance | `Q22` · CL | 0.92 | mL/kg/h | 1.7888888888888888e-08 | [ml] / [[h] · [kg]] | not captured | llm_confirmed (0.6) | Bernstein_2010:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Bernstein_2010_metadata.yaml (2 record(s)); values are summary statistics, not a fitted model
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Bernstein_2010:abstract'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Bernstein_2010:abstract'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 0.92 | not captured | not captured | ['Bernstein_2010:abstract'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.0644 L/h | not captured | not captured | ['Bernstein_2010:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_c1_inhibitor_plasma_derived/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Bernstein_2010` / `Bernstein_2010::reference`)
