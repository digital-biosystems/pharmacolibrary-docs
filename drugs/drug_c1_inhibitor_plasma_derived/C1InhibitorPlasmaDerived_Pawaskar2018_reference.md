...
|---|---|---|---|---|---|---|---|---|---|---|
| mean population bioavailability of C1-INH (SC) | `Q40` · Fab | 43 | % | not captured | not captured | not captured | llm_confirmed (0.6) | Pawaskar_2018:abstract | — | not captured |
| clearance (CL) | `Q22` · CL | 1.03 | mL/hour/kg | 2.0027777777777774e-08 | [ml] / [[h] · [kg]] | not captured | exact (1.0) | Pawaskar_2018:abstract | — | not captured |
| volume of distribution | `Q61` · V | 0.05 | L/kg | 0.0035 | [l] / [kg] | not captured | exact (1.0) | Pawaskar_2018:abstract | — | not captured |
| absorption rate | `Q49` · kabs | 0.0146 | hour-1 | 4.055555555555556e-06 | [1] / [h] | not captured | exact (1.0) | Pawaskar_2018:abstract | — | not captured |
| median time to peak concentration | `Q56` · tmax | 59 | hours | 212400.0 | [h] | not captured | llm_confirmed (0.6) | Pawaskar_2018:abstract | — | not captured |
| median apparent plasma half-life | `Q57` · t1/2z | 69 | hours | 248400.0 | [h] | not captured | llm (0.6) | Pawaskar_2018:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Pawaskar_2018_metadata.yaml (7 record(s)); values are summary statistics, not a fitted model
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Pawaskar_2018:abstract'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Pawaskar_2018:abstract'] |
| C5_dimension_Q56 | pass | [time] | not captured | not captured | not captured | ['Pawaskar_2018:abstract'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Pawaskar_2018:abstract'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Pawaskar_2018:abstract'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 1.03 | not captured | not captured | ['Pawaskar_2018:abstract'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.0721 L/h | not captured | not captured | ['Pawaskar_2018:abstract'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 3.5 L | not captured | not captured | ['Pawaskar_2018:abstract'] |
...
| T3_output_variable | not captured | pass | C_central (measured=C1-inhibitor functional activity) | central.C | not captured | output must be the measured/analyte compartment |
...
- scholar stages: `../../../knowledgebase/drugs/drug_c1_inhibitor_plasma_derived/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Pawaskar_2018` / `Pawaskar_2018::reference`)
- model: `../../../knowledgebase/drugs/drug_c1_inhibitor_plasma_derived/models/modelica/C1InhibitorPlasmaDerived_Pawaskar2018_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_c1_inhibitor_plasma_derived/models/modelica/C1InhibitorPlasmaDerived_Pawaskar2018_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_c1_inhibitor_plasma_derived/models/modelica/C1InhibitorPlasmaDerived_Pawaskar2018_reference.json`
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_c1_inhibitor_plasma_derived/C1InhibitorPlasmaDerived_Pawaskar2018_reference/C1InhibitorPlasmaDerived_Pawaskar2018_reference_sbml.zip" download>C1InhibitorPlasmaDerived_Pawaskar2018_reference_sbml.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_c1_inhibitor_plasma_derived/C1InhibitorPlasmaDerived_Pawaskar2018_reference/C1InhibitorPlasmaDerived_Pawaskar2018_reference_cellml.zip" download>C1InhibitorPlasmaDerived_Pawaskar2018_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_c1_inhibitor_plasma_derived/C1InhibitorPlasmaDerived_Pawaskar2018_reference/C1InhibitorPlasmaDerived_Pawaskar2018_reference.svg" alt="C1InhibitorPlasmaDerived_Pawaskar2018_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `C1InhibitorPlasmaDerived_Pawaskar2018_reference_params.json` · controls `C1InhibitorPlasmaDerived_Pawaskar2018_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
