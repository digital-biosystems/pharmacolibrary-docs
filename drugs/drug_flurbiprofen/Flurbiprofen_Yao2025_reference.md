...
## Model component
<dbs-pgx drug="flurbiprofen" model-id="Flurbiprofen_Yao2025_reference" status="extracted" stale="false" population="selective joint replacement patients with postoperative pain" measured-compound="R(-)-flurbiprofen and S(+)-flurbiprofen" parameterization="mechanistic" topology="1C"></dbs-pgx>
