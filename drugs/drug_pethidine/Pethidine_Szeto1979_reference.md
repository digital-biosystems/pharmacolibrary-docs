...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[the elimination half-life of meperidine in the fetus]` (32.6 vs not captured) and 1 more field(s) — not a structural parameter.
**How to address:** not a curation fix — the pipeline is the limit here (fulltext: the record was built from the abstract alone, so reported summary statistics stood in for a fitted model).
<sub>owner: **curator**</sub>

## Citation
Szeto HH; Kaiko RF; Clapp JF; Larrow RW; Mann LI; Inturrisi CE et al. (1979). The Journal of pharmacology and experimental therapeutics 209
...
|---|---|---|---|---|---|---|---|---|---|---|
| The elimination half-life of meperidine in the fetus | `Q57` · t1/2z | 32.6 | min | 1956.0 | [min] | not captured | llm (0.6) | Szeto_1979:abstract, Szeto_1979:abstract | — | not captured |
...
|---|---|---|---|
| The renal clearance of meperidine by the fetus | Q26 | not captured | llm_confirmed |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Szeto_1979_metadata.yaml (3 record(s)); values are summary statistics, not a fitted model
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[the elimination half-life of meperidine in the fetus]` | 32.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[the renal clearance of meperidine by the fetus]` | not captured | not captured | only_one_extracted |
...
| C5_dimension_Q26 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Szeto_1979:abstract'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Szeto_1979:abstract', 'Szeto_1979:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_pethidine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Szeto_1979` / `Szeto_1979::reference`)
