...
- built from REVIEW reference values (Groll_2019) — secondary source
...
- scholar stages: `../../../knowledgebase/drugs/drug_pethidine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Groll_2019` / `Groll_2019::reference`)
