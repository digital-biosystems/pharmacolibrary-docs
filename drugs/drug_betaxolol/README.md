...
|---|---|---|---|
| absorption | liver | <sub>“…f an oral dose is complete. There is a small and consistent first-pass effect resulting in…”</sub> | prose |
...
<sub>Actors without a tissue in the table: ADRA1A (target), ADRB1 (target), ADRB2 (target).</sub>
