...
# best corrected visual acuity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.444). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.444 (16/36 fields) | 20 |
...
| `gpt-oss:120b` | `parameters[Q364]` | not captured | 0.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q364]` | not captured | 0.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 0.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | -15.1 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q38]` | not captured | -1.1 | only_one_extracted |
