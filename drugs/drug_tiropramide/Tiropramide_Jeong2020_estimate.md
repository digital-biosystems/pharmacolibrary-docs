...
|---|---|---|---|---|---|---|---|---|---|---|
| tvKa1 (1/h) | `Q95` · t1/2ka | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | pharmaceutics-12-00374-t006:row2:col1, pharmaceutics-12-00374-t006:row14:col1 | — | not captured |
| tvCL/F (mL/h) | `Q27` · CL/F | —(suppressed) | mL/h | — | [ml] / [h] | not captured | tv_prefix (0.95) | pharmaceutics-12-00374-t006:row5:col1, pharmaceutics-12-00374-t006:row17:col1 | — | not captured |
| tvTlag (h) | `Q83` · tlag | —(suppressed) | h | — | [h] | not captured | tv_prefix (0.95) | pharmaceutics-12-00374-t006:row6:col1, pharmaceutics-12-00374-t006:row18:col1 | — | not captured |
