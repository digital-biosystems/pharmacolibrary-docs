...
## Model component
<dbs-pgx drug="tiropramide" model-id="Tiropramide_Jeong2020_iiv" status="rejected" stale="false" population="healthy Korean adults" measured-compound="tiropramide" parameterization="apparent" topology="1C"></dbs-pgx>
...
- population split: 'iiv (%)' subgroup of Jeong_2020 (paper reports 8 populations: 1236c&gt;t, 1287g&gt;c, 2677g&gt;t/a, 3435c&gt;t, 808g&gt;t, estimate, iiv (%), shrinkage (%))
...
- scholar stages: `../../../knowledgebase/drugs/drug_tiropramide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Jeong_2020` / `Jeong_2020::iiv`)
