...
## Citation
Yang Z; Guo L; Zhou C; Wang X; Yu M; Xul M; et al. et al. (2020). Journal of pesticide science 45
...
| `gpt-oss:120b` | `parameters[Q322]` | 3.18 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 30.03 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 10.47 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 4.95 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 11.18 | not captured | only_one_extracted |
