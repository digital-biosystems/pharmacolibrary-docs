...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-19 09:32 | 26:39 | 0/0/0 | 1/2/2 | 0/1/0 | 884,877/15,207 | ollama / qwen3.8:27b-mtp-q8_0 | 55 | 7/48 | 54/1 | 0 |
...
<sub>queue written 2026-09-19T09:24:42.758852+00:00</sub>
...
| PGx | Alayed_2024 | not_relevant | 0 | 0 | The paper describes a case of Carbonic Anhydrase II deficiency and the use of sodium bicarbonate for treatment, but it does not report a pharmacogenomic study analyzing how the CA2 genotype alters the pharmacokinetics or pharmacodynamics of sodium bicarbonate. |
...
| popPK | Beffinger_2025 | irrelevant | 0 | 0 | The paper studies the pharmacokinetics of IL-12Fc fusion proteins in glioblastoma models, not sodium bicarbonate. |
...
| popPK | Biju_2026 | irrelevant | 0 | 0 | The paper is a review on bacterial endophytes and drug discovery, and sodium bicarbonate is only mentioned as a sterilization agent, not as a subject drug for pharmacokinetic analysis. |
...
| PGx | Islam_2015 | not_relevant | 0 | 0 | The paper investigates the effect of storage temperature on cell viability and morphology, not the effect of a gene variant on the pharmacokinetics or pharmacodynamics of sodium bicarbonate. |
| popPK | Isono_2021 | irrelevant | 0 | 0 | The study reports population pharmacokinetic parameters for methotrexate, while sodium bicarbonate is only mentioned as a co-administered agent for urine alkalinization. |
...
| popPK | Iuga_2026 | irrelevant | 0 | 0 | The paper describes the synthesis and biological evaluation of SARS-CoV-2 papain-like protease inhibitors and does not involve sodium bicarbonate or pharmacokinetic studies. |
...
| popPK | Kang_2026 | irrelevant | 0 | 0 | The paper is a computational study on drug-food interaction prediction using knowledge graphs and does not report pharmacokinetic parameters for sodium bicarbonate. |
...
| PGx | Khairy_2016 | not_relevant | 0 | 0 | The paper studies the effect of sodium nitroprusside on tobacco plants, not the pharmacogenomics of sodium bicarbonate in humans. |
...
| PGx | Kyan_2026 | not_relevant | 0 | 0 | The paper is a case report of atomoxetine overdose and does not report any pharmacogenomic effects on sodium bicarbonate PK/PD. |
...
| popPK | Li_2025_2 | irrelevant | 0 | 0 | The paper is a mechanistic study of europium complex binding to proteins, where sodium bicarbonate is used only as a comparative anion ligand, not as a subject drug for pharmacokinetic analysis. |
...
| popPK | M_2026 | irrelevant | 0 | 0 | The paper focuses on the synthesis and antioxidant activity of cyclic dipeptides and does not involve sodium bicarbonate or pharmacokinetic parameters. |
...
| popPK | Maiga_2025 | irrelevant | 0 | 0 | The paper is an in-vitro pharmacodynamic study of antimalarial drugs (DHA, CQ, ATO, PYRI) and does not involve sodium bicarbonate or report any pharmacokinetic parameters for it. |
...
| PGx | Ovaska_2010 | not_relevant | 0 | 0 | The paper is a case report on propafenone poisoning and does not report pharmacogenomic effects on sodium bicarbonate PK/PD. |
...
| popPK | Pozo_2026 | irrelevant | 0 | 0 | The paper is an in-vitro metabolomics study on glycine metabolism in hepatocytes and does not report pharmacokinetic parameters for sodium bicarbonate. |
...
| popPK | Thakre_2026 | irrelevant | 0 | 0 | The paper investigates neuroplasticity mechanisms involving ampakines and hypoxia in rats and does not involve sodium bicarbonate or pharmacokinetic parameters. |
...
| popPK | Thomas_2026 | irrelevant | 0 | 0 | The paper describes a gold-based PROTAC and protein degradation kinetics in cell lines, containing no pharmacokinetic data for sodium bicarbonate. |
...
| popPK | Zhou_2025 | irrelevant | 0 | 0 | The paper is a proteomic study of blood-brain barrier transporters and does not report pharmacokinetic parameters for sodium bicarbonate. |
