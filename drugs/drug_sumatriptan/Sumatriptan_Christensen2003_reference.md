...
- apparent-ness (ontology-grounded): parameterization=apparent, measured_compound=sumatriptan
...
| `gpt-oss:120b` | `parameters[auc infinity]` | 57.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[cl/f]` | 316 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[cmax]` | 13.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[t1/2]` | 2.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[vd/f]` | 1070 | not captured | only_one_extracted |
...
| C9_phys_window_Q76 | pass | volume within physiological range | 1.07e+03 L | not captured | not captured | ['Christensen_2003:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_sumatriptan/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Christensen_2003` / `Christensen_2003::reference`)
