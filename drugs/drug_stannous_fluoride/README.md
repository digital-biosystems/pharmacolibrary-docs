...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-18 03:25 | 6:26 | 0/0/0 | 1/0/0 | 0/0/0 | 145,595/4,757 | ollama / qwen3.8:27b-mtp-q8_0 | 7 | 1/6 | 7/0 | 0 |
...
<sub>queue written 2026-09-18T03:25:02.298360+00:00</sub>
...
| popPK | Fisher_2003 | irrelevant | 0 | 0 | The paper evaluates anticaries efficacy and fluoride uptake in enamel, not systemic pharmacokinetic parameters (CL, V, etc.) for stannous fluoride. |
...
| popPK | Kong_2011 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for the radiotracer 99mTc-PQQ, not for stannous fluoride, which is used only as a reagent for radiolabeling. |
