...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h)a | `Q22` · CL | —(suppressed) | not captured | — | not captured | 21 | llm_confirmed (0.6) | Tab2:row1:col2, Tab2:row1:col3 | — | not captured |
| Vc (L)a | `Q63` · V1 | —(suppressed) | not captured | — | not captured | 16 | llm_confirmed (0.6) | Tab2:row2:col2, Tab2:row2:col3 | — | 78.3 (21% RSE) |
| Q (L/h)a | `Q30` · Q | —(suppressed) | not captured | — | not captured | 14 | llm (0.6) | Tab2:row3:col2, Tab2:row3:col3 | — | not captured |
| Vp (L)a | `Q64` · V2 | —(suppressed) | not captured | — | not captured | 20 | llm_confirmed (0.6) | Tab2:row4:col2, Tab2:row4:col3 | — | not captured |
| LAGT (h) | `Q83` · tlag | —(suppressed) | h | — | [h] | 18 | llm (0.6) | Tab2:row5:col2, Tab2:row5:col3 | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_vincristine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Centanni_2024` / `Centanni_2024::reference`)
- model: `../../../knowledgebase/drugs/drug_vincristine/models/modelica/_needs_review/Vincristine_Centanni2024_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_vincristine/models/modelica/_needs_review/Vincristine_Centanni2024_reference.deviation.json`
