...
## Model component
<dbs-pgx drug="gabapentin" model-id="Gabapentin_AlZubaydi2024_reference" status="needs_review" stale="false" population="hospitalized adults" measured-compound="gabapentin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| ka (h−1) | `Q49` · kabs | —(suppressed) | h−1 | — | [1] / [h] | not captured | exact (1.0) | pharmaceutics-16-01514-t002:row2:col1, pharmaceutics-16-01514-t002:row2:col2 | — | not captured |
| Vd (L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | exact (1.0) | pharmaceutics-16-01514-t002:row3:col1 | — | not captured |
| Cl (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | pharmaceutics-16-01514-t002:row4:col1 | — | not captured |
...
**Extraction notes:**
- unparsed cell pharmaceutics-16-01514-t002:row3:col2 = '45.99 (32.84–65.91)'
- unparsed cell pharmaceutics-16-01514-t002:row4:col2 = '7.01 (4.3–12.54)'
- unparsed cell pharmaceutics-16-01514-t002:row5:col2 = '−1.12 ((−1.66)–(−0.58))'
- unparsed cell pharmaceutics-16-01514-t002:row7:col2 = '0.75 (0.42–1.07)'
- unparsed cell pharmaceutics-16-01514-t002:row8:col2 = '0.26 (0.11–0.48)'
- unparsed cell pharmaceutics-16-01514-t002:row10:col2 = '1.93 (1.1–2.65)'
...
- scholar stages: `../../../knowledgebase/drugs/drug_gabapentin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Al-Zubaydi_2024` / `Al-Zubaydi_2024::reference`)
- model: `../../../knowledgebase/drugs/drug_gabapentin/models/modelica/Gabapentin_AlZubaydi2024_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_gabapentin/models/modelica/Gabapentin_AlZubaydi2024_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_gabapentin/models/modelica/Gabapentin_AlZubaydi2024_reference.json`
...
<img src="drugs/drug_gabapentin/Gabapentin_AlZubaydi2024_reference/Gabapentin_AlZubaydi2024_reference.svg" alt="Gabapentin_AlZubaydi2024_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_gabapentin/Gabapentin_AlZubaydi2024_reference/Gabapentin_AlZubaydi2024_reference_modelica.zip" download>Gabapentin_AlZubaydi2024_reference_modelica.zip</a> <span class="pk-size">(3.9 kB)</span></td></tr>
...
<sub>Template `PK_1C_enteral` · parameters `Gabapentin_AlZubaydi2024_reference_params.json` · controls `Gabapentin_AlZubaydi2024_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
