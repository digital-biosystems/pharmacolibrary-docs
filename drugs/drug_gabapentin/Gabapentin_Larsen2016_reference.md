...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl]` | 160.67 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[k m]` | 44.1 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[v max]` | 41.9 | not captured | only_one_extracted |
