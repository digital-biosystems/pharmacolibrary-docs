...
| OCT2 on ke1 — Final estimate (%RSE) | `Q47` · not captured | -2.44 | not captured | not captured | llm (not captured) | T1:row10:col1 |
...
| ke2 (h-1) — Final estimate (%RSE) | `Q47` · not captured | 1 | h-1 | not captured | llm (not captured) | T1:row13:col1 |
...
| ωQ — Final estimate (%RSE) | `Q30` · not captured | 0.64 | not captured | not captured | llm (not captured) | T1:row20:col1 |
