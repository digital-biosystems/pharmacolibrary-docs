<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;N02B&quot;,&quot;href&quot;:&quot;atc/N02B.md&quot;},{&quot;label&quot;:&quot;gabapentin&quot;,&quot;href&quot;:&quot;drugs/drug_gabapentin/&quot;},{&quot;label&quot;:&quot;Ahmed_2017 \u00b7 reference&quot;}]"></div>
...
# gabapentin — `Gabapentin_Ahmed2017_reference`
...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[gbp cl in elderly nursing home patients]` (2.93 vs not captured) and 2 more field(s) — a structural parameter, so the record is disputed.
**How to address:** not a curation fix — the pipeline is the limit here (fulltext: the record was built from the abstract alone, so reported summary statistics stood in for a fitted model).
<sub>owner: **curator**</sub>

## Citation
Ahmed GF; Bathena SP; Brundage RC; Leppik IE; Conway JM; Schwartz JB; et al. et al. (2017). The AAPS journal 19
  ·  DOI: [10.1208/s12248-016-0022-z](https://doi.org/10.1208/s12248-016-0022-z)

## Model component
<dbs-pgx drug="gabapentin" model-id="Gabapentin_Ahmed2017_reference" status="needs_review" stale="false" population="elderly nursing home patients" measured-compound="gabapentin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| GBP CL in elderly nursing home patients | `Q22` · CL | 2.93 | L/h | 8.13888888888889e-07 | [l] / [h] | not captured | llm_confirmed (0.6) | Ahmed_2017:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Ahmed_2017_metadata.yaml (2 record(s)); values are summary statistics, not a fitted model
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[gbp cl in elderly nursing home patients]` | 2.93 | not captured | only_one_extracted |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Ahmed_2017:abstract'] |
...
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 2.93 | not captured | not captured | ['Ahmed_2017:abstract'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 2.93 L/h | not captured | not captured | ['Ahmed_2017:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_gabapentin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ahmed_2017` / `Ahmed_2017::reference`)
