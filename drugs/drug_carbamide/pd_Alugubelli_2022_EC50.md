...
# Antiviral potency (plaque reduction) — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Alugubelli YR; Geng ZZ; Yang KS; Shaabani N; Khatua K; Ma XR; et al. et al. (2022). European journal of medicinal chemistry 240
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | boceprevir-based MPro inhibitors (e.g. MPI40, MPI43, MPI44, MPI46) | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | 3.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 7.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 7.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 2.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.37 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.31 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.74 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.14 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 1.30 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q322]` | 9.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 40 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 360 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q322]` | 370 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 720 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 720 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q322]` | 45 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 59 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 97 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 120 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 34.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 143.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 163.4 | not captured | only_one_extracted |
...
---
<sub>← back to [carbamide](drugs/drug_carbamide/)</sub>
