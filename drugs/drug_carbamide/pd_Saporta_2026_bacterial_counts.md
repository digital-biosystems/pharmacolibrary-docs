...
## Citation
Saporta R; Tassi N; Biordi V; Ticha O; Ginosyan A; Loryan I; Nielsen EI; Bekeredjian-Ding I; Kerscher B; Friberg LE et al. (2026). Antimicrobial agents and chemotherapy 70
...
| k a — Estimate | `Q49` · not captured | 71.3 | not captured | not captured | space_fold (not captured) | T1:row5:col3 |
| k a — RSE (%) | `Q49` · not captured | 39 | not captured | not captured | space_fold (not captured) | T1:row5:col4 |
...
| E max — Estimate | `Q320` · not captured | 0.934 | not captured | not captured | space_fold (not captured) | T1:row16:col3 |
| E max — RSE (%) | `Q320` · not captured | 14 | not captured | not captured | space_fold (not captured) | T1:row16:col4 |
...
| `gpt-oss:120b` | `parameters[Q22]` | 5.33 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | 11 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 0.385 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 19 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 2.48 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 13 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 0.934 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 14 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 1.62 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 18 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q332]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 71.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 39 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | 2.19 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | 3.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 9.27 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 26 | not captured | only_one_extracted |
