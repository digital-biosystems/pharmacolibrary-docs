...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | 6a16 | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | 9.06 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 12.29 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.34 | not captured | only_one_extracted |
