...
# GRABeCB2.0 fluorescence — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | 2-arachidonoyl glycerol | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q320]` | 1.79 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 0.90 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 1.69 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 4.38 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 3.74 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 4.64 | not captured | only_one_extracted |
