...
# seizure stage &gt;1 — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.286). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q301]` | not captured | 2248.0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q301]` | not captured | 2315.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q347]` | not captured | 2246.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q347]` | not captured | 2332.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q347]` | not captured | 2325.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q347]` | 2246.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q347]` | 2332.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q347]` | 2247.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q347]` | 2325.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q48]` | not captured | 2247.6 | only_one_extracted |
