...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[cl]` (not captured vs not captured) and 2 more field(s) — not a structural parameter.
...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka (h-1) | `Q49` · kabs | 0.48 | h-1 | 0.00013333333333333334 | 1/h | not captured | exact (1.0) | Zufferey_2021:results_prose | — | not captured |
| mean volume of distribution | `Q61` · V | 17.9 | L | 0.0179 | L | not captured | boundary (0.8) | Zufferey_2021:discussion_prose | — | not captured |
| Cl (L.h-1) = θ1 × (eGFR/87)θ2 | `Q900` · Cl (L.h-1) = θ1 × (eGFR/87)θ2 | 0.4 | L.h-1 | 1.1111111111111112e-07 | not captured | not captured | not captured (not captured) | Zufferey_2021:results_prose | — | not captured |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl (l.h-1) = θ1 × (egfr/87)θ2]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[cl]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[mean volume of distribution]` | 17.9 | not captured | only_one_extracted |
