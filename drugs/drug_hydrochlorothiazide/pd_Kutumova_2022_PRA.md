...
# plasma renin activity — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.75). The first reading is what the record holds.">cross-check: disputed</span>
...
`Hydrochlorothiazide_Kutumova2022_PD_pra` — sigmoid_emax, `response = E0 + Emax*frac`
...
Closed-form check points (response, SI): `at_0` = 0, `at_EC50` = -0.495, `at_inf` = -0.99

Deviations:

- `defaulted_parameters` — E0, gamma
- `pd_binding_off_target_driver` — driver compound 'aliskiren' is not 'hydrochlorothiazide' nor one of its metabolites — the curve belongs to that compound's exposure (S12)
...
- off_target_driver: 'aliskiren' is not 'hydrochlorothiazide' (S12)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | aliskiren | antihypertensive drug | mismatch |
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Kutumova2022_PD_pra/Hydrochlorothiazide_Kutumova2022_PD_pra_modelica.zip" download>Hydrochlorothiazide_Kutumova2022_PD_pra_modelica.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Kutumova2022_PD_pra/Hydrochlorothiazide_Kutumova2022_PD_pra_matlab.zip" download>Hydrochlorothiazide_Kutumova2022_PD_pra_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Kutumova2022_PD_pra/Hydrochlorothiazide_Kutumova2022_PD_pra_sbml.zip" download>Hydrochlorothiazide_Kutumova2022_PD_pra_sbml.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Kutumova2022_PD_pra/Hydrochlorothiazide_Kutumova2022_PD_pra_cellml.zip" download>Hydrochlorothiazide_Kutumova2022_PD_pra_cellml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
</tbody></table>
...
<dbs-fmusim paramsurl="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Kutumova2022_PD_pra/Hydrochlorothiazide_Kutumova2022_PD_pra_params.json" metaurl="assets/fmu/PD_SigmoidEmaxSweep.vr.json" wasmurl="assets/fmu/PD_SigmoidEmaxSweep.js" controlsurl="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Kutumova2022_PD_pra/Hydrochlorothiazide_Kutumova2022_PD_pra_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PD_SigmoidEmaxSweep` · parameters `Hydrochlorothiazide_Kutumova2022_PD_pra_params.json` · controls `Hydrochlorothiazide_Kutumova2022_PD_pra_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>

<div class="pk-tab-end"></div>

---
<sub>← back to [hydrochlorothiazide](drugs/drug_hydrochlorothiazide/)</sub>
