...
## Model component
<dbs-pgx drug="hydrochlorothiazide" model-id="Hydrochlorothiazide_Shimizu2012_reference" status="not_modelled" stale="false" population="spontaneously hypertensive rats" measured-compound="losartan" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Shimizu_2012` / `Shimizu_2012::spontaneously hypertensive rats`)
- sim: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/models/modelica/Hydrochlorothiazide_Shimizu2012_spontaneously_hypertensive_r.json`
