...
> **Dose compound ≠ measured compound:** dosed `losartan and hydrochlorothiazide`, measured `losartan`.
...
## Model component
<dbs-pgx drug="hydrochlorothiazide" model-id="Hydrochlorothiazide_Shimizu2012_reference" status="rejected" stale="false" population="spontaneously hypertensive rats" measured-compound="losartan" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- review gap-fill skipped: this record measures 'losartan', not hydrochlorothiazide — the review values are the parent's
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Shimizu2012_reference/Hydrochlorothiazide_Shimizu2012_reference_fmi.zip" download>Hydrochlorothiazide_Shimizu2012_reference_fmi.zip</a> <span class="pk-size">(4.1 kB)</span></td></tr>
