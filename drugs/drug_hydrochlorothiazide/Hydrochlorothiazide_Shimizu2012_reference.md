...
> **Dose compound ≠ measured compound:** dosed `losartan, hydrochlorothiazide`, measured `losartan`.

## Citation
Shimizu R; Miyazaki M; Iwanaga K; Kakemi M et al. (2012). Drug metabolism and pharmacokinetics 27
  ·  DOI: [10.2133/dmpk.dmpk-11-rg-060](https://doi.org/10.2133/dmpk.dmpk-11-rg-060)

## Model component
<dbs-pgx drug="hydrochlorothiazide" model-id="Hydrochlorothiazide_Shimizu2012_reference" status="model_quarantined" stale="false" population="spontaneously hypertensive rats" measured-compound="losartan" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| T3_output_variable | not captured | pass | C_central (measured=losartan) | central.C | not captured | output must be the measured/analyte compartment |
...
- scholar stages: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Shimizu_2012` / `Shimizu_2012::reference`)
- model: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/models/modelica/_needs_review/Hydrochlorothiazide_Shimizu2012_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/models/modelica/_needs_review/Hydrochlorothiazide_Shimizu2012_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/models/modelica/Hydrochlorothiazide_Shimizu2012_reference.json`
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Shimizu2012_reference/Hydrochlorothiazide_Shimizu2012_reference.svg" alt="Hydrochlorothiazide_Shimizu2012_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Shimizu2012_reference/Hydrochlorothiazide_Shimizu2012_reference_params.json" metaurl="assets/fmu/PK_1C_enteral.vr.json" wasmurl="assets/fmu/PK_1C_enteral.js" controlsurl="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Shimizu2012_reference/Hydrochlorothiazide_Shimizu2012_reference_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Hydrochlorothiazide_Shimizu2012_reference_params.json` · controls `Hydrochlorothiazide_Shimizu2012_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
