...
# HEME pathway genes — PGx  <span class="pk-badge pk-badge--neutral">evidence_only</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.25). The first reading is what the record holds.">cross-check: partial</span>
...
- **paper:** `Del-Aguila_2015`
- **gene:** HEME pathway genes
- **mechanism:** target
- **applies to:** pd
- **target:** `Q100` NIL
...
## Citation
Del-Aguila JL; Cooper-DeHoff RM; Chapman AB; Gums JG; Beitelshees AL; Bailey K; et al. et al. (2015). The pharmacogenomics journal 15
  ·  DOI: [10.1038/tpj.2014.46](https://doi.org/10.1038/tpj.2014.46)
