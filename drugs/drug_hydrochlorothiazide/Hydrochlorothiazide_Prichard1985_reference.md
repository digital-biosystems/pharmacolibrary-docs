...
## Model component
<dbs-pgx drug="hydrochlorothiazide" model-id="Hydrochlorothiazide_Prichard1985_reference" status="accepted_with_caveats" stale="false" population="" measured-compound="hydrochlorothiazide" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Total plasma clearance | `Q22` · CL | 2.1 | L/h | 5.833333333333334e-07 | L/h | not captured | review (0.7) | Prichard_1985:review | — | not captured |
| volume of distribution | `Q61` · V | 21.0 | L | 0.021 | L | not captured | review (0.7) | Prichard_1985:review | — | not captured |
...
- built from REVIEW reference values (Prichard_1985) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Prichard_1985:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Prichard_1985:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 2.1 | not captured | not captured | ['Prichard_1985:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 2.1 L/h | not captured | not captured | ['Prichard_1985:review'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 21 L | not captured | not captured | ['Prichard_1985:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Prichard_1985` / `Prichard_1985::reference`)
- model: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/models/modelica/Hydrochlorothiazide_Prichard1985_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/models/modelica/Hydrochlorothiazide_Prichard1985_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/models/modelica/Hydrochlorothiazide_Prichard1985_reference.json`
...
<img src="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Prichard1985_reference/Hydrochlorothiazide_Prichard1985_reference.svg" alt="Hydrochlorothiazide_Prichard1985_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Prichard1985_reference/Hydrochlorothiazide_Prichard1985_reference_sbml.zip" download>Hydrochlorothiazide_Prichard1985_reference_sbml.zip</a> <span class="pk-size">(2.5 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_hydrochlorothiazide/Hydrochlorothiazide_Prichard1985_reference/Hydrochlorothiazide_Prichard1985_reference_cellml.zip" download>Hydrochlorothiazide_Prichard1985_reference_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
...
<sub>Template `PK_1C` · parameters `Hydrochlorothiazide_Prichard1985_reference_params.json` · controls `Hydrochlorothiazide_Prichard1985_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
