...
|---|---|---|---|---|---|---|---|---|---|---|
| k a (h -1 ) | `Q95` · t1/2ka | 1.34 | h -1 | not captured | [1] / [h] | 17.0 | llm (0.6) | tab_1:row1:col1, tab_1:row1:col2 | — | not captured |
| CL NR (l/h) | `Q79` · CLNR | 2.44 | l/h | 6.777777777777778e-07 | [l] / [h] | 22.2 | llm_corrected (0.6) | tab_1:row4:col1, tab_1:row4:col2 | — | not captured |
| V c (l) | `Q63` · V1 | 97.3 | l | 0.0973 | [l] | 10.5 | llm (0.6) | tab_1:row5:col1, tab_1:row5:col2 | — | not captured |
| CL d (l/h) | `Q22` · CL | 17.2 | l/h | 4.777777777777777e-06 | [l] / [h] | 2.79 | llm_confirmed (0.6) | tab_1:row6:col1, tab_1:row6:col2 | — | not captured |
| V p (l) | `Q61` · V | 178 | l | 0.178 | [l] | 24.1 | llm (0.6) | tab_1:row7:col1, tab_1:row7:col2 | — | not captured |
| theta_cl_weight_power | `Q900` · theta_cl_weight_power | 1.38 | not captured | not captured | not captured | 8.65 | not captured (not captured) | tab_1:row3:col1, tab_1:row3:col2 | — | not captured |
