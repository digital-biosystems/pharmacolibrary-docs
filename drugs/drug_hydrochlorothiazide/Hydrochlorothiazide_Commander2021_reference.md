...
## Model component
<dbs-pgx drug="hydrochlorothiazide" model-id="Hydrochlorothiazide_Commander2021_reference" status="model_quarantined" stale="false" population="children" measured-compound="hydrochlorothiazide" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka hr−1 | `Q49` · kabs | 0.43 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | T2:row1:col1 | — | not captured |
| CL/F70kg (L/h) | `Q355` · CLnorm/F | 19.0 | L/h | 5.277777777777778e-06 | [l] / [h] | not captured | llm (0.6) | T2:row2:col1 | — | not captured |
| V/F70kg (L) | `Q353` · Vnorm/F | 191.0 | L | 0.191 | [l] | not captured | llm (0.6) | T2:row3:col1 | — | not captured |
...
|---|---|---|---|
| Fi | Q22 | not captured | exact |
| V | Q61 | not captured | exact |

## Departures & gaps

**Interpretation flags:**
- dropped PD-category row 'Hill factor' → Q325 (Hill, category G11) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['T2:row4:col1'])
- dropped unlinked row (NIL): 'TM50 (weeks)' — extend the ontology if this is a real PK parameter (source ['T2:row5:col1'])
...
- bound model equation to Q61 (V): V = 191.0*(WT/70)^θ
- Q22 (CL) is equation-defined: value moved to equation-variable 'Fi'; equation kept verbatim
- Q61 (V) is equation-defined: value moved to equation-variable 'V'; equation kept verbatim
- skipped review gap-fill of V2: primary is 1C (peripheral family needs ≥2C)
- skipped review gap-fill of Q: primary is 1C (peripheral family needs ≥2C)
- skipped review gap-fill of TLAG: primary's parameterization (rate-constant / ka-only) does not use it

**Extraction notes:**
- unparsed cell T2:row1:col2 = '0.49 (0.08, 2.9)'
- unparsed cell T2:row2:col2 = '19.0 (15.1, 23.4)'
- unparsed cell T2:row3:col2 = '191.9 (42.7, 271.3)'
- unparsed cell T2:row4:col2 = '6.3 (3.1, 13.8)'
- unparsed cell T2:row5:col2 = '38.6 (32.8, 43.7)'
- unparsed cell T2:row6:col2 = '49.6 (28.3, 70.2)'
- unparsed cell T2:row7:col2 = '42.5 (33.2, 50.8)'
- LLM selected parameter table(s) 2
- captured model equation Fi = CL/Fstd*(WT/70)^θ
- captured model equation CL = 19.0*(WT/70)^θ
- captured model equation V = 191.0*(WT/70)^θ
...
- scholar stages: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Commander_2021` / `Commander_2021::reference`)
- model: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/models/modelica/_needs_review/Hydrochlorothiazide_Commander2021_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_hydrochlorothiazide/models/modelica/_needs_review/Hydrochlorothiazide_Commander2021_reference.deviation.json`
