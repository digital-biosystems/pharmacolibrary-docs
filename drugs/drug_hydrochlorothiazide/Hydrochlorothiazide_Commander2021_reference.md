...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka hr−1 | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | T2:row1:col1 | — | not captured |
| CL/F70kg (L/h) | `Q355` · CLnorm/F | —(suppressed) | L/h | — | [l] / [h] | not captured | llm (0.6) | T2:row2:col1 | — | not captured |
| V/F70kg (L) | `Q353` · Vnorm/F | —(suppressed) | L | — | [l] | not captured | llm (0.6) | T2:row3:col1 | — | not captured |
