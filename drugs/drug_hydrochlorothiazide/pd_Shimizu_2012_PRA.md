...
# plasma renin activity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.4). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 24 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 48 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 72 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 120 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 144 | only_one_extracted |
