...
- scholar stages: `../../../knowledgebase/drugs/drug_bleomycin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Giri_1986` / `Giri_1986::reference`)
