...
## Model component
<dbs-pgx drug="bleomycin" model-id="Bleomycin_Han2024_reference" status="needs_review" stale="false" population="" measured-compound="bleomycin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_bleomycin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Han_2024` / `Han_2024::reference`)
