...
## Model component
<dbs-pgx drug="bleomycin" model-id="Bleomycin_Yadav2023_reference" status="not_modelled" stale="false" population="" measured-compound="bleomycin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| nonspecific CL | `Q22` · CL | —(suppressed) | mL/day/kg | — | L/h | not captured | review (0.7) | Yadav_2023:review | — | not captured |
| V (derived from CL·t½/ln2) | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Yadav_2023:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_bleomycin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Yadav_2023` / `Yadav_2023::review reference`)
- sim: `../../../knowledgebase/drugs/drug_bleomycin/models/modelica/Bleomycin_Yadav2023_review_reference.json`
