...
|---|---|---|---|---|---|---|---|---|---|---|
| Kontrast K | `Q87` · Frel | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | fig_7:caption, fig_7:caption, fig_7:caption | — | not captured |
| Exkretion | `Q44` · fe | —(suppressed) | % | — | [%] | not captured | llm (0.5) | fig_7:caption, fig_7:caption | — | not captured |
| Retentionswerte | `Q88` · AUC | —(suppressed) | Std. | — | [s] · [td] | not captured | llm (0.5) | fig_7:caption | — | not captured |
| CL (mL/day) | `Q22` · CL | —(suppressed) | mL/day | — | L/h | not captured | review_gapfill (0.7) | Han_2024:review | — | not captured |
| Vz (mL) | `Q61` · V | —(suppressed) | mL | — | L | not captured | review_gapfill (0.7) | Han_2024:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_bleomycin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Schober_1978_2` / `Schober_1978_2::patients with cervical carcinoma`)
