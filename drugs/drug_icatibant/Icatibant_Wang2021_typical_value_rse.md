...
|---|---|---|---|---|---|---|---|---|---|---|
| ka (h–1) | `Q49` · kabs | —(suppressed) | h–1 | — | [1] / [h] | not captured | exact (1.0) | Wang_2021_table_S4:row0:col1 | — | not captured |
| tlag (h) | `Q83` · tlag | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Wang_2021_table_S4:row1:col1 | — | not captured |
