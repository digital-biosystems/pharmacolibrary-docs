...
## Model component
<dbs-pgx drug="icatibant" model-id="Icatibant_Wang2021_shrinkage" status="rejected" stale="false" population="pediatric and adult patients with hereditary angioedema and healthy adults" measured-compound="icatibant" parameterization="apparent" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| ka | `Q49` · kabs | 3.27 | h–1 | 0.0009083333333333334 | 1/h | not captured | exact (1.0) | Wang_2021:other_prose | — | not captured |
| Cl/F | `Q27` · CL/F | 15.4 | L/h | 4.277777777777778e-06 | L/h | not captured | exact (1.0) | Wang_2021:other_prose | — | not captured |
| Vc/F | `Q290` · V1/F | 20.4 | L | 0.020399999999999998 | L | not captured | exact (1.0) | Wang_2021:other_prose | — | not captured |
| Vp/F | `Q82` · V2/F | 1.75 | L | 0.00175 | L | not captured | exact (1.0) | Wang_2021:other_prose | — | not captured |
...
| C9_phys_window_Q27 | pass | clearance within physiological range | 15.4 L/h | not captured | not captured | ['Wang_2021:other_prose'] |
| C9_phys_window_Q290 | pass | volume within physiological range | 20.4 L | not captured | not captured | ['Wang_2021:other_prose'] |
| C9_phys_window_Q82 | pass | volume within physiological range | 1.75 L | not captured | not captured | ['Wang_2021:other_prose'] |
