...
|---|---|---|---|---|---|---|---|---|---|---|
| Saliva sample in peak level of lacosamide (mg/L) | `Q32` · Cmax | 9.12 | mg/L | not captured | [mg] / [l] | not captured | llm_confirmed (0.6) | Tab1:row40:col2 | — | not captured |
| Saliva sample in trough level of lacosamide (mg/L) | `Q37` · Ctrough | 6.76 | mg/L | not captured | [mg] / [l] | not captured | llm_confirmed (0.6) | Tab1:row41:col2 | — | not captured |
| AUC in saliva (mg h/L) | `Q88` · AUC | 116 | mg h/L | not captured | [[h] · [mg]] / [l] | not captured | llm_confirmed (0.6) | Tab1:row46:col2 | — | not captured |
...
- dropped unlinked row (NIL): 'Age (years)' — extend the ontology if this is a real PK parameter (source ['Tab1:row2:col2'])
- dropped unlinked row (NIL): 'Height (cm)' — extend the ontology if this is a real PK parameter (source ['Tab1:row4:col2'])
- dropped unlinked row (NIL): 'Body weights (kg)' — extend the ontology if this is a real PK parameter (source ['Tab1:row5:col2'])
- dropped unlinked row (NIL): 'BSA (m2)' — extend the ontology if this is a real PK parameter (source ['Tab1:row6:col2'])
- dropped unlinked row (NIL): 'BUN (mg/dL)' — extend the ontology if this is a real PK parameter (source ['Tab1:row19:col2'])
- dropped unlinked row (NIL): 'Creatinine (mg/dL)' — extend the ontology if this is a real PK parameter (source ['Tab1:row20:col2'])
- dropped unlinked row (NIL): 'GFR (mL/min/1.73 m2)' — extend the ontology if this is a real PK parameter (source ['Tab1:row21:col2'])
- dropped unlinked row (NIL): 'AST (U/L)' — extend the ontology if this is a real PK parameter (source ['Tab1:row22:col2'])
- dropped unlinked row (NIL): 'ALT (U/L)' — extend the ontology if this is a real PK parameter (source ['Tab1:row23:col2'])
- dropped unlinked row (NIL): 'Saliva sample in outpatient clinic (mg/L)' — extend the ontology if this is a real PK parameter (source ['Tab1:row39:col2'])
- dropped unlinked row (NIL): 'Blood sample in outpatient clinic (mg/L)' — extend the ontology if this is a real PK parameter (source ['Tab1:row42:col2'])
- dropped duplicate Q32 ('Cmax in saliva (mg/L)', value '12.4') — already have one for this compound
- dropped duplicate Q37 ('Trough in saliva (mg/L)', value '7.35') — already have one for this compound
- unit_dimension_unknown: 'mg h/L' (AUC)
- dropped duplicate Q32 ('Cmax in blood (mg/L)', value '8.57') — already have one for this compound
- dropped duplicate Q37 ('Trough in blood (mg/L)', value '5.10') — already have one for this compound
- dropped duplicate Q88 ('AUC in blood (mg h/L)', value '81.0') — already have one for this compound
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=lacosamide
- held at status:extracted — NIL link or unit issue (mismatch/unknown/normalisation-failed) present
- status held at route_to_review — not promoted
- population split: 'low seizure burden group (n = 95)' subgroup of Jang_2025 (paper reports 4 populations: high seizure burden group (n = 28), low seizure burden group (n = 95), p-value, total (n = 123))
...
| C5_dimension_Q32 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Tab1:row40:col2'] |
| C5_dimension_Q37 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Tab1:row41:col2'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_lacosamide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Jang_2025` / `Jang_2025::low_seizure_burden_group_n_95`)
