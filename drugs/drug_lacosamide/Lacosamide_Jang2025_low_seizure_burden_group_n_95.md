...
|---|---|---|---|---|---|---|---|---|---|---|
| Saliva sample in peak level of lacosamide (mg/L) | `Q32` · Cmax | —(suppressed) | mg/L | — | [mg] / [l] | not captured | llm_confirmed (0.6) | Tab1:row40:col2 | — | not captured |
| Saliva sample in trough level of lacosamide (mg/L) | `Q37` · Ctrough | —(suppressed) | mg/L | — | [mg] / [l] | not captured | llm_confirmed (0.6) | Tab1:row41:col2 | — | not captured |
| AUC in saliva (mg h/L) | `Q88` · AUC | —(suppressed) | mg h/L | — | [[h] · [mg]] / [l] | not captured | llm_confirmed (0.6) | Tab1:row46:col2 | — | not captured |
