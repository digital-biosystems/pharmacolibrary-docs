...
<sub>Template `PK_1C_enteral` · parameters `Lacosamide_Yu2026_reference_params.json` · controls `Lacosamide_Yu2026_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
