...
|---|---|---|---|---|---|---|---|---|---|---|
| V1 | `Q63` · V1 | —(suppressed) | not captured | — | not captured | 19.2 | exact (1.0) | Tab2:row2:col1, Tab2:row2:col2, Tab2:row2:col3, Tab2:row2:col4, Tab2:row2:col5 | — | 0.230 (42.9% RSE) |
| CL | `Q22` · CL | —(suppressed) | not captured | — | not captured | 10.5 | exact (1.0) | Tab2:row3:col1, Tab2:row3:col2, Tab2:row3:col3, Tab2:row3:col4, Tab2:row3:col5 | — | 0.089 (39.9% RSE) |
| V2 | `Q64` · V2 | —(suppressed) | not captured | — | not captured | 14.4 | exact (1.0) | Tab2:row4:col1, Tab2:row4:col2, Tab2:row4:col3, Tab2:row4:col4, Tab2:row4:col5 | — | not captured |
| Q1 | `Q30` · Q | —(suppressed) | not captured | — | not captured | 15.3 | exact (1.0) | Tab2:row5:col1, Tab2:row5:col2, Tab2:row5:col3, Tab2:row5:col4, Tab2:row5:col5 | — | not captured |
| V3 | `Q77` · V3 | —(suppressed) | not captured | — | not captured | 9.8 | exact (1.0) | Tab2:row6:col1, Tab2:row6:col2, Tab2:row6:col3, Tab2:row6:col4, Tab2:row6:col5 | — | not captured |
| Q3 | `Q308` · Q3 | —(suppressed) | not captured | — | not captured | 16.8 | exact (1.0) | Tab2:row9:col1, Tab2:row9:col2, Tab2:row9:col3, Tab2:row9:col4, Tab2:row9:col5 | — | not captured |
