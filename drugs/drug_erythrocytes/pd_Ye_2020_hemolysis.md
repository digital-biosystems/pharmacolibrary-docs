...
# name — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.647). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.647 (22/34 fields) | 12 |
...
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 67.4 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 4.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 9.0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 6.6 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 1.8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 1.3 | only_one_extracted |
