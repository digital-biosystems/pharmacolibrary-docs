...
# erythrocyte lysis — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Amador LA; Colón-Lorenzo EE; Rodríguez AD; Serrano AE et al. (2024). Life (Basel, Switzerland) 14
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | plakortinic acids C and D | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q100]` | -2.679 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | -2.735 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | -4.249 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | -4.392 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q44]` | 1.092 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q44]` | 0.953 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q46]` | 0.191 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q46]` | 0.089 | not captured | only_one_extracted |
