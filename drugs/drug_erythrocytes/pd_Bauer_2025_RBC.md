...
# Red Blood Cells — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.192). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Bauer RJ; Krzyzanski W et al. (2025). CPT: pharmacometrics & systems pharmacology 14
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.192 (5/26 fields) | 21 |

<details><summary>21 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | EPO-receptor complex (RC) | RC (drug-receptor complex) | mismatch |
| `gpt-oss:120b` | `model_family` | tmdd | indirect_response_i | mismatch |
| `gpt-oss:120b` | `parameters[Q100]` | 190 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 190 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 190 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | not captured | 0.09 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 0.01 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 0.0101 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 0.0101 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 0.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 0.478 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 0.479 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 2.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 2.59 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 2.69 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q327]` | not captured | 190 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q327]` | not captured | 190 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q327]` | not captured | 190 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 0.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 0.478 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 0.479 | not captured | only_one_extracted |
