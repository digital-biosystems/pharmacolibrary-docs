...
# lipase activity — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | seaweed extracts | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 0.748 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.238 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.932 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 2.098 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.119 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.360 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.159 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.969 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.379 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.228 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.822 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.789 | not captured | only_one_extracted |
