...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | colistin | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | 170 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q338]` | -4.27 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q338]` | -1.57 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0 | not captured | only_one_extracted |
