...
# Glucosidase inhibition — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | linseed extract | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q341]` | -50.8947 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q341]` | -69.8904 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q341]` | -66.5634 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q341]` | -75.9115 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q341]` | -74.0203 | not captured | only_one_extracted |
