...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F (L/h) | `Q27` · CL/F | 3269 | L/h | 0.0009080555555555556 | [l] / [h] | not captured | exact (1.0) | bcp70096-tbl-0003:row2:col6 | — | not captured |
| V2/F (L) | `Q82` · V2/F | 2807 | L | 2.807 | [l] | not captured | exact (1.0) | bcp70096-tbl-0003:row3:col6 | — | not captured |
| KA (1/h) | `Q49` · kabs | 2750 | not captured | not captured | not captured | not captured | exact (1.0) | bcp70096-tbl-0003:row4:col6 | — | not captured |
| Q/F (L/h) | `Q69` · Q/F | 3074 | L/h | 0.0008538888888888888 | [l] / [h] | not captured | exact (1.0) | bcp70096-tbl-0003:row5:col6 | — | not captured |
| V3/F (L) | `Q78` · V3/F | 2718 | L | 2.718 | [l] | not captured | exact (1.0) | bcp70096-tbl-0003:row6:col6 | — | not captured |
| D1 (h) | `Q310` · D1 | 2704 | h | 9734400.0 | [h] | not captured | exact (1.0) | bcp70096-tbl-0003:row7:col6 | — | not captured |
...
- dropped duplicate Q27 ('EGFRCL/F', value '3034') — already have one for this compound
- dropped unlinked row (NIL): 'BLACKCL/F' — extend the ontology if this is a real PK parameter (source ['bcp70096-tbl-0003:row10:col6'])
- dropped unlinked row (NIL): 'ASIANCL/F' — extend the ontology if this is a real PK parameter (source ['bcp70096-tbl-0003:row11:col6'])
- dropped unlinked row (NIL): 'FEMALECL/F' — extend the ontology if this is a real PK parameter (source ['bcp70096-tbl-0003:row12:col6'])
- dropped unlinked row (NIL): 'ΩCL/F' — extend the ontology if this is a real PK parameter (source ['bcp70096-tbl-0003:row14:col6'])
- apparent-ness (ontology-grounded): parameterization=apparent, measured_compound=empagliflozin
- structure disagreement: deterministic 1C vs LLM 2C — review compartment count
- population split: 'tail ess' subgroup of Rascher_2025 (paper reports 4 populations: bulk ess, median, tail ess, ȓ)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl/f].value` | 3269 | 6.74 | mismatch |
| `gpt-oss:120b` | `parameters[d1].value` | 2704 | 0.326 | mismatch |
| `gpt-oss:120b` | `parameters[ka].value` | 2750 | 0.239 | mismatch |
| `gpt-oss:120b` | `parameters[q/f].value` | 3074 | 5.51 | mismatch |
| `gpt-oss:120b` | `parameters[v2/f].value` | 2807 | 4.12 | mismatch |
| `gpt-oss:120b` | `parameters[v3/f].value` | 2718 | 71.7 | mismatch |
...
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['bcp70096-tbl-0003:row2:col6'] |
| C5_dimension_Q310 | pass | [time] | not captured | not captured | not captured | ['bcp70096-tbl-0003:row7:col6'] |
| C5_dimension_Q69 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['bcp70096-tbl-0003:row5:col6'] |
| C5_dimension_Q78 | pass | [length] ** 3 | not captured | not captured | not captured | ['bcp70096-tbl-0003:row6:col6'] |
| C5_dimension_Q82 | pass | [length] ** 3 | not captured | not captured | not captured | ['bcp70096-tbl-0003:row3:col6'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q27 | pass | clearance within physiological range | 3.27e+03 L/h | not captured | not captured | ['bcp70096-tbl-0003:row2:col6'] |
| C9_phys_window_Q82 | pass | volume within physiological range | 2.81e+03 L | not captured | not captured | ['bcp70096-tbl-0003:row3:col6'] |
