...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | bcp70096-tbl-0003:row2:col7 | — | not captured |
| V2/F (L) | `Q82` · V2/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | bcp70096-tbl-0003:row3:col7 | — | not captured |
| KA (1/h) | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | bcp70096-tbl-0003:row4:col7 | — | not captured |
| Q/F (L/h) | `Q69` · Q/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | bcp70096-tbl-0003:row5:col7 | — | not captured |
| V3/F (L) | `Q78` · V3/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | bcp70096-tbl-0003:row6:col7 | — | not captured |
| D1 (h) | `Q310` · D1 | —(suppressed) | h | — | [h] | not captured | exact (1.0) | bcp70096-tbl-0003:row7:col7 | — | not captured |
