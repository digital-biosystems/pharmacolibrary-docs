...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F (L/h) | `Q27` · CL/F | 6.74 | L/h | 1.8722222222222222e-06 | [l] / [h] | not captured | exact (1.0) | bcp70096-tbl-0003:row2:col3 | — | not captured |
| V2/F (L) | `Q82` · V2/F | 4.12 | L | 0.00412 | [l] | not captured | exact (1.0) | bcp70096-tbl-0003:row3:col3 | — | not captured |
| KA (1/h) | `Q49` · kabs | 0.239 | not captured | not captured | not captured | not captured | exact (1.0) | bcp70096-tbl-0003:row4:col3 | — | not captured |
| Q/F (L/h) | `Q69` · Q/F | 5.51 | L/h | 1.5305555555555556e-06 | [l] / [h] | not captured | exact (1.0) | bcp70096-tbl-0003:row5:col3 | — | not captured |
| V3/F (L) | `Q78` · V3/F | 71.7 | L | 0.0717 | [l] | not captured | exact (1.0) | bcp70096-tbl-0003:row6:col3 | — | not captured |
| D1 (h) | `Q310` · D1 | 0.326 | h | 1173.6000000000001 | [h] | not captured | exact (1.0) | bcp70096-tbl-0003:row7:col3 | — | not captured |
