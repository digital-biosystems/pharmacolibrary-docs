...
## Citation
Strydom N; Gupta SV; Fox WS; Via LE; Bang H; Lee M; et al. et al. (2019). PLoS medicine 16
...
|---|---|---|---|---|---|---|---|---|---|---|
| Lag time (h) | `Q83` · tlag | —(suppressed) | h | — | h | not captured | exact (1.0) | Strydom_2019_2:other_prose | — | not captured |
| Clearance (L/h) | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | exact (1.0) | Strydom_2019_2:other_prose | — | not captured |
| Central volume (L) | `Q63` · V1 | —(suppressed) | L | — | L | not captured | exact (1.0) | Strydom_2019_2:other_prose | — | not captured |
| Peripheral volume (L) | `Q64` · V2 | —(suppressed) | L | — | L | not captured | exact (1.0) | Strydom_2019_2:other_prose | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_kanamycin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Strydom_2019_2` / `Strydom_2019_2::pulmonary tuberculosis patients undergoing lung resection surgery`)
