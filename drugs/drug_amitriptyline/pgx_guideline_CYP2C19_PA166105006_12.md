...
# CYP2C19 — PGx  <span class="pk-badge pk-badge--neutral">guideline_estimate</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.2). The first reading is what the record holds.">cross-check: partial</span>
...
| `gpt-oss:120b` | `theta[IM]` | -0.25 | not captured | only_one_extracted |
