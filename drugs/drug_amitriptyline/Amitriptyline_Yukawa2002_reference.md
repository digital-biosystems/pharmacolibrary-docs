...
Yukawa E; Hokazono T; Yukawa M; Ichimaru R; Maki T; Matsunaga K; et al. et al. (2002). Clinical pharmacokinetics 41
  ·  DOI: [10.2165/00003088-200241020-00006](https://doi.org/10.2165/00003088-200241020-00006)
...
|---|---|---|---|---|---|---|---|---|---|---|
| mean CL/F | `Q27` · CL/F | 141.65 | L/h | 3.934722222222222e-05 | L/h | not captured | review (0.7) | Yukawa_2002:review | — | not captured |
| Vd | `Q61` · V | 9.5 | L/kg | 0.665 | L | not captured | review (0.7) | Yukawa_2002:review | — | not captured |
...
- built from REVIEW reference values (Yukawa_2002) — secondary source
...
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Yukawa_2002:review'] |
...
| C9_phys_window_Q27 | pass | clearance within physiological range | 142 L/h | not captured | not captured | ['Yukawa_2002:review'] |
...
| T3_output_variable | not captured | pass | C_central (measured=amitriptyline) | central.C | not captured | output must be the measured/analyte compartment |
...
- scholar stages: `../../../knowledgebase/drugs/drug_amitriptyline/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Yukawa_2002` / `Yukawa_2002::reference`)
- model: `../../../knowledgebase/drugs/drug_amitriptyline/models/modelica/Amitriptyline_Yukawa2002_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_amitriptyline/models/modelica/Amitriptyline_Yukawa2002_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_amitriptyline/models/modelica/Amitriptyline_Yukawa2002_reference.json`
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-07-22 09:14 UTC</sub>
