...
|---|---|---|---|---|---|---|---|---|---|---|
| TVCL TRM, AMIT , L/h | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | tab_1:row3:col1, tab_1:row3:col2, tab_1:row3:col3 | — | 0.05 (None% RSE) |
| TVV c, AMIT , L | `Q61` · V | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | tab_1:row11:col1, tab_1:row11:col2, tab_1:row11:col3 | — | not captured |
| TVKa, 1/h | `Q95` · t1/2ka | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | tab_1:row16:col1, tab_1:row16:col2, tab_1:row16:col3 | — | not captured |
| TVALAG, h | `Q83` · tlag | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | tab_1:row18:col1, tab_1:row18:col2, tab_1:row18:col3 | — | not captured |
| D1, h | `Q310` · D1 | —(suppressed) | not captured | — | not captured | not captured | boundary (0.8) | tab_1:row20:col1, tab_1:row20:col2, tab_1:row20:col3 | — | not captured |
| K24, 1/h | `Q48` · kcomp | —(suppressed) | not captured | — | not captured | not captured | boundary (0.8) | tab_1:row21:col1, tab_1:row21:col2, tab_1:row21:col3 | — | not captured |
| K56, 1/h | `Q47` · kel | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | tab_1:row29:col1, tab_1:row29:col2, tab_1:row29:col3 | — | not captured |
| K65, 1/h | `Q65` · Vss | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | tab_1:row30:col1, tab_1:row30:col2, tab_1:row30:col3 | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_amitriptyline/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Koh_2019` / `Koh_2019::healthy adults`)
