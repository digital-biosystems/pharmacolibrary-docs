...
# bleeding count — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Jonsson F; Schmitt C; Petry C; Mercier F; Frey N; Retout S et al. (2021). Clinical pharmacokinetics 60
...
| `gpt-oss:120b` | `parameters[Q322]` | 3.58 | not captured | only_one_extracted |
...
---
<sub>← back to [coagulation factor IX](drugs/drug_coagulation_factor_ix/)</sub>
