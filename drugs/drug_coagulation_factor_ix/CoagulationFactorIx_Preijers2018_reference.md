...
- unit_dimension_unknown: 'mL h-170 kg-1' (CL)
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Preijers_2018_metadata.yaml (12 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_coagulation_factor_ix/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Preijers_2018` / `Preijers_2018::reference`)
