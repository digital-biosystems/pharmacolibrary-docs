...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-19 09:26 | 35:16 | 0/0/0 | 4/2/0 | 0/0/0 | 1,009,609/15,818 | ollama / qwen3.8:27b-mtp-q8_0 | 40 | 2/38 | 39/1 | 0 |
...
| <span class="pk-badge pk-badge--green">extracted</span> | [Nesbitt_2025](drugs/drug_ammonium_chloride/pd_Nesbitt_2025_CD41.md) | Nesbitt NM et al., Small molecule BLVRB redox inhibitor pr…, Nature communications (2025) | [10.1038/s41467-025-58497-9](https://doi.org/10.1038/s41467-025-58497-9) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Nesbitt_2025](drugs/drug_ammonium_chloride/pd_Nesbitt_2025_CD61.md) | Nesbitt NM et al., Small molecule BLVRB redox inhibitor pr…, Nature communications (2025) | [10.1038/s41467-025-58497-9](https://doi.org/10.1038/s41467-025-58497-9) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Nesbitt_2025](drugs/drug_ammonium_chloride/pd_Nesbitt_2025_Platelets.md) | Nesbitt NM et al., Small molecule BLVRB redox inhibitor pr…, Nature communications (2025) | [10.1038/s41467-025-58497-9](https://doi.org/10.1038/s41467-025-58497-9) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Walton_2024](drugs/drug_ammonium_chloride/pd_Walton_2024_unknown.md) | Walton J et al., PRMT1 inhibition perturbs RNA metabolis…, Nature communications (2024) | [10.1038/s41467-024-52507-y](https://doi.org/10.1038/s41467-024-52507-y) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Liang_2023](drugs/drug_ammonium_chloride/pd_Liang_2023_IC50.md) | Liang Y et al., Self-Aggregation, Antimicrobial Activit…, Molecules (Basel, Switzerla… (2023) | [10.3390/molecules28145469](https://doi.org/10.3390/molecules28145469) |
...
<sub>queue written 2026-09-19T09:18:36.648531+00:00</sub>
...
| popPK | Chen_2023 | irrelevant | 0 | 0 | The paper is a computational drug design study for SPOP inhibitors and does not involve ammonium chloride or report its pharmacokinetic parameters. |
...
| popPK | De_2025 | irrelevant | 0 | 0 | The paper describes the synthesis and pharmacological characterization of novel LIFR/GPBAR1 modulators for liver fibrosis and does not study ammonium chloride. |
...
| popPK | Hawtin_2023 | irrelevant | 0 | 0 | The paper studies the pharmacokinetics and pharmacodynamics of MHV370, not ammonium chloride. |
...
| popPK | Jesudason_2026 | irrelevant | 0 | 0 | The paper focuses on SHIP1 ligands for Alzheimer's disease and does not involve ammonium chloride or report any pharmacokinetic parameters for it. |
...
| popPK | Kameneva_2022 | irrelevant | 0 | 0 | The paper is a developmental biology study on serotonin and chromaffin cell differentiation, not a pharmacokinetic study of ammonium chloride. |
...
| popPK | Kumar_2026 | irrelevant | 0 | 0 | The paper is a proteomics study on tauopathies and does not report pharmacokinetic parameters for ammonium chloride. |
...
| popPK | Medrano_2024 | irrelevant | 0 | 0 | The paper describes the development of peptidyl nitroalkene inhibitors for SARS-CoV-2 Mpro and does not involve ammonium chloride or report any pharmacokinetic parameters. |
...
| popPK | Nash_2022 | irrelevant | 0 | 0 | The paper studies the pharmacokinetics of Interleukin-2 (IL2) delivered via engineered cells, not ammonium chloride. |
...
| popPK | Nasr_2026 | irrelevant | 0 | 0 | The paper focuses on the synthesis and in vitro anticancer evaluation of thiazole-derived inhibitors, with no mention of ammonium chloride or pharmacokinetic parameters. |
...
| popPK | Ni_2024 | irrelevant | 0 | 0 | The paper is a computational study on drug target identification using knowledge graphs and does not involve ammonium chloride or pharmacokinetic parameters. |
...
| popPK | Rafehi_2026 | irrelevant | 0 | 0 | The paper is a mechanistic study on membrane transporter polypharmacology and does not report pharmacokinetic parameters for ammonium chloride. |
...
| popPK | Suissa_2026 | irrelevant | 0 | 0 | The paper focuses on metabolic determinants of cancer immunotherapy outcomes and does not report pharmacokinetic parameters for ammonium chloride. |
...
| popPK | Taskar_2020 | irrelevant | 0 | 0 | The paper is a review of PBPK modeling for transporter-mediated drug-drug interactions and does not report pharmacokinetic parameters for ammonium chloride. |
...
| popPK | Walton_2024 | irrelevant | 0 | 0 | The paper is a mechanistic study on PRMT1 inhibition in renal cell carcinoma and does not involve ammonium chloride or report any pharmacokinetic parameters. |
...
| popPK | Widerlöv_1989 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of remoxipride, using ammonium chloride only as a pH-modifying agent, not as the subject drug. |
...
| popPK | Zahiruddin_2021 | irrelevant | 0 | 0 | The paper is a metabolomic and immunomodulatory study of a polyherbal combination and does not involve ammonium chloride or pharmacokinetic parameters. |
