...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-11 22:18 | 8:39 | 0/0/0 | 0/0/0 | 0/0/0 | 65,596/3,616 | ollama / qwen3.8:27b-mtp-q8_0 | 3 | 0/0 | 3/0 | 0 |
...
- **PubMed hits:** 45 matched, 41 returned
...
<sub>queue written 2026-09-11T22:17:30.255303+00:00</sub>

## Screened and excluded

| domain | paper | verdict | relevance | extractability | reason |
|---|---|---|---|---|---|
| popPK | Ahrens_1984 | irrelevant | 0 | 0 | The paper is a review of albuterol pharmacokinetics and only mentions cromoglicic acid (cromolyn) as a comparator for maintenance therapy without providing any PK parameters for it. |
...
| PD | Cockcroft_2005 | not_relevant | 0 | 0 | The text is a review of asthma management guidelines focusing on beta2-agonists and mentions cromones only as a class of anti-inflammatory agents without providing any pharmacodynamic data, exposure-response analysis, or numeric parameters for cromoglicic acid. |
...
| PD | Friedrich_1984 | not_relevant | 0 | 0 | The paper reports PD parameters for cloxacepride, not cromoglicic acid (cromolyn sodium), which is only mentioned as an inactive reference compound. |
...
| popPK | Lawton_1995 | irrelevant | 0 | 0 | The paper focuses on the modulation of histamine secretion in ECL cells (in-vitro/mechanistic) and does not report pharmacokinetic parameters for cromoglicic acid. |
| popPK | Leonardi_2003 | irrelevant | 0 | 0 | The paper is a clinical efficacy study comparing anti-allergic effects in a conjunctival challenge model and does not report any pharmacokinetic parameters for cromoglicic acid. |
| PD | Leonardi_2003 | not_relevant | 2 | 1 | The study reports clinical efficacy comparisons and allergen dose-response thresholds but lacks drug concentration data or formal PK/PD modeling to derive numeric PD parameters like Emax or EC50. |
...
| popPK | Wilson_2018 | irrelevant | 0 | 0 | The paper describes a computational algorithm (PathFX) for drug safety and efficacy analysis and does not report any pharmacokinetic parameters for cromoglicic acid. |
| PD | Wilson_2018 | not_relevant | 0 | 0 | The paper describes a network-based algorithm (PathFX) for identifying drug-disease associations and adverse events using protein-protein interaction data; it does not report any pharmacokinetic or pharmacodynamic data, exposure-response relationships, or numeric PD parameters for cromoglicic acid or any other drug. |
...
| PD | Yanni_1997 | not_relevant | 0 | 0 | The paper studies the effects of anti-allergy drugs on mast cells but does not report a pharmacokinetic or pharmacodynamic exposure-response relationship for cromoglicic acid with numeric PD parameters. |
...
| PD | Yasmeen_2020 | not_relevant | 0 | 0 | The paper investigates the molecular binding interaction between cromolyn sodium and BSA using spectroscopic and calorimetric methods, reporting thermodynamic parameters (Kd, ΔG, ΔH) rather than pharmacodynamic exposure-response or dose-response relationships. |
| popPK | Yoshimi_1992 | irrelevant | 0 | 0 | The provided evidence contains no text, data, or parameters, making it impossible to assess relevance or extractability. |
