...
|---|---|---|---|---|---|---|---|---|---|---|
| tvCL (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | not captured | tv_prefix (0.95) | Tsushima_2020:abstract | — | 0.0532 (None% RSE) |
| V1 (L) | `Q63` · V1 | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Tsushima_2020:abstract | — | not captured |
| Km (μg/mL) | `Q1` · Km | —(suppressed) | μg/mL | — | [µg] / [ml] | not captured | exact (1.0) | Tsushima_2020:abstract | — | not captured |
| Vmax (μg/mL/h) | `Q66` · Vmax | —(suppressed) | μg/mL/h | — | [µg] / [[h] · [ml]] | not captured | special_case (0.95) | Tsushima_2020:abstract | — | not captured |
| K21 (h−1) | `Q302` · k21 | —(suppressed) | h−1 | — | [1] / [h] | not captured | exact (1.0) | Tsushima_2020:abstract | — | not captured |
| Q3 (L/h) | `Q308` · Q3 | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | Tsushima_2020:abstract | — | not captured |
| tvV3 (L) | `Q77` · V3 | —(suppressed) | L | — | [l] | not captured | tv_prefix (0.95) | Tsushima_2020:abstract | — | 0.0419 (None% RSE) |
| θBSAonV3 | `Q900` · θBSAonV3 | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | not captured | — | not captured |
