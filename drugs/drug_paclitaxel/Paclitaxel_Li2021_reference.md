...
## Citation
not matched (stem Li_2021)

## Model component
<dbs-pgx drug="paclitaxel" model-id="Paclitaxel_Li2021_reference" status="rejected" stale="false" population="pediatric patients with recurrent or refractory solid tumors" measured-compound="paclitaxel" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
**Extraction notes:**
- no GROBID TEI available — transcribed from cached Li_2021_extracted.txt (0 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_paclitaxel/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Li_2021` / `Li_2021::reference`)
