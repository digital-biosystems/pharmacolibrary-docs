...
|---|---|---|---|---|---|---|---|---|---|---|
| volume of distribution | `Q61` · V | —(suppressed) | liters/kg | — | [l] / [kg] | not captured | exact (1.0) | Levin_1978:abstract | — | not captured |
| clearance | `Q22` · CL | —(suppressed) | ml/minute/kg | — | [ml] / [[min] · [kg]] | not captured | exact (1.0) | Levin_1978:abstract | — | not captured |
| transfer constant from the central compartment to the outside (K10) | `Q47` · kel | —(suppressed) | MINUTE-1 | — | [1] / [min] | not captured | llm (0.6) | Levin_1978:abstract | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_carmustine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Levin_1978` / `Levin_1978::reference`)
- model: `../../../knowledgebase/drugs/drug_carmustine/models/modelica/_needs_review/Carmustine_Levin1978_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_carmustine/models/modelica/_needs_review/Carmustine_Levin1978_reference.deviation.json`
