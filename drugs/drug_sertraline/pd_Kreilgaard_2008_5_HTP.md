...
# 5-HTP-potentiated behavioral syndrome — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Kreilgaard M; Smith DG; Brennum LT; Sánchez C et al. (2008). British journal of pharmacology 155
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | escitalopram, paroxetine, sertraline | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q320]` | 100 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 100 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 11 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 28 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 5.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 52 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 7.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 80 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | 0.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | 5.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | 0.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | 1.0 | not captured | only_one_extracted |
...
---
<sub>← back to [sertraline](drugs/drug_sertraline/)</sub>
