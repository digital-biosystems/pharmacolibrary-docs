...
|---|---|---|---|---|---|---|---|---|---|---|
| sertraline clearance | `Q22` · CL | 66 | L/h | 1.8333333333333333e-05 | [l] / [h] | not captured | llm_confirmed (0.6) | Castillo_2024:abstract, Castillo_2024:abstract, Castillo_2024:abstract, Castillo_2024:abstract | — | not captured |
| absorption constant | `Q49` · kabs | 0.855 | 1/h | 0.0002375 | [1] / [h] | not captured | exact (1.0) | Castillo_2024:abstract | — | not captured |
| volume of distribution | `Q61` · V | 20.2 | L/kg | 1.414 | [l] / [kg] | not captured | exact (1.0) | Castillo_2024:abstract | — | not captured |
...
- routed 'interindividual variability in sertraline clearance' → Q312 (IIV) to iiv — variability estimate, not a structural parameter
- apparent-by-design (ADVISORY, codes unchanged): extravascular dosing with no identifiable F, so these reported disposition parameters are likely apparent unless the model puts first-pass in its structure — Q22 (sertraline clearance); Q61 (volume of distribution)
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Castillo_2024_metadata.yaml (7 record(s)); values are summary statistics, not a fitted model
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[absorption constant]` | 0.855 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[sertraline clearance]` | 66 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[volume of distribution]` | 20.2 | not captured | only_one_extracted |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Castillo_2024:abstract', 'Castillo_2024:abstract', 'Castillo_2024:abstract', 'Castillo_2024:abstract'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Castillo_2024:abstract'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Castillo_2024:abstract'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 66.0 | not captured | not captured | ['Castillo_2024:abstract', 'Castillo_2024:abstract', 'Castillo_2024:abstract', 'Castillo_2024:abstract'] |
