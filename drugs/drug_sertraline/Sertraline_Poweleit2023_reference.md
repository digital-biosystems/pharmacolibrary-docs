...
| `gpt-oss:120b` | `parameters[cl/f]` | 14.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[ctrough]` | 151.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[v/f]` | 428 | not captured | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_sertraline/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Poweleit_2023` / `Poweleit_2023::reference`)
