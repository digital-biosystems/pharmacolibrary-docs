...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl/f].value` | 76.1 | 67.22 | mismatch |
| `gpt-oss:120b` | `parameters[v/f].value` | 803 | 372.19 | mismatch |
| `gpt-oss:120b` | `parameters[θcl-age].value` | 0.0068 | 0.004 | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_sertraline/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Zhang_2024` / `Zhang_2024::reference`)
