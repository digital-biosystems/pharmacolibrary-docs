...
# TPMT — PGx  <span class="pk-badge pk-badge--neutral">guideline_estimate</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.25). The first reading is what the record holds.">cross-check: partial</span>
