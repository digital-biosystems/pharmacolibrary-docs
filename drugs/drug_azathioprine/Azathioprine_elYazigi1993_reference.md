...
<sub>Template `PK_1C` · parameters `Azathioprine_elYazigi1993_reference_params.json` · controls `Azathioprine_elYazigi1993_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
