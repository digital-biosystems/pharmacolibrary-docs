...
# MAdCAM-1-a4b7 binding inhibition — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
| AUC 0-? (lgÁday/mL) | `Q88` · not captured | 5813 | lgÁday/mL | not captured | llm_confirmed (not captured) | tab_0:row16:col5 |
| t (day) — Vedolizumab dose a | `Q900` · not captured | 14.3 | day | not captured | llm (not captured) | tab_0:row17:col1 |
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.0 (0/53 fields) | 53 |
...
| `gpt-oss:120b` | `parameters[Q74]` | 884 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 1990 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 3750 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 5488 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 31.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 119 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 955 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 3020 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 4840 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q900]` | 14.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q900]` | 6.79 | not captured | only_one_extracted |
