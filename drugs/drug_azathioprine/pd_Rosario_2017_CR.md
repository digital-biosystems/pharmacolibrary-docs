...
# Clinical response — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.75). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.75 (45/60 fields) | 15 |
...
| `gpt-oss:120b` | `parameters[Q19]` | not captured | 2000 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | not captured | 3890 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | not captured | 5813 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | not captured | 127 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | not captured | 969 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | not captured | 3030 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | not captured | 4850 | only_one_extracted |
