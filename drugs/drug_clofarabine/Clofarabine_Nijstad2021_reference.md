...
|---|---|---|---|---|---|---|---|---|---|---|
| CLnon − renal,70kg (L/h) | `Q79` · CLNR | —(suppressed) | L/h | — | [l] / [h] | not captured | llm (0.6) | bcp14738-tbl-0002:row3:col1, bcp14738-tbl-0002:row3:col2 | — | not captured |
| CLrenal,70kg (L/h) | `Q26` · CLR | —(suppressed) | L/h | — | [l] / [h] | not captured | llm (0.6) | bcp14738-tbl-0002:row4:col1, bcp14738-tbl-0002:row4:col2 | — | not captured |
| V270kg (L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | llm (0.6) | bcp14738-tbl-0002:row8:col1, bcp14738-tbl-0002:row8:col2 | — | not captured |
