...
# gastric acid pH — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.828). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Jeong HC; Kim MG; Wei Z; Lee KR; Lee J; Song IS; et al. et al. (2022). Pharmaceutics 14
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.828 (24/29 fields) | 5 |
...
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 1.43 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 1.43 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q410]` | not captured | 0.792 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q410]` | not captured | 0.792 | only_one_extracted |
...
---
<sub>← back to [tegoprazan](drugs/drug_tegoprazan/)</sub>
