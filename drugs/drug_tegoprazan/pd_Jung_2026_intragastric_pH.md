...
|---|---|---|---|---|---|---|
| Kin (1/h) | `Q327` · not captured | 0.435 | 1/h | not captured | review_gapfill (not captured) | Jung_2026:review |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | tegoprazan, YH4808, fexuprazan, vonoprazan | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q327]` | 0.435 | not captured | only_one_extracted |
