...
- scholar stages: `../../../knowledgebase/drugs/drug_tegoprazan/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Jung_2026` / `Jung_2026::reference`)
