...
## Model component
<dbs-pgx drug="prednisolone" model-id="Prednisolone_Bouazza2025_covariate_effect" status="rejected" stale="false" population="systemic lupus erythematosus patients" measured-compound="prednisolone" parameterization="apparent" topology="1C"></dbs-pgx>
...
| CLU/F (L.h−1.70 kg−1) | Q27 | not captured | llm |
| VU/F (L.70 kg−1) | Q76 | not captured | llm |

## Departures & gaps

**Interpretation flags:**
- apparent-ness (ontology-grounded): parameterization=apparent, measured_compound=prednisolone
- population split: 'covariate effect' subgroup of Bouazza_2025 (paper reports 2 populations: covariate effect, estimate (% rse))
...
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['bcp70103-tbl-0002:row5:col1'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['bcp70103-tbl-0002:row6:col1'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_prednisolone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Bouazza_2025` / `Bouazza_2025::covariate_effect`)
