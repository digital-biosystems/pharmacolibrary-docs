...
## Model component
<dbs-pgx drug="prednisolone" model-id="Prednisolone_Purcell2025_5_crl" status="rejected" stale="false" population="dogs" measured-compound="prednisolone" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- population split: '5% crl' subgroup of Purcell_2025 (paper reports 3 populations: 5% crl, 95% crl, posterior median)
...
- scholar stages: `../../../knowledgebase/drugs/drug_prednisolone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Purcell_2025` / `Purcell_2025::5_crl`)
