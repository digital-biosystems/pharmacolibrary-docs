...
|---|---|---|---|---|---|---|---|---|---|---|
| Ktr (h-1) | `Q306` · ktr | —(suppressed) | h-1 | — | [1] / [h] | 4 | exact (1.0) | de_2023_table_p5_1:row1:col1, de_2023_table_p5_1:row1:col2 | — | not captured |
| Mtt (h) | `Q81` · MTT | —(suppressed) | h | — | [h] | 37 | exact (1.0) | de_2023_table_p5_1:row2:col1, de_2023_table_p5_1:row2:col2 | — | 0.755 (35% RSE) |
| VU (L/70 kg) | `Q352` · Vnorm | —(suppressed) | L/70 kg | — | [l] / [70kg] | 9 | llm (0.6) | de_2023_table_p5_1:row3:col1, de_2023_table_p5_1:row3:col2 | — | not captured |
| CLU (L/h/70 kg) | `Q24` · CLu | —(suppressed) | L/h/70 kg | — | [l] / [[h] · [70kg]] | 11 | exact (1.0) | de_2023_table_p5_1:row4:col1, de_2023_table_p5_1:row4:col2 | — | 0.429 (22% RSE) |
