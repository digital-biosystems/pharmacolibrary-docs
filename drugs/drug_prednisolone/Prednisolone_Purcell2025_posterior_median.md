...
## Model component
<dbs-pgx drug="prednisolone" model-id="Prednisolone_Purcell2025_posterior_median" status="rejected" stale="false" population="dogs" measured-compound="prednisolone" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| logℯ(A) | `Q319` · allometric_exponent | —(suppressed) | A | — | [a] | not captured | llm (0.6) | pone.0326586.t002:row1:col1 | — | not captured |
| A | `Q900` · equation variable | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | pone.0326586.t002:row2:col1 | — | not captured |
| CL RBCs | `Q22` · CL | —(suppressed) | L.hour À1 | — | L/h | not captured | review_gapfill (0.7) | Tan_2024:review | — | not captured |
...
- dropped duplicate Q319 ('logℯ(B)', value '-0.19') — already have one for this compound
- dropped duplicate Q319 ('B', value '0.83') — already have one for this compound
- dropped unlinked row (NIL): 'ν' — extend the ontology if this is a real PK parameter (source ['pone.0326586.t002:row6:col1'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=prednisolone
- population split: 'posterior median' subgroup of Purcell_2025 (paper reports 3 populations: 5% crl, 95% crl, posterior median)
- gap-filled Q22 (CL) from Tan_2024's review values (primary lacked it)
...
- scholar stages: `../../../knowledgebase/drugs/drug_prednisolone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Purcell_2025` / `Purcell_2025::posterior_median`)
