...
## Model component
<dbs-pgx drug="prednisolone" model-id="Prednisolone_Purcell2025_95_crl" status="rejected" stale="false" population="dogs" measured-compound="prednisolone" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- dropped value-less row: 'logℯ(A)' (captured trailing unit 'A' for child rows)
- dropped value-less row: 'A'
- dropped value-less row: 'logℯ(B)' (captured trailing unit 'B' for child rows)
- dropped value-less row: 'B'
- dropped value-less row: 'ν'
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=prednisolone
- population split: '95% crl' subgroup of Purcell_2025 (paper reports 3 populations: 5% crl, 95% crl, posterior median)
...
- scholar stages: `../../../knowledgebase/drugs/drug_prednisolone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Purcell_2025` / `Purcell_2025::95_crl`)
