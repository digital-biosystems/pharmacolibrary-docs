...
## Model component
<dbs-pgx drug="prednisolone" model-id="Prednisolone_Tan2024_reference" status="not_modelled" stale="false" population="" measured-compound="prednisolone" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_prednisolone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Tan_2024` / `Tan_2024::review reference`)
