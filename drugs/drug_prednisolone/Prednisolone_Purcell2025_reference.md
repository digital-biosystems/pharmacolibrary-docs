<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;A01A&quot;,&quot;href&quot;:&quot;atc/A01A.md&quot;},{&quot;label&quot;:&quot;prednisolone&quot;,&quot;href&quot;:&quot;drugs/drug_prednisolone/&quot;},{&quot;label&quot;:&quot;Purcell_2025 \u00b7 reference&quot;}]"></div>
...
# prednisolone — `Prednisolone_Purcell2025_reference`
...
|---|---|---|---|---|---|---|---|---|---|---|
| logℯ(A) | `Q319` · allometric_exponent | 3.13 | A | not captured | [a] | not captured | llm (0.6) | pone.0326586.t002:row1:col1, pone.0326586.t002:row1:col2, pone.0326586.t002:row1:col3 | — | not captured |
| A | `Q900` · equation variable | 22.8 | not captured | not captured | not captured | not captured | llm (0.6) | pone.0326586.t002:row2:col1, pone.0326586.t002:row2:col2, pone.0326586.t002:row2:col3 | — | not captured |
| CL RBCs | `Q22` · CL | 7.74 | L.hour À1 | 2.15e-06 | L/h | not captured | review_gapfill (0.7) | Tan_2024:review | — | not captured |
...
- dropped unlinked row (NIL): 'ν' — extend the ontology if this is a real PK parameter (source ['pone.0326586.t002:row6:col1', 'pone.0326586.t002:row6:col2', 'pone.0326586.t002:row6:col3'])
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[a]` | 22.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[cl rbcs]` | 7.74 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[loge].value` | 3.13 | -0.19 | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_prednisolone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Purcell_2025` / `Purcell_2025::reference`)
