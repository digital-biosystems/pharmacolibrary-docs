...
**What is wrong:** the simulated model does not reproduce a value the paper reports. Evidence: T1_t_half_beta — expected 16.0 — got 5.48158071932417 — ratio 0.3426; T1_t_half_beta — expected 58.0 — got 5.48158071932417 — ratio 0.0945
...
|---|---|---|---|---|---|---|---|---|---|---|
| Clearance (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | T3:row2:col3 | — | not captured |
| V1 (L) | `Q63` · V1 | —(suppressed) | L | — | [l] | not captured | exact (1.0) | T3:row3:col3 | — | not captured |
| Q2 (L/h) | `Q30` · Q | —(suppressed) | L/h | — | [l] / [h] | not captured | special_case (0.95) | T3:row4:col3 | — | not captured |
| V2 (L) | `Q64` · V2 | —(suppressed) | L | — | [l] | not captured | exact (1.0) | T3:row5:col3 | — | not captured |
| Q3 (L/h) | `Q308` · Q3 | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | T3:row6:col3 | — | not captured |
| V3 (L) | `Q77` · V3 | —(suppressed) | L | — | [l] | not captured | exact (1.0) | T3:row7:col3 | — | not captured |
| Oral Ka (h-1) | `Q49` · kabs | —(suppressed) | h-1 | — | [1] / [h] | not captured | llm_confirmed (0.6) | T3:row8:col3 | — | not captured |
| Oral F | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | T3:row9:col3 | — | not captured |
...
<img src="drugs/drug_cladribine/Cladribine_Lindemalm2005_interindividual_variability/Cladribine_Lindemalm2005_interindividual_variability.svg" alt="Cladribine_Lindemalm2005_interindividual_variability diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
