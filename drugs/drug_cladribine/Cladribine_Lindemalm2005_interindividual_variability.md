...
**What is wrong:** the simulated model does not reproduce a value the paper reports; the engineer's deviations are not documented and quantified. Evidence: T1_t_half_beta — expected 16.0 — got 5.48158071932417 — ratio 0.3426; T1_t_half_beta — expected 58.0 — got 5.48158071932417 — ratio 0.0945; T6_deviations — got defaulted_parameters: structural deviation not quantified
