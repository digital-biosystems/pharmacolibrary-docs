...
|---|---|---|---|---|---|---|---|---|---|---|
| Effect of BW (kg) on CL/Fb | `Q27` · CL/F | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | jcph1511-tbl-0003:row6:col3 | — | not captured |
| theta_q49_category | `Q900` · theta_q49_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | jcph1511-tbl-0003:row3:col3 | — | not captured |
| theta_cl_f_category | `Q900` · theta_cl_f_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | jcph1511-tbl-0003:row5:col3 | — | not captured |
| theta_q76_category | `Q900` · theta_q76_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | jcph1511-tbl-0003:row8:col3 | — | not captured |
