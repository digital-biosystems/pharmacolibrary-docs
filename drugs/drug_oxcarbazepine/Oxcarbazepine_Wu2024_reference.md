...
## Citation
Wu W; Yang WS; Xu XY; Ge XL; Lu J; Wang GF; et al. et al. (2024). Basic & clinical pharmacology & toxicology 134
...
|---|---|---|---|---|---|---|---|---|---|---|
| K a h −1 | `Q95` · t1/2ka | —(suppressed) | （） | — | [（）] | not captured | llm (0.5) | Wu_2024:table 2_flattened | — | not captured |
