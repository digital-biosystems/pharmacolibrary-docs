...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[dose excreted unchanged in the urine]` | 5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[overall volume of distribution]` | 14.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[plasma clearance]` | 1814 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[renal clearance]` | 91 | not captured | only_one_extracted |
...
| C9_phys_window_Q22 | pass | clearance within physiological range | 109 L/h | not captured | not captured | ['Schran_1985:abstract'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 1.02e+03 L | not captured | not captured | ['Schran_1985:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_dihydroergotamine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Schran_1985` / `Schran_1985::reference`)
