...
## Model component
<dbs-pgx drug="flucloxacillin" model-id="Flucloxacillin_Drennan2021v2_reference" status="extracted" stale="false" population="adults treated with oral flucloxacillin plus probenecid" measured-compound="free flucloxacillin" parameterization="mechanistic" topology="1C"></dbs-pgx>
