...
|---|---|---|---|---|---|---|---|---|---|---|
| B max (mmol/L) | `Q332` · Bmax | —(suppressed) | mmol/L | — | [mM] / [l] | not captured | llm (0.5) | tab_1:row2:col1, tab_1:row2:col2, tab_1:row2:col3, tab_1:row2:col4, tab_1:row2:col5, tab_1:row2:col6 | — | not captured |
| K d (mmol/L) | `Q331` · KD | —(suppressed) | mmol/L | — | [mM] / [l] | not captured | llm (0.5) | tab_1:row3:col1, tab_1:row3:col2, tab_1:row3:col3, tab_1:row3:col4, tab_1:row3:col5, tab_1:row3:col6 | — | not captured |
| CL (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | tab_1:row4:col1, tab_1:row4:col2, tab_1:row4:col3, tab_1:row4:col4, tab_1:row4:col5, tab_1:row4:col6 | — | 43.7 (None% RSE) |
| V 1 (L) | `Q63` · V1 | —(suppressed) | L | — | [l] | not captured | llm (0.5) | tab_1:row5:col1, tab_1:row5:col2, tab_1:row5:col3, tab_1:row5:col4, tab_1:row5:col5, tab_1:row5:col6 | — | not captured |
| V 2 (L) | `Q64` · V2 | —(suppressed) | L | — | [l] | not captured | llm (0.5) | tab_1:row6:col1, tab_1:row6:col2, tab_1:row6:col3, tab_1:row6:col4, tab_1:row6:col5, tab_1:row6:col6 | — | not captured |
| Q (L/h) | `Q30` · Q | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | tab_1:row7:col1, tab_1:row7:col2, tab_1:row7:col3, tab_1:row7:col4, tab_1:row7:col5, tab_1:row7:col6 | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_flucloxacillin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Jager_2020` / `Jager_2020::reference`)
