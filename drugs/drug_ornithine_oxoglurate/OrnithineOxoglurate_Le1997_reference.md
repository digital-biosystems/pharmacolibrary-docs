...
- scholar stages: `../../../knowledgebase/drugs/drug_ornithine_oxoglurate/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Le_1997` / `Le_1997::burn patients`)
