...
# cell proliferation — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Etienne MC; Milano G; Fischel JL; Frenay M; François E; Formento JL; et al. et al. (1989). British journal of cancer 60
  ·  DOI: [10.1038/bjc.1989.214](https://doi.org/10.1038/bjc.1989.214)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | tamoxifen and metabolites (NDT, 4-OHT, Y, Z) | not captured | mismatch |
