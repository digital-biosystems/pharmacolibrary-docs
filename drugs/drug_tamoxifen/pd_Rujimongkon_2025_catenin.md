...
# β-catenin localization — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Rujimongkon K; Adchariyasakulchai P; Meeprasertskul P; Ketchart W et al. (2025). PloS one 20
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.0 (0/9 fields) | 9 |

<details><summary>9 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | Ivermectin | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 48 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 72 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 9.35 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 9.06 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 10.14 | not captured | only_one_extracted |
