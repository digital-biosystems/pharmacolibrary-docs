...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-07 15:25 | 18:57 | 0/0/0 | 2/1/1 | 0/0/0 | 197,798/6,059 | ollama / qwen3.8:27b-mtp-q8_0 | 12 | 3/9 | 12/0 | 0 |
...
|---|---|---|---|
| <span class="pk-badge pk-badge--green">extracted</span> | [Chen_2023](drugs/drug_mandelic_acid/pd_Chen_2023_fungal_growth_inhibition.md) | Chen B et al., Design, Synthesis, In Vitro Antifungal…, International journal of mo… (2023) | [10.3390/ijms24108898](https://doi.org/10.3390/ijms24108898) |
| <span class="pk-badge pk-badge--orange">needs review</span> | [Kwon_2025](drugs/drug_mandelic_acid/pd_Kwon_2025_unknown.md) | Kwon OH et al., Occupational exposure to styrene and ac…, PloS one (2025) | [10.1371/journal.pone.0334962](https://doi.org/10.1371/journal.pone.0334962) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Mesquita_2008](drugs/drug_mandelic_acid/pd_Mesquita_2008_HIV_1_infection.md) | Mesquita PM et al., Candidate microbicide PPCM blocks human…, Journal of virology (2008) | [10.1128/JVI.00335-08](https://doi.org/10.1128/JVI.00335-08) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Mesquita_2008](drugs/drug_mandelic_acid/pd_Mesquita_2008_HSV_2_infection.md) | Mesquita PM et al., Candidate microbicide PPCM blocks human…, Journal of virology (2008) | [10.1128/JVI.00335-08](https://doi.org/10.1128/JVI.00335-08) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Sisto_2020](drugs/drug_mandelic_acid/pd_Sisto_2020_direct_DNA_damage.md) | Sisto R et al., Direct and Oxidative DNA Damage in a Gr…, Frontiers in public health (2020) | [10.3389/fpubh.2020.00445](https://doi.org/10.3389/fpubh.2020.00445) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Sisto_2020](drugs/drug_mandelic_acid/pd_Sisto_2020_oxidative_DNA_damage.md) | Sisto R et al., Direct and Oxidative DNA Damage in a Gr…, Frontiers in public health (2020) | [10.3389/fpubh.2020.00445](https://doi.org/10.3389/fpubh.2020.00445) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Sisto_2020](drugs/drug_mandelic_acid/pd_Sisto_2020_oxidative_stress.md) | Sisto R et al., Direct and Oxidative DNA Damage in a Gr…, Frontiers in public health (2020) | [10.3389/fpubh.2020.00445](https://doi.org/10.3389/fpubh.2020.00445) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Sisto_2020](drugs/drug_mandelic_acid/pd_Sisto_2020_total_DNA_damage.md) | Sisto R et al., Direct and Oxidative DNA Damage in a Gr…, Frontiers in public health (2020) | [10.3389/fpubh.2020.00445](https://doi.org/10.3389/fpubh.2020.00445) |
...
<sub>queue written 2026-09-07T15:21:49.306328+00:00</sub>
...
| popPK | Amagaya_1990 | irrelevant | 0 | 0 | The study focuses on the behavioral effects of Shosaikoto on age-induced amnesia in rats, and mandelic acid is only mentioned as a neurochemical marker (vanillyl mandelic acid) without any pharmacokinetic parameter reporting. |
| popPK | Amin_1975 | relevant | 9 | 0 | The paper is a pharmacokinetic study in rats reporting compartmental parameters for mandelic acid, but the specific numeric values are not present in the provided evidence text. |
| popPK | Amin_1975_2 | relevant | 9 | 0 | The paper is a pharmacokinetic study of mandelic acid in rats using a compartmental model, but the specific numeric parameter values are not present in the provided evidence. |
...
| PD | Chen_2021 | not_relevant | 3 | 2 | The paper reports in vitro IC50 values for a series of compounds, which is a static potency metric rather than a dynamic pharmacodynamic (exposure-response) or dose-response curve analysis for a specific drug in a physiological context. |
| popPK | Chen_2023 | irrelevant | 0 | 0 | The paper is an in-vitro medicinal chemistry study on the antifungal activity of mandelic acid derivatives, reporting no pharmacokinetic parameters. |
...
| PD | Cipriani_2022 | not_relevant | 0 | 0 | The paper reports IC50 values for crude extracts and fractions, not for the specific compound mandelic acid, and does not provide a concentration-effect curve or PD parameters for mandelic acid itself. |
| popPK | Dimpfel_1994 | irrelevant | 0 | 0 | The study focuses on cyclandelate as the subject drug, with mandelic acid mentioned only as a metabolite without any reported pharmacokinetic parameters. |
| PD | Dimpfel_1994 | not_relevant | 1 | 0 | The paper describes a qualitative temporal relationship between EEG changes and metabolite peaks for cyclandelate, but does not provide numeric PD parameters or a concentration-effect curve for mandelic acid. |
...
| PD | Duffin_2018 | not_relevant | 3 | 2 | The paper reports IC50 values for antimony and bismuth complexes (including mandelate ligands) but does not provide a concentration-effect curve, Emax, or a formal PK/PD model for mandelic acid itself. |
...
| PGx | Fustinoni_2008 | not_relevant | 0 | 0 | The paper investigates styrene exposure and its metabolite mandelic acid, not the pharmacokinetics or pharmacodynamics of mandelic acid as a therapeutic drug. |
...
| PD | Fustinoni_2010 | not_relevant | 0 | 0 | The paper analyzes the variability of biomarkers (including mandelic acid) for use in epidemiological studies and estimates variance components, but it does not report a pharmacodynamic or exposure-response model with numeric PD parameters (e.g., Emax, EC50) for mandelic acid. |
...
| PD | Gobba_1993 | not_relevant | 2 | 0 | The paper discusses styrene exposure and its effects on color vision, mentioning mandelic acid only as a biomarker of exposure; it does not report a pharmacodynamic model or numeric PD parameters for mandelic acid itself. |
...
| PD | Han_2007 | not_relevant | 0 | 0 | The paper reports IC50 values for chiral thiazoline oligomers, not mandelic acid; mandelic acid is only used as a ligand for binding affinity studies without dose-response or PD parameters. |
| popPK | Hou_2021 | irrelevant | 0 | 0 | The paper is a medicinal chemistry study on the synthesis and in-vitro antifungal activity of mandelic acid derivatives, containing no pharmacokinetic data. |
| popPK | Hou_2023 | irrelevant | 0 | 0 | The paper focuses on the synthesis and in vitro antifungal activity of mandelic acid derivatives, containing no pharmacokinetic data or disposition parameters. |
...
| PD | Hu_2024 | not_relevant | 4 | 2 | The paper reports an epidemiological exposure-response association using restricted cubic splines but does not provide specific numeric PD parameters (e.g., EC50, Emax) or a derivable concentration-effect curve for mandelic acid in the provided text. |
| popPK | Härkönen_1978 | irrelevant | 0 | 0 | The provided evidence consists only of metadata and keywords related to styrene exposure and mandelic acid excretion, with no quantitative pharmacokinetic parameters or full text available. |
...
| popPK | Jeyaraj_2025 | irrelevant | 0 | 0 | The paper focuses on in silico modeling of AKT inhibitors and does not study mandelic acid or report any pharmacokinetic parameters for it. |
...
| PD | Kolstad_1999 | not_relevant | 2 | 0 | The paper reports a qualitative exposure-response relationship for DNA denaturation but explicitly states that no relationship was apparent for sperm parameters and provides no numeric PD parameters (Emax, EC50, etc.) or derivable concentration-effect curves in the text. |
...
| PD | Li_2021 | not_relevant | 0 | 0 | The paper describes a chiral sensor for detecting mandelic acid enantiomers and does not report any pharmacodynamic or exposure-response relationships for the drug. |
...
| PD | Liljelind_2003 | not_relevant | 0 | 0 | The paper focuses on exposure assessment and variance components for biomonitoring (mandelic acid as a metabolite of styrene), not on pharmacodynamic or dose-response relationships. |
...
| PD | Mu_2025 | not_relevant | 0 | 0 | The paper identifies mandelic acid as a differential metabolite in a metabolomics study but does not report any pharmacodynamic or exposure-response relationship for mandelic acid itself. |
| popPK | Mutti_1984 | irrelevant | 0 | 0 | The study uses mandelic acid as a biomarker for styrene exposure in a neuropsychological study and does not report pharmacokinetic parameters for mandelic acid itself. |
...
| PD | Nazir_2021 | not_relevant | 0 | 0 | The paper reports pharmacological activity of plant extracts (containing mandelic acid) but does not isolate mandelic acid or report specific exposure-response or dose-response parameters for it. |
...
| PD | Seeber_2009 | not_relevant | 3 | 2 | The study reports qualitative dose-response associations for specific neurobehavioral tests (Benton, peg board) with chronic exposure, but does not provide numeric PD parameters (e.g., Emax, EC50) or a quantitative concentration-effect curve in the provided text. |
...
| popPK | Symanski_2001 | irrelevant | 0 | 0 | The study analyzes variability in urinary biomarker levels for exposure assessment, not pharmacokinetic disposition parameters (CL, V, ka) for mandelic acid. |
...
| PD | Triebig_2009 | not_relevant | 2 | 1 | The study investigates styrene exposure (using mandelic acid as a biomarker) and hearing loss but explicitly concludes that no clear dose-response relationship was found, providing only qualitative group comparisons and odds ratios rather than numeric PD parameters like Emax or EC50. |
...
| PD | Zahoor_2018 | not_relevant | 2 | 1 | The paper reports in vitro antioxidant and enzyme inhibition assays for isolated compounds but does not provide a dose-response curve or numeric PD parameters (e.g., IC50) specifically for mandelic acid. |
...
| popPK | Zheng_2024 | irrelevant | 0 | 0 | The paper is a medicinal chemistry study on fungicide synthesis and mechanism, not a pharmacokinetic study, and reports no PK parameters for mandelic acid. |
...
| popPK | unknown_2016 | irrelevant | 0 | 0 | The paper does not mention mandelic acid or report any pharmacokinetic parameters for it. |
...
| popPK | unknown_2021 | irrelevant | 0 | 0 | The provided evidence contains only a conference title and no pharmacokinetic data or parameters for mandelic acid. |

---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_mandelic_acid`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
