...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-19 06:13 | 51:17 | 0/0/0 | 11/7/0 | 0/0/0 | 1,440,412/24,007 | ollama / qwen3.8:27b-mtp-q8_0 | 80 | 10/70 | 80/0 | 0 |
...
| <span class="pk-badge pk-badge--red">rejected</span> | [Hasanin_2024](drugs/drug_gelatin/pd_Hasanin_2024_IC50.md) | Hasanin MS et al., Advanced functional Cu-Cr-Co-NPs@gelati…, RSC advances (2024) | [10.1039/d4ra06216g](https://doi.org/10.1039/d4ra06216g) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Hasanin_2024](drugs/drug_gelatin/pd_Hasanin_2024_MIC.md) | Hasanin MS et al., Advanced functional Cu-Cr-Co-NPs@gelati…, RSC advances (2024) | [10.1039/d4ra06216g](https://doi.org/10.1039/d4ra06216g) |
...
| <span class="pk-badge pk-badge--red">rejected</span> | [Schulz_2026](drugs/drug_gelatin/pd_Schulz_2026_GR50.md) | Schulz T et al., Structure-based scaffold hopping reveal…, Nature communications (2026) | [10.1038/s41467-026-76340-7](https://doi.org/10.1038/s41467-026-76340-7) |
...
<sub>queue written 2026-09-19T05:54:18.459534+00:00</sub>
...
| PGx | Burgert_1975 | not_relevant | 0 | 0 | The paper describes a case of angiofollicular lymph node hyperplasia causing anemia and does not involve gelatin or pharmacogenomics. |
...
| PGx | Chen_1999 | not_relevant | 0 | 0 | The paper studies the antifungal mechanism of a corn protein inhibitor, not the pharmacokinetics or pharmacodynamics of gelatin in humans. |
...
| PGx | Cheng_2026 | not_relevant | 0 | 0 | The paper describes a microneedle drug delivery system and monitoring platform, not a pharmacogenomic study of gelatin. |
...
| PGx | Choi_2024 | not_relevant | 0 | 0 | The paper investigates cell differentiation using gelatin as a substrate and fasudil as a drug, containing no pharmacogenomic analysis or PK/PD parameters for gelatin. |
| popPK | Comisar_2025 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for zavegepant, not gelatin (which is only mentioned as a formulation component). |
...
| popPK | Deng_2026 | irrelevant | 0 | 0 | The paper describes a bioartificial liver model for AML and hepatotoxicity studies, where gelatin (GelMA) is used as a scaffold material, not as a subject drug for pharmacokinetic analysis. |
| popPK | Desai_2026 | irrelevant | 0 | 0 | The paper investigates the cytocompatibility of living biomaterials (bacteria in PVA hydrogels) for ocular use and does not report pharmacokinetic parameters for gelatin. |
...
| popPK | Dogan_2025 | irrelevant | 0 | 0 | The paper describes a microphysiological system for cancer metastasis studies where gelatin is used only as a hydrogel matrix component, not as a subject drug for pharmacokinetic analysis. |
...
| PGx | Gato-Diaz_2026 | not_relevant | 0 | 0 | The paper describes a 3D cell culture model using gelatin as a structural component, not a pharmacogenomic study of gelatin as a drug. |
| PGx | German_2019 | not_relevant | 0 | 0 | The paper studies acetaminophen metabolism in cell cultures using gelatin scaffolds, not the pharmacokinetics or pharmacodynamics of gelatin itself, and does not involve human genetic variants. |
...
| PGx | Goldman_2025 | not_relevant | 0 | 0 | The paper is a systematic review discussing the theoretical interaction between CYP450 enzymes and vaccine excipients (including gelatin) in infants, but it does not report specific pharmacokinetic or pharmacodynamic parameters for gelatin or fitted effect sizes for gene variants. |
...
| PGx | Hou_2020 | not_relevant | 0 | 0 | The paper investigates the anti-tumor effects of digoxin on colorectal cancer cells and does not report pharmacogenomic effects on the pharmacokinetics or pharmacodynamics of gelatin. |
...
| PGx | Hull_2009 | not_relevant | 0 | 0 | The study compares pharmacokinetics of different formulations (capsules vs. tablets) and the effect of CYP3A4 inducers, but does not report any pharmacogenomic effects (gene variants) on PK parameters. |
| popPK | Iakab_2026 | irrelevant | 0 | 0 | The paper describes a 3D MALDI imaging platform for spatial omics and does not report any pharmacokinetic parameters for gelatin. |
...
| popPK | Lad_2026 | irrelevant | 0 | 0 | The paper is a phytochemical and in-vitro bioactivity study of Eucalyptus globulus essential oil and does not involve the drug gelatin or any pharmacokinetic analysis. |
...
| popPK | Larkin_2018 | irrelevant | 0 | 0 | The paper investigates sepsis-associated thrombocytopenia using gelatin zymography as a diagnostic technique to measure MMP activity, not as a pharmacokinetic study of gelatin as a drug. |
...
| PGx | Liang_2004 | not_relevant | 0 | 0 | The paper studies drug resistance and invasiveness in cancer cells; gelatin is used only as a substrate for zymography assays, not as a drug subject to pharmacogenomic analysis. |
...
| popPK | Lyu_2025 | irrelevant | 0 | 0 | The paper is a clinical trial investigating the effects of glucocorticoids on gut microbiota and metabolic markers, and does not study the pharmacokinetics of gelatin. |
...
| popPK | M_2025 | irrelevant | 0 | 0 | The paper is a study on caspase-8 and SARS-CoV-2 pathology in mice, containing no pharmacokinetic data for gelatin. |
...
| popPK | McCoombe_2026 | irrelevant | 0 | 0 | The study is a phantom imaging investigation where gelatin is used as a tissue-mimicking medium, not as a subject drug for pharmacokinetic analysis. |
...
| PGx | Muirhead_2000 | not_relevant | 0 | 0 | The paper investigates drug-drug interactions between sildenafil and protease inhibitors, not pharmacogenomic effects on gelatin. |
...
| popPK | Rezek_2026 | irrelevant | 0 | 0 | The paper is a study on antisense oligonucleotide therapy for Doyne honeycomb retinal dystrophy and does not involve the drug gelatin or report any pharmacokinetic parameters. |
...
| popPK | Schulz_2026 | irrelevant | 0 | 0 | The paper describes the structure-based design of kinase inhibitors for GIST and does not involve the drug gelatin or report any pharmacokinetic parameters. |
...
| popPK | Thanishka_2026 | irrelevant | 0 | 0 | The paper is a formulation and in vitro evaluation study of a herbal suppository where gelatin is used only as an excipient, not as the subject drug for pharmacokinetic analysis. |
...
| popPK | Turchaninova_2026 | irrelevant | 0 | 0 | The paper focuses on fibroblast-to-cardiomyocyte transdifferentiation and does not involve gelatin as a subject drug or report any pharmacokinetic parameters. |
...
| popPK | Yakavets_2025 | irrelevant | 0 | 0 | The paper is an in-vitro study on cancer organoids where gelatin is used as a hydrogel component, not as a subject drug for pharmacokinetic analysis. |
...
| popPK | Yuh_2026 | irrelevant | 0 | 0 | The paper is a study on ameloblastoma tumor microenvironment and does not involve the drug gelatin or report any pharmacokinetic parameters. |
...
| popPK | Zheng_2023 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of Panax notoginseng saponins (ginsenosides), where gelatin is used only as an excipient in the capsule formulation, not as the subject drug. |
...
| popPK | Zhou_2023 | irrelevant | 0 | 0 | The paper describes the physical coating of lignin nanospheres with gelatin and reports adsorption parameters, not pharmacokinetic disposition parameters for gelatin as a drug. |
