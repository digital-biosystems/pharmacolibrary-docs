...
# name — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.235). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q40]` | not captured | 0.61 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | not captured | 0.61 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | 0.61 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | 0.61 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 0.85 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 0.80 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | 0.85 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | 0.80 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | not captured | 0.63 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 0.63 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | not captured | 960 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | 960 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q81]` | not captured | 6.37 | only_one_extracted |
