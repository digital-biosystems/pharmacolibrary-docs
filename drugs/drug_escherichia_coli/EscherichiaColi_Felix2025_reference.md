...
## Model component
<dbs-pgx drug="escherichia coli" model-id="EscherichiaColi_Felix2025_reference" status="needs_review" stale="false" population="" measured-compound="escherichia_coli" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl (ml/kg/h) | `Q22` · CL | 209.5 | ml/kg/h | 4.073611111111111e-06 | L/h | not captured | review (0.7) | Felix_2025:review | — | not captured |
| V1 (ml/kg) | `Q63` · V1 | 785.5 | ml/kg | 0.054985 | L | not captured | review (0.7) | Felix_2025:review | — | not captured |
| V2 (ml/kg) | `Q64` · V2 | 3234.73 | ml/kg | 0.2264311 | L | not captured | review (0.7) | Felix_2025:review | — | not captured |
| Q (ml/kg/h) | `Q30` · Q | 1647.54 | ml/kg/h | 3.2035499999999995e-05 | L/h | not captured | review (0.7) | Felix_2025:review | — | not captured |
| Ka (/h) | `Q49` · kabs | 0.42 | /h | 0.00011666666666666667 | 1/h | not captured | review (0.7) | Felix_2025:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Felix_2025` / `Felix_2025::reference`)
