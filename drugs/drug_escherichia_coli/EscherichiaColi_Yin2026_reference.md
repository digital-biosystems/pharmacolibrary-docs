...
## Citation
Yin Q; Chen Y; Lv J; Zheng Z; Zhao X; Chen H; Xie F; Yi H; Chen Q et al. (2026). Antimicrobial agents and chemotherapy 70
  ·  DOI: [10.1128/aac.01810-25](https://doi.org/10.1128/aac.01810-25)

## Model component
<dbs-pgx drug="escherichia coli" model-id="EscherichiaColi_Yin2026_reference" status="extracted" stale="false" population="" measured-compound="escherichia_coli" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | 19.6 | L/h/70 kg | 5.444444444444446e-06 | L/h | not captured | review (0.7) | Yin_2026:review | — | not captured |
| V | `Q61` · V | 70.6 | L/70 kg | 0.0706 | L | not captured | review (0.7) | Yin_2026:review | — | not captured |
...
- built from REVIEW reference values (Yin_2026) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Yin_2026:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Yin_2026:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 19.6 | not captured | not captured | ['Yin_2026:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 19.6 L/h | not captured | not captured | ['Yin_2026:review'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 70.6 L | not captured | not captured | ['Yin_2026:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Yin_2026` / `Yin_2026::reference`)
