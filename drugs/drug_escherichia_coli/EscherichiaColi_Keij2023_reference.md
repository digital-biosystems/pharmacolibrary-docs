...
## Model component
<dbs-pgx drug="escherichia coli" model-id="EscherichiaColi_Keij2023_reference" status="extracted" stale="false" population="" measured-compound="escherichia_coli" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| TVCL (L/h) | `Q22` · CL | 3.22 | L/h | 8.944444444444445e-07 | L/h | not captured | review (0.7) | Keij_2023:review | — | not captured |
| TVV1 (L) | `Q63` · V1 | 43.0 | L | 0.043000000000000003 | L | not captured | review (0.7) | Keij_2023:review | — | not captured |
| Ka (h−1) | `Q49` · kabs | 0.085 | h−1 | 2.3611111111111114e-05 | 1/h | not captured | review (0.7) | Keij_2023:review | — | not captured |
...
- built from REVIEW reference values (Keij_2023) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Keij_2023:review'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Keij_2023:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Keij_2023:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 3.22 | not captured | not captured | ['Keij_2023:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 3.22 L/h | not captured | not captured | ['Keij_2023:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 43 L | not captured | not captured | ['Keij_2023:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Keij_2023` / `Keij_2023::reference`)
