...
| T3_output_variable | not captured | pass | C_central (measured=asparaginase) | central.C | not captured | output must be the measured/analyte compartment |
| T3_param_coverage | not captured | pass | 2 scholar param(s) emitted or defaulted | 2 covered | not captured | all structural parameters accounted for |
| T3_topology_template | not captured | pass | 1C → PK_1C* | PK_1C | not captured | engineer template must match the scholar topology |
| T6_deviations | not captured | pass | not captured | not captured | not captured | no engineer deviations to adjudicate |
| T1_t_half_terminal | reference | fail | 20.46 | 12.151959797638268 | 0.5939 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 160.5 | 12.151959797638268 | 0.0757 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 160.5 | 12.151959797638268 | 0.0757 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 20.46 | 12.151959797638268 | 0.5939 | h→SI vs simulated h |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Sethuramalingam_2026` / `Sethuramalingam_2026::reference`)
- model: `../../../knowledgebase/drugs/drug_escherichia_coli/models/modelica/EscherichiaColi_Sethuramalingam2026_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_escherichia_coli/models/modelica/EscherichiaColi_Sethuramalingam2026_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_escherichia_coli/models/modelica/EscherichiaColi_Sethuramalingam2026_reference.json`
...
<img src="drugs/drug_escherichia_coli/EscherichiaColi_Sethuramalingam2026_reference/EscherichiaColi_Sethuramalingam2026_reference.svg" alt="EscherichiaColi_Sethuramalingam2026_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_1C` · parameters `EscherichiaColi_Sethuramalingam2026_reference_params.json` · controls `EscherichiaColi_Sethuramalingam2026_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
