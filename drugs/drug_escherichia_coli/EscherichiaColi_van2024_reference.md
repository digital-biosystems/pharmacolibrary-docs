...
## Citation
van Os W; Nussbaumer-Pröll A; Pham AD; Wijnant GJ; Ngougni Pokem P; Van Bambeke F; et al. et al. (2024). The Journal of antimicrobial chemotherapy 79
  ·  DOI: [10.1093/jac/dkae243](https://doi.org/10.1093/jac/dkae243)

## Model component
<dbs-pgx drug="escherichia coli" model-id="EscherichiaColi_van2024_reference" status="extracted" stale="false" population="" measured-compound="escherichia_coli" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h) | `Q22` · CL | 3.69 | L/h | 1.0250000000000001e-06 | L/h | not captured | review (0.7) | van_2024:review | — | not captured |
| V c (L) | `Q63` · V1 | 14.0 | L | 0.014 | L | not captured | review (0.7) | van_2024:review | — | not captured |
| V p (L) | `Q64` · V2 | 21.7 | L | 0.0217 | L | not captured | review (0.7) | van_2024:review | — | not captured |
| Q (L/h) | `Q30` · Q | 8.45 | L/h | 2.347222222222222e-06 | L/h | not captured | review (0.7) | van_2024:review | — | not captured |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['van_2024:review'] |
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['van_2024:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['van_2024:review'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['van_2024:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 3.69 | not captured | not captured | ['van_2024:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 3.69 L/h | not captured | not captured | ['van_2024:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 14 L | not captured | not captured | ['van_2024:review'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 21.7 L | not captured | not captured | ['van_2024:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `van_2024` / `van_2024::reference`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-22 05:07 UTC</sub>
