...
## Citation
Steffens NA; Zimmermann ES; Azeredo FJ; Linden R; Finatto LJ; Hahn RZ; Schwarzbold AV; Pacheco LS; Brucker N et al. (2025). Antibiotics (Basel, Switzerland) 14
  ·  DOI: [10.3390/antibiotics14060531](https://doi.org/10.3390/antibiotics14060531)

## Model component
<dbs-pgx drug="escherichia coli" model-id="EscherichiaColi_Steffens2025_reference" status="extracted" stale="false" population="" measured-compound="escherichia_coli" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl (L/h) | `Q22` · CL | 1.49 | L/h | 4.1388888888888887e-07 | L/h | not captured | review (0.7) | Steffens_2025:review | — | not captured |
| Vd (L) | `Q61` · V | 23.18 | L | 0.02318 | L | not captured | review (0.7) | Steffens_2025:review | — | not captured |
...
- built from REVIEW reference values (Steffens_2025) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Steffens_2025:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Steffens_2025:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 1.49 | not captured | not captured | ['Steffens_2025:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 1.49 L/h | not captured | not captured | ['Steffens_2025:review'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 23.2 L | not captured | not captured | ['Steffens_2025:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Steffens_2025` / `Steffens_2025::reference`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-22 05:05 UTC</sub>
