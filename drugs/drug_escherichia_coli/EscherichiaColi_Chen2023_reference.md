...
## Citation
Chen JC; Yang F; Li GH; Duan MH; Li ZE; Dai Y; et al. et al. (2023). Metabolites 13
  ·  DOI: [10.3390/metabo13080906](https://doi.org/10.3390/metabo13080906)

## Model component
<dbs-pgx drug="escherichia coli" model-id="EscherichiaColi_Chen2023_reference" status="needs_review" stale="false" population="" measured-compound="escherichia_coli" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl | `Q22` · CL | 446.86 | mL/h/kg | 8.688944444444445e-06 | L/h | not captured | review (0.7) | Chen_2023:review | — | not captured |
| VZ | `Q61` · V | 6590.63 | mL/kg | 0.46134410000000003 | L | not captured | review (0.7) | Chen_2023:review | — | not captured |
...
- built from REVIEW reference values (Chen_2023) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Chen_2023:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Chen_2023:review'] |
| C6_cl_magnitude | fail | &lt;= 90.0 L/h | 446.86 | not captured | not captured | ['Chen_2023:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 31.3 L/h | not captured | not captured | ['Chen_2023:review'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 461 L | not captured | not captured | ['Chen_2023:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Chen_2023` / `Chen_2023::reference`)
