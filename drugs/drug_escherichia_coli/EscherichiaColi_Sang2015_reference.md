...
## Model component
<dbs-pgx drug="escherichia coli" model-id="EscherichiaColi_Sang2015_reference" status="extracted" stale="false" population="" measured-compound="escherichia_coli" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl/F (mL/h/kg) | `Q27` · CL/F | 48.47 | mL/h/kg | 9.424722222222222e-07 | L/h | not captured | review (0.7) | Sang_2015:review | — | not captured |
| V/F (mL/kg) | `Q76` · V/F | 413.02 | mL/kg | 0.028911399999999997 | L | not captured | review (0.7) | Sang_2015:review | — | not captured |
| Ka (h−1) | `Q49` · kabs | 2.79 | h−1 | 0.000775 | 1/h | not captured | review (0.7) | Sang_2015:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Sang_2015` / `Sang_2015::reference`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-22 05:04 UTC</sub>
