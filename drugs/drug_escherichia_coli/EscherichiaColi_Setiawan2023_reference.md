...
## Citation
Setiawan E; Cotta MO; Abdul-Aziz MH; Widjanarko D; Sosilya H; Lukas DL; et al. et al. (2023). Clinical pharmacokinetics 62
  ·  DOI: [10.1007/s40262-023-01219-5](https://doi.org/10.1007/s40262-023-01219-5)

## Model component
<dbs-pgx drug="escherichia coli" model-id="EscherichiaColi_Setiawan2023_reference" status="extracted" stale="false" population="" measured-compound="escherichia_coli" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h) | `Q22` · CL | 5.58 | L/h | 1.55e-06 | L/h | not captured | review (0.7) | Setiawan_2023:review | — | not captured |
| V (L) | `Q61` · V | 12.6 | L | 0.0126 | L | not captured | review (0.7) | Setiawan_2023:review | — | not captured |
...
- built from REVIEW reference values (Setiawan_2023) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Setiawan_2023:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Setiawan_2023:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 5.58 | not captured | not captured | ['Setiawan_2023:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 5.58 L/h | not captured | not captured | ['Setiawan_2023:review'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 12.6 L | not captured | not captured | ['Setiawan_2023:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Setiawan_2023` / `Setiawan_2023::reference`)
