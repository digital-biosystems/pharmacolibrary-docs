...
## Citation
Boşnak C; Metan G; Zarakolu P; Karakulak EA; Pınar A; Göker H; Roberts JA; Hernandez-Mitre MP; Akova M et al. (2026). The Journal of antimicrobial chemotherapy 81
  ·  DOI: [10.1093/jac/dkag284](https://doi.org/10.1093/jac/dkag284)

## Model component
<dbs-pgx drug="escherichia coli" model-id="EscherichiaColi_Bonak2026_reference" status="extracted" stale="false" population="" measured-compound="escherichia_coli" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F (L/h) | `Q27` · CL/F | 4.77 | L/h | 1.325e-06 | L/h | not captured | review (0.7) | Boşnak_2026:review | — | not captured |
| V/F (L) | `Q76` · V/F | 97.57 | L | 0.09756999999999999 | L | not captured | review (0.7) | Boşnak_2026:review | — | not captured |
| ka (h−1) | `Q49` · kabs | 1.12 | h−1 | 0.0003111111111111111 | 1/h | not captured | review (0.7) | Boşnak_2026:review | — | not captured |
...
- built from REVIEW reference values (Boşnak_2026) — secondary source
...
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Boşnak_2026:review'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Boşnak_2026:review'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Boşnak_2026:review'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q27 | pass | clearance within physiological range | 4.77 L/h | not captured | not captured | ['Boşnak_2026:review'] |
| C9_phys_window_Q76 | pass | volume within physiological range | 97.6 L | not captured | not captured | ['Boşnak_2026:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_escherichia_coli/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Boşnak_2026` / `Boşnak_2026::reference`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-22 05:02 UTC</sub>
