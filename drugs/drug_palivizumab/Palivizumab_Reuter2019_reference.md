...
|---|---|---|---|---|---|---|---|---|---|---|
| median estimated creatinine clearance | `Q22` · CL | —(suppressed) | mL/min | — | L/h | not captured | review_gapfill (0.7) | Huang_2017:review | — | not captured |
| volume of distribution of clesrovimab | `Q61` · V | —(suppressed) | L | — | L | not captured | review_gapfill (0.7) | Madhi_2025:review | — | not captured |
