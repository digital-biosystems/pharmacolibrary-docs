...
- scholar stages: `../../../knowledgebase/drugs/drug_palivizumab/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Huang_2017` / `Huang_2017::reference`)
