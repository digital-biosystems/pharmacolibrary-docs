...
# Viral genomic copies — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Broadbent L; Parke HG; Ferguson LJ; Millar A; Shields MD; Detalle L; et al. et al. (2020). Antimicrobial agents and chemotherapy 64
  ·  DOI: [10.1128/AAC.02034-19](https://doi.org/10.1128/AAC.02034-19)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | ALX-0171 | not captured | mismatch |
