...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-19 01:46 | 22:47 | 0/0/0 | 0/1/0 | 0/0/0 | 889,248/11,319 | ollama / qwen3.8:27b-mtp-q8_0 | 34 | 2/32 | 34/0 | 0 |
...
<sub>queue written 2026-09-19T01:42:56.184998+00:00</sub>
...
| popPK | Batlle_2025 | irrelevant | 0 | 0 | The paper is a computational study on ALDH1A3 inhibitors and does not involve the drug vadadustat. |
...
| popPK | Bhardwaj_2025 | irrelevant | 0 | 0 | The paper is an in-silico study on thiazole derivatives as LasR inhibitors and does not involve the drug vadadustat or report any pharmacokinetic parameters for it. |
...
| popPK | Didier_2026 | irrelevant | 0 | 0 | The paper is an in-vitro drug discovery study for Trypanosoma cruzi and does not involve vadadustat or report any pharmacokinetic parameters. |
...
| popPK | Disharoon_2026 | irrelevant | 0 | 0 | The paper is a computational study on drug-drug interaction prediction using deep learning and does not report pharmacokinetic parameters for vadadustat. |
...
| popPK | Draveny_2026 | irrelevant | 0 | 0 | The paper studies the antibiotic adjuvant NV716 in bacteria, not the drug vadadustat, and contains no pharmacokinetic parameters for vadadustat. |
...
| popPK | Dusek_2025 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics and pharmacodynamics of MI-883, not vadadustat. |
...
| popPK | Imai_2024 | irrelevant | 1 | 0 | The study is a clinical comparison of efficacy and cost, reporting hemoglobin levels and dose escalation rather than quantitative pharmacokinetic disposition parameters (CL, V, etc.) for vadadustat. |
| popPK | Inganäs_2025 | irrelevant | 0 | 0 | The paper is a computational study on PROTAC conformational dynamics and does not report pharmacokinetic parameters for vadadustat. |
...
| popPK | Janković_2025 | irrelevant | 2 | 0 | The text is a qualitative review describing general PK properties (linear, protein binding, excretion percentages) without reporting specific quantitative disposition parameters like clearance, volume, or half-life. |
...
| popPK | Jesudason_2026 | irrelevant | 0 | 0 | The paper focuses on SHIP1 ligands for Alzheimer's disease and does not involve vadadustat or report its pharmacokinetic parameters. |
...
| popPK | Jha_2024 | irrelevant | 0 | 0 | The paper is a computational study on MTHFD inhibitors and does not involve the drug vadadustat or report any pharmacokinetic parameters. |
...
| popPK | Jian_2022 | irrelevant | 0 | 0 | The paper focuses on the formulation of liposomes for PHD2 inhibitors and reports no quantitative pharmacokinetic parameters for vadadustat. |
...
| popPK | Marbán-González_2025 | irrelevant | 0 | 0 | The paper is a chemoinformatics study on Staphylococcus aureus FabI inhibitors and does not involve the drug vadadustat or report any pharmacokinetic parameters for it. |
...
| popPK | Moral-Sanz_2026 | irrelevant | 0 | 0 | The paper investigates the mechanism of action of sticholysin I (StnI) as a senolytic agent and does not mention vadadustat or report any pharmacokinetic parameters. |
...
| popPK | Muliaditan_2025 | irrelevant | 0 | 0 | The paper focuses on a PBPK model for transferrin receptor-mediated brain delivery of antibodies (e.g., trontinemab) and does not mention or report pharmacokinetic parameters for vadadustat. |
...
| popPK | Nakai_2024 | irrelevant | 2 | 0 | The study is a mechanistic investigation in mice focusing on gene expression and EPO induction, and the provided evidence contains no quantitative pharmacokinetic parameter values (CL, V, etc.) for vadadustat. |
...
| popPK | Nasr_2026 | irrelevant | 0 | 0 | The paper describes in vitro anticancer evaluation of thiazole-derived inhibitors and does not involve vadadustat or report any pharmacokinetic parameters. |
...
| popPK | Navarro-Gonzales_2024 | relevant | 8 | 4 | The paper reports quantitative PK parameters (t1/2, Tmax) for vadadustat, but lacks detailed compartmental model parameters (CL, V, Q) and specific AUC/Cmax values in the provided text. |
...
| popPK | Nourmandipour_2025 | irrelevant | 0 | 0 | The paper studies morphine derivatives, not vadadustat, and contains no pharmacokinetic parameters for the target drug. |
...
| popPK | OJeanson_2025 | irrelevant | 0 | 0 | The paper focuses on beta-lactam/beta-lactamase inhibitor combinations (e.g., ceftazidime-avibactam) and does not mention or study vadadustat. |
...
| popPK | Rudnicki_2024 | irrelevant | 0 | 0 | The paper studies the electrochemical properties of danofloxacin, not vadadustat, and contains no pharmacokinetic parameters. |
...
| popPK | Sako_2026 | irrelevant | 0 | 0 | The paper describes a computational method for 3D molecular generation (DiffPharma) and does not report pharmacokinetic parameters for vadadustat. |
...
| popPK | Shaikh_2025 | irrelevant | 2 | 0 | The paper is a comprehensive review without original quantitative PK parameter values (CL, V, etc.) for vadadustat. |
...
| popPK | Tavares_2023 | irrelevant | 0 | 0 | The paper studies antimalarial HDAC inhibitors (compounds 6a-8k) and does not mention or report pharmacokinetic parameters for vadadustat. |
...
| popPK | Todsaporn_2026 | irrelevant | 0 | 0 | The paper is a computational and in-vitro study on JAK2 inhibitors for cervical cancer and does not involve vadadustat or pharmacokinetic parameters. |
...
| popPK | Tükenmez_2026 | irrelevant | 0 | 0 | The paper describes the antimicrobial activity of TriPcides against Staphylococcus aureus and does not involve the drug vadadustat or pharmacokinetic parameters. |
...
| popPK | Waitman_2025 | irrelevant | 0 | 0 | The paper focuses on the discovery of novel HDAC6/AKT2 inhibitors for myeloid cancer and does not involve vadadustat or pharmacokinetic parameters. |
...
| popPK | Yokoyama_2024 | irrelevant | 2 | 0 | The paper describes a bioanalytical method validation and reports only raw plasma concentrations and variability, lacking quantitative pharmacokinetic parameters such as clearance, volume of distribution, or half-life. |
...
| popPK | Yu_2026 | irrelevant | 1 | 0 | The paper is a review of drug-drug interactions for 2024 FDA approvals where vadadustat is only mentioned as a transporter substrate/inhibitor without reporting its specific population PK parameters (CL, V, etc.). |
| PGx | Yu_2026 | not_relevant | 0 | 0 | The paper reviews drug-drug interactions (DDIs) for 2024 FDA approvals and mentions vadadustat only as a transporter substrate/inhibitor, without reporting any pharmacogenomic effects on its PK or PD parameters. |
