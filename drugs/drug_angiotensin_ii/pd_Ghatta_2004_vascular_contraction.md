...
## Citation
Ghatta S; Ramarao P et al. (2004). Lipids in health and disease 3
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | 5-hydroxytryptamine | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q320]` | 30.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 25.0 | not captured | only_one_extracted |
