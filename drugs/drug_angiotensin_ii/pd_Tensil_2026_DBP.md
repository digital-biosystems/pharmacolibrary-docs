...
# diastolic blood pressure — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.143). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Tensil E; Myshkina M; König M et al. (2026). Pharmaceutics 18
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model_family` | indirect_response_ii | indirect_response_iv | mismatch |
| `gpt-oss:120b` | `parameters[Q100]` | 25 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 50 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 50 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 25 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 50 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 50 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 50 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 12.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 25 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 50 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 50 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 50 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 50 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 12.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 100 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q364]` | not captured | 100 | only_one_extracted |
