...
Kurup S; de Mendizabal NV; Becker S; Bolella E; De Sousa D; Fätkenheuer G; Gruell H; Klein F; Malin JJ; Schmid U; Korell J et al. (2024). Journal of pharmacokinetics and pharmacodynamics 52
  ·  DOI: [10.1007/s10928-024-09947-2](https://doi.org/10.1007/s10928-024-09947-2)
...
|---|---|---|---|---|---|---|---|---|---|---|
| CLL (L/h) | `Q22` · CL | 0.000412 | L/h | 1.1444444444444444e-10 | L/h | not captured | review (0.7) | Kurup_2024:review | — | not captured |
| Vc (L) | `Q63` · V1 | 3.08 | L | 0.0030800000000000003 | L | not captured | review (0.7) | Kurup_2024:review | — | not captured |
| VP (L) | `Q64` · V2 | 4.36 | L | 0.00436 | L | not captured | review (0.7) | Kurup_2024:review | — | not captured |
| Q2 (L/h) | `Q30` · Q | 0.0359 | L/h | 9.972222222222223e-09 | L/h | not captured | review (0.7) | Kurup_2024:review | — | not captured |
...
- built from REVIEW reference values (Kurup_2024) — secondary source
...
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Kurup_2024:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 0.000412 | not captured | not captured | ['Kurup_2024:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | fail | clearance within physiological range | 0.000412 L/h | not captured | not captured | ['Kurup_2024:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 3.08 L | not captured | not captured | ['Kurup_2024:review'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 4.36 L | not captured | not captured | ['Kurup_2024:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_angiotensin_ii/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kurup_2024` / `Kurup_2024::reference`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-20 16:55 UTC</sub>
