...
## Model component
<dbs-pgx drug="angiotensin II" model-id="AngiotensinIi_van2026_reference" status="needs_review" stale="false" population="" measured-compound="angiotensin_ii" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl (ml/h) | `Q22` · CL | 716.15 | ml/h | 1.9893055555555554e-07 | L/h | not captured | review (0.7) | van_2026:review | — | not captured |
| V (L) | `Q61` · V | 24.87 | L | 0.024870000000000003 | L | not captured | review (0.7) | van_2026:review | — | not captured |
...
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.716 L/h | not captured | not captured | ['van_2026:review'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 24.9 L | not captured | not captured | ['van_2026:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_angiotensin_ii/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `van_2026` / `van_2026::reference`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-20 17:00 UTC</sub>
