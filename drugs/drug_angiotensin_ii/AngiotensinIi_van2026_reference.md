...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl (ml/h) | `Q22` · CL | —(suppressed) | ml/h | — | L/h | not captured | review (0.7) | van_2026:review | — | not captured |
| V (L) | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | van_2026:review | — | not captured |
