...
|---|---|---|---|---|---|---|---|---|---|---|
| Patient 1 V | `Q24` · CLu | —(suppressed) | ml/min | — | L/h | not captured | review (0.7) | Moran_1985:review | — | not captured |
| Patient 2 V | `Q61` · V | —(suppressed) | ml/min | — | L | not captured | review (0.7) | Moran_1985:review | — | not captured |
