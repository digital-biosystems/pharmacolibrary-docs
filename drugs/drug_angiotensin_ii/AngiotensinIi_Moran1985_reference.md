...
Moran SM; Myers BD et al. (1985). The Journal of clinical investigation 76
  ·  DOI: [10.1172/JCI112122](https://doi.org/10.1172/JCI112122)
...
|---|---|---|---|---|---|---|---|---|---|---|
| Patient 1 V | `Q24` · CLu | 1.4 | ml/min | 2.3333333333333334e-08 | L/h | not captured | review (0.7) | Moran_1985:review | — | not captured |
| Patient 2 V | `Q61` · V | 0.5 | ml/min | 8.333333333333334e-09 | L | not captured | review (0.7) | Moran_1985:review | — | not captured |
...
- built from REVIEW reference values (Moran_1985) — secondary source
...
| C9_phys_window_Q24 | pass | clearance within physiological range | 0.084 L/h | not captured | not captured | ['Moran_1985:review'] |
| C9_phys_window_Q61 | fail | volume within physiological range | 8.33e-06 L | not captured | not captured | ['Moran_1985:review'] |
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-20 16:57 UTC</sub>
