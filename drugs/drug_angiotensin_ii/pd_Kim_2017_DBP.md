...
# diastolic blood pressure — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.69). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.69 (29/42 fields) | 13 |
...
| `gpt-oss:120b` | `parameters[Q312]` | not captured | 5.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | not captured | 36.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | not captured | 1.25 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | not captured | 35.6 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 0.063 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 6.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 0.0001 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q316]` | 0.0001 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 82.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 131.0 | only_one_extracted |
