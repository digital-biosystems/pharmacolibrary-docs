...
# target protein — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.462). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.462 (48/104 fields) | 56 |

<details><summary>56 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | free cytoplasmic siRNA | siRNA | mismatch |
| `gpt-oss:120b` | `model_family` | indirect_response_ii | indirect_response_iii | mismatch |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 0.96 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q25]` | not captured | 211 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 33.79 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 66.48 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 33.79 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q328]` | not captured | 0.014 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q333]` | 14.34 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q343]` | not captured | 0.54 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q343]` | not captured | 1.54 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q47]` | 0.014 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 0.0012 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 0.014 | only_one_extracted |
