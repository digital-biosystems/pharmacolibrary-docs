...
|---|---|---|---|---|---|---|---|---|---|---|
| t lag (h) | `Q83` · tlag | —(suppressed) | h | — | h | not captured | space_fold (0.95) | Sáez-Belló_2021:other_prose | — | not captured |
| k a (h -1 ) | `Q49` · kabs | —(suppressed) | h -1 | — | 1/h | not captured | space_fold (0.95) | Sáez-Belló_2021:other_prose | — | not captured |
| CL 0 CAP (L/h) | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | boundary (0.8) | Sáez-Belló_2021:other_prose | — | not captured |
| CL 2 (%) | `Q30` · Q | —(suppressed) | % | — | % | not captured | special_case (0.95) | Sáez-Belló_2021:other_prose | — | not captured |
| V 2 (%) | `Q64` · V2 | —(suppressed) | % | — | % | not captured | space_fold (0.95) | Sáez-Belló_2021:other_prose | — | not captured |
