...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `kabs`, `fu`</sub>
...
|---|---|---|---|---|---|---|---|---|---|---|
| KA (l h -1 ) | `Q49` · kabs | —(suppressed) | l h -1 | — | [l] / [h] | not captured | exact (1.0) | tab_3:row2:col1, tab_3:row2:col2, tab_3:row2:col3, tab_3:row2:col4 | — | not captured |
| V1 (l) | `Q63` · V1 | —(suppressed) | l | — | [l] | not captured | exact (1.0) | tab_3:row4:col1, tab_3:row4:col2, tab_3:row4:col3 | — | not captured |
| V2 (l) | `Q64` · V2 | —(suppressed) | l | — | [l] | not captured | exact (1.0) | tab_3:row6:col1 | — | not captured |
| CL2 (l h -1 ) | `Q30` · Q | —(suppressed) | l h -1 | — | [l] / [h] | not captured | special_case (0.95) | tab_3:row7:col1, tab_3:row7:col2, tab_3:row7:col3, tab_3:row7:col4 | — | not captured |
| V3 (l) | `Q77` · V3 | —(suppressed) | l | — | [l] | not captured | exact (1.0) | tab_3:row8:col1, tab_3:row8:col2, tab_3:row8:col3, tab_3:row8:col4 | — | not captured |
| Res. Error 5-FU | `Q46` · fu | —(suppressed) | RE | — | [re] | not captured | boundary (0.8) | tab_3:row19:col3, tab_3:row19:col4 | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_capecitabine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Gieschke_2003` / `Gieschke_2003::reference`)
