...
- dropped unlinked row (NIL): 'Grade 0' — extend the ontology if this is a real PK parameter (source ['Joerger_2015_table_2:row15:col5', 'Joerger_2015_table_2:row18:col5', 'Joerger_2015_table_2:row21:col5', 'Joerger_2015_table_2:row24:col5'])
- dropped unlinked row (NIL): 'Grade I-III' — extend the ontology if this is a real PK parameter (source ['Joerger_2015_table_2:row16:col5', 'Joerger_2015_table_2:row22:col5', 'Joerger_2015_table_2:row25:col5'])
- dropped unlinked row (NIL): 'Grade I-IV' — extend the ontology if this is a real PK parameter (source ['Joerger_2015_table_2:row19:col5'])
...
- population split: 'dpyd c.2846a&gt;t wt' subgroup of Joerger_2015 (paper reports 3 populations: dpyd c.2846a&gt;t wt, dpyd c.85t&gt;c hom, mthfr c.677c&gt;t het)
...
- scholar stages: `../../../knowledgebase/drugs/drug_capecitabine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Joerger_2015` / `Joerger_2015::dpyd_c_2846a_t_wt`)
