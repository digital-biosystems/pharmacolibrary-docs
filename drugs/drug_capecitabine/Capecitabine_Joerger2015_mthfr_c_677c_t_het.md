...
## Model component
<dbs-pgx drug="capecitabine" model-id="Capecitabine_Joerger2015_mthfr_c_677c_t_het" status="rejected" stale="false" population="patients with metastatic gastrointestinal malignancies" measured-compound="capecitabine" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
- dropped unlinked row (NIL): 'Grade 0' — extend the ontology if this is a real PK parameter (source ['Joerger_2015_table_2:row2:col9', 'Joerger_2015_table_2:row5:col9', 'Joerger_2015_table_2:row8:col9', 'Joerger_2015_table_2:row11:col9', 'Joerger_2015_table_2:row15:col9', 'Joerger_2015_table_2:row18:col9', 'Joerger_2015_table_2:row21:col9', 'Joerger_2015_table_2:row24:col9'])
- dropped unlinked row (NIL): 'Grade I-III' — extend the ontology if this is a real PK parameter (source ['Joerger_2015_table_2:row3:col9', 'Joerger_2015_table_2:row9:col9', 'Joerger_2015_table_2:row12:col9', 'Joerger_2015_table_2:row16:col9', 'Joerger_2015_table_2:row22:col9', 'Joerger_2015_table_2:row25:col9'])
- dropped unlinked row (NIL): 'Grade I-IV' — extend the ontology if this is a real PK parameter (source ['Joerger_2015_table_2:row6:col9', 'Joerger_2015_table_2:row19:col9'])
...
- population split: 'mthfr c.677c&gt;t het' subgroup of Joerger_2015 (paper reports 3 populations: dpyd c.2846a&gt;t wt, dpyd c.85t&gt;c hom, mthfr c.677c&gt;t het)
...
- scholar stages: `../../../knowledgebase/drugs/drug_capecitabine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Joerger_2015` / `Joerger_2015::mthfr_c_677c_t_het`)
