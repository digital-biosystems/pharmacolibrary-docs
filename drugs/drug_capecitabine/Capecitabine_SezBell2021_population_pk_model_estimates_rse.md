...
|---|---|---|---|---|---|---|---|---|---|---|
| CL₀ CAP (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | not captured | llm (0.6) | Sáez-Belló_2021_table_p5_1:row3:col2 | — | not captured |
| V₂ CAP (L) | `Q64` · V2 | —(suppressed) | L | — | [l] | not captured | llm_confirmed (0.6) | Sáez-Belló_2021_table_p5_1:row9:col2 | — | not captured |
| t₁ag (%) | `Q83` · tlag | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Sáez-Belló_2021_table_p5_1:row13:col2 | — | not captured |
| kₐ (%) | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Sáez-Belló_2021_table_p5_1:row14:col2 | — | not captured |
| CL₂ (%) | `Q30` · Q | —(suppressed) | not captured | — | not captured | not captured | special_case (0.95) | Sáez-Belló_2021_table_p5_1:row16:col2 | — | not captured |
