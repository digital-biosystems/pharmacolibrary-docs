...
|---|---|---|---|---|---|---|---|---|---|---|
| k d (per year per mg) | `Q331` · KD | —(suppressed) | per year per mg | — | [peryearpermg] | not captured | space_fold (0.95) | tab_0:row6:col1 | — | not captured |
| k PD (per year) | `Q358` · CL_PD | —(suppressed) | per year | — | [peryear] | not captured | llm (0.6) | tab_0:row7:col1 | — | not captured |
