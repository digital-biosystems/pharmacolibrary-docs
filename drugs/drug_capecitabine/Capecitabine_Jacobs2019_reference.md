...
Jacobs BAW; Deenen MJ; Joerger M; Rosing H; de Vries N; Meulendijks D; et al. et al. (2019). CPT: pharmacometrics & systems pharmacology 8
  ·  DOI: [10.1002/psp4.12474](https://doi.org/10.1002/psp4.12474)
...
- dropped value-less row: 'k tr (hour−1)' (captured trailing unit 'hour−1' for child rows)
- dropped value-less row: 'Effect of partial gastrectomy'
- dropped value-less row: 'Effect of total gastrectomy'
- dropped value-less row: 'CLc/F CAP (L/hour)' (captured trailing unit 'L/hour' for child rows)
- dropped value-less row: 'Vc/F CAP (L)' (captured trailing unit 'L' for child rows)
- dropped value-less row: 'Qp/F CAP (L/hour)' (captured trailing unit 'L/hour' for child rows)
- dropped value-less row: 'Vp/F CAP (L)' (captured trailing unit 'L' for child rows)
- dropped value-less row: 'CLc/F dFCR (L/hour)' (captured trailing unit 'L/hour' for child rows)
- dropped value-less row: 'Vc/F dFCR (L)' (captured trailing unit 'L' for child rows)
- dropped value-less row: 'Qp/F dFCR (L/hour)' (captured trailing unit 'L/hour' for child rows)
- dropped value-less row: 'Vp/F dFCR (L)' (captured trailing unit 'L' for child rows)
- dropped value-less row: 'k dFUR&gt;5‐FU (hour‐1)' (captured trailing unit 'hour‐1' for child rows)
- dropped value-less row: 'k 5‐FU&gt;FBAL (hour‐1)' (captured trailing unit 'hour‐1' for child rows)
- dropped value-less row: 'Effect of DPYD*2A heterozygous mutation'
- dropped value-less row: 'CLc/F FBAL (L/hour)' (captured trailing unit 'L/hour' for child rows)
- dropped value-less row: 'Effect of age'
- dropped value-less row: 'Effect of gender female'
- dropped value-less row: 'Vc/F FBAL (L)' (captured trailing unit 'L' for child rows)
- dropped value-less row: 'Qp/F FBAL (L/hour)' (captured trailing unit 'L/hour' for child rows)
- dropped value-less row: 'Vp/F FBAL (L)' (captured trailing unit 'L' for child rows)
...
- scholar stages: `../../../knowledgebase/drugs/drug_capecitabine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Jacobs_2019` / `Jacobs_2019::reference`)
