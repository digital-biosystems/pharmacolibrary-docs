...
## Citation
Majiene D; Kuseliauskyte J; Stimbirys A; Jekabsone A et al. (2019). Nutrients 11
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | plumbagin, menadione, lawsone | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q358]` | 60.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | 30.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | 34.1 | not captured | only_one_extracted |
