...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[nonpregnant cl/f parameter - range]` | not captured | 2.9 | only_one_extracted |
| `gpt-oss:120b` | `parameters[nonpregnant cl/f]` | 2.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[nonpregnant clearance]` | 0.33 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[nonpregnant v/f - combined error model]` | not captured | 130 | only_one_extracted |
| `gpt-oss:120b` | `parameters[nonpregnant v/f]` | 130 | not captured | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_lamotrigine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Karanam_2025` / `Karanam_2025::reference`)
- model: `../../../knowledgebase/drugs/drug_lamotrigine/models/modelica/Lamotrigine_Karanam2025_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_lamotrigine/models/modelica/Lamotrigine_Karanam2025_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_lamotrigine/models/modelica/Lamotrigine_Karanam2025_reference.json`
