...
## Model component
<dbs-pgx drug="doxycycline" model-id="Doxycycline_Petkova2022_units" status="model_quarantined" stale="false" population="healthy and M. gallisepticum-infected broiler chickens" measured-compound="doxycycline" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|
| tvka | Q49 | not captured | tv_prefix |
| tvke | Q47 | not captured | tv_prefix |
...
- dropped unlinked row (NIL): 'tvk 12' — extend the ontology if this is a real PK parameter (source ['pharmaceutics-14-02440-t001:row4:col2'])
- dropped unlinked row (NIL): 'tvk 21' — extend the ontology if this is a real PK parameter (source ['pharmaceutics-14-02440-t001:row5:col2'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=doxycycline
- population split: 'units' subgroup of Petkova_2022 (paper reports 2 populations: estimates, units)
...
- scholar stages: `../../../knowledgebase/drugs/drug_doxycycline/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Petkova_2022` / `Petkova_2022::units`)
- model: `../../../knowledgebase/drugs/drug_doxycycline/models/modelica/_needs_review/Doxycycline_Petkova2022_units.mo`
- deviation: `../../../knowledgebase/drugs/drug_doxycycline/models/modelica/_needs_review/Doxycycline_Petkova2022_units.deviation.json`
