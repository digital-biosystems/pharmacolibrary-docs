...
|---|---|---|---|---|---|---|---|---|---|---|
| volume of distribution (Vd) | `Q61` · V | 865.15 | ml/kg | 0.060560499999999996 | [ml] / [kg] | not captured | exact (1.0) | Yang_2016:abstract | — | not captured |
| distribution rate constant (α) | `Q48` · kcomp | 2.28 | 1/h | 0.0006333333333333333 | [1] / [h] | not captured | exact (1.0) | Yang_2016:abstract | — | not captured |
| elimination rate constant (β) | `Q47` · kel | 0.08 | 1/h | 2.2222222222222223e-05 | [1] / [h] | not captured | exact (1.0) | Yang_2016:abstract | — | not captured |
| total body clearance (Cl) | `Q22` · CL | 104.11 | ml/h/kg | 2.024361111111111e-06 | [ml] / [[h] · [kg]] | not captured | llm_confirmed (0.6) | Yang_2016:abstract | — | not captured |
| absorption rate constant (Ka) | `Q49` · kabs | 2.55 | 1/h | 0.0007083333333333333 | [1] / [h] | not captured | exact (1.0) | Yang_2016:abstract | — | not captured |
| peak concentration (Cmax) | `Q32` · Cmax | 5.88 | μg/ml | not captured | [µg] / [ml] | not captured | exact (1.0) | Yang_2016:abstract | — | not captured |
| time to reach Cmax (tmax) | `Q56` · tmax | 1.73 | h | 6228.0 | [h] | not captured | llm_corrected (0.6) | Yang_2016:abstract | — | not captured |
| absolute bioavailability (F) | `Q40` · Fab | 52.33 | % | not captured | not captured | not captured | exact (1.0) | Yang_2016:abstract | — | not captured |
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_doxycycline/Doxycycline_Yang2016_reference/Doxycycline_Yang2016_reference_matlab.zip" download>Doxycycline_Yang2016_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
