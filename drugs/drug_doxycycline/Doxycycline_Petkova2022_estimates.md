...
## Model component
<dbs-pgx drug="doxycycline" model-id="Doxycycline_Petkova2022_estimates" status="model_quarantined" stale="false" population="healthy and M. gallisepticum-infected broiler chickens" measured-compound="doxycycline" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| tvka | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | tv_prefix (0.95) | pharmaceutics-14-02440-t001:row1:col1 | — | not captured |
| tvV/F | `Q76` · V/F | —(suppressed) | not captured | — | not captured | not captured | tv_prefix (0.95) | pharmaceutics-14-02440-t001:row2:col1 | — | not captured |
| tvke | `Q47` · kel | —(suppressed) | not captured | — | not captured | not captured | tv_prefix (0.95) | pharmaceutics-14-02440-t001:row3:col1 | — | not captured |
| tvtlag | `Q83` · tlag | —(suppressed) | not captured | — | not captured | not captured | tv_prefix (0.95) | pharmaceutics-14-02440-t001:row6:col1 | — | not captured |
...
- dropped unlinked row (NIL): 'tvk 12' — extend the ontology if this is a real PK parameter (source ['pharmaceutics-14-02440-t001:row4:col1'])
- dropped unlinked row (NIL): 'tvk 21' — extend the ontology if this is a real PK parameter (source ['pharmaceutics-14-02440-t001:row5:col1'])
...
- population split: 'estimates' subgroup of Petkova_2022 (paper reports 2 populations: estimates, units)
...
- scholar stages: `../../../knowledgebase/drugs/drug_doxycycline/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Petkova_2022` / `Petkova_2022::estimates`)
- model: `../../../knowledgebase/drugs/drug_doxycycline/models/modelica/_needs_review/Doxycycline_Petkova2022_estimates.mo`
- deviation: `../../../knowledgebase/drugs/drug_doxycycline/models/modelica/_needs_review/Doxycycline_Petkova2022_estimates.deviation.json`
