...
## Citation
Tynan BE; Papich MG; Kerl ME; Cohn LA et al. (2016). Journal of feline medicine and surgery 18
...
|---|---|---|---|---|---|---|---|---|---|---|
| Oral bioavailability | `Q40` · Fab | 62 | % | not captured | not captured | not captured | exact (1.0) | Tynan_2016:abstract | — | not captured |
| Plasma protein binding | `Q46` · fu | 60 | % | not captured | [%] | not captured | llm_confirmed (0.6) | Tynan_2016:abstract, Tynan_2016:abstract | — | not captured |
| elimination half-life (t(½)) | `Q57` · t1/2z | 6.7 | h | 24120.0 | [h] | not captured | llm (0.6) | Tynan_2016:abstract | — | not captured |
...
- dropped unlinked row (NIL): 'minimum inhibitory concentration' — extend the ontology if this is a real PK parameter (source ['Tynan_2016:abstract'])
- dropped unlinked row (NIL): 'oral dose' — extend the ontology if this is a real PK parameter (source ['Tynan_2016:abstract'])
...
- scholar stages: `../../../knowledgebase/drugs/drug_minocycline/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Tynan_2016` / `Tynan_2016::reference`)
- model: `../../../knowledgebase/drugs/drug_minocycline/models/modelica/Minocycline_Tynan2016_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_minocycline/models/modelica/Minocycline_Tynan2016_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_minocycline/models/modelica/Minocycline_Tynan2016_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_minocycline/Minocycline_Tynan2016_reference/Minocycline_Tynan2016_reference_modelica.zip" download>Minocycline_Tynan2016_reference_modelica.zip</a> <span class="pk-size">(3.9 kB)</span></td></tr>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_minocycline/Minocycline_Tynan2016_reference/Minocycline_Tynan2016_reference_matlab.zip" download>Minocycline_Tynan2016_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_minocycline/Minocycline_Tynan2016_reference/Minocycline_Tynan2016_reference.svg" alt="Minocycline_Tynan2016_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_minocycline/Minocycline_Tynan2016_reference/Minocycline_Tynan2016_reference_params.json" metaurl="assets/fmu/PK_1C.vr.json" wasmurl="assets/fmu/PK_1C.js" controlsurl="drugs/drug_minocycline/Minocycline_Tynan2016_reference/Minocycline_Tynan2016_reference_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C` · parameters `Minocycline_Tynan2016_reference_params.json` · controls `Minocycline_Tynan2016_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
