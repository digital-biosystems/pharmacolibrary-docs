...
| popPK | Saito_2020 | irrelevant | 2 | 0 | The paper reports pharmacodynamic (PD) parameters (Emax, EC50, disease progression) for glucose lowering, not pharmacokinetic (PK) disposition parameters (CL, V, ka) for ipragliflozin. |
...
| popPK | Toyoshima_2020 | irrelevant | 4 | 2 | The study reports PK/PD parameters (Emax, EX50) and AUC, but lacks the specific compartmental disposition parameters (CL, V, Q, ka) required for population-PK extraction. |
