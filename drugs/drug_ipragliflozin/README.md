...
**Description.** Ipragliflozin is under investigation in Type 2 Diabetes and Diabetes Mellitus, Type 2.

## Extraction summary

| extracted at | time | popPK e/r/o | PD e/r/o (paper) | PGx e/r/o | tokens in/out | LLM | papers | GROBID/JATS | OA/non-OA | NONMEM |
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-14 21:24 | 13:13 | 0/0/0 | 1/3/0 | 0/0/0 | 130,318/4,688 | ollama / qwen3.8:27b-mtp-q8_0 | 6 | 2/4 | 5/1 | 0 |
...
|---|---|---|---|---|---|---|
| `Saito_2019.pdf` | Saito M et al., Pharmacokinetic and pharmacodynamic mod…, British journal of clinical… (2019) | popPK | 10 | [10.1111/bcp.13972](https://doi.org/10.1111/bcp.13972) | [31026084](https://pubmed.ncbi.nlm.nih.gov/31026084) | The title confirms a PK/PD modeling study for ipragliflozin, but the provided evidence contains only the title and no numeric parameter values. |
| `Toyoshima_2020.pdf` | Toyoshima J et al., Comparison of the Pharmacokinetic and P…, Clinical therapeutics (2020) | popPK | 10 | [10.1016/j.clinthera.2020.07.009](https://doi.org/10.1016/j.clinthera.2020.07.009) | [32839028](https://pubmed.ncbi.nlm.nih.gov/32839028) | The title confirms a PK study of ipragliflozin, but the provided evidence contains only the title and no numeric parameter values. |
...
<sub>queue written 2026-09-14T21:21:25.529163+00:00</sub>
...
| popPK | Inoue_2019 | irrelevant | 0 | 0 | The study is a model-based meta-analysis of efficacy (FPG/HbA1c) and does not report pharmacokinetic parameters for ipragliflozin. |
...
| popPK | Jiang_2024 | irrelevant | 0 | 0 | The study focuses on empagliflozin, not ipragliflozin. |
...
| PD | Kong_2023 | not_relevant | 0 | 0 | The paper is an in silico study using molecular docking and dynamics; it cites a static IC50 value for ipragliflozin as a benchmark but does not report any exposure-response, dose-response, or PK/PD analysis or model. |
| popPK | Lo_2018 | irrelevant | 0 | 0 | This is a systematic review of clinical efficacy and safety outcomes (HbA1c, BP, etc.) in diabetes and CKD, not a pharmacokinetic study, and it does not report any PK parameters for ipragliflozin. |
| PD | Lo_2018 | not_relevant | 0 | 0 | The paper is a systematic review of clinical trials assessing efficacy and safety outcomes (HbA1c, BP, etc.) and does not report any pharmacokinetic or pharmacodynamic modeling, exposure-response relationships, or numeric PD parameters for ipragliflozin. |
| popPK | Maurer_2011 | irrelevant | 0 | 0 | The study focuses on dapagliflozin, not ipragliflozin, and does not report PK parameters for the target drug. |
| PD | Maurer_2011 | not_relevant | 0 | 0 | The paper focuses on the pharmacodynamic modeling of dapagliflozin, not ipragliflozin. |
| popPK | Saito_2019 | relevant | 10 | 0 | The title confirms a PK/PD modeling study for ipragliflozin, but the provided evidence contains only the title and no numeric parameter values. |
| popPK | Saito_2020 | irrelevant | 2 | 0 | The paper focuses on pharmacodynamic modeling of glucose-lowering effects (FPG/HbA1c) rather than reporting quantitative pharmacokinetic disposition parameters (CL, V, ka) for ipragliflozin. |
| popPK | Sato_2024 | irrelevant | 0 | 0 | The paper is a model-based meta-analysis of pharmacodynamic efficacy (HbA1c reduction) and does not report quantitative pharmacokinetic disposition parameters (CL, V, Q, ka) for ipragliflozin. |
...
| PD | Tahara_2016 | not_relevant | 2 | 1 | The text is an abstract describing a comparative study in mice that classifies drugs by duration of action but does not provide specific numeric PD parameters (e.g., Emax, EC50) or extractable concentration-effect curves for ipragliflozin. |
...
| popPK | Tanaka_2023 | irrelevant | 0 | 0 | The paper is a clinical trial sub-analysis focusing on fluid volume changes (ePV/eEV) and does not report pharmacokinetic parameters (CL, V, ka, etc.) for ipragliflozin. |
...
| popPK | Toyoshima_2020 | relevant | 10 | 0 | The title confirms a PK study of ipragliflozin, but the provided evidence contains only the title and no numeric parameter values. |
...
| PD | Veltkamp_2012 | not_relevant | 2 | 1 | The paper reports a single dose (300 mg) effect on urinary glucose excretion (UGE) but does not provide a concentration-effect curve, multiple dose levels, or numeric PD parameters (e.g., Emax, EC50) to define a pharmacodynamic relationship. |
| popPK | Wang_2022 | irrelevant | 0 | 0 | The study reports pharmacodynamic parameters (weight loss Emax and ET50) rather than pharmacokinetic disposition parameters (CL, V, ka, etc.) for ipragliflozin. |

---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_ipragliflozin`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
