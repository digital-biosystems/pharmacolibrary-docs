...
- scholar stages: `../../../knowledgebase/drugs/drug_diazepam/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Helfer_2026` / `Helfer_2026::reference`)
- model: `../../../knowledgebase/drugs/drug_diazepam/models/modelica/Diazepam_Helfer2026_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_diazepam/models/modelica/Diazepam_Helfer2026_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_diazepam/models/modelica/Diazepam_Helfer2026_reference.json`
...
<sub>Template `PK_2C` · parameters `Diazepam_Helfer2026_reference_params.json` · controls `Diazepam_Helfer2026_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
