...
## Model component
<dbs-pgx drug="diazepam" model-id="Diazepam_Ku2018_reference" status="curated_candidate" stale="false" population="children with status epilepticus" measured-compound="diazepam" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
| Q (L/h/70 kg) | `Q30` · Q | 18.1 | L/h/70 kg | 5.027777777777778e-06 | L/h | not captured | review_gapfill (0.7) | Helfer_2026:review | — | not captured |
...
- control_stream ADVAN3 TRANS4: topology=2C, parameterization=mechanistic (clearance)
...
- gap-filled Q30 (Q) from Helfer_2026's review values (primary lacked it)
...
- scholar stages: `../../../knowledgebase/drugs/drug_diazepam/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ku_2018` / `Ku_2018::reference`)
- model: `../../../knowledgebase/drugs/drug_diazepam/models/modelica/Diazepam_Ku2018_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_diazepam/models/modelica/Diazepam_Ku2018_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_diazepam/models/modelica/Diazepam_Ku2018_reference.json`
...
<img src="drugs/drug_diazepam/Diazepam_Ku2018_reference/Diazepam_Ku2018_reference.svg" alt="Diazepam_Ku2018_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_diazepam/Diazepam_Ku2018_reference/Diazepam_Ku2018_reference_modelica.zip" download>Diazepam_Ku2018_reference_modelica.zip</a> <span class="pk-size">(3.6 kB)</span></td></tr>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_diazepam/Diazepam_Ku2018_reference/Diazepam_Ku2018_reference_matlab.zip" download>Diazepam_Ku2018_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_diazepam/Diazepam_Ku2018_reference/Diazepam_Ku2018_reference_sbml.zip" download>Diazepam_Ku2018_reference_sbml.zip</a> <span class="pk-size">(2.4 kB)</span></td></tr>
...
<sub>Template `PK_2C` · parameters `Diazepam_Ku2018_reference_params.json` · controls `Diazepam_Ku2018_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
