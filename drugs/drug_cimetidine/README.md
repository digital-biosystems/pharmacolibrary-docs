...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-18 05:12 | 46:53 | 0/0/0 | 2/6/1 | 0/0/0 | 1,045,787/23,553 | ollama / qwen3.8:27b-mtp-q8_0 | 62 | 26/36 | 58/4 | 0 |
...
<sub>queue written 2026-09-18T04:56:06.176713+00:00</sub>
...
| popPK | Blandizzi_2001 | irrelevant | 0 | 0 | The study is a pharmacological investigation of H3 receptor mechanisms in guinea pig ileum where cimetidine is used only as a negative control H2 antagonist, with no pharmacokinetic parameters reported. |
...
| PGx | Curi-Pedrosa_1994 | not_relevant | 0 | 0 | The paper investigates the induction of CYP enzymes by drugs in vitro and does not report pharmacogenomic effects on cimetidine PK/PD parameters. |
...
| popPK | Dias_2026 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of vildagliptin, and cimetidine is used only as an internal standard for the analytical method. |
| popPK | Dodeja_2026 | irrelevant | 0 | 0 | The paper is a review on drug transfer into human milk, and cimetidine is only mentioned as a comparator in in-vitro/animal studies without reporting specific population PK parameters for the drug itself. |
...
| popPK | Emami_1986_2 | irrelevant | 0 | 0 | The study is a mechanistic in-vitro investigation of receptor binding (Ki) in fetal tissue, not a pharmacokinetic study reporting disposition parameters for cimetidine. |
...
| PGx | Ferguson_2017 | not_relevant | 0 | 0 | The paper reports on voriconazole autoinduction and the use of cimetidine as an inhibitor, but does not report a pharmacogenomic effect (gene variant) on cimetidine's PK/PD parameters. |
| popPK | Fimbo_2023 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of ivermectin, not cimetidine, which is only mentioned as a potential drug interaction. |
...
| PGx | Furuta_2001 | not_relevant | 0 | 0 | The paper investigates in vitro CYP inhibition by cimetidine but does not report any pharmacogenomic effects (gene variants) on cimetidine's PK or PD parameters. |
...
| popPK | Gisselmann_2004 | irrelevant | 0 | 0 | The paper is an in-vitro electrophysiology study on Drosophila ion channels where cimetidine is used only as a pharmacological antagonist, not as a subject drug for PK analysis. |
...
| PGx | Haehner_2004 | not_relevant | 0 | 0 | The paper reports in vitro drug-drug inhibition of CYP3A4 by cimetidine, not a pharmacogenomic effect of a gene variant on cimetidine's PK/PD. |
...
| popPK | Hanke_2021 | irrelevant | 0 | 0 | The paper focuses on the pharmacokinetics of rosuvastatin, not cimetidine. |
...
| popPK | Hosseini_2018 | irrelevant | 0 | 0 | The paper describes a software tool (gPKPDSim) for PK/PD modeling and uses generic or antibody examples for demonstration, with no mention of cimetidine as the subject drug. |
...
| PGx | Huang_2009 | not_relevant | 0 | 0 | The paper investigates in vitro inhibition of CYP enzymes by mushroom compounds and uses cimetidine only as a reference inhibitor, reporting no pharmacogenomic effects on cimetidine's PK or PD. |
...
| PGx | Jaiswal_2025 | not_relevant | 0 | 0 | The paper focuses on drug-drug interactions (DDI) and PBPK modeling for dordaviprone, not pharmacogenomic effects on cimetidine. |
...
| popPK | Kita_2017 | irrelevant | 0 | 0 | The paper is an in-vitro electrophysiology study on housefly chloride channels where cimetidine is used only as a pharmacological probe/inhibitor, not as a subject for PK analysis. |
...
| popPK | Lee_2015 | irrelevant | 0 | 0 | The paper is an ecotoxicological study reporting toxicity endpoints (EC50, NOEC) and endocrine disruption effects in aquatic organisms, not pharmacokinetic parameters for cimetidine. |
| PGx | Lennard_1986 | not_relevant | 0 | 0 | The paper studies the metabolism of metoprolol and the inhibitory effects of cimetidine in rat liver microsomes, not the pharmacogenomic effect of a gene variant on cimetidine's PK/PD. |
...
| popPK | Ma_2023 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of valproic acid (VPA), and cimetidine is only mentioned as an excluded medication in the study criteria. |
...
| popPK | Marques_2026 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of propranolol and omeprazole, with cimetidine mentioned only as a historical comparator for drug-drug interactions without any reported PK parameters. |
...
| popPK | Matsumoto_1999 | irrelevant | 0 | 0 | The paper is an electrophysiology study on histamine receptors in guinea-pig atrial cells where cimetidine is used only as a pharmacological tool (H2 antagonist) to determine receptor subtype, not as a subject for PK analysis. |
...
| PGx | Nomoto_2005 | not_relevant | 0 | 0 | The paper focuses on Parkinson's disease treatment and does not mention cimetidine or specific pharmacogenomic effects on its PK/PD. |
...
| popPK | Ottosson_1990 | irrelevant | 0 | 0 | The study is an in-vitro pharmacological investigation of histamine receptors where cimetidine is used only as a receptor antagonist, not as a subject drug for PK analysis. |
...
| PGx | Prescott_1983 | not_relevant | 0 | 0 | The paper discusses drug-drug interactions involving cimetidine and acetaminophen but does not report any pharmacogenomic effects (gene variants) on cimetidine's PK or PD parameters. |
...
| PGx | Royer_1996 | not_relevant | 0 | 0 | The paper investigates the metabolism of docetaxel and paclitaxel, not cimetidine, and does not report pharmacogenomic effects on cimetidine's PK/PD parameters. |
...
| PGx | Shibata_1983 | not_relevant | 0 | 0 | The paper investigates cimetidine polymorphism (crystal forms) and its effect on dissolution and receptor binding, not the effect of human gene variants on pharmacokinetics or pharmacodynamics. |
...
| popPK | Suttle_1992 | relevant | 8 | 0 | The paper reports fitting a PK model to cimetidine data and obtaining parameters, but the specific numeric values are not present in the provided evidence text. |
...
| popPK | Tamaoki_1991 | irrelevant | 0 | 0 | The study is an in-vitro mechanistic investigation of airway epithelium where cimetidine is used only as a comparator antagonist, with no pharmacokinetic parameters reported. |
...
| popPK | Tenero_1989 | irrelevant | 0 | 0 | The study evaluates the pharmacokinetics of dilevalol, with cimetidine serving only as a co-administered enzyme inhibitor, so no PK parameters for cimetidine are reported. |
...
| popPK | Wang_2020 | irrelevant | 0 | 0 | The study reports population pharmacokinetic parameters for delamanid, not cimetidine, which is only mentioned as a concomitant medication. |
...
| popPK | Yan_2026 | irrelevant | 0 | 0 | The study focuses on the PBPK modeling of rilzabrutinib, and cimetidine is only used as a CYP3A4 inhibitor in DDI simulations without reporting its own pharmacokinetic parameters. |
...
| PGx | Zhao_1997 | not_relevant | 0 | 0 | The paper reports in vitro drug-drug interactions (CYP3A4 inhibition) involving cimetidine, not pharmacogenomic effects of gene variants on cimetidine's PK or PD. |
| popPK | Zhou_2020 | irrelevant | 0 | 0 | The study reports population pharmacokinetic parameters for paclitaxel liposome, not cimetidine, which was only used as a premedication agent. |
