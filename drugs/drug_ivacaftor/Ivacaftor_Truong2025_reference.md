...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[σ additive].parameter_id` | Q317 | Q315 | mismatch |
| `gpt-oss:120b` | `parameters[σ proportional]` | 0.278 | not captured | only_one_extracted |
| `gpt-oss:120b` | `screen.dose_compound` | elexacaftor/tezacaftor/ivacaftor | elexacaftor, tezacaftor, ivacaftor | mismatch |
| `gpt-oss:120b` | `screen.primary_analyte` | elexacaftor/tezacaftor/ivacaftor | unknown | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_ivacaftor/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Truong_2025` / `Truong_2025::reference`)
- model: `../../../knowledgebase/drugs/drug_ivacaftor/models/modelica/_needs_review/Ivacaftor_Truong2025_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_ivacaftor/models/modelica/_needs_review/Ivacaftor_Truong2025_reference.deviation.json`
