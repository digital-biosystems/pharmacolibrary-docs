...
## Model component
<dbs-pgx drug="ivacaftor" model-id="Ivacaftor_Truong2025_reference" status="extracted" stale="false" population="pediatric patients with cystic fibrosis" measured-compound="elexacaftor/tezacaftor/ivacaftor" parameterization="apparent" topology="1C"></dbs-pgx>
...
| V/F (L/70 kg) | `Q76` · V/F | 183 | L/70 kg | not captured | [l] / [70kg] | 56.1 | exact (1.0) | tab_1:row7:col1, tab_1:row7:col2, tab_1:row7:col3 | — | not captured |
