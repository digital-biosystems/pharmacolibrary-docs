...
> ## <span class="pk-badge pk-badge--orange">built, not shipped</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.667 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `parameters[k(tr)]` | 5.97 | not captured | only_one_extracted |
| `parameters[v(2)]` | 21.0 | not captured | only_one_extracted |
