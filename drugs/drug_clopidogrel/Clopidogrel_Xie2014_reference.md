...
## Citation
Xie C; Ding XL; Xue L; Jiang B; Hang YF; Gao J; et al. et al. (2014). Yao xue xue bao = Acta pharmaceutica Sinica 49

## Model component
<dbs-pgx drug="clopidogrel" model-id="Clopidogrel_Xie2014_reference" status="rejected" stale="false" population="patients with acute coronary syndrome" measured-compound="clopidogrel active metabolite" parameterization="apparent" topology="parent_metabolite"></dbs-pgx>
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Xie_2014_metadata.yaml (6 record(s)); values are summary statistics, not a fitted model

## Validation

**Cross-check (two models):** <span class="pk-badge pk-badge--red">not confirmed</span>  
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.222 (2/9 fields) · the first reading is what this page shows

<details><summary>7 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `model.links` | [['clopidogrel', 'clopidogrel active metabolite', 'metabolism']] | [] | mismatch |
| `model.parameterization` | apparent | mechanistic | mismatch |
| `parameters[cl/f]` | 179 | not captured | only_one_extracted |
| `parameters[e]` | 0.664 | not captured | only_one_extracted |
| `parameters[k12]` | 0.259 | not captured | only_one_extracted |
| `parameters[k]` | 4.29 | not captured | only_one_extracted |
| `parameters[v/f]` | 632 | not captured | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_clopidogrel/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Xie_2014` / `Xie_2014::reference`)
