...
## Model component
<dbs-pgx drug="clopidogrel" model-id="Clopidogrel_Xie2014_reference" status="extracted" stale="false" population="patients with acute coronary syndrome" measured-compound="clopidogrel active metabolite" parameterization="mechanistic" topology="1C"></dbs-pgx>
