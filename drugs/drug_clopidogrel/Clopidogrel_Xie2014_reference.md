...
## Model component
<dbs-pgx drug="clopidogrel" model-id="Clopidogrel_Xie2014_reference" status="rejected" stale="false" population="patients with acute coronary syndrome" measured-compound="clopidogrel active metabolite" parameterization="apparent" topology="1C"></dbs-pgx>
