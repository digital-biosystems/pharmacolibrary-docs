...
# inhibition of platelet aggregation — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.5 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `driver_compound` | selatogrel, clopidogrel active metabolite, prasugrel active metabolite, ticagrelor, AR-C124910XX | selatogrel | mismatch |
| `model_family` | tmdd | effect_compartment | mismatch |
