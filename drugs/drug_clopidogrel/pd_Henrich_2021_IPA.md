...
# inhibition of platelet aggregation — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.75). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | selatogrel, clopidogrel active metabolite, prasugrel active metabolite, ticagrelor, AR-C124910XX | selatogrel (parent) and active metabolites of clopidogrel, prasugrel, ticagrelor | mismatch |
