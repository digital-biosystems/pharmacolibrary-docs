...
## Citation
Liu S; Wang Z; Tian X; Cai W et al. (2020). Frontiers in pharmacology 11
  ·  DOI: [10.3389/fphar.2020.591854](https://doi.org/10.3389/fphar.2020.591854)
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.0 (0/5 fields) · the first reading is what this page shows

<details><summary>5 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | AM-H4 | not captured | mismatch |
| `effect_direction` | inhibition | not captured | mismatch |
| `effect_form` | unknown | not captured | mismatch |
| `model_family` | indirect_response_ii | not captured | mismatch |
