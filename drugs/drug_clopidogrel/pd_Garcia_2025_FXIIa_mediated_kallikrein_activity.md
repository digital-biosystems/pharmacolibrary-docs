...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.0 (0/16 fields) · the first reading is what this page shows
...
| `parameters[Q88]` | 10300 | not captured | only_one_extracted |
| `parameters[Q88]` | 9920 | not captured | only_one_extracted |
