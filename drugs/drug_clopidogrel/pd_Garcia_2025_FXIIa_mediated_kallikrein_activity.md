...
# FXIIa-mediated kallikrein activity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.0 (0/16 fields) · the first reading is what this page shows

<details><summary>16 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | garadacimab | not captured | mismatch |
...
| `parameters[Q18]` | 10300 | not captured | only_one_extracted |
| `parameters[Q18]` | 9920 | not captured | only_one_extracted |
| `parameters[Q27]` | 0.0217 | not captured | only_one_extracted |
| `parameters[Q27]` | 0.0243 | not captured | only_one_extracted |
| `parameters[Q32]` | 21.2 | not captured | only_one_extracted |
| `parameters[Q32]` | 20.5 | not captured | only_one_extracted |
| `parameters[Q36]` | 9.30 | not captured | only_one_extracted |
| `parameters[Q36]` | 8.94 | not captured | only_one_extracted |
| `parameters[Q56]` | 140 | not captured | only_one_extracted |
| `parameters[Q57]` | 442 | not captured | only_one_extracted |
| `parameters[Q82]` | 7.42 | not captured | only_one_extracted |
| `parameters[Q82]` | 8.36 | not captured | only_one_extracted |
