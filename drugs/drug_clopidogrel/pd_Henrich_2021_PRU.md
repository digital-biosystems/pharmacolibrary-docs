...
# Platelet reactivity units — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.5). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | selatogrel, active metabolite of clopidogrel, active metabolite of prasugrel, ticagrelor, active metabolite of ticagrelor | selatogrel (parent) and active metabolites of clopidogrel, prasugrel, ticagrelor | mismatch |
| `gpt-oss:120b` | `model_family` | sigmoid_emax | tmdd | mismatch |
