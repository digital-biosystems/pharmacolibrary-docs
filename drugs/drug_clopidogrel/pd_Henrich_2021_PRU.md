...
# Platelet reactivity units — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.5 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `driver_compound` | selatogrel, active metabolite of clopidogrel, active metabolite of prasugrel, ticagrelor, active metabolite of ticagrelor | selatogrel | mismatch |
| `model_family` | sigmoid_emax | effect_compartment | mismatch |
