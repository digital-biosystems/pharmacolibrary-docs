...
# CYP2C19 — PGx  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.2). The first reading is what the record holds.">cross-check: partial</span>
...
| `gpt-oss:120b` | `target_parameter_id` | Q45 | not captured | mismatch |
| `gpt-oss:120b` | `theta[reported]` | -0.48 | not captured | only_one_extracted |
