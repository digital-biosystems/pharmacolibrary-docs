...
# JAK2V617F allele burden reduction — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.745). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.745 (38/51 fields) | 13 |

<details><summary>13 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `model_family` | tmdd | indirect_response_i | mismatch |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 11.4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 1.36 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 1.44 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 477 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 58.9 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 62.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | not captured | 135 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | 9.21 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q346]` | 135 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q346]` | not captured | 9.21 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 477 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q86]` | not captured | 1.44 | only_one_extracted |
