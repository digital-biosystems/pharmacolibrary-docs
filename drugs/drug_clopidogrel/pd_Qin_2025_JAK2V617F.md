...
# JAK2V617F allele burden reduction — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.692 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Qin A; Shimoda K; Suo S; Fu R; Kirito K; Wu D; Liao J; Chen H; Wu L; Su X; Gao Y; Sato T; Li Y; Zhang J; Shen W; Wang W; Zhang L; Jin J; Komatsu N et al. (2025). Pharmacology research & perspectives 13
...
| PLT0 (109 L−1 day−1) — Definition (units) | `Q358` · not captured | 477 | units | not captured | llm (not captured) | prp270109-tbl-0003:row12:col1 |
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.692 (36/52 fields) · the first reading is what this page shows

<details><summary>16 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `model_family` | tmdd | indirect_response_i | mismatch |
| `parameters[Q312]` | 1.36 | not captured | only_one_extracted |
| `parameters[Q312]` | 47.4 | not captured | only_one_extracted |
| `parameters[Q312]` | 1.44 | not captured | only_one_extracted |
| `parameters[Q312]` | 20 | not captured | only_one_extracted |
| `parameters[Q312]` | 1.05 | not captured | only_one_extracted |
| `parameters[Q320]` | not captured | 332 | only_one_extracted |
| `parameters[Q324]` | not captured | 477 | only_one_extracted |
| `parameters[Q324]` | not captured | 1.36 | only_one_extracted |
| `parameters[Q324]` | not captured | 11.4 | only_one_extracted |
| `parameters[Q324]` | not captured | 62.5 | only_one_extracted |
| `parameters[Q324]` | not captured | 1.44 | only_one_extracted |
| `parameters[Q324]` | not captured | 10.4 | only_one_extracted |
| `parameters[Q328]` | 9.44 | not captured | only_one_extracted |
| `parameters[Q358]` | 477 | not captured | only_one_extracted |
| `parameters[Q47]` | not captured | 9.44 | only_one_extracted |
