...
# thromboxane B2 — PD  <span class="pk-badge pk-badge--green">reviewed — candidate</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.705 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.705 (43/61 fields) · the first reading is what this page shows

<details><summary>18 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[Q290]` | 7.5 | not captured | only_one_extracted |
| `parameters[Q290]` | 2.6 | not captured | only_one_extracted |
| `parameters[Q290]` | 1.98 | not captured | only_one_extracted |
| `parameters[Q304]` | 0.27 | not captured | only_one_extracted |
| `parameters[Q312]` | not captured | 0.91 | only_one_extracted |
| `parameters[Q312]` | 12.6 | not captured | only_one_extracted |
| `parameters[Q326]` | 0.91 | not captured | only_one_extracted |
| `parameters[Q48]` | not captured | 0.27 | only_one_extracted |
| `parameters[Q48]` | not captured | 15 | only_one_extracted |
| `parameters[Q49]` | not captured | 14.7 | only_one_extracted |
| `parameters[Q76]` | not captured | 7.5 | only_one_extracted |
| `parameters[Q76]` | not captured | 2.6 | only_one_extracted |
| `parameters[Q76]` | not captured | 1.98 | only_one_extracted |
| `parameters[Q83]` | not captured | 12.6 | only_one_extracted |
| `parameters[Q83]` | not captured | 1.58 | only_one_extracted |
| `parameters[Q83]` | 15.8 | not captured | only_one_extracted |
| `parameters[Q86]` | 1.58 | not captured | only_one_extracted |
| `parameters[Q95]` | 14.7 | not captured | only_one_extracted |
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_clopidogrel/Clopidogrel_Koh2025_PD_txb2/Clopidogrel_Koh2025_PD_txb2_matlab.zip" download>Clopidogrel_Koh2025_PD_txb2_matlab.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
