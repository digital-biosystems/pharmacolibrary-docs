...
# thromboxane B2 — PD  <span class="pk-badge pk-badge--green">reviewed — candidate</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.778 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.778 (42/54 fields) · the first reading is what this page shows

<details><summary>12 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | acetylsalicylic acid | acetylsalicylic_acid | mismatch |
| `effect_form` | unknown | proportional | mismatch |
| `parameters[Q27]` | 0.24 | not captured | only_one_extracted |
| `parameters[Q312]` | not captured | 0.91 | only_one_extracted |
| `parameters[Q312]` | not captured | 0.24 | only_one_extracted |
| `parameters[Q312]` | not captured | 11.9 | only_one_extracted |
| `parameters[Q314]` | not captured | 13.7 | only_one_extracted |
| `parameters[Q76]` | 2.6 | not captured | only_one_extracted |
...
| `parameters[Q86]` | 15.8 | not captured | only_one_extracted |
