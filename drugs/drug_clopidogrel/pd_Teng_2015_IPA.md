...
# final-extent inhibition of platelet aggregation — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.444 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `parameters[Q320]` | not captured | 2 | only_one_extracted |
| `parameters[Q32]` | 2 | not captured | only_one_extracted |
| `parameters[Q32]` | 8 | not captured | only_one_extracted |
| `parameters[Q32]` | 3 | not captured | only_one_extracted |
| `parameters[Q38]` | not captured | 2 | only_one_extracted |
