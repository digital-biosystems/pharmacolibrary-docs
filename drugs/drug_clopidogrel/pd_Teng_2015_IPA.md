...
# final-extent inhibition of platelet aggregation — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.444). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 3 | not captured | only_one_extracted |
