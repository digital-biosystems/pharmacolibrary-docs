...
<img src="drugs/drug_clopidogrel/Clopidogrel_Grafeneder2024_hv/Clopidogrel_Grafeneder2024_hv.svg" alt="Clopidogrel_Grafeneder2024_hv diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_1C` · parameters `Clopidogrel_Grafeneder2024_hv_params.json` · controls `Clopidogrel_Grafeneder2024_hv_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
