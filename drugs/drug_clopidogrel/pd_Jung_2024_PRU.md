...
# P2Y12 reaction unit — PD  <span class="pk-badge pk-badge--green">reviewed — candidate</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.591 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
| fm1 — Standard deviation | `Q45` · not captured | 0.255 | not captured | not captured | llm (not captured) | psp413053-tbl-0002:row12:col2 |
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.591 (26/44 fields) · the first reading is what this page shows

<details><summary>18 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[Q22]` | not captured | 0.123 | only_one_extracted |
| `parameters[Q22]` | not captured | 0.343 | only_one_extracted |
| `parameters[Q22]` | not captured | 845.70 | only_one_extracted |
| `parameters[Q30]` | 845.70 | not captured | only_one_extracted |
| `parameters[Q314]` | not captured | 0.702 | only_one_extracted |
| `parameters[Q315]` | not captured | 1.130 | only_one_extracted |
| `parameters[Q327]` | not captured | 0.120 | only_one_extracted |
| `parameters[Q45]` | not captured | 0.255 | only_one_extracted |
| `parameters[Q45]` | not captured | -0.996 | only_one_extracted |
| `parameters[Q45]` | not captured | -2.432 | only_one_extracted |
| `parameters[Q49]` | not captured | 19.64 | only_one_extracted |
| `parameters[Q61]` | 51.89 | not captured | only_one_extracted |
| `parameters[Q61]` | 1463.92 | not captured | only_one_extracted |
| `parameters[Q61]` | 0.331 | not captured | only_one_extracted |
| `parameters[Q63]` | not captured | 1463.92 | only_one_extracted |
| `parameters[Q63]` | not captured | 0.331 | only_one_extracted |
| `parameters[Q64]` | not captured | 51.89 | only_one_extracted |
| `parameters[Q95]` | 19.64 | not captured | only_one_extracted |
