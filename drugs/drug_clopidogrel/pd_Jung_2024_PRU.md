...
# P2Y12 reaction unit — PD  <span class="pk-badge pk-badge--green">reviewed — candidate</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.569). The first reading is what the record holds.">cross-check: disputed</span>
...
| Q p (L/h) — Population mean | `Q358` · not captured | 587.93 | L/h | not captured | llm (not captured) | psp413053-tbl-0002:row7:col1 |
...
| fm1 — Population mean | `Q45` · not captured | 0.125 | not captured | not captured | llm (not captured) | psp413053-tbl-0002:row12:col1 |
...
| fm2 — Population mean | `Q45` · not captured | 0.960 | not captured | not captured | llm (not captured) | psp413053-tbl-0002:row15:col1 |
...
| V m2 (L) — Population mean | `Q352` · not captured | 17.34 | L | not captured | llm (not captured) | psp413053-tbl-0002:row20:col1 |
...
`Clopidogrel_Jung2024_PD_pru` — turnover (indirect response type IV), `response = E0/(1 + Emax*frac)`
...
- `pd_binding_emax_not_a_fraction` — type II needs Imax ≤ 1 but the record has 57.84; bound as the reciprocal stimulation form (IV) the paper fitted
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.569 (29/51 fields) | 22 |
...
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 74.25 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 7.248 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 0.123 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 0.307 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 4.476 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 845.70 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 587.93 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | not captured | 0.255 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | 0.702 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 1.130 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q352]` | 17.34 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 74.25 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 7.248 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.123 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 4.476 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 845.70 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.307 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 587.93 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | not captured | 51.45 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | not captured | 17.34 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q63]` | 51.45 | not captured | only_one_extracted |
...
<dbs-fmusim paramsurl="drugs/drug_clopidogrel/Clopidogrel_Jung2024_PD_pru/Clopidogrel_Jung2024_PD_pru_params.json" metaurl="assets/fmu/PD_IndirectTurnoverSweep.vr.json" wasmurl="assets/fmu/PD_IndirectTurnoverSweep.js" controlsurl="drugs/drug_clopidogrel/Clopidogrel_Jung2024_PD_pru/Clopidogrel_Jung2024_PD_pru_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PD_IndirectTurnoverSweep` · parameters `Clopidogrel_Jung2024_PD_pru_params.json` · controls `Clopidogrel_Jung2024_PD_pru_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
