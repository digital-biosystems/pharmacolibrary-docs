...
# Hemoglobin — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.562 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.562 (59/105 fields) · the first reading is what this page shows

<details><summary>46 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `model_family` | disease_progression | indirect_response_i | mismatch |
| `parameters[Q100]` | 103 | not captured | only_one_extracted |
| `parameters[Q100]` | 105 | not captured | only_one_extracted |
| `parameters[Q100]` | 104 | not captured | only_one_extracted |
| `parameters[Q100]` | 96.1 | not captured | only_one_extracted |
| `parameters[Q100]` | 101 | not captured | only_one_extracted |
| `parameters[Q100]` | 94.3 | not captured | only_one_extracted |
| `parameters[Q100]` | 96.4 | not captured | only_one_extracted |
| `parameters[Q30]` | not captured | 10.8 | only_one_extracted |
| `parameters[Q30]` | not captured | 0.422 | only_one_extracted |
| `parameters[Q312]` | not captured | 1.10 | only_one_extracted |
| `parameters[Q312]` | not captured | 11.2 | only_one_extracted |
| `parameters[Q314]` | not captured | 11.9 | only_one_extracted |
| `parameters[Q315]` | not captured | 4.4 | only_one_extracted |
| `parameters[Q315]` | not captured | 4.3 | only_one_extracted |
| `parameters[Q315]` | not captured | 8.6 | only_one_extracted |
| `parameters[Q315]` | not captured | 5.73 | only_one_extracted |
| `parameters[Q315]` | not captured | 1.0 | only_one_extracted |
| `parameters[Q315]` | not captured | 5.72 | only_one_extracted |
| `parameters[Q315]` | not captured | 1.0 | only_one_extracted |
| `parameters[Q317]` | not captured | 11.3 | only_one_extracted |
| `parameters[Q317]` | not captured | not captured | only_one_extracted |
| `parameters[Q324]` | not captured | 103 | only_one_extracted |
| `parameters[Q324]` | 4.4 | not captured | only_one_extracted |
| `parameters[Q324]` | 4.3 | not captured | only_one_extracted |
| `parameters[Q324]` | not captured | 105 | only_one_extracted |
| `parameters[Q324]` | not captured | 104 | only_one_extracted |
| `parameters[Q324]` | not captured | 96.1 | only_one_extracted |
| `parameters[Q324]` | not captured | 101 | only_one_extracted |
| `parameters[Q324]` | not captured | 94.3 | only_one_extracted |
| `parameters[Q324]` | not captured | 96.4 | only_one_extracted |
| `parameters[Q340]` | -0.0462 | not captured | only_one_extracted |
| `parameters[Q340]` | 6.0 | not captured | only_one_extracted |
| `parameters[Q340]` | -0.0851 | not captured | only_one_extracted |
| `parameters[Q340]` | 8.3 | not captured | only_one_extracted |
| `parameters[Q340]` | 11.3 | not captured | only_one_extracted |
| `parameters[Q340]` | 8.6 | not captured | only_one_extracted |
| `parameters[Q340]` | 11.2 | not captured | only_one_extracted |
| `parameters[Q342]` | not captured | -0.0462 | only_one_extracted |
| `parameters[Q342]` | not captured | 6.0 | only_one_extracted |
| `parameters[Q342]` | not captured | -0.0851 | only_one_extracted |
| `parameters[Q342]` | not captured | 8.3 | only_one_extracted |
| `parameters[Q53]` | not captured | 3.19 | only_one_extracted |
| `parameters[Q57]` | not captured | 3.19 | only_one_extracted |
| `parameters[Q900]` | 0.426 | not captured | only_one_extracted |
| `parameters[Q900]` | not captured | not captured | only_one_extracted |
