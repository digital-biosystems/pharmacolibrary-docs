...
| Covariance between disease progression second year and third year and beyond — Final model | `Q314` · not captured | 11.9 | not captured | not captured | llm (not captured) | cpt3544-tbl-0002:row47:col4 |
