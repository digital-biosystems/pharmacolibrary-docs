...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax_CLO [ng/ml] | `Q32` · Cmax | —(suppressed) | ng/ml | — | [ng] / [ml] | not captured | llm (0.6) | Grafeneder_2024_table_3:row3:col7 | — | not captured |
...
| AUClast_CLO [ng/ml·min] | `Q74` · AUClast | —(suppressed) | ng/ml·min | — | [ng] / [[min] · [ml]] | not captured | llm (0.6) | Grafeneder_2024_table_3:row6:col7 | — | not captured |
| t1/2 [min] | `Q57` · t1/2z | —(suppressed) | min | — | [min] | not captured | llm_confirmed (0.6) | Grafeneder_2024_table_3:row13:col7 | — | not captured |
| Clearance [ml/min] | `Q22` · CL | —(suppressed) | ml/min | — | [ml] / [min] | not captured | llm_confirmed (0.6) | Grafeneder_2024_table_3:row14:col7 | — | not captured |
| VD [ml] | `Q61` · V | —(suppressed) | ml | — | [ml] | not captured | llm_confirmed (0.6) | Grafeneder_2024_table_3:row15:col7 | — | not captured |
...
| C9_phys_window_Q61 | pass | volume within physiological range | 40.6 L | not captured | not captured | ['Grafeneder_2024_table_3:row15:col7'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_clopidogrel/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Grafeneder_2024` / `Grafeneder_2024::hdp`)
