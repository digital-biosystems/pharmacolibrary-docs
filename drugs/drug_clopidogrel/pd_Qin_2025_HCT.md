...
# hematocrit — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.756 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
| PLT0 (109 L−1 day−1) — Estimates (RSE%) | `Q358` · not captured | 58.9 | RSE% | not captured | llm (not captured) | prp270109-tbl-0003:row12:col2 |
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.756 (34/45 fields) · the first reading is what this page shows

<details><summary>11 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[Q306]` | not captured | 113 | only_one_extracted |
| `parameters[Q306]` | not captured | 17.8 | only_one_extracted |
...
| `parameters[Q320]` | not captured | 0.592 | only_one_extracted |
| `parameters[Q323]` | 0.592 | not captured | only_one_extracted |
| `parameters[Q328]` | 0.0299 | not captured | only_one_extracted |
| `parameters[Q338]` | 113 | not captured | only_one_extracted |
| `parameters[Q338]` | 17.8 | not captured | only_one_extracted |
| `parameters[Q47]` | not captured | 0.0299 | only_one_extracted |
