...
## Citation
Kim MJ; Kim H; Lee SM; Choi HY; Kim YH; Choi SC; et al. et al. (2023). Clinical pharmacology in drug development 12
  ·  DOI: [10.1002/cpdd.1172](https://doi.org/10.1002/cpdd.1172)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | R-138727 | not captured | mismatch |
...
---
<sub>← back to [prasugrel](drugs/drug_prasugrel/)</sub>
