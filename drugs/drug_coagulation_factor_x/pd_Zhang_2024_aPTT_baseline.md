...
# aPTT ratio to baseline — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.292). The first reading is what the record holds.">cross-check: disputed</span>
