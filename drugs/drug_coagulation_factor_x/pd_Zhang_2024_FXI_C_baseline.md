...
# FXI clotting activity ratio to baseline — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.292). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Zhang JY; Ruan ZR; Jiang B; Yang DD; Wang JY; Hu Y; Wang YR; Wang YM; Lin YF; Wang LL; Lou HG et al. (2024). Clinical and translational science 17
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.292 (7/24 fields) | 17 |
...
| `gpt-oss:120b` | `parameters[Q100]` | 1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 23.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 6.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 37.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 6.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 37.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 23.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 0 | only_one_extracted |
