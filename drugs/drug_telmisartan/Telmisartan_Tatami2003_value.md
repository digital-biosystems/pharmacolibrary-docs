...
## Model component
<dbs-pgx drug="telmisartan" model-id="Telmisartan_Tatami2003_value" status="rejected" stale="false" population="healthy volunteers and hypertensive patients" measured-compound="telmisartan" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Tatami_2003_table_p6_2:row7:col1, Tatami_2003_table_4:row4:col4 | — | not captured |
...
| V_1/F | Q290 | not captured | exact |
| V_2/F | Q82 | not captured | exact |
| ALAG | Q83 | not captured | exact |

## Departures & gaps

**Interpretation flags:**
- dropped unlinked row (NIL): 'ETOH' — extend the ontology if this is a real PK parameter (source ['Tatami_2003_table_p6_2:row2:col1'])
- dropped unlinked row (NIL): 'GENDER' — extend the ontology if this is a real PK parameter (source ['Tatami_2003_table_p6_2:row6:col1'])
...
- population split: 'value' subgroup of Tatami_2003 (paper reports 5 populations: calculated exposures, covariates, estimated parameters, final estimates of the model parameters, value)
...
- scholar stages: `../../../knowledgebase/drugs/drug_telmisartan/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Tatami_2003` / `Tatami_2003::value`)
