...
## Model component
<dbs-pgx drug="telmisartan" model-id="Telmisartan_Chae2018_reference" status="not_modelled" stale="false" population="healthy adults" measured-compound="telmisartan" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_telmisartan/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Chae_2018` / `Chae_2018::healthy adults`)
- sim: `../../../knowledgebase/drugs/drug_telmisartan/models/modelica/Telmisartan_Chae2018_healthy_adults.json`
