...
|---|---|---|---|---|---|---|---|---|---|---|
| 1.098 | `Q47` · kel | —(suppressed) | h−1 | — | [1] / [h] | not captured | llm (0.5) | T2:row2:col1, T2:row2:col2, T2:row2:col3, T2:row2:col4, T2:row2:col5, T2:row2:col6, T2:row2:col7, T2:row2:col8, T2:row2:col9, T2:row2:col10, T2:row2:col11, T2:row2:col12 | — | not captured |
