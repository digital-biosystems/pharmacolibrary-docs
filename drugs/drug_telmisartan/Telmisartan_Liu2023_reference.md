...
## Citation
Liu F; Yi H; Wang L; Cheng Z; Zhang G et al. (2023). Frontiers in pharmacology 14
  ·  DOI: [10.3389/fphar.2023.1087913](https://doi.org/10.3389/fphar.2023.1087913)

## Model component
<dbs-pgx drug="telmisartan" model-id="Telmisartan_Liu2023_reference" status="rejected" stale="false" population="healthy volunteers" measured-compound="telmisartan" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1.098 | `Q47` · kel | 1.09 | h−1 | 0.0003027777777777778 | [1] / [h] | not captured | llm (0.5) | T2:row2:col1, T2:row2:col2, T2:row2:col3, T2:row2:col4, T2:row2:col5, T2:row2:col6, T2:row2:col7, T2:row2:col8, T2:row2:col9, T2:row2:col10, T2:row2:col11, T2:row2:col12 | — | not captured |
...
- dropped duplicate Q47 ('0.525', value '-86.4') — already have one for this compound
- dropped duplicate Q47 ('0.211', value '-35.5') — already have one for this compound
- dropped duplicate Q47 ('0.133', value '-48.3') — already have one for this compound
- dropped duplicate Q47 ('0.603', value '-19.6') — already have one for this compound
- dropped duplicate Q47 ('0.375', value '41.1') — already have one for this compound
...
**Extraction notes:**
- LLM region Liu_2023:discussion_prose: no JSON records returned
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model.links` | [['candesartan cilexetil', 'candesartan', 'metabolism'], ['tenofovir disoproxil fumarate', 'tenofovir', 'metabolism']] | [] | mismatch |
| `gpt-oss:120b` | `screen.dose_compound` | telmisartan | telmisartan, candesartan cilexetil, tenofovir disoproxil fumarate | mismatch |
| `gpt-oss:120b` | `screen.primary_analyte` | telmisartan | telmisartan, candesartan cilexetil, tenofovir disoproxil fumarate | mismatch |
...
| C5_dimension_Q47 | pass | 1 / [time] | not captured | not captured | not captured | ['T2:row2:col1', 'T2:row2:col2', 'T2:row2:col3', 'T2:row2:col4', 'T2:row2:col5', 'T2:row2:col6', 'T2:row2:col7', 'T2:row2:col8', 'T2:row2:col9', 'T2:row2:col10', 'T2:row2:col11', 'T2:row2:col12'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_telmisartan/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Liu_2023` / `Liu_2023::reference`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-23 02:22 UTC</sub>
