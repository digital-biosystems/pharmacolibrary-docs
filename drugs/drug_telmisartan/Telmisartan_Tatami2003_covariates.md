...
## Model component
<dbs-pgx drug="telmisartan" model-id="Telmisartan_Tatami2003_covariates" status="model_quarantined" stale="false" population="healthy volunteers and hypertensive patients" measured-compound="telmisartan" parameterization="apparent" topology="2C"></dbs-pgx>
...
- population split: 'covariates' subgroup of Tatami_2003 (paper reports 5 populations: calculated exposures, covariates, estimated parameters, final estimates of the model parameters, value)
...
- scholar stages: `../../../knowledgebase/drugs/drug_telmisartan/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Tatami_2003` / `Tatami_2003::covariates`)
- model: `../../../knowledgebase/drugs/drug_telmisartan/models/modelica/_needs_review/Telmisartan_Tatami2003_covariates.mo`
- deviation: `../../../knowledgebase/drugs/drug_telmisartan/models/modelica/_needs_review/Telmisartan_Tatami2003_covariates.deviation.json`
