...
|---|---|---|---|---|---|---|---|---|---|---|
| K 12 (h -1 ) | `Q301` · k12 | 8.09 | h -1 | 0.002247222222222222 | [1] / [h] | not captured | space_fold (0.95) | tab_3:row2:col2, tab_3:row2:col3 | — | not captured |
...
| T LAG (h) | `Q83` · tlag | 0.242 | h | 871.1999999999999 | [h] | not captured | space_fold (0.95) | tab_3:row7:col1, tab_3:row7:col3, tab_3:row7:col4 | — | not captured |
...
| `gpt-oss:120b` | `parameters[theta_q51_ugt1a3]` | not captured | 0.550 | only_one_extracted |
...
| T1_cmax | reference | pass | 0.0008359999999999999 | 0.0010426681604244585 | 1.2472 | ng/ml→SI vs simulated kg/m3 |
| T1_cmax | reference | fail | 1.0600000000000001e-07 | 0.0010426681604244585 | 9836.4921 | pg/ml→SI vs simulated kg/m3 |
| T1_tmax | reference | fail | 0.773 | 1.0768998483149987 | 1.3931 | h→SI vs simulated h |
| T1_tmax | reference | fail | 9.06 | 1.0768998483149987 | 0.1189 | h→SI vs simulated h |
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_telmisartan/Telmisartan_Ieiri2011_reference/Telmisartan_Ieiri2011_reference.svg" alt="Telmisartan_Ieiri2011_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
