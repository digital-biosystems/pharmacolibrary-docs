...
**What is wrong:** the simulated model does not reproduce a value the paper reports; the model was built differently from what the record describes; the engineer did not exercise the covariate scenarios this record defines. Evidence: T1_cmax — expected 0.0008359999999999999 — got 0.0005763151316749828 — ratio 0.6894; T1_cmax — expected 1.0600000000000001e-07 — got 0.0005763151316749828 — ratio 5436.9352; T1_tmax — expected 0.773 — got 4.157325810879046 — ratio 5.3782; T1_tmax — expected 9.06 — got 4.157325810879046 — ratio 0.4589
...
## Model component
<dbs-pgx drug="telmisartan" model-id="Telmisartan_Ieiri2011_reference" status="needs_review" stale="false" population="healthy volunteers" measured-compound="telmisartan" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| K 12 (h -1 ) | `Q301` · k12 | —(suppressed) | h -1 | — | [1] / [h] | not captured | llm (0.6) | tab_3:row2:col2, tab_3:row2:col3 | — | not captured |
| CL/F (l/h) | `Q27` · CL/F | —(suppressed) | l/h | — | [l] / [h] | not captured | exact (1.0) | tab_3:row3:col1, tab_3:row3:col3 | — | not captured |
| V/F (l) | `Q76` · V/F | —(suppressed) | l | — | [l] | not captured | exact (1.0) | tab_3:row4:col2 | — | not captured |
| T g (h) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | llm (0.6) | tab_3:row6:col1, tab_3:row6:col3, tab_3:row6:col4 | — | not captured |
| T LAG (h) | `Q83` · tlag | —(suppressed) | h | — | [h] | not captured | llm (0.6) | tab_3:row7:col1, tab_3:row7:col3, tab_3:row7:col4 | — | not captured |
...
| T3_param_coverage | not captured | fail | 5 scholar param(s) emitted or defaulted | 4 covered | not captured | neither emitted nor in defaulted[]: ['k12'] |
| T3_topology_template | not captured | pass | 1C → PK_1C* | PK_1C_enteral | not captured | engineer template must match the scholar topology |
| T6_deviations | not captured | pass | not captured | all deviations documented+quantified | not captured | LLM adjudication → deterministic rule |
| T1_cmax | reference | fail | 0.0008359999999999999 | 0.0005763151316749828 | 0.6894 | ng/ml→SI vs simulated kg/m3 |
| T1_cmax | reference | fail | 1.0600000000000001e-07 | 0.0005763151316749828 | 5436.9352 | pg/ml→SI vs simulated kg/m3 |
| T1_tmax | reference | fail | 0.773 | 4.157325810879046 | 5.3782 | h→SI vs simulated h |
| T1_tmax | reference | fail | 9.06 | 4.157325810879046 | 0.4589 | h→SI vs simulated h |
...
- model: `../../../knowledgebase/drugs/drug_telmisartan/models/modelica/Telmisartan_Ieiri2011_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_telmisartan/models/modelica/Telmisartan_Ieiri2011_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_telmisartan/models/modelica/Telmisartan_Ieiri2011_reference.json`
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_telmisartan/Telmisartan_Ieiri2011_reference/Telmisartan_Ieiri2011_reference.svg" alt="Telmisartan_Ieiri2011_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Telmisartan_Ieiri2011_reference_params.json` · controls `Telmisartan_Ieiri2011_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
