...
# cellular antioxidant activity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Wang X; Yu H; Xing R; Liu S; Chen X; Li P et al. (2019). Molecules (Basel, Switzerland) 24
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | Pacific herring protein hydrolysates (PHPH) | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 4.57 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 3.78 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 5.14 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 4.37 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | not captured | only_one_extracted |
