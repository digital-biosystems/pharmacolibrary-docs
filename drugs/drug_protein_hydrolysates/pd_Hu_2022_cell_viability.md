...
## Citation
Hu X; Liu J; Li J; Song Y; Chen S; Zhou S; et al. et al. (2022). Frontiers in nutrition 9
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | PGPTY | PGPTY peptide | mismatch |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 5.35 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 1.21 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 0.24 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 5.35 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.21 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.24 | not captured | only_one_extracted |
