...
# Superoxide anion radical scavenging activity — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
| `gpt-oss:120b` | `parameters[Q321]` | 3.76 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.31 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 1.33 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q321]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 2.43 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.30 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 1.71 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.43 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.81 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q321]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 1.79 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.56 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 1.51 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.38 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 3.04 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.71 | not captured | only_one_extracted |
