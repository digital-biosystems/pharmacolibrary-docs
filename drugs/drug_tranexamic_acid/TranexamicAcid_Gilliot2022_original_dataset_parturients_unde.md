...
## Model component
<dbs-pgx drug="tranexamic acid" model-id="TranexamicAcid_Gilliot2022_original_dataset_parturients_unde" status="not_modelled" stale="false" population="parturients undergoing hemorrhagic cesarean delivery" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_tranexamic_acid/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Gilliot_2022` / `Gilliot_2022::original_dataset::parturients undergoing hemorrhagic cesarean delivery`)
