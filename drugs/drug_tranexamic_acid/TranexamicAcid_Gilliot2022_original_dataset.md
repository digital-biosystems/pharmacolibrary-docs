...
> ## <span class="pk-badge pk-badge--orange" title="covariates_not_exercised: the record defines covariate effects (weight on clearance, renal function …) but the engineer simulated only the reference individual, so those scenarios were never run. The base model still reproduces the paper; what is missing is the covariate curves.">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.133). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[θcl]` | 0.077 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[θcl]` | not captured | 0.077 | only_one_extracted |
| `gpt-oss:120b` | `parameters[θpurine]` | 0.54 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[θpurine]` | not captured | 0.54 | only_one_extracted |
| `gpt-oss:120b` | `parameters[θq]` | 0.32 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[θq]` | not captured | 0.32 | only_one_extracted |
| `gpt-oss:120b` | `parameters[θv1]` | 9.25 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[θv1]` | not captured | 9.25 | only_one_extracted |
| `gpt-oss:120b` | `parameters[θv2]` | 9.49 | not captured | only_one_extracted |
