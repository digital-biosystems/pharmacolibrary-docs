...
**What is wrong:** the simulated model does not reproduce a value the paper reports; the engineer did not exercise the covariate scenarios this record defines. Evidence: T1_t_half_terminal — expected 1.8499999999999999 — got 9720.216833107688 — ratio 5254.1713; T2_covariates_not_exercised
...
|---|---|---|---|---|---|---|---|---|---|---|
| θCL (L/min) | `Q22` · CL | —(suppressed) | L/min | — | [l] / [min] | not captured | llm_confirmed (0.6) | pharmaceutics-14-00578-t004:row2:col2, pharmaceutics-14-00578-t004:row2:col3 | — | not captured |
| θV1 (L) | `Q63` · V1 | —(suppressed) | L | — | [l] | not captured | llm_confirmed (0.6) | pharmaceutics-14-00578-t004:row4:col2, pharmaceutics-14-00578-t004:row4:col3 | — | not captured |
| θQ (L/min) | `Q30` · Q | —(suppressed) | L/min | — | [l] / [min] | not captured | llm (0.6) | pharmaceutics-14-00578-t004:row6:col2, pharmaceutics-14-00578-t004:row6:col3 | — | not captured |
| θV2 (L) | `Q64` · V2 | —(suppressed) | L | — | [l] | not captured | llm_confirmed (0.6) | pharmaceutics-14-00578-t004:row7:col2 | — | not captured |
| θpurine | `Q900` · θpurine | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | not captured | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_tranexamic_acid/models/modelica/TranexamicAcid_Gilliot2022_original_dataset.mo`
- deviation: `../../../knowledgebase/drugs/drug_tranexamic_acid/models/modelica/TranexamicAcid_Gilliot2022_original_dataset.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_tranexamic_acid/models/modelica/TranexamicAcid_Gilliot2022_original_dataset.json`
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_tranexamic_acid/TranexamicAcid_Gilliot2022_original_dataset/TranexamicAcid_Gilliot2022_original_dataset.svg" alt="TranexamicAcid_Gilliot2022_original_dataset diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_2C` · parameters `TranexamicAcid_Gilliot2022_original_dataset_params.json` · controls `TranexamicAcid_Gilliot2022_original_dataset_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
