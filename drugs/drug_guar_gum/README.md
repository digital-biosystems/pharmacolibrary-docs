...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-14 20:52 | 13:48 | 0/0/0 | 0/0/0 | 0/0/0 | 70,948/4,917 | ollama / qwen3.8:27b-mtp-q8_0 | 5 | 1/4 | 5/0 | 0 |
...
<sub>queue written 2026-09-14T20:50:49.893829+00:00</sub>
...
| popPK | Aro_1984 | irrelevant | 0 | 0 | The study reports clinical outcomes (serum cholesterol levels) rather than pharmacokinetic disposition parameters (CL, V, ka, etc.) for guar gum. |
| PD | Aro_1984 | not_relevant | 2 | 1 | The paper reports a single-dose clinical trial outcome (mean cholesterol reduction) but does not provide a concentration-effect curve, dose-response relationship, or numeric PD parameters (e.g., Emax, EC50). |
| popPK | Awadeen_2020 | irrelevant | 0 | 0 | The study focuses on the formulation of Zolmitriptan nanoparticles where guar gum is used only as an excipient in the capsule, and no pharmacokinetic parameters for guar gum are reported. |
...
| popPK | Bashir_2018 | irrelevant | 0 | 0 | The paper concerns food packaging films and does not report pharmacokinetic parameters for guar gum. |
...
| popPK | Cloutier_1992 | irrelevant | 0 | 0 | The study is a clinical diagnostic challenge for occupational asthma using guar gum as an inhaled allergen, not a pharmacokinetic study, and reports no disposition parameters. |
...
| popPK | Fernandez_1995 | irrelevant | 0 | 0 | The study investigates the metabolic effects of guar gum on cholesterol levels and enzyme activity in guinea pigs, not its pharmacokinetic disposition parameters. |
| PD | Fernandez_1995 | not_relevant | 4 | 2 | The paper reports a dose-response study with significant correlations between guar gum dose and LDL/cholesterol levels, but the provided text lacks the specific numeric data points or fitted parameters (e.g., Emax, EC50) required to extract a quantitative PD curve. |
...
| popPK | Garg_2026 | irrelevant | 0 | 0 | The study focuses on the formulation and efficacy of acarbose-guar gum solid dispersions, reporting pharmacodynamic outcomes (glucose, body weight) rather than quantitative pharmacokinetic parameters for guar gum. |
| PD | Garg_2026 | not_relevant | 3 | 2 | The paper reports in vitro IC50 values for enzyme inhibition and qualitative in vivo glucose reduction, but lacks a pharmacokinetic-pharmacodynamic (PK/PD) model or exposure-response analysis linking drug concentration to effect. |
| popPK | Ge_2025 | irrelevant | 0 | 0 | The paper focuses on the functionalization and encapsulation of hesperidin, not the pharmacokinetics of guar gum. |
...
| PGx | Grigoreva_2021 | not_relevant | 0 | 0 | The paper focuses on marker-assisted selection and agronomic traits (pod maturation) in guar plants, not pharmacogenomics or PK/PD parameters of guar gum as a drug. |
...
| PD | Jana_2026 | not_relevant | 0 | 0 | The paper reports MIC and IC50 values for a novel small molecule (TPL(II)-07) and mentions guar gum only as a delivery vehicle (hydrogel), but does not report a pharmacodynamic or exposure-response relationship for guar gum itself. |
...
| popPK | Kasabri_2017 | irrelevant | 0 | 0 | The paper focuses on Adiantum capillus-veneris extracts and does not report pharmacokinetic parameters for guar_gum. |
...
| PGx | Rideout_2008 | not_relevant | 0 | 0 | The paper is a review of the general cholesterol-lowering effects of guar gum and does not report specific pharmacogenomic effects (gene variants altering PK/PD). |
...
| popPK | Różyło_2022 | irrelevant | 0 | 0 | The paper focuses on the spectral and antioxidant characteristics of cornflower extract, not the pharmacokinetics of guar gum. |
...
| PGx | Sanaei_2022 | not_relevant | 0 | 0 | The paper investigates the effect of heavy metals (Pb, Cd) on guar plant growth and phytoremediation, not the pharmacokinetics or pharmacodynamics of guar gum in humans. |
...
| PD | Sati_2025 | not_relevant | 0 | 0 | The paper is a review of silver nanoparticles (AgNPs) synthesis and applications, containing no data or analysis regarding guar gum pharmacodynamics. |
...
| PD | Sharma_2019 | not_relevant | 2 | 1 | The paper reports in vitro IC50 and PK parameters (Cmax) for paclitaxel formulations, but does not provide an exposure-response or dose-response model linking paclitaxel concentrations to pharmacodynamic effects in vivo or in vitro with derivable PD parameters like Emax or EC50 for the drug itself. |
...
| popPK | Vachon_1988 | irrelevant | 0 | 0 | The paper focuses on the metabolic effects of dietary fibers on glucose and insulin, not on the pharmacokinetic disposition parameters of guar gum. |
...
| popPK | Wahyuningsih_2026 | irrelevant | 0 | 0 | The paper is a review on nanocarrier-mediated delivery of phytochemicals for diabetic wound healing and does not report pharmacokinetic parameters for guar_gum. |
...
| PD | Whiteley_1996 | not_relevant | 4 | 2 | The paper describes a qualitative dose-response relationship for guar gum but does not provide specific numeric PD parameters (e.g., Emax, EC50) or detailed data points in the text to derive them. |
...
| popPK | unknown_2024 | irrelevant | 0 | 0 | The provided evidence contains no text, only a note about a PDF file, so no pharmacokinetic data for guar_gum is present. |
