...
## Model component
<dbs-pgx drug="colistin" model-id="Colistin_Yu2022_pk_parameter" status="rejected" stale="false" population="critically ill patients with carbapenem-resistant organism infections" measured-compound="colistin sulfate" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- dropped unlinked row (NIL): 'Colistin sulfate' — extend the ontology if this is a real PK parameter (source ['Yu_2022_table_4:row0:col5'])
- dropped unlinked row (NIL): 'Polymyxin B sulfate (Yu et al., 2021)' — extend the ontology if this is a real PK parameter (source ['Yu_2022_table_4:row1:col5'])
...
- population split: 'pk parameter' subgroup of Yu_2022 (paper reports 4 populations: estimate, pk formula, pk parameter, shrinkage (%))
...
- scholar stages: `../../../knowledgebase/drugs/drug_colistin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Yu_2022` / `Yu_2022::pk_parameter`)
