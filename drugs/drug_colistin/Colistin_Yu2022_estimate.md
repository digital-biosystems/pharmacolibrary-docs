...
|---|---|---|---|---|---|---|---|---|---|---|
| TVV (L) | `Q61` · V | 20.7 | L | 0.0207 | [l] | not captured | tv_prefix (0.95) | T3:row4:col1 | — | not captured |
| theta_cl_crcl | `Q900` · theta_cl_crcl | 0.525 | not captured | not captured | not captured | not captured | not captured (not captured) | T3:row3:col1 | — | not captured |
| TVCL | `Q900` · TVCL | 0.994 | L/h | 2.7611111111111114e-07 | not captured | not captured | not captured (not captured) | T3:row2:col1 | — | not captured |
