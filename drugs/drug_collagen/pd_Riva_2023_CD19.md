...
# CD19+ B lymphocytes — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.6). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.6 (18/30 fields) | 12 |
...
| `gpt-oss:120b` | `parameters[Q312]` | 27 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 80.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 43 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 57 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 353 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 25 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | not captured | 80.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | not captured | 43 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | not captured | 57 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | 27 | only_one_extracted |
