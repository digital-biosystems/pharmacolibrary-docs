...
# dietary intake — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Takada T; Sato R; Kikuta S et al. (2017). PloS one 12
  ·  DOI: [10.1371/journal.pone.0186420](https://doi.org/10.1371/journal.pone.0186420)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | mannitol | not captured | mismatch |
...
---
<sub>← back to [sorbitol](drugs/drug_sorbitol/)</sub>
