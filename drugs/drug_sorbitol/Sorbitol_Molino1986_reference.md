...
- scholar stages: `../../../knowledgebase/drugs/drug_sorbitol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Molino_1986` / `Molino_1986::reference`)
