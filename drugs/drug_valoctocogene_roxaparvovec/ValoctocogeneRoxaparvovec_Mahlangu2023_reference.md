...
## Model component
<dbs-pgx drug="valoctocogene roxaparvovec" model-id="ValoctocogeneRoxaparvovec_Mahlangu2023_reference" status="extracted" stale="false" population="men with severe hemophilia A" measured-compound="factor VIII" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h/kg) | `Q22` · CL | 0.011 | L/h/kg | 2.1388888888888888e-07 | L/h | not captured | review_gapfill (0.7) | Cao_2025:review | — | not captured |
| Vz (L/kg) | `Q61` · V | 0.065 | L/kg | 0.00455 | L | not captured | review_gapfill (0.7) | Cao_2025:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_valoctocogene_roxaparvovec/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Mahlangu_2023` / `Mahlangu_2023::reference`)
