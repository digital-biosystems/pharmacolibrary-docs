...
# name — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.077). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Li J; Zhou L; Leung ACF; Yin D; Chen X et al. (2026). CPT: pharmacometrics & systems pharmacology 15
...
| `gpt-oss:120b` | `model_family` | tte | disease_progression | mismatch |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 0.03089 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 9.211 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 24.86 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 21.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 21.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 0.3589 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 6.126 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q63]` | not captured | 1.681 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q63]` | not captured | 9.406 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q63]` | not captured | -0.3186 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q63]` | not captured | 16.36 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q64]` | not captured | 3.005 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | not captured | 9.418 | only_one_extracted |
