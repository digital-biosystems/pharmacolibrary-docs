...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | ocrelizumab | not captured | mismatch |
| `gpt-oss:120b` | `effect_direction` | inhibition | not captured | mismatch |
| `gpt-oss:120b` | `effect_form` | unknown | not captured | mismatch |
| `gpt-oss:120b` | `model_family` | tmdd | not captured | mismatch |
| `gpt-oss:120b` | `parameters[Q22]` | 0.234 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | 0.153 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | 0.133 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 0.220 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 0.163 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | 2.28 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | 1.72 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q316]` | 0.0662 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q316]` | 0.0510 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q317]` | 0.545 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q317]` | 0.390 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | 0.02 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q63]` | 2.58 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q63]` | 2.37 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q63]` | 0.138 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q63]` | 0.0882 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 0.109 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 0.0534 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 1.95 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 1.75 | not captured | only_one_extracted |
