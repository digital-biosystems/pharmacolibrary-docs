...
| ΘQ (L/h) — RSE (%) | `Q358` · not captured | 21.5 | L/h | not captured | llm (not captured) | psp470261-tbl-0001:row4:col2 |
...
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 24.86 | only_one_extracted |
