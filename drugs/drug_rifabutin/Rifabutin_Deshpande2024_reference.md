...
Deshpande D; Magombedze G; Srivastava S; Gumbo T et al. (2024). IJTLD open 1
  ·  DOI: [10.5588/ijtldopen.24.0238](https://doi.org/10.5588/ijtldopen.24.0238)
...
|---|---|---|---|---|---|---|---|---|---|---|
| extracellular clearance | `Q22` · CL | 0.07 | L/h | 1.9444444444444445e-08 | L/h | not captured | review (0.7) | Deshpande_2024:review | — | not captured |
| volume | `Q61` · V | 0.31 | L | 0.00031 | L | not captured | review (0.7) | Deshpande_2024:review | — | not captured |
...
- built from REVIEW reference values (Deshpande_2024) — secondary source
...
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deshpande_2024:review'] |
...
| C9_phys_window_Q61 | fail | volume within physiological range | 0.31 L | not captured | not captured | ['Deshpande_2024:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_rifabutin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Deshpande_2024` / `Deshpande_2024::reference`)
