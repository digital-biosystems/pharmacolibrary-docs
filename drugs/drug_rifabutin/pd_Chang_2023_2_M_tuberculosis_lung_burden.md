...
| `gpt-oss:120b` | `parameters[Q71]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q900]` | 0.16 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q900]` | 0.07 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q900]` | 0.63 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q900]` | 0.54 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q900]` | 2.98 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q900]` | 2.60 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q900]` | 5.60 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q900]` | 4.90 | not captured | only_one_extracted |
