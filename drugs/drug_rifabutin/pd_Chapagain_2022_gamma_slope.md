...
# name — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.875). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.875 (70/80 fields) | 10 |

<details><summary>10 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q21]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q21]` | not captured | 29.93 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q21]` | not captured | 28.02 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q21]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q21]` | not captured | 1.43 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q21]` | not captured | 1.08 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 3512 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 37.00 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 13.57 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 7.81 | only_one_extracted |
