...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-09 08:52 | 14:31 | 0/0/0 | 3/4/0 | 0/0/0 | 114,555/4,205 | ollama / qwen3.8:27b-mtp-q8_0 | 10 | 9/1 | 9/1 | 0 |
...
<sub>queue written 2026-09-09T08:49:22.091583+00:00</sub>
...
| popPK | Brazzell_1984 | irrelevant | 0 | 0 | The evidence contains only the title and no quantitative pharmacokinetic parameters or data for cibenzoline. |
...
| popPK | Hasannejad_2004 | irrelevant | 0 | 0 | The paper focuses on the mechanism of organic cation transporter 3 and does not report quantitative pharmacokinetic parameters for cibenzoline. |
...
| popPK | Holazo_1986 | relevant | 10 | 0 | The title confirms a pharmacokinetic modeling study of cibenzoline, but the provided evidence contains no numeric parameter values. |
...
| popPK | Horie_1992 | irrelevant | 0 | 0 | The paper focuses on electrophysiological mechanisms (ATP-sensitive potassium channels) and does not report pharmacokinetic parameters for cibenzoline. |
...
| popPK | Matsuoka_1991 | irrelevant | 0 | 0 | The study focuses on the pharmacodynamic effects (Ca2+ channel inhibition) of cibenzoline on guinea-pig heart, not on pharmacokinetic disposition parameters. |
...
| popPK | Nawada_1994 | irrelevant | 0 | 0 | The paper focuses on negative inotropic and antiarrhythmic effects (pharmacodynamics) rather than pharmacokinetic parameters, and no quantitative PK data for cibenzoline is present in the evidence. |
...
| popPK | Sakuta_1994 | irrelevant | 0 | 0 | The study is an in-vitro electrophysiology investigation of potassium channel inhibition in Xenopus oocytes and does not report pharmacokinetic parameters for cibenzoline. |
...
| popPK | Tabuchi_2001 | irrelevant | 0 | 0 | The paper is an in-vitro mechanistic study of cibenzoline's effect on gastric H+,K+-ATPase activity and does not report pharmacokinetic disposition parameters. |
| popPK | Takahashi_2011 | relevant | 8 | 0 | The paper describes a pharmacokinetic study of cibenzoline in rats using a two-compartment model, but no specific numeric parameter values (CL, V, etc.) are provided in the extracted evidence. |
| PD | Takahashi_2011 | not_relevant | 0 | 0 | The provided text contains only the title of the paper and lacks the full text, abstract, or data required to determine if numeric PD parameters are reported or derivable. |
...
| popPK | Yamamoto_1999 | irrelevant | 0 | 0 | The paper focuses on receptor binding characteristics (pharmacodynamics) rather than pharmacokinetic disposition parameters. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_cibenzoline`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
