...
|---|---|---|---|---|---|---|---|---|---|---|
| AUC (h·ng/mL per mg) | `Q88` · AUC | 480 | h·ng/mL per mg | not captured | [[h] · [ng]] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row2:col15, Czock_2022_table_1:row2:col16, Czock_2022_table_1:row2:col19 | — | not captured |
| Cmax (ng/mL per mg) | `Q32` · Cmax | 65 | ng/mL per mg | not captured | [ng] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row3:col15, Czock_2022_table_1:row3:col16, Czock_2022_table_1:row3:col19 | — | not captured |
| CL/F (L/h) | `Q27` · CL/F | 2.29 | L/h | 6.361111111111111e-07 | [l] / [h] | not captured | exact (1.0) | Czock_2022_table_1:row6:col15, Czock_2022_table_1:row6:col16, Czock_2022_table_1:row6:col19 | — | not captured |
| t½ or t½α and t½ß (h) | `Q57` · t1/2z | 15.7 | h | 56520.0 | [h] | not captured | llm (0.6) | Czock_2022_table_1:row8:col7, Czock_2022_table_1:row8:col15, Czock_2022_table_1:row8:col16, Czock_2022_table_1:row8:col19 | — | not captured |
...
- dropped unlinked row (NIL): 'UR (%)' — extend the ontology if this is a real PK parameter (source ['Czock_2022_table_1:row9:col19'])
- apparent-ness (ontology-grounded): parameterization=apparent, measured_compound=roxadustat
- held at status:extracted — NIL link or unit issue (mismatch/unknown/normalisation-failed) present
- status held at route_to_review — not promoted
- population split: 'healthy, fasting' subgroup of Czock_2022 (paper reports 8 populations: eskd, healthy, healthy, fasting, healthy, fed, healthy, sca, liver cirrhosis cp b, parameter value, severe renal impairment)
...
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Czock_2022_table_1:row6:col15', 'Czock_2022_table_1:row6:col16', 'Czock_2022_table_1:row6:col19'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Czock_2022_table_1:row8:col7', 'Czock_2022_table_1:row8:col15', 'Czock_2022_table_1:row8:col16', 'Czock_2022_table_1:row8:col19'] |
...
| C9_phys_window_Q27 | pass | clearance within physiological range | 2.29 L/h | not captured | not captured | ['Czock_2022_table_1:row6:col15', 'Czock_2022_table_1:row6:col16', 'Czock_2022_table_1:row6:col19'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_roxadustat/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Czock_2022` / `Czock_2022::healthy_fasting`)
- model: `../../../knowledgebase/drugs/drug_roxadustat/models/modelica/Roxadustat_Czock2022_healthy_fasting.mo`
- deviation: `../../../knowledgebase/drugs/drug_roxadustat/models/modelica/Roxadustat_Czock2022_healthy_fasting.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_roxadustat/models/modelica/Roxadustat_Czock2022_healthy_fasting.json`
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_roxadustat/Roxadustat_Czock2022_healthy_fasting/Roxadustat_Czock2022_healthy_fasting_matlab.zip" download>Roxadustat_Czock2022_healthy_fasting_matlab.zip</a> <span class="pk-size">(3.5 kB)</span></td></tr>
...
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_roxadustat/Roxadustat_Czock2022_healthy_fasting/Roxadustat_Czock2022_healthy_fasting_cellml.zip" download>Roxadustat_Czock2022_healthy_fasting_cellml.zip</a> <span class="pk-size">(3.2 kB)</span></td></tr>
</tbody></table>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Roxadustat_Czock2022_healthy_fasting_params.json` · controls `Roxadustat_Czock2022_healthy_fasting_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
