...
| `gpt-oss:120b` | `parameters[apparent central and peripheral volumes of distribution]` | 14.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[apparent clearance]` | 1.1 | not captured | only_one_extracted |
