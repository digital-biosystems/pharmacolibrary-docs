...
|---|---|---|---|---|---|---|---|---|---|---|
| Kinetics Cmax ROXA | `Q32` · Cmax | 1.0 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | Tab2:row3:col2 | — | not captured |
| tpeak E1 = tpeak EPO | `Q56` · tmax | 1.0 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | Tab2:row19:col2 | — | not captured |
| 9.33 ± 2.9 h | `Q57` · t1/2z | 8 | not captured | not captured | not captured | not captured | llm (0.6) | Tab2:row22:col1 | — | not captured |
