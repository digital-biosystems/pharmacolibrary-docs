...
<dbs-fmusim paramsurl="drugs/drug_roxadustat/Roxadustat_Czock2022_pharmacodynamics/Roxadustat_Czock2022_pharmacodynamics_params.json" metaurl="assets/fmu/PK_1C.vr.json" wasmurl="assets/fmu/PK_1C.js" controlsurl="drugs/drug_roxadustat/Roxadustat_Czock2022_pharmacodynamics/Roxadustat_Czock2022_pharmacodynamics_sim_controls.json"></dbs-fmusim>

<sub>Template `PK_1C` · parameters `Roxadustat_Czock2022_pharmacodynamics_params.json` · controls `Roxadustat_Czock2022_pharmacodynamics_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
