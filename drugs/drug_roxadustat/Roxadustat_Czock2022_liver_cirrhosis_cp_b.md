<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;B03X&quot;,&quot;href&quot;:&quot;atc/B03X.md&quot;},{&quot;label&quot;:&quot;roxadustat&quot;,&quot;href&quot;:&quot;drugs/drug_roxadustat/&quot;},{&quot;label&quot;:&quot;Czock_2022 \u00b7 liver_cirrhosis_cp_b&quot;}]"></div>

# roxadustat — `Roxadustat_Czock2022_liver_cirrhosis_cp_b`
...
## Model component
<dbs-pgx drug="roxadustat" model-id="Roxadustat_Czock2022_liver_cirrhosis_cp_b" status="needs_review" stale="false" population="chronic kidney disease patients" measured-compound="roxadustat" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| AUC (h·ng/mL per mg) | `Q88` · AUC | —(suppressed) | h·ng/mL per mg | — | [[h] · [ng]] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row2:col2, Czock_2022_table_1:row2:col15, Czock_2022_table_1:row2:col16 | — | not captured |
| Cmax (ng/mL per mg) | `Q32` · Cmax | —(suppressed) | ng/mL per mg | — | [ng] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row3:col2, Czock_2022_table_1:row3:col15, Czock_2022_table_1:row3:col16 | — | not captured |
...
| t½ or t½α and t½ß (h) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Czock_2022_table_1:row8:col7, Czock_2022_table_1:row8:col15, Czock_2022_table_1:row8:col16 | — | not captured |
| fu (%) | `Q46` · fu | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Czock_2022_table_1:row10:col2, Czock_2022_table_1:row10:col7 | — | not captured |
...
- dropped unlinked row (NIL): 'UR (%)' — extend the ontology if this is a real PK parameter (source ['Czock_2022_table_1:row9:col2'])
- apparent-ness (ontology-grounded): parameterization=apparent, measured_compound=roxadustat
- held at status:extracted — NIL link or unit issue (mismatch/unknown/normalisation-failed) present
- status held at route_to_review — not promoted
- population split: 'liver cirrhosis cp b' subgroup of Czock_2022 (paper reports 6 populations: eskd, healthy, liver cirrhosis cp b, parameter value, pharmacodynamics, severe renal impairment)
...
- scholar stages: `../../../knowledgebase/drugs/drug_roxadustat/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Czock_2022` / `Czock_2022::liver_cirrhosis_cp_b`)
- model: `../../../knowledgebase/drugs/drug_roxadustat/models/modelica/Roxadustat_Czock2022_liver_cirrhosis_cp_b.mo`
- deviation: `../../../knowledgebase/drugs/drug_roxadustat/models/modelica/Roxadustat_Czock2022_liver_cirrhosis_cp_b.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_roxadustat/models/modelica/Roxadustat_Czock2022_liver_cirrhosis_cp_b.json`
...
<img src="drugs/drug_roxadustat/Roxadustat_Czock2022_liver_cirrhosis_cp_b/Roxadustat_Czock2022_liver_cirrhosis_cp_b.svg" alt="Roxadustat_Czock2022_liver_cirrhosis_cp_b diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_roxadustat/Roxadustat_Czock2022_liver_cirrhosis_cp_b/Roxadustat_Czock2022_liver_cirrhosis_cp_b_modelica.zip" download>Roxadustat_Czock2022_liver_cirrhosis_cp_b_modelica.zip</a> <span class="pk-size">(4.1 kB)</span></td></tr>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_roxadustat/Roxadustat_Czock2022_liver_cirrhosis_cp_b/Roxadustat_Czock2022_liver_cirrhosis_cp_b_matlab.zip" download>Roxadustat_Czock2022_liver_cirrhosis_cp_b_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_roxadustat/Roxadustat_Czock2022_liver_cirrhosis_cp_b/Roxadustat_Czock2022_liver_cirrhosis_cp_b_sbml.zip" download>Roxadustat_Czock2022_liver_cirrhosis_cp_b_sbml.zip</a> <span class="pk-size">(2.5 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_roxadustat/Roxadustat_Czock2022_liver_cirrhosis_cp_b/Roxadustat_Czock2022_liver_cirrhosis_cp_b_cellml.zip" download>Roxadustat_Czock2022_liver_cirrhosis_cp_b_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
...
<dbs-fmusim paramsurl="drugs/drug_roxadustat/Roxadustat_Czock2022_liver_cirrhosis_cp_b/Roxadustat_Czock2022_liver_cirrhosis_cp_b_params.json" metaurl="assets/fmu/PK_1C.vr.json" wasmurl="assets/fmu/PK_1C.js" controlsurl="drugs/drug_roxadustat/Roxadustat_Czock2022_liver_cirrhosis_cp_b/Roxadustat_Czock2022_liver_cirrhosis_cp_b_sim_controls.json"></dbs-fmusim>

<sub>Template `PK_1C` · parameters `Roxadustat_Czock2022_liver_cirrhosis_cp_b_params.json` · controls `Roxadustat_Czock2022_liver_cirrhosis_cp_b_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
