...
|---|---|---|---|---|---|---|---|---|---|---|
| AUC (h·ng/mL per mg) | `Q88` · AUC | 637 | h·ng/mL per mg | not captured | [[h] · [ng]] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row2:col2, Czock_2022_table_1:row2:col15, Czock_2022_table_1:row2:col16 | — | not captured |
| Cmax (ng/mL per mg) | `Q32` · Cmax | 70 | ng/mL per mg | not captured | [ng] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row3:col2, Czock_2022_table_1:row3:col15, Czock_2022_table_1:row3:col16 | — | not captured |
...
| fu (%) | `Q46` · fu | 1.10 | h | not captured | [h] | not captured | exact (1.0) | Czock_2022_table_1:row10:col2, Czock_2022_table_1:row10:col7 | — | not captured |
