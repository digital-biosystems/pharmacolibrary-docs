...
- population split: 'liver cirrhosis cp b' subgroup of Czock_2022 (paper reports 8 populations: eskd, healthy, healthy, fasting, healthy, fed, healthy, sca, liver cirrhosis cp b, parameter value, severe renal impairment)
...
| `gpt-oss:120b` | `parameters[ur]` | not captured | 2.4 | only_one_extracted |
