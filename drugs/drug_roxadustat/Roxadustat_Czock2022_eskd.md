...
**What is wrong:** the simulated model does not reproduce a value the paper reports. Evidence: T1_t_half_beta — expected 11.8 — got 16.25321143297934 — ratio 1.3774; T1_t_half_beta — expected 12.0 — got 16.25321143297934 — ratio 1.3544; T1_t_half_terminal — expected 13.0 — got 16.25321143297934 — ratio 1.2502; T1_t_half_terminal — expected 3.46 — got 16.25321143297934 — ratio 4.6975.
...
|---|---|---|---|---|---|---|---|---|---|---|
| AUC (h·ng/mL per mg) | `Q88` · AUC | —(suppressed) | h·ng/mL per mg | — | [[h] · [ng]] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row2:col5, Czock_2022_table_1:row2:col15, Czock_2022_table_1:row2:col16 | — | not captured |
| Cmax (ng/mL per mg) | `Q32` · Cmax | —(suppressed) | ng/mL per mg | — | [ng] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row3:col5, Czock_2022_table_1:row3:col15, Czock_2022_table_1:row3:col16 | — | not captured |
| CL/F (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | Czock_2022_table_1:row6:col5, Czock_2022_table_1:row6:col15, Czock_2022_table_1:row6:col16 | — | not captured |
| Vz/F (L) | `Q76` · V/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Czock_2022_table_1:row7:col5 | — | not captured |
| t½ or t½α and t½ß (h) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Czock_2022_table_1:row8:col5, Czock_2022_table_1:row8:col6, Czock_2022_table_1:row8:col7, Czock_2022_table_1:row8:col15, Czock_2022_table_1:row8:col16 | — | not captured |
| fu (%) | `Q46` · fu | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Czock_2022_table_1:row10:col5, Czock_2022_table_1:row10:col6, Czock_2022_table_1:row10:col7 | — | not captured |
...
- population split: 'eskd' subgroup of Czock_2022 (paper reports 6 populations: eskd, healthy, liver cirrhosis cp b, parameter value, pharmacodynamics, severe renal impairment)
...
| T1_cmax | reference | fail | 0.01 | 0.0029307484903453563 | 0.2931 | µg/mL→SI vs simulated kg/m3 |
| T1_t_half_beta | reference | fail | 11.8 | 16.25321143297934 | 1.3774 | h→SI vs simulated h |
| T1_t_half_beta | reference | fail | 12.0 | 16.25321143297934 | 1.3544 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 13.0 | 16.25321143297934 | 1.2502 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 3.46 | 16.25321143297934 | 4.6975 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 0.74 | 16.25321143297934 | 21.9638 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 1.1 | 16.25321143297934 | 14.7756 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 8.1 | 16.25321143297934 | 2.0066 | h→SI vs simulated h |
| T1_t_half_terminal | reference | pass | 17.5 | 16.25321143297934 | 0.9288 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 8.5 | 16.25321143297934 | 1.9121 | h→SI vs simulated h |
| T1_t_half_terminal | reference | pass | 14.6 | 16.25321143297934 | 1.1132 | h→SI vs simulated h |
| T1_t_half_terminal | reference | pass | 15.9 | 16.25321143297934 | 1.0222 | h→SI vs simulated h |
| T1_t_half_terminal | reference | pass | 18.2 | 16.25321143297934 | 0.893 | h→SI vs simulated h |
| T1_t_half_terminal | reference | pass | 14.7 | 16.25321143297934 | 1.1057 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 12.0 | 16.25321143297934 | 1.3544 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 8.5 | 16.25321143297934 | 1.9121 | h→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 12.0 | 16.25321143297934 | 1.3544 | h→SI vs simulated h |
...
<img src="drugs/drug_roxadustat/Roxadustat_Czock2022_eskd/Roxadustat_Czock2022_eskd.svg" alt="Roxadustat_Czock2022_eskd diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_roxadustat/Roxadustat_Czock2022_eskd/Roxadustat_Czock2022_eskd_cellml.zip" download>Roxadustat_Czock2022_eskd_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
...
<dbs-fmusim paramsurl="drugs/drug_roxadustat/Roxadustat_Czock2022_eskd/Roxadustat_Czock2022_eskd_params.json" metaurl="assets/fmu/PK_1C.vr.json" wasmurl="assets/fmu/PK_1C.js" controlsurl="drugs/drug_roxadustat/Roxadustat_Czock2022_eskd/Roxadustat_Czock2022_eskd_sim_controls.json"></dbs-fmusim>

<sub>Template `PK_1C` · parameters `Roxadustat_Czock2022_eskd_params.json` · controls `Roxadustat_Czock2022_eskd_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
