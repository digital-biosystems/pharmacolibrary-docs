...
**What is wrong:** the simulated model does not reproduce a value the paper reports; the engineer's deviations are not documented and quantified. Evidence: T1_t_half_beta — expected 11.8 — got 18.738469558412874 — ratio 1.588; T1_t_half_beta — expected 12.0 — got 18.738469558412874 — ratio 1.5615; T1_t_half_terminal — expected 13.0 — got 18.738469558412874 — ratio 1.4414; T1_t_half_terminal — expected 3.46 — got 18.738469558412874 — ratio 5.4157.
...
|---|---|---|---|---|---|---|---|---|---|---|
| AUC (h·ng/mL per mg) | `Q88` · AUC | 825 | h·ng/mL per mg | not captured | [[h] · [ng]] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row2:col4, Czock_2022_table_1:row2:col15, Czock_2022_table_1:row2:col16 | — | not captured |
| Cmax (ng/mL per mg) | `Q32` · Cmax | 67 | ng/mL per mg | not captured | [ng] / [[ml] · [permg]] | not captured | exact (1.0) | Czock_2022_table_1:row3:col4, Czock_2022_table_1:row3:col15, Czock_2022_table_1:row3:col16 | — | not captured |
| CL/F (L/h) | `Q27` · CL/F | 1.26 | L/h | 3.5000000000000004e-07 | [l] / [h] | not captured | exact (1.0) | Czock_2022_table_1:row6:col4, Czock_2022_table_1:row6:col15, Czock_2022_table_1:row6:col16 | — | not captured |
| Vz/F (L) | `Q76` · V/F | 34 | L | 0.034 | [l] | not captured | exact (1.0) | Czock_2022_table_1:row7:col4 | — | not captured |
| t½ or t½α and t½ß (h) | `Q57` · t1/2z | 18.5 | h | 66600.0 | [h] | not captured | llm (0.6) | Czock_2022_table_1:row8:col4, Czock_2022_table_1:row8:col7, Czock_2022_table_1:row8:col15, Czock_2022_table_1:row8:col16 | — | not captured |
| fu (%) | `Q46` · fu | 1.06 | h | not captured | [h] | not captured | exact (1.0) | Czock_2022_table_1:row10:col4, Czock_2022_table_1:row10:col7 | — | not captured |
...
- population split: 'severe renal impairment' subgroup of Czock_2022 (paper reports 8 populations: eskd, healthy, healthy, fasting, healthy, fed, healthy, sca, liver cirrhosis cp b, parameter value, severe renal impairment)
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_roxadustat/Roxadustat_Czock2022_severe_renal_impairment/Roxadustat_Czock2022_severe_renal_impairment_matlab.zip" download>Roxadustat_Czock2022_severe_renal_impairment_matlab.zip</a> <span class="pk-size">(3.6 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_roxadustat/Roxadustat_Czock2022_severe_renal_impairment/Roxadustat_Czock2022_severe_renal_impairment.svg" alt="Roxadustat_Czock2022_severe_renal_impairment diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Roxadustat_Czock2022_severe_renal_impairment_params.json` · controls `Roxadustat_Czock2022_severe_renal_impairment_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
