...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.053 (2/38 fields) | 36 |
...
| `gpt-oss:120b` | `model_family` | effect_compartment | emax | mismatch |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 0.03 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | 0.03 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 9.85 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 22.18 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 9.85 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 22.18 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 1.13 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.13 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 4.65 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 4.35 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 4.65 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 4.35 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 1.66 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 18.67 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | 1.66 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | 18.67 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | not captured | 7.47 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | not captured | 90.61 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | 7.47 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | 90.61 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | not captured | 9.57 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | not captured | 91.95 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 9.57 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 91.95 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | not captured | 6.15 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | not captured | 17.61 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | 6.15 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | 17.61 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | not captured | 104.69 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 104.69 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q83]` | not captured | 0.09 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q83]` | not captured | 70.71 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q83]` | 0.09 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q83]` | 70.71 | not captured | only_one_extracted |
...
---
<sub>← back to [mitiglinide](drugs/drug_mitiglinide/)</sub>
