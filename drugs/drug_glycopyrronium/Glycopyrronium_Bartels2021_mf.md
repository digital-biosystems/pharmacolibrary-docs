...
- dropped unlinked row (NIL): 'Duration of zero-order absorption (h)' — extend the ontology if this is a real PK parameter (source ['Tab5:row8:col5'])
- dropped unlinked row (NIL): 'Body weight on Q/F' — extend the ontology if this is a real PK parameter (source ['Tab5:row25:col5'])
- dropped unlinked row (NIL): 'Body weight on Vp/F' — extend the ontology if this is a real PK parameter (source ['Tab5:row26:col5'])
- salvaged Q27 ('CL/F (L/h)'=210) from results prose — parameter table was unreadable
- salvaged Q290 ('Vc/F (L)'=1800) from results prose — parameter table was unreadable
- salvaged Q69 ('Q/F (L/h)'=250) from results prose — parameter table was unreadable
- salvaged Q82 ('Vp/F (L)'=3700) from results prose — parameter table was unreadable
- salvaged Q49 ('Ka (1/h)'=2.4) from results prose — parameter table was unreadable
...
- population split: 'mf' subgroup of Bartels_2021 (paper reports 3 populations: gly, ind, mf)
...
| C9_phys_window_Q27 | pass | clearance within physiological range | 210 L/h | not captured | not captured | ['Bartels_2021:other_prose'] |
| C9_phys_window_Q290 | pass | volume within physiological range | 1.8e+03 L | not captured | not captured | ['Bartels_2021:other_prose'] |
| C9_phys_window_Q82 | pass | volume within physiological range | 3.7e+03 L | not captured | not captured | ['Bartels_2021:other_prose'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_glycopyrronium/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Bartels_2021` / `Bartels_2021::mf`)
- model: `../../../knowledgebase/drugs/drug_glycopyrronium/models/modelica/Glycopyrronium_Bartels2021_mf.mo`
- deviation: `../../../knowledgebase/drugs/drug_glycopyrronium/models/modelica/Glycopyrronium_Bartels2021_mf.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_glycopyrronium/models/modelica/Glycopyrronium_Bartels2021_mf.json`
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_glycopyrronium/Glycopyrronium_Bartels2021_mf/Glycopyrronium_Bartels2021_mf_matlab.zip" download>Glycopyrronium_Bartels2021_mf_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_glycopyrronium/Glycopyrronium_Bartels2021_mf/Glycopyrronium_Bartels2021_mf_matlab_simbio.zip" download>Glycopyrronium_Bartels2021_mf_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
