...
**What is wrong:** the engineer built the model but a core parameter had no value and was left at its base-class default, so it was not shipped; the model was built differently from what the record describes. Evidence: T3_param_coverage — expected 6 scholar param(s) emitted or defaulted — got 2 covered
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | Valenzuela_2025_table_1:row1:col1 | — | not captured |
| Vc/F (L) | `Q290` · V1/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Valenzuela_2025_table_1:row2:col1 | — | not captured |
| Vp/F (L) | `Q82` · V2/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Valenzuela_2025_table_1:row3:col1 | — | not captured |
| Q/F (L/h) | `Q69` · Q/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | Valenzuela_2025_table_1:row4:col1 | — | not captured |
| F 8 mg | `Q87` · Frel | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Valenzuela_2025_table_1:row5:col1 | — | not captured |
| k a 8 mg (h−1) | `Q49` · kabs | —(suppressed) | h−1 | — | [1] / [h] | not captured | llm (0.6) | Valenzuela_2025_table_1:row7:col1 | — | not captured |
| Alag 8 mg (h) | `Q83` · tlag | —(suppressed) | h | — | [h] | not captured | llm_confirmed (0.6) | Valenzuela_2025_table_1:row9:col1 | — | not captured |
| D1 (h) | `Q310` · D1 | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Valenzuela_2025_table_1:row11:col1 | — | not captured |
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_loperamide/Loperamide_Valenzuela2025_loperamide/Loperamide_Valenzuela2025_loperamide_matlab.zip" download>Loperamide_Valenzuela2025_loperamide_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
