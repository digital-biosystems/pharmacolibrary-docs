...
| `gpt-oss:120b` | `parameters[fraction of mph dose released from the er core]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[ε]` | not captured | 0.44 | only_one_extracted |
| `gpt-oss:120b` | `screen.dose_compound` | methylphenidate hydrochloride extended-release multiple-layer beads | methylphenidate | mismatch |
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-07-15 13:26 UTC</sub>
