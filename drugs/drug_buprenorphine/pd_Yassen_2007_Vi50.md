...
# ventilation — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.464). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.464 (13/28 fields) | 15 |

<details><summary>15 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | fentanyl | fentanyl, buprenorphine | mismatch |
| `gpt-oss:120b` | `model_family` | sigmoid_emax | effect_compartment | mismatch |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 23.90 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 25.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 0.246 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 17.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 72.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 26.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 23.90 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 25.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 35.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q329]` | not captured | 0.246 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q329]` | not captured | 17.9 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q329]` | not captured | 72.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q329]` | not captured | 26.4 | only_one_extracted |
