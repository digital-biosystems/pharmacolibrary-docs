...
## Model component
<dbs-pgx drug="buprenorphine" model-id="Buprenorphine_Nelson2024_reference" status="extracted" stale="false" population="horses" measured-compound="buprenorphine" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| T max (hours) | `Q56` · tmax | 5.88 | hours | not captured | [h] | not captured | llm (0.5) | tab_0:row4:col2, tab_0:row4:col3, tab_0:row4:col4 | — | not captured |
