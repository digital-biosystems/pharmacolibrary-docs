...
# PeakAmp — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.521). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.521 (25/48 fields) | 23 |
...
| `gpt-oss:120b` | `parameters[Q317]` | not captured | 3.54 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 8.82 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | not captured | 0.855 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 1.80 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 0.00488 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q57]` | not captured | 48.4 | only_one_extracted |
