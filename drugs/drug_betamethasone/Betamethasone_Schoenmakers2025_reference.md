...
|---|---|---|---|---|---|---|---|---|---|---|
| Betamethasone clearance in early-onset pre-eclamptic women | `Q22` · CL | 9.35 | L/h | 2.5972222222222223e-06 | [l] / [h] | not captured | llm_confirmed (0.6) | Schoenmakers_2025:abstract | — | not captured |
| maternal betamethasone exposure | `Q88` · AUC | 1567 | ng*h/L | not captured | [[h] · [ng]] / [l] | not captured | llm_confirmed (0.6) | Schoenmakers_2025:abstract | — | not captured |
...
- dropped duplicate Q22 ('Betamethasone clearance in women without pre-eclampsia', value 15.78) — already have one for this compound
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Schoenmakers_2025:abstract'] |
| C5_dimension_Q88 | pass | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['Schoenmakers_2025:abstract'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 9.35 | not captured | not captured | ['Schoenmakers_2025:abstract'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 9.35 L/h | not captured | not captured | ['Schoenmakers_2025:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_betamethasone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Schoenmakers_2025` / `Schoenmakers_2025::reference`)
