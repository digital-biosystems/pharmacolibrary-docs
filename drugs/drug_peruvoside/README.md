...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-09 07:34 | 13:32 | 0/0/0 | 1/0/0 | 0/0/0 | 133,197/3,955 | ollama / qwen3.8:27b-mtp-q8_0 | 18 | 7/11 | 17/1 | 0 |
...
|---|---|---|---|
| <span class="pk-badge pk-badge--green">extracted</span> | [Samanta_2016](drugs/drug_peruvoside/pd_Samanta_2016_unknown.md) | Samanta J et al., Antifertility activity of Thevetia peru…, Indian journal of pharmacol… (2016) | [10.4103/0253-7613.194861](https://doi.org/10.4103/0253-7613.194861) |

## Coverage

- **PubMed hits:** 59 matched, 57 returned
...
|---|---|---|---|---|---|---|
| `Garbe_1968.pdf` | Garbe A et al., [On the pharmacokinetics of peruvoside.…, Arzneimittel-Forschung (1968) | popPK | 10 | not captured | [5756472](https://pubmed.ncbi.nlm.nih.gov/5756472) | The title confirms a pharmacokinetic study of peruvoside, but no numeric parameter values are present in the provided evidence. |
| `Hundeshagen_1968.pdf` | Hundeshagen H et al., [On the pharmacokinetics of peruvoside.…, Arzneimittel-Forschung (1968) | popPK | 10 | not captured | [5756259](https://pubmed.ncbi.nlm.nih.gov/5756259) | The title indicates a pharmacokinetic study of peruvoside, but no numeric parameter values are present in the provided evidence. |
| `Kramer_1969.pdf` | Kramer P et al., [Serum half-life and renal clearance of…, Verhandlungen der Deutschen… (1969) | popPK | 10 | not captured | [5380625](https://pubmed.ncbi.nlm.nih.gov/5380625) | The title indicates a PK study reporting half-life and clearance for peruvoside, but no numeric values are present in the provided evidence. |

<sub>queue written 2026-09-09T07:33:50.628732+00:00</sub>

## Screened and excluded

| domain | paper | verdict | relevance | extractability | reason |
|---|---|---|---|---|---|
| popPK | Abdel_2021 | irrelevant | 0 | 0 | The paper is a systematic review or methodological assessment of PK studies (likely for a different drug, given the reference list) and does not report original quantitative PK parameters for peruvoside. |
...
| popPK | Bhatia_1975 | irrelevant | 0 | 0 | The study is a hemodynamic assessment of systolic time intervals, not a pharmacokinetic study, and reports no disposition parameters for peruvoside. |
...
| popPK | Feng_2016 | irrelevant | 0 | 0 | The paper is an in-vitro mechanistic study on cell death and apoptosis, reporting no pharmacokinetic parameters such as clearance, volume, or half-life. |
...
| popPK | Fierro_1987 | irrelevant | 0 | 0 | The paper is a clinical case report on a myasthenia-like syndrome and contains no pharmacokinetic data for peruvoside. |
...
| popPK | Garbe_1968 | relevant | 10 | 0 | The title confirms a pharmacokinetic study of peruvoside, but no numeric parameter values are present in the provided evidence. |
...
| popPK | Hundeshagen_1968 | relevant | 10 | 0 | The title indicates a pharmacokinetic study of peruvoside, but no numeric parameter values are present in the provided evidence. |
| popPK | Imai_1972 | irrelevant | 2 | 1 | The study applies a two-compartment model to cardiac pharmacodynamics (dose-response) in heart-lung preparations rather than pharmacokinetics (plasma concentration-time), and specific PK parameters like clearance or volume are not reported. |
...
| popPK | Kramer_1969 | relevant | 10 | 0 | The title indicates a PK study reporting half-life and clearance for peruvoside, but no numeric values are present in the provided evidence. |
...
| popPK | Li_2012 | irrelevant | 0 | 0 | The paper is a drug discovery study focusing on the mechanism of action (androgen receptor degradation) and does not report any pharmacokinetic parameters for peruvoside. |
| popPK | Liu_1987 | irrelevant | 1 | 0 | The evidence contains only the title of the paper, with no quantitative pharmacokinetic parameters or numeric values provided. |
| popPK | Liu_1988 | irrelevant | 0 | 0 | The paper concerns Thevetia neriifolia constituents, not peruvoside, and no PK parameters are provided. |
| popPK | Maes_2022 | irrelevant | 0 | 0 | The paper discusses foxglove (Digitalis purpurea) poisoning and does not involve peruvoside or report any pharmacokinetic parameters for it. |
...
| popPK | Misra_1991 | irrelevant | 0 | 0 | The paper concerns yellow oleander poisoning and does not report pharmacokinetic parameters for peruvoside. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_peruvoside`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
