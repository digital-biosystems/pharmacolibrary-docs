...
<div class="pk-recnav" data-items="[{&quot;id&quot;:&quot;Chlortetracycline_Reinbold2010_reference&quot;,&quot;label&quot;:&quot;Reinbold_2010_reference&quot;,&quot;href&quot;:&quot;drugs/drug_chlortetracycline/Chlortetracycline_Reinbold2010_reference.md&quot;,&quot;status&quot;:&quot;needs review&quot;,&quot;css&quot;:&quot;pk-badge--orange&quot;,&quot;here&quot;:true}]"></div>
...
|---|---|---|---|---|---|---|---|---|---|---|
| volume of distribution (V/F | `Q76` · V/F | —(suppressed) | L/kg | — | [l] / [kg] | not captured | llm_corrected (0.6) | Reinbold_2010:abstract | — | not captured |
| rate constant (k | `Q47` · kel | —(suppressed) | h(-1) | — | [1] / [h] | not captured | llm (0.6) | Reinbold_2010:abstract | — | not captured |
| dose-normalized area under the curve (AUC/D | `Q189` · AUC/dose | —(suppressed) | h x microg/L | — | [[h] · [µg]] / [l] | not captured | llm_corrected (0.6) | Reinbold_2010:abstract | — | not captured |
| clearance (Cl/F | `Q27` · CL/F | —(suppressed) | L/kg/h | — | [l] / [[h] · [kg]] | not captured | llm_corrected (0.6) | Reinbold_2010:abstract | — | not captured |
| elimination half-life (t(1/2) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Reinbold_2010:abstract | — | not captured |
| C(max/Dose) | `Q174` · Cmax/dose | —(suppressed) | ng/mL | — | [ng] / [ml] | not captured | llm (0.6) | Reinbold_2010:abstract | — | not captured |
| time of C(max) (T(max) | `Q56` · tmax | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Reinbold_2010:abstract | — | not captured |
...
| C5_dimension_Q174 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Reinbold_2010:abstract'] |
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Reinbold_2010:abstract'] |
| C5_dimension_Q47 | pass | 1 / [time] | not captured | not captured | not captured | ['Reinbold_2010:abstract'] |
| C5_dimension_Q56 | pass | [time] | not captured | not captured | not captured | ['Reinbold_2010:abstract'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Reinbold_2010:abstract'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Reinbold_2010:abstract'] |
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_chlortetracycline/Chlortetracycline_Reinbold2010_reference/Chlortetracycline_Reinbold2010_reference_matlab.zip" download>Chlortetracycline_Reinbold2010_reference_matlab.zip</a> <span class="pk-size">(3.5 kB)</span></td></tr>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Chlortetracycline_Reinbold2010_reference_params.json` · controls `Chlortetracycline_Reinbold2010_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
