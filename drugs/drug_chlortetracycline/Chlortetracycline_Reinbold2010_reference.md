...
- scholar stages: `../../../knowledgebase/drugs/drug_chlortetracycline/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Reinbold_2010` / `Reinbold_2010::group fed, ruminating, Holstein steers`)
