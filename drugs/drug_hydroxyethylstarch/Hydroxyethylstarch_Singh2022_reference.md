...
<sub>Template `PK_1C_enteral` · parameters `Hydroxyethylstarch_Singh2022_reference_params.json` · controls `Hydroxyethylstarch_Singh2022_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
