...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | GSK3511294 | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 2 | not captured | only_one_extracted |
