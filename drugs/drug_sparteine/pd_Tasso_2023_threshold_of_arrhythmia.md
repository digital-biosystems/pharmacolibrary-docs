...
## Citation
Tasso B; Mattioli LB; Tonelli M; Boido V; Chiarini A; Sparatore F; et al. et al. (2023). Molecules (Basel, Switzerland) 28
...
| `gpt-oss:120b` | `parameters[Q321]` | 0.017 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q321]` | 3.66 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 10.67 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 8.44 | not captured | only_one_extracted |
