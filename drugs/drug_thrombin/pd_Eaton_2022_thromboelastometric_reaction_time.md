...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | dabigatran | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q320]` | 899 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 899 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 19.7.22.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 26.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 20.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 25.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 100 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 100 | not captured | only_one_extracted |
