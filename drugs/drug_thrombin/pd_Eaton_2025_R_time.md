...
# name — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.769). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Eaton MP; Nadtochiy SM; Stefanos T; Anderson BJ et al. (2025). Perfusion 40
...
| `gpt-oss:120b` | `parameters[Q57]` | 0.011 | not captured | only_one_extracted |
