...
## Citation
Cheng YH; Eby JM; LaPorte HM; Volkman BF; Majetschak M et al. (2017). PloS one 12
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | CXCL12 | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 117 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q322]` | 111 | not captured | only_one_extracted |
