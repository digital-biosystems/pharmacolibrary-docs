...
# normalized plasmin peak height — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | factor VIII | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q22]` | 1.69 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | 2.27 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 43.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q316]` | 11.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q316]` | 10.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q316]` | 26.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q317]` | 4.15 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q317]` | 4.28 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q317]` | 11.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q317]` | 8.62 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 70.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 50.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 13.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 614 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q63]` | 27.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 5.63 | not captured | only_one_extracted |
