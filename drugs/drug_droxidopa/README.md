...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-09 19:04 | 6:57 | 0/0/0 | 1/0/0 | 0/0/0 | 82,244/1,979 | ollama / qwen3.8:27b-mtp-q8_0 | 8 | 0/8 | 8/0 | 0 |
...
| PGx | Ando_1995 | not_relevant | 0 | 0 | The paper discusses the clinical management of FAP and the use of L-threo-DOPS (droxidopa) for autonomic symptoms, but it does not report any pharmacogenomic analysis or gene variant effects on PK/PD parameters. |
| popPK | Castillo-Mancilla_2016 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of atazanavir, not droxidopa. |
| PD | Castillo-Mancilla_2016 | not_relevant | 0 | 0 | The paper focuses on the pharmacokinetics and pharmacogenetics of atazanavir, not droxidopa, and does not report any pharmacodynamic or exposure-response relationships. |
...
| PGx | Egle_2008 | not_relevant | 0 | 0 | The paper focuses on a gene delivery system for TPMT and thiopurine drugs, not droxidopa. |
| PGx | Kaler_2026 | not_relevant | 0 | 0 | The paper reports clinical efficacy and safety of droxidopa in patients with ATP7A variants (Menkes/OHS) but does not report pharmacogenomic effects on PK/PD parameters (e.g., no analysis of how specific genotypes alter drug clearance or response magnitude compared to wild-type). |
| popPK | Kanodia_2021 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for ampreloxetine, not droxidopa, which is only mentioned as a comparator drug in the background. |
| popPK | Li_2025 | irrelevant | 0 | 0 | The paper is a computational study on drug-disease interaction prediction using network pharmacology and does not contain any pharmacokinetic data for droxidopa. |
| PD | Li_2025 | not_relevant | 0 | 0 | The paper describes a network-based computational model (Meta-DEP) for predicting drug efficacy in Traditional Chinese Medicine and does not report any pharmacokinetic or pharmacodynamic data, exposure-response relationships, or numeric PD parameters for droxidopa. |
...
| popPK | Tang_2023 | irrelevant | 0 | 0 | The paper studies Dendrobium officinale polysaccharides and oxidative stress in C. elegans, and does not involve droxidopa or pharmacokinetic parameters. |
...
| popPK | White_2018 | relevant | 4 | 6 | The study reports non-compartmental PK parameters (AUC, Cmax, t1/2) for droxidopa, but lacks compartmental model parameters (CL, V, Q) and is primarily a QT safety study. |
| popPK | Yamamoto_1988 | irrelevant | 0 | 0 | The study is a behavioral pharmacology experiment in rats involving serotonin antagonists and L-threo-DOPS, with no pharmacokinetic data or mention of droxidopa. |
...
| popPK | unknown_2015 | irrelevant | 0 | 0 | The evidence consists only of a conference title and contains no pharmacokinetic data or mention of droxidopa. |
...
| PGx | van_2018 | not_relevant | 0 | 0 | The paper describes a genetic cause of orthostatic hypotension (CYB561 mutations) and does not investigate the pharmacokinetics or pharmacodynamics of droxidopa. |

---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_droxidopa`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
