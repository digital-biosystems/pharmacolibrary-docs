...
|---|---|---|---|---|---|---|---|---|---|---|
| Half-life (h) | `Q57` · t1/2z | 1.34 | h | 4824.0 | [h] | not captured | llm (0.6) | Kim_2021_table_3:row1:col1 | — | not captured |
| Cmax or Co (ng/mL) | `Q32` · Cmax | 6710.62 | ng/mL | not captured | [ng] / [ml] | not captured | llm_confirmed (0.6) | Kim_2021_table_3:row2:col1 | — | not captured |
| AUCinf (h × ng/mL) | `Q17` · AUC∞ | 1228.75 | h × ng/mL | not captured | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Kim_2021_table_3:row4:col1 | — | not captured |
...
| C5_dimension_Q32 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Kim_2021_table_3:row2:col1'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Kim_2021_table_3:row1:col1'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_lidocaine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kim_2021` / `Kim_2021::group_1`)
