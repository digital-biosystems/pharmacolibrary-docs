...
|---|---|---|---|---|---|---|---|---|---|---|
| lignocaine plasma clearance | `Q22` · CL | 7.5 | ml min -1 kg -1 | not captured | ml min -1 kg -1 | not captured | boundary (0.8) | Reichel_1998:other_prose | — | not captured |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model.links` | [['lignocaine', 'megx', 'metabolism']] | [] | mismatch |
| `gpt-oss:120b` | `parameters[lignocaine plasma clearance]` | 7.5 | not captured | only_one_extracted |
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-09 10:39 UTC</sub>
