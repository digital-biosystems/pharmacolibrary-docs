...
# HCN channel half-activation voltage — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Meng QT; Xia ZY; Liu J; Bayliss DA; Chen X et al. (2011). Molecular pharmacology 79
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | lidocaine | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | 67.6 | not captured | only_one_extracted |
...
---
<sub>← back to [lidocaine](drugs/drug_lidocaine/)</sub>
