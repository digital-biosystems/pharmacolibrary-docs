...
|---|---|---|---|---|---|---|---|---|---|---|
| Half-life (h) | `Q57` · t1/2z | 1.20 | h | 4320.0 | [h] | not captured | llm (0.6) | Kim_2021_table_3:row1:col7 | — | not captured |
| Cmax or Co (ng/mL) | `Q32` · Cmax | 1204.21 | ng/mL | not captured | [ng] / [ml] | not captured | llm_confirmed (0.6) | Kim_2021_table_3:row2:col7 | — | not captured |
| Tmax (h) | `Q56` · tmax | 0.58 | h | 2088.0 | [h] | not captured | exact (1.0) | Kim_2021_table_3:row3:col7 | — | not captured |
| AUCinf (h × ng/mL) | `Q17` · AUC∞ | 2588.77 | h × ng/mL | not captured | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Kim_2021_table_3:row4:col7 | — | not captured |
...
| `gpt-oss:120b` | `parameters[tmax]` | 0.58 | not captured | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_lidocaine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kim_2021` / `Kim_2021::group_3`)
