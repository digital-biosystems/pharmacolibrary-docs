...
# Electrocutaneous stimulation response score — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
not matched (stem Ross_2024_2)

## Parameters
| label (paper) | Q-code · name | value | unit | value_si | link | source |
|---|---|---|---|---|---|---|
| EC50 | `Q321` · not captured | 0.63 | mg/g | not captured | review_gapfill (not captured) | Ross_2024_2:review |
