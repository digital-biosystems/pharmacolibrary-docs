...
# endotracheal intubation reflex — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Xu Q; Zhou Z; Ai L; Liu J; Tian X et al. (2021). BMC anesthesiology 21
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | sufentanil | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | 0.232 | not captured | only_one_extracted |
