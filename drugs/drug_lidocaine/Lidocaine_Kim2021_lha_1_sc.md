...
|---|---|---|---|---|---|---|---|---|---|---|
| Half-life (h) | `Q57` · t1/2z | 0.75 | h | 2700.0 | [h] | not captured | llm (0.6) | Kim_2021_table_3:row1:col11 | — | not captured |
| Cmax or Co (ng/mL) | `Q32` · Cmax | 132.13 | ng/mL | not captured | [ng] / [ml] | not captured | llm_confirmed (0.6) | Kim_2021_table_3:row2:col11 | — | not captured |
| Tmax (h) | `Q56` · tmax | 0.75 | h | 2700.0 | [h] | not captured | exact (1.0) | Kim_2021_table_3:row3:col11 | — | not captured |
| AUCinf (h × ng/mL) | `Q17` · AUC∞ | 295.73 | h × ng/mL | not captured | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Kim_2021_table_3:row4:col11 | — | not captured |
...
- population split: '(lha 1%, sc)' subgroup of Kim_2021 (paper reports 12 populations: (0.3% solution, iv), (0.3% solution, sc), (lha 0.3%, sc), (lha 1%, sc), (lha 3%, sc), estimate, group 1, group 2, group 3, group 4, group 5, gx)
...
| `gpt-oss:120b` | `parameters[aucinf]` | 295.73 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[cmax or co]` | 132.13 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[half-life]` | 0.75 | not captured | only_one_extracted |
...
| C5_dimension_Q32 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Kim_2021_table_3:row2:col11'] |
| C5_dimension_Q56 | pass | [time] | not captured | not captured | not captured | ['Kim_2021_table_3:row3:col11'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Kim_2021_table_3:row1:col11'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_lidocaine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kim_2021` / `Kim_2021::lha_1_sc`)
