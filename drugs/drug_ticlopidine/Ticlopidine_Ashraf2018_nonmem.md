...
|---|---|---|---|---|---|---|---|---|---|---|
| CLINT,H,SK (L/h) | `Q3` · CLint | —(suppressed) | L/h | — | [l] / [h] | not captured | llm_confirmed (0.6) | psp412346-tbl-0002:row3:col2, psp412346-tbl-0002:row3:col3 | — | 0.25 (None% RSE) |
| V C,SK (L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | llm (0.6) | psp412346-tbl-0002:row6:col2, psp412346-tbl-0002:row6:col3 | — | not captured |
| Q PER1,SK (L/h) | `Q30` · Q | —(suppressed) | L/h | — | [l] / [h] | not captured | llm (0.6) | psp412346-tbl-0002:row8:col2, psp412346-tbl-0002:row8:col3 | — | not captured |
