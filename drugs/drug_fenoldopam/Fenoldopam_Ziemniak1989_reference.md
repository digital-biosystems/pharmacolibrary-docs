...
- scholar stages: `../../../knowledgebase/drugs/drug_fenoldopam/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ziemniak_1989` / `Ziemniak_1989::healthy volunteers`)
