...
|---|---|---|---|---|---|---|---|---|---|---|
| apparent weight‐normalized total apparent clearance (CL/F) value ... in patients with COVID‐19 | `Q27` · CL/F | 0.077 | L h−1 kg−1 | not captured | L h−1 kg−1 | not captured | boundary (0.8) | Świerczek_2023:other_prose | — | not captured |
