...
|---|---|---|---|---|---|---|---|---|---|---|
| initial systemic CL | `Q22` · CL | —(suppressed) | L/day | — | L/h | not captured | review (0.7) | Papathanasiou_2025:review | — | not captured |
| cys-mcMMAF Vc | `Q63` · V1 | —(suppressed) | L | — | L | not captured | review (0.7) | Papathanasiou_2025:review | — | not captured |
| ADC Vp | `Q64` · V2 | —(suppressed) | L | — | L | not captured | review (0.7) | Papathanasiou_2025:review | — | not captured |
...
- built from REVIEW reference values (Papathanasiou_2025) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Papathanasiou_2025:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Papathanasiou_2025:review'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Papathanasiou_2025:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 0.926 | not captured | not captured | ['Papathanasiou_2025:review'] |
| C8_topology | fail | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.0386 L/h | not captured | not captured | ['Papathanasiou_2025:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 12.3 L | not captured | not captured | ['Papathanasiou_2025:review'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 6.63 L | not captured | not captured | ['Papathanasiou_2025:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_dexamethasone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Papathanasiou_2025` / `Papathanasiou_2025::reference`)
