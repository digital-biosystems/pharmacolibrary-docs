...
> ⚠️ **STALE** — review status `accepted_with_caveats` (reviewed 2026-09-17 23:43:50.299523+00:00) predates the upstream re-run (2026-09-18 06:34:46.190770+00:00). Current validate status: `extracted`.

## Citation
Marier JF; Dubuc MC; Drouin E; Alvarez F; Ducharme MP; Brazier JL et al. (2004). Therapeutic drug monitoring 26
  ·  DOI: [10.1097/00007691-200402000-00003](https://doi.org/10.1097/00007691-200402000-00003)

## Model component
<dbs-pgx drug="omeprazole" model-id="Omeprazole_Marier2004_reference" status="extracted" stale="true" population="healthy adults and children with GERD" measured-compound="omeprazole" parameterization="apparent" topology="1C"></dbs-pgx>
...
| apparent volume of distribution (V(ss)/F) in healthy adults | `Q65` · Vss | 0.76 | L/kg | 0.053200000000000004 | [l] / [kg] | not captured | llm_corrected (0.6) | Marier_2004:abstract | — | not captured |
| apparent volume of distribution (V(ss)/F) in children with GERD | `Q76` · V/F | 0.66 | L/kg | 0.0462 | [l] / [kg] | not captured | llm_confirmed (0.6) | Marier_2004:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Marier_2004_metadata.yaml (4 record(s)); values are summary statistics, not a fitted model
...
| C5_dimension_Q65 | pass | [length] ** 3 | not captured | not captured | not captured | ['Marier_2004:abstract'] |
...
| C9_phys_window_Q76 | pass | volume within physiological range | 46.2 L | not captured | not captured | ['Marier_2004:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_omeprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Marier_2004` / `Marier_2004::reference`)
- model: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Marier2004_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Marier2004_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Marier2004_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_omeprazole/Omeprazole_Marier2004_reference/Omeprazole_Marier2004_reference_modelica.zip" download>Omeprazole_Marier2004_reference_modelica.zip</a> <span class="pk-size">(3.9 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Marier2004_reference/Omeprazole_Marier2004_reference_matlab.zip" download>Omeprazole_Marier2004_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_omeprazole/Omeprazole_Marier2004_reference/Omeprazole_Marier2004_reference.svg" alt="Omeprazole_Marier2004_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Omeprazole_Marier2004_reference_params.json` · controls `Omeprazole_Marier2004_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
