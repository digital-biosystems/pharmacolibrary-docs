...
> ⚠️ **STALE** — review status `needs_review` (reviewed 2026-09-17 23:43:50.492664+00:00) predates the upstream re-run (2026-09-18 06:30:49.060054+00:00). Current validate status: `needs_review`.

## Citation
not matched (stem Yang_2026_2)

## Model component
<dbs-pgx drug="omeprazole" model-id="Omeprazole_Yang2026v2_reference" status="needs_review" stale="true" population="" measured-compound="omeprazole" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | 215.0 | L/h | 5.972222222222222e-05 | L/h | not captured | review (0.7) | Yang_2026_2:review | — | not captured |
| V1 | `Q63` · V1 | 2330.0 | L | 2.33 | L | not captured | review (0.7) | Yang_2026_2:review | — | not captured |
| V2 | `Q64` · V2 | 28200.0 | L | 28.2 | L | not captured | review (0.7) | Yang_2026_2:review | — | not captured |
| Q | `Q30` · Q | 2590.0 | L/h | 0.0007194444444444444 | L/h | not captured | review (0.7) | Yang_2026_2:review | — | not captured |
