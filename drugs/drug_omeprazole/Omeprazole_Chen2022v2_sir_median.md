...
> ⚠️ **STALE** — review status `accepted_with_caveats` (reviewed 2026-09-18 07:51:27.078488+00:00) predates the upstream re-run (2026-09-23 21:29:17.712315+00:00). Current validate status: `extracted`.

## Citation
not matched (stem Chen_2022_2)

## Model component
<dbs-pgx drug="omeprazole" model-id="Omeprazole_Chen2022v2_sir_median" status="extracted" stale="true" population="obese patients undergoing laparoscopic sleeve gastrectomy" measured-compound="omeprazole" parameterization="apparent" topology="1C"></dbs-pgx>
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_omeprazole/Omeprazole_Chen2022v2_sir_median/Omeprazole_Chen2022v2_sir_median_modelica.zip" download>Omeprazole_Chen2022v2_sir_median_modelica.zip</a> <span class="pk-size">(4.2 kB)</span></td></tr>
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Chen2022v2_sir_median/Omeprazole_Chen2022v2_sir_median_matlab.zip" download>Omeprazole_Chen2022v2_sir_median_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Omeprazole_Chen2022v2_sir_median_params.json` · controls `Omeprazole_Chen2022v2_sir_median_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
