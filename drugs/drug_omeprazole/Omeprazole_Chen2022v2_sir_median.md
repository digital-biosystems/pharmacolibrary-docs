...
> ⚠️ **STALE** — review status `accepted_with_caveats` (reviewed 2026-09-17 23:43:49.873307+00:00) predates the upstream re-run (2026-09-18 06:34:23.500874+00:00). Current validate status: `not captured`.

## Citation
not matched (stem Chen_2022_2)

## Model component
<dbs-pgx drug="omeprazole" model-id="Omeprazole_Chen2022v2_sir_median" status="" stale="true" population="obese patients undergoing laparoscopic sleeve gastrectomy" measured-compound="" parameterization="" topology=""></dbs-pgx>
