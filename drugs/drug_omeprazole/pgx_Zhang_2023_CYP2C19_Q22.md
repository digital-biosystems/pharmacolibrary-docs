...
# CYP2C19 — PGx  <span class="pk-badge pk-badge--green">extracted</span>
...
- **applies to:** pk
- **target:** `Q22` CL
- **effect (θ / form):** EM=0.0, IM=-0.5198, PM=-0.9054
- **phenotype map:** standardized
- **evidence:** not captured

## Citation
Zhang R; Guo P; Zhou J; Li P; Wan J; Yang C; et al. et al. (2023). Scientific reports 13
  ·  DOI: [10.1038/s41598-022-27286-5](https://doi.org/10.1038/s41598-022-27286-5)
