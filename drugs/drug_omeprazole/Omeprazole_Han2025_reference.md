...
> ⚠️ **STALE** — review status `rejected` (reviewed 2026-09-17 23:43:50.033509+00:00) predates the upstream re-run (2026-09-18 06:27:02.090922+00:00). Current validate status: `rejected`.
...
## Model component
<dbs-pgx drug="omeprazole" model-id="Omeprazole_Han2025_reference" status="rejected" stale="true" population="" measured-compound="omeprazole" parameterization="apparent" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CLP/F | `Q27` · CL/F | 2.91 | L/h | 8.083333333333334e-07 | L/h | not captured | review (0.7) | Han_2025:review | — | not captured |
| V/F | `Q76` · V/F | 24.9 | L | 0.0249 | L | not captured | review (0.7) | Han_2025:review | — | not captured |
| VP/F | `Q82` · V2/F | 24.9 | L | 0.0249 | L | not captured | review (0.7) | Han_2025:review | — | not captured |
| ka | `Q49` · kabs | 0.3 | h−1 | 8.333333333333333e-05 | 1/h | not captured | review (0.7) | Han_2025:review | — | not captured |
