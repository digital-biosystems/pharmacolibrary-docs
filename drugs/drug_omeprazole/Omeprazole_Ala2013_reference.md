...
> ⚠️ **STALE** — review status `accepted_with_caveats` (reviewed 2026-09-18 07:51:27.010482+00:00) predates the upstream re-run (2026-09-23 21:29:27.714409+00:00). Current validate status: `extracted`.

## Citation
Ala S; Zanad F; Shiran MR et al. (2013). Caspian journal of internal medicine 4

## Model component
<dbs-pgx drug="omeprazole" model-id="Omeprazole_Ala2013_reference" status="extracted" stale="true" population="healthy Iranian adults" measured-compound="omeprazole" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| apparent plasma clearance (CL/F) | `Q27` · CL/F | 20.8 | L.h(-1) | 5.777777777777779e-06 | [l] / [h] | not captured | exact (1.0) | Ala_2013:abstract | — | not captured |
| apparent volume of distribution (V/F) | `Q76` · V/F | 21.6 | L | 0.0216 | [l] | not captured | exact (1.0) | Ala_2013:abstract | — | not captured |
| t 1/2 beta | `Q60` · t1/2β | 0.8 | h | 2880.0 | [h] | not captured | llm_corrected (0.6) | Ala_2013:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Ala_2013_metadata.yaml (3 record(s)); values are summary statistics, not a fitted model
...
| `gpt-oss:120b` | `parameters[apparent plasma clearance]` | 20.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[apparent volume of distribution]` | 21.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[t 1/2 beta]` | 0.8 | not captured | only_one_extracted |
...
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Ala_2013:abstract'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Gao_2025:review'] |
| C5_dimension_Q60 | pass | [time] | not captured | not captured | not captured | ['Ala_2013:abstract'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Ala_2013:abstract'] |
| C5_dimension_Q83 | pass | [time] | not captured | not captured | not captured | ['McCann_2023:review'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q27 | pass | clearance within physiological range | 20.8 L/h | not captured | not captured | ['Ala_2013:abstract'] |
| C9_phys_window_Q76 | pass | volume within physiological range | 21.6 L | not captured | not captured | ['Ala_2013:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_omeprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ala_2013` / `Ala_2013::reference`)
- model: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Ala2013_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Ala2013_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Ala2013_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_omeprazole/Omeprazole_Ala2013_reference/Omeprazole_Ala2013_reference_modelica.zip" download>Omeprazole_Ala2013_reference_modelica.zip</a> <span class="pk-size">(3.6 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_omeprazole/Omeprazole_Ala2013_reference/Omeprazole_Ala2013_reference_fmi.zip" download>Omeprazole_Ala2013_reference_fmi.zip</a> <span class="pk-size">(4.1 kB)</span><br><a href="models/fmu/PK_1C_enteral.fmu" download>PK_1C_enteral.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Ala2013_reference/Omeprazole_Ala2013_reference_matlab.zip" download>Omeprazole_Ala2013_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Ala2013_reference/Omeprazole_Ala2013_reference_matlab_simbio.zip" download>Omeprazole_Ala2013_reference_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Ala2013_reference/Omeprazole_Ala2013_reference_sbml.zip" download>Omeprazole_Ala2013_reference_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Ala2013_reference/Omeprazole_Ala2013_reference_cellml.zip" download>Omeprazole_Ala2013_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_omeprazole/Omeprazole_Ala2013_reference/Omeprazole_Ala2013_reference.svg" alt="Omeprazole_Ala2013_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Omeprazole_Ala2013_reference_params.json` · controls `Omeprazole_Ala2013_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
