...
> ⚠️ **STALE** — review status `needs_review` (reviewed 2026-09-18 07:51:27.186387+00:00) predates the upstream re-run (2026-09-23 21:21:06.485639+00:00). Current validate status: `extracted`.
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Chung2022_reference/Omeprazole_Chung2022_reference_matlab.zip" download>Omeprazole_Chung2022_reference_matlab.zip</a> <span class="pk-size">(3.5 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_omeprazole/Omeprazole_Chung2022_reference/Omeprazole_Chung2022_reference.svg" alt="Omeprazole_Chung2022_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
