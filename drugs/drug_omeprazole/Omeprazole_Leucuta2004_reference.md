...
> ⚠️ **STALE** — review status `needs_review` (reviewed 2026-09-18 07:51:27.644501+00:00) predates the upstream re-run (2026-09-23 21:29:35.446919+00:00). Current validate status: `needs_review`.
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[auc0-10]` | 1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[cmax]` | 730.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[tmax]` | 1.29 | not captured | only_one_extracted |
