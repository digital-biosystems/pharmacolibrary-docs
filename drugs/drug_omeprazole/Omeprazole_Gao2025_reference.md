...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L·h-1) | `Q22` · CL | —(suppressed) | L·h-1 | — | L/h | not captured | review (0.7) | Gao_2025:review | — | not captured |
| V (L) | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Gao_2025:review | — | not captured |
| V2 (L) | `Q64` · V2 | —(suppressed) | L | — | L | not captured | review (0.7) | Gao_2025:review | — | not captured |
| Q (L·h-1) | `Q30` · Q | —(suppressed) | L·h-1 | — | L/h | not captured | review (0.7) | Gao_2025:review | — | not captured |
| KA (h-1) | `Q49` · kabs | —(suppressed) | h-1 | — | 1/h | not captured | review (0.7) | Gao_2025:review | — | not captured |
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_omeprazole/Omeprazole_Gao2025_reference/Omeprazole_Gao2025_reference_modelica.zip" download>Omeprazole_Gao2025_reference_modelica.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
