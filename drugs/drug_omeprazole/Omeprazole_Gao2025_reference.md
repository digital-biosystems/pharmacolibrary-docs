...
## Citation
Gao T; Xu W; Li X; Guo Q; Liu D; Zhang X; Leng P; Sun J et al. (2025). Frontiers in pharmacology 16
...
- built from REVIEW reference values (Gao_2025) — secondary source
...
| C9_phys_window_Q64 | pass | volume within physiological range | 40 L | not captured | not captured | ['Gao_2025:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_omeprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Gao_2025` / `Gao_2025::reference`)
- model: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Gao2025_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Gao2025_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Gao2025_reference.json`
...
<img src="drugs/drug_omeprazole/Omeprazole_Gao2025_reference/Omeprazole_Gao2025_reference.svg" alt="Omeprazole_Gao2025_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_omeprazole/Omeprazole_Gao2025_reference/Omeprazole_Gao2025_reference_modelica.zip" download>Omeprazole_Gao2025_reference_modelica.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Gao2025_reference/Omeprazole_Gao2025_reference_matlab.zip" download>Omeprazole_Gao2025_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Gao2025_reference/Omeprazole_Gao2025_reference_sbml.zip" download>Omeprazole_Gao2025_reference_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Gao2025_reference/Omeprazole_Gao2025_reference_cellml.zip" download>Omeprazole_Gao2025_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
...
<sub>Template `PK_2C_enteral` · parameters `Omeprazole_Gao2025_reference_params.json` · controls `Omeprazole_Gao2025_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
