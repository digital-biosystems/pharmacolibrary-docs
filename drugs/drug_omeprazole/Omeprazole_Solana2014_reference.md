...
|---|---|---|---|---|---|---|---|---|---|---|
| plasma CL | `Q22` · CL | —(suppressed) | L·h·70 kg | — | [h] · [70kg] · [l] | not captured | llm_confirmed (0.6) | Solana_2014:abstract | — | not captured |
| central compartment distribution volumes | `Q63` · V1 | —(suppressed) | L/70 kg | — | [l] / [70kg] | not captured | llm (0.6) | Solana_2014:abstract | — | not captured |
| peripheral compartment distribution volumes | `Q64` · V2 | —(suppressed) | L/70 kg | — | [l] / [70kg] | not captured | llm (0.6) | Solana_2014:abstract | — | not captured |
| Q (L·h-1) | `Q30` · Q | —(suppressed) | L·h-1 | — | L/h | not captured | review_gapfill (0.7) | Gao_2025:review | — | not captured |
| KA (h-1) | `Q49` · kabs | —(suppressed) | h-1 | — | 1/h | not captured | review_gapfill (0.7) | Gao_2025:review | — | not captured |
