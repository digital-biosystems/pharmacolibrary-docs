<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;A02B&quot;,&quot;href&quot;:&quot;atc/A02B.md&quot;},{&quot;label&quot;:&quot;omeprazole&quot;,&quot;href&quot;:&quot;drugs/drug_omeprazole/&quot;},{&quot;label&quot;:&quot;Solana_2014 \u00b7 reference&quot;}]"></div>
...
# omeprazole — `Omeprazole_Solana2014_reference`

> ## <span class="pk-badge pk-badge--orange" title="covariates_not_exercised: the record defines covariate effects (weight on clearance, renal function …) but the engineer simulated only the reference individual, so those scenarios were never run. The base model still reproduces the paper; what is missing is the covariate curves.">needs review</span> <span class="pk-badge pk-badge--stale">stale</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.571). The first reading is what the record holds.">cross-check: disputed</span>
...
> ⚠️ **STALE** — review status `model_quarantined` (reviewed 2026-09-18 07:51:28.295239+00:00) predates the upstream re-run (2026-09-23 21:29:46.804978+00:00). Current validate status: `needs_review`.

## Citation
Solana MJ; Colom H; López-Herce J; Urbano J; González R; López J; et al. et al. (2014). Therapeutic drug monitoring 36
  ·  DOI: [10.1097/FTD.0000000000000033](https://doi.org/10.1097/FTD.0000000000000033)

## Model component
<dbs-pgx drug="omeprazole" model-id="Omeprazole_Solana2014_reference" status="needs_review" stale="true" population="critically ill pediatric patients" measured-compound="omeprazole" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| plasma CL | `Q22` · CL | 24.9 | L·h·70 kg | not captured | [h] · [70kg] · [l] | not captured | llm_confirmed (0.6) | Solana_2014:abstract | — | not captured |
| central compartment distribution volumes | `Q63` · V1 | 4.23 | L/70 kg | 0.00423 | [l] / [70kg] | not captured | llm (0.6) | Solana_2014:abstract | — | not captured |
| peripheral compartment distribution volumes | `Q64` · V2 | 674 | L/70 kg | 0.674 | [l] / [70kg] | not captured | llm (0.6) | Solana_2014:abstract | — | not captured |
| Q (L·h-1) | `Q30` · Q | 22.0 | L·h-1 | 6.11111111111111e-06 | L/h | not captured | review_gapfill (0.7) | Gao_2025:review | — | not captured |
...
- unit_dimension_unknown: 'L·h·70 kg' (CL)
- dropped unlinked row (NIL): 'distributional clearance' — extend the ontology if this is a real PK parameter (source ['Solana_2014:abstract'])
- routed 'between-patient variability of CL' → Q312 (IIV) to iiv — variability estimate, not a structural parameter
...
- gap-filled Q30 (Q) from Gao_2025's review values (primary lacked it)
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Solana_2014_metadata.yaml (6 record(s)); values are summary statistics, not a fitted model
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[central compartment distribution volumes]` | 4.23 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[peripheral compartment distribution volumes]` | 674 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[plasma cl]` | 24.9 | not captured | only_one_extracted |
...
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Gao_2025:review'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Gao_2025:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Solana_2014:abstract'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Solana_2014:abstract'] |
| C5_dimension_Q83 | pass | [time] | not captured | not captured | not captured | ['McCann_2023:review'] |
| C5_unit_missing_Q22 | fail | [length] ** 3 / [time] | L·h·70 kg | not captured | not captured | ['Solana_2014:abstract'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 24.9 | not captured | not captured | ['Solana_2014:abstract'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q63 | pass | volume within physiological range | 4.23 L | not captured | not captured | ['Solana_2014:abstract'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 674 L | not captured | not captured | ['Solana_2014:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_omeprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Solana_2014` / `Solana_2014::reference`)
- model: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/_needs_review/Omeprazole_Solana2014_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/_needs_review/Omeprazole_Solana2014_reference.deviation.json`
