...
## Model component
<dbs-pgx drug="omeprazole" model-id="Omeprazole_Solana2014_reference" status="model_quarantined" stale="false" population="critically ill pediatric patients" measured-compound="omeprazole" parameterization="mechanistic" topology="2C"></dbs-pgx>
