...
**Second reading:** `gpt-oss:120b` read this paper differently on `screen.dose_compound` (omeprazole vs omeprazole, lansoprazole) and 2 more field(s) — a structural parameter, so the record is disputed.
**How to address:** not a curation fix — the pipeline is the limit here (fulltext: the record was built from the abstract alone, so reported summary statistics stood in for a fitted model).
<sub>owner: **curator**</sub>

> ⚠️ **STALE** — review status `accepted_with_caveats` (reviewed 2026-09-18 07:51:27.505803+00:00) predates the upstream re-run (2026-09-23 21:29:31.573728+00:00). Current validate status: `extracted`.

## Citation
Katashima M; Yamamoto K; Sugiura M; Sawada Y; Iga T et al. (1995). Drug metabolism and disposition: the biological fate of chemicals 23

## Model component
<dbs-pgx drug="omeprazole" model-id="Omeprazole_Katashima1995_reference" status="extracted" stale="true" population="rats" measured-compound="omeprazole" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| V (L) | `Q61` · V | 0.653 | L | 0.000653 | L | not captured | review_gapfill (0.7) | Gao_2025:review | — | not captured |
...
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=omeprazole
- abstract-only: no full text was available, so these values were read from the abstract's prose — reported summary statistics, not a fitted model
- gap-filled Q61 (V) from Gao_2025's review values (primary lacked it)
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Katashima_1995_metadata.yaml (3 record(s)); values are summary statistics, not a fitted model
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[total body clearance]` | 57.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `screen.dose_compound` | omeprazole | omeprazole, lansoprazole | mismatch |
| `gpt-oss:120b` | `screen.primary_analyte` | omeprazole | omeprazole, lansoprazole | mismatch |
...
| C9_phys_window_Q61 | pass | volume within physiological range | 0.653 L | not captured | not captured | ['Gao_2025:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_omeprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Katashima_1995` / `Katashima_1995::reference`)
- model: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Katashima1995_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Katashima1995_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_omeprazole/models/modelica/Omeprazole_Katashima1995_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_omeprazole/Omeprazole_Katashima1995_reference/Omeprazole_Katashima1995_reference_modelica.zip" download>Omeprazole_Katashima1995_reference_modelica.zip</a> <span class="pk-size">(4.0 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_omeprazole/Omeprazole_Katashima1995_reference/Omeprazole_Katashima1995_reference_fmi.zip" download>Omeprazole_Katashima1995_reference_fmi.zip</a> <span class="pk-size">(4.1 kB)</span><br><a href="models/fmu/PK_1C_enteral.fmu" download>PK_1C_enteral.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Katashima1995_reference/Omeprazole_Katashima1995_reference_matlab.zip" download>Omeprazole_Katashima1995_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Katashima1995_reference/Omeprazole_Katashima1995_reference_matlab_simbio.zip" download>Omeprazole_Katashima1995_reference_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Katashima1995_reference/Omeprazole_Katashima1995_reference_sbml.zip" download>Omeprazole_Katashima1995_reference_sbml.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_omeprazole/Omeprazole_Katashima1995_reference/Omeprazole_Katashima1995_reference_cellml.zip" download>Omeprazole_Katashima1995_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Omeprazole_Katashima1995_reference_params.json` · controls `Omeprazole_Katashima1995_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
