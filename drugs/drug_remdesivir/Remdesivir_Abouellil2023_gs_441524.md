...
> ## <span class="pk-badge pk-badge--neutral">not simulated</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.333). The first reading is what the record holds.">cross-check: disputed</span>
...
## Model component
<dbs-pgx drug="remdesivir" model-id="Remdesivir_Abouellil2023_gs_441524" status="not_simulated" stale="false" population="healthy adults" measured-compound="remdesivir" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Central compartment volume of distribution (L) | `Q63` · V1 | 26.2 | L | 0.0262 | [l] | not captured | llm_confirmed (0.6) | Tab2:row1:col3 | — | not captured |
| Peripheral compartment volume of distribution (L) | `Q64` · V2 | 66.2 | L | 0.06620000000000001 | [l] | not captured | llm_confirmed (0.6) | Tab2:row2:col3 | — | not captured |
| Inter-compartmental clearance (L/h) | `Q30` · Q | 55 | L/h | 1.5277777777777777e-05 | [l] / [h] | not captured | llm_corrected (0.6) | Tab2:row3:col3 | — | not captured |
| Total body clearance (L/h) | `Q22` · CL | 4.74 | L/h | 1.3166666666666668e-06 | [l] / [h] | not captured | llm_confirmed (0.6) | Tab2:row4:col3 | — | not captured |
...
- dropped duplicate Q22 ('Central formation clearance (L/h)', value '50.5') — already have one for this compound
...
- population split: 'gs‐441524' subgroup of Abouellil_2023 (paper reports 3 populations: gs‐441524, gs‐704277, remdesivir)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[central compartment volume of distribution]` | 26.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[central compartment volume of distribution]` | not captured | 4.89 | only_one_extracted |
| `gpt-oss:120b` | `parameters[inter-compartmental clearance]` | 55 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[inter-compartmental clearance]` | not captured | 13.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[peripheral compartment volume of distribution]` | 66.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[peripheral compartment volume of distribution]` | not captured | 46.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[total body clearance]` | 4.74 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[total body clearance]` | not captured | 18.1 | only_one_extracted |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tab2:row4:col3'] |
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tab2:row3:col3'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Tab2:row1:col3'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Tab2:row2:col3'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 4.74 | not captured | not captured | ['Tab2:row4:col3'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 4.74 L/h | not captured | not captured | ['Tab2:row4:col3'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 26.2 L | not captured | not captured | ['Tab2:row1:col3'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 66.2 L | not captured | not captured | ['Tab2:row2:col3'] |
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_remdesivir/Remdesivir_Abouellil2023_gs_441524/Remdesivir_Abouellil2023_gs_441524_matlab.zip" download>Remdesivir_Abouellil2023_gs_441524_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_remdesivir/Remdesivir_Abouellil2023_gs_441524/Remdesivir_Abouellil2023_gs_441524_sbml.zip" download>Remdesivir_Abouellil2023_gs_441524_sbml.zip</a> <span class="pk-size">(2.5 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_remdesivir/Remdesivir_Abouellil2023_gs_441524/Remdesivir_Abouellil2023_gs_441524_cellml.zip" download>Remdesivir_Abouellil2023_gs_441524_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
