...
|---|---|---|---|---|---|---|---|---|---|---|
| Central compartment volume of distribution (L) | `Q63` · V1 | —(suppressed) | L | — | [l] | not captured | llm_confirmed (0.6) | Tab2:row1:col3 | — | not captured |
| Peripheral compartment volume of distribution (L) | `Q64` · V2 | —(suppressed) | L | — | [l] | not captured | llm_confirmed (0.6) | Tab2:row2:col3 | — | not captured |
| Inter-compartmental clearance (L/h) | `Q30` · Q | —(suppressed) | L/h | — | [l] / [h] | not captured | llm_corrected (0.6) | Tab2:row3:col3 | — | not captured |
| Total body clearance (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | not captured | llm_confirmed (0.6) | Tab2:row4:col3 | — | not captured |
