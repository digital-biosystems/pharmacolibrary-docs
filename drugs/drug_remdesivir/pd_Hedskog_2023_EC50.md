...
# SARS-CoV-2 susceptibility — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.708). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.708 (17/24 fields) | 7 |
...
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 3 | only_one_extracted |
