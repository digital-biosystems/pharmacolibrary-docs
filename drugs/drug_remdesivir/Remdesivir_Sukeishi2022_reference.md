...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[1485]` (not captured vs 1485) and 1 more field(s) — a structural parameter, so the record is disputed.
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_remdesivir/Remdesivir_Sukeishi2022_reference/Remdesivir_Sukeishi2022_reference_fmi.zip" download>Remdesivir_Sukeishi2022_reference_fmi.zip</a> <span class="pk-size">(4.0 kB)</span></td></tr>
