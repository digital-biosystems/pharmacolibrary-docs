...
**Why:** the simulated model does not reproduce a value the paper reports; the model was built differently from what the record describes. Evidence: T1_t_half_terminal — expected 29.36 — got 4.303332272169723 — ratio 0.1466; T3_param_coverage — expected 4 scholar param(s) emitted or defaulted — got 2 covered
