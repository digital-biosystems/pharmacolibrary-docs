...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | GS-443902 | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 0.36 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.242 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.006 | not captured | only_one_extracted |
