<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;J05A&quot;,&quot;href&quot;:&quot;atc/J05A.md&quot;},{&quot;label&quot;:&quot;remdesivir&quot;,&quot;href&quot;:&quot;drugs/drug_remdesivir/&quot;},{&quot;label&quot;:&quot;Leegwater_2022 \u00b7 hospitalized COVID-19 patients&quot;}]"></div>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Metabolic CL (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | not captured | llm_confirmed (0.6) | T2:row4:col1, T2:row4:col2, T2:row4:col4, T2:row4:col5 | — | not captured |
| Renal CL (L/h) | `Q26` · CLR | —(suppressed) | L/h | — | [l] / [h] | not captured | llm_corrected (0.6) | T2:row5:col1 | — | not captured |
| V (L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | exact (1.0) | T2:row6:col1, T2:row6:col2, T2:row6:col4, T2:row6:col5, T2:row11:col1, T2:row11:col2, T2:row11:col4, T2:row11:col5 | — | not captured |
| theta_cl_egfr | `Q900` · theta_cl_egfr | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | T2:row10:col1, T2:row10:col2, T2:row10:col4, T2:row10:col5 | — | not captured |
...
- dropped duplicate Q22 ('CL (L/h)', value '20.7') — already have one for this compound
- dropped duplicate Q22 ('Remdesivir nonrenal CL', value '18.9') — already have one for this compound
- dropped duplicate Q61 ('Remdesivir V', value '17.1') — already have one for this compound
- dropped duplicate Q22 ('GS-441524 CL', value '17.5') — already have one for this compound
- dropped duplicate Q61 ('GS-441524 V', value '14.6') — already have one for this compound
- dropped unlinked row (NIL): 'Remdesivir' — extend the ontology if this is a real PK parameter (source ['T2:row20:col1', 'T2:row20:col2', 'T2:row20:col4', 'T2:row20:col5'])
- dropped unlinked row (NIL): 'GS-441524' — extend the ontology if this is a real PK parameter (source ['T2:row21:col1', 'T2:row21:col2', 'T2:row21:col4', 'T2:row21:col5'])
...
- scholar stages: `../../../knowledgebase/drugs/drug_remdesivir/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Leegwater_2022` / `Leegwater_2022::hospitalized COVID-19 patients`)
