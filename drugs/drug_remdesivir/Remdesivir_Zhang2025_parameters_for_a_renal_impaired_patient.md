...
|---|---|---|---|---|---|---|---|---|---|---|
| KP,NUC | `Q350` · kic | —(suppressed) | Sörgel et al., 2021 | — | [s] · [örgeletal] | not captured | exact (1.0) | T1:row5:col4 | — | not captured |
| theta_kic_im | `Q900` · theta_kic_im | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | T1:row4:col4 | — | not captured |
| theta_kic_im | `Q900` · theta_kic_im | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | T1:row8:col4 | — | not captured |
