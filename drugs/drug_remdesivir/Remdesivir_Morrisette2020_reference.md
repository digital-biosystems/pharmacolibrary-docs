...
| blood and plasma Vd | `Q61` · V | 5522.0 | l | 5.522 | L | not captured | review (0.7) | Morrisette_2020:review | — | not captured |
...
- built from REVIEW reference values (Morrisette_2020) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Morrisette_2020:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Morrisette_2020:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 15.5 | not captured | not captured | ['Morrisette_2020:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 15.5 L/h | not captured | not captured | ['Morrisette_2020:review'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 5.52e+03 L | not captured | not captured | ['Morrisette_2020:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_remdesivir/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Morrisette_2020` / `Morrisette_2020::reference`)
- model: `../../../knowledgebase/drugs/drug_remdesivir/models/modelica/Remdesivir_Morrisette2020_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_remdesivir/models/modelica/Remdesivir_Morrisette2020_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_remdesivir/models/modelica/Remdesivir_Morrisette2020_reference.json`
...
<img src="drugs/drug_remdesivir/Remdesivir_Morrisette2020_reference/Remdesivir_Morrisette2020_reference.svg" alt="Remdesivir_Morrisette2020_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_remdesivir/Remdesivir_Morrisette2020_reference/Remdesivir_Morrisette2020_reference_modelica.zip" download>Remdesivir_Morrisette2020_reference_modelica.zip</a> <span class="pk-size">(3.2 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_remdesivir/Remdesivir_Morrisette2020_reference/Remdesivir_Morrisette2020_reference_fmi.zip" download>Remdesivir_Morrisette2020_reference_fmi.zip</a> <span class="pk-size">(4.1 kB)</span><br><a href="models/fmu/PK_1C.fmu" download>PK_1C.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_remdesivir/Remdesivir_Morrisette2020_reference/Remdesivir_Morrisette2020_reference_matlab.zip" download>Remdesivir_Morrisette2020_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_remdesivir/Remdesivir_Morrisette2020_reference/Remdesivir_Morrisette2020_reference_matlab_simbio.zip" download>Remdesivir_Morrisette2020_reference_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_remdesivir/Remdesivir_Morrisette2020_reference/Remdesivir_Morrisette2020_reference_sbml.zip" download>Remdesivir_Morrisette2020_reference_sbml.zip</a> <span class="pk-size">(2.4 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_remdesivir/Remdesivir_Morrisette2020_reference/Remdesivir_Morrisette2020_reference_cellml.zip" download>Remdesivir_Morrisette2020_reference_cellml.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
</tbody></table>
...
<sub>Template `PK_1C` · parameters `Remdesivir_Morrisette2020_reference_params.json` · controls `Remdesivir_Morrisette2020_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
