...
| Peripheral compartment volume of distribution (L) | `Q64` · V2 | 8.64 | L | 0.00864 | [l] | not captured | llm_confirmed (0.6) | Tab2:row2:col2 | — | not captured |
| Inter-compartmental clearance (L/h) | `Q30` · Q | 0.12 | L/h | 3.3333333333333334e-08 | [l] / [h] | not captured | llm_corrected (0.6) | Tab2:row3:col2 | — | not captured |
| Total body clearance (L/h) | `Q22` · CL | 36.9 | L/h | 1.025e-05 | [l] / [h] | not captured | llm_confirmed (0.6) | Tab2:row4:col2 | — | not captured |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[central compartment volume of distribution]` | 96.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[central compartment volume of distribution]` | not captured | 4.89 | only_one_extracted |
| `gpt-oss:120b` | `parameters[inter-compartmental clearance]` | 0.12 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[inter-compartmental clearance]` | not captured | 13.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[peripheral compartment volume of distribution]` | 8.64 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[peripheral compartment volume of distribution]` | not captured | 46.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[total body clearance]` | 36.9 | not captured | only_one_extracted |
...
- model: `../../../knowledgebase/drugs/drug_remdesivir/models/modelica/Remdesivir_Abouellil2023_gs_704277.mo`
- deviation: `../../../knowledgebase/drugs/drug_remdesivir/models/modelica/Remdesivir_Abouellil2023_gs_704277.deviation.json`
