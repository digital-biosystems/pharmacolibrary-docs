...
|---|---|---|---|---|---|---|---|---|---|---|
| Mean total clearance | `Q22` · CL | —(suppressed) | mL/min | — | L/h | not captured | review (0.7) | Humeniuk_2021:review | — | not captured |
| volume of distribution | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Humeniuk_2021:review | — | not captured |
