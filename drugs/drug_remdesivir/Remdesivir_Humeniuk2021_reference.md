...
**Second reading:** `gpt-oss:120b` read this paper differently on `model.links` ([['remdesivir', 'gs-441524', 'metabolism'], ['remdesivir', 'gs-704277', 'metabolism'], ['remdesivir', 'gs-443902', 'metabolism']] vs []) and 3 more field(s) — a structural parameter, so the record is disputed.
...
| volume of distribution | `Q61` · V | 93.0 | L | 0.093 | L | not captured | review (0.7) | Humeniuk_2021:review | — | not captured |
...
- built from REVIEW reference values (Humeniuk_2021) — secondary source
- volume reported by review

**Extraction notes:**
- unparsed cell Tab3:row7:col2 = '1590b (16.6)'
- LLM region Tab3:footnote: no JSON records returned
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model.links` | [['remdesivir', 'gs-441524', 'metabolism'], ['remdesivir', 'gs-704277', 'metabolism'], ['remdesivir', 'gs-443902', 'metabolism']] | [] | mismatch |
| `gpt-oss:120b` | `parameters[ctau, ng/ml].parameter_id` | Q75 | Q37 | mismatch |
| `gpt-oss:120b` | `parameters[volume of distribution]` | 93 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[vz]` | not captured | 92.6 | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_remdesivir/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Humeniuk_2021` / `Humeniuk_2021::reference`)
