...
|---|---|---|---|---|---|---|---|---|---|---|
| CLpm | `Q22` · CL | —(suppressed) | mL/min | — | L/h | not captured | review (0.7) | Tamura_2023:review | — | not captured |
| V p | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Tamura_2023:review | — | not captured |
