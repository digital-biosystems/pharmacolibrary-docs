...
## Model component
<dbs-pgx drug="paromomycin" model-id="Paromomycin_Verrest2023_estimate" status="extracted" stale="false" population="Eastern African children and adults with visceral leishmaniasis" measured-compound="paromomycin and miltefosine" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h) | `Q22` · CL | 2.62 | L/h | 7.277777777777778e-07 | [l] / [h] | not captured | exact (1.0) | dkad286-T3:row2:col1 | — | not captured |
| V c (L) | `Q63` · V1 | 13.6 | L | 0.0136 | [l] | not captured | space_fold (0.95) | dkad286-T3:row3:col1, Verrest_2023_table_4:row2:col1 | — | not captured |
| Q | `Q30` · Q | 0.26 | not captured | not captured | not captured | not captured | exact (1.0) | dkad286-T3:row4:col1 | — | not captured |
| V p (L) | `Q64` · V2 | 2.22 | L | 0.00222 | [l] | not captured | space_fold (0.95) | dkad286-T3:row5:col1, Verrest_2023_table_4:row4:col1 | — | not captured |
| ka (h−1) | `Q49` · kabs | 2.05 | h−1 | 0.0005694444444444444 | [1] / [h] | not captured | exact (1.0) | dkad286-T3:row6:col1 | — | not captured |
