...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-11 15:42 | 7:02 | 1/3/0 | 1/0/0 | 0/0/0 | 85,794/14,950 | ollama / qwen3.8:27b-mtp-q8_0 | 13 | 0/2 | 3/0 | 1 |

## popPK records

| status | detail | citation | doi |
|---|---|---|---|
| <span class="pk-badge pk-badge--green">extracted</span> | [Verrest_2023](drugs/drug_paromomycin/Paromomycin_Verrest2023_estimate.md) | Verrest L et al., Population pharmacokinetics of a combin…, The Journal of antimicrobia… (2023) | [10.1093/jac/dkad286](https://doi.org/10.1093/jac/dkad286) |
| <span class="pk-badge pk-badge--neutral">not modelled</span> | [Verrest_2023](drugs/drug_paromomycin/Paromomycin_Verrest2023_estimate_eastern_african_children_an.md) | Verrest L et al., Population pharmacokinetics of a combin…, The Journal of antimicrobia… (2023) | [10.1093/jac/dkad286](https://doi.org/10.1093/jac/dkad286) |
| <span class="pk-badge pk-badge--red">rejected</span><br><sub>blocking: no structural parameters extracted (nothing to build)</sub><br><sub>route_to: `human_review`</sub> | [Lentzen_1981](drugs/drug_paromomycin/Paromomycin_Lentzen1981_reference.md) | Lentzen H et al., [Comparative study of serum levels and…, Arzneimittel-Forschung (1981) | — |
| <span class="pk-badge pk-badge--red">rejected</span><br><sub>blocking: no structural parameters extracted (nothing to build)</sub><br><sub>route_to: `human_review`</sub> | [Verrest_2021_2](drugs/drug_paromomycin/Paromomycin_Verrest2021v2_reference.md) | Verrest L et al., Geographical Variability in Paromomycin…, Clinical pharmacokinetics (2021) | [10.1007/s40262-021-01036-8](https://doi.org/10.1007/s40262-021-01036-8) |
| <span class="pk-badge pk-badge--red">rejected</span><br><sub>blocking: no structural parameters extracted (nothing to build)</sub><br><sub>route_to: `human_review`</sub> | [Verrest_2023](drugs/drug_paromomycin/Paromomycin_Verrest2023_shrinkage.md) | Verrest L et al., Population pharmacokinetics of a combin…, The Journal of antimicrobia… (2023) | [10.1093/jac/dkad286](https://doi.org/10.1093/jac/dkad286) |
| <span class="pk-badge pk-badge--red">rejected</span><br><sub>blocking: no structural parameters extracted (nothing to build)</sub><br><sub>route_to: `human_review`</sub> | [Verrest_2023](drugs/drug_paromomycin/Paromomycin_Verrest2023_shrinkage_eastern_african_children_a.md) | Verrest L et al., Population pharmacokinetics of a combin…, The Journal of antimicrobia… (2023) | [10.1093/jac/dkad286](https://doi.org/10.1093/jac/dkad286) |
...
- **records:** 6  ·  extracted 1  ·  needs_review 0  ·  rejected 4  ·  stale 0
...
|---|---|---|---|---|---|---|
| `Lentzen_1981.pdf` | Lentzen H et al., [Comparative study of serum levels and…, Arzneimittel-Forschung (1981) | popPK | 9 | not captured | [7198477](https://pubmed.ncbi.nlm.nih.gov/7198477) | The study reports quantitative PK parameters for paromomycin, including a one-compartment model, half-life (2.6 h), and Cmax (3.6 µg/ml), which are explicitly stated in the text. |

<sub>queue written 2026-09-11T15:36:13.314858+00:00</sub>
...
| popPK | Paixão_2018 | irrelevant | 2 | 0 | Paromomycin is used only as an external reference marker for validation, not as the subject drug for PK parameter estimation, and no quantitative PK values are provided in the evidence. |
...
| popPK | Seifert_2006 | irrelevant | 0 | 0 | The study focuses on in vitro and in vivo drug interactions (efficacy) of miltefosine with paromomycin, not on the pharmacokinetic disposition parameters (CL, V, etc.) of paromomycin. |
...
| PD | Seifert_2011 | not_relevant | 2 | 1 | The paper reports in vitro drug interaction data (FICs) and mentions EC50/EC90 levels for classification, but does not provide the specific numeric concentration values or dose-response curves for paromomycin required to derive PD parameters. |
