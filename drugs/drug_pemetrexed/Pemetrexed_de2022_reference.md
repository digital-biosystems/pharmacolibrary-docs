...
|---|---|---|---|---|---|---|---|---|---|---|
| Nonrenal clearance | `Q79` · CLNR | —(suppressed) | L/h | — | L/h | not captured | exact (1.0) | de_2022:results_prose | — | not captured |
| population pemetrexed clearance | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | boundary (0.8) | de_2022:discussion_prose | — | not captured |
