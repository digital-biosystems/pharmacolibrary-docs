...
## Model component
<dbs-pgx drug="conestat alfa" model-id="ConestatAlfa_Farrell2013_reference" status="extracted" stale="false" population="healthy volunteers and hereditary angioedema patients" measured-compound="C1 inhibitor" parameterization="mechanistic" topology="1C"></dbs-pgx>
