<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;B06A&quot;,&quot;href&quot;:&quot;atc/B06A.md&quot;},{&quot;label&quot;:&quot;conestat alfa&quot;,&quot;href&quot;:&quot;drugs/drug_conestat_alfa/&quot;},{&quot;label&quot;:&quot;Farrell_2013 \u00b7 healthy volunteers and hereditary angioedema patients&quot;}]"></div>
...
## Model component
<dbs-pgx drug="conestat alfa" model-id="ConestatAlfa_Farrell2013_reference" status="not_modelled" stale="false" population="healthy volunteers and hereditary angioedema patients" measured-compound="C1 inhibitor" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Volume of distribution (l) | `Q61` · V | —(suppressed) | l | — | [l] | not captured | exact (1.0) | Farrell_2013_table_p5_1:row2:col1, Farrell_2013_table_p5_1:row2:col2 | — | not captured |
| Vmax (U ml-1 h-1) in healthy volunteers and symptomatic HAE patients | `Q66` · Vmax | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Farrell_2013_table_p5_1:row5:col1, Farrell_2013_table_p5_1:row5:col2 | — | not captured |
| Km (U ml-1) | `Q1` · Km | —(suppressed) | U ml-1 | — | [u] / [ml] | not captured | exact (1.0) | Farrell_2013_table_p5_1:row7:col1, Farrell_2013_table_p5_1:row7:col2 | — | not captured |
| theta_v_category | `Q900` · theta_v_category | —(suppressed) | l | — | not captured | not captured | not captured (not captured) | Farrell_2013_table_p5_1:row3:col1, Farrell_2013_table_p5_1:row3:col2 | — | not captured |
| theta_v_bodyweight | `Q900` · theta_v_bodyweight | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Farrell_2013_table_p5_1:row4:col1, Farrell_2013_table_p5_1:row4:col2 | — | not captured |
| theta_vmax_category | `Q900` · theta_vmax_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Farrell_2013_table_p5_1:row6:col1, Farrell_2013_table_p5_1:row6:col2 | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_conestat_alfa/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Farrell_2013` / `Farrell_2013::healthy volunteers and hereditary angioedema patients`)
