...
# DPPH radical scavenging activity — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | Eucalyptus globulus essential oil | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 604.01 | not captured | only_one_extracted |
