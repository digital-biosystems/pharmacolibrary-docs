...
**What is wrong:** the simulated model does not reproduce a value the paper reports. Evidence: T1_t_half_terminal — expected 0.23333333333333334 — got 1.0275562803018619 — ratio 4.4038
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (mL/min) | `Q22` · CL | —(suppressed) | mL/min | — | [ml] / [min] | not captured | exact (1.0) | tab_1:row2:col1, tab_1:row2:col4 | — | not captured |
| V c (mL) | `Q61` · V | —(suppressed) | mL | — | [ml] | not captured | llm (0.6) | tab_1:row3:col1, tab_1:row3:col2, tab_1:row3:col4 | — | not captured |
| Q (mL/min) | `Q30` · Q | —(suppressed) | mL/min | — | [ml] / [min] | not captured | exact (1.0) | tab_1:row4:col1, tab_1:row4:col2, tab_1:row4:col4 | — | not captured |
| Fu (%) | `Q46` · fu | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | tab_1:row6:col1, tab_1:row6:col2, tab_1:row6:col4 | — | not captured |
...
<img src="drugs/drug_oxymorphone/Oxymorphone_Sadiq2013_original_data_set/Oxymorphone_Sadiq2013_original_data_set.svg" alt="Oxymorphone_Sadiq2013_original_data_set diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_oxymorphone/Oxymorphone_Sadiq2013_original_data_set/Oxymorphone_Sadiq2013_original_data_set_matlab.zip" download>Oxymorphone_Sadiq2013_original_data_set_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
<sub>Template `PK_1C` · parameters `Oxymorphone_Sadiq2013_original_data_set_params.json` · controls `Oxymorphone_Sadiq2013_original_data_set_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
