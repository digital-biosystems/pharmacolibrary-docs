...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-10 21:13 | 18:09 | 0/0/0 | 0/1/0 | 0/0/0 | 145,761/4,577 | ollama / qwen3.8:27b-mtp-q8_0 | 19 | 5/14 | 17/2 | 0 |
...
|---|---|---|---|
| <span class="pk-badge pk-badge--red">rejected</span> | [Yuan_2020](drugs/drug_ranitidine_bismuth_citrate/pd_Yuan_2020_percent_virus_entry.md) | Yuan S et al., Metallodrug ranitidine bismuth citrate…, Nature microbiology (2020) | [10.1038/s41564-020-00802-x](https://doi.org/10.1038/s41564-020-00802-x) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Yuan_2020](drugs/drug_ranitidine_bismuth_citrate/pd_Yuan_2020_viral_RNA_load.md) | Yuan S et al., Metallodrug ranitidine bismuth citrate…, Nature microbiology (2020) | [10.1038/s41564-020-00802-x](https://doi.org/10.1038/s41564-020-00802-x) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Yuan_2020](drugs/drug_ranitidine_bismuth_citrate/pd_Yuan_2020_viral_nucleoprotein_expression.md) | Yuan S et al., Metallodrug ranitidine bismuth citrate…, Nature microbiology (2020) | [10.1038/s41564-020-00802-x](https://doi.org/10.1038/s41564-020-00802-x) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Yuan_2020](drugs/drug_ranitidine_bismuth_citrate/pd_Yuan_2020_viral_titre.md) | Yuan S et al., Metallodrug ranitidine bismuth citrate…, Nature microbiology (2020) | [10.1038/s41564-020-00802-x](https://doi.org/10.1038/s41564-020-00802-x) |

## Coverage

- **PubMed hits:** 935 matched, 63 returned
...
|---|---|---|---|---|---|
| popPK | Applefeld_2020 | irrelevant | 0 | 0 | The paper focuses on red blood cell storage and shock models, and does not contain any pharmacokinetic data for ranitidine_bismuth_citrate. |
...
| popPK | Copp_2014 | irrelevant | 0 | 0 | The paper describes a biomimetic nanoparticle study for antibody clearance and does not involve ranitidine_bismuth_citrate or its pharmacokinetics. |
...
| popPK | Feldman_1981 | irrelevant | 0 | 0 | The paper studies ferrokinetics in dogs with inflammatory anemia and does not involve ranitidine_bismuth_citrate or its pharmacokinetics. |
...
| popPK | Kanne_2021 | irrelevant | 0 | 0 | The paper studies GBT1118 (a voxelotor analog) in sickle cell mice and does not mention or report pharmacokinetic parameters for ranitidine_bismuth_citrate. |
| popPK | Khopade_2025 | irrelevant | 0 | 0 | The study evaluates the pharmacokinetics of paclitaxel, not ranitidine_bismuth_citrate. |
| popPK | Kuck_2022 | irrelevant | 0 | 0 | The paper studies blood rheology and erythrocyte mechanics, not the pharmacokinetics of ranitidine_bismuth_citrate. |
...
| popPK | Liu_2021 | irrelevant | 0 | 0 | The paper studies the pharmacokinetics of chloroquine, not ranitidine_bismuth_citrate. |
...
| PD | Mobley_1999 | not_relevant | 3 | 2 | The paper reports MICs (minimal inhibitory concentrations) for ranitidine bismuth citrate in bacterial strains, which is a microbiological susceptibility assay, not a pharmacodynamic (exposure-response) analysis in a biological host or cell system with derivable PD parameters like Emax or EC50 for a drug effect. |
...
| popPK | Ningtyas_2024 | irrelevant | 0 | 0 | The paper discusses platelet-mediated clearance of senescent red blood cells and does not involve ranitidine_bismuth_citrate or pharmacokinetic parameters. |
...
| popPK | Thomas_2023 | irrelevant | 0 | 0 | The paper is a study on red blood cell alloimmunization in mice and does not involve the drug ranitidine_bismuth_citrate or any pharmacokinetic parameters. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_ranitidine_bismuth_citrate`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
