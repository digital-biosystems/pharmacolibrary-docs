...
## Citation
Yuan S; Wang R; Chan JF; Zhang AJ; Cheng T; Chik KK; et al. et al. (2020). Nature microbiology 5
  ·  DOI: [10.1038/s41564-020-00802-x](https://doi.org/10.1038/s41564-020-00802-x)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | RBC | not captured | mismatch |
...
---
<sub>← back to [ranitidine bismuth citrate](drugs/drug_ranitidine_bismuth_citrate/)</sub>
