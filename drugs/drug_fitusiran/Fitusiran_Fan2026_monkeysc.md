...
|---|---|---|---|---|---|---|---|---|---|---|
| ka (1/h) | `Q49` · kabs | —(suppressed) | units | — | [units] | not captured | exact (1.0) | tbl1:row3:col4 | — | not captured |
| Fu (1/h) | `Q46` · fu | —(suppressed) | units | — | [units] | not captured | exact (1.0) | tbl1:row4:col4 | — | not captured |
| RTOT0 (nM) | `Q333` · Rtot | —(suppressed) | nM | — | [nM] | not captured | llm (0.6) | tbl1:row9:col4 | — | not captured |
| Vm (nmol/h) | `Q66` · Vmax | —(suppressed) | nmol/h | — | [nM] / [h] | not captured | special_case (0.95) | tbl1:row10:col4 | — | not captured |
| Km (∗105 nM) | `Q1` · Km | —(suppressed) | units | — | [units] | not captured | exact (1.0) | tbl1:row11:col4 | — | not captured |
| koff (1/h) | `Q330` · koff | —(suppressed) | units | — | [units] | not captured | exact (1.0) | tbl1:row12:col4 | — | not captured |
| kint (1/h) | `Q334` · kint | —(suppressed) | nM−1·h−1 | — | [1] / [[h] · [nM]] | not captured | exact (1.0) | tbl1:row15:col4 | — | not captured |
| Kdis (∗10−3 h−1) | `Q331` · KD | —(suppressed) | nM | — | [nM] | not captured | llm (0.6) | tbl1:row21:col4 | — | not captured |
...
- population split: 'monkeysc' subgroup of Fan_2026 (paper reports 7 populations: 0.38, 0.71 (9.45), 1.48 (21.16), humansa, micea, monkeysc, ratsb)
