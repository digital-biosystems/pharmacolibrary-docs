...
|---|---|---|---|---|---|---|---|---|---|---|
| elimination rate constant from plasma | `Q47` · kel | 0.39 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | Fan_2026_table_S3:row0:col3 | — | not captured |
| rate_constant_for_free_cytosolic_sirna_degradation | `Q900` · rate_constant_for_free_cytosolic_sirna_degradation | 0.0012 | not captured | not captured | not captured | not captured | not captured (not captured) | Fan_2026_table_S3:row4:col3 | — | not captured |
| Michaelis constant | `Q1` · Km | 27.44 | not captured | not captured | not captured | not captured | llm (0.6) | Fan_2026_table_S3:row7:col3 | — | not captured |
| theta_q330_category | `Q900` · theta_q330_category | 0.021 | not captured | not captured | not captured | not captured | not captured (not captured) | Fan_2026_table_S3:row8:col3 | — | not captured |
| theta_q334_category | `Q900` · theta_q334_category | 2.01 | not captured | not captured | not captured | not captured | not captured (not captured) | Fan_2026_table_S3:row11:col3 | — | not captured |
| theta_q329_category | `Q900` · theta_q329_category | 0.013 | not captured | not captured | not captured | not captured | not captured (not captured) | Fan_2026_table_S3:row16:col3 | — | not captured |
| theta_q328_category | `Q900` · theta_q328_category | 0.0083 | not captured | not captured | not captured | not captured | not captured (not captured) | Fan_2026_table_S3:row18:col3 | — | not captured |
