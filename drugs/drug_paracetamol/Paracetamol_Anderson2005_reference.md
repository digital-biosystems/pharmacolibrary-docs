...
## Model component
<dbs-pgx drug="paracetamol" model-id="Paracetamol_Anderson2005_reference" status="needs_review" stale="false" population="children" measured-compound="paracetamol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| Clearance increased from 27 weeks PCA | `Q22` · CL | 1.87 | lAEh )1 70 kg )1 | not captured | lAEh )1 70 kg )1 | not captured | boundary (0.8) | Anderson_2005:results_prose | — | not captured |
| Peripheral volume of distribution decreased from 27 weeks PCA | `Q61` · V | 45.0 | lAE70 kg )1 | not captured | lAE70 kg )1 | not captured | boundary (0.8) | Anderson_2005:results_prose | — | not captured |
...
| `gpt-oss:120b` | `parameters[14.9]` | not captured | 58.1 | only_one_extracted |
...
| C5_unit_missing_Q22 | fail | [length] ** 3 / [time] | lAEh )1 70 kg )1 | not captured | not captured | ['Anderson_2005:results_prose'] |
| C5_unit_missing_Q61 | fail | [length] ** 3 | lAE70 kg )1 | not captured | not captured | ['Anderson_2005:results_prose'] |
