...
# sum pain intensity over 6 h — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.412). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.412 (7/17 fields) | 10 |

<details><summary>10 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 3.0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 0 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q71]` | not captured | 1.9 | only_one_extracted |
