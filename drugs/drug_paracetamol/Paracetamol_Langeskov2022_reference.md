...
## Model component
<dbs-pgx drug="paracetamol" model-id="Paracetamol_Langeskov2022_reference" status="needs_review" stale="false" population="healthy adults" measured-compound="paracetamol" parameterization="apparent" topology="2C"></dbs-pgx>
...
<img src="drugs/drug_paracetamol/Paracetamol_Langeskov2022_reference/Paracetamol_Langeskov2022_reference.svg" alt="Paracetamol_Langeskov2022_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_2C_enteral` · parameters `Paracetamol_Langeskov2022_reference_params.json` · controls `Paracetamol_Langeskov2022_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
