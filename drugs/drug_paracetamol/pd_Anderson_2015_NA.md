...
# analgesic effect — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.0 (0/12 fields) | 12 |

<details><summary>12 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | paracetamol | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q320]` | 5.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 5.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 8.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | 4.89 | not captured | only_one_extracted |
