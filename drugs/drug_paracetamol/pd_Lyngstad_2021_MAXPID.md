...
# maximum pain intensity difference — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.278). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.278 (5/18 fields) | 13 |

<details><summary>13 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q341]` | 10 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q341]` | 26 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 46 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 40 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 26 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q71]` | not captured | 2.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q71]` | not captured | 2.4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q87]` | 6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q87]` | 8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q87]` | 8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q87]` | 26 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q87]` | 28 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q87]` | 16 | not captured | only_one_extracted |
