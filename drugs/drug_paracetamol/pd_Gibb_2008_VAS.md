...
# pain relief — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.286). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Gibb IA; Anderson BJ et al. (2008). Archives of disease in childhood 93
...
`Paracetamol_Gibb2008_PD_vas` — sigmoid_emax, `response = E0 + Emax*frac`

| parameter | value (paper units) | SI |
|---|---|---|
| E0 | 0 | — |
| Emax | -10 VAS of 0-10 | — |
| EC50 | 9.98 mg/l | 0.00998 kg/m3 |
| gamma | 1 | — |

Closed-form check points (response, SI): `at_0` = 0, `at_EC50` = -5, `at_inf` = -10
...
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 1.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 3.4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 4.2 | only_one_extracted |
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_paracetamol/Paracetamol_Gibb2008_PD_vas/Paracetamol_Gibb2008_PD_vas_modelica.zip" download>Paracetamol_Gibb2008_PD_vas_modelica.zip</a> <span class="pk-size">(2.3 kB)</span></td></tr>
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_paracetamol/Paracetamol_Gibb2008_PD_vas/Paracetamol_Gibb2008_PD_vas_sbml.zip" download>Paracetamol_Gibb2008_PD_vas_sbml.zip</a> <span class="pk-size">(2.5 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_paracetamol/Paracetamol_Gibb2008_PD_vas/Paracetamol_Gibb2008_PD_vas_cellml.zip" download>Paracetamol_Gibb2008_PD_vas_cellml.zip</a> <span class="pk-size">(2.4 kB)</span></td></tr>
</tbody></table>
...
<dbs-fmusim paramsurl="drugs/drug_paracetamol/Paracetamol_Gibb2008_PD_vas/Paracetamol_Gibb2008_PD_vas_params.json" metaurl="assets/fmu/PD_SigmoidEmaxSweep.vr.json" wasmurl="assets/fmu/PD_SigmoidEmaxSweep.js" controlsurl="drugs/drug_paracetamol/Paracetamol_Gibb2008_PD_vas/Paracetamol_Gibb2008_PD_vas_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PD_SigmoidEmaxSweep` · parameters `Paracetamol_Gibb2008_PD_vas_params.json` · controls `Paracetamol_Gibb2008_PD_vas_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
