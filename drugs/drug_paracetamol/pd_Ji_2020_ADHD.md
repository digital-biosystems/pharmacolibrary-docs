...
# ADHD diagnosis — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.429). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 0.01 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | not captured | 53 | only_one_extracted |
