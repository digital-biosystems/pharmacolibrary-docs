...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `MTT`, `AUCt`, `AUC∞`, `Cmax`</sub>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_tramadol/Tramadol_SoriaChacartegui2026_reference/Tramadol_SoriaChacartegui2026_reference_matlab.zip" download>Tramadol_SoriaChacartegui2026_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
