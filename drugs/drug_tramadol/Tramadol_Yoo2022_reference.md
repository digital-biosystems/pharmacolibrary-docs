...
|---|---|---|---|---|---|---|---|---|---|---|
| relative bioavailability for the tablet | `Q87` · Frel | 1.25 | times higher | not captured | not captured | not captured | llm_confirmed (0.6) | Yoo_2022:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Yoo_2022_metadata.yaml (2 record(s)); values are summary statistics, not a fitted model
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_tramadol/Tramadol_Yoo2022_reference/Tramadol_Yoo2022_reference_modelica.zip" download>Tramadol_Yoo2022_reference_modelica.zip</a> <span class="pk-size">(4.0 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_tramadol/Tramadol_Yoo2022_reference/Tramadol_Yoo2022_reference_matlab.zip" download>Tramadol_Yoo2022_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_tramadol/Tramadol_Yoo2022_reference/Tramadol_Yoo2022_reference.svg" alt="Tramadol_Yoo2022_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
