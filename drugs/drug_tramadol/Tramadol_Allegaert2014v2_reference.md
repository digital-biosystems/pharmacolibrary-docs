...
Allegaert K; van de Velde M; van den Anker J et al. (2014). Paediatric anaesthesia 24
  ·  DOI: [10.1111/pan.12176](https://doi.org/10.1111/pan.12176)
...
|---|---|---|---|---|---|---|---|---|---|---|
| propofol clearance capacity in a 38 postmenstrual weeks newborn at birth | `Q22` · CL | 0.029 | l.min−1 | 4.833333333333334e-07 | L/h | not captured | review (0.7) | Allegaert_2014_2:review | — | not captured |
| distribution volume | `Q61` · V | 0.6 | l.kg-1 | 0.041999999999999996 | L | not captured | review (0.7) | Allegaert_2014_2:review | — | not captured |
| peripheral volume of distribution | `Q64` · V2 | 45.0 | l .70 kg−1 | 3.15 | L | not captured | review (0.7) | Allegaert_2014_2:review | — | not captured |
...
- built from REVIEW reference values (Allegaert_2014_2) — secondary source
...
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Allegaert_2014_2:review'] |
...
| C9_phys_window_Q64 | pass | volume within physiological range | 3.15e+03 L | not captured | not captured | ['Allegaert_2014_2:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_tramadol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Allegaert_2014_2` / `Allegaert_2014_2::reference`)
