...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[clmo]` | not captured | 78.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[ka]` | 0.65 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[theta_cl_cyp2d6]` | not captured | 28.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[tm50 clmo]` | not captured | 47.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[vm1]` | not captured | 1.45 | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_tramadol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Healy_2025` / `Healy_2025::reference`)
- model: `../../../knowledgebase/drugs/drug_tramadol/models/modelica/_needs_review/Tramadol_Healy2025_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_tramadol/models/modelica/_needs_review/Tramadol_Healy2025_reference.deviation.json`
