...
# CYP2D6 — PGx  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.2). The first reading is what the record holds.">cross-check: partial</span>
...
- **paper:** `Soria-Chacartegui_2026`
- **gene:** CYP2D6
- **mechanism:** metabolism
- **applies to:** pk
- **target:** `Q22` CL
- **effect (θ / form):** reported=-0.198
...
| `gpt-oss:120b` | `theta[reported]` | -0.198 | not captured | only_one_extracted |
