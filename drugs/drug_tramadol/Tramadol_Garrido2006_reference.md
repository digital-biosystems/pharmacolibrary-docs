...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Garrido_2006_metadata.yaml (3 record(s)); values are summary statistics, not a fitted model
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model.links` | [['tramadol', 'o-demethyltramadol', 'metabolism']] | [['tramadol', 'o-demethyltramadol (m1)', 'metabolism']] | mismatch |
| `gpt-oss:120b` | `model.parameterization` | apparent | mechanistic | mismatch |
| `gpt-oss:120b` | `parameters[apparent volumes of distribution ... at steady state]` | 46.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[apparent volumes of distribution of the central compartment]` | 8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[ka]` | 0.65 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[total plasma clearance of t]` | 15.2 | not captured | only_one_extracted |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Garrido_2006:abstract'] |
| C5_dimension_Q290 | pass | [length] ** 3 | not captured | not captured | not captured | ['Garrido_2006:abstract'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Ekstrand_2026:review'] |
| C5_dimension_Q65 | pass | [length] ** 3 | not captured | not captured | not captured | ['Garrido_2006:abstract'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 15.2 L/h | not captured | not captured | ['Garrido_2006:abstract'] |
| C9_phys_window_Q290 | pass | volume within physiological range | 8 L | not captured | not captured | ['Garrido_2006:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_tramadol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Garrido_2006` / `Garrido_2006::reference`)
- model: `../../../knowledgebase/drugs/drug_tramadol/models/modelica/_needs_review/Tramadol_Garrido2006_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_tramadol/models/modelica/_needs_review/Tramadol_Garrido2006_reference.deviation.json`
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_tramadol/Tramadol_Garrido2006_reference/Tramadol_Garrido2006_reference_matlab.zip" download>Tramadol_Garrido2006_reference_matlab.zip</a> <span class="pk-size">(3.2 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_tramadol/Tramadol_Garrido2006_reference/Tramadol_Garrido2006_reference_matlab_simbio.zip" download>Tramadol_Garrido2006_reference_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_tramadol/Tramadol_Garrido2006_reference/Tramadol_Garrido2006_reference_sbml.zip" download>Tramadol_Garrido2006_reference_sbml.zip</a> <span class="pk-size">(2.4 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_tramadol/Tramadol_Garrido2006_reference/Tramadol_Garrido2006_reference_cellml.zip" download>Tramadol_Garrido2006_reference_cellml.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
</tbody></table>
