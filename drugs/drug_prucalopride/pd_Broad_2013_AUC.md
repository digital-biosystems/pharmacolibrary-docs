...
# EFS-evoked cholinergic contractions (AUC) — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--green" title="re-read by gpt-oss:120b (confirmed, agreement 1.0). The first reading is what the record holds.">cross-checked ✓</span>
...
## Citation
Broad J; Kung VW; Boundouki G; Aziz Q; De Maeyer JH; Knowles CH; et al. et al. (2013). British journal of pharmacology 170
  ·  DOI: [10.1111/bph.12397](https://doi.org/10.1111/bph.12397)
...
---
<sub>← back to [prucalopride](drugs/drug_prucalopride/)</sub>
