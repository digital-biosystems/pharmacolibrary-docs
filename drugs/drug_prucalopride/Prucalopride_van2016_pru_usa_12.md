...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (l h−1) | `Q22` · CL | 12.1 | l h−1 | 3.361111111111111e-06 | [l] / [h] | not captured | exact (1.0) | van_2016_table_4:row2:col1, van_2016_table_4:row2:col2, van_2016_table_4:row2:col3 | — | not captured |
| V2 (l) | `Q64` · V2 | 192 | l | 0.192 | [l] | not captured | exact (1.0) | van_2016_table_4:row3:col1, van_2016_table_4:row3:col2, van_2016_table_4:row3:col3 | — | not captured |
| AUC (ng mL−1 h) | `Q88` · AUC | 62.3 | ng mL−1 h | not captured | [ng] / [[h] · [ml]] | not captured | exact (1.0) | van_2016_table_4:row4:col1, van_2016_table_4:row4:col2, van_2016_table_4:row4:col3 | — | not captured |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[auc]` | 62.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[cl]` | 12.1 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[v2]` | 192 | not captured | only_one_extracted |
