...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[t1/2 alpha]` | 1.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[t1/2 beta]` | 17.85 | not captured | only_one_extracted |
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-21 02:06 UTC</sub>
