...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-08-28 10:48 | 20:10 | 0/0/0 | 0/3/0 | 0/0/0 | 208,530/2,475 | ollama / qwen3.8:27b-mtp-q8_0 | 11 | 7/4 | 9/2 | 0 |
...
|---|---|---|---|
| <span class="pk-badge pk-badge--red">rejected</span> | [Kasuya_2013](drugs/drug_diflunisal/pd_Kasuya_2013_unknown.md) | Kasuya F et al., Effect of the non-steroidal anti-inflam…, Journal of enzyme inhibitio… (2013) | [10.3109/14756366.2011.636742](https://doi.org/10.3109/14756366.2011.636742) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Serlin_1980](drugs/drug_diflunisal/pd_Serlin_1980_free_fraction_of_warfarin.md) | Serlin MJ et al., The effect of diflunisal on the steady…, British journal of clinical… (1980) | [10.1111/j.1365-2125.1980.tb04847.x](https://doi.org/10.1111/j.1365-2125.1980.tb04847.x) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Şenkardeş_2016_2](drugs/drug_diflunisal/pd_enkarde_2016_2_anti_HCV_activity.md) | Şenkardeş (2016) | — |
| <span class="pk-badge pk-badge--red">rejected</span> | [Şenkardeş_2016_2](drugs/drug_diflunisal/pd_enkarde_2016_2_antiproliferative_activity.md) | Şenkardeş (2016) | — |
...
<sub>queue written 2026-08-28T10:43:57.085978+00:00</sub>
...
| PGx | Ji_2025 | not_relevant | 0 | 0 | The paper compares the in vitro binding affinities and TTR stabilization kinetics of acoramidis, tafamidis, and diflunisal, but does not report any pharmacogenomic effects (gene variants) on the PK or PD parameters of diflunisal. |
...
| PD | Maier_2021 | not_relevant | 0 | 0 | The paper focuses on antibiotic activity spectra and antidote screening for gut bacteria; diflunisal is mentioned only as a single data point in a combinatorial assay, with no pharmacodynamic modeling or dose-response analysis for the drug itself. |
...
| PGx | Sha_2024 | not_relevant | 0 | 0 | The paper investigates the biochemical properties of a TTR mutation and the in vitro stabilizing effect of diflunisal on TTR fibril formation, but does not report pharmacokinetic or pharmacodynamic parameters of diflunisal itself. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_diflunisal`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
