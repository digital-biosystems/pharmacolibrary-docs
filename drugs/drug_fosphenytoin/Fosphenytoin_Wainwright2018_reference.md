...
## Citation
not matched (stem Wainwright_2018)
...
- scholar stages: `../../../knowledgebase/drugs/drug_fosphenytoin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Wainwright_2018` / `Wainwright_2018::reference`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-10 00:07 UTC</sub>
