...
## Citation
Coles LD; Leppik IE; Patterson EE; Rivers Z; Mishra U; Cloyd JC et al. (2015). Epilepsia 56
  ·  DOI: [10.1111/epi.12961](https://doi.org/10.1111/epi.12961)

## Model component
<dbs-pgx drug="fosphenytoin" model-id="Fosphenytoin_Coles2015_reference" status="rejected" stale="false" population="healthy dogs" measured-compound="phenytoin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Coles_2015_metadata.yaml (0 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_fosphenytoin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Coles_2015` / `Coles_2015::reference`)
