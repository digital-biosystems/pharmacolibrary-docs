...
## Citation
Ohno Y; Niwa T; Hirai K; Suzuki K; Yamada Y; Hayashi Y; et al. et al. (2018). Therapeutic drug monitoring 40
  ·  DOI: [10.1097/FTD.0000000000000521](https://doi.org/10.1097/FTD.0000000000000521)

## Model component
<dbs-pgx drug="fosphenytoin" model-id="Fosphenytoin_Ohno2018_reference" status="rejected" stale="false" population="adult Japanese patients" measured-compound="phenytoin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
**Extraction notes:**
- no GROBID TEI available; abstract in Ohno_2018_metadata.yaml carries no parameter-bearing sentence
...
- scholar stages: `../../../knowledgebase/drugs/drug_fosphenytoin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ohno_2018` / `Ohno_2018::reference`)
