...
## Model component
<dbs-pgx drug="clarithromycin" model-id="Clarithromycin_Shah2025_mean_parameter_estimates" status="curated_candidate" stale="false" population="critically ill adults" measured-compound="clarithromycin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| θCL (L/h/70 kg) | `Q22` · CL | 8.17 | L/h/70 kg | 2.2694444444444446e-06 | [l] / [[h] · [70kg]] | not captured | llm_confirmed (0.6) | antibiotics-14-00559-t002:row2:col1 | — | not captured |
| θV1 (L/70 kg) | `Q61` · V | 25.7 | L/70 kg | 0.0257 | [l] / [70kg] | not captured | llm_confirmed (0.6) | antibiotics-14-00559-t002:row3:col1 | — | not captured |
| θQ (L/h/70 kg) | `Q30` · Q | 62.0 | L/h/70 kg | 1.7222222222222224e-05 | [l] / [[h] · [70kg]] | not captured | llm (0.6) | antibiotics-14-00559-t002:row4:col1 | — | not captured |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['antibiotics-14-00559-t002:row2:col1'] |
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['antibiotics-14-00559-t002:row4:col1'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['antibiotics-14-00559-t002:row3:col1'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 8.17 | not captured | not captured | ['antibiotics-14-00559-t002:row2:col1'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 8.17 L/h | not captured | not captured | ['antibiotics-14-00559-t002:row2:col1'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 25.7 L | not captured | not captured | ['antibiotics-14-00559-t002:row3:col1'] |
...
- model: `../../../knowledgebase/drugs/drug_clarithromycin/models/modelica/Clarithromycin_Shah2025_mean_parameter_estimates.mo`
- deviation: `../../../knowledgebase/drugs/drug_clarithromycin/models/modelica/Clarithromycin_Shah2025_mean_parameter_estimates.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_clarithromycin/models/modelica/Clarithromycin_Shah2025_mean_parameter_estimates.json`
