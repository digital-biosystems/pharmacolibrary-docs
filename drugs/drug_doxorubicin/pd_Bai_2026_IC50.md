...
## Citation
Bai J; Huang J; Zhang Q; Su W; Tang X; Amuti M; Zhu G; Shen Q; Yang J; Wang M et al. (2026). Pharmaceutics 18
...
| `gpt-oss:120b` | `parameters[Q75]` | 0.84 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q75]` | 0.79 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q75]` | 0.72 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q75]` | 0.63 | not captured | only_one_extracted |
