...
Liang S; Brundage RC; Jacobson PA; Blaes A; Kirstein MN et al. (2016). British journal of clinical pharmacology 82
  ·  DOI: [10.1111/bcp.12989](https://doi.org/10.1111/bcp.12989)

## Model component
<dbs-pgx drug="doxorubicin" model-id="Doxorubicin_Liang2016_reference" status="rejected" stale="false" population="adults with breast cancer" measured-compound="doxorubicin" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | —(suppressed) | mL/day | — | L/h | not captured | review_gapfill (0.7) | Augustin_2026:review | — | not captured |
| V E | `Q61` · V | —(suppressed) | µL | — | L | not captured | review_gapfill (0.7) | Andrean_2025:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_doxorubicin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Liang_2016` / `Liang_2016::reference`)
