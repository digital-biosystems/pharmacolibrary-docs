...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `CL`, `Q2`, `Q3`, `fm`</sub>
...
## Model component
<dbs-pgx drug="doxorubicin" model-id="Doxorubicin_PrezBlanco2016_final_model_n_44" status="model_quarantined" stale="false" population="adults with non-Hodgkin&#39;s lymphoma" measured-compound="doxorubicin" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
...
| V 1 (l) | `Q63` · V1 | —(suppressed) | l | — | [l] | not captured | llm (0.6) | tab_2:row3:col3, tab_2:row3:col6, tab_2:row3:col8 | — | not captured |
| Q 2 (l h | `Q99` · Q2 | —(suppressed) | l h | — | [h] · [l] | not captured | llm (0.6) | tab_2:row4:col6, tab_2:row4:col7 | — | not captured |
| V 2 (l) | `Q64` · V2 | —(suppressed) | l | — | [l] | not captured | llm (0.6) | tab_2:row5:col3, tab_2:row5:col6, tab_2:row5:col8 | — | not captured |
| Q 3 (l h | `Q308` · Q3 | —(suppressed) | l h | — | [h] · [l] | not captured | llm (0.6) | tab_2:row6:col6, tab_2:row6:col7 | — | 28.2 (None% RSE) |
| V 3 (l) | `Q77` · V3 | —(suppressed) | l | — | [l] | not captured | llm (0.6) | tab_2:row7:col3, tab_2:row7:col6, tab_2:row7:col8 | — | not captured |
| F m | `Q45` · fm | —(suppressed) | n = 44 | — | [n=44] | not captured | llm (0.6) | tab_2:row10:col3, tab_2:row10:col4, tab_2:row10:col6, tab_2:row10:col7, tab_2:row10:col8 | — | not captured |
| V 5 (l) | `Q61` · V | —(suppressed) | l | — | [l] | not captured | llm (0.6) | tab_2:row11:col3, tab_2:row11:col6, tab_2:row11:col8 | — | not captured |
| Q 5 (l h | `Q30` · Q | —(suppressed) | l h | — | [h] · [l] | not captured | llm (0.6) | tab_2:row12:col2, tab_2:row12:col3, tab_2:row12:col6, tab_2:row12:col7 | — | 64.1 (None% RSE) |
...
- model: `../../../knowledgebase/drugs/drug_doxorubicin/models/modelica/_needs_review/Doxorubicin_PrezBlanco2016_final_model_n_44.mo`
- deviation: `../../../knowledgebase/drugs/drug_doxorubicin/models/modelica/_needs_review/Doxorubicin_PrezBlanco2016_final_model_n_44.deviation.json`
