...
# overall survival — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.5). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Fudio S; Pérez-Ramos L; Asín-Prieto E; Zeaiter A; Lubomirov R et al. (2023). Frontiers in oncology 13
...
| `gpt-oss:120b` | `parameters[Q100]` | 10.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 8.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 10.8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q342]` | not captured | 294.2 | only_one_extracted |
