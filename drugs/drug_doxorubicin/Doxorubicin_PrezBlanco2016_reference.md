...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[cl (l h].value` (63.4 vs 1.7) and 4 more field(s) — a structural parameter, so the record is disputed.
...
## Model component
<dbs-pgx drug="doxorubicin" model-id="Doxorubicin_PrezBlanco2016_reference" status="needs_review" stale="false" population="adults with non-Hodgkin&#39;s lymphoma" measured-compound="doxorubicin" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (l h | `Q22` · CL | 63.4 | l h | not captured | [h] · [l] | not captured | llm_confirmed (0.6) | tab_2:row2:col5, tab_2:row2:col6, tab_2:row2:col7 | — | 22.9 (None% RSE) |
| V 1 (l) | `Q63` · V1 | 17.7 | l | 0.0177 | [l] | not captured | space_fold (0.95) | tab_2:row3:col3, tab_2:row3:col6, tab_2:row3:col8 | — | not captured |
| Q 2 (l h | `Q99` · Q2 | 52.4 | l h | not captured | [h] · [l] | not captured | llm (0.6) | tab_2:row4:col5, tab_2:row4:col6, tab_2:row4:col7 | — | not captured |
| V 2 (l) | `Q64` · V2 | 1830 | l | 1.83 | [l] | not captured | space_fold (0.95) | tab_2:row5:col3, tab_2:row5:col6, tab_2:row5:col8 | — | not captured |
| Q 3 (l h | `Q308` · Q3 | 29.9 | l h | not captured | [h] · [l] | not captured | llm (0.6) | tab_2:row6:col5, tab_2:row6:col6, tab_2:row6:col7 | — | 28.2 (None% RSE) |
| V 3 (l) | `Q77` · V3 | 71 | l | 0.07100000000000001 | [l] | not captured | space_fold (0.95) | tab_2:row7:col3, tab_2:row7:col6, tab_2:row7:col8 | — | not captured |
| F m | `Q45` · fm | 0.22 | n = 44 | not captured | [n=44] | not captured | space_fold (0.95) | tab_2:row10:col3, tab_2:row10:col4, tab_2:row10:col6, tab_2:row10:col7, tab_2:row10:col8 | — | not captured |
| Q 5 (l h | `Q30` · Q | 424 | l h | not captured | [h] · [l] | not captured | llm (0.6) | tab_2:row12:col2, tab_2:row12:col3, tab_2:row12:col5, tab_2:row12:col6, tab_2:row12:col7 | — | 64.1 (None% RSE) |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl (l h].value` | 63.4 | 1.7 | mismatch |
| `gpt-oss:120b` | `parameters[q 2 (l h].value` | 52.4 | 3.4 | mismatch |
| `gpt-oss:120b` | `parameters[q 3 (l h].value` | 29.9 | 5.4 | mismatch |
| `gpt-oss:120b` | `parameters[q 5 (l h].value` | 424 | 18.0 | mismatch |
| `gpt-oss:120b` | `parameters[v 4]` | not captured | 79.8 | only_one_extracted |
...
| C5_unit_missing_Q22 | fail | [length] ** 3 / [time] | l h | not captured | not captured | ['tab_2:row2:col5', 'tab_2:row2:col6', 'tab_2:row2:col7'] |
| C5_unit_missing_Q30 | fail | [length] ** 3 / [time] | l h | not captured | not captured | ['tab_2:row12:col2', 'tab_2:row12:col3', 'tab_2:row12:col5', 'tab_2:row12:col6', 'tab_2:row12:col7'] |
| C5_unit_missing_Q308 | fail | [length] ** 3 / [time] | l h | not captured | not captured | ['tab_2:row6:col5', 'tab_2:row6:col6', 'tab_2:row6:col7'] |
| C5_unit_missing_Q99 | fail | [length] ** 3 / [time] | l h | not captured | not captured | ['tab_2:row4:col5', 'tab_2:row4:col6', 'tab_2:row4:col7'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 63.4 | not captured | not captured | ['tab_2:row2:col5', 'tab_2:row2:col6', 'tab_2:row2:col7'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_doxorubicin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Pérez-Blanco_2016` / `Pérez-Blanco_2016::reference`)
