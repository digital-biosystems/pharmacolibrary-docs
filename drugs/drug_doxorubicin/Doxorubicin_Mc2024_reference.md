...
## Model component
<dbs-pgx drug="doxorubicin" model-id="Doxorubicin_Mc2024_reference" status="rejected" stale="false" population="patients with advanced solid tumours" measured-compound="doxorubicin" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| V1 [L] | `Q63` · V1 | 3.39 | not captured | not captured | not captured | 7 | llm_confirmed (0.6) | Tab2:row1:col2, Tab2:row1:col3 | — | not captured |
| CL1 [L/h] | `Q22` · CL | 0.0271 | not captured | not captured | not captured | 11 | llm (0.6) | Tab2:row2:col2, Tab2:row2:col3 | — | not captured |
| V2 [L] | `Q64` · V2 | 0.531 | not captured | not captured | not captured | 16 | llm_confirmed (0.6) | Tab2:row3:col2, Tab2:row3:col3 | — | not captured |
| Q [L/h] | `Q30` · Q | 0.136 | not captured | not captured | not captured | 18 | llm (0.6) | Tab2:row5:col2, Tab2:row5:col3 | — | None (11% RSE) |
| V3 [L] | `Q77` · V3 | 61.3 | not captured | not captured | not captured | 19 | llm_confirmed (0.6) | Tab2:row6:col2, Tab2:row6:col3 | — | not captured |
...
- dropped duplicate Q77 ('V4 [L]', value '8152') — already have one for this compound
...
- unparsed cell Tab2:row7:col1 = 'Exponent of the power covariate model of BSA on V3'
- unparsed cell Tab2:row11:col1 = 'Shared η scale factor for V1'
- unparsed cell Tab2:row12:col2 = '45.1% CV'
- unparsed cell Tab2:row13:col2 = '28.2% CV'
- unparsed cell Tab2:row14:col2 = '34.2% CV'
- unparsed cell Tab2:row15:col2 = '15.1% CV'
- unparsed cell Tab2:row16:col1 = 'Interoccasion variability for CL1'
- unparsed cell Tab2:row16:col2 = '14.4% CV'
- unparsed cell Tab2:row17:col1 = 'Interoccasion variability for CL2'
- unparsed cell Tab2:row17:col2 = '22.4% CV'
- unparsed cell Tab2:row18:col1 = 'Interoccasion variability for V1'
- unparsed cell Tab2:row18:col2 = '8.85% CV'
- unparsed cell Tab2:row19:col1 = 'Interoccasion variability for V2'
- unparsed cell Tab2:row19:col2 = '126% CV'
- unparsed cell Tab2:row20:col2 = '19.6% CV'
- unparsed cell Tab2:row21:col2 = '64.2% CV'
- unparsed cell Tab2:row22:col2 = '65.0% CV'
