...
|---|---|---|---|---|---|---|---|---|---|---|
| V1 [L] | `Q63` · V1 | —(suppressed) | not captured | — | not captured | 7 | llm_confirmed (0.6) | Tab2:row1:col2, Tab2:row1:col3 | — | not captured |
| CL1 [L/h] | `Q22` · CL | —(suppressed) | not captured | — | not captured | 11 | llm (0.6) | Tab2:row2:col2, Tab2:row2:col3 | — | not captured |
| V2 [L] | `Q64` · V2 | —(suppressed) | not captured | — | not captured | 16 | llm_confirmed (0.6) | Tab2:row3:col2, Tab2:row3:col3 | — | not captured |
| Q [L/h] | `Q30` · Q | —(suppressed) | not captured | — | not captured | 18 | llm (0.6) | Tab2:row5:col2, Tab2:row5:col3 | — | None (11% RSE) |
| V3 [L] | `Q77` · V3 | —(suppressed) | not captured | — | not captured | 19 | llm_confirmed (0.6) | Tab2:row6:col2, Tab2:row6:col3 | — | not captured |
