...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | doxorubicin, sorafenib | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q358]` | 0.531 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.680 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.694 | not captured | only_one_extracted |
