...
# thrombocyte reduction — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | carboplatin | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q17]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q17]` | 0.73 | not captured | only_one_extracted |
