...
# Platelet count — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.333). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
De Carlo A; Tosca EM; Crul M; Schutte T; van Zuijlen L; Bahce I; Said MM; Buter J; Huls H; Magni P; Bartelink I et al. (2026). British journal of clinical pharmacology 92
  ·  DOI: [10.1002/bcp.70413](https://doi.org/10.1002/bcp.70413)
...
| `gpt-oss:120b` | `model_family` | indirect_response_iii | indirect_response_i | mismatch |
| `gpt-oss:120b` | `parameters[Q335]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q60]` | not captured | not captured | only_one_extracted |
