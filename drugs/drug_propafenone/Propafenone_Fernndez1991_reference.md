...
|---|---|---|---|---|---|---|---|---|---|---|
| t1/2 beta | `Q60` · t1/2β | 55.4 | min | 3324.0 | [min] | not captured | exact (1.0) | Fernández_1991:abstract | — | not captured |
| central Vd/kg | `Q61` · V | 2.4 | ml/kg | 0.000168 | [ml] / [kg] | not captured | llm (0.6) | Fernández_1991:abstract | — | not captured |
| Cl | `Q22` · CL | 62.8 | ml/min.kg | not captured | [ml] / [[min] · [kg]] | not captured | exact (1.0) | Fernández_1991:abstract | — | not captured |
| AUC0-oo | `Q17` · AUC∞ | 31.6 | micrograms.min/ml | not captured | [[min] · [µg]] / [ml] | not captured | llm (0.6) | Fernández_1991:abstract | — | not captured |
...
- unit_dimension_mismatch: 'Cl' → Q22 (unit '[length] ** 3 * [mass] / [time]' vs ontology '[length] ** 3 / [time]') — route to review
...
- 1C volume normalization: Q63→Q61 (single-compartment model has no central/peripheral split; 'central Vd/kg' is the general volume)
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Fernández_1991_metadata.yaml (4 record(s)); values are summary statistics, not a fitted model
...
| C5_dimension_Q17 | pass | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['Fernández_1991:abstract'] |
| C5_dimension_Q22 | fail | [length] ** 3 * [mass] / [time] | ml/min.kg | not captured | not captured | ['Fernández_1991:abstract'] |
| C5_dimension_Q60 | pass | [time] | not captured | not captured | not captured | ['Fernández_1991:abstract'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Fernández_1991:abstract'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 62.8 | not captured | not captured | ['Fernández_1991:abstract'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q61 | fail | volume within physiological range | 0.168 L | not captured | not captured | ['Fernández_1991:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_propafenone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Fernández_1991` / `Fernández_1991::reference`)
