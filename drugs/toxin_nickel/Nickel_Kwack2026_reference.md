...
## Model component
<dbs-pgx drug="nickel" model-id="Nickel_Kwack2026_reference" status="extracted" stale="false" population="" measured-compound="nickel" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/toxins/toxin_nickel/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kwack_2026` / `Kwack_2026::reference`)
