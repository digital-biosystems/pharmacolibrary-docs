...
## Model component
<dbs-pgx drug="nickel" model-id="Nickel_Zhao2017_reference" status="extracted" stale="false" population="rat and occupational population" measured-compound="nickel" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/toxins/toxin_nickel/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Zhao_2017` / `Zhao_2017::reference`)
