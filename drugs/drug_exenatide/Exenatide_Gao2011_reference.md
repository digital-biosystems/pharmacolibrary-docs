...
**What is wrong:** the simulated model does not reproduce a value the paper reports. Evidence: T1_t_half_beta — expected 1.1666666666666667 — got 0.6859026180961096 — ratio 0.5879; T1_t_half_terminal — expected 0.5166666666666666 — got 0.6859026180961096 — ratio 1.3276
...
- scholar stages: `../../../knowledgebase/drugs/drug_exenatide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Gao_2011` / `Gao_2011::reference`)
- model: `../../../knowledgebase/drugs/drug_exenatide/models/modelica/Exenatide_Gao2011_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_exenatide/models/modelica/Exenatide_Gao2011_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_exenatide/models/modelica/Exenatide_Gao2011_reference.json`
...
<img src="drugs/drug_exenatide/Exenatide_Gao2011_reference/Exenatide_Gao2011_reference.svg" alt="Exenatide_Gao2011_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_1C` · parameters `Exenatide_Gao2011_reference_params.json` · controls `Exenatide_Gao2011_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
