...
|---|---|---|---|---|---|---|---|---|---|---|
| ka (1/day) | `Q49` · kabs | 2.98 | not captured | not captured | not captured | not captured | exact (1.0) | Cirincione_2017_table_p6_1:row0:col1 | — | not captured |
...
| ktr1 (1/day) | `Q306` · ktr | 0.0872 | not captured | not captured | not captured | not captured | llm (0.6) | Cirincione_2017_table_p6_1:row8:col1 | — | not captured |
...
| Vmax (mg/day) | `Q66` · Vmax | 0.037 | mg/day | not captured | [mg] / [d] | not captured | exact (1.0) | Cirincione_2017_table_p6_1:row15:col1 | — | not captured |
