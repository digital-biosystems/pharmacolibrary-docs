...
|---|---|---|---|---|---|---|---|---|---|---|
| ka (1/day) | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Cirincione_2017_table_p6_1:row0:col3 | — | not captured |
| f1 (%) | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Cirincione_2017_table_p6_1:row3:col3 | — | not captured |
| clearance | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | review_gapfill (0.7) | Admiraal_2023:review | — | not captured |
| volume of distribution | `Q61` · V | —(suppressed) | L | — | L | not captured | review_gapfill (0.7) | Admiraal_2023:review | — | not captured |
