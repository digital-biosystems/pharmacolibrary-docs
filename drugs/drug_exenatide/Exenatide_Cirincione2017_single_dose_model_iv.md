...
|---|---|---|---|---|---|---|---|---|---|---|
| ka (1/day) | `Q49` · kabs | 77.9 | not captured | not captured | not captured | not captured | exact (1.0) | Cirincione_2017_table_p6_1:row0:col3 | — | not captured |
| f1 (%) | `Q40` · Fab | 83 | not captured | not captured | not captured | not captured | exact (1.0) | Cirincione_2017_table_p6_1:row3:col3 | — | not captured |
| clearance | `Q22` · CL | 12.3 | L/h | 3.416666666666667e-06 | L/h | not captured | review_gapfill (0.7) | Admiraal_2023:review | — | not captured |
| volume of distribution | `Q61` · V | 10.0 | L | 0.01 | L | not captured | review_gapfill (0.7) | Admiraal_2023:review | — | not captured |
...
- dropped unlinked row (NIL): 'N1' — extend the ontology if this is a real PK parameter (source ['Cirincione_2017_table_p6_1:row10:col3'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=exenatide
- population split: 'single-dose model iv (%)' subgroup of Cirincione_2017 (paper reports 4 populations: combined single- and multiple-dose models iv (%), combined single- and multiple-dose models parameter estimate, single-dose model iv (%), single-dose model parameter estimate)
...
- scholar stages: `../../../knowledgebase/drugs/drug_exenatide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Cirincione_2017` / `Cirincione_2017::single_dose_model_iv`)
- model: `../../../knowledgebase/drugs/drug_exenatide/models/modelica/Exenatide_Cirincione2017_single_dose_model_iv.mo`
- deviation: `../../../knowledgebase/drugs/drug_exenatide/models/modelica/Exenatide_Cirincione2017_single_dose_model_iv.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_exenatide/models/modelica/Exenatide_Cirincione2017_single_dose_model_iv.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_exenatide/Exenatide_Cirincione2017_single_dose_model_iv/Exenatide_Cirincione2017_single_dose_model_iv_modelica.zip" download>Exenatide_Cirincione2017_single_dose_model_iv_modelica.zip</a> <span class="pk-size">(4.2 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_exenatide/Exenatide_Cirincione2017_single_dose_model_iv/Exenatide_Cirincione2017_single_dose_model_iv_fmi.zip" download>Exenatide_Cirincione2017_single_dose_model_iv_fmi.zip</a> <span class="pk-size">(4.2 kB)</span><br><a href="models/fmu/PK_1C_enteral.fmu" download>PK_1C_enteral.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_exenatide/Exenatide_Cirincione2017_single_dose_model_iv/Exenatide_Cirincione2017_single_dose_model_iv_matlab.zip" download>Exenatide_Cirincione2017_single_dose_model_iv_matlab.zip</a> <span class="pk-size">(3.5 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_exenatide/Exenatide_Cirincione2017_single_dose_model_iv/Exenatide_Cirincione2017_single_dose_model_iv_matlab_simbio.zip" download>Exenatide_Cirincione2017_single_dose_model_iv_matlab_simbio.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_exenatide/Exenatide_Cirincione2017_single_dose_model_iv/Exenatide_Cirincione2017_single_dose_model_iv_sbml.zip" download>Exenatide_Cirincione2017_single_dose_model_iv_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_exenatide/Exenatide_Cirincione2017_single_dose_model_iv/Exenatide_Cirincione2017_single_dose_model_iv_cellml.zip" download>Exenatide_Cirincione2017_single_dose_model_iv_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Exenatide_Cirincione2017_single_dose_model_iv_params.json` · controls `Exenatide_Cirincione2017_single_dose_model_iv_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
