...
<sub>Template `PK_1C_enteral` · parameters `Exenatide_Cirincione2017_single_dose_model_iv_params.json` · controls `Exenatide_Cirincione2017_single_dose_model_iv_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
