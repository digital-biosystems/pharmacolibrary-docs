...
## Model component
<dbs-pgx drug="exenatide" model-id="Exenatide_Cirincione2017v2_iiv" status="needs_review" stale="false" population="adults with type 2 diabetes mellitus" measured-compound="exenatide" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| linear clearance | `Q22` · CL | —(suppressed) | l h−1 | — | L/h | not captured | boundary (0.8) | Cirincione_2017_2:other_prose | — | not captured |
