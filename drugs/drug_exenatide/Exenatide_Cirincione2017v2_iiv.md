...
<img src="drugs/drug_exenatide/Exenatide_Cirincione2017v2_iiv/Exenatide_Cirincione2017v2_iiv.svg" alt="Exenatide_Cirincione2017v2_iiv diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_1C_enteral` · parameters `Exenatide_Cirincione2017v2_iiv_params.json` · controls `Exenatide_Cirincione2017v2_iiv_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
