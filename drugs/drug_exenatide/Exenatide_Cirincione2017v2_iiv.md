...
## Model component
<dbs-pgx drug="exenatide" model-id="Exenatide_Cirincione2017v2_iiv" status="curated_candidate" stale="false" population="adults with type 2 diabetes mellitus" measured-compound="exenatide" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| linear clearance | `Q22` · CL | 5.06 | l h−1 | 1.4055555555555553e-06 | L/h | not captured | boundary (0.8) | Cirincione_2017_2:other_prose | — | not captured |
...
- dropped value-less row: 'Vc_int (l)' (captured trailing unit 'l' for child rows)
- dropped value-less row: 'Vc=Vc_int⋅weight84.8Vc_wtkg'
- salvaged Q22 ('linear clearance'=5.06) from results prose — parameter table was unreadable
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=exenatide
- held at status:extracted — NIL link or unit issue (mismatch/unknown/normalisation-failed) present
- status held at route_to_review — not promoted
- population split: 'iiv(%)' subgroup of Cirincione_2017_2 (paper reports 2 populations: iiv(%), parameter estimate)
...
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 5.06 | not captured | not captured | ['Cirincione_2017_2:other_prose'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 5.06 L/h | not captured | not captured | ['Cirincione_2017_2:other_prose'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_exenatide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Cirincione_2017_2` / `Cirincione_2017_2::iiv`)
- model: `../../../knowledgebase/drugs/drug_exenatide/models/modelica/Exenatide_Cirincione2017v2_iiv.mo`
- deviation: `../../../knowledgebase/drugs/drug_exenatide/models/modelica/Exenatide_Cirincione2017v2_iiv.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_exenatide/models/modelica/Exenatide_Cirincione2017v2_iiv.json`
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_exenatide/Exenatide_Cirincione2017v2_iiv/Exenatide_Cirincione2017v2_iiv_matlab.zip" download>Exenatide_Cirincione2017v2_iiv_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_exenatide/Exenatide_Cirincione2017v2_iiv/Exenatide_Cirincione2017v2_iiv_cellml.zip" download>Exenatide_Cirincione2017v2_iiv_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_exenatide/Exenatide_Cirincione2017v2_iiv/Exenatide_Cirincione2017v2_iiv.svg" alt="Exenatide_Cirincione2017v2_iiv diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Exenatide_Cirincione2017v2_iiv_params.json` · controls `Exenatide_Cirincione2017v2_iiv_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
