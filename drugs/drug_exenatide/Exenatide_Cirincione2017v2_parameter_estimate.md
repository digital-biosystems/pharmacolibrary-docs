...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl_int (l h −1 ) | `Q3` · CLint | 4.58 | l h −1 | not captured | [l] / [h] | not captured | exact (1.0) | bcp13135-tbl-0002:row1:col1 | — | not captured |
| K m (pg ml −1 ) | `Q1` · Km | 567 | pg ml −1 | not captured | [pg] / [ml] | not captured | llm (0.6) | bcp13135-tbl-0002:row5:col1 | — | not captured |
| V max (μg h −1 ) | `Q66` · Vmax | 1.55 | μg h −1 | not captured | [µg] / [h] | not captured | llm (0.6) | bcp13135-tbl-0002:row6:col1 | — | not captured |
| V p (l) | `Q65` · Vss | 7.04 | l | 0.00704 | [l] | not captured | llm (0.6) | bcp13135-tbl-0002:row7:col1, bcp13135-tbl-0002:row11:col1 | — | not captured |
| Vc_int (l) | `Q61` · V | 7.03 | l | 0.007030000000000001 | [l] | not captured | llm (0.6) | bcp13135-tbl-0002:row8:col1 | — | not captured |
| Vc_wtkg | `Q352` · Vnorm | 2.67 | unit | not captured | [unit] | not captured | llm (0.6) | bcp13135-tbl-0002:row9:col1 | — | not captured |
| F | `Q40` · Fab | 1 | not captured | not captured | not captured | not captured | exact (1.0) | bcp13135-tbl-0002:row15:col1 | — | not captured |
| fr | `Q43` · FR | 0.628 | not captured | not captured | not captured | not captured | exact (1.0) | bcp13135-tbl-0002:row16:col1 | — | not captured |
