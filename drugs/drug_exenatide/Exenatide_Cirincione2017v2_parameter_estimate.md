...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl_int (l h −1 ) | `Q3` · CLint | —(suppressed) | l h −1 | — | [l] / [h] | not captured | exact (1.0) | bcp13135-tbl-0002:row1:col1 | — | not captured |
| K m (pg ml −1 ) | `Q1` · Km | —(suppressed) | pg ml −1 | — | [pg] / [ml] | not captured | llm (0.6) | bcp13135-tbl-0002:row5:col1 | — | not captured |
| V max (μg h −1 ) | `Q66` · Vmax | —(suppressed) | μg h −1 | — | [µg] / [h] | not captured | llm (0.6) | bcp13135-tbl-0002:row6:col1 | — | not captured |
| V p (l) | `Q65` · Vss | —(suppressed) | l | — | [l] | not captured | llm (0.6) | bcp13135-tbl-0002:row7:col1, bcp13135-tbl-0002:row11:col1 | — | not captured |
| Vc_int (l) | `Q61` · V | —(suppressed) | l | — | [l] | not captured | llm (0.6) | bcp13135-tbl-0002:row8:col1 | — | not captured |
| Vc_wtkg | `Q352` · Vnorm | —(suppressed) | unit | — | [unit] | not captured | llm (0.6) | bcp13135-tbl-0002:row9:col1 | — | not captured |
| F | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | bcp13135-tbl-0002:row15:col1 | — | not captured |
| fr | `Q43` · FR | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | bcp13135-tbl-0002:row16:col1 | — | not captured |
| ka | `Q49` · kabs | —(suppressed) | h-1 | — | 1/h | not captured | review_gapfill (0.7) | Choi_2025:review | — | not captured |
...
|---|---|---|---|
| Cl = Cl_int ⋅eGFR80 Cl_eGFR | Q22 | not captured | llm_confirmed |
...
- dropped unlinked row (NIL): 'Cl_eGFR' — extend the ontology if this is a real PK parameter (source ['bcp13135-tbl-0002:row2:col1'])
- unit_dimension_mismatch: 'Cl = Cl_int ⋅eGFR80 Cl_eGFR' → Q22 (unit '[luminosity] / [length] ** 2' vs ontology '[length] ** 3 / [time]') — route to review
- dropped duplicate Q22 ('Cl d (l h −1 )', value '3.72') — already have one for this compound
...
- dropped unlinked row (NIL): 'k a_max (μg h −1 )' — extend the ontology if this is a real PK parameter (source ['bcp13135-tbl-0002:row12:col1'])
...
- dropped unlinked row (NIL): 'Study 1' — extend the ontology if this is a real PK parameter (source ['bcp13135-tbl-0002:row18:col1'])
- dropped unlinked row (NIL): 'Study 5' — extend the ontology if this is a real PK parameter (source ['bcp13135-tbl-0002:row19:col1'])
- dropped unlinked row (NIL): 'All other studies' — extend the ontology if this is a real PK parameter (source ['bcp13135-tbl-0002:row20:col1'])
...
- population split: 'parameter estimate' subgroup of Cirincione_2017_2 (paper reports 2 populations: iiv(%), parameter estimate)
...
| C5_dimension_Q1 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['bcp13135-tbl-0002:row5:col1'] |
| C5_dimension_Q22 | fail | [luminosity] / [length] ** 2 | unit | not captured | not captured | ['bcp13135-tbl-0002:row3:col1'] |
| C5_dimension_Q3 | fail | [length] ** 3 / [time] | l h −1 | not captured | not captured | ['bcp13135-tbl-0002:row1:col1'] |
| C5_dimension_Q352 | fail | [luminosity] / [length] ** 2 | unit | not captured | not captured | ['bcp13135-tbl-0002:row9:col1'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Choi_2025:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['bcp13135-tbl-0002:row8:col1'] |
| C5_dimension_Q63 | fail | [luminosity] / [length] ** 2 | unit | not captured | not captured | ['bcp13135-tbl-0002:row10:col1'] |
| C5_dimension_Q65 | pass | [length] ** 3 | not captured | not captured | not captured | ['bcp13135-tbl-0002:row7:col1', 'bcp13135-tbl-0002:row11:col1'] |
| C5_dimension_Q66 | fail | [mass] / [time] | μg h −1 | not captured | not captured | ['bcp13135-tbl-0002:row6:col1'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q61 | pass | volume within physiological range | 7.03 L | not captured | not captured | ['bcp13135-tbl-0002:row8:col1'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_exenatide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Cirincione_2017_2` / `Cirincione_2017_2::parameter_estimate`)
