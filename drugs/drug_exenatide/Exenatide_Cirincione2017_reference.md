...
|---|---|---|---|---|---|---|---|---|---|---|
| CL int (L/day) | `Q22` · CL | —(suppressed) | L/day | — | L/h | not captured | review (0.7) | Cirincione_2017:review | — | not captured |
| V cint (L) | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Cirincione_2017:review | — | not captured |
