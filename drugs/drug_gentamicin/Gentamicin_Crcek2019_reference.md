...
## Model component
<dbs-pgx drug="gentamicin" model-id="Gentamicin_Crcek2019_reference" status="not_modelled" stale="false" population="paediatric patients" measured-compound="gentamicin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl (L/h/kg) | `Q22` · CL | —(suppressed) | L/h/kg | — | L/h | not captured | exact (1.0) | Crcek_2019:other_prose | — | not captured |
| Vd (L/kg) | `Q61` · V | —(suppressed) | L/kg | — | L | not captured | exact (1.0) | Crcek_2019:other_prose | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_gentamicin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Crcek_2019` / `Crcek_2019::paediatric patients`)
