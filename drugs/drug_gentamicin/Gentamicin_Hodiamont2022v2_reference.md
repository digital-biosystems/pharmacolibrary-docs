...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[volume of distribution]` (not captured vs 19.5) — a structural parameter, so the record is disputed.
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[volume of distribution]` | not captured | 19.5 | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_gentamicin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Hodiamont_2022_2` / `Hodiamont_2022_2::reference`)
