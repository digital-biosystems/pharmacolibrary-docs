...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[the elimination half-life (t1/2)beta]` (not captured vs not captured) and 1 more field(s) — not a structural parameter.
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[the elimination half-life (t1/2)beta]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[the volume of distribution (vd)beta]` | not captured | not captured | only_one_extracted |
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-21 04:49 UTC</sub>
