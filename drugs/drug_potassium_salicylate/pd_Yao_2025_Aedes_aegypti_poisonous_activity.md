...
## Citation
Yao H; Liu Y; Liu X; Zhou J; Deng Q; Huang J et al. (2025). Plants (Basel, Switzerland) 14
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | methyl salicylate | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 0.02 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.24 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 3.29 | not captured | only_one_extracted |
