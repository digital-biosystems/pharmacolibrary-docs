...
# inhibition rate — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.625). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | phenazine-1-carboxylic acid ester conjugates | hydroxybenzoic acid ester conjugates (e.g., compound 5c) | mismatch |
| `gpt-oss:120b` | `model_family` | unknown | sigmoid_emax | mismatch |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 5.08 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q344]` | not captured | 4.37 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q344]` | not captured | 3.84 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q344]` | not captured | 4.42 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 0.37 | only_one_extracted |
