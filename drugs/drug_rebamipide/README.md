...
- **PubMed hits:** 89 matched, 96 returned
...
| `Cho_2009.pdf` | Cho HY et al., Pharmacokinetics and bioequivalence of…, Clinical therapeutics (2009) | pgx | 8 | [10.1016/j.clinthera.2009.11.010](https://doi.org/10.1016/j.clinthera.2009.11.010) | [20110013](https://www.ncbi.nlm.nih.gov/pubmed/20110013) | metadata signals extractable PGX data (ABCB1, PK/PD-context) |

<sub>queue written 2026-09-10T21:34:01.840275+00:00</sub>
...
| popPK | Fang_2026 | irrelevant | 0 | 0 | The paper focuses on the formulation and therapeutic efficacy of rebamipide for diabetic keratopathy, with no report of quantitative pharmacokinetic parameters such as clearance, volume, or half-life. |
| popPK | Feng_2025 | irrelevant | 1 | 1 | The paper is a mechanistic study on hair regeneration and only cites general pharmacokinetic properties (Tmax, half-life, bioavailability) from a reference without reporting original quantitative disposition parameters or compartmental models. |
...
| popPK | Ivashkin_2020 | irrelevant | 0 | 0 | The paper is a clinical review of rebamipide's efficacy in GERD and contains no pharmacokinetic data or disposition parameters. |
...
| popPK | Jhun_2022 | irrelevant | 0 | 0 | The paper is a mechanistic study on obesity and immune regulation, reporting no pharmacokinetic parameters (CL, V, ka, etc.) for rebamipide. |
| popPK | Jin_2022 | relevant | 8 | 0 | The paper describes an in vivo pharmacokinetic study of rebamipide in beagle dogs, but the provided evidence contains only qualitative descriptions and no numeric PK parameter values. |
...
| popPK | Kako_2024 | irrelevant | 0 | 0 | The paper is an analytical method validation study for HPLC quantification of rebamipide in ethosomes, reporting no pharmacokinetic parameters such as clearance, volume, or half-life. |
...
| popPK | Kawano_1991 | irrelevant | 1 | 0 | The study focuses on gastric mucosal protection and blood flow dynamics rather than pharmacokinetic disposition parameters (CL, V, t1/2), and while plasma concentrations are mentioned, no quantitative PK values are provided in the evidence. |
| popPK | Ki_2018 | irrelevant | 0 | 0 | The paper investigates the pharmacodynamics of end-tidal carbon dioxide on cerebral oxygen saturation and does not involve rebamipide or its pharmacokinetics. |
...
| popPK | Kim_2017 | irrelevant | 2 | 0 | The paper focuses on formulation development (microemulsions) and bioavailability enhancement without reporting specific quantitative pharmacokinetic parameters (CL, V, ka) for rebamipide in the provided evidence. |
...
| popPK | Ko_2021 | relevant | 8 | 2 | The study reports pharmacokinetics in rats for rebamipide, but the specific numeric parameter values (AUC, Cmax, etc.) are not present in the provided evidence text. |
...
| popPK | Markovic_2020 | relevant | 8 | 0 | The paper describes a physiologically-based pharmacokinetic (PBPK) study of rebamipide, but the specific quantitative parameter values (CL, V, etc.) are not present in the provided abstract/evidence. |
...
| popPK | Oka_1991 | irrelevant | 0 | 0 | The study is a pharmacological investigation of ulcer protection mechanisms in rats and does not report any pharmacokinetic parameters for rebamipide. |
...
| popPK | Pradhan_2015 | relevant | 8 | 2 | The study reports a pharmacokinetic comparison in rats showing higher AUC and Cmax for the solid dispersion formulation, but specific numeric PK parameter values (like CL, V, or t1/2) are not present in the provided evidence. |
...
| popPK | Shimoyama_2002 | irrelevant | 0 | 0 | The evidence contains only the drug name with no pharmacokinetic data, study details, or numeric parameters. |
...
| popPK | Suzuki_1994 | irrelevant | 0 | 0 | The study is an in-vitro mechanistic investigation of rebamipide's effect on gastric mucosal cell injury and does not report any pharmacokinetic parameters. |
...
| popPK | Urita_2009 | irrelevant | 0 | 0 | The study investigates the effect of rebamipide on pilocarpine-induced salivation in rats and does not report any pharmacokinetic parameters (e.g., clearance, volume, half-life) for rebamipide. |
...
| popPK | Yamasaki_1987 | irrelevant | 0 | 0 | The study focuses on the pharmacodynamic effects of OPC-12759 (a different drug) on gastric mucosal protection and secretion, with no pharmacokinetic parameters reported for rebamipide. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_rebamipide`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
