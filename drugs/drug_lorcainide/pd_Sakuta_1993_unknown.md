...
# Y-26763-induced K+ current — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | clofilium | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | 57.5 | not captured | only_one_extracted |
...
---
<sub>← back to [lorcainide](drugs/drug_lorcainide/)</sub>
