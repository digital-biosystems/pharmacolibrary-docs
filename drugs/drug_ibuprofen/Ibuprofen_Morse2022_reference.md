...
|---|---|---|---|---|---|---|---|---|---|---|
| factor for fat (FFAT) on CL | `Q22` · CL | 0.816 | not captured | not captured | L/h | not captured | boundary (0.8) | Morse_2022:results_prose | — | not captured |
| lag time on the tablet formulation increased ... under fed conditions | `Q83` · tlag | 4.6 | fold | not captured | fold | not captured | boundary (0.8) | Morse_2022:results_prose | — | not captured |
...
- salvaged Q22 ('factor for fat (FFAT) on CL'=0.816) from results prose — parameter table was unreadable
- salvaged Q83 ('lag time on the tablet formulation increased ... under fed conditions'=4.6) from results prose — parameter table was unreadable
...
|---|---|---|---|
| `gpt-5.6-luna` | not confirmed | 0.25 (2/8 fields) | 6 |

<details><summary>6 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-5.6-luna` | `parameters[factor for fat (ffat) on cl]` | 0.816 | not captured | only_one_extracted |
| `gpt-5.6-luna` | `parameters[first-order absorption rate constant]` | 1.1 | not captured | only_one_extracted |
| `gpt-5.6-luna` | `parameters[lag time on the tablet formulation increased ... under fed conditions]` | 4.6 | not captured | only_one_extracted |
| `gpt-5.6-luna` | `parameters[v,,]` | 22.37 | not captured | only_one_extracted |
| `gpt-5.6-luna` | `screen.dose_compound` | acetaminophen, ibuprofen | acetaminophen and ibuprofen | mismatch |
| `gpt-5.6-luna` | `screen.primary_analyte` | acetaminophen, ibuprofen | acetaminophen and ibuprofen | mismatch |
...
| C5_unit_missing_Q83 | fail | [time] | fold | not captured | not captured | ['Morse_2022:results_prose'] |
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-07-15 06:33 UTC</sub>
