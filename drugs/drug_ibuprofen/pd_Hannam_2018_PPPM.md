...
# Pain Score — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.5). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | acetaminophen, ibuprofen, tramadol | acetaminophen \| ibuprofen \| tramadol | mismatch |
| `gpt-oss:120b` | `model_family` | effect_compartment | sigmoid_emax | mismatch |
