...
Clissold SP; Beresford R et al. (1987). Drugs 33
  ·  DOI: [10.2165/00003495-198733050-00004](https://doi.org/10.2165/00003495-198733050-00004)

## Model component
<dbs-pgx drug="ibuprofen" model-id="Ibuprofen_Clissold1987_reference" status="curated_candidate" stale="false" population="patients with rheumatic diseases and pain states" measured-compound="ibuprofen" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| total body clearance of proquazone | `Q22` · CL | 40.0 | L/h | 1.1111111111111112e-05 | L/h | not captured | review (0.7) | Clissold_1987:review | — | not captured |
| mean apparent volume of distribution | `Q76` · V/F | 10.8 | L | 0.0108 | L | not captured | review (0.7) | Clissold_1987:review | — | not captured |
...
- built from REVIEW reference values (Clissold_1987) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Clissold_1987:review'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Clissold_1987:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 40.0 | not captured | not captured | ['Clissold_1987:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 40 L/h | not captured | not captured | ['Clissold_1987:review'] |
| C9_phys_window_Q76 | pass | volume within physiological range | 10.8 L | not captured | not captured | ['Clissold_1987:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_ibuprofen/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Clissold_1987` / `Clissold_1987::reference`)
- model: `../../../knowledgebase/drugs/drug_ibuprofen/models/modelica/Ibuprofen_Clissold1987_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_ibuprofen/models/modelica/Ibuprofen_Clissold1987_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_ibuprofen/models/modelica/Ibuprofen_Clissold1987_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_ibuprofen/Ibuprofen_Clissold1987_reference/Ibuprofen_Clissold1987_reference_modelica.zip" download>Ibuprofen_Clissold1987_reference_modelica.zip</a> <span class="pk-size">(3.2 kB)</span></td></tr>
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_ibuprofen/Ibuprofen_Clissold1987_reference/Ibuprofen_Clissold1987_reference_matlab.zip" download>Ibuprofen_Clissold1987_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_ibuprofen/Ibuprofen_Clissold1987_reference/Ibuprofen_Clissold1987_reference_matlab_simbio.zip" download>Ibuprofen_Clissold1987_reference_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_ibuprofen/Ibuprofen_Clissold1987_reference/Ibuprofen_Clissold1987_reference.svg" alt="Ibuprofen_Clissold1987_reference diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-17 07:58 UTC</sub>
