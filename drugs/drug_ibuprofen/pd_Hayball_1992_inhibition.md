...
# percentage inhibition of TXB2 generation — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Hayball PJ; Nation RL; Bochner F et al. (1992). Chirality 4
  ·  DOI: [10.1002/chir.530040805](https://doi.org/10.1002/chir.530040805)
...
|---|---|---|---|
| `driver_compound` | (S)-ketoprofen | not captured | mismatch |
