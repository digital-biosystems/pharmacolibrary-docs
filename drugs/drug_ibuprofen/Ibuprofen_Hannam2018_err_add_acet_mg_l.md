...
## Model component
<dbs-pgx drug="ibuprofen" model-id="Ibuprofen_Hannam2018_err_add_acet_mg_l" status="extracted" stale="false" population="children undergoing adenotonsillectomy" measured-compound="acetaminophen, ibuprofen, tramadol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- population split: 'err_add, acet (mg/l)' subgroup of Hannam_2018 (paper reports 9 populations: cl_acet (l/h.70 kg^-1), cl_ibu (l/h.70 kg^-1), err_add, acet (mg/l), err_add, ibu (mg/l), t_absacet (h), t_absibu (h), t_abstram (h), v_acet (l.70 kg^-1), v_ibu (l.70 kg^-1))
...
- scholar stages: `../../../knowledgebase/drugs/drug_ibuprofen/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Hannam_2018` / `Hannam_2018::err_add_acet_mg_l`)
