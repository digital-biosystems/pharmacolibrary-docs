...
# temperature decrement — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Kauffman RE; Nelson MV et al. (1992). The Journal of pediatrics 121
  ·  DOI: [10.1016/s0022-3476(05)80354-3](https://doi.org/10.1016/s0022-3476(05)80354-3)
...
|---|---|---|---|
| `driver_compound` | ibuprofen | not captured | mismatch |
