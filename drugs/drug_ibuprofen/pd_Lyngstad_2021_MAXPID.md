...
# maximum pain intensity difference — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.278 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.278 (5/18 fields) · the first reading is what this page shows
...
| `parameters[Q38]` | not captured | 0 | only_one_extracted |
| `parameters[Q38]` | not captured | 0 | only_one_extracted |
| `parameters[Q71]` | not captured | 3.0 | only_one_extracted |
| `parameters[Q71]` | not captured | 1.9 | only_one_extracted |
| `parameters[Q71]` | not captured | 1.8 | only_one_extracted |
