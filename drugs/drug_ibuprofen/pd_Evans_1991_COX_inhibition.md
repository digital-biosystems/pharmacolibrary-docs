...
# platelet cyclo-oxygenase inhibition — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | S(+)-ibuprofen | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q100]` | 5.32 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 7.13 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 7.06 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 5.56 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 6.27 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0.96 | not captured | only_one_extracted |
