...
# platelet cyclo-oxygenase inhibition — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Evans AM; Nation RL; Sansom LN; Bochner F; Somogyi AA et al. (1991). British journal of clinical pharmacology 31
...
|---|---|---|---|
| `driver_compound` | S(+)-ibuprofen | not captured | mismatch |
...
| `parameters[Q100]` | 5.32 | not captured | only_one_extracted |
| `parameters[Q100]` | 7.13 | not captured | only_one_extracted |
| `parameters[Q100]` | 7.06 | not captured | only_one_extracted |
| `parameters[Q100]` | 5.56 | not captured | only_one_extracted |
| `parameters[Q100]` | 6.27 | not captured | only_one_extracted |
| `parameters[Q100]` | 0.96 | not captured | only_one_extracted |
