...
> ## <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.429 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.429 (3/7 fields) · the first reading is what this page shows

<details><summary>4 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[k21].value` | 0.318 | 60 | mismatch |
| `parameters[kel = θ1 × e (age -26.6) × θ2].value` | 0.0272 | 109 | mismatch |
| `parameters[v].value` | 183 | 101 | mismatch |
| `screen.primary_analyte` | R-ibuprofen | R-ibuprofen and S-ibuprofen | mismatch |
...
| C9_phys_window_Q61 | pass | volume within physiological range | 4.34 L | not captured | not captured | ['Gregoire_2004:other_prose'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_ibuprofen/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Gregoire_2004` / `Gregoire_2004::reference`)
