...
# visual analogue pain score — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.375 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Grennan DM; Aarons L; Siddiqui M; Richards M; Thompson R; Higham C et al. (1983). British journal of clinical pharmacology 15
  ·  DOI: [10.1111/j.1365-2125.1983.tb01504.x](https://doi.org/10.1111/j.1365-2125.1983.tb01504.x)
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.375 (3/8 fields) · the first reading is what this page shows
...
| `parameters[Q321]` | not captured | 600 | only_one_extracted |
| `parameters[Q38]` | not captured | 400 | only_one_extracted |
| `parameters[Q38]` | not captured | 18.2 | only_one_extracted |
| `parameters[Q38]` | not captured | 58.3 | only_one_extracted |
