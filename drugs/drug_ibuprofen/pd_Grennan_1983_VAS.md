...
# visual analogue pain score — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.429). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 600 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 18.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 58.3 | only_one_extracted |
