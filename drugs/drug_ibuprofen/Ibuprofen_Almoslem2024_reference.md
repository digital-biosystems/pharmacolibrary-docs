...
> ## <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-5.6-luna (not confirmed, agreement 0.333). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-5.6-luna` | not confirmed | 0.333 (2/6 fields) | 4 |
...
| `gpt-5.6-luna` | `screen.dose_compound` | acetaminophen, ibuprofen | ibuprofen and acetaminophen | mismatch |
| `gpt-5.6-luna` | `screen.primary_analyte` | acetaminophen, ibuprofen | ibuprofen and acetaminophen | mismatch |
