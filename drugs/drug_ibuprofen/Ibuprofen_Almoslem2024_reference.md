...
Almoslem M; Shah SD; Vozmediano V; Guzy S; Kim S; Hudak ML; et al. et al. (2024). Journal of clinical pharmacology 64
  ·  DOI: [10.1002/jcph.2386](https://doi.org/10.1002/jcph.2386)

## Model component
<dbs-pgx drug="ibuprofen" model-id="Ibuprofen_Almoslem2024_reference" status="rejected" stale="false" population="preterm neonates less than 29 weeks gestation" measured-compound="acetaminophen, ibuprofen" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|
| `screen.dose_compound` | acetaminophen, ibuprofen | ibuprofen, acetaminophen | mismatch |
| `screen.primary_analyte` | acetaminophen, ibuprofen | ibuprofen, acetaminophen | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_ibuprofen/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Almoslem_2024` / `Almoslem_2024::reference`)
