...
# ductus arteriosus diameter — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.667 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.667 (4/6 fields) · the first reading is what this page shows

<details><summary>2 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[Q38]` | not captured | 0.81 | only_one_extracted |
| `parameters[Q38]` | not captured | 0.22 | only_one_extracted |
