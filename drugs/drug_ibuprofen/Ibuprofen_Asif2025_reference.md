...
> ## <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-5.6-luna (not confirmed, agreement 0.444). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-5.6-luna` | not confirmed | 0.444 (4/9 fields) | 5 |

<details><summary>5 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-5.6-luna` | `parameters[auc0‐24 h].parameter_id` | Q19 | Q88 | mismatch |
| `gpt-5.6-luna` | `parameters[auc0‐72 h]` | not captured | 1529 | only_one_extracted |
...
| `gpt-5.6-luna` | `screen.primary_analyte` | ibuprofen | R- and S-ibuprofen | mismatch |
