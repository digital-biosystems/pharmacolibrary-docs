...
|---|---|---|---|---|---|---|---|---|---|---|
| Geometric mean (range) volume of distribution at steady state | `Q65` · Vss | 0.16 | L/kg | 0.011200000000000002 | [l] / [kg] | not captured | llm_corrected (0.6) | DeGraves_1993:abstract, DeGraves_1993:abstract | — | not captured |
