...
|---|---|---|---|---|---|---|---|---|---|---|
| Geometric mean (range) volume of distribution at steady state | `Q65` · Vss | —(suppressed) | L/kg | — | [l] / [kg] | not captured | llm_corrected (0.6) | DeGraves_1993:abstract, DeGraves_1993:abstract | — | not captured |
| terminal half-life | `Q57` · t1/2z | —(suppressed) | hours | — | [h] | not captured | llm (0.6) | DeGraves_1993:abstract, DeGraves_1993:abstract | — | not captured |
| bioavailability | `Q40` · Fab | —(suppressed) | % | — | not captured | not captured | exact (1.0) | DeGraves_1993:abstract, DeGraves_1993:abstract | — | not captured |
