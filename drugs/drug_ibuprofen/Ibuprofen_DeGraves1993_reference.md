...
## Model component
<dbs-pgx drug="ibuprofen" model-id="Ibuprofen_DeGraves1993_reference" status="rejected" stale="false" population="lactating dairy goats" measured-compound="ibuprofen" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.5 (4/8 fields) · the first reading is what this page shows

<details><summary>4 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `model.bioavailability.theta` | 90.8 | not captured | only_one_extracted |
| `parameters[bioavailability]` | 90.8 | not captured | only_one_extracted |
| `parameters[terminal half-life]` | 1.08 | not captured | only_one_extracted |
| `parameters[volume of distribution at steady state]` | 0.16 | not captured | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_ibuprofen/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `DeGraves_1993` / `DeGraves_1993::reference`)
