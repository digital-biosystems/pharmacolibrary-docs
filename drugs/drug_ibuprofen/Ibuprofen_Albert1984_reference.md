...
|---|---|---|---|
| `model.links` | [['sulindac', 'sulindac sulfide', 'metabolism'], ['sulindac', 'sulindac sulfone', 'metabolism']] | [] | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_ibuprofen/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Albert_1984` / `Albert_1984::reference`)
