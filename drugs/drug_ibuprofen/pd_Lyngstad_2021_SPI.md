...
# sum pain intensity over 6 h — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.278 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
| `parameters[Q40]` | not captured | 6 | only_one_extracted |
| `parameters[Q40]` | not captured | 8 | only_one_extracted |
| `parameters[Q40]` | not captured | 8 | only_one_extracted |
| `parameters[Q71]` | not captured | 2.4 | only_one_extracted |
