...
# sum pain intensity over 6 h — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.278). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q40]` | not captured | 6 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | not captured | 8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | not captured | 8 | only_one_extracted |
