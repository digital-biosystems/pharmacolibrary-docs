...
|---|---|---|---|---|---|---|---|---|---|---|
| kₐ,susp (h⁻¹) | `Q49` · kabs | —(suppressed) | h⁻¹ | — | [1] / [h] | not captured | llm_confirmed (0.6) | Trocóniz_2000_table_p6_1:row0:col1, Trocóniz_2000_table_p6_1:row0:col2 | — | not captured |
| tₗag (h) | `Q83` · tlag | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Trocóniz_2000_table_p6_1:row3:col1, Trocóniz_2000_table_p6_1:row3:col2 | — | not captured |
| F₁ | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Trocóniz_2000_table_p6_1:row4:col1, Trocóniz_2000_table_p6_1:row4:col2 | — | not captured |
| V1 (L)ᵇ | `Q63` · V1 | —(suppressed) | L | — | [l] | not captured | llm_confirmed (0.6) | Trocóniz_2000_table_p6_1:row5:col1 | — | not captured |
| CL (L/h)ᵇ | `Q23` · CLb | —(suppressed) | L/h | — | [l] / [h] | not captured | space_fold (0.95) | Trocóniz_2000_table_p6_1:row6:col1, Trocóniz_2000_table_p6_1:row6:col2 | — | not captured |
| CLd (L/h)ᵇ | `Q364` · Qd | —(suppressed) | L/h | — | [l] / [h] | not captured | llm_corrected (0.6) | Trocóniz_2000_table_p6_1:row7:col1, Trocóniz_2000_table_p6_1:row7:col2 | — | not captured |
| V2 (L)ᵇ | `Q64` · V2 | —(suppressed) | L | — | [l] | not captured | llm_confirmed (0.6) | Trocóniz_2000_table_p6_1:row8:col1, Trocóniz_2000_table_p6_1:row8:col2 | — | not captured |
