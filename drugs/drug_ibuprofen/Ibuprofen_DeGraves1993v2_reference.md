...
## Model component
<dbs-pgx drug="ibuprofen" model-id="Ibuprofen_DeGraves1993v2_reference" status="model_quarantined" stale="false" population="lactating dairy cows" measured-compound="ibuprofen" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Harmonic mean volume of distribution at steady state | `Q65` · Vss | —(suppressed) | L/kg | — | [l] / [kg] | not captured | llm_corrected (0.6) | DeGraves_1993_2:abstract | — | not captured |
| elimination half-life | `Q57` · t1/2z | —(suppressed) | hours | — | [h] | not captured | llm (0.6) | DeGraves_1993_2:abstract | — | not captured |
| total clearance | `Q22` · CL | —(suppressed) | ml/kg/h | — | [ml] / [[h] · [kg]] | not captured | exact (1.0) | DeGraves_1993_2:abstract | — | not captured |
| Harmonic mean oral bioavailability | `Q40` · Fab | —(suppressed) | % | — | not captured | not captured | llm_confirmed (0.6) | DeGraves_1993_2:abstract | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_ibuprofen/models/modelica/_needs_review/Ibuprofen_DeGraves1993v2_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_ibuprofen/models/modelica/_needs_review/Ibuprofen_DeGraves1993v2_reference.deviation.json`
