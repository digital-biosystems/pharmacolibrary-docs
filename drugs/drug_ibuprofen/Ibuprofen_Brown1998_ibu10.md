...
|---|---|---|---|---|---|---|---|---|---|---|
| t_lag (hr) x̄ | `Q83` · tlag | —(suppressed) | hr | — | [h] | not captured | exact (1.0) | Brown_1998_table_3:row0:col3 | — | not captured |
| k_a (hr⁻¹) x̄ | `Q49` · kabs | —(suppressed) | hr⁻¹ | — | [1] / [h] | not captured | exact (1.0) | Brown_1998_table_3:row2:col3 | — | not captured |
| β (hr⁻¹) x̄ | `Q47` · kel | —(suppressed) | hr⁻¹ | — | [1] / [h] | not captured | exact (1.0) | Brown_1998_table_3:row4:col3 | — | not captured |
| T₁/₂ (hr) x̄ | `Q57` · t1/2z | —(suppressed) | hr | — | [h] | not captured | exact (1.0) | Brown_1998_table_3:row6:col3 | — | not captured |
| AUC₀→∞ (µg/ml*hr) x̄ | `Q17` · AUC∞ | —(suppressed) | µg/ml*hr | — | [µg] / [[h] · [ml]] | not captured | exact (1.0) | Brown_1998_table_4:row0:col3 | — | not captured |
| V_d/F (L/kg) x̄ | `Q76` · V/F | —(suppressed) | L/kg | — | [l] / [kg] | not captured | exact (1.0) | Brown_1998_table_4:row2:col3 | — | not captured |
| Cl_p/F (L/kg/hr) x̄ | `Q27` · CL/F | —(suppressed) | L/kg/hr | — | [l] / [[h] · [kg]] | not captured | exact (1.0) | Brown_1998_table_4:row4:col3 | — | not captured |
...
- dropped unlinked row (NIL): 't_lag (hr) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_3:row1:col3'])
- dropped unlinked row (NIL): 'k_a (hr⁻¹) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_3:row3:col3'])
...
- dropped unlinked row (NIL): 'V_d/F (L/kg) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_4:row3:col3'])
- dropped unlinked row (NIL): 'Cl_p/F (L/kg/hr) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_4:row5:col3'])
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_ibuprofen/Ibuprofen_Brown1998_ibu10/Ibuprofen_Brown1998_ibu10_modelica.zip" download>Ibuprofen_Brown1998_ibu10_modelica.zip</a> <span class="pk-size">(4.1 kB)</span></td></tr>
