...
## Model component
<dbs-pgx drug="ibuprofen" model-id="Ibuprofen_Brown1998_ibu10" status="rejected" stale="false" population="febrile children" measured-compound="ibuprofen" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| tlag (hr) x̄ | `Q83` · tlag | 0.29 | hr | 1044.0 | [h] | not captured | exact (1.0) | Brown_1998_table_3:row0:col3 | — | not captured |
| ka (hr⁻¹) x̄ | `Q49` · kabs | 8.22 | hr⁻¹ | 0.0022833333333333334 | [1] / [h] | not captured | exact (1.0) | Brown_1998_table_3:row2:col3 | — | not captured |
| β (hr⁻¹) x̄ | `Q47` · kel | 0.57 | hr⁻¹ | 0.00015833333333333332 | [1] / [h] | not captured | exact (1.0) | Brown_1998_table_3:row4:col3 | — | not captured |
| T1/2 (hr) x̄ | `Q57` · t1/2z | 1.37 | hr | 4932.0 | [h] | not captured | exact (1.0) | Brown_1998_table_3:row6:col3 | — | not captured |
| AUC0-∞ (μg/ml·hr) x̄ | `Q17` · AUC∞ | 104.99 | μg/ml·hr | not captured | [µg] / [[h] · [ml]] | not captured | exact (1.0) | Brown_1998_table_4:row0:col3 | — | not captured |
| Va/F (L/kg) x̄ | `Q76` · V/F | 0.22 | L/kg | 0.0154 | [l] / [kg] | not captured | llm (0.6) | Brown_1998_table_4:row2:col3 | — | not captured |
| CLp/F (L/kg·hr) x̄ | `Q27` · CL/F | 0.11 | L/kg·hr | not captured | [l] / [[h] · [kg]] | not captured | special_case (0.95) | Brown_1998_table_4:row4:col3 | — | not captured |
...
- dropped unlinked row (NIL): 'ka (hr⁻¹) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_3:row3:col3'])
...
- dropped unlinked row (NIL): 'AUC0-∞ (μg/ml·hr) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_4:row1:col3'])
...
| C5_dimension_Q27 | fail | [length] ** 3 * [time] | L/kg·hr | not captured | not captured | ['Brown_1998_table_4:row4:col3'] |
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_ibuprofen/Ibuprofen_Brown1998_ibu10/Ibuprofen_Brown1998_ibu10_fmi.zip" download>Ibuprofen_Brown1998_ibu10_fmi.zip</a> <span class="pk-size">(4.1 kB)</span></td></tr>
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_ibuprofen/Ibuprofen_Brown1998_ibu10/Ibuprofen_Brown1998_ibu10_matlab.zip" download>Ibuprofen_Brown1998_ibu10_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
