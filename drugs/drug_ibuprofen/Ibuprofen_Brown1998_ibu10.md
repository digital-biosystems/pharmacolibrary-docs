...
**What is wrong:** the simulated model does not reproduce a value the paper reports. Evidence: T1_t_half_terminal — expected 1.82 — got 1.360339175098173 — ratio 0.7474; T1_t_half_terminal — expected 1.83 — got 1.360339175098173 — ratio 0.7434; T1_t_half_terminal — expected 2.15 — got 1.360339175098173 — ratio 0.6327.
...
|---|---|---|---|---|---|---|---|---|---|---|
| tlag (hr) x̄ | `Q83` · tlag | —(suppressed) | hr | — | [h] | not captured | exact (1.0) | Brown_1998_table_3:row0:col3 | — | not captured |
| ka (hr-1) x̄ | `Q49` · kabs | —(suppressed) | hr-1 | — | [1] / [h] | not captured | exact (1.0) | Brown_1998_table_3:row2:col3 | — | not captured |
| β (hr-1) x̄ | `Q47` · kel | —(suppressed) | hr-1 | — | [1] / [h] | not captured | exact (1.0) | Brown_1998_table_3:row4:col3 | — | not captured |
| T1/2 (hr) x̄ | `Q57` · t1/2z | —(suppressed) | hr | — | [h] | not captured | exact (1.0) | Brown_1998_table_3:row6:col3 | — | not captured |
| AUC0→∞ (µg/ml*hr) x̄ | `Q17` · AUC∞ | —(suppressed) | µg/ml*hr | — | [µg] / [[h] · [ml]] | not captured | exact (1.0) | Brown_1998_table_4:row0:col3 | — | not captured |
| Va/F (L/kg) x̄ | `Q76` · V/F | —(suppressed) | L/kg | — | [l] / [kg] | not captured | llm (0.6) | Brown_1998_table_4:row2:col3 | — | not captured |
| CLp/F (L/kg/hr) x̄ | `Q27` · CL/F | —(suppressed) | L/kg/hr | — | [l] / [[h] · [kg]] | not captured | special_case (0.95) | Brown_1998_table_4:row4:col3 | — | not captured |
...
- dropped unlinked row (NIL): 'tlag (hr) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_3:row1:col3'])
- dropped unlinked row (NIL): 'ka (hr-1) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_3:row3:col3'])
- dropped unlinked row (NIL): 'β (hr-1) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_3:row5:col3'])
- dropped unlinked row (NIL): 'T1/2 (hr) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_3:row7:col3'])
...
- dropped unlinked row (NIL): 'AUC0→∞ (µg/ml*hr) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_4:row1:col3'])
- dropped unlinked row (NIL): 'Va/F (L/kg) SE' — extend the ontology if this is a real PK parameter (source ['Brown_1998_table_4:row3:col3'])
...
| C9_phys_window_Q76 | pass | volume within physiological range | 15.4 L | not captured | not captured | ['Brown_1998_table_4:row2:col3'] |
...
| T1_t_half_terminal | reference | fail | 1.82 | 1.360339175098173 | 0.7474 | hr→SI vs simulated h |
| T1_t_half_terminal | reference | pass | 1.44 | 1.360339175098173 | 0.9447 | hr→SI vs simulated h |
| T1_t_half_terminal | reference | pass | 1.37 | 1.360339175098173 | 0.9929 | hr→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 1.83 | 1.360339175098173 | 0.7434 | hr→SI vs simulated h |
| T1_t_half_terminal | reference | pass | 1.75 | 1.360339175098173 | 0.7773 | hr→SI vs simulated h |
| T1_t_half_terminal | reference | fail | 2.15 | 1.360339175098173 | 0.6327 | hr→SI vs simulated h |
...
- scholar stages: `../../../knowledgebase/drugs/drug_ibuprofen/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Brown_1998` / `Brown_1998::ibu10`)
- model: `../../../knowledgebase/drugs/drug_ibuprofen/models/modelica/Ibuprofen_Brown1998_ibu10.mo`
- deviation: `../../../knowledgebase/drugs/drug_ibuprofen/models/modelica/Ibuprofen_Brown1998_ibu10.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_ibuprofen/models/modelica/Ibuprofen_Brown1998_ibu10.json`
...
<img src="drugs/drug_ibuprofen/Ibuprofen_Brown1998_ibu10/Ibuprofen_Brown1998_ibu10.svg" alt="Ibuprofen_Brown1998_ibu10 diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_ibuprofen/Ibuprofen_Brown1998_ibu10/Ibuprofen_Brown1998_ibu10_modelica.zip" download>Ibuprofen_Brown1998_ibu10_modelica.zip</a> <span class="pk-size">(4.0 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_ibuprofen/Ibuprofen_Brown1998_ibu10/Ibuprofen_Brown1998_ibu10_matlab.zip" download>Ibuprofen_Brown1998_ibu10_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_ibuprofen/Ibuprofen_Brown1998_ibu10/Ibuprofen_Brown1998_ibu10_matlab_simbio.zip" download>Ibuprofen_Brown1998_ibu10_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
...
<sub>Template `PK_1C_enteral` · parameters `Ibuprofen_Brown1998_ibu10_params.json` · controls `Ibuprofen_Brown1998_ibu10_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
