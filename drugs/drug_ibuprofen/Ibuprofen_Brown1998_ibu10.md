...
> ## <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.917 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
| AUC0→∞ (µg/ml*hr) x̄ | `Q17` · AUC∞ | 104.99 | µg/ml*hr | not captured | [µg] / [[h] · [ml]] | not captured | exact (1.0) | Brown_1998_table_4:row0:col3 | — | not captured |
| Va/F (L/kg) x̄ | `Q353` · Vnorm/F | 0.22 | L/kg | 0.0154 | [l] / [kg] | not captured | llm (0.6) | Brown_1998_table_4:row2:col3 | — | not captured |
...
|---|---|---|---|
| `parameters[va/f].parameter_id` | Q353 | Q76 | mismatch |
...
| C5_dimension_Q353 | pass | [length] ** 3 | not captured | not captured | not captured | ['Brown_1998_table_4:row2:col3'] |
