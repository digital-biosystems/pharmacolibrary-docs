...
| AUC0→∞ (µg/ml*hr) x̄ | `Q17` · AUC∞ | 71.05 | µg/ml*hr | not captured | [µg] / [[h] · [ml]] | not captured | exact (1.0) | Brown_1998_table_4:row0:col2 | — | not captured |
| Va/F (L/kg) x̄ | `Q353` · Vnorm/F | 0.16 | L/kg | 0.011200000000000002 | [l] / [kg] | not captured | llm (0.6) | Brown_1998_table_4:row2:col2 | — | not captured |
| Clp/F (L/kg/hr) x̄ | `Q27` · CL/F | 0.08 | L/kg/hr | 1.5555555555555556e-06 | [l] / [[h] · [kg]] | not captured | special_case (0.95) | Brown_1998_table_4:row4:col2 | — | not captured |
...
| C5_dimension_Q353 | pass | [length] ** 3 | not captured | not captured | not captured | ['Brown_1998_table_4:row2:col2'] |
