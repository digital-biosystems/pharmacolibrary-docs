...
Burk M; Peters U et al. (1983). Clinical pharmacology and therapeutics 34
  ·  DOI: [10.1038/clpt.1983.176](https://doi.org/10.1038/clpt.1983.176)
...
|---|---|---|---|
| endogenous creatinine clearance | Q22 | not captured | llm_confirmed |

## Departures & gaps

**Interpretation flags:**
- unit_dimension_unknown: 'ml/min/1.73 m2' (CL)
- dropped unlinked row (NIL): 'r' — extend the ontology if this is a real PK parameter (source ['Burk_1983:abstract', 'Burk_1983:abstract', 'Burk_1983:abstract'])
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Burk_1983_metadata.yaml (4 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_disopyramide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Burk_1983` / `Burk_1983::reference`)
