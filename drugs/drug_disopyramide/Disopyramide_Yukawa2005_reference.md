...
## Model component
<dbs-pgx drug="disopyramide" model-id="Disopyramide_Yukawa2005_reference" status="model_quarantined" stale="false" population="Japanese patients" measured-compound="disopyramide" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Vd (L/kg) | `Q61` · V | —(suppressed) | L/kg | — | [l] / [kg] | not captured | exact (1.0) | Yukawa_2005:abstract | — | not captured |
| k(a) (h-1) | `Q49` · kabs | —(suppressed) | h-1 | — | [1] / [h] | not captured | exact (1.0) | Yukawa_2005:abstract | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_disopyramide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Yukawa_2005` / `Yukawa_2005::reference`)
- model: `../../../knowledgebase/drugs/drug_disopyramide/models/modelica/_needs_review/Disopyramide_Yukawa2005_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_disopyramide/models/modelica/_needs_review/Disopyramide_Yukawa2005_reference.deviation.json`
