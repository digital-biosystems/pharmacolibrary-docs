...
## Model component
<dbs-pgx drug="disopyramide" model-id="Disopyramide_Aso2001_r_dp" status="model_quarantined" stale="false" population="arrhythmia patients" measured-compound="disopyramide" parameterization="apparent" topology="parent_metabolite"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| ke (h-1) | `Q47` · kel | 0.0691 | h-1 | 1.9194444444444443e-05 | [1] / [h] | not captured | exact (1.0) | Aso_2001_table_4:row0:col3 | — | not captured |
| Vd/F (L) | `Q76` · V/F | 71.6 | L | 0.0716 | [l] | not captured | exact (1.0) | Aso_2001_table_4:row1:col3 | — | not captured |
| ωvd*1 (%) | `Q61` · V | 43.5 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | Aso_2001_table_4:row3:col3 | — | not captured |
...
- dropped unlinked row (NIL): 'Obj*2' — extend the ontology if this is a real PK parameter (source ['Aso_2001_table_4:row5:col3'])
- apparent-ness (ontology-grounded): parameterization=apparent, measured_compound=disopyramide
- topology: transfer parameter unlinked (Q100) — add Kfm/formation-rate/rate-constant to the ontology; routing to review
- status held at route_to_review — not promoted
- population split: 'r(–)-dp' subgroup of Aso_2001 (paper reports 6 populations: dp, r(–)-dp, r(–)-udp, s(+) -dp, s(+) -udp, udp)
...
| C5_dimension_Q47 | pass | 1 / [time] | not captured | not captured | not captured | ['Aso_2001_table_4:row0:col3'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Aso_2001_table_4:row1:col3'] |
...
- model: `../../../knowledgebase/drugs/drug_disopyramide/models/modelica/_needs_review/Disopyramide_Aso2001_r_dp.mo`
- deviation: `../../../knowledgebase/drugs/drug_disopyramide/models/modelica/_needs_review/Disopyramide_Aso2001_r_dp.deviation.json`
