...
|---|---|---|---|---|---|---|---|---|---|---|
| ke (h-1) | `Q47` · kel | —(suppressed) | h-1 | — | [1] / [h] | not captured | exact (1.0) | Aso_2001_table_4:row0:col3 | — | not captured |
| Vd/F (L) | `Q76` · V/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Aso_2001_table_4:row1:col3 | — | not captured |
| ωvd*1 (%) | `Q61` · V | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Aso_2001_table_4:row3:col3 | — | not captured |
