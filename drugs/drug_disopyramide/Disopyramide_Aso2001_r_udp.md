...
## Model component
<dbs-pgx drug="disopyramide" model-id="Disopyramide_Aso2001_r_udp" status="model_quarantined" stale="false" population="arrhythmia patients" measured-compound="disopyramide" parameterization="apparent" topology="parent_metabolite"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| ke (h-1) | `Q47` · kel | 0.0990 | h-1 | 2.75e-05 | [1] / [h] | not captured | exact (1.0) | Aso_2001_table_4:row0:col6 | — | not captured |
| Vd/F (L) | `Q76` · V/F | 161 | L | 0.161 | [l] | not captured | exact (1.0) | Aso_2001_table_4:row1:col6 | — | not captured |
| ωvd*1 (%) | `Q61` · V | 64.9 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | Aso_2001_table_4:row3:col6 | — | not captured |
...
- dropped unlinked row (NIL): 'Obj*2' — extend the ontology if this is a real PK parameter (source ['Aso_2001_table_4:row5:col6'])
- apparent-ness (ontology-grounded): parameterization=apparent, measured_compound=disopyramide
- topology: transfer parameter unlinked (Q100) — add Kfm/formation-rate/rate-constant to the ontology; routing to review
- status held at route_to_review — not promoted
- population split: 'r(–)-udp' subgroup of Aso_2001 (paper reports 6 populations: dp, r(–)-dp, r(–)-udp, s(+) -dp, s(+) -udp, udp)
...
| C5_dimension_Q47 | pass | 1 / [time] | not captured | not captured | not captured | ['Aso_2001_table_4:row0:col6'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Aso_2001_table_4:row1:col6'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q76 | pass | volume within physiological range | 161 L | not captured | not captured | ['Aso_2001_table_4:row1:col6'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_disopyramide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Aso_2001` / `Aso_2001::r_udp`)
- model: `../../../knowledgebase/drugs/drug_disopyramide/models/modelica/_needs_review/Disopyramide_Aso2001_r_udp.mo`
- deviation: `../../../knowledgebase/drugs/drug_disopyramide/models/modelica/_needs_review/Disopyramide_Aso2001_r_udp.deviation.json`
