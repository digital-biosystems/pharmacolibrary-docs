...
## Citation
Bryson SM; Whiting B; Lawrence JR et al. (1978). British journal of clinical pharmacology 6
  ·  DOI: [10.1111/j.1365-2125.1978.tb04605.x](https://doi.org/10.1111/j.1365-2125.1978.tb04605.x)

## Model component
<dbs-pgx drug="disopyramide" model-id="Disopyramide_Bryson1978_reference" status="curated_candidate" stale="false" population="healthy volunteers" measured-compound="disopyramide" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| total clearance | `Q22` · CL | 61.57 | ml/min | 1.0261666666666666e-06 | L/h | not captured | review (0.7) | Bryson_1978:review | — | not captured |
| V (derived from CL·t½/ln2) | `Q61` · V | 31.9776 | L | 0.031977624120312055 | L | not captured | review (0.7) | Bryson_1978:review | — | not captured |
...
- built from REVIEW reference values (Bryson_1978) — secondary source
...
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Bryson_1978:review'] |
...
| C9_phys_window_Q61 | pass | volume within physiological range | 32 L | not captured | not captured | ['Bryson_1978:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_disopyramide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Bryson_1978` / `Bryson_1978::reference`)
- model: `../../../knowledgebase/drugs/drug_disopyramide/models/modelica/Disopyramide_Bryson1978_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_disopyramide/models/modelica/Disopyramide_Bryson1978_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_disopyramide/models/modelica/Disopyramide_Bryson1978_reference.json`
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_disopyramide/Disopyramide_Bryson1978_reference/Disopyramide_Bryson1978_reference_matlab.zip" download>Disopyramide_Bryson1978_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_disopyramide/Disopyramide_Bryson1978_reference/Disopyramide_Bryson1978_reference_cellml.zip" download>Disopyramide_Bryson1978_reference_cellml.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_disopyramide/Disopyramide_Bryson1978_reference/Disopyramide_Bryson1978_reference.svg" alt="Disopyramide_Bryson1978_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_disopyramide/Disopyramide_Bryson1978_reference/Disopyramide_Bryson1978_reference_params.json" metaurl="assets/fmu/PK_1C.vr.json" wasmurl="assets/fmu/PK_1C.js" controlsurl="drugs/drug_disopyramide/Disopyramide_Bryson1978_reference/Disopyramide_Bryson1978_reference_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C` · parameters `Disopyramide_Bryson1978_reference_params.json` · controls `Disopyramide_Bryson1978_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
