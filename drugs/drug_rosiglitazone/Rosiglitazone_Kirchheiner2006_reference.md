...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Kirchheiner_2006_metadata.yaml (9 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_rosiglitazone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kirchheiner_2006` / `Kirchheiner_2006::reference`)
