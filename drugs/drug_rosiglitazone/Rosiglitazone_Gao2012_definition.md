...
- dropped unlinked row (NIL): 'I_0, ng/ml' — extend the ontology if this is a real PK parameter (source ['Gao_2012_table_3:row2:col1'])
- dropped unlinked row (NIL): 'G_0, mg/dl' — extend the ontology if this is a real PK parameter (source ['Gao_2012_table_3:row3:col1'])
- dropped unlinked row (NIL): 'ID_50wt, mg/kg' — extend the ontology if this is a real PK parameter (source ['Gao_2012_table_3:row15:col1'])
...
- population split: 'definition' subgroup of Gao_2012 (paper reports 2 populations: definition, estimate (cv%))
...
| `gpt-oss:120b` | `parameters[k a]` | 2.01 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[v/f]` | 342 | not captured | only_one_extracted |
| `gpt-oss:120b` | `screen.primary_analyte` | glucose | rosiglitazone | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_rosiglitazone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Gao_2012` / `Gao_2012::definition`)
