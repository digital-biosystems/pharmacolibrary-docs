...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-11 00:09 | 35:29 | 0/0/0 | 3/0/0 | 0/0/0 | 334,921/7,529 | ollama / qwen3.8:27b-mtp-q8_0 | 29 | 4/25 | 27/2 | 0 |
...
- **PubMed hits:** 247 matched, 95 returned
...
<sub>queue written 2026-09-11T00:03:37.284577+00:00</sub>
...
| popPK | Corona_2016 | irrelevant | 2 | 0 | The study investigates the bioavailability and metabolism of complex seaweed phlorotannin extracts (oligomers/polymers) rather than phloroglucinol as a specific subject drug, and it does not report quantitative compartmental PK parameters (CL, V, ka) for phloroglucinol. |
...
| popPK | Jiang_2022 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of DHEA (dehydroepiandrosterone) cocrystals, where phloroglucinol is used only as a coformer for crystal engineering, not as the subject drug for PK parameter extraction. |
...
| popPK | Rao_2013 | irrelevant | 0 | 0 | The paper describes the biotechnological production and purification of phloroglucinol in bacteria, not its pharmacokinetics in a biological host. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_phloroglucinol`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
