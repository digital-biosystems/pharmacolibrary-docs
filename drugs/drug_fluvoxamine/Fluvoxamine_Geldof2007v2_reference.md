...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[cl]` (25.1 vs not captured) and 2 more field(s) — a structural parameter, so the record is disputed.
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl]` | 25.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[q]` | 30.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[v]` | 256 | not captured | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluvoxamine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Geldof_2007_2` / `Geldof_2007_2::reference`)
