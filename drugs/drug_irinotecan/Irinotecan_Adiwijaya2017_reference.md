...
## Model component
<dbs-pgx drug="irinotecan" model-id="Irinotecan_Adiwijaya2017_reference" status="extracted" stale="false" population="patients with cancer" measured-compound="total irinotecan" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
