...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_metamizole/Metamizole_Stoschus2025_reference/Metamizole_Stoschus2025_reference_modelica.zip" download>Metamizole_Stoschus2025_reference_modelica.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_metamizole/Metamizole_Stoschus2025_reference/Metamizole_Stoschus2025_reference_matlab.zip" download>Metamizole_Stoschus2025_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_metamizole/Metamizole_Stoschus2025_reference/Metamizole_Stoschus2025_reference_matlab_simbio.zip" download>Metamizole_Stoschus2025_reference_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_metamizole/Metamizole_Stoschus2025_reference/Metamizole_Stoschus2025_reference_sbml.zip" download>Metamizole_Stoschus2025_reference_sbml.zip</a> <span class="pk-size">(2.4 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_metamizole/Metamizole_Stoschus2025_reference/Metamizole_Stoschus2025_reference_cellml.zip" download>Metamizole_Stoschus2025_reference_cellml.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
</tbody></table>
...
<dbs-fmusim paramsurl="drugs/drug_metamizole/Metamizole_Stoschus2025_reference/Metamizole_Stoschus2025_reference_params.json" metaurl="assets/fmu/PK_1C.vr.json" wasmurl="assets/fmu/PK_1C.js" controlsurl="drugs/drug_metamizole/Metamizole_Stoschus2025_reference/Metamizole_Stoschus2025_reference_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C` · parameters `Metamizole_Stoschus2025_reference_params.json` · controls `Metamizole_Stoschus2025_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
