...
## Model component
<dbs-pgx drug="Metamizole" model-id="Metamizole_Blaser2021_4_aa" status="curated_candidate" stale="false" population="healthy salt-depleted adults" measured-compound="4-methylaminoantipyrine" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax ratio MD/SD | `Q33` · Cmax_ratio | 2.22 | not captured | not captured | not captured | not captured | llm_corrected (0.6) | Blaser_2021_table_2:row9:col2 | — | not captured |
| AUC0-5h ratio MD/SD | `Q21` · AUC ratio | 3.24 | not captured | not captured | not captured | not captured | llm (0.6) | Blaser_2021_table_2:row11:col2 | — | not captured |
...
- column '4-aa' classified 'other' by the LLM but kept: the deterministic diagnostic-column test disagrees (a stratum column is a value column, not a statistic)
...
- population split: '4-aa' subgroup of Blaser_2021 (paper reports 6 populations: 4-aa, 4-aaa, 4-faa, 4-maa, metamizole (n = 8), naproxen (n = 7))
...
| T3_output_variable | not captured | pass | C_central (measured=4-methylaminoantipyrine) | C_central | not captured | output must be the measured/analyte compartment |
...
| T1_t_half_terminal | reference | pass | 5.5 | 6.700469904048642 | 1.2183 | h→SI vs simulated h |
...
- scholar stages: `../../../knowledgebase/drugs/drug_metamizole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Blaser_2021` / `Blaser_2021::4_aa`)
- model: `../../../knowledgebase/drugs/drug_metamizole/models/modelica/Metamizole_Blaser2021_4_aa.mo`
- deviation: `../../../knowledgebase/drugs/drug_metamizole/models/modelica/Metamizole_Blaser2021_4_aa.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_metamizole/models/modelica/Metamizole_Blaser2021_4_aa.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_metamizole/Metamizole_Blaser2021_4_aa/Metamizole_Blaser2021_4_aa_modelica.zip" download>Metamizole_Blaser2021_4_aa_modelica.zip</a> <span class="pk-size">(4.3 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_metamizole/Metamizole_Blaser2021_4_aa/Metamizole_Blaser2021_4_aa_fmi.zip" download>Metamizole_Blaser2021_4_aa_fmi.zip</a> <span class="pk-size">(1.2 MB)</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_metamizole/Metamizole_Blaser2021_4_aa/Metamizole_Blaser2021_4_aa_matlab.zip" download>Metamizole_Blaser2021_4_aa_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_metamizole/Metamizole_Blaser2021_4_aa/Metamizole_Blaser2021_4_aa_matlab_simbio.zip" download>Metamizole_Blaser2021_4_aa_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_metamizole/Metamizole_Blaser2021_4_aa/Metamizole_Blaser2021_4_aa_sbml.zip" download>Metamizole_Blaser2021_4_aa_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_metamizole/Metamizole_Blaser2021_4_aa/Metamizole_Blaser2021_4_aa_cellml.zip" download>Metamizole_Blaser2021_4_aa_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
