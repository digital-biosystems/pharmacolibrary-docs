...
|---|---|---|---|
| maximum plasma concentration | Q174 | not captured | llm |
| AUC0-infinity | Q17 | not captured | llm |
| total body clearance (Cl/F) | Q27 | not captured | llm_corrected |

## Departures & gaps

**Interpretation flags:**
- unit_dimension_unknown: 'ng/mL per mg/kg dose' (Cmax/dose)
- unit_dimension_unknown: 'ng*hour/mL per mg/kg dose' (AUC∞)
- unit_dimension_unknown: 'Cl/F' (CL/F)
- dropped unlinked row (NIL): 'Vss/F' — extend the ontology if this is a real PK parameter (source ['Abdel-Rahman_2004:abstract'])
- apparent-ness (ontology-grounded): parameterization=apparent, measured_compound=nizatidine
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Abdel-Rahman_2004_metadata.yaml (4 record(s)); values are summary statistics, not a fitted model
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-18 06:23 UTC</sub>
