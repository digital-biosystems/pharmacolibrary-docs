...
|---|---|---|---|---|---|---|---|---|---|---|
| V_pop | `Q61` · V | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab3:row1:col1 | — | not captured |
| CL_pop | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab3:row2:col1 | — | not captured |
