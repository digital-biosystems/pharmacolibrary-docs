...
## Model component
<dbs-pgx drug="magnesium sulfate" model-id="MagnesiumSulfate_da2020_pop" status="rejected" stale="false" population="pregnant women with preeclampsia" measured-compound="magnesium" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- population split: '%' subgroup of da_2020 (paper reports 4 populations: %, estimated, p value, rsea)
...
- scholar stages: `../../../knowledgebase/drugs/drug_magnesium_sulfate/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `da_2020` / `da_2020::pop`)
