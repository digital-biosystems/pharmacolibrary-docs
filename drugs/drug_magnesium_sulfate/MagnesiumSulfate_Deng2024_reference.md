...
**Second reading:** `gpt-oss:120b` read this paper differently on `screen.dose_compound` (magnesium sulfate vs magnesium_sulfate) and 3 more field(s) — a structural parameter, so the record is disputed.
