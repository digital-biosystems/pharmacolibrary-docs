...
## Model component
<dbs-pgx drug="magnesium sulfate" model-id="MagnesiumSulfate_da2020_p_value" status="rejected" stale="false" population="pregnant women with preeclampsia" measured-compound="magnesium" parameterization="mechanistic" topology="1C"></dbs-pgx>
