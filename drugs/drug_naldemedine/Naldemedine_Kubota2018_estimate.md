...
|---|---|---|---|---|---|---|---|---|---|---|
| THETA (2) | `Q900` · equation variable | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab3:row4:col1 | — | not captured |
| Vc/F (L) | `Q290` · V1/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Tab3:row8:col1, Kubota_2018_table_S2:row2:col1, Kubota_2018_table_S2:row2:col5 | — | not captured |
| Q/F (L/h) | `Q69` · Q/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | Tab3:row16:col1 | — | not captured |
| Vp/F | `Q82` · V2/F | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Tab3:row17:col1, Tab3:row24:col1, Kubota_2018_table_S2:row12:col1, Kubota_2018_table_S2:row12:col5 | — | not captured |
| ALAG (hr) | `Q83` · tlag | —(suppressed) | hr | — | [h] | not captured | exact (1.0) | Tab3:row18:col1, Kubota_2018_table_S2:row6:col1, Kubota_2018_table_S2:row6:col5 | — | not captured |
