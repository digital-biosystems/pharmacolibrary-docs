...
| Q/F | `Q69` · Q/F | —(suppressed) | hr−1 | — | [1] / [h] | not captured | exact (1.0) | Kubota_2018_table_S2:row11:col5 | — | not captured |
| Vp/F | `Q82` · V2/F | —(suppressed) | hr−1 | — | [1] / [h] | not captured | exact (1.0) | Kubota_2018_table_S2:row12:col5 | — | not captured |
| ALAG (hr) | `Q83` · tlag | —(suppressed) | hr | — | [h] | not captured | exact (1.0) | Kubota_2018_table_S2:row6:col5 | — | not captured |
| CL/F | `Q900` · CL/F | —(suppressed) | hr−1 | — | not captured | not captured | not captured (not captured) | Kubota_2018_table_S2:row8:col5 | — | not captured |
| Ka | `Q900` · Ka | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Kubota_2018_table_S2:row10:col5 | — | not captured |
...
- dropped value-less row: 'Ka (hr−1)' (captured trailing unit 'hr−1' for child rows)
- unit 'hr−1' inherited from a section-header row for CL/F (not printed on this row itself) — see the unit_dimension_mismatch check below if this is wrong
- unit_dimension_mismatch: 'CL/F' → Q27 (unit '1 / [time]' vs ontology '[length] ** 3 / [time]') — route to review
- unit 'hr−1' inherited from a section-header row for V1/F (not printed on this row itself) — see the unit_dimension_mismatch check below if this is wrong
- unit_dimension_mismatch: 'Vc/F' → Q290 (unit '1 / [time]' vs ontology '[length] ** 3') — route to review
- dropped duplicate Q290 ('Vc/F', value '42.6') — already have one for this compound
- unit 'hr−1' inherited from a section-header row for Q/F (not printed on this row itself) — see the unit_dimension_mismatch check below if this is wrong
- unit_dimension_mismatch: 'Q/F' → Q69 (unit '1 / [time]' vs ontology '[length] ** 3 / [time]') — route to review
- unit 'hr−1' inherited from a section-header row for V2/F (not printed on this row itself) — see the unit_dimension_mismatch check below if this is wrong
- unit_dimension_mismatch: 'Vp/F' → Q82 (unit '1 / [time]' vs ontology '[length] ** 3') — route to review
- routed 'proportional' → Q316 (prop_error) to residual_error — variability estimate, not a structural parameter
- dropped duplicate Q27 ('CL/F (L/hr)', value '8.44') — already have one for this compound
- dropped duplicate Q49 ('Ka (hr-1)', value '4.45') — already have one for this compound
- dropped duplicate Q69 ('Q/F (L/hr)', value '5.59') — already have one for this compound
- dropped duplicate Q82 ('Vp/F (L)', value '46.6') — already have one for this compound
...
- Q49 (kabs) is equation-defined: value moved to equation-variable 'Ka'; equation kept verbatim
- status held at route_to_review — not promoted
- population split: 'shrinkage' subgroup of Kubota_2018 (paper reports 5 populations: 1107v9221(phase 2b), 1314v9231_1315v9232(phase 3), cl/f (l/hr), estimate, shrinkage)
...
| C5_dimension_Q27 | fail | 1 / [time] | hr−1 | not captured | not captured | ['Kubota_2018_table_S2:row8:col5'] |
| C5_dimension_Q290 | pass | [length] ** 3 | not captured | not captured | not captured | ['Kubota_2018_table_S2:row2:col5'] |
| C5_dimension_Q69 | fail | 1 / [time] | hr−1 | not captured | not captured | ['Kubota_2018_table_S2:row11:col5'] |
| C5_dimension_Q82 | fail | 1 / [time] | hr−1 | not captured | not captured | ['Kubota_2018_table_S2:row12:col5'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_naldemedine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kubota_2018` / `Kubota_2018::shrinkage`)
