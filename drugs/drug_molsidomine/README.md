...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-09 22:36 | 17:05 | 0/0/0 | 0/0/0 | 0/0/0 | 102,609/6,422 | ollama / qwen3.8:27b-mtp-q8_0 | 6 | 2/4 | 6/0 | 0 |
...
- **PubMed hits:** 96 matched, 86 returned
...
| `Wildgrube_1986.pdf` | Wildgrube HJ et al., Liver function and pharmacokinetics of…, Arzneimittel-Forschung (1986) | popPK | 8 | not captured | [3768083](https://pubmed.ncbi.nlm.nih.gov/3768083) | The paper is a PK study of molsidomine, but the provided evidence contains only qualitative descriptions and no specific numeric parameter values (CL, V, t1/2, etc.). |
...
<sub>queue written 2026-09-09T22:33:54.381976+00:00</sub>

## Screened and excluded

| domain | paper | verdict | relevance | extractability | reason |
|---|---|---|---|---|---|
| popPK | Bergstrand_1984 | relevant | 8 | 2 | The study reports PK parameters for molsidomine, but the evidence only provides a qualitative description and a single bioavailability value, lacking specific numeric values for clearance, volume, or half-life. |
| PD | Bergstrand_1984 | not_relevant | 0 | 0 | The provided text is only the title of the paper and does not contain the full text, data, or numeric PD parameters required to assess the relationship. |
| popPK | Berkenboom_1989 | irrelevant | 0 | 0 | The study is an in-vitro pharmacological investigation of coronary artery relaxation and does not report any pharmacokinetic parameters for molsidomine. |
...
| popPK | Brockmeier_1981 | irrelevant | 0 | 0 | The paper focuses on in-vitro dissolution modeling and does not report pharmacokinetic disposition parameters for molsidomine. |
...
| popPK | Chander_2005 | irrelevant | 0 | 0 | The study is a mechanistic/toxicology investigation of molsidomine's renoprotective effects in rats and does not report any pharmacokinetic parameters. |
...
| popPK | García-Pagán_1996 | irrelevant | 0 | 0 | The study is a clinical trial evaluating hemodynamic effects (portal hypertension) rather than pharmacokinetic parameters, and no PK values for molsidomine are reported. |
| popPK | Gong_2020 | irrelevant | 0 | 0 | The study focuses on the population pharmacokinetics of tacrolimus, and molsidomine is only mentioned in the introduction as an example of a drug with reduced clearance in heart failure. |
...
| popPK | Kuhn_1989 | irrelevant | 0 | 0 | The paper focuses on the pharmacodynamic effects of glyceryl trinitrate and SIN-1 on coronary arteries, not the pharmacokinetics of molsidomine. |
...
| PD | Nunez_1987 | not_relevant | 0 | 0 | The paper investigates the effects of SIN-1 (a metabolite) on platelets in vitro, not the pharmacodynamic or exposure-response relationship of the parent drug molsidomine in a clinical or PK/PD context. |
...
| PD | Ostrowski_1985 | not_relevant | 0 | 0 | The paper title and context indicate a pure pharmacokinetic study of molsidomine without reporting pharmacodynamic or exposure-response relationships. |
...
| popPK | Pitsikas_2003_2 | irrelevant | 0 | 0 | The study is a behavioral pharmacology experiment investigating memory in rats, where molsidomine is used as a nitric oxide donor to test mechanistic interactions, not as a subject for pharmacokinetic analysis. |
...
| popPK | Pitsikas_2007 | irrelevant | 0 | 0 | The study is a behavioral pharmacology investigation of memory in rats, not a pharmacokinetic study, and reports no disposition parameters for molsidomine. |
...
| PD | Robak_1993 | not_relevant | 0 | 0 | The paper focuses on the chemical mechanism of nitric oxide donors generating or scavenging superoxide anions, not on pharmacodynamic exposure-response or dose-response relationships for molsidomine. |
...
| PGx | Sinha_2021 | not_relevant | 0 | 0 | The paper investigates the effect of a nitric oxide donor (NCX-4040) on drug resistance mechanisms (ABC transporters) and mentions molsidomine only as a comparator that was ineffective, without reporting any pharmacogenomic effects on molsidomine's PK or PD parameters. |
...
| popPK | Wildgrube_1986 | relevant | 8 | 0 | The paper is a PK study of molsidomine, but the provided evidence contains only qualitative descriptions and no specific numeric parameter values (CL, V, t1/2, etc.). |
| popPK | Wilson_1986 | irrelevant | 2 | 0 | The study focuses on metabolic identification and radiolabel excretion rather than reporting quantitative compartmental pharmacokinetic parameters (CL, V, Q) for molsidomine. |
| popPK | Zembowicz_1990 | irrelevant | 0 | 0 | The paper title indicates a study on vasorelaxant and platelet-suppressant potencies, which is a pharmacodynamic/mechanistic study, not a pharmacokinetic study reporting disposition parameters. |
...
| popPK | Zordan_2013 | irrelevant | 0 | 0 | The paper is a mechanistic study on the immunomodulatory effects of molsidomine in a mouse model of muscular dystrophy and does not report pharmacokinetic parameters. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_molsidomine`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
