...
**Second reading:** `gpt-oss:120b` read this paper differently on `screen.dose_compound` (glycopyrronium vs glycopyrronium bromide) and 4 more field(s) — a structural parameter, so the record is disputed.
