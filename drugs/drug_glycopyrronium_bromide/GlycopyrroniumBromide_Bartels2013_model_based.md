...
**Second reading:** `gpt-oss:120b` read this paper differently on `screen.dose_compound` (glycopyrronium vs glycopyrronium bromide) and 5 more field(s) — a structural parameter, so the record is disputed.
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-18 09:01 UTC</sub>
