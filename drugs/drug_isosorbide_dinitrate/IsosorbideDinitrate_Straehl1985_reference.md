...
- scholar stages: `../../../knowledgebase/drugs/drug_isosorbide_dinitrate/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Straehl_1985` / `Straehl_1985::healthy adults`)
