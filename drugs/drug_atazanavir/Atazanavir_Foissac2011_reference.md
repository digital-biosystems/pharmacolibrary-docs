...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F (l h -1 (70 kg) -1 ) † | `Q27` · CL/F | —(suppressed) | not captured | — | not captured | not captured | boundary (0.8) | tab_1:row4:col1 | — | not captured |
| V/F (l (70 kg) -1 ) | `Q76` · V/F | —(suppressed) | not captured | — | not captured | not captured | boundary (0.8) | tab_1:row7:col1 | — | not captured |
| Ka (h -1 ) | `Q49` · kabs | —(suppressed) | h -1 | — | [1] / [h] | not captured | exact (1.0) | tab_1:row8:col1 | — | not captured |
