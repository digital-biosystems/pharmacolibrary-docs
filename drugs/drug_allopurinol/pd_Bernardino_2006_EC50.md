...
# leishmanicidal activity — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Bernardino AM; Gomes AO; Charret KS; Freitas AC; Machado GM; Canto-Cavalheiro MM; et al. et al. (2006). European journal of medicinal chemistry 41
  ·  DOI: [10.1016/j.ejmech.2005.10.007](https://doi.org/10.1016/j.ejmech.2005.10.007)
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.0 (0/15 fields) · the first reading is what this page shows

<details><summary>15 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | 1-(4-X-phenyl)-N′-[(4-Y-phenyl)methylene]-1H-pyrazole-4-carbohydrazides | not captured | mismatch |
| `effect_direction` | inhibition | not captured | mismatch |
| `effect_form` | unknown | not captured | mismatch |
| `model_family` | emax | not captured | mismatch |
| `parameters[Q27]` | 210 | not captured | only_one_extracted |
| `parameters[Q322]` | 229.0 | not captured | only_one_extracted |
| `parameters[Q322]` | 192.7 | not captured | only_one_extracted |
| `parameters[Q322]` | 203.2 | not captured | only_one_extracted |
| `parameters[Q322]` | 213.9 | not captured | only_one_extracted |
| `parameters[Q322]` | 215.6 | not captured | only_one_extracted |
| `parameters[Q38]` | 440 | not captured | only_one_extracted |
| `parameters[Q38]` | 222.6 | not captured | only_one_extracted |
| `parameters[Q38]` | 188.8 | not captured | only_one_extracted |
| `parameters[Q38]` | 50 | not captured | only_one_extracted |
| `parameters[Q38]` | 167.7 | not captured | only_one_extracted |
