...
# bacterial burden in kidney — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.0 (0/24 fields) · the first reading is what this page shows

<details><summary>24 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | apramycin | not captured | mismatch |
| `effect_direction` | inhibition | not captured | mismatch |
| `effect_form` | unknown | not captured | mismatch |
| `model_family` | indirect_response_i | not captured | mismatch |
| `parameters[Q323]` | 19.2 | not captured | only_one_extracted |
| `parameters[Q323]` | 3.77 | not captured | only_one_extracted |
| `parameters[Q325]` | 1 | not captured | only_one_extracted |
| `parameters[Q325]` | 1 | not captured | only_one_extracted |
| `parameters[Q327]` | 0.694 | not captured | only_one_extracted |
| `parameters[Q329]` | 0.43 | not captured | only_one_extracted |
| `parameters[Q331]` | 0.526 | not captured | only_one_extracted |
| `parameters[Q331]` | 0.348 | not captured | only_one_extracted |
| `parameters[Q331]` | 1.16 | not captured | only_one_extracted |
| `parameters[Q331]` | 0.85 | not captured | only_one_extracted |
| `parameters[Q331]` | 0.179 | not captured | only_one_extracted |
| `parameters[Q332]` | not captured | not captured | only_one_extracted |
| `parameters[Q332]` | 6.49 | not captured | only_one_extracted |
| `parameters[Q332]` | not captured | not captured | only_one_extracted |
| `parameters[Q332]` | 7.07 | not captured | only_one_extracted |
| `parameters[Q332]` | not captured | not captured | only_one_extracted |
| `parameters[Q332]` | 9.18 | not captured | only_one_extracted |
| `parameters[Q332]` | 8.97 | not captured | only_one_extracted |
| `parameters[Q337]` | 0.006 | not captured | only_one_extracted |
| `parameters[Q38]` | 25.2 | not captured | only_one_extracted |
