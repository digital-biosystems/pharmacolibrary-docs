...
# plasma urate — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.727 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|---|---|
| Oral availability | `Q40` · not captured | 0.80 | not captured | not captured | llm_confirmed (not captured) | tab_0:row2:col1 |
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.727 (8/11 fields) · the first reading is what this page shows

<details><summary>3 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | allopurinol | unknown | mismatch |
| `effect_direction` | inhibition | unknown | mismatch |
| `model_family` | linear | unknown | mismatch |
