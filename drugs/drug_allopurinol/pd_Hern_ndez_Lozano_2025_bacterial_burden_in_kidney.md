...
| `gpt-oss:120b` | `parameters[Q49]` | 0.033 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 0.031 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 0.006 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 0.43 | not captured | only_one_extracted |
