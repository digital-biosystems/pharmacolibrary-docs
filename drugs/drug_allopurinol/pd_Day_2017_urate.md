...
# plasma urate — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Day RO; Kannangara DR; Stocker SL; Carland JE; Williams KM; Graham GG et al. (2017). Expert opinion on drug metabolism & toxicology 13
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.0 (0/11 fields) · the first reading is what this page shows

<details><summary>11 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | oxypurinol | not captured | mismatch |
| `effect_direction` | inhibition | not captured | mismatch |
| `effect_form` | unknown | not captured | mismatch |
| `model_family` | unknown | not captured | mismatch |
| `parameters[Q22]` | 15.8 | not captured | only_one_extracted |
| `parameters[Q22]` | 0.31 | not captured | only_one_extracted |
| `parameters[Q40]` | 0.80 | not captured | only_one_extracted |
| `parameters[Q57]` | 1.2 | not captured | only_one_extracted |
| `parameters[Q57]` | 23 | not captured | only_one_extracted |
| `parameters[Q61]` | 1.31 | not captured | only_one_extracted |
| `parameters[Q61]` | 0.59 | not captured | only_one_extracted |
