...
# serum uric acid — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.176 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.176 (3/17 fields) · the first reading is what this page shows

<details><summary>14 field(s) the two readings disagree on</summary>
...
| `parameters[Q325]` | 40 | not captured | only_one_extracted |
| `parameters[Q38]` | 64 | not captured | only_one_extracted |
| `parameters[Q38]` | 72 | not captured | only_one_extracted |
| `parameters[Q75]` | 31 | not captured | only_one_extracted |
| `parameters[Q75]` | 15 | not captured | only_one_extracted |
