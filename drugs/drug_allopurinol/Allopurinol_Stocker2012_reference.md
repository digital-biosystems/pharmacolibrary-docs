...
## Citation
Stocker SL; McLachlan AJ; Savic RM; Kirkpatrick CM; Graham GG; Williams KM; et al. et al. (2012). British journal of clinical pharmacology 74
...
- unparsed cell tab_0:row0:col15 = 'BOVCL ( )+ 1'
- LLM selected parameter table(s) 1

## Validation

**Cross-check (two models):** <span class="pk-badge pk-badge--red">not confirmed</span>  
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.833 (5/6 fields) · the first reading is what this page shows

<details><summary>1 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[tvcl].parameter_id` | Q61 | Q22 | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_allopurinol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Stocker_2012` / `Stocker_2012::reference`)
