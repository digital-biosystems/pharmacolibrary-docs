...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.0 (0/22 fields) · the first reading is what this page shows

<details><summary>22 field(s) the two readings disagree on</summary>
...
| `parameters[Q49]` | 0.080 | not captured | only_one_extracted |
| `parameters[Q49]` | 0.031 | not captured | only_one_extracted |
| `parameters[Q89]` | 1 | not captured | only_one_extracted |
| `parameters[Q89]` | 1 | not captured | only_one_extracted |
| `parameters[Q95]` | 0.033 | not captured | only_one_extracted |
| `parameters[Q95]` | 0.006 | not captured | only_one_extracted |
