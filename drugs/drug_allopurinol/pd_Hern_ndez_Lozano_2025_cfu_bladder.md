...
# bacterial burden in bladder — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.0 (0/26 fields) · the first reading is what this page shows

<details><summary>26 field(s) the two readings disagree on</summary>
...
| `parameters[Q323]` | 25.2 | not captured | only_one_extracted |
| `parameters[Q323]` | 5.44 | not captured | only_one_extracted |
| `parameters[Q325]` | 1 | not captured | only_one_extracted |
| `parameters[Q325]` | 1 | not captured | only_one_extracted |
| `parameters[Q327]` | 1.51 | not captured | only_one_extracted |
| `parameters[Q329]` | 1.35 | not captured | only_one_extracted |
...
| `parameters[Q341]` | 3.77 | not captured | only_one_extracted |
| `parameters[Q344]` | 4.42 | not captured | only_one_extracted |
| `parameters[Q38]` | 0.05 | not captured | only_one_extracted |
