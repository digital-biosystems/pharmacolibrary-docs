...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.6 (3/5 fields) · the first reading is what this page shows

<details><summary>2 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `mechanism` | safety_allele | not captured | mismatch |
| `safety_allele` | True | False | mismatch |
