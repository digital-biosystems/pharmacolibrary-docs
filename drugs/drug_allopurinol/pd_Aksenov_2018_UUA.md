...
# uric acid excretion — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.364). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 0.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 0.07 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q336]` | not captured | 50.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 50.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 0.07 | only_one_extracted |
