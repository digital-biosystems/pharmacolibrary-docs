...
# uric acid excretion — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.364 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.364 (4/11 fields) · the first reading is what this page shows
...
| `parameters[Q22]` | not captured | 0.3 | only_one_extracted |
| `parameters[Q324]` | 0.07 | not captured | only_one_extracted |
| `parameters[Q336]` | not captured | 50.5 | only_one_extracted |
| `parameters[Q358]` | 50.5 | not captured | only_one_extracted |
| `parameters[Q358]` | 0.3 | not captured | only_one_extracted |
| `parameters[Q38]` | not captured | 0.07 | only_one_extracted |
