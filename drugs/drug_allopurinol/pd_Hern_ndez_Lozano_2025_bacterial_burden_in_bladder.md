...
# name — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.0 (0/19 fields) · the first reading is what this page shows

<details><summary>19 field(s) the two readings disagree on</summary>
...
| `model_family` | linear | not captured | mismatch |
...
| `parameters[Q49]` | 0.033 | not captured | only_one_extracted |
| `parameters[Q49]` | 0.031 | not captured | only_one_extracted |
| `parameters[Q49]` | 0.006 | not captured | only_one_extracted |
| `parameters[Q49]` | 0.43 | not captured | only_one_extracted |
