...
# serum urate — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.533 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
`Allopurinol_Wen2023_PD_su` — sigmoid_emax, `response = E0 + Emax*frac`
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.533 (8/15 fields) · the first reading is what this page shows

<details><summary>7 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[Q100]` | not captured | -0.27 | only_one_extracted |
| `parameters[Q22]` | 1 | not captured | only_one_extracted |
| `parameters[Q22]` | 1.05 | not captured | only_one_extracted |
| `parameters[Q322]` | -0.27 | not captured | only_one_extracted |
| `parameters[Q324]` | 9.3 | not captured | only_one_extracted |
| `parameters[Q328]` | 0.32 | not captured | only_one_extracted |
| `parameters[Q76]` | 59.3 | not captured | only_one_extracted |
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_allopurinol/Allopurinol_Wen2023_PD_su/Allopurinol_Wen2023_PD_su_matlab.zip" download>Allopurinol_Wen2023_PD_su_matlab.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
...
<dbs-fmusim paramsurl="drugs/drug_allopurinol/Allopurinol_Wen2023_PD_su/Allopurinol_Wen2023_PD_su_params.json" metaurl="assets/fmu/PD_SigmoidEmaxSweep.vr.json" wasmurl="assets/fmu/PD_SigmoidEmaxSweep.js" controlsurl="drugs/drug_allopurinol/Allopurinol_Wen2023_PD_su/Allopurinol_Wen2023_PD_su_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PD_SigmoidEmaxSweep` · parameters `Allopurinol_Wen2023_PD_su_params.json` · controls `Allopurinol_Wen2023_PD_su_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
