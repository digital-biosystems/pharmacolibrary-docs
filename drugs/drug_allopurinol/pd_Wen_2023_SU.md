...
# serum urate — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.533). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q100]` | not captured | -0.27 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | 1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | 1.05 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | -0.27 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 9.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | 0.32 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | 59.3 | not captured | only_one_extracted |
