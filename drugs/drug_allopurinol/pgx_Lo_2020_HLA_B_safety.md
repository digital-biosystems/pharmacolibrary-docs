...
# HLA-B — PGx  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--green" title="gpt-oss:120b re-read this paper; the two readings agree on 1.0 of the compared fields. The first reading is what the record holds.">cross-checked ✓</span>
...
## Citation
Lo C; Nguyen S; Yang C; Witt L; Wen A; Liao TV; et al. et al. (2020). Clinical and translational science 13
  ·  DOI: [10.1111/cts.12771](https://doi.org/10.1111/cts.12771)


**Cross-check (two models):** <span class="pk-badge pk-badge--green">confirmed</span>  
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 1.0 (4/4 fields) · the first reading is what this page shows

_Both readings agree on every compared field of this PGx record._
