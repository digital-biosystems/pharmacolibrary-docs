...
# uric acid — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.1 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|---|---|
| Allopurinol clearance (CL1) — SIR parameter 95% CI | `Q22` · not captured | 0.62 | CL1 | not captured | boundary (not captured) | Tab3:row1:col2 |
| Allopurinol volume of distribution (V1) — SIR parameter 95% CI | `Q61` · not captured | 2.25 | V1 | not captured | boundary (not captured) | Tab3:row2:col2 |
| Oxypurinol clearance (CL2)a — SIR parameter 95% CI | `Q22` · not captured | 0.23 | not captured | not captured | boundary (not captured) | Tab3:row3:col2 |
| Oxypurinol volume of distribution (V2)a — SIR parameter 95% CI | `Q61` · not captured | 9.9 | not captured | not captured | boundary (not captured) | Tab3:row4:col2 |
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.1 (1/10 fields) · the first reading is what this page shows

<details><summary>9 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | allopurinol and oxypurinol | combined_allopurinol_and_oxypurinol | mismatch |
| `effect_form` | proportional | unknown | mismatch |
| `model_family` | indirect_response_iii | indirect_response_iv | mismatch |
| `parameters[Q22]` | not captured | not captured | only_one_extracted |
| `parameters[Q22]` | 0.62 | not captured | only_one_extracted |
| `parameters[Q22]` | not captured | not captured | only_one_extracted |
| `parameters[Q22]` | 0.23 | not captured | only_one_extracted |
| `parameters[Q61]` | 2.25 | not captured | only_one_extracted |
| `parameters[Q61]` | 9.9 | not captured | only_one_extracted |
