...
# uric acid — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.1). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | allopurinol and oxypurinol | combined_allopurinol_and_oxypurinol | mismatch |
...
| `gpt-oss:120b` | `parameters[Q22]` | 0.62 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | 0.23 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | 2.25 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | 9.9 | not captured | only_one_extracted |
