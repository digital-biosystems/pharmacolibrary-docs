...
## Model component
<dbs-pgx drug="allopurinol" model-id="Allopurinol_Leander2021_reference" status="accepted_with_caveats" stale="false" population="" measured-compound="allopurinol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL I (L/h) | `Q22` · CL | 0.2272 | L/h | 6.311111111111112e-08 | L/h | not captured | review (0.7) | Leander_2021:review | — | not captured |
| V 1 , uric acid (L) | `Q63` · V1 | 14.11 | L | 0.01411 | L | not captured | review (0.7) | Leander_2021:review | — | not captured |
...
- built from REVIEW reference values (Leander_2021) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Leander_2021:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Leander_2021:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 0.2272 | not captured | not captured | ['Leander_2021:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.227 L/h | not captured | not captured | ['Leander_2021:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 14.1 L | not captured | not captured | ['Leander_2021:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_allopurinol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Leander_2021` / `Leander_2021::reference`)
- model: `../../../knowledgebase/drugs/drug_allopurinol/models/modelica/Allopurinol_Leander2021_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_allopurinol/models/modelica/Allopurinol_Leander2021_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_allopurinol/models/modelica/Allopurinol_Leander2021_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_allopurinol/Allopurinol_Leander2021_reference/Allopurinol_Leander2021_reference_modelica.zip" download>Allopurinol_Leander2021_reference_modelica.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_allopurinol/Allopurinol_Leander2021_reference/Allopurinol_Leander2021_reference_fmi.zip" download>Allopurinol_Leander2021_reference_fmi.zip</a> <span class="pk-size">(4.0 kB)</span><br><a href="models/fmu/PK_1C.fmu" download>PK_1C.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_allopurinol/Allopurinol_Leander2021_reference/Allopurinol_Leander2021_reference_matlab.zip" download>Allopurinol_Leander2021_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_allopurinol/Allopurinol_Leander2021_reference/Allopurinol_Leander2021_reference_matlab_simbio.zip" download>Allopurinol_Leander2021_reference_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_allopurinol/Allopurinol_Leander2021_reference/Allopurinol_Leander2021_reference_sbml.zip" download>Allopurinol_Leander2021_reference_sbml.zip</a> <span class="pk-size">(2.4 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_allopurinol/Allopurinol_Leander2021_reference/Allopurinol_Leander2021_reference_cellml.zip" download>Allopurinol_Leander2021_reference_cellml.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_allopurinol/Allopurinol_Leander2021_reference/Allopurinol_Leander2021_reference.svg" alt="Allopurinol_Leander2021_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_allopurinol/Allopurinol_Leander2021_reference/Allopurinol_Leander2021_reference_params.json" metaurl="assets/fmu/PK_1C.vr.json" wasmurl="assets/fmu/PK_1C.js" controlsurl="drugs/drug_allopurinol/Allopurinol_Leander2021_reference/Allopurinol_Leander2021_reference_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C` · parameters `Allopurinol_Leander2021_reference_params.json` · controls `Allopurinol_Leander2021_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
