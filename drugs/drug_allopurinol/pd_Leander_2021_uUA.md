...
# urine uric acid — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.071 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.071 (1/14 fields) · the first reading is what this page shows
...
| `model_family` | emax | indirect_response_ii | mismatch |
| `parameters[Q325]` | not captured | 48 | only_one_extracted |
| `parameters[Q325]` | not captured | 23 | only_one_extracted |
| `parameters[Q325]` | not captured | 12 | only_one_extracted |
| `parameters[Q325]` | not captured | 31 | only_one_extracted |
| `parameters[Q325]` | not captured | 15 | only_one_extracted |
| `parameters[Q325]` | not captured | 40 | only_one_extracted |
| `parameters[Q325]` | not captured | 64 | only_one_extracted |
| `parameters[Q325]` | not captured | 72 | only_one_extracted |
| `parameters[Q325]` | not captured | 40 | only_one_extracted |
