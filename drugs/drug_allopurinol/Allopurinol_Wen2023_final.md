...
> ## <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-5.6-luna (not confirmed, agreement 0.636), gpt-oss:120b (partly confirmed, agreement 0.9). The first reading is what the record holds.">cross-check: disputed 0/2</span>
...
**Second reading:** `gpt-5.6-luna` read this paper differently on `parameters[cl/fm].covariate_forms` (['power'] vs []) and 3 more field(s) — a structural parameter, so the record is disputed.
...
|---|---|---|---|---|
| `gpt-5.6-luna` | `parameters[cl/fm].covariate_forms` | ['power'] | [] | mismatch |
...
| `gpt-oss:120b` | `parameters[theta_q22_creatinine_power]` | not captured | 0.45 | only_one_extracted |
