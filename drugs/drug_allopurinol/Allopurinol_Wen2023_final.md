...
> ## <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--orange" title="gpt-oss:120b re-read this paper; the two readings agree on 0.9 of the compared fields. The first reading is what the record holds.">cross-check: partial</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.9 (9/10 fields) · the first reading is what this page shows

<details><summary>1 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[theta_q22_creatinine_power]` | not captured | 0.45 | only_one_extracted |
