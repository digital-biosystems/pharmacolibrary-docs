...
# SLCO1B1 — PGx  <span class="pk-badge pk-badge--neutral">evidence_only</span>
...
## Citation
Rattanacheeworn P; Chamnanphon M; Thongthip S; Kittanamongkolchai W; Townamchai N; Avihingsanon Y; et al. et al. (2020). Pharmacogenomics and personalized medicine 13
  ·  DOI: [10.2147/PGPM.S268457](https://doi.org/10.2147/PGPM.S268457)


**Cross-check (two models):** <span class="pk-badge pk-badge--neutral">secondary_empty</span>  
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.25 (1/4 fields) · the first reading is what this page shows
