...
# BCRP — PGx  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|
| `gpt-oss:120b` | secondary_empty | 0.0 (0/7 fields) | 7 |
...
| `gpt-oss:120b` | `reference_category` | AA | not captured | mismatch |
| `gpt-oss:120b` | `target_parameter_id` | Q22 | not captured | mismatch |
| `gpt-oss:120b` | `theta[AA]` | 0.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `theta[CA]` | 0.0539 | not captured | only_one_extracted |
| `gpt-oss:120b` | `theta[CC]` | 0.0183 | not captured | only_one_extracted |
