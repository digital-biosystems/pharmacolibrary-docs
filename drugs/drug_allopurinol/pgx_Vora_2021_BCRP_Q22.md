...
# BCRP — PGx  <span class="pk-badge pk-badge--green">extracted</span>
...
- **applies to:** pk
- **target:** `Q22` CL
- **effect (θ / form):** AA=0.0, CA=0.0539, CC=0.0183
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.0 (0/7 fields) · the first reading is what this page shows
...
| `reference_category` | AA | not captured | mismatch |
| `target_parameter_id` | Q22 | not captured | mismatch |
| `theta[AA]` | 0.0 | not captured | only_one_extracted |
| `theta[CA]` | 0.0539 | not captured | only_one_extracted |
| `theta[CC]` | 0.0183 | not captured | only_one_extracted |
