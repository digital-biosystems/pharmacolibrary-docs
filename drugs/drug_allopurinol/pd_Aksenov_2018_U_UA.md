...
# uric acid excretion in urine — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.444 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|---|---|
| k P,0 (mg/h) — Value | `Q91` · not captured | 50.5 | mg/h | not captured | llm (not captured) | tab_1:row1:col1 |
| F E,0 — Value | `Q38` · not captured | 0.07 | not captured | not captured | llm (not captured) | tab_1:row2:col1 |
| V UA (L) — Value | `Q61` · not captured | 20 | L | not captured | llm (not captured) | tab_1:row3:col1 |
| CL I (L/h) — Value | `Q22` · not captured | 0.3 | L/h | not captured | llm_confirmed (not captured) | tab_1:row4:col1 |
| GFR (mL/min) — Value | `Q26` · not captured | 130 | mL/min | not captured | llm (not captured) | tab_1:row5:col1 |
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.444 (4/9 fields) · the first reading is what this page shows

<details><summary>5 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | oxypurinol | oxypurinol, lesinurad | mismatch |
| `model_family` | indirect_response_i | emax | mismatch |
| `parameters[Q324]` | not captured | 0.07 | only_one_extracted |
| `parameters[Q336]` | not captured | 50.5 | only_one_extracted |
| `parameters[Q38]` | 0.07 | not captured | only_one_extracted |
