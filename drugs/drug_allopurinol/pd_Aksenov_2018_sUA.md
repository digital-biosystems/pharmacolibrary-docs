...
# uric acid — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.222 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.222 (2/9 fields) · the first reading is what this page shows

<details><summary>7 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | oxypurinol; febuxostat; lesinurad | oxypurinol | mismatch |
| `effect_direction` | unknown | inhibition | mismatch |
| `model_family` | emax | indirect_response_i | mismatch |
| `parameters[Q26]` | 130 | not captured | only_one_extracted |
| `parameters[Q324]` | 0.07 | not captured | only_one_extracted |
| `parameters[Q327]` | 50.5 | not captured | only_one_extracted |
| `parameters[Q61]` | 20 | not captured | only_one_extracted |
