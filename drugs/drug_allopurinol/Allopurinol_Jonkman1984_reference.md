...
## Model component
<dbs-pgx drug="allopurinol" model-id="Allopurinol_Jonkman1984_reference" status="not_modelled" stale="false" population="" measured-compound="allopurinol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Clearance (L/h/kg) | `Q22` · CL | —(suppressed) | L/h/kg | — | L/h | not captured | review (0.7) | Jonkman_1984:review | — | not captured |
| V (derived from CL·t½/ln2) | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Jonkman_1984:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_allopurinol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Jonkman_1984` / `Jonkman_1984::review reference`)
- sim: `../../../knowledgebase/drugs/drug_allopurinol/models/modelica/Allopurinol_Jonkman1984_review_reference.json`
