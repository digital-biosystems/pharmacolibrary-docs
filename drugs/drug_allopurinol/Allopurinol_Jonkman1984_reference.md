...
<sub>Template `PK_1C` · parameters `Allopurinol_Jonkman1984_reference_params.json` · controls `Allopurinol_Jonkman1984_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
