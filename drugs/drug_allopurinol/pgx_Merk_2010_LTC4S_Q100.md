...
# LTC4S — PGx  <span class="pk-badge pk-badge--neutral">evidence_only</span>
...
|---|---|---|---|
| `applies_to` | unknown | not captured | mismatch |
| `mechanism` | unknown | not captured | mismatch |
| `target_parameter_id` | Q100 | not captured | mismatch |
