...
|---|---|---|---|---|
| `gpt-5.6-luna` | `model.links` | [['allopurinol', 'oxypurinol', 'metabolism']] | [['allopurinol', 'oxypurinol', 'metabolism'], ['hypoxanthine', 'xanthine', 'interconversion'], ['xanthine', 'uric acid', 'interconversion']] | mismatch |
| `gpt-5.6-luna` | `parameters[absorption rate]` | 2.6 | not captured | only_one_extracted |
| `gpt-5.6-luna` | `parameters[allopurinol clearance].covariate_forms` | ['categorical_fractional'] | [] | mismatch |
