...
> ## <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.75 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
| V UA | `Q61` · V | 19.0 | L | 0.019 | L | not captured | review_gapfill (0.7) | Aksenov_2018:review | — | not captured |
...
- unparsed cell Tab3:row4:col1 = '11 L'
...
|---|---|---|---|
| `model.links` | [['allopurinol', 'oxypurinol', 'metabolism']] | [['allopurinol', 'oxypurinol', 'metabolism'], ['hypoxanthine', 'xanthine', 'interconversion'], ['xanthine', 'uric acid', 'interconversion']] | mismatch |
| `screen.primary_analyte` | oxypurinol | allopurinol | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_allopurinol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Chu_2022` / `Chu_2022::reference`)
