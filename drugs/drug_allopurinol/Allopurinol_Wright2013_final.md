...
## Model component
<dbs-pgx drug="allopurinol" model-id="Allopurinol_Wright2013_final" status="rejected" stale="false" population="patients with gout and healthy volunteers" measured-compound="oxypurinol" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| peripheral volume; Q, inter- | `Q64` · V2 | 28.9 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | tab_1:row14:col3 | — | not captured |
| volume; F, bioavailability; ω, | `Q40` · Fab | 0.148 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | tab_1:row16:col3 | — | not captured |
...
- model-stage split: 'final sequential model' is the final model of Wright_2013 (paper reports 2 stages: base sequential model, final sequential model); same population, different model-building step
...
- scholar stages: `../../../knowledgebase/drugs/drug_allopurinol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Wright_2013` / `Wright_2013::final`)
