...
> ## <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-5.6-luna (not confirmed, agreement 0.857), gpt-oss:120b (confirmed, agreement 1.0). The first reading is what the record holds.">cross-check: disputed 1/2</span>
...
**Second reading:** `gpt-5.6-luna` read this paper differently on `screen.primary_analyte` (oxypurinol vs allopurinol) — a structural parameter, so the record is disputed.
...
|---|---|---|---|
| `gpt-5.6-luna` | not confirmed | 0.857 (6/7 fields) | 1 |
...
|---|---|---|---|---|
| `gpt-5.6-luna` | `screen.primary_analyte` | oxypurinol | allopurinol | mismatch |
...
| C5_unit_missing_Q64 | fail | [length] ** 3 | not captured | not captured | not captured | ['tab_1:row14:col2'] |
