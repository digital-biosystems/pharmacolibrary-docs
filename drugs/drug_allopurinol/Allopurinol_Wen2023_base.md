...
## Model component
<dbs-pgx drug="allopurinol" model-id="Allopurinol_Wen2023_base" status="extracted" stale="false" population="Hmong adults with gout and/or hyperuricemia" measured-compound="oxypurinol" parameterization="apparent" topology="1C"></dbs-pgx>
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_allopurinol/Allopurinol_Wen2023_base/Allopurinol_Wen2023_base_fmi.zip" download>Allopurinol_Wen2023_base_fmi.zip</a> <span class="pk-size">(1.2 MB)</span></td></tr>
