...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/fm (L/h) | `Q351` · CLm/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | T2:row2:col1 | — | not captured |
| V/fm (L) | `Q367` · Vm/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | T2:row3:col1 | — | not captured |
| Kfm (/h) | `Q305` · kfm | —(suppressed) | /h | — | [1] / [h] | not captured | exact (1.0) | T2:row4:col1 | — | 27.9 (None% RSE) |
