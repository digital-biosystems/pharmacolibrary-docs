...
|---|---|---|---|---|---|---|---|---|---|---|
| θ CL (l h | `Q22` · CL | —(suppressed) | l h | — | [h] · [l] | 4.5 | llm_confirmed (0.6) | tab_0:row1:col4 | — | not captured |
| θ V (l) | `Q61` · V | —(suppressed) | l | — | [l] | not captured | llm (0.6) | tab_0:row2:col5, tab_0:row2:col6 | — | not captured |
| K α (h | `Q47` · kel | —(suppressed) | h | — | [h] | not captured | llm (0.6) | tab_0:row3:col4, tab_0:row3:col5, tab_0:row3:col6 | — | not captured |
| θ diuretic | `Q900` · θ diuretic | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | not captured | — | not captured |
