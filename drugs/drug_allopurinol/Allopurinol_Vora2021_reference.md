...
## Model component
<dbs-pgx drug="allopurinol" model-id="Allopurinol_Vora2021_reference" status="needs_review" stale="false" population="healthy volunteers" measured-compound="oxypurinol" parameterization="mechanistic" topology="manual_model_class"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_allopurinol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Vora_2021` / `Vora_2021::healthy volunteers`)
