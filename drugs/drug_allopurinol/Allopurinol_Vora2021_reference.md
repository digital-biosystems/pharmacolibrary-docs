...
## Citation
Vora B; Brackman DJ; Zou L; Garcia-Cremades M; Sirota M; Savic RM; et al. et al. (2021). Clinical and translational science 14
  ·  DOI: [10.1111/cts.12992](https://doi.org/10.1111/cts.12992)

## Model component
<dbs-pgx drug="allopurinol" model-id="Allopurinol_Vora2021_reference" status="rejected" stale="false" population="healthy volunteers" measured-compound="oxypurinol" parameterization="mechanistic" topology="manual_model_class"></dbs-pgx>
...
| not captured | not captured | 0.253467 | not captured |
| not captured | not captured | 1742.83 | not captured |
| not captured | not captured | 57013.5 | not captured |
| not captured | not captured | 0.77117 | not captured |
| not captured | not captured | -0.248189 | not captured |
| not captured | not captured | not captured | not captured |
| not captured | not captured | not captured | not captured |
| not captured | not captured | not captured | not captured |
| not captured | not captured | not captured | not captured |
...
| not captured | not captured | not captured | not captured |
| not captured | not captured | not captured | not captured |
| not captured | not captured | 4.36262 | not captured |
| not captured | not captured | not captured | not captured |
| not captured | not captured | not captured | not captured |
| not captured | not captured | not captured | not captured |
| not captured | not captured | not captured | not captured |
...
- control_stream ADVAN6 TRANS1: topology=manual_model_class, parameterization=mechanistic (rate_constant)
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.5 (2/4 fields) · the first reading is what this page shows

<details><summary>2 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `model.links` | [] | [['allopurinol', 'oxypurinol', 'metabolism']] | mismatch |
| `model.parameterization` | mechanistic | apparent_wrt_Fm | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_allopurinol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Vora_2021` / `Vora_2021::reference`)
