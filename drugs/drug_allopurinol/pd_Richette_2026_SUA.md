...
# serum urate — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.4 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Richette P; Walter-Petrich A; Nguyen QD; Resche-Rigon M; Nguyen QHD; Do MD; et al. et al. (2026). Arthritis care & research 78
...
|---|---|---|---|
| `driver_compound` | oxypurinol | unknown | mismatch |
| `effect_form` | unknown | additive | mismatch |
| `parameters[Q44]` | 6.46 | not captured | only_one_extracted |
