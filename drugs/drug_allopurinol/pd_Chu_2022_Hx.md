...
# hypoxanthine — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.7 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.7 (7/10 fields) · the first reading is what this page shows

<details><summary>3 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | allopurinol and oxypurinol | combined allopurinol and oxypurinol | mismatch |
| `effect_form` | unknown | proportional | mismatch |
| `model_family` | indirect_response_i | indirect_response_iv | mismatch |
