...
|---|---|---|---|---|---|---|
| E max (%) — CpdH mean (RSE%) | `Q320` · not captured | -100 | RSE% | not captured | llm (not captured) | cts13543-tbl-0001:row7:col1 |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | CpdH | not captured | mismatch |
