...
- scholar stages: `../../../knowledgebase/drugs/drug_dulaglutide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Choi_2025` / `Choi_2025::reference`)
