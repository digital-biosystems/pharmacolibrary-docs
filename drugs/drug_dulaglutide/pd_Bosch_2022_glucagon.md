...
# glucagon — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q321]` | 6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 80 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 1.54 | not captured | only_one_extracted |
