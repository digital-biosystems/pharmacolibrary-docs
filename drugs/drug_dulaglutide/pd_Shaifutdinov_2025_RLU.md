...
# GLP-1R/CRE-Luc activity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.6). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Shaifutdinov RR; Sinegubova MV; Vorobiev II; Prokhorova PE; Podkorytov AB; Orlova NA et al. (2025). Pharmaceuticals (Basel, Switzerland) 18
  ·  DOI: [10.3390/ph18121896](https://doi.org/10.3390/ph18121896)

## Parameters
| label (paper) | Q-code · name | value | unit | value_si | link | source |
|---|---|---|---|---|---|---|
| in vitro EC50 ratio (test/reference) | `Q321` · not captured | 0.73 | GLP-1R/CRE Luciferase Reporter HEK293 Cell Line | not captured | review_gapfill (not captured) | Shaifutdinov_2025:review |
...
| `gpt-oss:120b` | `parameters[Q321]` | 0.73 | not captured | only_one_extracted |
