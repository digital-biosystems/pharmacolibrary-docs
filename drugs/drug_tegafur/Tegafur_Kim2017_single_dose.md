...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `Cmax`, `AUClast`, `AUC∞`</sub>
...
## Model component
<dbs-pgx drug="tegafur" model-id="Tegafur_Kim2017_single_dose" status="model_quarantined" stale="false" population="Sprague-Dawley rats" measured-compound="tegafur" parameterization="apparent" topology="parent_metabolite"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Tmax (h) | `Q56` · tmax | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Kim_2017_table_1:row2:col2, Kim_2017_table_1:row2:col3, Kim_2017_table_1:row9:col2, Kim_2017_table_1:row9:col3, Kim_2017_table_1:row15:col2, Kim_2017_table_1:row15:col3 | — | not captured |
| Cmax (ng/mL) | `Q32` · Cmax | —(suppressed) | ng/mL | — | [ng] / [ml] | not captured | exact (1.0) | Kim_2017_table_1:row3:col2, Kim_2017_table_1:row3:col3, Kim_2017_table_1:row10:col2, Kim_2017_table_1:row10:col3, Kim_2017_table_1:row16:col2, Kim_2017_table_1:row16:col3 | — | not captured |
| AUCall (ng·h/mL) | `Q74` · AUClast | —(suppressed) | ng·h/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Kim_2017_table_1:row4:col2, Kim_2017_table_1:row4:col3, Kim_2017_table_1:row11:col2, Kim_2017_table_1:row11:col3, Kim_2017_table_1:row17:col2, Kim_2017_table_1:row17:col3 | — | not captured |
| AUCinf (ng·h/mL) | `Q17` · AUC∞ | —(suppressed) | ng·h/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Kim_2017_table_1:row5:col2, Kim_2017_table_1:row5:col3, Kim_2017_table_1:row12:col2, Kim_2017_table_1:row12:col3, Kim_2017_table_1:row18:col2, Kim_2017_table_1:row18:col3 | — | not captured |
| CL/F (mL/min/kg) | `Q27` · CL/F | —(suppressed) | mL/min/kg | — | [ml] / [[min] · [kg]] | not captured | exact (1.0) | Kim_2017_table_1:row6:col2, Kim_2017_table_1:row6:col3, Kim_2017_table_1:row19:col2, Kim_2017_table_1:row19:col3 | — | not captured |
| Vz/F (L/kg) | `Q76` · V/F | —(suppressed) | L/kg | — | [l] / [kg] | not captured | exact (1.0) | Kim_2017_table_1:row7:col3, Kim_2017_table_1:row20:col2, Kim_2017_table_1:row20:col3 | — | not captured |
| AUCmeta/AUCparent (%) | `Q21` · AUC ratio | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Kim_2017_table_1:row13:col2, Kim_2017_table_1:row13:col3 | — | not captured |
...
- population split: 'single dose' subgroup of Kim_2017 (paper reports 6 populations: multiple dose, parameter, population mean (bsv), single dose, symbol, unit)
...
- model: `../../../knowledgebase/drugs/drug_tegafur/models/modelica/_needs_review/Tegafur_Kim2017_single_dose.mo`
- deviation: `../../../knowledgebase/drugs/drug_tegafur/models/modelica/_needs_review/Tegafur_Kim2017_single_dose.deviation.json`
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_tegafur/Tegafur_Kim2017_single_dose/Tegafur_Kim2017_single_dose_matlab.zip" download>Tegafur_Kim2017_single_dose_matlab.zip</a> <span class="pk-size">(3.2 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_tegafur/Tegafur_Kim2017_single_dose/Tegafur_Kim2017_single_dose_matlab_simbio.zip" download>Tegafur_Kim2017_single_dose_matlab_simbio.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_tegafur/Tegafur_Kim2017_single_dose/Tegafur_Kim2017_single_dose_sbml.zip" download>Tegafur_Kim2017_single_dose_sbml.zip</a> <span class="pk-size">(2.4 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_tegafur/Tegafur_Kim2017_single_dose/Tegafur_Kim2017_single_dose_cellml.zip" download>Tegafur_Kim2017_single_dose_cellml.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
</tbody></table>
