...
|---|---|---|---|
| Formation rate constant of 5-FU precursor from gut compartment in control group | Q305 | not captured | llm_confirmed |
...
- dropped duplicate Q305 ('Formation rate constant of 5-FU precursor from gut compartment in SDT pretreatment group', value None) — already have one for this compound
- dropped duplicate Q305 ('Formation rate constant of 5-FU from 5-FU precursor', value None) — already have one for this compound
...
- population split: 'unit' subgroup of Kim_2017 (paper reports 6 populations: multiple dose, parameter, population mean (bsv), single dose, symbol, unit)
