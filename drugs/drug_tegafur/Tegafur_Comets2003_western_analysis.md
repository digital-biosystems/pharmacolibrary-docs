...
- dropped unlinked row (NIL): 'CDHP' — extend the ontology if this is a real PK parameter (source ['Comets_2003_table_5:row1:col2', 'Comets_2003_table_5:row2:col2'])
- dropped unlinked row (NIL): 'FT' — extend the ontology if this is a real PK parameter (source ['Comets_2003_table_5:row4:col2', 'Comets_2003_table_5:row5:col2'])
