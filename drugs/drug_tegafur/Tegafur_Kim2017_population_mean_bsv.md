...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `kfm`, `CL`</sub>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Formation rate constant of 5-FU precursor from gut compartment in control group | `Q305` · kfm | —(suppressed) | BSV | — | [bsv] | not captured | llm_confirmed (0.6) | molecules-22-01488-t002:row3:col3 | — | not captured |
| theta_q49_category | `Q900` · theta_q49_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | molecules-22-01488-t002:row1:col3 | — | not captured |
| theta_q22_category | `Q900` · theta_q22_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | molecules-22-01488-t002:row6:col3 | — | not captured |
| theta_q30_category | `Q900` · theta_q30_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | molecules-22-01488-t002:row10:col3 | — | not captured |
| theta_q61_category | `Q900` · theta_q61_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | molecules-22-01488-t002:row12:col3 | — | not captured |
| theta_q63_category | `Q900` · theta_q63_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | molecules-22-01488-t002:row13:col3 | — | not captured |
| theta_q64_category | `Q900` · theta_q64_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | molecules-22-01488-t002:row14:col3 | — | not captured |
| estimated 5-FU clearance | `Q22` · CL | —(suppressed) | fold | — | fold | not captured | boundary (0.8) | Kim_2017:discussion_prose | — | not captured |
