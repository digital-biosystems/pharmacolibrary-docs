...
## Model component
<dbs-pgx drug="tegafur" model-id="Tegafur_Kim2017_symbol" status="model_quarantined" stale="false" population="Sprague-Dawley rats" measured-compound="tegafur" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
...
|---|---|---|---|
| theta_q22_category | Q900 | not captured | not captured |
| theta_q30_category | Q900 | not captured | not captured |
| theta_q63_category | Q900 | not captured | not captured |
| theta_q64_category | Q900 | not captured | not captured |
...
- population split: 'symbol' subgroup of Kim_2017 (paper reports 6 populations: multiple dose, parameter, population mean (bsv), single dose, symbol, unit)
...
- scholar stages: `../../../knowledgebase/drugs/drug_tegafur/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kim_2017` / `Kim_2017::symbol`)
- model: `../../../knowledgebase/drugs/drug_tegafur/models/modelica/_needs_review/Tegafur_Kim2017_symbol.mo`
- deviation: `../../../knowledgebase/drugs/drug_tegafur/models/modelica/_needs_review/Tegafur_Kim2017_symbol.deviation.json`
