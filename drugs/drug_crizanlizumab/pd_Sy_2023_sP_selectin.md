...
# soluble P-selectin — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.75). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model_family` | tmdd | sigmoid_emax | mismatch |
...
---
<sub>← back to [crizanlizumab](drugs/drug_crizanlizumab/)</sub>
