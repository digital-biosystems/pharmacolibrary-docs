...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `V1`, `add_error`</sub>
...
## Citation
Junkert AM; Lazo REL; Deffert F; Carneiro J; Borba HHL; de Campos ML; et al. et al. (2024). British journal of clinical pharmacology 90
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl (L h À1 ) | `Q22` · CL | —(suppressed) | L h À1 | — | [l] / [h] | not captured | exact (1.0) | Junkert_2024:table 4_flattened | — | not captured |
| Vdc (L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | llm (0.5) | Junkert_2024:table 4_flattened | — | not captured |
| Q (L h À1 ) | `Q30` · Q | —(suppressed) | L h À1 | — | [l] / [h] | not captured | exact (1.0) | Junkert_2024:table 4_flattened | — | not captured |
| Vc (%) | `Q63` · V1 | —(suppressed) | % | — | [%] | not captured | exact (1.0) | Junkert_2024:table 4_flattened | — | not captured |
| Add (%) | `Q317` · add_error | —(suppressed) | % | — | [%] | not captured | llm (0.5) | Junkert_2024:table 4_flattened | — | not captured |
| Vp (L/kg) | `Q64` · V2 | —(suppressed) | L/kg | — | L | not captured | review_gapfill (0.7) | Ambros_2025:review | — | not captured |
...
- gap-filled Q64 (V2) from Ambros_2025's review values (primary lacked it)
...
- scholar stages: `../../../knowledgebase/drugs/drug_ciprofloxacin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Junkert_2024` / `Junkert_2024::reference`)
