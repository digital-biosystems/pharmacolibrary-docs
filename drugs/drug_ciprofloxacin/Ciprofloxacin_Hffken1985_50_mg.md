...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (mg/liter) | `Q32` · Cmax | 0.56 | mg/liter | not captured | [mg] / [l] | not captured | exact (1.0) | Höffken_1985_table_2:row0:col1 | — | not captured |
| AUC0tot (mg · h/liter) | `Q17` · AUC∞ | 1.80 | mg · h/liter | not captured | [[h] · [mg]] / [l] | not captured | llm_confirmed (0.6) | Höffken_1985_table_2:row1:col1 | — | not captured |
| volume of distribution | `Q61` · V | 266 | liters/100 kg | 0.1862 | L | not captured | exact (1.0) | Höffken_1985:other_prose | — | not captured |
| total clearance | `Q22` · CL | 687 | ml/min per 1.73 m2 | not captured | ml/min per 1.73 m2 | not captured | exact (1.0) | Höffken_1985:other_prose | — | not captured |
