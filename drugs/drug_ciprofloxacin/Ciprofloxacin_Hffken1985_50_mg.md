...
## Model component
<dbs-pgx drug="ciprofloxacin" model-id="Ciprofloxacin_Hffken1985_50_mg" status="needs_review" stale="false" population="healthy volunteers" measured-compound="ciprofloxacin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (mg/liter) | `Q32` · Cmax | —(suppressed) | mg/liter | — | [mg] / [l] | not captured | exact (1.0) | Höffken_1985_table_2:row0:col1 | — | not captured |
| AUC0tot (mg · h/liter) | `Q17` · AUC∞ | —(suppressed) | mg · h/liter | — | [[h] · [mg]] / [l] | not captured | llm_confirmed (0.6) | Höffken_1985_table_2:row1:col1 | — | not captured |
| volume of distribution | `Q61` · V | —(suppressed) | liters/100 kg | — | L | not captured | exact (1.0) | Höffken_1985:other_prose | — | not captured |
| total clearance | `Q22` · CL | —(suppressed) | ml/min per 1.73 m2 | — | ml/min per 1.73 m2 | not captured | exact (1.0) | Höffken_1985:other_prose | — | not captured |
...
- salvaged Q61 ('volume of distribution'=266) from results prose — parameter table was unreadable
- salvaged Q22 ('total clearance'=687) from results prose — parameter table was unreadable
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=ciprofloxacin
- held at status:extracted — NIL link or unit issue (mismatch/unknown/normalisation-failed) present
- status held at route_to_review — not promoted
- population split: '50 mg' subgroup of Höffken_1985 (paper reports 7 populations: 100 mg, 100 mg i.v., 100 mg orally, 50 mg, 50 mg i.v., 50 mg orally, 750 mg orally)
...
| C5_dimension_Q17 | pass | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['Höffken_1985_table_2:row1:col1'] |
| C5_dimension_Q32 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Höffken_1985_table_2:row0:col1'] |
...
| C9_phys_window_Q61 | pass | volume within physiological range | 186 L | not captured | not captured | ['Höffken_1985:other_prose'] |
