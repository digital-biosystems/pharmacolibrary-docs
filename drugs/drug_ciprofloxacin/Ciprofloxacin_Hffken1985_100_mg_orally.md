...
**What is wrong:** the simulated model does not reproduce a value the paper reports. Evidence: T1_t_half_beta — expected 4.1 — got 2.6004331421704863 — ratio 0.6343; T1_t_half_beta — expected 4.75 — got 2.6004331421704863 — ratio 0.5475.
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (mg/liter) | `Q32` · Cmax | —(suppressed) | mg/liter | — | [mg] / [l] | not captured | exact (1.0) | Höffken_1985_table_1:row0:col4 | — | not captured |
| Tmax (min) | `Q56` · tmax | —(suppressed) | min | — | [min] | not captured | exact (1.0) | Höffken_1985_table_1:row1:col4 | — | not captured |
| Varea (liters/ 100 kg) | `Q61` · V | —(suppressed) | liters/ 100 kg | — | [l] / [100kg] | not captured | llm (0.6) | Höffken_1985_table_1:row2:col4 | — | not captured |
| t1/2α (min) | `Q59` · t1/2α | —(suppressed) | min | — | [min] | not captured | exact (1.0) | Höffken_1985_table_1:row3:col4 | — | not captured |
| t1/2β (min) | `Q60` · t1/2β | —(suppressed) | min | — | [min] | not captured | exact (1.0) | Höffken_1985_table_1:row4:col4 | — | not captured |
| AUCtot (mg · h/liter) | `Q17` · AUC∞ | —(suppressed) | mg · h/liter | — | [[h] · [mg]] / [l] | not captured | exact (1.0) | Höffken_1985_table_1:row6:col4 | — | not captured |
| f | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Höffken_1985_table_1:row7:col4 | — | not captured |
...
| T1_t_half_beta | reference | pass | 3.0 | 2.6004331421704863 | 0.8668 | min→SI vs simulated h |
| T1_t_half_beta | reference | pass | 3.0666666666666664 | 2.6004331421704863 | 0.848 | min→SI vs simulated h |
| T1_t_half_beta | reference | pass | 3.433333333333333 | 2.6004331421704863 | 0.7574 | min→SI vs simulated h |
| T1_t_half_beta | reference | fail | 4.1 | 2.6004331421704863 | 0.6343 | min→SI vs simulated h |
| T1_t_half_beta | reference | fail | 4.75 | 2.6004331421704863 | 0.5475 | min→SI vs simulated h |
...
<img src="drugs/drug_ciprofloxacin/Ciprofloxacin_Hffken1985_100_mg_orally/Ciprofloxacin_Hffken1985_100_mg_orally.svg" alt="Ciprofloxacin_Hffken1985_100_mg_orally diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_1C_enteral` · parameters `Ciprofloxacin_Hffken1985_100_mg_orally_params.json` · controls `Ciprofloxacin_Hffken1985_100_mg_orally_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
