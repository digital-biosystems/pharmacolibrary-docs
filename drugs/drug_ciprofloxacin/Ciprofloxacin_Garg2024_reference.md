...
## Model component
<dbs-pgx drug="ciprofloxacin" model-id="Ciprofloxacin_Garg2024_reference" status="model_quarantined" stale="false" population="neonates with early onset neonatal sepsis and suspected meningitis" measured-compound="ciprofloxacin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL = tvcl | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | tab_2:row5:col1, tab_2:row5:col2, tab_2:row5:col3 | — | not captured |
| Vc = tvvc* | `Q900` · Vc = tvvc* | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | tab_2:row3:col1, tab_2:row3:col2, tab_2:row3:col3 | — | not captured |
