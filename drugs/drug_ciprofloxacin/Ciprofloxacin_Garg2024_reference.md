...
## Model component
<dbs-pgx drug="ciprofloxacin" model-id="Ciprofloxacin_Garg2024_reference" status="needs_review" stale="true" population="neonates with early onset neonatal sepsis and suspected meningitis" measured-compound="ciprofloxacin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- unparsed cell tab_2:row5:col4 = '[2.51; 7.99]'
- unparsed cell tab_2:row6:col4 = '[0.013; 0.70]'
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl = tvcl].value` | 0.44 | 18.68 | mismatch |
| `gpt-oss:120b` | `parameters[vc = tvvc*].value` | not captured | 11.13 | mismatch |
