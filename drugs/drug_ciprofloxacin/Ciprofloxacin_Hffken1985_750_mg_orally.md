...
**What is wrong:** the simulated model does not reproduce a value the paper reports. Evidence: T1_t_half_beta — expected 4.1 — got 3.020059010477038 — ratio 0.7366; T1_t_half_beta — expected 4.75 — got 3.020059010477038 — ratio 0.6358.
...
## Model component
<dbs-pgx drug="ciprofloxacin" model-id="Ciprofloxacin_Hffken1985_750_mg_orally" status="needs_review" stale="false" population="healthy volunteers" measured-compound="ciprofloxacin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (mg/liter) | `Q32` · Cmax | —(suppressed) | mg/liter | — | [mg] / [l] | not captured | exact (1.0) | Höffken_1985_table_1:row0:col5 | — | not captured |
| Tmax (min) | `Q56` · tmax | —(suppressed) | min | — | [min] | not captured | exact (1.0) | Höffken_1985_table_1:row1:col5 | — | not captured |
| Varea (liters/100 kg) | `Q61` · V | —(suppressed) | liters/100 kg | — | [l] / [100kg] | not captured | llm (0.6) | Höffken_1985_table_1:row2:col5 | — | not captured |
| t1/2α (min) | `Q59` · t1/2α | —(suppressed) | min | — | [min] | not captured | exact (1.0) | Höffken_1985_table_1:row3:col5 | — | not captured |
| t1/2β (min) | `Q60` · t1/2β | —(suppressed) | min | — | [min] | not captured | exact (1.0) | Höffken_1985_table_1:row4:col5 | — | not captured |
| AUCtot (mg · h/liter) | `Q17` · AUC∞ | —(suppressed) | mg · h/liter | — | [[h] · [mg]] / [l] | not captured | exact (1.0) | Höffken_1985_table_1:row6:col5 | — | not captured |
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_ciprofloxacin/Ciprofloxacin_Hffken1985_750_mg_orally/Ciprofloxacin_Hffken1985_750_mg_orally_matlab.zip" download>Ciprofloxacin_Hffken1985_750_mg_orally_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
