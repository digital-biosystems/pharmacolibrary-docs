...
## Model component
<dbs-pgx drug="ciprofloxacin" model-id="Ciprofloxacin_Hffken1985_750_mg_orally" status="extracted" stale="true" population="healthy volunteers" measured-compound="ciprofloxacin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (mg/liter) | `Q32` · Cmax | 2.65 | mg/liter | not captured | [mg] / [l] | not captured | exact (1.0) | Höffken_1985_table_1:row0:col5 | — | not captured |
| Tmax (min) | `Q56` · tmax | 69.4 | min | 4164.0 | [min] | not captured | exact (1.0) | Höffken_1985_table_1:row1:col5 | — | not captured |
| Varea (liters/ 100 kg) | `Q61` · V | 353 | liters/ 100 kg | 0.24709999999999996 | [l] / [100kg] | not captured | llm (0.6) | Höffken_1985_table_1:row2:col5 | — | not captured |
| t1/2a (min) | `Q59` · t1/2α | 58.8 | min | 3528.0 | [min] | not captured | llm_corrected (0.6) | Höffken_1985_table_1:row3:col5 | — | not captured |
| t1/2β (min) | `Q60` · t1/2β | 285.1 | min | 17106.0 | [min] | not captured | exact (1.0) | Höffken_1985_table_1:row4:col5 | — | not captured |
| AUCtot (mg · h/liter) | `Q17` · AUC∞ | 12.2 | mg · h/liter | not captured | [[h] · [mg]] / [l] | not captured | exact (1.0) | Höffken_1985_table_1:row6:col5 | — | not captured |
...
- population split: '750 mg orally' subgroup of Höffken_1985 (paper reports 7 populations: 100 mg, 100 mg i.v., 100 mg orally, 50 mg, 50 mg i.v., 50 mg orally, 750 mg orally)
...
| C5_dimension_Q17 | pass | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['Höffken_1985_table_1:row6:col5'] |
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Ambros_2025:review'] |
| C5_dimension_Q32 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Höffken_1985_table_1:row0:col5'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Alonso_2021:review'] |
| C5_dimension_Q56 | pass | [time] | not captured | not captured | not captured | ['Höffken_1985_table_1:row1:col5'] |
| C5_dimension_Q59 | pass | [time] | not captured | not captured | not captured | ['Höffken_1985_table_1:row3:col5'] |
| C5_dimension_Q60 | pass | [time] | not captured | not captured | not captured | ['Höffken_1985_table_1:row4:col5'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Höffken_1985_table_1:row2:col5'] |
...
| T1_t_half_beta | reference | pass | 3.0 | 3.020059010477038 | 1.0067 | min→SI vs simulated h |
| T1_t_half_beta | reference | pass | 3.0666666666666664 | 3.020059010477038 | 0.9848 | min→SI vs simulated h |
| T1_t_half_beta | reference | pass | 3.433333333333333 | 3.020059010477038 | 0.8796 | min→SI vs simulated h |
| T1_t_half_beta | reference | fail | 4.1 | 3.020059010477038 | 0.7366 | min→SI vs simulated h |
| T1_t_half_beta | reference | fail | 4.75 | 3.020059010477038 | 0.6358 | min→SI vs simulated h |
