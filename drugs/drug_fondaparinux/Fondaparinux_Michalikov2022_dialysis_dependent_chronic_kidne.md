...
## Citation
not matched (stem Michaličková_2022)

## Model component
<dbs-pgx drug="fondaparinux" model-id="Fondaparinux_Michalikov2022_dialysis_dependent_chronic_kidne" status="rejected" stale="false" population="dialysis-dependent chronic kidney disease patients" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_fondaparinux/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Michaličková_2022` / `Michaličková_2022::dialysis-dependent chronic kidney disease patients`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-05 22:23 UTC</sub>
