...
# coagulation activity — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.125). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.125 (3/24 fields) | 21 |

<details><summary>21 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | argatroban, dabigatran, rivaroxaban, apixaban, fondaparinux | anticoagulant | mismatch |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 29 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 45 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 26 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 107 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 17 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q322]` | 107 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 17 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 4.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 1.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 2.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 4.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 3.6 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | 4.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | 1.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | 2.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | 4.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | 3.6 | not captured | only_one_extracted |
...
---
<sub>← back to [fondaparinux](drugs/drug_fondaparinux/)</sub>
