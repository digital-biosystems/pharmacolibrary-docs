...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[clearance cl]` | 0.0971 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[volume of distribution v]` | 1.0 | not captured | only_one_extracted |
