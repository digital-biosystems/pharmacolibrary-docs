...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax | `Q32` · Cmax | —(suppressed) | ng mL-1 | — | [ng] / [ml] | not captured | exact (1.0) | Gretler_2020:abstract | — | not captured |
| tmax | `Q56` · tmax | —(suppressed) | hours | — | [h] | not captured | exact (1.0) | Gretler_2020:abstract | — | not captured |
| elimination t½ | `Q57` · t1/2z | —(suppressed) | hours | — | [h] | not captured | llm_confirmed (0.6) | Gretler_2020:abstract | — | not captured |
...
- dropped duplicate Q32 ('M3G Cmax', value 492.7) — already have one for this compound
- dropped duplicate Q32 ('C6G Cmax', value 96.1) — already have one for this compound
- dropped duplicate Q32 ('M6G Cmax', value 22.3) — already have one for this compound
- dropped duplicate Q32 ('Morphine Cmax', value 3.17) — already have one for this compound
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Gretler_2020_metadata.yaml (8 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_codeine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Gretler_2020` / `Gretler_2020::reference`)
