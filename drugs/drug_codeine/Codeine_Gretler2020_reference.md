...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cmax]` | 270.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[elimination t1⁄2]` | 2.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[tmax]` | 0.438 | not captured | only_one_extracted |
