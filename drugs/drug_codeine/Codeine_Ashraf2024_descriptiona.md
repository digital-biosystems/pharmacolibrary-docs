...
## Model component
<dbs-pgx drug="codeine" model-id="Codeine_Ashraf2024_descriptiona" status="rejected" stale="false" population="ambulatory surgical patients" measured-compound="codeine" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
- dropped unlinked row (NIL): 'CLC6G' — extend the ontology if this is a real PK parameter (source ['Tab2:row10:col1'])
- dropped unlinked row (NIL): 'CLM3G' — extend the ontology if this is a real PK parameter (source ['Tab2:row12:col1'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=codeine
- topology: transfer parameter unlinked (Q100) — add Kfm/formation-rate/rate-constant to the ontology; routing to review
- status held at route_to_review — not promoted
- population split: 'descriptiona' subgroup of Ashraf_2024 (paper reports 2 populations: descriptiona, parameter estimate)
...
- scholar stages: `../../../knowledgebase/drugs/drug_codeine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ashraf_2024` / `Ashraf_2024::descriptiona`)
