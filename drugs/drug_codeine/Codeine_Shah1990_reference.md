...
## Citation
Shah J; Mason WD et al. (1990). Drug metabolism and disposition: the biological fate of chemicals 18
...
|---|---|---|---|---|---|---|---|---|---|---|
| The weight normalized volume of distribution of (Vdarea) | `Q352` · Vnorm | —(suppressed) | liters/kg | — | [l] / [kg] | not captured | llm_confirmed (0.6) | Shah_1990:abstract | — | not captured |
| total body clearance (CL) | `Q22` · CL | —(suppressed) | liters/kg/hr | — | [l] / [[h] · [kg]] | not captured | llm_confirmed (0.6) | Shah_1990:abstract | — | not captured |
| The ratio of AUCmorphine/AUCcodeine | `Q21` · AUC ratio | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Shah_1990:abstract | — | not captured |
| The absolute bioavailability of codeine calculated | `Q40` · Fab | —(suppressed) | % | — | not captured | not captured | llm_confirmed (0.6) | Shah_1990:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Shah_1990_metadata.yaml (4 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_codeine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Shah_1990` / `Shah_1990::reference`)
