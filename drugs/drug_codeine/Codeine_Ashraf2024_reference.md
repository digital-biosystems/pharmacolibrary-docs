...
| CLcod | `Q22` · CL | 59.6 | not captured | not captured | not captured | not captured | llm (0.6) | Tab2:row3:col2, Tab2:row3:col3, Tab2:row3:col4, Tab2:row3:col5 | — | not captured |
