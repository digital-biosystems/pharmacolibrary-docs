<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;L01X&quot;,&quot;href&quot;:&quot;atc/L01X.md&quot;},{&quot;label&quot;:&quot;cisplatin&quot;,&quot;href&quot;:&quot;drugs/drug_cisplatin/&quot;},{&quot;label&quot;:&quot;Urien_2004 \u00b7 adult patients with various malignancies&quot;}]"></div>
...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `fm`, `CL`</sub>
...
## Citation
Urien S; Lokiec F et al. (2004). British journal of clinical pharmacology 57
...
|---|---|---|---|---|---|---|---|---|---|---|
| f m /V m (l -1 ) | `Q45` · fm | —(suppressed) | l -1 | — | [1] / [l] | not captured | llm (0.5) | tab_4:row4:col2, tab_4:row4:col3, tab_4:row4:col4 | — | not captured |
| f m /V m , q DOSEm | `Q76` · V/F | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | tab_4:row5:col1, tab_4:row5:col2, tab_4:row5:col3, tab_4:row5:col4 | — | not captured |
| CL m0 /V m (h -1 ) | `Q22` · CL | —(suppressed) | h -1 | — | [1] / [h] | not captured | boundary (0.8) | tab_4:row9:col1, tab_4:row9:col2, tab_4:row9:col3 | — | 10.6 (None% RSE) |
| T 1/2 , elimination (h) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | fuzzy (0.91) | tab_4:row15:col1 | — | not captured |
...
| C7_apparent_coherence | fail | F==1, Fm==1, no molar corr. | Fm=0.001 present with apparent parameterization | not captured | not captured | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_cisplatin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Urien_2004` / `Urien_2004::adult patients with various malignancies`)
