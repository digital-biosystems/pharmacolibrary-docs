...
## Citation
Liu W; Stachura P; Xu HC; Umesh Ganesh N; Cox F; Wang R; et al. et al. (2020). Journal of experimental & clinical cancer research : CR 39
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | Tegaserod | not captured | mismatch |
...
---
<sub>← back to [tegaserod](drugs/drug_tegaserod/)</sub>
