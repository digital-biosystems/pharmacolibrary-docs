...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[total body plasma clearance of the drug]` (10.9 vs not captured) — not a structural parameter.
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Bateman_1978_metadata.yaml (1 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_metoclopramide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Bateman_1978` / `Bateman_1978::reference`)
