...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[aucinf].value` | 762.8 | 1710 | mismatch |
| `gpt-oss:120b` | `parameters[auclast].value` | 618.2 | 1270 | mismatch |
| `gpt-oss:120b` | `parameters[cl/f].value` | 718.6 | 680.4 | mismatch |
| `gpt-oss:120b` | `parameters[cmax].value` | 175.5 | 376.9 | mismatch |
| `gpt-oss:120b` | `parameters[half-life].value` | 1.942 | 2.407 | mismatch |
| `gpt-oss:120b` | `parameters[vd].value` | 404.5 | 604.8 | mismatch |
