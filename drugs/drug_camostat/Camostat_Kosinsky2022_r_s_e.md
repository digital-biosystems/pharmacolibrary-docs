...
|---|---|---|---|---|---|---|---|---|---|---|
| volume of distribution of FOY-251 | `Q61` · V | —(suppressed) | liters | — | L | not captured | boundary (0.8) | Kosinsky_2022:other_prose | — | not captured |
