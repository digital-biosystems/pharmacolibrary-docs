...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka oral route | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | boundary (0.8) | tab_1:row7:col1 | — | not captured |
| CL (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | 11 | exact (1.0) | tab_1:row10:col1, tab_1:row10:col2, tab_1:row10:col4, tab_1:row10:col5, tab_1:row10:col6 | — | not captured |
| Vd (L) | `Q61` · V | —(suppressed) | L | — | [l] | 19 | exact (1.0) | tab_1:row11:col1, tab_1:row11:col2, tab_1:row11:col4, tab_1:row11:col5, tab_1:row11:col6 | — | not captured |
