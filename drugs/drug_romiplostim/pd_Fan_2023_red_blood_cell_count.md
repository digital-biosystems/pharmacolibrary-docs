...
|---|---|---|---|---|---|---|
| TRET (h) — estimate | `Q361` · not captured | 35.13 | h | not captured | llm (not captured) | tbl1:row3:col2 |
...
| `gpt-oss:120b` | `parameters[Q361]` | 35.13 | not captured | only_one_extracted |
