...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-18 22:13 | 6:00 | 0/1/0 | 1/2/0 | 0/0/0 | 230,165/5,837 | ollama / qwen3.8:27b-mtp-q8_0 | 12 | 1/10 | 12/0 | 0 |

## popPK records

| status | detail | citation | doi |
|---|---|---|---|
| <span class="pk-badge pk-badge--red">rejected</span><br><sub>blocking: C5 dimension mismatch on a structural parameter</sub><br><sub>route_to: `human_review`</sub> | [Fan_2023_reference](drugs/drug_romiplostim/Romiplostim_Fan2023_reference.md) | Fan (2023) | — |

## Pharmacodynamics (PD)

| status | detail | citation | doi |
|---|---|---|---|
| <span class="pk-badge pk-badge--green">extracted</span> | [Perez_2013](drugs/drug_romiplostim/pd_Perez_2013_PLT.md) | Perez Ruixo JJ et al., Romiplostim dose-response in patients w…, British journal of clinical… (2013) | [10.1111/bcp.12041](https://doi.org/10.1111/bcp.12041) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Fan_2023](drugs/drug_romiplostim/pd_Fan_2023_hemoglobin.md) | Fan (2023) | — |
| <span class="pk-badge pk-badge--red">rejected</span> | [Fan_2023](drugs/drug_romiplostim/pd_Fan_2023_hemoglobin_concentration.md) | Fan (2023) | — |
| <span class="pk-badge pk-badge--red">rejected</span> | [Fan_2023](drugs/drug_romiplostim/pd_Fan_2023_platelet_count.md) | Fan (2023) | — |
| <span class="pk-badge pk-badge--red">rejected</span> | [Fan_2023](drugs/drug_romiplostim/pd_Fan_2023_platelets.md) | Fan (2023) | — |
| <span class="pk-badge pk-badge--red">rejected</span> | [Fan_2023](drugs/drug_romiplostim/pd_Fan_2023_red_blood_cell_count.md) | Fan (2023) | — |
...
| <span class="pk-badge pk-badge--red">rejected</span> | [Fan_2023_2](drugs/drug_romiplostim/pd_Fan_2023_2_hemoglobin.md) | Fan (2023) | — |
| <span class="pk-badge pk-badge--red">rejected</span> | [Fan_2023_2](drugs/drug_romiplostim/pd_Fan_2023_2_platelets.md) | Fan (2023) | — |
...
<sub>queue written 2026-09-18T22:08:45.236902+00:00</sub>
...
| popPK | Dua_2015 | irrelevant | 2 | 0 | The paper is a tutorial on TMDD models that mentions romiplostim only as a context for a dose correction example, without reporting original quantitative PK parameter values for the drug. |
...
| popPK | Krzyzanski_2013 | relevant | 9 | 2 | The paper is a relevant animal PK/PD modeling study for romiplostim, but the specific quantitative disposition parameters (CL, V, Q) are not explicitly listed in the provided evidence, which focuses on potency parameters (RO, KD). |
| popPK | Makarenko_2024 | relevant | 10 | 0 | The paper describes a population PK study for romiplostim, but the specific numeric parameter values are not present in the provided evidence text. |
...
| popPK | Obrador_2026 | irrelevant | 0 | 0 | The paper is a review of radiomitigators for radiation injury and does not contain any pharmacokinetic data or mention of romiplostim. |
...
| popPK | Perez_2013 | irrelevant | 2 | 0 | The study is a pharmacodynamic (PD) analysis of platelet counts using a K-PD model, not a pharmacokinetic (PK) study, and does not report quantitative PK parameters like clearance or volume for romiplostim. |
| popPK | Petrov_2025 | irrelevant | 2 | 0 | The paper describes an in silico trial optimization for a biosimilar using a PK/PD model, but no quantitative PK parameter values (CL, V, etc.) for romiplostim are reported in the provided evidence. |
...
| popPK | Wang_2010 | relevant | 9 | 2 | The paper describes a compartmental PK model for romiplostim but the evidence only lists PD parameters (receptor kinetics, lifespans) without explicit numeric values for CL, V, or Q. |
...
| popPK | unknown_2016 | irrelevant | 0 | 0 | The provided evidence contains no mention of romiplostim or its pharmacokinetic parameters. |
