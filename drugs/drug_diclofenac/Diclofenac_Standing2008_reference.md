...
|---|---|---|---|---|---|---|---|---|---|---|
| clearance | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | review_gapfill (0.7) | Karunanidhi_2026:review | — | not captured |
...
- gap-filled Q22 (CL) from Karunanidhi_2026's review values (primary lacked it)
...
- scholar stages: `../../../knowledgebase/drugs/drug_diclofenac/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Standing_2008` / `Standing_2008::reference`)
