...
# prostaglandin E2 — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.643). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Zhang J; Li P; Guo HF; Liu L; Liu XD et al. (2012). Acta pharmacologica Sinica 33
...
| `gpt-oss:120b` | `parameters[Q323]` | 54.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 1.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 1.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 2.0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | not captured | 54.8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q89]` | 1.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q89]` | 1.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q89]` | 1.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q89]` | 2.0 | not captured | only_one_extracted |
...
---
<sub>← back to [diclofenac](drugs/drug_diclofenac/)</sub>
