...
## Model component
<dbs-pgx drug="diclofenac" model-id="Diclofenac_Rahal2008_reference" status="model_quarantined" stale="false" population="sheep" measured-compound="diclofenac" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| t(1/2beta) | `Q60` · t1/2β | —(suppressed) | h | — | [h] | not captured | llm (0.6) | Rahal_2008:abstract, Rahal_2008:abstract | — | not captured |
| AUC | `Q88` · AUC | —(suppressed) | microg h ml(-1) | — | [[h] · [µg]] / [ml] | not captured | exact (1.0) | Rahal_2008:abstract, Rahal_2008:abstract | — | not captured |
| Vd(area) | `Q61` · V | —(suppressed) | Lkg(-1) | — | [l] / [kg] | not captured | exact (1.0) | Rahal_2008:abstract, Rahal_2008:abstract | — | not captured |
| MRT | `Q53` · MRT | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Rahal_2008:abstract | — | not captured |
| Cl(B) | `Q22` · CL | —(suppressed) | Lkg(-1)h(-1) | — | [[h] · [l]] / [kg] | not captured | exact (1.0) | Rahal_2008:abstract, Rahal_2008:abstract | — | not captured |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Rahal_2008_metadata.yaml (9 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_diclofenac/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Rahal_2008` / `Rahal_2008::reference`)
- model: `../../../knowledgebase/drugs/drug_diclofenac/models/modelica/_needs_review/Diclofenac_Rahal2008_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_diclofenac/models/modelica/_needs_review/Diclofenac_Rahal2008_reference.deviation.json`
