...
|---|---|---|---|---|---|---|---|---|---|---|
| formation clearance to 5'-hydroxydiclofenac | `Q22` · CL | —(suppressed) | l.h(-1) | — | [l] / [h] | not captured | llm_confirmed (0.6) | van_2004:abstract | — | not captured |
| absorption half-life | `Q95` · t1/2ka | —(suppressed) | h | — | [h] | not captured | llm_corrected (0.6) | van_2004:abstract | — | not captured |
| lag time | `Q83` · tlag | —(suppressed) | h | — | [h] | not captured | exact (1.0) | van_2004:abstract | — | not captured |
| relative bioavailability of the suppository compared with an enteric-coated tablet | `Q87` · Frel | —(suppressed) | 1 | — | not captured | not captured | llm_confirmed (0.6) | van_2004:abstract | — | not captured |
| Vd | `Q61` · V | —(suppressed) | L | — | L | not captured | review_gapfill (0.7) | Karunanidhi_2026:review | — | not captured |
