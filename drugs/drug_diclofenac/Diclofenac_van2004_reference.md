...
| relative bioavailability of the suppository compared with an enteric-coated tablet | `Q87` · Frel | 1.26 | 1 | not captured | not captured | not captured | llm_confirmed (0.6) | van_2004:abstract | — | not captured |
