...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | dulaglutide | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q53]` | 0.27 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q53]` | 1.18 | not captured | only_one_extracted |
