...
## Model component
<dbs-pgx drug="semaglutide" model-id="Semaglutide_Overgaard2019_one_compartment_model_from_phase_3" status="model_quarantined" stale="false" population="healthy subjects and subjects with type 2 diabetes" measured-compound="semaglutide" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Total volume/Fb, L | `Q76` · V/F | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Overgaard_2019_table_5:row3:col3 | — | not captured |
| theta_q27_body_weight | `Q900` · theta_q27_body_weight | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Overgaard_2019_table_5:row1:col3 | — | not captured |
| CL/F | `Q27` · CL/F | —(suppressed) | l/h | — | L/h | not captured | review_gapfill (0.7) | Carlsson_2018:review | — | not captured |
| Kaglc (h−1) | `Q49` · kabs | —(suppressed) | h−1 | — | 1/h | not captured | review_gapfill (0.7) | Bosch_2025:review | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_semaglutide/models/modelica/_needs_review/Semaglutide_Overgaard2019_one_compartment_model_from_phase_3.mo`
- deviation: `../../../knowledgebase/drugs/drug_semaglutide/models/modelica/_needs_review/Semaglutide_Overgaard2019_one_compartment_model_from_phase_3.deviation.json`
