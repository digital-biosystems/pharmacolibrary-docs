...
## Model component
<dbs-pgx drug="semaglutide" model-id="Semaglutide_Overgaard2021v2_reference" status="needs_review" stale="false" population="adults with type 2 diabetes" measured-compound="semaglutide" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| Vd threshold | `Q61` · V | —(suppressed) | L/kg | — | L | not captured | review_gapfill (0.7) | Hernández-Gago_2026:review | — | not captured |
...
<img src="drugs/drug_semaglutide/Semaglutide_Overgaard2021v2_reference/Semaglutide_Overgaard2021v2_reference.svg" alt="Semaglutide_Overgaard2021v2_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_1C_enteral` · parameters `Semaglutide_Overgaard2021v2_reference_params.json` · controls `Semaglutide_Overgaard2021v2_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
