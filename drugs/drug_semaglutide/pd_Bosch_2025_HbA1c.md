...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.231 (6/26 fields) | 20 |
...
| `gpt-oss:120b` | `parameters[Q358]` | -0.381 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 26.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.21 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 1.38 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 31 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q83]` | not captured | 26.8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q83]` | not captured | 0.21 | only_one_extracted |
