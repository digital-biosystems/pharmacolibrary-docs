...
# name — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.231 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.231 (6/26 fields) · the first reading is what this page shows

<details><summary>20 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `effect_direction` | stimulation | unknown | mismatch |
| `parameters[Q317]` | not captured | 0.0309 | only_one_extracted |
| `parameters[Q326]` | not captured | not captured | only_one_extracted |
| `parameters[Q326]` | not captured | 1.38 | only_one_extracted |
| `parameters[Q358]` | -0.381 | not captured | only_one_extracted |
| `parameters[Q358]` | 26.8 | not captured | only_one_extracted |
| `parameters[Q358]` | 0.21 | not captured | only_one_extracted |
| `parameters[Q358]` | not captured | not captured | only_one_extracted |
| `parameters[Q358]` | 1.38 | not captured | only_one_extracted |
| `parameters[Q358]` | 31 | not captured | only_one_extracted |
| `parameters[Q40]` | 0.427 | not captured | only_one_extracted |
| `parameters[Q40]` | 38 | not captured | only_one_extracted |
| `parameters[Q43]` | not captured | 73 | only_one_extracted |
| `parameters[Q49]` | not captured | 31 | only_one_extracted |
| `parameters[Q83]` | not captured | 26.8 | only_one_extracted |
| `parameters[Q83]` | not captured | 0.21 | only_one_extracted |
| `parameters[Q83]` | not captured | 0.299 | only_one_extracted |
| `parameters[Q86]` | not captured | 39.4 | only_one_extracted |
| `parameters[Q86]` | not captured | 44 | only_one_extracted |
| `parameters[Q86]` | not captured | 30 | only_one_extracted |
