...
# nausea — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.143 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Petri KCC; Ingwersen SH; Flint A; Zacho J; Overgaard RV et al. (2018). Diabetes, obesity & metabolism 20
  ·  DOI: [10.1111/dom.13358](https://doi.org/10.1111/dom.13358)
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.143 (3/21 fields) · the first reading is what this page shows

<details><summary>18 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `effect_direction` | stimulation | inhibition | mismatch |
| `parameters[Q38]` | not captured | -1.91 | only_one_extracted |
| `parameters[Q38]` | not captured | 0.5 | only_one_extracted |
| `parameters[Q38]` | not captured | 15.3 | only_one_extracted |
| `parameters[Q38]` | not captured | -2.84 | only_one_extracted |
| `parameters[Q38]` | not captured | 0.5 | only_one_extracted |
| `parameters[Q38]` | not captured | 15.9 | only_one_extracted |
| `parameters[Q38]` | not captured | -0.83 | only_one_extracted |
| `parameters[Q38]` | not captured | 1.0 | only_one_extracted |
| `parameters[Q38]` | not captured | 31.7 | only_one_extracted |
| `parameters[Q38]` | not captured | 0.5 | only_one_extracted |
| `parameters[Q38]` | not captured | 10.5 | only_one_extracted |
| `parameters[Q38]` | not captured | -1.50 | only_one_extracted |
| `parameters[Q38]` | not captured | -1.82 | only_one_extracted |
| `parameters[Q38]` | not captured | 0.5 | only_one_extracted |
| `parameters[Q38]` | not captured | 21.8 | only_one_extracted |
| `parameters[Q38]` | not captured | -1.71 | only_one_extracted |
| `parameters[Q54]` | not captured | -7.0 | only_one_extracted |
