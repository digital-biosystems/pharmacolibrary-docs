...
# glucose — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.241). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.241 (7/29 fields) | 22 |
...
| `gpt-oss:120b` | `parameters[Q315]` | not captured | 9.28 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q317]` | not captured | 0.0309 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | not captured | 1.38 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | 0.427 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | 38 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q43]` | not captured | 73 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | 1.38 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | 31 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | not captured | 31 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q57]` | 8.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q75]` | 44 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q75]` | 30 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q83]` | not captured | 0.299 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q86]` | not captured | 39.4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q86]` | not captured | 44 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q86]` | not captured | 30 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q87]` | -0.0933 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q87]` | 0.299 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q87]` | 36 | not captured | only_one_extracted |
