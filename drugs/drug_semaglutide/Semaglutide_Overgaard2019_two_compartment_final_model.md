...
## Model component
<dbs-pgx drug="semaglutide" model-id="Semaglutide_Overgaard2019_two_compartment_final_model" status="accepted_with_caveats" stale="false" population="healthy subjects and subjects with type 2 diabetes" measured-compound="semaglutide" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Absorption rate constant ka, h−1 | `Q49` · kabs | 0.0253 | h−1 | 7.027777777777778e-06 | [1] / [h] | not captured | llm_confirmed (0.6) | Overgaard_2019_table_5:row0:col1 | — | not captured |
| Total volume/Fb, L | `Q76` · V/F | 9.08 | L | 0.00908 | [l] | not captured | llm (0.6) | Overgaard_2019_table_5:row3:col1 | — | not captured |
| theta_q27_body_weight | `Q900` · theta_q27_body_weight | 0.0460 | not captured | not captured | not captured | not captured | not captured (not captured) | Overgaard_2019_table_5:row1:col1 | — | not captured |
...
- population split: 'two-compartment final model' subgroup of Overgaard_2019 (paper reports 4 populations: estimate, one-compartment model, one-compartment model from phase 3a trialsa, two-compartment final model)
...
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Overgaard_2019_table_5:row0:col1'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Overgaard_2019_table_5:row3:col1'] |
...
| C9_phys_window_Q76 | pass | volume within physiological range | 9.08 L | not captured | not captured | ['Overgaard_2019_table_5:row3:col1'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_semaglutide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Overgaard_2019` / `Overgaard_2019::two_compartment_final_model`)
- model: `../../../knowledgebase/drugs/drug_semaglutide/models/modelica/Semaglutide_Overgaard2019_two_compartment_final_model.mo`
- deviation: `../../../knowledgebase/drugs/drug_semaglutide/models/modelica/Semaglutide_Overgaard2019_two_compartment_final_model.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_semaglutide/models/modelica/Semaglutide_Overgaard2019_two_compartment_final_model.json`
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_semaglutide/Semaglutide_Overgaard2019_two_compartment_final_model/Semaglutide_Overgaard2019_two_compartment_final_model.svg" alt="Semaglutide_Overgaard2019_two_compartment_final_model diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
