...
## Model component
<dbs-pgx drug="semaglutide" model-id="Semaglutide_Overgaard2019_two_compartment_final_model" status="model_quarantined" stale="false" population="healthy subjects and subjects with type 2 diabetes" measured-compound="semaglutide" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Absorption rate constant ka, h−1 | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Overgaard_2019_table_5:row0:col1 | — | not captured |
| Total volume/Fb, L | `Q76` · V/F | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Overgaard_2019_table_5:row3:col1 | — | not captured |
| theta_q27_body_weight | `Q900` · theta_q27_body_weight | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Overgaard_2019_table_5:row1:col1 | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_semaglutide/models/modelica/_needs_review/Semaglutide_Overgaard2019_two_compartment_final_model.mo`
- deviation: `../../../knowledgebase/drugs/drug_semaglutide/models/modelica/_needs_review/Semaglutide_Overgaard2019_two_compartment_final_model.deviation.json`
