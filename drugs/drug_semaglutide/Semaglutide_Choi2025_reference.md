...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F | `Q27` · CL/F | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | Choi_2025:review | — | not captured |
| VC | `Q63` · V1 | —(suppressed) | L | — | L | not captured | review (0.7) | Choi_2025:review | — | not captured |
| VP | `Q64` · V2 | —(suppressed) | L | — | L | not captured | review (0.7) | Choi_2025:review | — | not captured |
| ka | `Q49` · kabs | —(suppressed) | h-1 | — | 1/h | not captured | review (0.7) | Choi_2025:review | — | not captured |
...
- built from REVIEW reference values (Choi_2025) — secondary source
...
- scholar stages: `../../../knowledgebase/drugs/drug_semaglutide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Choi_2025` / `Choi_2025::reference`)
