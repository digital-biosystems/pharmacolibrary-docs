...
# gastric emptying half-life — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.714). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model_family` | unknown | effect_compartment | mismatch |
| `gpt-oss:120b` | `parameters[Q93]` | not captured | 1 | only_one_extracted |
