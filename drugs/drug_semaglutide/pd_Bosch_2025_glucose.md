...
# name — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.0 (0/15 fields) · the first reading is what this page shows

<details><summary>15 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `driver_compound` | cotadutide | not captured | mismatch |
| `effect_direction` | stimulation | not captured | mismatch |
| `effect_form` | unknown | not captured | mismatch |
| `model_family` | emax | not captured | mismatch |
| `parameters[Q312]` | 0.0145 | not captured | only_one_extracted |
| `parameters[Q312]` | 16.5 | not captured | only_one_extracted |
| `parameters[Q315]` | 9.28 | not captured | only_one_extracted |
