...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | cotadutide | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q312]` | 0.0145 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 16.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | 9.28 | not captured | only_one_extracted |
