...
## Model component
<dbs-pgx drug="semaglutide" model-id="Semaglutide_Overgaard2019_estimate" status="model_quarantined" stale="false" population="healthy subjects and subjects with type 2 diabetes" measured-compound="semaglutide" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Absorption rate constant (ka), h−1 | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Tab4:row1:col1 | — | not captured |
| Clearance (CL), L/h | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Tab4:row2:col1 | — | not captured |
| Central volume (Vc), L | `Q63` · V1 | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Tab4:row3:col1 | — | not captured |
| Intercompartmental clearance (Q), L/h | `Q30` · Q | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Tab4:row4:col1 | — | not captured |
| Peripheral volume (Vp), L | `Q64` · V2 | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | Tab4:row5:col1 | — | not captured |
| Absolute bioavailability (F) | `Q40` · Fab | —(suppressed) | F | — | not captured | not captured | exact (1.0) | Tab4:row6:col1 | — | not captured |
| body_weight_effect_on_cl_and_q | `Q900` · body_weight_effect_on_cl_and_q | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Tab4:row7:col1 | — | not captured |
| body_weight_effect_on_vc_and_vp | `Q900` · body_weight_effect_on_vc_and_vp | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Tab4:row8:col1 | — | not captured |
| injection_site_effect_on_f | `Q900` · injection_site_effect_on_f | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | Tab4:row10:col1 | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_semaglutide/models/modelica/_needs_review/Semaglutide_Overgaard2019_estimate.mo`
- deviation: `../../../knowledgebase/drugs/drug_semaglutide/models/modelica/_needs_review/Semaglutide_Overgaard2019_estimate.deviation.json`
