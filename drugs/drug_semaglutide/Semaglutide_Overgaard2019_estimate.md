...
|---|---|---|---|---|
| `gpt-5.6-luna` | `parameters[body_weight_effect_on_cl_and_q]` | 1.01 | not captured | only_one_extracted |
| `gpt-5.6-luna` | `parameters[body_weight_effect_on_vc_and_vp]` | 0.923 | not captured | only_one_extracted |
| `gpt-5.6-luna` | `parameters[clearance (cl)].covariate_forms` | ['linear_fractional', 'linear_fractional', 'linear_fractional'] | [] | mismatch |
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_semaglutide/Semaglutide_Overgaard2019_estimate/Semaglutide_Overgaard2019_estimate_matlab.zip" download>Semaglutide_Overgaard2019_estimate_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_semaglutide/Semaglutide_Overgaard2019_estimate/Semaglutide_Overgaard2019_estimate.svg" alt="Semaglutide_Overgaard2019_estimate diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
