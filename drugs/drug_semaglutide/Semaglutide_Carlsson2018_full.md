...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[cl/f].covariate_forms` (['linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'power'] vs ['linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'power']) and 6 more field(s) — a structural parameter, so the record is disputed.
...
## Model component
<dbs-pgx drug="semaglutide" model-id="Semaglutide_Carlsson2018_full" status="accepted_with_caveats" stale="false" population="adults with type 2 diabetes" measured-compound="semaglutide" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|
| `gpt-5.6-luna` | confirmed | 1.0 (36/36 fields) | none |
| `gpt-oss:120b` | not confirmed | 0.806 (29/36 fields) | 7 |

<details><summary>7 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[cl/f].covariate_forms` | ['linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'power'] | ['linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'linear_fractional', 'power'] | mismatch |
| `gpt-oss:120b` | `parameters[race_asian]` | 0.989 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[renal_mild_impairment]` | 0.948 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[renal_severe_impairment]` | 0.920 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[theta_q22_renal_mild_impairment]` | not captured | 0.948 | only_one_extracted |
| `gpt-oss:120b` | `parameters[theta_q26_renal_severe_impairment]` | not captured | 0.920 | only_one_extracted |
| `gpt-oss:120b` | `parameters[theta_q900_race_asian]` | not captured | 0.989 | only_one_extracted |
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_semaglutide/Semaglutide_Carlsson2018_full/Semaglutide_Carlsson2018_full_modelica.zip" download>Semaglutide_Carlsson2018_full_modelica.zip</a> <span class="pk-size">(4.8 kB)</span></td></tr>
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_semaglutide/Semaglutide_Carlsson2018_full/Semaglutide_Carlsson2018_full_matlab.zip" download>Semaglutide_Carlsson2018_full_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_semaglutide/Semaglutide_Carlsson2018_full/Semaglutide_Carlsson2018_full.svg" alt="Semaglutide_Carlsson2018_full diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Semaglutide_Carlsson2018_full_params.json` · controls `Semaglutide_Carlsson2018_full_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
