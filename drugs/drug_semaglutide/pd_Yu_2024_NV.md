...
# nausea severity — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.0 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|---|---|
| β 1,2\|0 — Estimate (RSE) | `Q60` · not captured | -0.34 | not captured | not captured | llm (not captured) | psp413194-tbl-0003:row12:col1 |
| β 0,1\|2 — Estimate (RSE) | `Q60` · not captured | -0.014 | not captured | not captured | llm (not captured) | psp413194-tbl-0003:row14:col1 |
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.0 (0/6 fields) · the first reading is what this page shows
...
| `model_family` | categorical | not captured | mismatch |
| `parameters[Q60]` | -0.34 | not captured | only_one_extracted |
| `parameters[Q60]` | -0.014 | not captured | only_one_extracted |
