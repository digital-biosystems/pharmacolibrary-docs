...
# nausea severity — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q60]` | -0.34 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q60]` | -0.014 | not captured | only_one_extracted |
