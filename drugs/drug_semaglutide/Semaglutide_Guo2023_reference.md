...
Guo W; Xu Z; Zou H; Li F; Li Y; Feng J; et al. et al. (2023). Molecular metabolism 75
  ·  DOI: [10.1016/j.molmet.2023.101762](https://doi.org/10.1016/j.molmet.2023.101762)

## Model component
<dbs-pgx drug="semaglutide" model-id="Semaglutide_Guo2023_reference" status="rejected" stale="false" population="" measured-compound="semaglutide" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F,ss (L/hr) Mean 0.2 mg | `Q27` · CL/F | 0.0575 | L/hr | 1.5972222222222224e-08 | L/h | not captured | review (0.7) | Guo_2023:review | — | not captured |
| V/F (derived from CL·t½/ln2) | `Q76` · V/F | 0.0028 | L | 2.76516549503718e-06 | L | not captured | review (0.7) | Guo_2023:review | — | not captured |
...
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Guo_2023:review'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q27 | pass | clearance within physiological range | 0.0575 L/h | not captured | not captured | ['Guo_2023:review'] |
| C9_phys_window_Q76 | fail | volume within physiological range | 0.00277 L | not captured | not captured | ['Guo_2023:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_semaglutide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Guo_2023` / `Guo_2023::reference`)
