...
|---|---|---|---|
| `driver_compound` | dulaglutide | not captured | mismatch |
...
| `parameters[Q53]` | 0.27 | not captured | only_one_extracted |
| `parameters[Q53]` | 1.18 | not captured | only_one_extracted |
