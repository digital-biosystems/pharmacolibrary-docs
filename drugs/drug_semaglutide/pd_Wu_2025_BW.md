...
# body weight — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.25 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `driver_compound` | semaglutide | semaglutide/tirzepatide | mismatch |
| `effect_direction` | stimulation | inhibition | mismatch |
| `model_family` | unknown | disease_progression | mismatch |
