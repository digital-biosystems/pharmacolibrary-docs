...
<sub>Template `PK_1C_enteral` · parameters `Semaglutide_Min2025_reference_params.json` · controls `Semaglutide_Min2025_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
