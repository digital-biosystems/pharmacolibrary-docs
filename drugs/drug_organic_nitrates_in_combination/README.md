...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-09 23:54 | 5:22 | 0/0/0 | 0/0/0 | 0/0/0 | 31,454/5,904 | ollama / qwen3.8:27b-mtp-q8_0 | 3 | 0/3 | 3/0 | 0 |
...
- **PubMed hits:** 0 matched, 16 returned
...
<sub>queue written 2026-09-09T23:54:32.198916+00:00</sub>
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_organic_nitrates_in_combination`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
