...
## Model component
<dbs-pgx drug="amiodarone" model-id="Amiodarone_Sermsappasuk2006_cv_mean_s_d" status="needs_review" stale="false" population="isolated perfused rat hearts" measured-compound="amiodarone" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- dropped value-less row: 'k₁₂ (1/min)' (captured trailing unit '1/min' for child rows)
- dropped value-less row: 'k₂₁ (1/min)' (captured trailing unit '1/min' for child rows)
- dropped value-less row: 'τ (min)' (captured trailing unit 'min' for child rows)
- dropped value-less row: 'Eₘₐₓ (%)' (captured trailing unit '%' for child rows)
- dropped value-less row: 'EC₅₀ (µM)' (captured trailing unit 'µM' for child rows)
...
- population split: 'cvᵃ (mean ± s.d.)' subgroup of Sermsappasuk_2006 (paper reports 2 populations: cvᵃ (mean ± s.d.), estimate (mean ± s.d.))
...
- scholar stages: `../../../knowledgebase/drugs/drug_amiodarone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Sermsappasuk_2006` / `Sermsappasuk_2006::cv_mean_s_d`)
