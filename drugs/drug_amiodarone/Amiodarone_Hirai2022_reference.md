...
## Model component
<dbs-pgx drug="amiodarone" model-id="Amiodarone_Hirai2022_reference" status="not_modelled" stale="false" population="adult patients treated with amiodarone" measured-compound="amiodarone" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_amiodarone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Hirai_2022` / `Hirai_2022::adult patients treated with amiodarone`)
