...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[cl 1 /f]` (229 vs not captured) and 4 more field(s) — a structural parameter, so the record is disputed.
