...
- scholar stages: `../../../knowledgebase/drugs/drug_duloxetine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Skinner_2004` / `Skinner_2004::reference`)
- model: `../../../knowledgebase/drugs/drug_duloxetine/models/modelica/Duloxetine_Skinner2004_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_duloxetine/models/modelica/Duloxetine_Skinner2004_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_duloxetine/models/modelica/Duloxetine_Skinner2004_reference.json`
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_duloxetine/Duloxetine_Skinner2004_reference/Duloxetine_Skinner2004_reference_matlab.zip" download>Duloxetine_Skinner2004_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<sub>Template `PK_1C_enteral` · parameters `Duloxetine_Skinner2004_reference_params.json` · controls `Duloxetine_Skinner2004_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
