...
## Model component
<dbs-pgx drug="duloxetine" model-id="Duloxetine_Skinner2004_reference" status="not_modelled" stale="false" population="women with urinary incontinence and healthy women" measured-compound="duloxetine" parameterization="apparent" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_duloxetine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Skinner_2004` / `Skinner_2004::women with urinary incontinence and healthy women`)
