...
# K-VABS-II-ABC score — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.633). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.633 (31/49 fields) | 18 |

<details><summary>18 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | AST-001 | L-serine (AST-001) | mismatch |
| `gpt-oss:120b` | `effect_form` | unknown | additive | mismatch |
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 0.48 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0.34 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | not captured | 1.31 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | not captured | 1.4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | not captured | 20.8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | not captured | 0.89 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | not captured | 0.14 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 0.0024 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | 0.14 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q340]` | 0.48 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q340]` | not captured | 0.34 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q358]` | 0.0008 | not captured | only_one_extracted |
