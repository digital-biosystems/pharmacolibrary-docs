...
## Model component
<dbs-pgx drug="abacavir" model-id="Abacavir_Fauchet2014_reference" status="extracted" stale="false" population="HIV-infected pregnant and nonpregnant women" measured-compound="abacavir" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F (liter • h Ϫ1 ) | `Q27` · CL/F | 41.3 | liter • h Ϫ1 | not captured | [h] · [l] · [ϫ1] | 4.5 | exact (1.0) | tab_0:row2:col1, tab_0:row2:col2, tab_0:row2:col3 | — | not captured |
...
| ka | `Q49` · kabs | 2.24 | h-1 | 0.0006222222222222223 | 1/h | not captured | review_gapfill (0.7) | Zhang_2015:review | — | not captured |
