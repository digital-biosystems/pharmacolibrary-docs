...
<sub>Template `PK_1C_enteral` · parameters `Abacavir_Ji2024_reference_params.json` · controls `Abacavir_Ji2024_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
