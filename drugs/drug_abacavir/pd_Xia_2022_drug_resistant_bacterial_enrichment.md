...
| `gpt-oss:120b` | `parameters[Q19]` | 0.9929 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | -0.47 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | -0.47 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | -0.46 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 1303.91 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 8.21 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q324]` | -6.05 | not captured | only_one_extracted |
