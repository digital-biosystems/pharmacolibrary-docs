...
|---|---|---|---|---|---|---|---|---|---|---|
| Clearance (L/h) | `Q22` · CL | 0.03 | L/h | 8.333333333333334e-09 | L/h | not captured | review (0.7) | Sudarsono_2026_2:review | — | not captured |
| Volume of distribution (L) | `Q61` · V | 0.2 | L | 0.0002 | L | not captured | review (0.7) | Sudarsono_2026_2:review | — | not captured |
...
- built from REVIEW reference values (Sudarsono_2026_2) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Sudarsono_2026_2:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Sudarsono_2026_2:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 0.03 | not captured | not captured | ['Sudarsono_2026_2:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.03 L/h | not captured | not captured | ['Sudarsono_2026_2:review'] |
| C9_phys_window_Q61 | fail | volume within physiological range | 0.2 L | not captured | not captured | ['Sudarsono_2026_2:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_amino_acids/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Sudarsono_2026_2` / `Sudarsono_2026_2::reference`)
