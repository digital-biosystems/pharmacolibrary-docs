...
|---|---|---|---|---|---|---|---|---|---|---|
| Clearance (L/h) | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | Sudarsono_2026_2:review | — | not captured |
| Volume of distribution (L) | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Sudarsono_2026_2:review | — | not captured |
