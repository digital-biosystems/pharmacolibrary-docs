...
# name — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.308). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 40 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 40 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 40 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | 40 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 456 | only_one_extracted |
