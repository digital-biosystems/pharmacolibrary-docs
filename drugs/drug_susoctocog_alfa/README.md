...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-06 20:36 | 6:38 | 0/0/0 | 0/0/0 | 0/0/0 | 55,629/2,247 | ollama / qwen3.8:27b-mtp-q8_0 | 12 | 3/4 | 12/0 | 0 |
...
- **PubMed hits:** 10 matched, 6 returned
...
| popPK | Ellgaard_2017 | irrelevant | 0 | 0 | The paper evaluates virus clearance in the manufacturing process for turoctocog alfa, not the pharmacokinetic disposition of susoctocog alfa. |
...
| popPK | Jiménez-Yuste_2015 | irrelevant | 0 | 0 | The paper studies turoctocog alfa, not susoctocog alfa. |
...
| popPK | Yu_2025 | irrelevant | 2 | 3 | This is a clinical case report describing the impact of acquired von Willebrand syndrome on the half-life of susoctocog alfa, not a pharmacokinetic study reporting quantitative disposition parameters (CL, V, Q) or a compartmental model. |
...
| popPK | Zhu_2021 | irrelevant | 0 | 0 | The study focuses on Factor VIII (FVIII) pharmacokinetics, not susoctocog alfa, and does not report parameters for the target drug. |
| PD | Zhu_2021 | not_relevant | 0 | 0 | The paper focuses exclusively on the pharmacokinetics (PK) of Factor VIII and dosing simulations for target attainment, with no analysis of pharmacodynamic (PD) effects or exposure-response relationships. |
...
| popPK | unknown_2015 | irrelevant | 0 | 0 | The provided evidence is only a conference title and contains no pharmacokinetic data or specific study details for susoctocog_alfa. |
| PD | unknown_2015 | not_relevant | 0 | 0 | The provided text is only a header for a conference abstract collection and contains no specific data, analysis, or PD parameters for susoctocog alfa. |

---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_susoctocog_alfa`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
