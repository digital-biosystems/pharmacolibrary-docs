...
**Extraction notes:**
- unparsed cell T3:row8:col2 = '0.964 [6.75]'
- unparsed cell T3:row12:col3 = '66.93 [14.6]'
...
- scholar stages: `../../../knowledgebase/drugs_non_atc/drug_efpeglenatide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Choi_2025` / `Choi_2025::reference`)
