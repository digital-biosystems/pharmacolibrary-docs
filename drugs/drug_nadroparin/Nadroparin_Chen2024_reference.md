...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[cl/f].value` (0.211 vs 0.063) and 2 more field(s) — a structural parameter, so the record is disputed.
...
- scholar stages: `../../../knowledgebase/drugs/drug_nadroparin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Chen_2024` / `Chen_2024::reference`)
- model: `../../../knowledgebase/drugs/drug_nadroparin/models/modelica/_needs_review/Nadroparin_Chen2024_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_nadroparin/models/modelica/_needs_review/Nadroparin_Chen2024_reference.deviation.json`
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_nadroparin/Nadroparin_Chen2024_reference/Nadroparin_Chen2024_reference_matlab.zip" download>Nadroparin_Chen2024_reference_matlab.zip</a> <span class="pk-size">(3.2 kB)</span></td></tr>
