...
|---|---|---|---|---|---|---|---|---|---|---|
| apparent concentration clearance in the group of mechanically ventilated patients | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | boundary (0.8) | Piwowarczyk_2023:other_prose | — | not captured |
