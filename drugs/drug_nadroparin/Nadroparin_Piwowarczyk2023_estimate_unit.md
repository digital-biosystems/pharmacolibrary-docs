...
|---|---|---|---|---|---|---|---|---|---|---|
| Apparent volume of distribution in group 1, L | `Q76` · V/F | 6.62 | unit | not captured | [unit] | not captured | llm_confirmed (0.6) | Tab2:row2:col1 | — | not captured |
| Apparent clearance in group 1, L/h | `Q27` · CL/F | 1.15 | unit | not captured | [unit] | not captured | llm_confirmed (0.6) | Tab2:row5:col1 | — | not captured |
| Absorption rate constant in group 1, 1/h | `Q49` · kabs | 0.319 | unit | not captured | [unit] | not captured | llm_confirmed (0.6) | Tab2:row8:col1 | — | not captured |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[absorption rate constant in group 1].rse_percent` | not captured | 10.5 | mismatch |
| `gpt-oss:120b` | `parameters[absorption rate constant in group 1].value` | 0.319 | 0.325 | mismatch |
| `gpt-oss:120b` | `parameters[apparent clearance in group 1].rse_percent` | not captured | 4.2 | mismatch |
| `gpt-oss:120b` | `parameters[apparent volume of distribution in group 1].rse_percent` | not captured | 9.6 | mismatch |
