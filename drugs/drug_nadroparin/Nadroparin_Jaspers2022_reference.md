...
|---|---|---|---|---|---|---|---|---|---|---|
| Apparent clearance from central compartment (mL/min) | `Q27` · CL/F | 7.4 | mL/min | 1.2333333333333333e-07 | [ml] / [min] | 15.9 | llm_confirmed (0.6) | Tab2:row1:col2, Tab2:row1:col3 | — | not captured |
| Apparent intercompartmental clearance (mL/min) | `Q30` · Q | 7.1 | mL/min | 1.1833333333333332e-07 | [ml] / [min] | 16.4 | llm_confirmed (0.6) | Tab2:row3:col2, Tab2:row3:col3 | — | not captured |
| theta_q290_category | `Q900` · theta_q290_category | 3864.2 | not captured | not captured | not captured | 0.3 | not captured (not captured) | Tab2:row2:col2, Tab2:row2:col3 | — | not captured |
| theta_q82_category | `Q900` · theta_q82_category | 34554.7 | not captured | not captured | not captured | 18.1 | not captured (not captured) | Tab2:row4:col2, Tab2:row4:col3 | — | not captured |
...
- unparsed cell Tab2:row4:col1 = 'V2'
...
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tab2:row1:col2', 'Tab2:row1:col3'] |
...
| C9_phys_window_Q27 | pass | clearance within physiological range | 0.444 L/h | not captured | not captured | ['Tab2:row1:col2', 'Tab2:row1:col3'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_nadroparin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Jaspers_2022` / `Jaspers_2022::reference`)
- model: `../../../knowledgebase/drugs/drug_nadroparin/models/modelica/_needs_review/Nadroparin_Jaspers2022_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_nadroparin/models/modelica/_needs_review/Nadroparin_Jaspers2022_reference.deviation.json`
