...
|---|---|---|---|---|---|---|---|---|---|---|
| Apparent clearance from central compartment (mL/min) | `Q27` · CL/F | —(suppressed) | mL/min | — | [ml] / [min] | 15.9 | llm_confirmed (0.6) | Tab2:row1:col2, Tab2:row1:col3 | — | not captured |
| Apparent intercompartmental clearance (mL/min) | `Q30` · Q | —(suppressed) | mL/min | — | [ml] / [min] | 16.4 | llm_confirmed (0.6) | Tab2:row3:col2, Tab2:row3:col3 | — | not captured |
| theta_q290_category | `Q900` · theta_q290_category | —(suppressed) | not captured | — | not captured | 0.3 | not captured (not captured) | Tab2:row2:col2, Tab2:row2:col3 | — | not captured |
| theta_q82_category | `Q900` · theta_q82_category | —(suppressed) | not captured | — | not captured | 18.1 | not captured (not captured) | Tab2:row4:col2, Tab2:row4:col3 | — | not captured |
