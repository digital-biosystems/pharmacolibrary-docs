...
## Model component
<dbs-pgx drug="aripiprazole" model-id="Aripiprazole_Wang2022_reference" status="not_modelled" stale="false" population="subjects with schizophrenia or schizoaffective disorder and healthy subjects" measured-compound="aripiprazole" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F in the presence of strong CYP3A4 inhibitors | `Q27` · CL/F | —(suppressed) | % lower | — | % lower | not captured | boundary (0.8) | Wang_2022:other_prose | — | not captured |
| reduction in clearance for CYP2D6 PMs | `Q22` · CL | —(suppressed) | % | — | % | not captured | boundary (0.8) | Wang_2022:results_prose | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_aripiprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Wang_2022` / `Wang_2022::subjects with schizophrenia or schizoaffective disorder and healthy subjects`)
