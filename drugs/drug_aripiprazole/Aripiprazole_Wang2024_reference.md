...
> ## <span class="pk-badge pk-badge--orange">built, not shipped</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (partly confirmed, agreement 0.8). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[aom 400]` | 400 | not captured | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_aripiprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Wang_2024` / `Wang_2024::reference`)
- model: `../../../knowledgebase/drugs/drug_aripiprazole/models/modelica/_needs_review/Aripiprazole_Wang2024_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_aripiprazole/models/modelica/_needs_review/Aripiprazole_Wang2024_reference.deviation.json`
