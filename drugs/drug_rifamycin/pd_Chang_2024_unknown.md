...
# grade 3 or higher adverse events — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | rifapentine | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q100]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 67 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 49 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 153 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 125 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 138 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 57 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 67 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 49 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 153 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 125 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 138 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 57 | not captured | only_one_extracted |
