...
# activated partial thromboplastin time — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.737). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 3.51 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q61]` | not captured | 210 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | not captured | 89.7 | only_one_extracted |
