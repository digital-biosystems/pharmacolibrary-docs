...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `Fab`, `kabs`</sub>
...
|---|---|---|---|---|---|---|---|---|---|---|
| F | `Q40` · Fab | —(suppressed) | n = 38 individuals | — | not captured | not captured | exact (1.0) | T2:row2:col2, T2:row2:col4, T2:row2:col6 | — | not captured |
| ka [h−1] | `Q49` · kabs | —(suppressed) | n = 38 individuals | — | [individuals] · [n=38] | not captured | llm_confirmed (0.6) | T2:row3:col2, T2:row3:col3, T2:row3:col4, T2:row3:col5, T2:row3:col6 | — | not captured |
| theta_q22_category | `Q900` · theta_q22_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | T2:row4:col2, T2:row4:col4, T2:row4:col6 | — | not captured |
| theta_q63_category | `Q900` · theta_q63_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | T2:row5:col2, T2:row5:col4, T2:row5:col6 | — | not captured |
| theta_q30_category | `Q900` · theta_q30_category | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | T2:row7:col1, T2:row7:col3, T2:row7:col5 | — | not captured |
| Cl (ml min À1 ) Intercept | `Q22` · CL | —(suppressed) | ml min À1 | — | L/h | not captured | review_gapfill (0.7) | Groenendaal_2007:review | — | not captured |
| Vd | `Q61` · V | —(suppressed) | L | — | L | not captured | review_gapfill (0.7) | Nie_2023:review | — | not captured |
...
- unit_dimension_unknown: 'n = 38 individuals' (kabs)
- dropped unlinked row (NIL): 'Res. Error' — extend the ontology if this is a real PK parameter (source ['T2:row10:col1', 'T2:row10:col2', 'T2:row10:col3', 'T2:row10:col4', 'T2:row10:col5', 'T2:row10:col6'])
...
**Extraction notes:**
- unparsed cell T2:row2:col1 = '0.41 (0.26–0.56)*'
- unparsed cell T2:row2:col3 = '0.405 (0.23–0.58)*'
- unparsed cell T2:row2:col5 = '0.36 (0.23–0.49)*'
- unparsed cell T2:row3:col1 = '0.81 (0.53–1.09)*'
- unparsed cell T2:row4:col1 = '10.3 (6.2–14.4)*'
- unparsed cell T2:row4:col3 = '4.6 (0.98–8.2)*'
- unparsed cell T2:row4:col5 = '8.86 (5.4–12.3)*'
- unparsed cell T2:row5:col1 = '12.2 (5.8–18.6)*'
- unparsed cell T2:row5:col3 = '5.02 (0.98–9.1)*'
- unparsed cell T2:row5:col5 = '8.36 (3.7–13.0)*'
...
- scholar stages: `../../../knowledgebase/drugs/drug_nalbuphine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Pfiffner_2022` / `Pfiffner_2022::reference`)
