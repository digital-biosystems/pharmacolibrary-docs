...
## Model component
<dbs-pgx drug="nalbuphine" model-id="Nalbuphine_Bressolle2011_iiv" status="needs_review" stale="false" population="children after surgery" measured-compound="nalbuphine" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
| V 1 (litre) | `Q63` · V1 | 208 | litre | 0.20800000000000002 | [l] | 51.1 | llm (0.6) | tab_5:row7:col3, Bressolle_2011_table_3:row1:col2 | — | not captured |
| V 2 (litre) | `Q64` · V2 | 153 | litre | 0.153 | [l] | 48.3 | llm (0.6) | tab_5:row8:col3, Bressolle_2011_table_3:row2:col2 | — | not captured |
...
- dropped value-less row: 'CL (litre h 21 )' (captured trailing unit 'litre h 21' for child rows)
- dropped value-less row: 'Q (litre h 21 )' (captured trailing unit 'litre h 21' for child rows)
- dropped value-less row: 'V ss (litre)' (captured trailing unit 'litre' for child rows)
...
- unit 'h' inherited from a section-header row for V1 (not printed on this row itself) — see the unit_dimension_mismatch check below if this is wrong
- unit_dimension_mismatch: 'V 1' → Q63 (unit '[time]' vs ontology '[length] ** 3') — route to review
- dropped duplicate Q63 ('V 1', value '0.153') — already have one for this compound
- unit 'h' inherited from a section-header row for V2 (not printed on this row itself) — see the unit_dimension_mismatch check below if this is wrong
- unit_dimension_mismatch: 'V 2' → Q64 (unit '[time]' vs ontology '[length] ** 3') — route to review
...
- population split: 'iiv (%)' subgroup of Bressolle_2011 (paper reports 4 populations: basic model, final covariate model (allometric model), iiv (%), mean)
...
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['tab_5:row7:col3', 'Bressolle_2011_table_3:row1:col2'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['tab_5:row8:col3', 'Bressolle_2011_table_3:row2:col2'] |
| C6_cl_magnitude | fail | &lt;= 90.0 L/h | 131.0 | not captured | not captured | ['tab_5:row6:col2'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q63 | pass | volume within physiological range | 208 L | not captured | not captured | ['tab_5:row7:col3', 'Bressolle_2011_table_3:row1:col2'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 153 L | not captured | not captured | ['tab_5:row8:col3', 'Bressolle_2011_table_3:row2:col2'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_nalbuphine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Bressolle_2011` / `Bressolle_2011::iiv`)
