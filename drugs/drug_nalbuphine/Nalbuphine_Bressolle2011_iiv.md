...
| V 1 (litre) | `Q63` · V1 | —(suppressed) | litre | — | [l] | 51.1 | llm (0.6) | tab_5:row7:col3, Bressolle_2011_table_3:row1:col2 | — | not captured |
| V 2 (litre) | `Q64` · V2 | —(suppressed) | litre | — | [l] | 48.3 | llm (0.6) | tab_5:row8:col3, Bressolle_2011_table_3:row2:col2 | — | not captured |
