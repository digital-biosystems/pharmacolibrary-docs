...
| V 1 (litre) | `Q63` · V1 | —(suppressed) | litre | — | [l] | not captured | llm (0.6) | tab_5:row7:col3 | — | not captured |
| V 2 (litre) | `Q64` · V2 | —(suppressed) | litre | — | [l] | not captured | llm (0.6) | tab_5:row8:col3 | — | not captured |
