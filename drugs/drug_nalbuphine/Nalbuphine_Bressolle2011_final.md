...
| V 1 (litre) | `Q63` · V1 | 208 | litre | 0.20800000000000002 | [l] | not captured | llm (0.6) | tab_5:row7:col3 | — | not captured |
| V 2 (litre) | `Q64` · V2 | 153 | litre | 0.153 | [l] | not captured | llm (0.6) | tab_5:row8:col3 | — | not captured |
...
- unit_dimension_unknown: 'litre h 21 70 kg 21' (CL)
- dropped duplicate Q22 ('CL (litre h 21 70 kg 21 )', value '130') — already have one for this compound
- unit_dimension_unknown: 'litre 70 kg 21' (V1)
- dropped duplicate Q63 ('V 1 (litre 70 kg 21 )', value '210') — already have one for this compound
- unit_dimension_unknown: 'litre 70 kg 21' (V2)
- dropped duplicate Q64 ('V 2 (litre 70 kg 21 )', value '151') — already have one for this compound
- unit_dimension_unknown: 'litre h 21 70 kg 21' (Q)
- dropped duplicate Q30 ('Q (litre h 21 70 kg 21 )', value '75.6') — already have one for this compound
- dropped PD-category row 's (%)' → Q335 (slope, category G13) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['Bressolle_2011_table_2:row10:col3'])
- dropped unlinked row (NIL): '(DV vs IPRED)' — extend the ontology if this is a real PK parameter (source ['Bressolle_2011_table_2:row12:col3', 'Bressolle_2011_table_2:row15:col3'])
- dropped unlinked row (NIL): '(DV vs PRED)' — extend the ontology if this is a real PK parameter (source ['Bressolle_2011_table_2:row13:col3', 'Bressolle_2011_table_2:row16:col3'])
...
- model-stage split: 'final covariate model (allometric model)' is the final model of Bressolle_2011 (paper reports 4 stages: basic model, final covariate model (allometric model), iiv (%), mean); same population, different model-building step
...
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['tab_5:row7:col3'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['tab_5:row8:col3'] |
| C6_cl_magnitude | fail | &lt;= 90.0 L/h | 131.0 | not captured | not captured | ['tab_5:row6:col2'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q63 | pass | volume within physiological range | 208 L | not captured | not captured | ['tab_5:row7:col3'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 153 L | not captured | not captured | ['tab_5:row8:col3'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_nalbuphine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Bressolle_2011` / `Bressolle_2011::final`)
