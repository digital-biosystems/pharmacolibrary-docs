...
Nie Y; Sun X; Cao R; Tang S; Zhou Q; Zhou M; Chen Z; Huang S et al. (2025). Drug design, development and therapy 19
  ·  DOI: [10.2147/dddt.s500189](https://doi.org/10.2147/dddt.s500189)
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h) | `Q22` · CL | 176.0 | L/h | 4.888888888888888e-05 | L/h | not captured | review (0.7) | Nie_2025:review | — | not captured |
| V1 (L) | `Q63` · V1 | 519.0 | L | 0.519 | L | not captured | review (0.7) | Nie_2025:review | — | not captured |
| V2 (L) | `Q64` · V2 | 0.187 | L | 0.000187 | L | not captured | review (0.7) | Nie_2025:review | — | not captured |
| CL2 (L/h) | `Q30` · Q | 0.0134 | L/h | 3.7222222222222223e-09 | L/h | not captured | review (0.7) | Nie_2025:review | — | not captured |
...
- built from REVIEW reference values (Nie_2025) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Nie_2025:review'] |
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Nie_2025:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Nie_2025:review'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Nie_2025:review'] |
| C6_cl_magnitude | fail | &lt;= 90.0 L/h | 176.0 | not captured | not captured | ['Nie_2025:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 176 L/h | not captured | not captured | ['Nie_2025:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 519 L | not captured | not captured | ['Nie_2025:review'] |
| C9_phys_window_Q64 | fail | volume within physiological range | 0.187 L | not captured | not captured | ['Nie_2025:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_nalbuphine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Nie_2025` / `Nie_2025::reference`)
