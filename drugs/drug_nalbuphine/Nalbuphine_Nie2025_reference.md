...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h) | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | Nie_2025:review | — | not captured |
| V1 (L) | `Q63` · V1 | —(suppressed) | L | — | L | not captured | review (0.7) | Nie_2025:review | — | not captured |
| V2 (L) | `Q64` · V2 | —(suppressed) | L | — | L | not captured | review (0.7) | Nie_2025:review | — | not captured |
| CL2 (L/h) | `Q30` · Q | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | Nie_2025:review | — | not captured |
