...
## Model component
<dbs-pgx drug="nalbuphine" model-id="Nalbuphine_Nie2023_final" status="model_quarantined" stale="false" population="adults undergoing general anesthesia surgery" measured-compound="nalbuphine" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | T4:row3:col1, T4:row3:col2 | — | not captured |
| V1 | `Q63` · V1 | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | T4:row4:col1, T4:row4:col2 | — | not captured |
| Q | `Q30` · Q | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | T4:row5:col1, T4:row5:col2 | — | not captured |
| V2 | `Q64` · V2 | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | T4:row6:col1, T4:row6:col2 | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/_needs_review/Nalbuphine_Nie2023_final.mo`
- deviation: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/_needs_review/Nalbuphine_Nie2023_final.deviation.json`
