...
- scholar stages: `../../../knowledgebase/drugs/drug_nalbuphine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Nie_2023` / `Nie_2023::reference`)
- model: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/Nalbuphine_Nie2023_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/Nalbuphine_Nie2023_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/Nalbuphine_Nie2023_reference.json`
...
<sub>Template `PK_2C` · parameters `Nalbuphine_Nie2023_reference_params.json` · controls `Nalbuphine_Nie2023_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
