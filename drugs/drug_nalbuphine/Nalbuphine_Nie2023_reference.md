...
## Model component
<dbs-pgx drug="nalbuphine" model-id="Nalbuphine_Nie2023_reference" status="not_modelled" stale="false" population="adults undergoing general anesthesia surgery" measured-compound="nalbuphine" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | Nie_2023:review | — | not captured |
| V1 | `Q63` · V1 | —(suppressed) | L | — | L | not captured | review (0.7) | Nie_2023:review | — | not captured |
| V2 | `Q64` · V2 | —(suppressed) | L | — | L | not captured | review (0.7) | Nie_2023:review | — | not captured |
| Q | `Q30` · Q | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | Nie_2023:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_nalbuphine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Nie_2023` / `Nie_2023::review reference`)
- sim: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/Nalbuphine_Nie2023_review_reference.json`
