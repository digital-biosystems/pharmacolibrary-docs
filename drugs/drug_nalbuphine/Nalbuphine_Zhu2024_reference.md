...
- built from REVIEW reference values (Zhu_2024) — secondary source
...
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Zhu_2024:review'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Zhu_2024:review'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Zhu_2024:review'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q27 | pass | clearance within physiological range | 149 L/h | not captured | not captured | ['Zhu_2024:review'] |
| C9_phys_window_Q76 | pass | volume within physiological range | 2.57e+03 L | not captured | not captured | ['Zhu_2024:review'] |
...
| T3_output_variable | not captured | pass | C_central (measured=nalbuphine) | central.C | not captured | output must be the measured/analyte compartment |
...
- scholar stages: `../../../knowledgebase/drugs/drug_nalbuphine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Zhu_2024` / `Zhu_2024::reference`)
- model: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/Nalbuphine_Zhu2024_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/Nalbuphine_Zhu2024_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/Nalbuphine_Zhu2024_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_nalbuphine/Nalbuphine_Zhu2024_reference/Nalbuphine_Zhu2024_reference_modelica.zip" download>Nalbuphine_Zhu2024_reference_modelica.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_nalbuphine/Nalbuphine_Zhu2024_reference/Nalbuphine_Zhu2024_reference_fmi.zip" download>Nalbuphine_Zhu2024_reference_fmi.zip</a> <span class="pk-size">(4.1 kB)</span><br><a href="models/fmu/PK_1C_enteral.fmu" download>PK_1C_enteral.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_nalbuphine/Nalbuphine_Zhu2024_reference/Nalbuphine_Zhu2024_reference_matlab.zip" download>Nalbuphine_Zhu2024_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_nalbuphine/Nalbuphine_Zhu2024_reference/Nalbuphine_Zhu2024_reference_matlab_simbio.zip" download>Nalbuphine_Zhu2024_reference_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_nalbuphine/Nalbuphine_Zhu2024_reference/Nalbuphine_Zhu2024_reference_sbml.zip" download>Nalbuphine_Zhu2024_reference_sbml.zip</a> <span class="pk-size">(2.6 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_nalbuphine/Nalbuphine_Zhu2024_reference/Nalbuphine_Zhu2024_reference_cellml.zip" download>Nalbuphine_Zhu2024_reference_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_nalbuphine/Nalbuphine_Zhu2024_reference/Nalbuphine_Zhu2024_reference.svg" alt="Nalbuphine_Zhu2024_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Nalbuphine_Zhu2024_reference_params.json` · controls `Nalbuphine_Zhu2024_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
