...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | 32.9 | not captured | not captured | not captured | not captured | exact (1.0) | Nie_2023_table_2:row1:col1 | — | not captured |
| V1 | `Q63` · V1 | 31 | not captured | not captured | not captured | not captured | exact (1.0) | Nie_2023_table_2:row2:col1 | — | not captured |
| Q | `Q30` · Q | 261 | not captured | not captured | not captured | not captured | exact (1.0) | Nie_2023_table_2:row3:col1 | — | not captured |
| V2 | `Q64` · V2 | 85.9 | not captured | not captured | not captured | not captured | exact (1.0) | Nie_2023_table_2:row4:col1 | — | not captured |
...
- dropped unlinked row (NIL): 'ωCL (%CV)' — extend the ontology if this is a real PK parameter (source ['Nie_2023_table_2:row6:col1'])
- dropped unlinked row (NIL): 'ωV1 (%CV)' — extend the ontology if this is a real PK parameter (source ['Nie_2023_table_2:row7:col1'])
- dropped unlinked row (NIL): 'ωQ (%CV)' — extend the ontology if this is a real PK parameter (source ['Nie_2023_table_2:row8:col1'])
- dropped unlinked row (NIL): 'ωV2 (%CV)' — extend the ontology if this is a real PK parameter (source ['Nie_2023_table_2:row9:col1'])
...
- scholar stages: `../../../knowledgebase/drugs/drug_nalbuphine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Nie_2023` / `Nie_2023::estimates`)
- model: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/_needs_review/Nalbuphine_Nie2023_estimates.mo`
- deviation: `../../../knowledgebase/drugs/drug_nalbuphine/models/modelica/_needs_review/Nalbuphine_Nie2023_estimates.deviation.json`
