...
|---|---|---|---|---|---|---|---|---|---|---|
| CL | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Nie_2023_table_2:row1:col1 | — | not captured |
| V1 | `Q63` · V1 | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Nie_2023_table_2:row2:col1 | — | not captured |
| Q | `Q30` · Q | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Nie_2023_table_2:row3:col1 | — | not captured |
| V2 | `Q64` · V2 | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Nie_2023_table_2:row4:col1 | — | not captured |
