...
|---|---|---|---|---|---|---|---|---|---|---|
| Absorption rate constant | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | ijpo12799-tbl-0003:row1:col2, Carlsson_2021_table_S1:row0:col2 | — | not captured |
| Apparent clearance | `Q27` · CL/F | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | ijpo12799-tbl-0003:row2:col2, Carlsson_2021_table_S1:row1:col2 | — | not captured |
| Apparent volume of distribution | `Q76` · V/F | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | ijpo12799-tbl-0003:row3:col2, Carlsson_2021_table_S1:row2:col2 | — | not captured |
| sex_contrast_male_female_on_cl_f | `Q900` · sex_contrast_male_female_on_cl_f | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | ijpo12799-tbl-0003:row5:col2 | — | not captured |
| age_contrast_child_adult_on_cl_f | `Q900` · age_contrast_child_adult_on_cl_f | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | ijpo12799-tbl-0003:row6:col2 | — | not captured |
| age_contrast_adolescent_adult_on_cl_f | `Q900` · age_contrast_adolescent_adult_on_cl_f | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | ijpo12799-tbl-0003:row7:col2 | — | not captured |
| theta_q319_body_weight_power | `Q900` · theta_q319_body_weight_power | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | ijpo12799-tbl-0003:row4:col2 | — | not captured |
| theta_q319_body_weight_power | `Q900` · theta_q319_body_weight_power | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | ijpo12799-tbl-0003:row8:col2 | — | not captured |
