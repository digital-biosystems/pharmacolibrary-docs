...
- population split: 'shrinkage (%)' subgroup of Carlsson_2021 (paper reports 2 populations: estimate, shrinkage (%))
...
|---|---|---|---|
| `gpt-oss:120b` | primary re-run | 0.3 (3/10 fields) | 7 |
...
| `gpt-oss:120b` | `parameters[absorption rate constant]` | not captured | 0.0804 | only_one_extracted |
| `gpt-oss:120b` | `parameters[apparent clearance]` | not captured | 1.07 | only_one_extracted |
| `gpt-oss:120b` | `parameters[apparent volume of distribution]` | not captured | 13.1 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[theta_q319_body_weight_power]` | not captured | 0.762 | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_liraglutide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Carlsson_2021` / `Carlsson_2021::shrinkage`)
