...
# proportion of individuals achieving 5% weight reduction — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | liraglutide | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q27]` | 1.01 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 0.922 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 1.09 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 4.25 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 31.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 10.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 6.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 0.0813 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | 13.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | 31.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | 19.2 | not captured | only_one_extracted |
