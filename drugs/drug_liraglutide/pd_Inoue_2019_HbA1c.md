...
# HbA1c — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.398). The first reading is what the record holds.">cross-check: disputed</span>
