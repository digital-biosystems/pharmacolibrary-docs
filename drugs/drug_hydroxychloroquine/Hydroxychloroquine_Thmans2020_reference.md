...
## Model component
<dbs-pgx drug="hydroxychloroquine" model-id="Hydroxychloroquine_Thmans2020_reference" status="not_modelled" stale="false" population="COVID-19 patients" measured-compound="hydroxychloroquine" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_hydroxychloroquine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Thémans_2020` / `Thémans_2020::COVID-19 patients`)
