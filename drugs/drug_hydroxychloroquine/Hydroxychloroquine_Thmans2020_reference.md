...
- unparsed cell tab_1:row1:col2 = '869.3 (679-1130) -'
- unparsed cell tab_1:row2:col2 = '15.4 (12.1-17.6)'
- unparsed cell tab_1:row3:col1 = '0.746 (fixed)'
- unparsed cell tab_1:row5:col1 = '1.39 (0.56-2.52)'
- unparsed cell tab_1:row7:col2 = '0.13 (0.04, 0.21)'
- unparsed cell tab_1:row8:col2 = '0.26 (0.13, 0.38)'
- unparsed cell tab_1:row11:col2 = '0.028 (0.01, 0.045) 40.7'
...
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['tab_1:row1:col1', 'tab_1:row1:col3'] |
| C5_dimension_Q83 | pass | [time] | not captured | not captured | not captured | ['tab_1:row4:col4'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 9.89 | not captured | not captured | ['tab_1:row2:col1', 'tab_1:row2:col4'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_hydroxychloroquine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Thémans_2020` / `Thémans_2020::reference`)
- model: `../../../knowledgebase/drugs/drug_hydroxychloroquine/models/modelica/Hydroxychloroquine_Thmans2020_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_hydroxychloroquine/models/modelica/Hydroxychloroquine_Thmans2020_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_hydroxychloroquine/models/modelica/Hydroxychloroquine_Thmans2020_reference.json`
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_hydroxychloroquine/Hydroxychloroquine_Thmans2020_reference/Hydroxychloroquine_Thmans2020_reference.svg" alt="Hydroxychloroquine_Thmans2020_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Hydroxychloroquine_Thmans2020_reference_params.json` · controls `Hydroxychloroquine_Thmans2020_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
