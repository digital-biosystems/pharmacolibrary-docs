...
## Model component
<dbs-pgx drug="hydroxychloroquine" model-id="Hydroxychloroquine_Thmans2020_reference" status="extracted" stale="false" population="COVID-19 patients" measured-compound="hydroxychloroquine" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka (/h) | `Q49` · kabs | 0.765 | /h | not captured | [1] / [h] | not captured | exact (1.0) | tab_1:row0:col1, tab_1:row0:col4 | — | 0.94 (None% RSE) |
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_hydroxychloroquine/Hydroxychloroquine_Thmans2020_reference/Hydroxychloroquine_Thmans2020_reference_fmi.zip" download>Hydroxychloroquine_Thmans2020_reference_fmi.zip</a> <span class="pk-size">(1.2 MB)</span></td></tr>
