...
**Second reading:** `gpt-oss:120b` read this paper differently on `model.bioavailability.theta` (0.349 vs 0.283) and 6 more field(s) — a structural parameter, so the record is disputed.
