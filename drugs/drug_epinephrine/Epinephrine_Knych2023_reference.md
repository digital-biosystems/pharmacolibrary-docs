...
|---|---|---|---|---|---|---|---|---|---|---|
| tvCl (mL/min) | `Q22` · CL | —(suppressed) | mL/min | — | L/h | not captured | review (0.7) | Knych_2023:review | — | not captured |
| tvV (L) | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Knych_2023:review | — | not captured |
| tvV2 (L) | `Q64` · V2 | —(suppressed) | L | — | L | not captured | review (0.7) | Knych_2023:review | — | not captured |
| tvKa (1/h) | `Q49` · kabs | —(suppressed) | 1/h | — | 1/h | not captured | review (0.7) | Knych_2023:review | — | not captured |
