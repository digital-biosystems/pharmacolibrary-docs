...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-10 05:02 | 22:51 | 1/1/0 | 0/1/0 | 0/0/0 | 174,573/35,004 | ollama / qwen3.8:27b-mtp-q8_0 | 17 | 1/16 | 15/2 | 0 |
...
| status | detail | citation | doi |
|---|---|---|---|
| <span class="pk-badge pk-badge--red">rejected</span> | [Yoo_2015](drugs/drug_epinephrine/pd_Yoo_2015_bispectral_index.md) | Yoo H et al., Mechanism-based population pharmacokine…, European journal of clinica… (2015) | [10.1007/s00228-015-1913-0](https://doi.org/10.1007/s00228-015-1913-0) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Yoo_2015](drugs/drug_epinephrine/pd_Yoo_2015_diastolic_blood_pressure.md) | Yoo H et al., Mechanism-based population pharmacokine…, European journal of clinica… (2015) | [10.1007/s00228-015-1913-0](https://doi.org/10.1007/s00228-015-1913-0) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Yoo_2015](drugs/drug_epinephrine/pd_Yoo_2015_epinephrine.md) | Yoo H et al., Mechanism-based population pharmacokine…, European journal of clinica… (2015) | [10.1007/s00228-015-1913-0](https://doi.org/10.1007/s00228-015-1913-0) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Yoo_2015](drugs/drug_epinephrine/pd_Yoo_2015_heart_rate.md) | Yoo H et al., Mechanism-based population pharmacokine…, European journal of clinica… (2015) | [10.1007/s00228-015-1913-0](https://doi.org/10.1007/s00228-015-1913-0) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Yoo_2015](drugs/drug_epinephrine/pd_Yoo_2015_norepinephrine.md) | Yoo H et al., Mechanism-based population pharmacokine…, European journal of clinica… (2015) | [10.1007/s00228-015-1913-0](https://doi.org/10.1007/s00228-015-1913-0) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Yoo_2015](drugs/drug_epinephrine/pd_Yoo_2015_systolic_blood_pressure.md) | Yoo H et al., Mechanism-based population pharmacokine…, European journal of clinica… (2015) | [10.1007/s00228-015-1913-0](https://doi.org/10.1007/s00228-015-1913-0) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Yoo_2015](drugs/drug_epinephrine/pd_Yoo_2015_visual_analog_scale_1.md) | Yoo H et al., Mechanism-based population pharmacokine…, European journal of clinica… (2015) | [10.1007/s00228-015-1913-0](https://doi.org/10.1007/s00228-015-1913-0) |
...
|---|---|---|---|---|---|---|
| `Frechen_2015.pdf` | Frechen S et al., Population pharmacokinetic and pharmaco…, Drug metabolism and pharmac… (2015) | popPK | 10 | [10.1016/j.dmpk.2015.08.002](https://doi.org/10.1016/j.dmpk.2015.08.002) | [26615448](https://pubmed.ncbi.nlm.nih.gov/26615448) | The title confirms a population PK study of epinephrine, but the provided evidence contains no numeric parameter values. |
| `Tanimoto_2023.pdf` | Tanimoto S et al., Pharmacokinetic and pharmacodynamic com…, Annals of allergy, asthma &… (2023) | popPK | 10 | [10.1016/j.anai.2022.10.024](https://doi.org/10.1016/j.anai.2022.10.024) | [36334720](https://pubmed.ncbi.nlm.nih.gov/36334720) | The title indicates a PK study of epinephrine, but the provided evidence contains only the title and no numeric parameter values. |
...
<sub>queue written 2026-09-10T04:50:50.969228+00:00</sub>
...
| popPK | Araneda_2025 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for levobupivacaine, with epinephrine serving only as a co-administered vasoconstrictor to modify absorption, not as the subject drug. |
...
| popPK | Bodtger_2023 | irrelevant | 0 | 0 | The paper describes a diagnostic procedure (local anesthetic thoracoscopy) where epinephrine is used only as a local anesthetic adjunct, with no pharmacokinetic parameters reported. |
| popPK | Britto-Júnior_2024 | irrelevant | 0 | 0 | The study is a pharmacological investigation of catecholamine release and contractility in seminal vesicles, not a pharmacokinetic study of epinephrine. |
...
| PGx | Butcher_1986 | not_relevant | 2 | 5 | The paper studies cAMP metabolism and desensitization in a specific lymphoma cell variant, not a human pharmacogenomic effect on epinephrine PK/PD parameters. |
| PGx | Cacabelos_2017 | not_relevant | 0 | 0 | The paper is a general review of Parkinson's disease pathogenesis and pharmacogenomics, focusing on dopaminergic drugs, and does not report specific pharmacogenomic effects on the PK or PD parameters of epinephrine. |
| popPK | Cavaillon_2006 | irrelevant | 0 | 0 | The paper is a review of inflammatory pathophysiology where epinephrine is mentioned only as a neuromediator, with no pharmacokinetic parameters reported. |
| popPK | Darakjian_2019 | irrelevant | 0 | 0 | The paper focuses on caffeine disposition in pregnancy, not epinephrine. |
...
| PGx | Despres_1984 | not_relevant | 2 | 5 | The paper studies the genetic basis of the physiological response to training on lipolysis, not the pharmacokinetics or pharmacodynamics of epinephrine as a therapeutic drug. |
...
| popPK | Fleischer_2025 | relevant | 8 | 2 | The study is a PK/PD trial for epinephrine, but the evidence only provides Cmax values and lacks specific quantitative disposition parameters like clearance, volume, or half-life. |
| popPK | Frechen_2015 | relevant | 10 | 0 | The title confirms a population PK study of epinephrine, but the provided evidence contains no numeric parameter values. |
...
| PGx | Hall_2016 | not_relevant | 2 | 5 | The paper reports pharmacogenomic effects on clinical outcomes (steps, sleep, QoL) and catecholamine levels, but explicitly states that COMT genotype did not significantly affect the pharmacokinetic parameter (clonidine concentration). |
| PGx | He_2023 | not_relevant | 0 | 0 | The paper investigates the effect of epinephrine on gemcitabine resistance in cancer cells, not the pharmacokinetics or pharmacodynamics of epinephrine itself. |
...
| PGx | Ji_2005 | not_relevant | 2 | 5 | The paper reports in vitro functional differences in PNMT enzyme activity and protein stability due to SNPs, but does not report in vivo pharmacokinetic or pharmacodynamic parameters of epinephrine in humans. |
| popPK | Knych_2023 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for lidocaine, with epinephrine serving only as a co-administered vasoconstrictor, not as the subject drug. |
| PGx | Kong_2022 | not_relevant | 0 | 0 | The paper is a study protocol for a clinical trial involving formoterol and budesonide, not epinephrine, and does not report pharmacogenomic effects on PK/PD parameters. |
...
| PGx | Ljungström_2024 | not_relevant | 0 | 0 | The paper reports a case of CFS treated with AMPT and mentions COMT variants, but does not report a pharmacogenomic effect on the PK or PD parameters of epinephrine. |
...
| PGx | Lozinski_2013 | not_relevant | 0 | 0 | The paper reviews the clinical use and safety of tumescent liposuction but does not report any pharmacogenomic effects on epinephrine PK or PD parameters. |
| PGx | Lymperopoulos_2014 | not_relevant | 2 | 0 | The text is an abstract for a review article discussing general pharmacogenetics of cardiac inotropy and does not report specific quantitative pharmacokinetic or pharmacodynamic effects of gene variants on epinephrine. |
| PGx | Martineau_1994 | not_relevant | 0 | 0 | The paper investigates associations between gene variants and autism status with catecholamine levels, but does not report a pharmacogenomic effect on the PK or PD of exogenous epinephrine administration. |
| popPK | McIntyre_1996 | irrelevant | 0 | 0 | The evidence provided is a title fragment regarding pulmonary vascular smooth muscle contraction, containing no pharmacokinetic data or parameters for epinephrine. |
...
| PGx | Muslimova_2017 | not_relevant | 0 | 0 | The paper investigates pharmacogenomics of antiplatelet therapy (clopidogrel/ASA) using epinephrine only as an aggregation agonist, not as the drug of interest. |
| popPK | Nijat_2022 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of Danhong Injection compounds in rats, using adrenaline only as a model inducer, and does not report PK parameters for epinephrine. |
| popPK | Nyman_2015 | irrelevant | 0 | 0 | The paper title indicates a focus on dose-response curve modeling (EC50) rather than pharmacokinetic parameter estimation for epinephrine. |
...
| popPK | Rajnák_2024 | irrelevant | 0 | 0 | The paper is a quantum-chemical study of molecular properties and redox potentials, not a pharmacokinetic study, and contains no PK parameters for epinephrine. |
...
| popPK | Riff_2018 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of lidocaine, with epinephrine serving only as a co-administered agent in the tumescent solution. |
| PGx | Russell_2016 | not_relevant | 0 | 0 | The paper is a review discussing the potential for pharmacogenomics in sepsis and lists candidate genes for epinephrine, but it does not report any experimental data or fitted effect sizes showing how specific variants alter epinephrine's PK or PD parameters. |
...
| PGx | Shen_2014 | not_relevant | 0 | 0 | The paper studies meat quality and glycolytic gene expression in pigs, not the pharmacokinetics or pharmacodynamics of epinephrine as a drug. |
| PGx | Sim_2025 | not_relevant | 0 | 0 | The paper reviews the effectiveness of adrenaline auto-injectors for anaphylaxis and discusses general pharmacokinetics, but it does not report any pharmacogenomic effects (gene variants) on PK or PD parameters. |
| PGx | Sue_2015 | not_relevant | 0 | 0 | The paper investigates the association between SDHB mutations and tumor characteristics (metastasis, adrenaline production) in phaeochromocytoma, not the effect of a gene variant on the pharmacokinetics or pharmacodynamics of exogenous epinephrine administration. |
| PGx | Takahara_1984 | not_relevant | 0 | 0 | The study investigates the correlation between plasma catecholamine levels and platelet aggregation in patients with different cardiac conditions, but it does not report any pharmacogenomic effects (gene variants) on the PK or PD of epinephrine. |
| PGx | Tandale_2016 | not_relevant | 2 | 5 | The paper reports in silico molecular dynamics simulations and calculated binding free energies for epinephrine, but does not report in vivo pharmacokinetic or pharmacodynamic parameters (e.g., AUC, Cmax, ED50) measured in humans or animals. |
| PGx | Taneyama_1989 | not_relevant | 0 | 0 | The study investigates the physiological effects of db-cAMP and dopamine in dogs, not the impact of genetic variants on epinephrine pharmacokinetics or pharmacodynamics. |
| popPK | Tanimoto_2023 | relevant | 10 | 0 | The title indicates a PK study of epinephrine, but the provided evidence contains only the title and no numeric parameter values. |
| PGx | Tatarunas_2014 | not_relevant | 0 | 0 | The paper investigates the effect of CYP2C19 and CYP4F2 genotypes on platelet aggregation induced by epinephrine (a PD parameter of the antiplatelet drugs), not the pharmacokinetics or pharmacodynamics of epinephrine itself. |
...
| PGx | Wei_2017 | not_relevant | 0 | 0 | The paper studies the effect of stress-induced depression (phenotype) on repaglinide pharmacokinetics, not the effect of a gene variant on epinephrine pharmacokinetics or pharmacodynamics. |
| popPK | Worm_2023 | irrelevant | 2 | 1 | The paper is a review of autoinjector devices that reports only exposure metrics (Cmax, AUC, Tmax) rather than compartmental pharmacokinetic parameters (CL, V, Q, ka) for epinephrine. |
...
| popPK | Yoo_2015 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of dexmedetomidine, with epinephrine serving only as a pharmacodynamic biomarker for catecholamine release rather than the subject drug. |
| PGx | Yu_2020 | not_relevant | 0 | 0 | The paper investigates the regulation of adiponectin by POMC deficiency and sympathetic outflow, not the pharmacokinetics or pharmacodynamics of epinephrine. |

---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_epinephrine`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
