...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-18 00:35 | 10:43 | 2/1/0 | 0/1/0 | 0/0/0 | 127,520/31,428 | ollama / qwen3.8:27b-mtp-q8_0 | 17 | 1/16 | 15/2 | 0 |
...
|---|---|---|---|---|---|---|
| `Frechen_2015.pdf` | Frechen S et al., Population pharmacokinetic and pharmaco…, Drug metabolism and pharmac… (2015) | popPK | 10 | [10.1016/j.dmpk.2015.08.002](https://doi.org/10.1016/j.dmpk.2015.08.002) | [26615448](https://pubmed.ncbi.nlm.nih.gov/26615448) | The paper is a population PK/PD study of epinephrine and the abstract provides specific quantitative parameters including absorption half-life (29 min), elimination half-life (4.1 min), and bioavailability (4.7%). |
...
| `Tanimoto_2023.pdf` | Tanimoto S et al., Pharmacokinetic and pharmacodynamic com…, Annals of allergy, asthma &… (2023) | popPK | 8 | [10.1016/j.anai.2022.10.024](https://doi.org/10.1016/j.anai.2022.10.024) | [36334720](https://pubmed.ncbi.nlm.nih.gov/36334720) | The study reports PK/PD data for epinephrine, but the evidence only provides Cmax and PD endpoints (blood pressure), lacking specific quantitative disposition parameters like clearance, volume, or half-life. |
...
<sub>queue written 2026-09-18T00:25:29.299487+00:00</sub>
...
| PGx | Ljungström_2024 | not_relevant | 0 | 0 | The paper is a case report on the treatment of Chronic Fatigue Syndrome with AMPT and does not report a pharmacogenomic effect on the PK or PD of epinephrine. |
...
| popPK | Rajnák_2024 | irrelevant | 0 | 0 | The paper is a quantum-chemical study of molecular properties and redox potentials, not a pharmacokinetic study, and contains no disposition parameters for epinephrine. |
...
| PGx | Russell_2016 | not_relevant | 0 | 0 | The paper is a review discussing the potential for pharmacogenomics in sepsis and mentions epinephrine only as a drug that could be targeted, without reporting any specific gene variant effects on its PK or PD parameters. |
...
| PGx | Takahara_1984 | not_relevant | 0 | 0 | The paper reports clinical associations between plasma catecholamine levels and platelet aggregation in angina patients, but does not investigate the effect of gene variants on the pharmacokinetics or pharmacodynamics of exogenous epinephrine. |
...
| popPK | Tanimoto_2023 | relevant | 8 | 2 | The study reports PK/PD data for epinephrine, but the evidence only provides Cmax and PD endpoints (blood pressure), lacking specific quantitative disposition parameters like clearance, volume, or half-life. |
...
| popPK | Worm_2023 | relevant | 5 | 4 | The paper is a review of PK studies for epinephrine autoinjectors that reports specific Cmax, Tmax, and AUC values in the text and supplementary tables, but lacks compartmental parameters like clearance (CL) or volume (V). |
