...
# per-4-week normalized HAE attack rate — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.643). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q321]` | 18.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | not captured | 1.03 | only_one_extracted |
