...
- scholar stages: `../../../knowledgebase/drugs/drug_esomeprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Nagase_2020` / `Nagase_2020::reference`)
