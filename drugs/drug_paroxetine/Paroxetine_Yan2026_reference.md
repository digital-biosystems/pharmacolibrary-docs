...
## Model component
<dbs-pgx drug="paroxetine" model-id="Paroxetine_Yan2026_reference" status="extracted" stale="false" population="" measured-compound="paroxetine" parameterization="apparent" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_paroxetine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Yan_2026` / `Yan_2026::reference`)
...
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_paroxetine/Paroxetine_Yan2026_reference/Paroxetine_Yan2026_reference_cellml.zip" download>Paroxetine_Yan2026_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
