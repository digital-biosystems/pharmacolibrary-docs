...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-15 16:58 | 11:30 | 0/0/0 | 0/1/0 | 0/0/0 | 65,908/4,923 | ollama / qwen3.8:27b-mtp-q8_0 | 1 | 0/0 | 1/0 | 0 |
...
|---|---|---|---|---|---|---|
| `Vila_1979.pdf` | Vila Jato JL et al., [Relation between the pharmacokinetic a…, Bollettino chimico farmaceu… (1979) | popPK | 10 | not captured | [553527](https://pubmed.ncbi.nlm.nih.gov/553527) | The paper is a pharmacokinetic study of chlorpropamide in rabbits, but the provided evidence contains only the title and metadata, with no numeric parameter values present. |
| `Vila_1980.pdf` | Vila JL et al., [Relationship between pharmacokinetic a…, Bollettino chimico farmaceu… (1980) | popPK | 10 | not captured | [7459053](https://pubmed.ncbi.nlm.nih.gov/7459053) | The title confirms a pharmacokinetic study of chlorpropamide in rabbits, but no numeric parameter values are present in the provided evidence. |
| `Batenhorst_1982.pdf` | Batenhorst RL et al., Comparative bioavailability of chlorpro…, Clinical pharmacy (1982) | popPK | 8 | not captured | [7184670](https://pubmed.ncbi.nlm.nih.gov/7184670) | The study reports a two-compartment PK model for chlorpropamide, but the specific numeric parameter values (ka, CL, V, etc.) are not present in the provided text, only qualitative comparisons and statistical outcomes. |
...
<sub>queue written 2026-09-15T16:56:29.776906+00:00</sub>
...
| popPK | Batenhorst_1982 | relevant | 8 | 2 | The study reports a two-compartment PK model for chlorpropamide, but the specific numeric parameter values (ka, CL, V, etc.) are not present in the provided text, only qualitative comparisons and statistical outcomes. |
...
| popPK | Haymer_2026 | irrelevant | 0 | 0 | The paper studies cannabinoid receptor 2 agonists (amprenavir analogues) and does not report pharmacokinetic parameters for chlorpropamide. |
...
| popPK | Incerpi_1979 | irrelevant | 0 | 0 | The study is an in-vitro mechanistic investigation of enzyme activity on liver membranes and does not report pharmacokinetic parameters for chlorpropamide. |
...
| popPK | Nasr_2026 | irrelevant | 0 | 0 | The paper describes the synthesis and in vitro anticancer evaluation of thiazole-derived EGFR/CDK-2 inhibitors and does not involve chlorpropamide or pharmacokinetic parameters. |
...
| popPK | Nielsen-Kudsk_1991 | irrelevant | 0 | 0 | The study is an in-vitro pharmacological investigation of vascular smooth muscle relaxation, not a pharmacokinetic study, and reports no disposition parameters for chlorpropamide. |
...
| popPK | Prendergast_1984 | irrelevant | not captured | not captured | Chlorpropamide is only mentioned as a clinical comparator in this review focused on glyburide and glipizide, with no quantitative PK parameters provided for it. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_chlorpropamide`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
