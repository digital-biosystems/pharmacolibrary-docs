...
# cytotoxicity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Tung MH; Duc HV; Huong TT; Duong NT; Phuong do T; Thao do T; et al. et al. (2013). Scientia pharmaceutica 81
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | isobruceine B | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 0.89 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.39 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 3.73 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 2.22 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.72 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.40 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.61 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.22 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.70 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.34 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.01 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.10 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.66 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.23 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.91 | not captured | only_one_extracted |
...
---
<sub>← back to [Tocopherol](drugs/drug_tocopherol/)</sub>
