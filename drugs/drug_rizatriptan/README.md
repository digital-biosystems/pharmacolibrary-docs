...
|---|---|---|---|
| <span class="pk-badge pk-badge--red">rejected</span> | [Longmore_1996](drugs/drug_rizatriptan/pd_Longmore_1996_isometric_tension.md) | Longmore J et al., 5-HT1D receptor agonists and human coro…, British journal of clinical… (1996) | [10.1046/j.1365-2125.1996.04217.x](https://doi.org/10.1046/j.1365-2125.1996.04217.x) |
| <span class="pk-badge pk-badge--red">rejected</span> | [MaassenVanDenBrink_1998](drugs/drug_rizatriptan/pd_MaassenVanDenBrink_1998_unknown.md) | MaassenVanDenBrink A et al., Coronary side-effect potential of curre…, Circulation (1998) | [10.1161/01.cir.98.1.25](https://doi.org/10.1161/01.cir.98.1.25) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Tokuoka_2014](drugs/drug_rizatriptan/pd_Tokuoka_2014_unknown.md) | Tokuoka K et al., Theory-based analysis of clinical effic…, The journal of headache and… (2014) | [10.1186/1129-2377-15-85](https://doi.org/10.1186/1129-2377-15-85) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Tokuoka_2015](drugs/drug_rizatriptan/pd_Tokuoka_2015_headache_recurrence_rate.md) | Tokuoka K et al., Theoretical analysis of headache recurr…, The journal of headache and… (2015) | [10.1186/s10194-015-0558-9](https://doi.org/10.1186/s10194-015-0558-9) |
...
|---|---|---|---|---|---|---|
| `Lee_1998.pdf` | Lee Y et al., Pharmacokinetics and tolerability of in…, Biopharmaceutics & drug dis… (1998) | popPK | 10 | [10.1002/(sici)1099-081x(199812)19:9&lt;577::aid-bdd136&gt;3.0.co;2-w](https://doi.org/10.1002/(sici)1099-081x(199812)19:9<577::aid-bdd136>3.0.co;2-w) | [9872339](https://pubmed.ncbi.nlm.nih.gov/9872339) | The study reports quantitative PK parameters (Cl, t1/2, Vss) for rizatriptan, with specific numeric values for clearance and half-life present in the text. |
| `Lee_1999.pdf` | Lee Y et al., Pharmacokinetics and tolerability of or…, British journal of clinical… (1999) | popPK | 10 | [10.1046/j.1365-2125.1999.00917.x](https://doi.org/10.1046/j.1365-2125.1999.00917.x) | [10233200](https://pubmed.ncbi.nlm.nih.gov/10233200) | The study reports quantitative PK parameters (AUC, CL, CLr, F) for rizatriptan in humans, with specific numeric values provided in the text. |
| `Vyas_2000.pdf` | Vyas KP et al., Disposition and pharmacokinetics of the…, Drug metabolism and disposi… (2000) | popPK | 10 | not captured | [10611145](https://pubmed.ncbi.nlm.nih.gov/10611145) | The study reports quantitative PK parameters for rizatriptan, including plasma clearance (1325 ml/min), renal clearance (349 ml/min), and bioavailability (47%). |
| `Barrish_1996.pdf` | Barrish A et al., The use of stable isotope labeling and…, Rapid communications in mas… (1996) | popPK | 8 | [10.1002/(SICI)1097-0231(19960715)10:9&lt;1033::AID-RCM616&gt;3.0.CO;2-4](https://doi.org/10.1002/(SICI)1097-0231(19960715)10:9<1033::AID-RCM616>3.0.CO;2-4) | [8755236](https://pubmed.ncbi.nlm.nih.gov/8755236) | The paper describes a pharmacokinetic study of rizatriptan in dogs that reports clearance and bioavailability, but the specific numeric parameter values are not present in the provided evidence. |
| `Bhagawati_2016.pdf` | Bhagawati ST et al., Bioavailability Enhancement of Rizatrip…, Current drug delivery (2016) | popPK | 8 | [10.2174/15672018113109990048](https://doi.org/10.2174/15672018113109990048) | [26310617](https://pubmed.ncbi.nlm.nih.gov/26310617) | The study reports quantitative pharmacokinetic parameters (Tmax, Cmax, AUC, t1/2) for rizatriptan in an in vivo comparison, though it lacks a full compartmental model or explicit clearance/volume values. |
| `Chokshi_2019.pdf` | Chokshi A et al., Intranasal spray formulation containing…, International journal of ph… (2019) | popPK | 8 | [10.1016/j.ijpharm.2019.118702](https://doi.org/10.1016/j.ijpharm.2019.118702) | [31593810](https://pubmed.ncbi.nlm.nih.gov/31593810) | The study reports PK parameters (Cmax, Tmax) for rizatriptan in beagle dogs, but lacks specific clearance, volume, or half-life values required for population PK modeling. |
| `Goldberg_2001.pdf` | Goldberg MR et al., Influence of beta-adrenoceptor antagoni…, British journal of clinical… (2001) | popPK | 8 | [10.1046/j.0306-5251.2001.01417.x](https://doi.org/10.1046/j.0306-5251.2001.01417.x) | [11453892](https://pubmed.ncbi.nlm.nih.gov/11453892) | The study reports quantitative changes in rizatriptan AUC and Cmax due to drug interactions, but lacks absolute baseline PK parameter values (CL, V, t1/2) in the provided text. |
| `Musson_2001.pdf` | Musson DG et al., Pharmacokinetics of rizatriptan in heal…, International journal of cl… (2001) | popPK | 8 | not captured | [11680669](https://pubmed.ncbi.nlm.nih.gov/11680669) | The study reports quantitative PK parameters (AUC, Cmax, t1/2, renal clearance) for rizatriptan in humans, with values explicitly listed in the text. |
| `Wang_2007.pdf` | Wang C et al., Uptake and biodistribution of rizatript…, International journal of ph… (2007) | popPK | 8 | [10.1016/j.ijpharm.2006.12.039](https://doi.org/10.1016/j.ijpharm.2006.12.039) | [17267150](https://pubmed.ncbi.nlm.nih.gov/17267150) | The study reports quantitative PK parameters (bioavailability, Tmax, AUC ratios) for rizatriptan in rats, but lacks specific clearance, volume, or rate constants required for population PK modeling. |
...
| popPK | Barrish_1996 | relevant | 8 | 0 | The paper describes a pharmacokinetic study of rizatriptan in dogs that reports clearance and bioavailability, but the specific numeric parameter values are not present in the provided evidence. |
| popPK | Belvis_2014 | irrelevant | 0 | 0 | The paper is a narrative review discussing migraine treatment strategies and does not report original quantitative pharmacokinetic parameters for rizatriptan. |
...
| popPK | Belvís_2009 | irrelevant | 0 | 0 | The paper is a narrative review discussing triptan selection and does not report original quantitative pharmacokinetic parameters for rizatriptan. |
...
| PGx | Capi_2016 | not_relevant | 0 | 0 | The paper reviews eletriptan and does not report pharmacogenomic effects on rizatriptan PK/PD parameters. |
| popPK | Chen_2005 | irrelevant | 2 | 0 | The study is a bioequivalence trial reporting only relative ratios (AUC, Cmax) and does not provide absolute quantitative disposition parameters (CL, V, ka) for rizatriptan. |
...
| popPK | Fraser_2012 | relevant | 4 | 2 | The study reports standard PK metrics (AUC, Cmax) for rizatriptan but lacks the specific disposition parameters (CL, V, ka, t1/2) required for population-PK modeling. |
...
| popPK | Goldberg_2000 | irrelevant | 2 | 0 | The paper describes a tolerability study with only qualitative PK descriptions (e.g., "threefold greater" AUC) and lacks specific quantitative disposition parameters like clearance, volume, or half-life. |
| popPK | Goldberg_2001 | relevant | 8 | 2 | The study reports quantitative changes in rizatriptan AUC and Cmax due to drug interactions, but lacks absolute baseline PK parameter values (CL, V, t1/2) in the provided text. |
...
| popPK | Hokama_2007 | irrelevant | 1 | 0 | The study focuses on the pharmacokinetics of valproic acid (VPA) as the subject drug, with rizatriptan acting as a co-administered agent, and no quantitative PK parameters for rizatriptan are reported. |
| popPK | Ikemoto_2004 | relevant | 4 | 8 | The paper reports standard non-compartmental PK parameters (Cmax, AUC, Tmax, t1/2) for rizatriptan in Table 3, but lacks the specific compartmental or population PK parameters (CL, V, Q, ka) required for the target extraction. |
| popPK | Jhee_2001 | irrelevant | 2 | 0 | The paper is a comparative review that mentions rizatriptan's half-life (2 hours) but lacks quantitative disposition parameters like clearance, volume, or compartmental models required for population PK extraction. |
...
| popPK | Kassem_2016 | irrelevant | 1 | 0 | The paper is a review of formulation approaches for triptans and does not report original quantitative pharmacokinetic parameters for rizatriptan. |
| popPK | Khokhlov_2023 | irrelevant | 2 | 0 | The study is a bioequivalence trial reporting only AUC and Cmax ratios/variability, lacking compartmental PK parameters like clearance, volume, or half-life. |
...
| popPK | Milano_2017 | irrelevant | 0 | 0 | The paper is a clinical case report of serotonin syndrome and does not report any quantitative pharmacokinetic parameters for rizatriptan. |
...
| popPK | Roon_1999 | irrelevant | 0 | 0 | The study is an in-vitro pharmacological investigation of receptor-mediated vascular contraction, not a pharmacokinetic study, and reports no disposition parameters for rizatriptan. |
...
| popPK | Sciberras_1997 | irrelevant | 2 | 0 | The study reports only tmax and qualitative pharmacodynamic effects, lacking quantitative disposition parameters like clearance, volume, or half-life. |
...
| popPK | Shadle_2000 | irrelevant | 1 | 0 | The study focuses on the pharmacokinetics of oral contraceptives (EE and NET) as the subject drugs, with rizatriptan acting only as a co-administered agent to test for interactions, and no quantitative PK parameters for rizatriptan are reported. |
...
| popPK | Sharma_2016 | irrelevant | 2 | 0 | The study focuses on nasal mucociliary clearance and residence time of microspheres, not systemic pharmacokinetic parameters (CL, V, ka) for rizatriptan. |
| popPK | Sternieri_2006 | irrelevant | 1 | 0 | The paper is a review article discussing drug-drug interactions and general pharmacokinetics of headache medications without reporting original quantitative disposition parameters for rizatriptan. |
| PGx | Sternieri_2006 | not_relevant | 0 | 0 | The paper is a review of drug-drug interactions and does not report pharmacogenomic effects of gene variants on rizatriptan PK/PD. |
| popPK | Sun_2013 | irrelevant | 1 | 0 | The paper is a systematic review of trial designs and efficacy outcomes, stating that PK profiles were similar but providing no quantitative PK parameter values for rizatriptan. |
...
| PGx | Tepper_2001 | not_relevant | 0 | 0 | The paper discusses general safety and drug-drug interactions for triptans but does not report any pharmacogenomic effects (gene variants) on PK or PD parameters. |
| popPK | Tfelt-Hansen_2000 | irrelevant | 1 | 0 | The paper is a comparative review that discusses general pharmacokinetic properties (bioavailability, half-life) qualitatively but does not report specific quantitative disposition parameters (CL, V, ka) for rizatriptan. |
...
| popPK | Tfelt-Hansen_2019 | irrelevant | 1 | 0 | The paper is a review of clinical efficacy and therapeutic delay, not a pharmacokinetic study, and it does not report quantitative disposition parameters (CL, V, ka) for rizatriptan. |
...
| popPK | Van_1999 | irrelevant | 2 | 0 | The study reports only relative changes (fold-increases) in AUC and Cmax due to drug interaction, without providing absolute quantitative PK parameters (CL, V, ka) or a compartmental model for rizatriptan. |
| popPK | Vishwanathan_2000 | irrelevant | 1 | 0 | The paper describes a bioanalytical method for quantifying rizatriptan in serum but does not report any pharmacokinetic parameters (e.g., clearance, volume, half-life) or population-PK model values. |
| popPK | Wainscott_1998 | irrelevant | 0 | 0 | The paper is an in-vitro receptor binding and mechanistic study, not a pharmacokinetic study, and contains no disposition parameters for rizatriptan. |
| popPK | Wang_2007 | relevant | 8 | 2 | The study reports quantitative PK parameters (bioavailability, Tmax, AUC ratios) for rizatriptan in rats, but lacks specific clearance, volume, or rate constants required for population PK modeling. |

---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_rizatriptan`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
