...
## Model component
<dbs-pgx drug="ilaprazole" model-id="Ilaprazole_Yu2023_bootstrapping_healthy_subjects_and_patient" status="not_reviewed" stale="false" population="healthy subjects and patients with duodenal ulcer" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_ilaprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Yu_2023` / `Yu_2023::bootstrapping::healthy subjects and patients with duodenal ulcer`)
