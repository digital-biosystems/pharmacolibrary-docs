...
## Model component
<dbs-pgx drug="cabazitaxel" model-id="Cabazitaxel_Ferron2013_all_n_170" status="needs_review" stale="false" population="patients with advanced solid tumors" measured-compound="cabazitaxel" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL, L/h/m2 | `Q22` · CL | 24.2 | n = 170 | not captured | [n=170] | not captured | llm_confirmed (0.6) | Ferron_2013_table_5:row0:col1 | — | not captured |
| V1, L/m2 | `Q61` · V | 19.6 | n = 170 | not captured | [n=170] | not captured | llm_confirmed (0.6) | Ferron_2013_table_5:row1:col1 | — | not captured |
| V ss, L/m² | `Q65` · Vss | 3360 | n = 170 | not captured | [n=170] | not captured | llm (0.6) | Ferron_2013_table_5:row2:col1 | — | not captured |
| t 1/2α, min | `Q59` · t1/2α | 4.60 | n = 170 | not captured | [n=170] | not captured | llm (0.6) | Ferron_2013_table_5:row3:col1 | — | not captured |
| t 1/2β, h | `Q60` · t1/2β | 1.78 | n = 170 | not captured | [n=170] | not captured | llm (0.6) | Ferron_2013_table_5:row4:col1 | — | not captured |
| t 1/2γ, h | `Q89` · t1/2γ | 134 | n = 170 | not captured | [n=170] | not captured | llm (0.6) | Ferron_2013_table_5:row5:col1 | — | not captured |
...
- unit_dimension_unknown: 'n = 170' (CL)
- unit_dimension_unknown: 'n = 170' (V1)
- unit_dimension_unknown: 'n = 170' (Vss)
- unit_dimension_unknown: 'n = 170' (t1/2α)
- unit_dimension_unknown: 'n = 170' (t1/2β)
- unit_dimension_unknown: 'n = 170' (t1/2γ)
...
- population split: 'all(n = 170)' subgroup of Ferron_2013 (paper reports 7 populations: all(n = 170), ard6191(n = 34), efc6193(n = 67), nonmem, ted6188(n = 21), ted6189(n = 13), ted6190(n = 35))
...
| C1_half_life_beta | fail | 1.6 | 0.561 | 0.3506 | 0.25 | reported t½β |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 24.2 | not captured | not captured | ['Ferron_2013_table_5:row0:col1'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_cabazitaxel/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ferron_2013` / `Ferron_2013::all_n_170`)
