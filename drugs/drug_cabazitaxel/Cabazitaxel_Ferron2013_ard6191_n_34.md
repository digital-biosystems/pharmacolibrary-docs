...
|---|---|---|---|---|---|---|---|---|---|---|
| CL, L/h/m2 | `Q22` · CL | —(suppressed) | n = 34 | — | [n=34] | not captured | llm_confirmed (0.6) | Ferron_2013_table_5:row0:col5 | — | not captured |
| V1, L/m2 | `Q61` · V | —(suppressed) | n = 34 | — | [n=34] | not captured | llm_confirmed (0.6) | Ferron_2013_table_5:row1:col5 | — | not captured |
| V ss, L/m² | `Q65` · Vss | —(suppressed) | n = 34 | — | [n=34] | not captured | llm (0.6) | Ferron_2013_table_5:row2:col5 | — | not captured |
| t 1/2α, min | `Q59` · t1/2α | —(suppressed) | n = 34 | — | [n=34] | not captured | llm (0.6) | Ferron_2013_table_5:row3:col5 | — | not captured |
| t 1/2β, h | `Q60` · t1/2β | —(suppressed) | n = 34 | — | [n=34] | not captured | llm (0.6) | Ferron_2013_table_5:row4:col5 | — | not captured |
| t 1/2γ, h | `Q89` · t1/2γ | —(suppressed) | n = 34 | — | [n=34] | not captured | llm (0.6) | Ferron_2013_table_5:row5:col5 | — | not captured |
