...
|---|---|---|---|---|---|---|---|---|---|---|
| CL, L/h/m2 | `Q22` · CL | —(suppressed) | n = 35 | — | [n=35] | not captured | llm_confirmed (0.6) | Ferron_2013_table_5:row0:col4 | — | not captured |
| V1, L/m2 | `Q61` · V | —(suppressed) | n = 35 | — | [n=35] | not captured | llm_confirmed (0.6) | Ferron_2013_table_5:row1:col4 | — | not captured |
| V ss, L/m² | `Q65` · Vss | —(suppressed) | n = 35 | — | [n=35] | not captured | llm (0.6) | Ferron_2013_table_5:row2:col4 | — | not captured |
| t 1/2α, min | `Q59` · t1/2α | —(suppressed) | n = 35 | — | [n=35] | not captured | llm (0.6) | Ferron_2013_table_5:row3:col4 | — | not captured |
| t 1/2β, h | `Q60` · t1/2β | —(suppressed) | n = 35 | — | [n=35] | not captured | llm (0.6) | Ferron_2013_table_5:row4:col4 | — | not captured |
| t 1/2γ, h | `Q89` · t1/2γ | —(suppressed) | n = 35 | — | [n=35] | not captured | llm (0.6) | Ferron_2013_table_5:row5:col4 | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_cabazitaxel/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ferron_2013` / `Ferron_2013::ted6190_n_35`)
