...
# Tumour volume — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Li Y; Sun Y; Zhou Y; Li X; Zhang H; Zhang G et al. (2021). Journal of enzyme inhibition and medicinal chemistry 36
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | D6 | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 6.03 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 2.29 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q322]` | 19.70 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 15.35 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 11.26 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 9.35 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 13.90 | not captured | only_one_extracted |
