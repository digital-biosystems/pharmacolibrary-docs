...
# name — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.12). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model_family` | tte | unknown | mismatch |
...
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 21.5 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q54]` | not captured | 24.86 | only_one_extracted |
