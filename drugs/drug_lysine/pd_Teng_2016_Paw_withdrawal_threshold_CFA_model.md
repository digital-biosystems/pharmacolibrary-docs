...
## Citation
Teng BC; Song Y; Zhang F; Ma TY; Qi JL; Zhang HL; et al. et al. (2016). Acta pharmacologica Sinica 37
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | QO58-lysine | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q32]` | 4.34 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 18.57 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 49.78 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.51 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q56]` | 3.83 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 3.00 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 3.20 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q57]` | 2.89 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q57]` | 2.72 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q57]` | 2.98 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | 2.12 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | 1.18 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | 0.77 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | 24.03 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | 85.84 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | 281.01 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | 24.68 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | 87.30 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | 281.85 | not captured | only_one_extracted |
