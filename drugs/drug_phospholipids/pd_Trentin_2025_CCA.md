...
# Copper chelating activity — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Trentin R; Moschin E; Custódio L; Moro I et al. (2025). Biomolecules 15
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | Microglena antarctica extracts | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | 4.18 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 26.24 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 3.57 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 10.26 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.12 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 27.23 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 6.31 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 26.69 | not captured | only_one_extracted |
