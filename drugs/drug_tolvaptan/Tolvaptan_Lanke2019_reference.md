...
> ## <span class="pk-badge pk-badge--green">accepted (caveats)</span> <span class="pk-badge pk-badge--orange" title="gpt-oss:120b re-read this paper; the two readings agree on 0.818 of the compared fields. The first reading is what the record holds.">cross-check: partial</span>
