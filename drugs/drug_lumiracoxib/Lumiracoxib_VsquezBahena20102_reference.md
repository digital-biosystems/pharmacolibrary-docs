...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `AUC`, `KD`, `C0`</sub>
...
- scholar stages: `../../../knowledgebase/drugs/drug_lumiracoxib/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Vásquez-Bahena_2010_2` / `Vásquez-Bahena_2010_2::female Wistar rats with carrageenan-induced inflammation`)
