...
## Model component
<dbs-pgx drug="coagulation factor VII" model-id="CoagulationFactorVii_Klitgaard2008_healthy_japanese_and_cauc" status="extracted" stale="false" population="mixed patient populations (haemophilia, liver surgery, trauma, etc.)" measured-compound="recombinant activated factor VII" parameterization="mechanistic" topology="1C"></dbs-pgx>
