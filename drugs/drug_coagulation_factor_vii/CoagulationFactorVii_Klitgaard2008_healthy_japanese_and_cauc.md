...
## Model component
<dbs-pgx drug="coagulation factor VII" model-id="CoagulationFactorVii_Klitgaard2008_healthy_japanese_and_cauc" status="not_modelled" stale="false" population="mixed patient populations (haemophilia, liver surgery, trauma, etc.)" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_coagulation_factor_vii/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Klitgaard_2008` / `Klitgaard_2008::healthy_japanese_and_caucasian_volunteers_16::mixed patient populations (haemophilia, liver surgery, trauma, etc.)`)
