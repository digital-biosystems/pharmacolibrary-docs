...
## Model component
<dbs-pgx drug="coagulation factor VII" model-id="CoagulationFactorVii_Klitgaard2008_patients_with_cirrhosis_a" status="not_modelled" stale="false" population="mixed patient populations (haemophilia, liver surgery, trauma, etc.)" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_coagulation_factor_vii/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Klitgaard_2008` / `Klitgaard_2008::patients_with_cirrhosis_and_ugib_19_unpublished_data_klitgaard_data_on_file_2004::mixed patient populations (haemophilia, liver surgery, trauma, etc.)`)
