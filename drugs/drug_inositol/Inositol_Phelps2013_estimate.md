...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `V`, `CL`, `kel`, `t1/2z`</sub>
...
|---|---|---|---|---|---|---|---|---|---|---|
| V (volume) | `Q61` · V | —(suppressed) | volume | — | [volume] | not captured | exact (1.0) | Phelps_2013_table_4:row1:col2 | — | not captured |
| Cl (clearance) | `Q22` · CL | —(suppressed) | clearance | — | [clearance] | not captured | exact (1.0) | Phelps_2013_table_4:row2:col2 | — | not captured |
| k (elimination rate; Cl/V) | `Q47` · kel | —(suppressed) | elimination rate; Cl/V | — | [eliminationrate] | not captured | exact (1.0) | Phelps_2013_table_4:row6:col2 | — | not captured |
| t1/2 (half-life; 0.693/k) | `Q57` · t1/2z | —(suppressed) | half-life; 0.693/k | — | [h] · [l] · [alf] · [ife] | not captured | exact (1.0) | Phelps_2013_table_4:row7:col2 | — | not captured |
| E (endogenous concentration; R/Cl) | `Q38` · E | —(suppressed) | endogenous concentration; R/Cl | — | [endogenousconcentration] | not captured | exact (1.0) | Phelps_2013_table_4:row8:col2 | — | not captured |
