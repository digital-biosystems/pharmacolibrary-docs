...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-10 23:55 | 21:45 | 0/0/0 | 0/0/0 | 0/0/0 | 185,671/5,849 | ollama / qwen3.8:27b-mtp-q8_0 | 23 | 3/20 | 23/0 | 0 |
...
- **PubMed hits:** 587 matched, 81 returned
...
<sub>queue written 2026-09-10T23:55:30.367297+00:00</sub>
...
| popPK | Hu_2015 | irrelevant | 0 | 0 | The paper is a fluid dynamics study on mucus plug rupture using Carbopol gels and PDMS channels, not a pharmacokinetic study of silicones. |
...
| popPK | Noonan_1985 | irrelevant | 0 | 0 | The paper studies the pulmonary microcirculatory effects of leukotrienes in sheep and does not involve silicones or pharmacokinetic parameters. |
...
| popPK | Sandor_1986 | irrelevant | 0 | 0 | The study focuses on cerebral blood volume measurement in rats using morphine and naloxone, with silicone mentioned only as a material for a sensor component, not as a pharmacokinetic subject. |
| popPK | Sarangi_2024 | irrelevant | 0 | 0 | The study focuses on the passive permeability of antidepressants (imipramine and desipramine) through lipid bilayers, not the pharmacokinetics of silicones. |
...
| popPK | Wright_1971 | irrelevant | 0 | 0 | The study evaluates silicone as a lubricant in joints and reports qualitative retention times (e.g., &lt;48 hours) rather than quantitative pharmacokinetic parameters like clearance, volume, or rate constants. |
...
| popPK | Xu_2022_2 | irrelevant | 0 | 0 | The paper studies the antibiofilm activity of cinnamaldehyde-chitosan nanoparticles on Staphylococcus aureus, with silicone mentioned only as the surface material for biofilm growth, not as the subject drug for pharmacokinetic analysis. |
| popPK | Yang_2021 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of erlotinib, not silicones. |
| popPK | Yu_2025 | irrelevant | 0 | 0 | The paper describes a silicone-based wound healing patch and does not report any pharmacokinetic parameters for silicones as a drug. |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_silicones`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
