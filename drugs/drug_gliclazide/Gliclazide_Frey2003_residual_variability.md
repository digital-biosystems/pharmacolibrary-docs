...
|---|---|---|---|---|---|---|---|---|---|---|
| Gliclazide AUC 50 (mg.h ml -1 ) | `Q19` · AUCt | —(suppressed) | mg.h ml -1 | — | [[h] · [mg]] / [ml] | not captured | llm_corrected (0.6) | tab_1:row9:col2, tab_1:row9:col4 | — | not captured |
...
<img src="drugs/drug_gliclazide/Gliclazide_Frey2003_residual_variability/Gliclazide_Frey2003_residual_variability.svg" alt="Gliclazide_Frey2003_residual_variability diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_1C_enteral` · parameters `Gliclazide_Frey2003_residual_variability_params.json` · controls `Gliclazide_Frey2003_residual_variability_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
