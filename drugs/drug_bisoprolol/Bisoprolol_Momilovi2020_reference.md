...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[apparent clearance]` (not captured vs 6.45) and 1 more field(s) — a structural parameter, so the record is disputed.
