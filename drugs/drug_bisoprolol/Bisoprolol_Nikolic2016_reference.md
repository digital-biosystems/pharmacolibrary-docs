...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F, l/h | `Q27` · CL/F | —(suppressed) | not captured | — | not captured | not captured | boundary (0.8) | tab_1:row2:col1, tab_1:row2:col2, tab_1:row2:col3, tab_1:row2:col4 | — | not captured |
| Volume of distribution, l | `Q61` · V | —(suppressed) | not captured | — | not captured | not captured | boundary (0.8) | tab_1:row3:col1, tab_1:row3:col2, tab_1:row3:col3, tab_1:row3:col4 | — | not captured |
| CLcr, l/h | `Q26` · CLR | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | tab_1:row4:col1, tab_1:row4:col2, tab_1:row4:col3, tab_1:row4:col4 | — | not captured |
