...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (mL/day) | `Q22` · CL | —(suppressed) | mL/day | — | L/h | not captured | review (0.7) | Han_2024:review | — | not captured |
| Vz (mL) | `Q61` · V | —(suppressed) | mL | — | L | not captured | review (0.7) | Han_2024:review | — | not captured |
