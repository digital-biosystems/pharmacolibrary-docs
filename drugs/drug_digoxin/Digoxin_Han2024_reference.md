...
## Citation
Han LW; Jamalian S; Hsu JC; Sheng XR; Yang X; Yang X; Monemi S; Hassan S; Yadav R; Tuckwell K; Kunder R; Pan L; Glickstein S et al. (2024). Rheumatology and therapy 11
  ·  DOI: [10.1007/s40744-024-00670-5](https://doi.org/10.1007/s40744-024-00670-5)

## Model component
<dbs-pgx drug="digoxin" model-id="Digoxin_Han2024_reference" status="needs_review" stale="false" population="" measured-compound="digoxin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (mL/day) | `Q22` · CL | 218.0 | mL/day | 2.523148148148148e-09 | L/h | not captured | review (0.7) | Han_2024:review | — | not captured |
| Vz (mL) | `Q61` · V | 6290.0 | mL | 0.00629 | L | not captured | review (0.7) | Han_2024:review | — | not captured |
...
- built from REVIEW reference values (Han_2024) — secondary source
...
- scholar stages: `../../../knowledgebase/drugs/drug_digoxin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Han_2024` / `Han_2024::reference`)
