...
## Model component
<dbs-pgx drug="digoxin" model-id="Digoxin_Komatsu2015_reference" status="not_modelled" stale="false" population="adult patients" measured-compound="digoxin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_digoxin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Komatsu_2015` / `Komatsu_2015::adult patients`)
