...
|---|---|---|---|---|---|---|---|---|---|---|
| CL/F, L/h | `Q27` · CL/F | 6.215 | not captured | not captured | not captured | 2.830 | llm_confirmed (0.6) | Tab3:row2:col1, Tab3:row2:col2, Tab3:row2:col3, Tab3:row2:col4 | — | not captured |
| Vd/F, L/kg (fixed) | `Q76` · V/F | 6.000 | fixed | not captured | [fixed] | not captured | llm_confirmed (0.6) | Tab3:row5:col1, Tab3:row5:col3 | — | not captured |
| ka, h−1 (fixed) | `Q49` · kabs | 1.000 | fixed | not captured | [fixed] | not captured | llm_confirmed (0.6) | Tab3:row6:col1, Tab3:row6:col3 | — | not captured |
