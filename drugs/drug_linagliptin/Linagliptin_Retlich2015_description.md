...
|---|---|---|---|---|---|---|---|---|---|---|
| V C/F (L) | `Q76` · V/F | —(suppressed) | L | — | L | not captured | space_fold (0.95) | Retlich_2015:results_prose | — | not captured |
| CL/F (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | L/h | not captured | exact (1.0) | Retlich_2015:results_prose | — | not captured |
| KA [h -1 ] | `Q49` · kabs | —(suppressed) | h -1 | — | 1/h | not captured | review_gapfill (0.7) | Tadayasu_2013:review | — | not captured |
