...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `Bmax`</sub>
...
|---|---|---|---|---|---|---|---|---|---|---|
| K a,1 (1/h) | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab4:row5:col1 | — | not captured |
| K a,2 (1/h) | `Q95` · t1/2ka | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab4:row6:col1 | — | not captured |
| K a,3 (1/h) | `Q303` · k13 | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab4:row7:col1 | — | not captured |
| V C/F (L) | `Q290` · V1/F | —(suppressed) | L | — | [l] | not captured | space_fold (0.95) | Tab4:row9:col1 | — | not captured |
| Q P/F (L/h)d | `Q69` · Q/F | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab4:row10:col1 | — | not captured |
| V P/F (L)d | `Q61` · V | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab4:row11:col1 | — | not captured |
| CL/F (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | Tab4:row12:col1 | — | not captured |
| B max,C (nmol/L) | `Q332` · Bmax | —(suppressed) | nmol/L | — | [nM] / [l] | not captured | llm (0.6) | Tab4:row14:col1 | — | not captured |
| DPP_B max,C g | `Q32` · Cmax | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab4:row15:col1 | — | not captured |
| K d (nmol/L)d | `Q331` · KD | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab4:row19:col1 | — | not captured |
| Corr F_CL | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Tab4:row23:col1 | — | not captured |
