...
|---|---|---|---|---|---|---|---|---|---|---|
| F1 | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | tab_2:row2:col1 | — | 46.7 (None% RSE) |
| KA [h -1 ] | `Q49` · kabs | —(suppressed) | not captured | — | not captured | 22.2 | llm_confirmed (0.6) | tab_2:row3:col1, tab_2:row3:col2 | — | 73.6 (None% RSE) |
| CL/F1 [L/h] | `Q27` · CL/F | —(suppressed) | not captured | — | not captured | 15.5 | llm (0.6) | tab_2:row4:col1, tab_2:row4:col2 | — | not captured |
| V2/F1 [L] | `Q82` · V2/F | —(suppressed) | not captured | — | not captured | 12.7 | llm (0.6) | tab_2:row5:col1, tab_2:row5:col2 | — | not captured |
| Q3/F1 [L/h] | `Q309` · Q3/F | —(suppressed) | not captured | — | not captured | 68.8 | llm (0.6) | tab_2:row7:col1, tab_2:row7:col2 | — | not captured |
| V3/F1 [L] | `Q78` · V3/F | —(suppressed) | not captured | — | not captured | 14.0 | llm (0.6) | tab_2:row9:col1, tab_2:row9:col2 | — | not captured |
| BMAX [nmol/L] | `Q332` · Bmax | —(suppressed) | not captured | — | not captured | 5.17 | llm_confirmed (0.6) | tab_2:row11:col1, tab_2:row11:col2 | — | 14.2 (None% RSE) |
| KD [nmol/L] | `Q331` · KD | —(suppressed) | not captured | — | not captured | 28.5 | llm_confirmed (0.6) | tab_2:row13:col1, tab_2:row13:col2 | — | not captured |
