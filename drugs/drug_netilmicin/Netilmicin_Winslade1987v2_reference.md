...
## Model component
<dbs-pgx drug="netilmicin" model-id="Netilmicin_Winslade1987v2_reference" status="extracted" stale="false" population="normal volunteers" measured-compound="tobramycin and netilmicin" parameterization="mechanistic" topology="1C"></dbs-pgx>
