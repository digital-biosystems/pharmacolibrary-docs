...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[3]` | not captured | 318.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[total body clearance for netilmicin]` | not captured | 48 | only_one_extracted |
| `gpt-oss:120b` | `parameters[total body clearance for netilmicin]` | 48 | not captured | only_one_extracted |
| `gpt-oss:120b` | `screen.dose_compound` | tobramycin and netilmicin | netilmicin, tobramycin | mismatch |
| `gpt-oss:120b` | `screen.primary_analyte` | tobramycin and netilmicin | netilmicin, tobramycin | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_netilmicin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Winslade_1987_2` / `Winslade_1987_2::reference`)
- model: `../../../knowledgebase/drugs/drug_netilmicin/models/modelica/_needs_review/Netilmicin_Winslade1987v2_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_netilmicin/models/modelica/_needs_review/Netilmicin_Winslade1987v2_reference.deviation.json`
