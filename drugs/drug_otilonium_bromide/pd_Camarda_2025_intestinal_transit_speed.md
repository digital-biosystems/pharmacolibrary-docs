...
## Citation
Camarda L; Corazza I; Locatelli A; Leoni A; Frosini M; Budriesi R; et al. et al. (2025). Pharmaceuticals (Basel, Switzerland) 18
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | 1,4-dihydropyridine derivatives (compounds 62 and 65) | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 0.0019 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 3.43 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.20 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 2.46 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.30 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.10 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.75 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.049 | not captured | only_one_extracted |
...
---
<sub>← back to [otilonium bromide](drugs/drug_otilonium_bromide/)</sub>
