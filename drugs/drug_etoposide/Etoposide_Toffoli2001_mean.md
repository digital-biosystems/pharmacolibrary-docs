...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (l h x1 ) | `Q22` · CL | 1.14 | l h x1 | not captured | [h] · [l] · [x1] | not captured | exact (1.0) | tab_1:row1:col1 | — | not captured |
| V (l) | `Q61` · V | 6.0 | l | 0.006 | [l] | not captured | exact (1.0) | tab_1:row2:col1 | — | not captured |
| k 12 (h x1 ) | `Q301` · k12 | 0.14 | h x1 | not captured | [h] · [x1] | not captured | space_fold (0.95) | tab_1:row3:col1 | — | not captured |
| k 21 (h x1 ) | `Q302` · k21 | 0.06 | h x1 | not captured | [h] · [x1] | not captured | space_fold (0.95) | tab_1:row4:col1 | — | not captured |
