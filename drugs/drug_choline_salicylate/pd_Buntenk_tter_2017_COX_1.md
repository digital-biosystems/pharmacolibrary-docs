...
# COX-1 inhibition — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Buntenkötter K; Osmers M; Schenk I; Schänzer W; Machnik M; Düe M; et al. et al. (2017). BMC veterinary research 13
...
|---|---|---|---|
| `gpt-oss:120b` | secondary_empty | 0.0 (0/26 fields) | 26 |
...
| `gpt-oss:120b` | `parameters[Q27]` | 82.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 97.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 114.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 19.75 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 30.06 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 51.66 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | 0.145 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | 0.148 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | 0.145 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q53]` | 7.26 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q53]` | 7.81 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q53]` | 8.39 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 2.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 2.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q56]` | 2.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q57]` | 5.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q57]` | 5.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q57]` | 5.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 154.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 264.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q74]` | 457.1 | not captured | only_one_extracted |
