...
# inhibition rate — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.588). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.588 (20/34 fields) | 14 |

<details><summary>14 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | phenazine-1-carboxylic acid ester conjugates | hydroxybenzoic acid ester conjugate (5c) | mismatch |
| `gpt-oss:120b` | `model_family` | unknown | emax | mismatch |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 1.76 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 3.84 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 4.72 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | 5.08 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q344]` | not captured | 4.86 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q344]` | not captured | 5.05 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 0.15 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 0.30 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 3.71 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 1.00 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 0.30 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 2.19 | only_one_extracted |
