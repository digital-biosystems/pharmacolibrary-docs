...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.6 (33/55 fields) | 22 |

<details><summary>22 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | acetylsalicylic acid | acetylsalicylic acid (ASA) | mismatch |
...
| `gpt-oss:120b` | `parameters[Q312]` | not captured | 1.09 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q314]` | not captured | 0.27 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | not captured | 15 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | not captured | 11.9 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q336]` | not captured | 0.49 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q351]` | not captured | 0.24 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q351]` | 11.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.24 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q49]` | not captured | 21.8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | not captured | 0.053 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q95]` | 21.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q95]` | 0.053 | not captured | only_one_extracted |
