...
**Second reading:** `gpt-oss:120b` read this paper differently on `screen.dose_compound` (rac-carvedilol vs carvedilol) and 11 more field(s) — a structural parameter, so the record is disputed.
