...
# UGT2B7 — PGx  <span class="pk-badge pk-badge--neutral">evidence_only</span> <span class="pk-badge pk-badge--green" title="re-read by gpt-oss:120b (confirmed, agreement 1.0). The first reading is what the record holds.">cross-checked ✓</span>
...
## Citation
Takekuma Y; Takenaka T; Kiyokawa M; Yamazaki K; Okamoto H; Kitabatake A; et al. et al. (2007). Biological & pharmaceutical bulletin 30
  ·  DOI: [10.1248/bpb.30.537](https://doi.org/10.1248/bpb.30.537)
...
---
<sub>← back to [carvedilol](drugs/drug_carvedilol/)</sub>
