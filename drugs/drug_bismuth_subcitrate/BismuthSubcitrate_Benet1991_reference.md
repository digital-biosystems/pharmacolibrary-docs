...
- scholar stages: `../../../knowledgebase/drugs/drug_bismuth_subcitrate/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Benet_1991` / `Benet_1991::adults`)
