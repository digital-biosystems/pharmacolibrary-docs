...
| Clearance of dexamethasone | `Q22` · CL | 24.7 | % | not captured | [%] | not captured | llm_confirmed (0.6) | Nakade_2008:abstract, Nakade_2008:abstract | — | not captured |
...
- routed 'intra-individual variability' → Q312 (IIV) to iiv — variability estimate, not a structural parameter
- unit_dimension_mismatch: 'Clearance of dexamethasone' → Q22 (unit 'dimensionless' vs ontology '[length] ** 3 / [time]') — route to review
- apparent-ness (ontology-grounded): parameterization=apparent, measured_compound=aprepitant
- held at status:extracted — NIL link or unit issue (mismatch/unknown/normalisation-failed) present
- status held at route_to_review — not promoted
- abstract-only: no full text was available, so these values were read from the abstract's prose — reported summary statistics, not a fitted model

**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Nakade_2008_metadata.yaml (10 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_aprepitant/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Nakade_2008` / `Nakade_2008::reference`)
