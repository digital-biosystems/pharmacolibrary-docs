...
# P/F — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|
| `gpt-oss:120b` | secondary_empty | 0.0 (0/39 fields) | 39 |

<details><summary>39 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | imatinib | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q19]` | 0.56 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.38 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.0046 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.50 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.31 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.0044 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.93 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.86 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.087 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.93 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.81 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.36 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.44 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.29 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.58 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.33 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | 0.066 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.73 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.60 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.0014 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.78 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.61 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.032 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.51 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.34 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.001 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.61 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.36 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.062 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.76 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.51 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.17 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 1.15 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.72 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q37]` | 0.56 | not captured | only_one_extracted |
