...
# Liberation of oxygen supplementation — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.773). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.773 (34/44 fields) | 10 |
...
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 0.44 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 0.29 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 0.58 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 0.33 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 0.066 | only_one_extracted |
