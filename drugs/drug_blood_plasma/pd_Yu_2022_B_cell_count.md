# B cell count — PD  <span class="pk-badge pk-badge--red">rejected</span>
...
| kdes (year−1) — Inter-individual variability | `Q358` · not captured | 0.654 | year−1 | not captured | llm (not captured) | Tab3:row22:col3 |
...
| B0 (cells/µL) — Inter-individual variability | `Q324` · not captured | 0.394 | cells/µL | not captured | llm (not captured) | Tab3:row25:col3 |
...
| Corr_Vb_Emax — Estimate | `Q30` · not captured | 0.28 | Q,IV | not captured | llm (not captured) | Tab3:row38:col1 |
...
| Ofatumumab conc. proportional — RSE % | `Q316` · not captured | 1.72 | Q,IV | not captured | llm (not captured) | Tab3:row48:col2 |
