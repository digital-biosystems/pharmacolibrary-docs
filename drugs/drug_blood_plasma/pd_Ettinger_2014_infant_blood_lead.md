...
# name — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.333). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Ettinger AS; Roy A; Amarasiriwardena CJ; Smith D; Lupoli N; Mercado-García A; et al. et al. (2014). Environmental health perspectives 122
  ·  DOI: [10.1289/ehp.1307187](https://doi.org/10.1289/ehp.1307187)
...
| `gpt-oss:120b` | `parameters[Q32]` | not captured | 0.02 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q44]` | not captured | 2.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q44]` | not captured | 0.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q75]` | not captured | 0.01 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | not captured | not captured | only_one_extracted |
