...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | DSM265 | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q30]` | 0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q40]` | 1 | not captured | only_one_extracted |
