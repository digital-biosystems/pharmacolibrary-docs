...
# HIV-1 infection probability — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Iannuzzi S; Müller M; Yu Y; Zhang L; Hendrix CW; Bies RR; von Kleist M et al. (2026). Nature communications 17
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | TFV-DP and FTC-TP | not captured | mismatch |
