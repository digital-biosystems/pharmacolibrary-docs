...
|---|---|---|---|---|---|---|---|---|---|---|
| Ke (1/h) | `Q47` · kel | —(suppressed) | not captured | — | not captured | 54.3 | exact (1.0) | T4:row1:col2, T4:row1:col3 | — | not captured |
| Vc/F (L) | `Q290` · V1/F | —(suppressed) | L | — | [l] | 56.3 | exact (1.0) | T4:row2:col2, T4:row2:col3 | — | not captured |
| Ka (1/h) | `Q49` · kabs | —(suppressed) | not captured | — | not captured | 29 | exact (1.0) | T4:row3:col2, T4:row3:col3 | — | not captured |
| Vb/F (L) | `Q76` · V/F | —(suppressed) | L | — | [l] | 125 | llm (0.6) | T4:row6:col2, T4:row6:col3 | — | not captured |
| Klc (1/h) | `Q410` · Kp | —(suppressed) | not captured | — | not captured | 94.5 | llm (0.6) | T4:row8:col2, T4:row8:col3 | — | not captured |
| Kpc (1/h) | `Q302` · k21 | —(suppressed) | not captured | — | not captured | 88.7 | exact (1.0) | T4:row12:col2, T4:row12:col3 | — | not captured |
| Kcp (1/h) | `Q301` · k12 | —(suppressed) | not captured | — | not captured | 122 | exact (1.0) | T4:row13:col2, T4:row13:col3 | — | not captured |
