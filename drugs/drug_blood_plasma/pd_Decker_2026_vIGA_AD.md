...
# vIGA-AD 0 or 1 at Week 16 — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.719). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.719 (23/32 fields) | 9 |

<details><summary>9 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q27]` | not captured | 62.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q290]` | not captured | 57.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 5.84 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 58.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 57.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 62.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q67]` | not captured | 0.311 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q79]` | not captured | 5.84 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q79]` | not captured | 58.4 | only_one_extracted |
