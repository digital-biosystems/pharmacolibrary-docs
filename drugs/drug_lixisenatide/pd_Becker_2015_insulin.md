...
| `gpt-oss:120b` | `parameters[Q19]` | -31.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q19]` | -61.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | -0.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | -0.8 | not captured | only_one_extracted |
