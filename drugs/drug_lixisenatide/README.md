...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-14 16:10 | 12:16 | 0/0/0 | 1/5/0 | 0/0/0 | 210,435/4,166 | ollama / qwen3.8:27b-mtp-q8_0 | 75 | 5/52 | 73/2 | 0 |
...
|---|---|---|---|
| <span class="pk-badge pk-badge--green">extracted</span> | [Goeyvaerts_2026](drugs/drug_lixisenatide/pd_Goeyvaerts_2026_DENV_3_RNA.md) | Goeyvaerts N et al., Viral Dynamic Model-Informed Dose Selec…, Clinical pharmacology and t… (2026) | [10.1002/cpt.70439](https://doi.org/10.1002/cpt.70439) |
...
|---|---|---|---|---|---|
| popPK | Barrett_2025 | irrelevant | 0 | 0 | The paper is a health economics and outcomes research study comparing weight loss and costs, containing no pharmacokinetic data for lixisenatide. |
...
| popPK | Davidson_2015 | irrelevant | 0 | 0 | The paper is a review discussing clinical efficacy and cardiovascular outcomes of GLP-1 RAs, containing no original pharmacokinetic data or quantitative disposition parameters for lixisenatide. |
...
| popPK | Goeyvaerts_2026 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of mosnodenvir, not lixisenatide. |
...
| popPK | Hölscher_2025 | irrelevant | 0 | 0 | The paper is a review of incretin hormones in neurodegenerative diseases and does not report quantitative pharmacokinetic parameters for lixisenatide. |
| popPK | Hölscher_2026 | irrelevant | 1 | 0 | This is a review article focusing on neuroprotection and BBB penetration, not a pharmacokinetic study, and it only cites a general half-life value for lixisenatide without reporting quantitative disposition parameters like clearance or volume. |
...
| popPK | Khoei_2026 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of dolutegravir, not lixisenatide. |
...
| popPK | Kim_2026 | irrelevant | 0 | 0 | The paper reports population pharmacokinetic parameters for bevacizumab (CT-P16), not lixisenatide. |
...
| popPK | Li_2018 | irrelevant | 0 | 0 | The paper is a review of cardiovascular outcomes and does not report quantitative pharmacokinetic parameters for lixisenatide. |
...
| popPK | Lund_2014 | irrelevant | 0 | 0 | The paper is a review article discussing clinical data and general pharmacokinetic differences of GLP-1 receptor agonists, but it does not report original quantitative population-pharmacokinetic parameter values for lixisenatide. |
...
| popPK | McCarty_2017 | irrelevant | 1 | 0 | The paper is a narrative review of pharmacology and clinical efficacy without original quantitative pharmacokinetic parameter values (e.g., CL, V, ka) for lixisenatide. |
...
| popPK | Nauck_2019 | irrelevant | 1 | 0 | The paper is a clinical review comparing GLP-1 agonists and does not report original quantitative pharmacokinetic parameters (CL, V, etc.) for lixisenatide. |
| popPK | Nauck_2021 | irrelevant | 2 | 1 | This is a narrative review of GLP-1 receptor agonists that lists a half-life for lixisenatide in a summary table but does not report quantitative disposition parameters like clearance, volume, or compartmental model parameters. |
...
| popPK | Petersen_2013 | irrelevant | 2 | 1 | The paper is a review that mentions a half-life range but lacks quantitative compartmental PK parameters (CL, V, Q, ka) or population model data. |
...
| popPK | Sethuramalingam_2026 | irrelevant | 0 | 0 | The study reports population pharmacokinetic parameters for asparaginase (N-Asp and P-Asp), not lixisenatide. |
...
| popPK | Sfairopoulos_2018 | irrelevant | 0 | 0 | The paper is a clinical review of GLP-1 receptor agonists that discusses pharmacological properties qualitatively but does not report quantitative pharmacokinetic parameters (e.g., clearance, volume) for lixisenatide. |
| popPK | Sharma_2018 | irrelevant | 2 | 0 | The paper is a review article discussing GLP-1 agonists generally and does not provide specific quantitative PK parameter values for lixisenatide in the provided text. |
...
| popPK | Tan_2026 | irrelevant | 0 | 0 | The study focuses on busulfan pharmacokinetics and does not involve lixisenatide. |
...
| popPK | Tan_2026_2 | irrelevant | 0 | 0 | The paper focuses on the population pharmacokinetics of 5-fluorouracil, not lixisenatide. |
...
| popPK | Tong_2026 | irrelevant | 0 | 0 | The paper reports population pharmacokinetic parameters for aminoglycosides (amikacin, gentamicin, tobramycin), not lixisenatide. |
...
| popPK | Wanika_2026 | irrelevant | 0 | 0 | The paper is a methodological case study using simulated data for a generic drug (Monolix Oral1 demo) to demonstrate uncertainty quantification metrics, and does not report pharmacokinetic parameters for lixisenatide. |
...
| popPK | Whyte_2019 | irrelevant | 1 | 0 | The study focuses on the pharmacodynamic effects of lixisenatide on lipid and glucose kinetics (clearance of chylomicron TAG), not the pharmacokinetic disposition parameters (CL, V, ka) of the drug itself. |
| popPK | Wu_2026 | irrelevant | 0 | 0 | The study focuses on growth hormone (rhGH/PEG-rhGH) pharmacokinetics and does not involve lixisenatide. |
...
| popPK | van_2017 | irrelevant | 2 | 0 | The study focuses on a PKPD framework for carcinogenicity in rodents and does not report quantitative human PK disposition parameters (CL, V, etc.) for lixisenatide in the provided evidence. |
