...
|---|---|---|---|---|---|---|---|---|---|---|
| central compartment volume of distribution (Vc) | `Q63` · V1 | 14.0 | %CV | not captured | %CV | not captured | boundary (0.8) | Li_2019:results_prose | — | not captured |
| peripheral volume of distribution (Vp) | `Q61` · V | 45.4 | %CV | not captured | %CV | not captured | boundary (0.8) | Li_2019:results_prose | — | not captured |
...
- salvaged Q61 ('peripheral volume of distribution (Vp)'=45.4) from results prose — parameter table was unreadable
...
| C5_unit_missing_Q61 | fail | [length] ** 3 | %CV | not captured | not captured | ['Li_2019:results_prose'] |
| C5_unit_missing_Q63 | fail | [length] ** 3 | %CV | not captured | not captured | ['Li_2019:results_prose'] |
