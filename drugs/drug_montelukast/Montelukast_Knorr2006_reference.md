...
|---|---|---|---|---|---|---|---|---|---|---|
| AUC(pop) | `Q88` · AUC | 3644.3 | ng x h/mL | not captured | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Knorr_2006:abstract, Knorr_2006:abstract | — | not captured |
...
- unit_dimension_unknown: 'ng x h/mL' (AUC)
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Knorr_2006_metadata.yaml (2 record(s)); values are summary statistics, not a fitted model
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[auc]` | 3644.3 | not captured | only_one_extracted |
...
| C5_unit_missing_Q88 | fail | [mass] * [time] / [length] ** 3 | ng x h/mL | not captured | not captured | ['Knorr_2006:abstract', 'Knorr_2006:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_montelukast/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Knorr_2006` / `Knorr_2006::reference`)
