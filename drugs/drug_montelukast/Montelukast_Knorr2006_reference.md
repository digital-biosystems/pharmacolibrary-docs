...
## Model component
<dbs-pgx drug="montelukast" model-id="Montelukast_Knorr2006_reference" status="needs_review" stale="false" population="infants aged 3 to 6 months" measured-compound="montelukast" parameterization="mechanistic" topology="1C"></dbs-pgx>
