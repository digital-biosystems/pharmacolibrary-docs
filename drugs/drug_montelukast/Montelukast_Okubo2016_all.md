...
> ⚠️ **STALE** — review status `needs_review` (reviewed 2026-09-17 23:33:24.414869+00:00) predates the upstream re-run (2026-09-24 17:00:42.042880+00:00). Current validate status: `needs_review`.
...
## Model component
<dbs-pgx drug="montelukast" model-id="Montelukast_Okubo2016_all" status="needs_review" stale="true" population="paediatric Japanese patients with perennial allergic rhinitis" measured-compound="montelukast" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Montelukast clearance (L/h) | `Q22` · CL | 0.87 | L/h | 2.4166666666666665e-07 | L/h | not captured | review_gapfill (0.7) | Li_2019:review | — | not captured |
...
- column 'all' classified 'other' by the LLM but kept: the deterministic diagnostic-column test disagrees (a stratum column is a value column, not a statistic)
- dropped unlinked row (NIL): 'Mean (SD)' — extend the ontology if this is a real PK parameter (source ['t0003:row3:col4', 't0003:row6:col4', 't0003:row9:col4', 't0003:row12:col4'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=montelukast
- population split: 'all' subgroup of Okubo_2016 (paper reports 4 populations: 10–15 years old, 1–5 years old, 6–9 years old, all)
...
| C5_dimension_Q17 | pass | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['t0003:row2:col4'] |
...
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['t0003:row8:col4'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_montelukast/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Okubo_2016` / `Okubo_2016::all`)
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-24 17:00 UTC</sub>
