...
| tn.+ tIag | `Q83` · tlag | 2.0825 | not captured | not captured | not captured | not captured | llm (0.6) | tab_1:row9:col2 | — | not captured |
| Cmax | `Q32` · Cmax | 5.7500 | not captured | not captured | not captured | not captured | exact (1.0) | tab_1:row10:col4 | — | not captured |
| AUC | `Q88` · AUC | 185.51 | not captured | not captured | not captured | not captured | exact (1.0) | tab_1:row15:col2, Carceles_1995_3_table_1:row13:col2 | — | not captured |
| AUC | `Q88` · AUC | 20.90 | not captured | not captured | not captured | not captured | exact (1.0) | tab_1:row15:col4 | — | not captured |
...
| k21 | `Q302` · k21 | 3.0391 | not captured | not captured | not captured | not captured | exact (1.0) | Carceles_1995_3_table_1:row7:col2 | — | not captured |
| CL | `Q22` · CL | 0.1097 | not captured | not captured | not captured | not captured | exact (1.0) | Carceles_1995_3_table_1:row9:col2 | — | not captured |
| t1/2a | `Q59` · t1/2α | 0.1014 | not captured | not captured | not captured | not captured | llm_corrected (0.6) | Carceles_1995_3_table_1:row10:col2 | — | not captured |
| MRT | `Q53` · MRT | 1.57 | not captured | not captured | not captured | not captured | exact (1.0) | Carceles_1995_3_table_1:row14:col2 | — | not captured |
...
| T3_param_coverage | not captured | fail | 6 scholar param(s) emitted or defaulted | 5 covered | not captured | neither emitted nor in defaulted[]: ['k21'] |
