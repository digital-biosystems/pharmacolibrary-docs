...
> ## <span class="pk-badge pk-badge--orange">built, not shipped</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.75 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.75 (24/32 fields) · the first reading is what this page shows

<details><summary>8 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[13].parameter_id` | Q307 | Q67 | mismatch |
| `parameters[13].parameter_id` | Q307 | Q67 | mismatch |
| `parameters[b].parameter_id` | Q302 | Q68 | mismatch |
| `parameters[b].parameter_id` | Q302 | Q68 | mismatch |
| `parameters[b].parameter_id` | Q302 | Q68 | mismatch |
| `parameters[ka`]` | not captured | 0.3632 | only_one_extracted |
| `parameters[t, 2/5]` | not captured | 2.1540 | only_one_extracted |
