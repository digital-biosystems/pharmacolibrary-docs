...
> ## <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.533 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
## Model component
<dbs-pgx drug="amoxicillin" model-id="Amoxicillin_Carceles1995v3_reference" status="needs_review" stale="false" population="goats" measured-compound="amoxicillin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| k21 | `Q302` · k21 | 3.0391 | not captured | not captured | not captured | not captured | exact (1.0) | tab_0:row8:col2 | — | not captured |
| CL | `Q22` · CL | 0.1097 | not captured | not captured | not captured | not captured | exact (1.0) | tab_0:row10:col2 | — | not captured |
| AUC | `Q88` · AUC | 185.51 | not captured | not captured | not captured | not captured | exact (1.0) | tab_0:row14:col2, Carceles_1995_3_table_2:row14:col2, Carceles_1995_3_table_2:row14:col4 | — | not captured |
| MRT | `Q53` · MRT | 1.57 | not captured | not captured | not captured | not captured | exact (1.0) | tab_0:row15:col2, Carceles_1995_3_table_2:row15:col4 | — | not captured |
| ka | `Q49` · kabs | 0.9996 | not captured | not captured | not captured | not captured | exact (1.0) | Carceles_1995_3_table_2:row2:col4 | — | not captured |
| tlag | `Q83` · tlag | 0.2094 | not captured | not captured | not captured | not captured | exact (1.0) | Carceles_1995_3_table_2:row7:col4 | — | not captured |
| Cmax | `Q32` · Cmax | 5.7500 | not captured | not captured | not captured | not captured | exact (1.0) | Carceles_1995_3_table_2:row9:col4 | — | not captured |
| MAT | `Q73` · MAT | 2.60 | not captured | not captured | not captured | not captured | exact (1.0) | Carceles_1995_3_table_2:row16:col4 | — | not captured |
...
- dropped unlinked row (NIL): '13' — extend the ontology if this is a real PK parameter (source ['Carceles_1995_3_table_2:row4:col4'])
- dropped duplicate Q59 ('t1,2a', value '0.6934') — already have one for this compound
- dropped unlinked row (NIL): 't, 2/5' — extend the ontology if this is a real PK parameter (source ['Carceles_1995_3_table_2:row6:col4'])
...
**Extraction notes:**
- unparsed cell tab_0:row5:col2 = '0.5751 ± 0.0136 0.0847 ± 0.0091'
- unparsed cell tab_0:row5:col3 = '0.8033 ± 0.0247 0.0528 ± 0.0071'
- unparsed cell tab_0:row6:col2 = '0.1907 ± 0.0188 0.1706 ± 0.0174'
- unparsed cell tab_0:row6:col3 = '0.1508 ± 0.0143 0.1270 ± 0.0108'
- unparsed cell tab_0:row7:col1 = 'h-1'
- unparsed cell tab_0:row8:col1 = 'h-1'
- unparsed cell Carceles_1995_3_table_2:row2:col2 = 'h-1'
- unparsed cell Carceles_1995_3_table_2:row4:col2 = 'h-1'
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.533 (8/15 fields) · the first reading is what this page shows

<details><summary>7 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[a].parameter_id` | Q59 | Q67 | mismatch |
| `parameters[cmax]` | 5.7500 | not captured | only_one_extracted |
| `parameters[ka]` | 0.9996 | not captured | only_one_extracted |
| `parameters[mat]` | 2.60 | not captured | only_one_extracted |
| `parameters[t1/2a]` | not captured | 0.1014 | only_one_extracted |
| `parameters[tlag]` | 0.2094 | not captured | only_one_extracted |
| `screen.dose_compound` | amoxicillin | amoxicillin + clavulanic acid | mismatch |
...
| C5_unit_missing_Q22 | fail | [length] ** 3 / [time] | not captured | not captured | not captured | ['tab_0:row10:col2'] |
| C5_unit_missing_Q302 | fail | 1 / [time] | not captured | not captured | not captured | ['tab_0:row8:col2'] |
| C5_unit_missing_Q32 | fail | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Carceles_1995_3_table_2:row9:col4'] |
| C5_unit_missing_Q49 | fail | 1 / [time] | not captured | not captured | not captured | ['Carceles_1995_3_table_2:row2:col4'] |
| C5_unit_missing_Q53 | fail | [time] | not captured | not captured | not captured | ['tab_0:row15:col2', 'Carceles_1995_3_table_2:row15:col4'] |
| C5_unit_missing_Q59 | fail | [time] | not captured | not captured | not captured | ['tab_0:row2:col2'] |
| C5_unit_missing_Q73 | fail | [time] | not captured | not captured | not captured | ['Carceles_1995_3_table_2:row16:col4'] |
| C5_unit_missing_Q83 | fail | [time] | not captured | not captured | not captured | ['Carceles_1995_3_table_2:row7:col4'] |
| C5_unit_missing_Q88 | fail | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['tab_0:row14:col2', 'Carceles_1995_3_table_2:row14:col2', 'Carceles_1995_3_table_2:row14:col4'] |
