...
**Why:** C5 dimensioned parameter(s) without a unit: Q32, Q56, Q17, Q47, Q57 — no SI value to build from
**Second reading:** `gpt-5.6-luna` read this paper differently on `parameters[ka]` (0.17 vs not captured) and 2 more field(s) — a structural parameter, so the record is disputed.
...
## Model component
<dbs-pgx drug="amoxicillin" model-id="Amoxicillin_Dubbelboer2025_cat_6" status="needs_review" stale="false" population="healthy cats" measured-compound="amoxicillin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| C5_unit_missing_Q17 | fail | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['Dubbelboer_2025_table_1:row7:col7'] |
| C5_unit_missing_Q32 | fail | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Dubbelboer_2025_table_1:row2:col7'] |
| C5_unit_missing_Q47 | fail | 1 / [time] | not captured | not captured | not captured | ['Dubbelboer_2025_table_1:row10:col7'] |
| C5_unit_missing_Q56 | fail | [time] | not captured | not captured | not captured | ['Dubbelboer_2025_table_1:row4:col7'] |
| C5_unit_missing_Q57 | fail | [time] | not captured | not captured | not captured | ['Dubbelboer_2025_table_1:row13:col7'] |
