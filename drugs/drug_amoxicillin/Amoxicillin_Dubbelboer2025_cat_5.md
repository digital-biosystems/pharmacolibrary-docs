...
| V d | `Q61` · V | 0.47 | not captured | not captured | not captured | not captured | llm (0.6) | Dubbelboer_2025_table_1:row1:col6 | — | not captured |
...
- population split: 'cat 5' subgroup of Dubbelboer_2025 (paper reports 9 populations: cat 1, cat 2, cat 3, cat 4, cat 5, cat 6, median, typical value, unit)
