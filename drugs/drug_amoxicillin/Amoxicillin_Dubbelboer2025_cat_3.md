...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl | `Q22` · CL | 0.17 | not captured | not captured | not captured | not captured | exact (1.0) | Dubbelboer_2025_table_1:row0:col4 | — | not captured |
| V d | `Q61` · V | 0.28 | not captured | not captured | not captured | not captured | space_fold (0.95) | Dubbelboer_2025_table_1:row1:col4 | — | not captured |
| C maxPO | `Q32` · Cmax | 4.3 | not captured | not captured | not captured | not captured | llm (0.6) | Dubbelboer_2025_table_1:row2:col4 | — | not captured |
| T maxPO | `Q56` · tmax | 1.1 | not captured | not captured | not captured | not captured | llm (0.6) | Dubbelboer_2025_table_1:row4:col4 | — | not captured |
| AUC0‐ꚙIV | `Q17` · AUC∞ | 62.0 | not captured | not captured | not captured | not captured | llm (0.6) | Dubbelboer_2025_table_1:row6:col4 | — | not captured |
| k eIV | `Q47` · kel | 0.58 | not captured | not captured | not captured | not captured | llm (0.6) | Dubbelboer_2025_table_1:row9:col4 | — | not captured |
| t 1/2zIV | `Q57` · t1/2z | 1.2 | not captured | not captured | not captured | not captured | llm (0.6) | Dubbelboer_2025_table_1:row12:col4 | — | not captured |
