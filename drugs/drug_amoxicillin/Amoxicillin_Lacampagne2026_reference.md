...
## Model component
<dbs-pgx drug="amoxicillin" model-id="Amoxicillin_Lacampagne2026_reference" status="needs_review" stale="false" population="post-weaning piglets" measured-compound="amoxicillin" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
| C5_unit_missing_Q22 | fail | [length] ** 3 / [time] | not captured | not captured | not captured | ['tbl0002:row1:col2'] |
| C5_unit_missing_Q30 | fail | [length] ** 3 / [time] | not captured | not captured | not captured | ['tbl0002:row2:col2'] |
| C5_unit_missing_Q49 | fail | 1 / [time] | not captured | not captured | not captured | ['tbl0002:row5:col1', 'tbl0002:row5:col2'] |
| C5_unit_missing_Q63 | fail | [length] ** 3 | not captured | not captured | not captured | ['tbl0002:row3:col2'] |
| C5_unit_missing_Q64 | fail | [length] ** 3 | not captured | not captured | not captured | ['tbl0002:row4:col2'] |
