...
> ## <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.846 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.846 (11/13 fields) · the first reading is what this page shows

<details><summary>2 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[k apo]` | not captured | 0.6 | only_one_extracted |
| `parameters[k asc]` | 0.31 | not captured | only_one_extracted |
