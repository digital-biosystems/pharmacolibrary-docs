...
## Model component
<dbs-pgx drug="amoxicillin" model-id="Amoxicillin_Dubbelboer2025_typical_value" status="extracted" stale="false" population="healthy cats" measured-compound="amoxicillin" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| V 1 | `Q63` · V1 | 0.12 | not captured | not captured | not captured | not captured | llm (0.6) | jvp70003-tbl-0002:row1:col2 | — | not captured |
| V 2 | `Q64` · V2 | 0.092 | not captured | not captured | not captured | not captured | llm (0.6) | jvp70003-tbl-0002:row2:col2 | — | not captured |
| V 3 | `Q77` · V3 | 0.021 | not captured | not captured | not captured | not captured | llm (0.6) | jvp70003-tbl-0002:row3:col2 | — | not captured |
| Cl | `Q22` · CL | 0.18 | not captured | not captured | not captured | not captured | exact (1.0) | jvp70003-tbl-0002:row4:col2 | — | not captured |
| Q 1 | `Q30` · Q | 0.39 | not captured | not captured | not captured | not captured | llm (0.6) | jvp70003-tbl-0002:row5:col2 | — | not captured |
...
- population split: 'typical value' subgroup of Dubbelboer_2025 (paper reports 9 populations: cat 1, cat 2, cat 3, cat 4, cat 5, cat 6, median, typical value, unit)
