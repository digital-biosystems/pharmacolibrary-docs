...
## Model component
<dbs-pgx drug="amoxicillin" model-id="Amoxicillin_Wu2021_reference" status="needs_review" stale="false" population="Chinese infants" measured-compound="amoxicillin" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
second reader `gpt-oss:120b` · first reading `qwen3.8:27b-mtp-q8_0` · agreement 0.933 (14/15 fields) · the first reading is what this page shows

<details><summary>1 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[fweight = (cw/7)^0.5 θ5].parameter_id` | Q900 | Q319 | mismatch |
...
| C5_unit_missing_Q22 | fail | [length] ** 3 / [time] | not captured | not captured | not captured | ['Wu_2021_table_p5_1:row0:col1', 'Wu_2021_table_p5_1:row0:col2', 'Wu_2021_table_p5_1:row0:col3', 'Wu_2021_table_p5_1:row0:col4'] |
| C5_unit_missing_Q30 | fail | [length] ** 3 / [time] | not captured | not captured | not captured | ['Wu_2021_table_p5_1:row3:col1', 'Wu_2021_table_p5_1:row3:col2', 'Wu_2021_table_p5_1:row3:col3', 'Wu_2021_table_p5_1:row3:col4'] |
| C5_unit_missing_Q63 | fail | [length] ** 3 | not captured | not captured | not captured | ['Wu_2021_table_p5_1:row1:col1', 'Wu_2021_table_p5_1:row1:col2', 'Wu_2021_table_p5_1:row1:col3', 'Wu_2021_table_p5_1:row1:col4'] |
| C5_unit_missing_Q64 | fail | [length] ** 3 | not captured | not captured | not captured | ['Wu_2021_table_p5_1:row2:col1', 'Wu_2021_table_p5_1:row2:col2', 'Wu_2021_table_p5_1:row2:col3', 'Wu_2021_table_p5_1:row2:col4'] |
