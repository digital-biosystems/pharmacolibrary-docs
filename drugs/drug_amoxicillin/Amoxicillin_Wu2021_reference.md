...
> ## <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.933), gpt-5.6-luna (not confirmed, agreement 0.875). The first reading is what the record holds.">cross-check: disputed 0/2</span>
...
| `gpt-5.6-luna` | not confirmed | 0.875 (14/16 fields) | 2 |
...
| `gpt-oss:120b` | `parameters[fweight = (cw/7)^0.5 θ5].parameter_id` | Q900 | Q319 | mismatch |
