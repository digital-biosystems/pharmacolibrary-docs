...
## Model component
<dbs-pgx drug="amoxicillin" model-id="Amoxicillin_Dubbelboer2025_cat_2" status="extracted" stale="false" population="healthy cats" measured-compound="amoxicillin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| V d | `Q61` · V | 0.55 | not captured | not captured | not captured | not captured | llm (0.6) | Dubbelboer_2025_table_1:row1:col3 | — | not captured |
...
- population split: 'cat 2' subgroup of Dubbelboer_2025 (paper reports 9 populations: cat 1, cat 2, cat 3, cat 4, cat 5, cat 6, median, typical value, unit)
