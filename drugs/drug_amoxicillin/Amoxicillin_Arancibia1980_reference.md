...
|---|---|---|---|---|---|---|---|---|---|---|
| tI/2 (h) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | llm (0.6) | tab_1:row3:col1 | — | not captured |
| k2l (h-') | `Q302` · k21 | —(suppressed) | h-' | — | [h-'] | not captured | llm (0.6) | tab_1:row4:col1 | — | not captured |
| k,o (h-') | `Q47` · kel | —(suppressed) | h-' | — | [h-'] | not captured | llm (0.6) | tab_1:row5:col1 | — | not captured |
| k12 (h-') | `Q301` · k12 | —(suppressed) | h-' | — | [h-'] | not captured | exact (1.0) | tab_1:row6:col1 | — | not captured |
| CIB (liters/h) | `Q22` · CL | —(suppressed) | liters/h | — | [l] / [h] | not captured | llm (0.6) | tab_1:row7:col1 | — | not captured |
| V, (liters) | `Q61` · V | —(suppressed) | liters | — | [l] | not captured | llm (0.6) | tab_1:row8:col1 | — | not captured |
| AUC, 0-ac (mg/liter | `Q17` · AUC∞ | —(suppressed) | h-' | — | [h-'] | not captured | llm_corrected (0.6) | tab_1:row11:col1 | — | not captured |
