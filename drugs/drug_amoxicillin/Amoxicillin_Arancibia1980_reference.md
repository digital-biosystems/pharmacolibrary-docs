...
## Model component
<dbs-pgx drug="amoxicillin" model-id="Amoxicillin_Arancibia1980_reference" status="needs_review" stale="false" population="healthy adults" measured-compound="amoxicillin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|
| `gpt-5.6-luna` | not confirmed | 0.688 (11/16 fields) | 5 |
...
|---|---|---|---|---|
| `gpt-5.6-luna` | `parameters[cib].parameter_id` | Q22 | Q23 | mismatch |
| `gpt-5.6-luna` | `parameters[f]` | not captured | not captured | only_one_extracted |
...
| `gpt-5.6-luna` | `parameters[urinary recovery over]` | not captured | 287.0 | only_one_extracted |
| `gpt-oss:120b` | `model.bioavailability.theta` | not captured | 100 | only_one_extracted |
| `gpt-oss:120b` | `parameters[auc, 0-ac (mg/liter].parameter_id` | Q17 | Q74 | mismatch |
| `gpt-oss:120b` | `parameters[k,o]` | 1.16 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[k2l].parameter_id` | Q302 | Q47 | mismatch |
| `gpt-oss:120b` | `parameters[ti/2].parameter_id` | Q57 | Q60 | mismatch |
| `gpt-oss:120b` | `parameters[urinary recovery over]` | not captured | 287.0 | only_one_extracted |
...
| C5_unit_missing_Q17 | fail | [mass] * [time] / [length] ** 3 | h-' | not captured | not captured | ['tab_1:row11:col1'] |
| C5_unit_missing_Q301 | fail | 1 / [time] | h-' | not captured | not captured | ['tab_1:row6:col1'] |
| C5_unit_missing_Q302 | fail | 1 / [time] | h-' | not captured | not captured | ['tab_1:row4:col1'] |
| C5_unit_missing_Q47 | fail | 1 / [time] | h-' | not captured | not captured | ['tab_1:row5:col1'] |
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_amoxicillin/Amoxicillin_Arancibia1980_reference/Amoxicillin_Arancibia1980_reference_fmi.zip" download>Amoxicillin_Arancibia1980_reference_fmi.zip</a> <span class="pk-size">(4.2 kB)</span></td></tr>
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_amoxicillin/Amoxicillin_Arancibia1980_reference/Amoxicillin_Arancibia1980_reference_matlab.zip" download>Amoxicillin_Arancibia1980_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-09-24 01:04 UTC</sub>
