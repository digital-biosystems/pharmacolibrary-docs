...
> ## <span class="pk-badge pk-badge--green">reviewed — candidate</span> <span class="pk-badge pk-badge--red" title="gpt-oss:120b re-read this paper; the two readings agree on 0.571 of the compared fields. The first reading is what the record holds.">cross-check: disputed</span>
...
second reader `gpt-oss:120b` · first reading `qwen3.6:27b-q8_0` · agreement 0.571 (4/7 fields) · the first reading is what this page shows

<details><summary>3 field(s) the two readings disagree on</summary>

| field | first reading | second reading | agreement |
|---|---|---|---|
| `parameters[1000]` | not captured | 50.9 | only_one_extracted |
| `parameters[250]` | not captured | 55.8 | only_one_extracted |
| `parameters[standard deviation 4.00]` | 26.9 | not captured | only_one_extracted |
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_amoxicillin/Amoxicillin_Spyker1977_reference/Amoxicillin_Spyker1977_reference.svg" alt="Amoxicillin_Spyker1977_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Amoxicillin_Spyker1977_reference_params.json` · controls `Amoxicillin_Spyker1977_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
