...
## Model component
<dbs-pgx drug="amoxicillin" model-id="Amoxicillin_Spyker1977_reference" status="needs_review" stale="false" population="healthy adult male volunteers" measured-compound="amoxicillin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Standard deviation 4.00 | `Q312` · IIV | —(suppressed) | mg | — | [mg] | not captured | llm (0.6) | tab_2:row7:col1, tab_2:row7:col2, tab_2:row7:col3, tab_2:row7:col4, tab_2:row7:col5, tab_2:row7:col6, tab_2:row7:col7, tab_2:row7:col8 | — | not captured |
