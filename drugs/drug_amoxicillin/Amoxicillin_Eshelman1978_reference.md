...
|---|---|---|---|---|---|---|---|---|---|---|
| Lode (7) | `Q32` · Cmax | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | tab_1:row8:col2, tab_1:row8:col3, tab_1:row8:col4, tab_1:row8:col5, tab_1:row8:col6, tab_1:row8:col7, tab_1:row8:col8, tab_1:row8:col9 | — | not captured |
| Cl | `Q22` · CL | —(suppressed) | L/h/kg | — | L/h | not captured | review_gapfill (0.7) | Bardhi_2026:review | — | not captured |
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_amoxicillin/Amoxicillin_Eshelman1978_reference/Amoxicillin_Eshelman1978_reference_modelica.zip" download>Amoxicillin_Eshelman1978_reference_modelica.zip</a> <span class="pk-size">(4.5 kB)</span></td></tr>
