...
## Model component
<dbs-pgx drug="amoxicillin" model-id="Amoxicillin_Eshelman1978_reference" status="needs_review" stale="false" population="healthy adults" measured-compound="amoxicillin and ampicillin" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|
| `gpt-5.6-luna` | not confirmed | 0.364 (4/11 fields) | 7 |
...
|---|---|---|---|---|
| `gpt-5.6-luna` | `parameters[cl]` | 0.18 | not captured | only_one_extracted |
| `gpt-5.6-luna` | `parameters[ka]` | 0.17 | not captured | only_one_extracted |
| `gpt-5.6-luna` | `parameters[lode].parameter_id` | Q32 | Q310 | mismatch |
| `gpt-5.6-luna` | `parameters[lode].value` | 58.0 | 3.8 | mismatch |
...
| `gpt-5.6-luna` | `parameters[welling et al. (13) 6 fc]` | not captured | 6.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[lode]` | 58.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `screen.dose_compound` | amoxicillin and ampicillin | amoxicillin, ampicillin | mismatch |
| `gpt-oss:120b` | `screen.primary_analyte` | amoxicillin and ampicillin | amoxicillin, ampicillin | mismatch |
...
| C5_unit_missing_Q32 | fail | [mass] / [length] ** 3 | not captured | not captured | not captured | ['tab_1:row8:col2', 'tab_1:row8:col3', 'tab_1:row8:col4', 'tab_1:row8:col5', 'tab_1:row8:col6', 'tab_1:row8:col7', 'tab_1:row8:col8', 'tab_1:row8:col9'] |
...
<tr><td><b>FMI 2.0 (FMU)</b></td><td><code>.fmu</code> + fmpy driver</td><td><a href="drugs/drug_amoxicillin/Amoxicillin_Eshelman1978_reference/Amoxicillin_Eshelman1978_reference_fmi.zip" download>Amoxicillin_Eshelman1978_reference_fmi.zip</a> <span class="pk-size">(4.1 kB)</span></td></tr>
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_amoxicillin/Amoxicillin_Eshelman1978_reference/Amoxicillin_Eshelman1978_reference_matlab.zip" download>Amoxicillin_Eshelman1978_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
