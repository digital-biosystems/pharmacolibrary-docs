...
## Model component
<dbs-pgx drug="salbutamol" model-id="Salbutamol_Marques2024_value" status="model_quarantined" stale="false" population="virtual patients" measured-compound="salbutamol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| F (%) | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Marques_2024_table_3:row1:col1 | — | not captured |
| Vd (L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | exact (1.0) | Marques_2024_table_3:row2:col1 | — | not captured |
| Cmax (ng/mL) | `Q32` · Cmax | —(suppressed) | ng/mL | — | [ng] / [ml] | not captured | exact (1.0) | Marques_2024_table_3:row3:col1 | — | not captured |
| Tmax (h) | `Q56` · tmax | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Marques_2024_table_3:row4:col1 | — | not captured |
| AUC (ng·h/mL) | `Q88` · AUC | —(suppressed) | ng·h/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Marques_2024_table_3:row5:col1 | — | not captured |
| t1/2 (h) | `Q57` · t1/2z | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Marques_2024_table_3:row7:col1 | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/_needs_review/Salbutamol_Marques2024_value.mo`
- deviation: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/_needs_review/Salbutamol_Marques2024_value.deviation.json`
