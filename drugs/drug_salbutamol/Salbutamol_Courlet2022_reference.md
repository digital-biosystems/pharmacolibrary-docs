...
**What is wrong:** no model exists yet, so there is nothing to judge; the simulated model does not reproduce a value the paper reports. Evidence: T1_tmax — expected 0.17 — got 16.157769583921635 — ratio 95.0457; T1_tmax — expected 1.8 — got 16.157769583921635 — ratio 8.9765; T1_tmax — expected 1.45 — got 16.157769583921635 — ratio 11.1433
...
## Model component
<dbs-pgx drug="salbutamol" model-id="Salbutamol_Courlet2022_reference" status="not_modelled" stale="false" population="healthy adults" measured-compound="salbutamol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| F 1 | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | psp412773-tbl-0001:row2:col1, psp412773-fig-0001:caption | — | not captured |
| k a1 (h−1) | `Q49` · kabs | —(suppressed) | h−1 | — | [1] / [h] | not captured | llm (0.6) | psp412773-tbl-0001:row4:col1 | — | not captured |
| V 3 (L) | `Q77` · V3 | —(suppressed) | L | — | [l] | not captured | llm (0.6) | psp412773-tbl-0001:row6:col1, psp412773-tbl-0001:row6:col2, psp412773-tbl-0001:row6:col3, psp412773-tbl-0001:row6:col4 | — | not captured |
| k 34 (h−1) | `Q304` · k31 | —(suppressed) | h−1 | — | [1] / [h] | not captured | llm (0.6) | psp412773-tbl-0001:row7:col1, psp412773-tbl-0001:row7:col2, psp412773-tbl-0001:row7:col3, psp412773-tbl-0001:row7:col4 | — | not captured |
...
| UR_PROD (L h−1) | `Q24` · CLu | —(suppressed) | L h−1 | — | [l] / [h] | not captured | llm (0.6) | psp412773-tbl-0001:row10:col1, psp412773-tbl-0001:row10:col3, psp412773-tbl-0001:row10:col4 | — | not captured |
...
| T1_tmax | reference | fail | 0.17 | 16.157769583921635 | 95.0457 | h→SI vs simulated h |
| T1_tmax | reference | fail | 1.8 | 16.157769583921635 | 8.9765 | h→SI vs simulated h |
| T1_tmax | reference | fail | 1.45 | 16.157769583921635 | 11.1433 | h→SI vs simulated h |
...
- scholar stages: `../../../knowledgebase/drugs/drug_salbutamol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Courlet_2022` / `Courlet_2022::healthy adults`)
- sim: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/Salbutamol_Courlet2022_healthy_adults.json`
