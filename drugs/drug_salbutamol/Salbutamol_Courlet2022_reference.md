...
**What is wrong:** the simulated model does not reproduce a value the paper reports. Evidence: T1_tmax — expected 0.17 — got 0.29727858857199785 — ratio 1.7487; T1_tmax — expected 1.8 — got 0.29727858857199785 — ratio 0.1652; T1_tmax — expected 1.45 — got 0.29727858857199785 — ratio 0.205
...
<sub>Template `PK_1C_enteral` · parameters `Salbutamol_Courlet2022_reference_params.json` · controls `Salbutamol_Courlet2022_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
