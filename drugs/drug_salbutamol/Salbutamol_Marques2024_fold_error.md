...
## Model component
<dbs-pgx drug="salbutamol" model-id="Salbutamol_Marques2024_fold_error" status="model_quarantined" stale="false" population="virtual patients" measured-compound="salbutamol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- dropped value-less row: 'Fa (%)' (captured trailing unit '%' for child rows)
- dropped value-less row: 'Cmax (μg/mL)' (captured trailing unit 'μg/mL' for child rows)
- dropped value-less row: 'Tmax (h)' (captured trailing unit 'h' for child rows)
- dropped value-less row: 'AUCinf (ng·h/mL)' (captured trailing unit 'ng·h/mL' for child rows)
...
- population split: 'fold-error' subgroup of Marques_2024 (paper reports 7 populations: covariate, estimate, fold-error, geometric mean, observed, predicted, value)
...
- scholar stages: `../../../knowledgebase/drugs/drug_salbutamol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Marques_2024` / `Marques_2024::fold_error`)
- model: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/_needs_review/Salbutamol_Marques2024_fold_error.mo`
- deviation: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/_needs_review/Salbutamol_Marques2024_fold_error.deviation.json`
