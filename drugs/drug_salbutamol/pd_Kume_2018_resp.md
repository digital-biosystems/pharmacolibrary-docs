...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | procaterol | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 3.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 2.78 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 9.82 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 5.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 4.55 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 12.57 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 8.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 7.05 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 13.26 | not captured | only_one_extracted |
