...
|---|---|---|---|---|---|---|---|---|---|---|
| ka | `Q49` · kabs | —(suppressed) | h(-1) | — | [1] / [h] | not captured | exact (1.0) | Valenzuela_2006:abstract | — | not captured |
| VMax | `Q66` · Vmax | —(suppressed) | mM/h | — | [mM] / [h] | not captured | special_case (0.95) | Valenzuela_2006:abstract | — | not captured |
| Km | `Q1` · Km | —(suppressed) | mM | — | [mM] | not captured | exact (1.0) | Valenzuela_2006:abstract | — | not captured |
...
- unit_dimension_mismatch: 'VMax' → Q66 (unit '[length] / [time]' vs ontology '[length] ** 3') — route to review
- unit_dimension_mismatch: 'Km' → Q1 (unit '[length]' vs ontology '[mass] / [length] ** 3') — route to review
- unit_dimension_mismatch: "V'max" → Q66 (unit '[length] / [time]' vs ontology '[length] ** 3') — route to review
- dropped duplicate Q66 ("V'max", value 0.678) — already have one for this compound
- unit_dimension_mismatch: "K'm" → Q1 (unit '[length]' vs ontology '[mass] / [length] ** 3') — route to review
- dropped duplicate Q1 ("K'm", value 0.357) — already have one for this compound
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=salbutamol sulphate
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Valenzuela_2006_metadata.yaml (5 record(s)); values are summary statistics, not a fitted model
...
- scholar stages: `../../../knowledgebase/drugs/drug_salbutamol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Valenzuela_2006` / `Valenzuela_2006::reference`)
