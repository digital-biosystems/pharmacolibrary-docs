...
## Model component
<dbs-pgx drug="salbutamol" model-id="Salbutamol_Walsh2023_random_effects" status="curated_candidate" stale="false" population="children with acute asthma" measured-compound="salbutamol" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (l/h) | `Q22` · CL | 0.522 | l/h | 1.45e-07 | [l] / [h] | not captured | exact (1.0) | Walsh_2023_table_p23_1:row3:col2 | — | not captured |
| Vc (l) | `Q63` · V1 | 1.79 | l | 0.0017900000000000001 | [l] | not captured | exact (1.0) | Walsh_2023_table_p23_1:row4:col2 | — | not captured |
| Vp (l) | `Q64` · V2 | 6.45 | l | 0.00645 | [l] | not captured | exact (1.0) | Walsh_2023_table_p23_1:row6:col2 | — | not captured |
| Q (L/h) | `Q30` · Q | 10.59 | L/h | 2.9416666666666667e-06 | L/h | not captured | review_gapfill (0.7) | Marques_2024_2:review | — | not captured |
...
- dropped PD-category row 'E0 (fraction of PASS-score [0-9])' → Q324 (E0, category G11) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['Walsh_2023_table_p23_1:row11:col2'])
- dropped PD-category row 'EMAX' → Q320 (Emax, category G11) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['Walsh_2023_table_p23_1:row18:col2'])
- dropped PD-category row 'EC50 (ng/ml)' → Q321 (EC50, category G11) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['Walsh_2023_table_p23_1:row19:col2', 'Walsh_2023_table_p23_1:row24:col2'])
- dropped PD-category row 'E0 (z-score)' → Q324 (E0, category G11) — pharmacodynamic parameters belong to scholarpd, not the PK model (source ['Walsh_2023_table_p23_1:row22:col2'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=salbutamol
- population split: 'random effects' subgroup of Walsh_2023 (paper reports 3 populations: fixed effects, random effects, residual variability)
- gap-filled Q30 (Q) from Marques_2024_2's review values (primary lacked it)
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Walsh_2023_table_p23_1:row3:col2'] |
...
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Walsh_2023_table_p23_1:row4:col2'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Walsh_2023_table_p23_1:row6:col2'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 0.522 | not captured | not captured | ['Walsh_2023_table_p23_1:row3:col2'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.522 L/h | not captured | not captured | ['Walsh_2023_table_p23_1:row3:col2'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 1.79 L | not captured | not captured | ['Walsh_2023_table_p23_1:row4:col2'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 6.45 L | not captured | not captured | ['Walsh_2023_table_p23_1:row6:col2'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_salbutamol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Walsh_2023` / `Walsh_2023::random_effects`)
- model: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/Salbutamol_Walsh2023_random_effects.mo`
- deviation: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/Salbutamol_Walsh2023_random_effects.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/Salbutamol_Walsh2023_random_effects.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_salbutamol/Salbutamol_Walsh2023_random_effects/Salbutamol_Walsh2023_random_effects_modelica.zip" download>Salbutamol_Walsh2023_random_effects_modelica.zip</a> <span class="pk-size">(4.1 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_salbutamol/Salbutamol_Walsh2023_random_effects/Salbutamol_Walsh2023_random_effects_fmi.zip" download>Salbutamol_Walsh2023_random_effects_fmi.zip</a> <span class="pk-size">(4.2 kB)</span><br><a href="models/fmu/PK_2C_enteral.fmu" download>PK_2C_enteral.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_salbutamol/Salbutamol_Walsh2023_random_effects/Salbutamol_Walsh2023_random_effects_matlab.zip" download>Salbutamol_Walsh2023_random_effects_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_salbutamol/Salbutamol_Walsh2023_random_effects/Salbutamol_Walsh2023_random_effects_matlab_simbio.zip" download>Salbutamol_Walsh2023_random_effects_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_salbutamol/Salbutamol_Walsh2023_random_effects/Salbutamol_Walsh2023_random_effects_sbml.zip" download>Salbutamol_Walsh2023_random_effects_sbml.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_salbutamol/Salbutamol_Walsh2023_random_effects/Salbutamol_Walsh2023_random_effects_cellml.zip" download>Salbutamol_Walsh2023_random_effects_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
...
<dbs-fmusim paramsurl="drugs/drug_salbutamol/Salbutamol_Walsh2023_random_effects/Salbutamol_Walsh2023_random_effects_params.json" metaurl="assets/fmu/PK_2C_enteral.vr.json" wasmurl="assets/fmu/PK_2C_enteral.js" controlsurl="drugs/drug_salbutamol/Salbutamol_Walsh2023_random_effects/Salbutamol_Walsh2023_random_effects_sim_controls.json"></dbs-fmusim>

<sub>Template `PK_2C_enteral` · parameters `Salbutamol_Walsh2023_random_effects_params.json` · controls `Salbutamol_Walsh2023_random_effects_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
