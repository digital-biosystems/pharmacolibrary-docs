...
## Model component
<dbs-pgx drug="salbutamol" model-id="Salbutamol_Vet2020_estimation" status="rejected" stale="false" population="children with refractory status asthmaticus" measured-compound="R-salbutamol, S-salbutamol" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CLR-salbutamol (L/h/70 kg) | `Q26` · CLR | —(suppressed) | L/h/70 kg | — | [l] / [[h] · [70kg]] | not captured | llm_confirmed (0.6) | Tab2:row2:col1 | — | not captured |
| CLS-salbutamol (L/h/70 kg) | `Q22` · CL | —(suppressed) | L/h/70 kg | — | [l] / [[h] · [70kg]] | not captured | llm (0.6) | Tab2:row3:col1 | — | not captured |
| Vc (L/70 kg) | `Q63` · V1 | —(suppressed) | L/70 kg | — | [l] / [70kg] | not captured | exact (1.0) | Tab2:row4:col1 | — | not captured |
| Q (L/h/70 kg) | `Q30` · Q | —(suppressed) | L/h/70 kg | — | [l] / [[h] · [70kg]] | not captured | exact (1.0) | Tab2:row5:col1 | — | not captured |
| Vp (L/70 kg) | `Q64` · V2 | —(suppressed) | L/70 kg | — | [l] / [70kg] | not captured | exact (1.0) | Tab2:row6:col1 | — | not captured |
...
- dropped unlinked row (NIL): 'Baseline dose (μg)' — extend the ontology if this is a real PK parameter (source ['Tab2:row1:col1'])
...
- population split: 'estimation' subgroup of Vet_2020 (paper reports 3 populations: estimation, ipv (%), shrinkage (%))
...
| C5_dimension_Q26 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tab2:row2:col1'] |
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tab2:row5:col1'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Marques_2024_2:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Tab2:row4:col1'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Tab2:row6:col1'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 8.82 | not captured | not captured | ['Tab2:row3:col1'] |
| C8_topology | fail | ontology-linked transfer parameter on every edge | ['none', 'none'] | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 8.82 L/h | not captured | not captured | ['Tab2:row3:col1'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 12.9 L | not captured | not captured | ['Tab2:row4:col1'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 45.5 L | not captured | not captured | ['Tab2:row6:col1'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_salbutamol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Vet_2020` / `Vet_2020::estimation`)
