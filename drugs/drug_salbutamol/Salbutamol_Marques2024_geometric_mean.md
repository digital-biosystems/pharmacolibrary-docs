...
## Model component
<dbs-pgx drug="salbutamol" model-id="Salbutamol_Marques2024_geometric_mean" status="needs_review" stale="false" population="virtual patients" measured-compound="salbutamol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Mtt | `Q81` · MTT | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Marques_2024_table_7:row0:col3 | — | not captured |
| V1 | `Q61` · V | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Marques_2024_table_7:row3:col3 | — | not captured |
| Cl | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Marques_2024_table_7:row6:col3 | — | not captured |
...
- dropped unlinked row (NIL): '0.94–1.60' — extend the ontology if this is a real PK parameter (source ['Marques_2024_table_7:row4:col3', 'Marques_2024_table_7:row7:col3'])
- dropped unlinked row (NIL): '1.60–2.37' — extend the ontology if this is a real PK parameter (source ['Marques_2024_table_7:row5:col3', 'Marques_2024_table_7:row8:col3'])
...
- population split: 'geometric mean' subgroup of Marques_2024 (paper reports 7 populations: covariate, estimate, fold-error, geometric mean, observed, predicted, value)
...
- scholar stages: `../../../knowledgebase/drugs/drug_salbutamol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Marques_2024` / `Marques_2024::geometric_mean`)
