...
## Model component
<dbs-pgx drug="salbutamol" model-id="Salbutamol_Marques2024_predicted" status="model_quarantined" stale="false" population="virtual patients" measured-compound="salbutamol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| F (%) | `Q40` · Fab | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Marques_2024_table_4:row1:col2 | — | not captured |
| Cmax (μg/mL) | `Q32` · Cmax | —(suppressed) | μg/mL | — | [µg] / [ml] | not captured | exact (1.0) | Marques_2024_table_4:row2:col2 | — | not captured |
| Tmax (h) | `Q56` · tmax | —(suppressed) | h | — | [h] | not captured | exact (1.0) | Marques_2024_table_4:row3:col2 | — | not captured |
| AUCinf (ng·h/mL) | `Q17` · AUC∞ | —(suppressed) | ng·h/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Marques_2024_table_4:row4:col2 | — | not captured |
...
- dropped unlinked row (NIL): 'Fa (%)' — extend the ontology if this is a real PK parameter (source ['Marques_2024_table_4:row0:col2'])
...
- population split: 'predicted' subgroup of Marques_2024 (paper reports 7 populations: covariate, estimate, fold-error, geometric mean, observed, predicted, value)
...
| C5_dimension_Q17 | pass | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['Marques_2024_table_4:row4:col2'] |
| C5_dimension_Q32 | pass | [mass] / [length] ** 3 | not captured | not captured | not captured | ['Marques_2024_table_4:row2:col2'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Marques_2024_2:review'] |
| C5_dimension_Q56 | pass | [time] | not captured | not captured | not captured | ['Marques_2024_table_4:row3:col2'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_salbutamol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Marques_2024` / `Marques_2024::predicted`)
- model: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/_needs_review/Salbutamol_Marques2024_predicted.mo`
- deviation: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/_needs_review/Salbutamol_Marques2024_predicted.deviation.json`
