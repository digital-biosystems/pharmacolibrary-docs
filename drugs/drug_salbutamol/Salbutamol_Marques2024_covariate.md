...
## Model component
<dbs-pgx drug="salbutamol" model-id="Salbutamol_Marques2024_covariate" status="model_quarantined" stale="false" population="virtual patients" measured-compound="salbutamol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| V1 | `Q61` · V | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Marques_2024_table_7:row3:col1, Marques_2024_table_7:row3:col2 | — | not captured |
| Cl | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | Marques_2024_table_7:row6:col1, Marques_2024_table_7:row6:col2 | — | not captured |
...
- dropped unlinked row (NIL): 'Male' — extend the ontology if this is a real PK parameter (source ['Marques_2024_table_7:row1:col1', 'Marques_2024_table_7:row1:col2'])
- dropped unlinked row (NIL): '0.94–1.60' — extend the ontology if this is a real PK parameter (source ['Marques_2024_table_7:row4:col1', 'Marques_2024_table_7:row4:col2', 'Marques_2024_table_7:row7:col1', 'Marques_2024_table_7:row7:col2'])
- dropped unlinked row (NIL): '1.60–2.37' — extend the ontology if this is a real PK parameter (source ['Marques_2024_table_7:row5:col1', 'Marques_2024_table_7:row5:col2', 'Marques_2024_table_7:row8:col1', 'Marques_2024_table_7:row8:col2'])
...
- population split: 'covariate' subgroup of Marques_2024 (paper reports 7 populations: covariate, estimate, fold-error, geometric mean, observed, predicted, value)
...
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 0.94 | not captured | not captured | ['Marques_2024_table_7:row6:col1', 'Marques_2024_table_7:row6:col2'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_salbutamol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Marques_2024` / `Marques_2024::covariate`)
- model: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/_needs_review/Salbutamol_Marques2024_covariate.mo`
- deviation: `../../../knowledgebase/drugs/drug_salbutamol/models/modelica/_needs_review/Salbutamol_Marques2024_covariate.deviation.json`
