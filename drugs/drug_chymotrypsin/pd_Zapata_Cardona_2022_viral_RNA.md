...
| `gpt-oss:120b` | `parameters[Q321]` | 8.7 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q322]` | 4.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 16.8 | not captured | only_one_extracted |
