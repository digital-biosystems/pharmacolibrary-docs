...
> **Dose compound ≠ measured compound:** dosed `diluted tincture of opium`, measured `morphine`.
...
- scholar stages: `../../../knowledgebase/drugs/drug_opium/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Liu_2016` / `Liu_2016::neonates with abstinence syndrome`)
