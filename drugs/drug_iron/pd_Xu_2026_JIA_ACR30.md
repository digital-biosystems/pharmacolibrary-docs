...
# JIA-ACR30 response — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | sarilumab | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q27]` | 73.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q27]` | 14 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | 0.460 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q315]` | 0.92 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 20.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 25.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 49.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 16.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q76]` | 29.9 | not captured | only_one_extracted |
