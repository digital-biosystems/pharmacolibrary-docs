...
|---|---|---|---|---|---|---|---|---|---|---|
| Blood clearance rate constant | `Q23` · CLb | 0.96 | hr-1 | not captured | hr-1 | not captured | boundary (0.8) | Phatruengdet_2022:results_prose | — | not captured |
| FTs metabolites clearance (k4) | `Q22` · CL | 0.07 | hr-1 | not captured | hr-1 | not captured | boundary (0.8) | Phatruengdet_2022:results_prose | — | not captured |
