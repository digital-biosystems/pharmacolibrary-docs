...
# Percentage change in absolute neutrophil count from baseline — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.632). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q290]` | not captured | 46.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q329]` | not captured | 14.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | not captured | 36.6 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | not captured | 39.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | not captured | 16.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q66]` | not captured | 19.9 | only_one_extracted |
