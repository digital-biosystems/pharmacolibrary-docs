...
> ## <span class="pk-badge pk-badge--green">reviewed — candidate</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.471). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[fed].parameter_id` | Q40 | Q44 | mismatch |
| `gpt-oss:120b` | `parameters[fed].rse_percent` | not captured | 29.8 | mismatch |
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_canagliflozin/Canagliflozin_Yao2023_estimates/Canagliflozin_Yao2023_estimates_matlab.zip" download>Canagliflozin_Yao2023_estimates_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_2C` · parameters `Canagliflozin_Yao2023_estimates_params.json` · controls `Canagliflozin_Yao2023_estimates_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
