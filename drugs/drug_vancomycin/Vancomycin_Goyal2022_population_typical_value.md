...
- population split: 'population typical value' subgroup of Goyal_2022 (paper reports 3 populations: final pk model, formula, population typical value)
...
<img src="drugs/drug_vancomycin/Vancomycin_Goyal2022_population_typical_value/Vancomycin_Goyal2022_population_typical_value.svg" alt="Vancomycin_Goyal2022_population_typical_value diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_vancomycin/Vancomycin_Goyal2022_population_typical_value/Vancomycin_Goyal2022_population_typical_value_modelica.zip" download>Vancomycin_Goyal2022_population_typical_value_modelica.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
<sub>Template `PK_2C` · parameters `Vancomycin_Goyal2022_population_typical_value_params.json` · controls `Vancomycin_Goyal2022_population_typical_value_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
