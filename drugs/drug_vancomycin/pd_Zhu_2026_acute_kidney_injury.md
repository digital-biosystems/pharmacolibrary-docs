...
# name — PD  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.079). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model_family` | categorical | unknown | mismatch |
...
| `gpt-oss:120b` | `parameters[Q21]` | not captured | 0.064 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 12 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 22 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | not captured | 0.148 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q32]` | 0.148 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q36]` | not captured | 0.001 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q36]` | not captured | 86 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q36]` | not captured | 19 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 36 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 0.011 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 75 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 16 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 0.001 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q88]` | not captured | 0.004 | only_one_extracted |
