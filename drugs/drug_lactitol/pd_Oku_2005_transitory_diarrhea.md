...
## Citation
Oku T; Nakamura S; Ichinose M et al. (2005). Journal of nutritional science and vitaminology 51
  ·  DOI: [10.3177/jnsv.51.51](https://doi.org/10.3177/jnsv.51.51)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | lactose | not captured | mismatch |
