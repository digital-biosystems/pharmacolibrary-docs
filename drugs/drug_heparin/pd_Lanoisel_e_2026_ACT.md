...
# ACT — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.5). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q358]` | 35 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 11 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q414]` | not captured | 1 | only_one_extracted |
...
---
<sub>← back to [heparin](drugs/drug_heparin/)</sub>
