...
- salvaged Q64 ('V 2 (L)'=24.5) from results prose — parameter table was unreadable
- salvaged Q30 ('Q (L/h)'=1.8) from results prose — parameter table was unreadable
- salvaged Q49 ('Ka (/h)'=4.04) from results prose — parameter table was unreadable
- apparent-by-design (ADVISORY, codes unchanged): extravascular dosing with no identifiable F, so these reported disposition parameters are likely apparent unless the model puts first-pass in its structure — Q22 (Cl (L/h)); Q64 (V 2 (L)); Q30 (Q (L/h))
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=acenocoumarol
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[15% decrease in acenocoumarol clearance with concomitant antibiotics]` | not captured | 15 | only_one_extracted |
| `gpt-oss:120b` | `parameters[decrease in acenocoumarol clearance]` | 15 | not captured | only_one_extracted |
...
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 4.08 | not captured | not captured | ['Delavenne_2009:other_prose'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 4.08 L/h | not captured | not captured | ['Delavenne_2009:other_prose'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 329 L | not captured | not captured | ['Chen_2024:review'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 24.5 L | not captured | not captured | ['Delavenne_2009:other_prose'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_acenocoumarol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Delavenne_2009` / `Delavenne_2009::reference`)
- model: `../../../knowledgebase/drugs/drug_acenocoumarol/models/modelica/Acenocoumarol_Delavenne2009_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_acenocoumarol/models/modelica/Acenocoumarol_Delavenne2009_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_acenocoumarol/models/modelica/Acenocoumarol_Delavenne2009_reference.json`
...
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_acenocoumarol/Acenocoumarol_Delavenne2009_reference/Acenocoumarol_Delavenne2009_reference_cellml.zip" download>Acenocoumarol_Delavenne2009_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Acenocoumarol_Delavenne2009_reference_params.json` · controls `Acenocoumarol_Delavenne2009_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
