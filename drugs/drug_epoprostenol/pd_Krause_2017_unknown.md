...
# adverse events denoting hemorrhage — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Krause A; Machacek M; Lott D; Hurst N; Bruderer S; Dingemanse J et al. (2017). CPT: pharmacometrics & systems pharmacology 6
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | selexipag and ACT-333679 | not captured | mismatch |
| `gpt-oss:120b` | `effect_direction` | unknown | not captured | mismatch |
| `gpt-oss:120b` | `effect_form` | unknown | not captured | mismatch |
| `gpt-oss:120b` | `model_family` | log_linear | not captured | mismatch |
| `gpt-oss:120b` | `parameters[Q1]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q1]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | -0.40 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | 0.61 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q22]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | 1.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q64]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q66]` | 0.88 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q66]` | not captured | not captured | only_one_extracted |
