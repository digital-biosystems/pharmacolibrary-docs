...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | E7080 | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q318]` | 4.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 6.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 45 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 51 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 32 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q318]` | 28 | not captured | only_one_extracted |
