...
# time to NT-proBNP &lt; 300 pg/mL — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | sotatercept | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | 2710 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 20.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 36.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 19.7 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 97.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 3.03 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | 1.00 | not captured | only_one_extracted |
