...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[mean]` | not captured | 131 | only_one_extracted |
| `gpt-oss:120b` | `parameters[median]` | not captured | 111 | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_dapsone/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Falloon_1994` / `Falloon_1994::reference`)
