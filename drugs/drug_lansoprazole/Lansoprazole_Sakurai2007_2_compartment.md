...
|---|---|---|---|---|---|---|---|---|---|---|
| q 1 (l/kg) | `Q30` · Q | 0.110 | l/kg | not captured | [l] / [kg] | not captured | space_fold (0.95) | tab_0:row3:col1, tab_0:row3:col3, tab_0:row3:col4 | — | not captured |
| q 3 | `Q308` · Q3 | 0.612 | not captured | not captured | not captured | not captured | space_fold (0.95) | tab_0:row5:col1, tab_0:row5:col3, tab_0:row5:col4 | — | not captured |
...
- dropped duplicate Q30 ('q 2 (l/h/kg)', value '0.179') — already have one for this compound
- dropped unlinked row (NIL): 'q 4' — extend the ontology if this is a real PK parameter (source ['tab_0:row6:col1', 'tab_0:row6:col3', 'tab_0:row6:col4'])
- unit_dimension_mismatch: 'q 5 (l/kg)' → Q30 (unit '[length] ** 3' vs ontology '[length] ** 3 / [time]') — route to review
- dropped duplicate Q30 ('q 5 (l/kg)', value '0.201') — already have one for this compound
- dropped unlinked row (NIL): 'w V 2 s CV' — extend the ontology if this is a real PK parameter (source ['tab_0:row10:col3'])
- dropped unlinked row (NIL): 's ADD (ng/ml)' — extend the ontology if this is a real PK parameter (source ['tab_0:row11:col1', 'tab_0:row11:col3', 'tab_0:row11:col4'])
...
- population split: '2-compartment' subgroup of Sakurai_2007 (paper reports 2 populations: 1-compartment, 2-compartment)
...
- scholar stages: `../../../knowledgebase/drugs/drug_lansoprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Sakurai_2007` / `Sakurai_2007::2_compartment`)
