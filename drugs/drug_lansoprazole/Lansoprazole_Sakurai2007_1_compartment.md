...
|---|---|---|---|---|---|---|---|---|---|---|
| q 1 (l/kg) | `Q30` · Q | —(suppressed) | l/kg | — | [l] / [kg] | not captured | space_fold (0.95) | tab_0:row3:col2, tab_0:row3:col3, tab_0:row3:col4 | — | not captured |
| q 3 | `Q308` · Q3 | —(suppressed) | not captured | — | not captured | not captured | space_fold (0.95) | tab_0:row5:col2, tab_0:row5:col3, tab_0:row5:col4 | — | not captured |
