...
|---|---|---|---|---|---|---|---|---|---|---|
| total body clearance | `Q22` · CL | —(suppressed) | ml/min/kg | — | [ml] / [[min] · [kg]] | not captured | llm_confirmed (0.6) | Katashima_1995:abstract, Katashima_1995:abstract | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_lansoprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Katashima_1995` / `Katashima_1995::reference`)
