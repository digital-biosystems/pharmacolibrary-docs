...
|---|---|---|---|---|---|---|---|---|---|---|
| AUC0–12 h (h·ng/mL) | `Q19` · AUCt | —(suppressed) | h·ng/mL | — | [[h] · [ng]] / [ml] | not captured | llm (0.6) | Eichler_2023_table_5:row0:col3 | — | not captured |
| Cmax (ng/mL) | `Q32` · Cmax | —(suppressed) | ng/mL | — | [ng] / [ml] | not captured | exact (1.0) | Eichler_2023_table_5:row1:col3 | — | not captured |
| tmax (hr) | `Q56` · tmax | —(suppressed) | hr | — | [h] | not captured | exact (1.0) | Eichler_2023_table_5:row2:col3 | — | not captured |
