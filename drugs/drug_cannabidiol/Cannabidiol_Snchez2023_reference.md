...
## Citation
Sánchez de Medina A; Serrano-Rodríguez JM; Díez de Castro E; García-Valverde MT; Saitua A; Becero M; et al. et al. (2023). Equine veterinary journal 55
...
|---|---|---|---|---|---|---|---|---|---|---|
| volume of distribution | `Q61` · V | 36 | L/kg | 2.5200000000000005 | [l] / [kg] | not captured | exact (1.0) | Sánchez_2023:abstract | — | not captured |
| systemic clearance | `Q22` · CL | 1.46 | L/h/kg | 2.8388888888888886e-05 | [l] / [[h] · [kg]] | not captured | llm_confirmed (0.6) | Sánchez_2023:abstract | — | not captured |
| Oral bioavailability | `Q40` · Fab | 14 | % | not captured | not captured | not captured | exact (1.0) | Sánchez_2023:abstract | — | not captured |
...
|---|---|---|---|
| half-lives | Q57 | not captured | llm |
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Sánchez_2023_metadata.yaml (4 record(s)); values are summary statistics, not a fitted model
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Sánchez_2023:abstract'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Sánchez_2023:abstract'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Sánchez_2023:abstract'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 1.46 | not captured | not captured | ['Sánchez_2023:abstract'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 102 L/h | not captured | not captured | ['Sánchez_2023:abstract'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 2.52e+03 L | not captured | not captured | ['Sánchez_2023:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_cannabidiol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Sánchez_2023` / `Sánchez_2023::reference`)
- model: `../../../knowledgebase/drugs/drug_cannabidiol/models/modelica/Cannabidiol_Snchez2023_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_cannabidiol/models/modelica/Cannabidiol_Snchez2023_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_cannabidiol/models/modelica/Cannabidiol_Snchez2023_reference.json`
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_cannabidiol/Cannabidiol_Snchez2023_reference/Cannabidiol_Snchez2023_reference_matlab.zip" download>Cannabidiol_Snchez2023_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_cannabidiol/Cannabidiol_Snchez2023_reference/Cannabidiol_Snchez2023_reference_sbml.zip" download>Cannabidiol_Snchez2023_reference_sbml.zip</a> <span class="pk-size">(2.4 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_cannabidiol/Cannabidiol_Snchez2023_reference/Cannabidiol_Snchez2023_reference_cellml.zip" download>Cannabidiol_Snchez2023_reference_cellml.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_cannabidiol/Cannabidiol_Snchez2023_reference/Cannabidiol_Snchez2023_reference.svg" alt="Cannabidiol_Snchez2023_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_cannabidiol/Cannabidiol_Snchez2023_reference/Cannabidiol_Snchez2023_reference_params.json" metaurl="assets/fmu/PK_1C.vr.json" wasmurl="assets/fmu/PK_1C.js" controlsurl="drugs/drug_cannabidiol/Cannabidiol_Snchez2023_reference/Cannabidiol_Snchez2023_reference_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C` · parameters `Cannabidiol_Snchez2023_reference_params.json` · controls `Cannabidiol_Snchez2023_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
