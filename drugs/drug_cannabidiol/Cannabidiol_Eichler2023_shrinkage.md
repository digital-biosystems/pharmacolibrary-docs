...
## Model component
<dbs-pgx drug="cannabidiol" model-id="Cannabidiol_Eichler2023_shrinkage" status="model_quarantined" stale="false" population="horses" measured-compound="cannabidiol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- dropped value-less row: 'Cl/F (L/h/kg)' (captured trailing unit 'L/h/kg' for child rows)
- dropped value-less row: 'V1/F (L/kg)' (captured trailing unit 'L/kg' for child rows)
- dropped value-less row: 'Q3 (L/h/kg)' (captured trailing unit 'L/h/kg' for child rows)
- dropped value-less row: 'V3/F (L/kg)' (captured trailing unit 'L/kg' for child rows)
...
- scholar stages: `../../../knowledgebase/drugs/drug_cannabidiol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Eichler_2023` / `Eichler_2023::shrinkage`)
- model: `../../../knowledgebase/drugs/drug_cannabidiol/models/modelica/_needs_review/Cannabidiol_Eichler2023_shrinkage.mo`
- deviation: `../../../knowledgebase/drugs/drug_cannabidiol/models/modelica/_needs_review/Cannabidiol_Eichler2023_shrinkage.deviation.json`
