...
- scholar stages: `../../../knowledgebase/drugs/drug_mavacamten/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Merali_2025` / `Merali_2025::reference`)
