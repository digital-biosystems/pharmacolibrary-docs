...
|---|---|---|---|---|---|---|---|---|---|---|
| CL FVIII, mL/70 kg/h | `Q22` · CL | 39.1 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | tab_1:row2:col2, tab_1:row2:col3, tab_1:row2:col4, tab_1:row2:col6 | — | 11.3 (None% RSE) |
| V FVIII, mL/70 kg | `Q352` · Vnorm | 7.3 | not captured | not captured | not captured | not captured | llm (0.6) | tab_1:row3:col2, tab_1:row3:col3, tab_1:row3:col4, tab_1:row3:col6 | — | not captured |
...
| `gpt-oss:120b` | `parameters[baseline fviii]` | not captured | 15.0 | only_one_extracted |
