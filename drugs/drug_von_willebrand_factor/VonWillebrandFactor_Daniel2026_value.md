...
## Model component
<dbs-pgx drug="von Willebrand factor" model-id="VonWillebrandFactor_Daniel2026_value" status="rejected" stale="false" population="patients with von Willebrand disease" measured-compound="VWF:Ag" parameterization="mechanistic" topology="1C"></dbs-pgx>
