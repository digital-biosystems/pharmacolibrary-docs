...
|---|---|---|---|---|---|---|---|---|---|---|
| VVWF (mL) | `Q61` · V | 4537 | mL | 0.004536999999999999 | [ml] | not captured | llm (0.6) | tbl2:row3:col1 | — | not captured |
| ClVWF (mL/h) | `Q22` · CL | 74.2 | mL/h | 2.0611111111111113e-08 | [ml] / [h] | not captured | llm (0.6) | tbl2:row4:col1 | — | not captured |
| 𝑄𝑄𝑉𝑉𝑉𝑉𝑉𝑉 (mL) | `Q30` · Q | 3290 | mL | not captured | [ml] | not captured | llm (0.6) | Daniel_2026_table_S4:row10:col2 | — | not captured |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['tbl2:row4:col1'] |
| C5_dimension_Q30 | fail | [length] ** 3 | mL | not captured | not captured | ['Daniel_2026_table_S4:row10:col2'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Schöning_2026:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['tbl2:row3:col1'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 74.2 | not captured | not captured | ['tbl2:row4:col1'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 0.0742 L/h | not captured | not captured | ['tbl2:row4:col1'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 4.54 L | not captured | not captured | ['tbl2:row3:col1'] |
