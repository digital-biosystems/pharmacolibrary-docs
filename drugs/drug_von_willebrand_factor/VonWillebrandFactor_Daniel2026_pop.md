<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;B02B&quot;,&quot;href&quot;:&quot;atc/B02B.md&quot;},{&quot;label&quot;:&quot;von Willebrand factor&quot;,&quot;href&quot;:&quot;drugs/drug_von_willebrand_factor/&quot;},{&quot;label&quot;:&quot;Daniel_2026 \u00b7 pop&quot;}]"></div>

# von Willebrand factor — `VonWillebrandFactor_Daniel2026_pop`
...
## Model component
<dbs-pgx drug="von Willebrand factor" model-id="VonWillebrandFactor_Daniel2026_pop" status="rejected" stale="false" population="patients with von Willebrand disease" measured-compound="VWF:Ag" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| 𝛽𝛽 𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝑉𝑉𝑉𝑉𝐹𝐹𝐹𝐹𝐹𝐹 | `Q900` · equation variable | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | Daniel_2026_table_S5:row4:col1, Daniel_2026_table_S5:row4:col2 | — | not captured |
...
- dropped unlinked row (NIL): '𝐴𝐴𝐴𝐴𝑒𝑒' — extend the ontology if this is a real PK parameter (source ['Daniel_2026_table_S5:row0:col3'])
- dropped unlinked row (NIL): '𝛽𝛽 𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝐵𝑉𝑉𝑉𝑉𝑉𝑉 𝑔𝑔𝑒𝑒𝑒𝑒𝑔𝑔𝑒𝑒𝑔𝑔𝑒𝑒𝑒𝑒𝐾𝐾𝑒𝑒' — extend the ontology if this is a real PK parameter (source ['Daniel_2026_table_S5:row2:col1', 'Daniel_2026_table_S5:row2:col2'])
- dropped unlinked row (NIL): '𝛽𝛽 𝑄𝑄𝑉𝑉𝑉𝑉𝑉𝑉' — extend the ontology if this is a real PK parameter (source ['Daniel_2026_table_S5:row6:col1', 'Daniel_2026_table_S5:row6:col2'])
...
- population split: '-' subgroup of Daniel_2026 (paper reports 5 populations: -, bauer et al (6), bukkems et al (7), value, will-pk)
...
- scholar stages: `../../../knowledgebase/drugs/drug_von_willebrand_factor/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Daniel_2026` / `Daniel_2026::pop`)
