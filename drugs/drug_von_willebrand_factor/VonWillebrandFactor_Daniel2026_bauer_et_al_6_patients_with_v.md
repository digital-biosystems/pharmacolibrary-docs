...
## Model component
<dbs-pgx drug="von Willebrand factor" model-id="VonWillebrandFactor_Daniel2026_bauer_et_al_6_patients_with_v" status="not_reviewed" stale="false" population="patients with von Willebrand disease" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_von_willebrand_factor/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Daniel_2026` / `Daniel_2026::bauer_et_al_6::patients with von Willebrand disease`)
