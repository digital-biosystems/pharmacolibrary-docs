...
# fluorouracil — `Fluorouracil_van2012_reference`
...
van Kuilenburg AB; Häusler P; Schalhorn A; Tanck MW; Proost JH; Terborg C; et al. et al. (2012). Clinical pharmacokinetics 51
  ·  DOI: [10.1007/BF03257473](https://doi.org/10.1007/BF03257473)

## Model component
<dbs-pgx drug="fluorouracil" model-id="Fluorouracil_van2012_reference" status="model_quarantined" stale="false" population="cancer patients with DPD deficiency and controls" measured-compound="5-fluorouracil" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| V 1 (L) | `Q63` · V1 | —(suppressed) | L | — | L | not captured | space_fold (0.95) | van_2012:results_prose | — | not captured |
| V 2 (L) | `Q64` · V2 | —(suppressed) | L | — | L | not captured | space_fold (0.95) | van_2012:results_prose | — | not captured |
| CL 12 (L h) | `Q22` · CL | —(suppressed) | L h | — | L h | not captured | boundary (0.8) | van_2012:results_prose | — | not captured |
| Q (L/h) | `Q30` · Q | —(suppressed) | L/h | — | L/h | not captured | review_gapfill (0.7) | Arshad_2020:review | — | not captured |
...
- salvaged Q63 ('V 1 (L)'=20.2) from results prose — parameter table was unreadable
- salvaged Q64 ('V 2 (L)'=15.7) from results prose — parameter table was unreadable
- salvaged Q22 ('CL 12 (L h)'=66.9) from results prose — parameter table was unreadable
...
| C9_phys_window_Q63 | pass | volume within physiological range | 20.2 L | not captured | not captured | ['van_2012:results_prose'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 15.7 L | not captured | not captured | ['van_2012:results_prose'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluorouracil/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `van_2012` / `van_2012::reference`)
- model: `../../../knowledgebase/drugs/drug_fluorouracil/models/modelica/_needs_review/Fluorouracil_van2012_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_fluorouracil/models/modelica/_needs_review/Fluorouracil_van2012_reference.deviation.json`
