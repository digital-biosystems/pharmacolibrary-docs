<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;L01B&quot;,&quot;href&quot;:&quot;atc/L01B.md&quot;},{&quot;label&quot;:&quot;fluorouracil&quot;,&quot;href&quot;:&quot;drugs/drug_fluorouracil/&quot;},{&quot;label&quot;:&quot;Gieschke_2003 \u00b7 remark&quot;}]"></div>

# fluorouracil — `Fluorouracil_Gieschke2003_remark`
...
3. Check the record's links in _interpretv2.yaml — every compartment needs a path to the dosed one.
4. Parent/metabolite records commonly miss the formation link.
...
## Model component
<dbs-pgx drug="fluorouracil" model-id="Fluorouracil_Gieschke2003_remark" status="rejected" stale="false" population="patients with advanced or metastatic colorectal cancer" measured-compound="5-fluorouracil" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|
| BSAV3: Effect of BSA on V3 | Q77 | not captured | llm_confirmed |

## Departures & gaps

**Interpretation flags:**
- column 'remark' classified 'other' by the LLM but kept: the deterministic diagnostic-column test disagrees (a stratum column is a value column, not a statistic)
- unit_dimension_mismatch: 'BSAV3: Effect of BSA on V3' → Q77 (unit '[luminosity] / [length] ** 2' vs ontology '[length] ** 3') — route to review
- dropped unlinked row (NIL): 'CLRCL3: Effect of CLCR on CL3' — extend the ontology if this is a real PK parameter (source ['tab_3:row14:col5'])
- dropped unlinked row (NIL): 'CLRV3: Effect of CLCR on V3' — extend the ontology if this is a real PK parameter (source ['tab_3:row15:col5'])
- dropped unlinked row (NIL): 'ALPCL2: Effect of ALP on CL2' — extend the ontology if this is a real PK parameter (source ['tab_3:row16:col5'])
...
- population split: 'remark' subgroup of Gieschke_2003 (paper reports 3 populations: re, remark, tv)
...
| C5_dimension_Q77 | fail | [luminosity] / [length] ** 2 | unit | not captured | not captured | ['tab_3:row13:col5'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluorouracil/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Gieschke_2003` / `Gieschke_2003::remark`)
