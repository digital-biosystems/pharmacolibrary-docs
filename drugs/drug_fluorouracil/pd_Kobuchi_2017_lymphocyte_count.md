...
| CL D — Final model | `Q358` · not captured | 2.5 | not captured | not captured | llm_corrected (not captured) | tab_0:row7:col2 |
| CL D | `Q358` · not captured | 14.2 | not captured | not captured | llm_corrected (not captured) | tab_0:row7:col3 |
| CL D — Bootstrap (n = 1000) | `Q358` · not captured | 2.5 | n = 1000 | not captured | llm_corrected (not captured) | tab_0:row7:col4 |
| CL D | `Q358` · not captured | 2.5 | not captured | not captured | llm_corrected (not captured) | tab_0:row7:col5 |
| CL D | `Q358` · not captured | 1.7 | not captured | not captured | llm_corrected (not captured) | tab_0:row7:col6 |
...
| CL D — Final model | `Q358` · not captured | 18.0 | not captured | not captured | llm_corrected (not captured) | tab_0:row10:col2 |
| CL D | `Q358` · not captured | 120.0 | not captured | not captured | llm_corrected (not captured) | tab_0:row10:col3 |
| CL D — Bootstrap (n = 1000) | `Q358` · not captured | 16.6 | n = 1000 | not captured | llm_corrected (not captured) | tab_0:row10:col4 |
| CL D | `Q358` · not captured | 15.9 | not captured | not captured | llm_corrected (not captured) | tab_0:row10:col5 |
| CL D | `Q358` · not captured | 0 | not captured | not captured | llm_corrected (not captured) | tab_0:row10:col6 |
