...
**Why:** a structural parameter has the wrong dimension; a compartment is unreachable, or a metabolite is unlinked.
...
## Model component
<dbs-pgx drug="fluorouracil" model-id="Fluorouracil_Deyme2019_klo_24" status="rejected" stale="false" population="patients with digestive cancers" measured-compound="fluorouracil" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| V3 (L) | `Q77` · V3 | 494.1 | L | 0.49410000000000004 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row3:col13 | — | not captured |
| Vss (L) | `Q65` · Vss | 494.1 | L | 0.49410000000000004 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row4:col13 | — | not captured |
| V2 (L) | `Q64` · V2 | 0.61 | L | 0.00061 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row7:col13 | — | not captured |
| V1 (L) | `Q63` · V1 | 1.6 | L | 0.0016 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row8:col13 | — | not captured |
| Vmax (mg/h) | `Q66` · Vmax | 0.15 | mg/h | not captured | [mg] / [h] | not captured | special_case (0.95) | Deyme_2019_table_4:row9:col13 | — | not captured |
...
- column 'klo (2006) [24]' classified 'other' by the LLM but kept: the deterministic diagnostic-column test disagrees (a stratum column is a value column, not a statistic)
...
- population split: 'klo (2006) [24]' subgroup of Deyme_2019 (paper reports 14 populations: bastian (2003) [26], beaty (2010) [31], berg (2015) [37], delord (2003) [25], fouadi (2006) [30], kimura (2010) [29], klein (2003) [38], klo (2006) [24], nikanjan (2015) [32], porta-oltra (2004) [34], poujol (2007) [27], terret (2000) [23], thompson (2008) [28], van kuijlenburg (2012) [36])
...
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row8:col13'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row7:col13'] |
| C5_dimension_Q65 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row4:col13'] |
| C5_dimension_Q66 | fail | [mass] / [time] | mg/h | not captured | not captured | ['Deyme_2019_table_4:row9:col13'] |
| C5_dimension_Q77 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row3:col13'] |
...
| C9_phys_window_Q63 | pass | volume within physiological range | 1.6 L | not captured | not captured | ['Deyme_2019_table_4:row8:col13'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 0.61 L | not captured | not captured | ['Deyme_2019_table_4:row7:col13'] |
| C9_phys_window_Q65 | pass | volume within physiological range | 494 L | not captured | not captured | ['Deyme_2019_table_4:row4:col13'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluorouracil/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Deyme_2019` / `Deyme_2019::klo_24`)
