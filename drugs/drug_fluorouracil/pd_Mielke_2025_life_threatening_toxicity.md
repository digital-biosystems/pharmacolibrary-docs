...
## Citation
Mielke H; Algharably EAE; Gundert-Remy U et al. (2025). Pharmaceuticals (Basel, Switzerland) 18
  ·  DOI: [10.3390/ph18050653](https://doi.org/10.3390/ph18050653)

## Parameters
| label (paper) | Q-code · name | value | unit | value_si | link | source |
|---|---|---|---|---|---|---|
| Cardiac output (Qc) (L/h) [47] — Physiological Data | `Q54` · not captured | 401.7 | not captured | not captured | llm (not captured) | pharmaceuticals-18-00653-t001:row1:col1 |
...
| Protein binding (%) [49] — Physiological Data | `Q46` · not captured | 8 | not captured | not captured | llm_confirmed (not captured) | pharmaceuticals-18-00653-t001:row16:col1 |
