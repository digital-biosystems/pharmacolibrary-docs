<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;L01B&quot;,&quot;href&quot;:&quot;atc/L01B.md&quot;},{&quot;label&quot;:&quot;fluorouracil&quot;,&quot;href&quot;:&quot;drugs/drug_fluorouracil/&quot;},{&quot;label&quot;:&quot;Brooks_2025 \u00b7 patients with gastrointestinal cancer&quot;}]"></div>
...
## Citation
Brooks GA; Ness DB; Hourdequin KC; Ripple GH; Amin M; Lord-Halvorson S; et al. et al. (2025). Cancer chemotherapy and pharmacology 95
...
|---|---|---|---|---|---|---|---|---|---|---|
| Intercept | `Q344` · logit_intercept | —(suppressed) | not captured | — | not captured | not captured | llm (0.5) | Tab2:row1:col1, Tab2:row1:col3 | — | not captured |
| 5-FU dose, mg/m2 | `Q46` · fu | —(suppressed) | not captured | — | not captured | not captured | boundary (0.8) | Tab2:row7:col1, Tab2:row7:col3 | — | not captured |
...
- dropped unlinked row (NIL): 'Cycle 2 (reference = cycle 1)' — extend the ontology if this is a real PK parameter (source ['Tab2:row2:col1', 'Tab2:row2:col3'])
- dropped unlinked row (NIL): 'Pretreatment plasma uracil concentration, ng/mL' — extend the ontology if this is a real PK parameter (source ['Tab2:row3:col1', 'Tab2:row3:col3'])
- dropped unlinked row (NIL): 'rs4294451 T-allele count (0, 1, or 2)' — extend the ontology if this is a real PK parameter (source ['Tab2:row4:col1', 'Tab2:row4:col3'])
- dropped unlinked row (NIL): 'Male sex (reference = female)' — extend the ontology if this is a real PK parameter (source ['Tab2:row5:col1', 'Tab2:row5:col3'])
...
- unparsed cell Tab2:row2:col2 = '−7.98, 2.53'
- unparsed cell Tab2:row3:col2 = '−0.43, 0.75'
- unparsed cell Tab2:row4:col2 = '−7.98, −0.008'
- unparsed cell Tab2:row5:col2 = '−13.78, −1.30'
- unparsed cell Tab2:row6:col2 = '−4.07, 29.26'
- unparsed cell Tab2:row7:col2 = '−0.005, 0.031'
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluorouracil/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Brooks_2025` / `Brooks_2025::patients with gastrointestinal cancer`)
