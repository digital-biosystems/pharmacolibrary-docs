...
## Model component
<dbs-pgx drug="fluorouracil" model-id="Fluorouracil_Deyme2019_poujol_27" status="rejected" stale="false" population="patients with digestive cancers" measured-compound="fluorouracil" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h) | `Q22` · CL | 31.7 | L/h | 8.805555555555555e-06 | [l] / [h] | not captured | exact (1.0) | Deyme_2019_table_4:row0:col20 | — | not captured |
| V2 (L) | `Q64` · V2 | 102 | L | 0.10200000000000001 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row2:col20 | — | not captured |
| V3 (L) | `Q77` · V3 | 267.3 | L | 0.26730000000000004 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row3:col20 | — | not captured |
| Vss (L) | `Q65` · Vss | 8.59 | L | 0.00859 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row4:col20 | — | not captured |
| Q1 (L/h) | `Q30` · Q | 193 | L/h | 5.3611111111111115e-05 | [l] / [h] | not captured | exact (1.0) | Deyme_2019_table_4:row5:col20 | — | not captured |
...
- population split: 'poujol (2007) [27]' subgroup of Deyme_2019 (paper reports 14 populations: bastian (2003) [26], beaty (2010) [31], berg (2015) [37], delord (2003) [25], fouadi (2006) [30], kimura (2010) [29], klein (2003) [38], klo (2006) [24], nikanjan (2015) [32], porta-oltra (2004) [34], poujol (2007) [27], terret (2000) [23], thompson (2008) [28], van kuijlenburg (2012) [36])
...
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Deyme_2019_table_4:row5:col20'] |
...
| C5_dimension_Q65 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row4:col20'] |
...
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 31.7 | not captured | not captured | ['Deyme_2019_table_4:row0:col20'] |
...
| C9_phys_window_Q22 | pass | clearance within physiological range | 31.7 L/h | not captured | not captured | ['Deyme_2019_table_4:row0:col20'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 161 L | not captured | not captured | ['Deyme_2019:review'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 102 L | not captured | not captured | ['Deyme_2019_table_4:row2:col20'] |
| C9_phys_window_Q65 | pass | volume within physiological range | 8.59 L | not captured | not captured | ['Deyme_2019_table_4:row4:col20'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluorouracil/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Deyme_2019` / `Deyme_2019::poujol_27`)
