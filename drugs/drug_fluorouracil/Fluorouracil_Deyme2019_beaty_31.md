...
**Why:** a compartment is unreachable, or a metabolite is unlinked; a parameter falls outside the physiological window
...
## Model component
<dbs-pgx drug="fluorouracil" model-id="Fluorouracil_Deyme2019_beaty_31" status="rejected" stale="false" population="patients with digestive cancers" measured-compound="fluorouracil" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h) | `Q22` · CL | 21.1 | L/h | 5.861111111111111e-06 | [l] / [h] | not captured | exact (1.0) | Deyme_2019_table_4:row0:col15 | — | not captured |
| V2 (L) | `Q64` · V2 | 5364 | L | 5.364 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row2:col15, Deyme_2019_table_4:row7:col15 | — | not captured |
| V3 (L) | `Q77` · V3 | 5711 | L | 5.711 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row3:col15 | — | not captured |
| Vss (L) | `Q65` · Vss | 29.5 | L | 0.029500000000000002 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row4:col15 | — | not captured |
| Q2 (L/h) | `Q30` · Q | 0.061 | L/h | 1.6944444444444443e-08 | [l] / [h] | not captured | special_case (0.95) | Deyme_2019_table_4:row6:col15 | — | not captured |
| V1 (L) | `Q63` · V1 | 0.0055 | L | 5.5e-06 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row8:col15 | — | not captured |
...
- column 'beaty (2010) [31]' classified 'other' by the LLM but kept: the deterministic diagnostic-column test disagrees (a stratum column is a value column, not a statistic)
...
- population split: 'beaty (2010) [31]' subgroup of Deyme_2019 (paper reports 14 populations: bastian (2003) [26], beaty (2010) [31], berg (2015) [37], delord (2003) [25], fouadi (2006) [30], kimura (2010) [29], klein (2003) [38], klo (2006) [24], nikanjan (2015) [32], porta-oltra (2004) [34], poujol (2007) [27], terret (2000) [23], thompson (2008) [28], van kuijlenburg (2012) [36])
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Deyme_2019_table_4:row0:col15'] |
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Deyme_2019_table_4:row6:col15'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Bae_2026:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row8:col15'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row2:col15', 'Deyme_2019_table_4:row7:col15'] |
| C5_dimension_Q65 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row4:col15'] |
| C5_dimension_Q77 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row3:col15'] |
| C5_dimension_Q83 | pass | [time] | not captured | not captured | not captured | ['Blesch_2003:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 21.1 | not captured | not captured | ['Deyme_2019_table_4:row0:col15'] |
...
| C9_phys_window_Q22 | pass | clearance within physiological range | 21.1 L/h | not captured | not captured | ['Deyme_2019_table_4:row0:col15'] |
| C9_phys_window_Q63 | fail | volume within physiological range | 0.0055 L | not captured | not captured | ['Deyme_2019_table_4:row8:col15'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 5.36e+03 L | not captured | not captured | ['Deyme_2019_table_4:row2:col15', 'Deyme_2019_table_4:row7:col15'] |
| C9_phys_window_Q65 | pass | volume within physiological range | 29.5 L | not captured | not captured | ['Deyme_2019_table_4:row4:col15'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluorouracil/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Deyme_2019` / `Deyme_2019::beaty_31`)
