...
## Model component
<dbs-pgx drug="fluorouracil" model-id="Fluorouracil_Deyme2019_bastian_26" status="rejected" stale="false" population="patients with digestive cancers" measured-compound="fluorouracil" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| V3 (L) | `Q77` · V3 | 160.9 | L | 0.16090000000000002 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row3:col17 | — | not captured |
| Q2 (L/h) | `Q30` · Q | 0.57 | L/h | 1.5833333333333333e-07 | [l] / [h] | not captured | special_case (0.95) | Deyme_2019_table_4:row6:col17 | — | not captured |
| V2 (L) | `Q64` · V2 | 1.4 | L | 0.0014 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row7:col17 | — | not captured |
| V1 (L) | `Q63` · V1 | 0.26 | L | 0.00026000000000000003 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row8:col17 | — | not captured |
...
- column 'bastian (2003) [26]' classified 'other' by the LLM but kept: the deterministic diagnostic-column test disagrees (a stratum column is a value column, not a statistic)
...
- population split: 'bastian (2003) [26]' subgroup of Deyme_2019 (paper reports 14 populations: bastian (2003) [26], beaty (2010) [31], berg (2015) [37], delord (2003) [25], fouadi (2006) [30], kimura (2010) [29], klein (2003) [38], klo (2006) [24], nikanjan (2015) [32], porta-oltra (2004) [34], poujol (2007) [27], terret (2000) [23], thompson (2008) [28], van kuijlenburg (2012) [36])
...
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Deyme_2019_table_4:row6:col17'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Bae_2026:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row8:col17'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row7:col17'] |
| C5_dimension_Q77 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row3:col17'] |
...
| C9_phys_window_Q63 | fail | volume within physiological range | 0.26 L | not captured | not captured | ['Deyme_2019_table_4:row8:col17'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 1.4 L | not captured | not captured | ['Deyme_2019_table_4:row7:col17'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluorouracil/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Deyme_2019` / `Deyme_2019::bastian_26`)
