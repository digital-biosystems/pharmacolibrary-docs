...
|---|---|---|---|---|---|---|---|---|---|---|
| CL1 | `Q22` · CL | —(suppressed) | L/h | — | L/h | not captured | review (0.7) | Blesch_2003:review | — | not captured |
| V1 | `Q63` · V1 | —(suppressed) | L | — | L | not captured | review (0.7) | Blesch_2003:review | — | not captured |
| TLAG | `Q83` · tlag | —(suppressed) | h | — | h | not captured | review (0.7) | Blesch_2003:review | — | not captured |
...
- built from REVIEW reference values (Blesch_2003) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Blesch_2003:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Blesch_2003:review'] |
| C5_dimension_Q83 | pass | [time] | not captured | not captured | not captured | ['Blesch_2003:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 75.8 | not captured | not captured | ['Blesch_2003:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 75.8 L/h | not captured | not captured | ['Blesch_2003:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 90.6 L | not captured | not captured | ['Blesch_2003:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluorouracil/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Blesch_2003` / `Blesch_2003::reference`)
- model: `../../../knowledgebase/drugs/drug_fluorouracil/models/modelica/Fluorouracil_Blesch2003_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_fluorouracil/models/modelica/Fluorouracil_Blesch2003_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_fluorouracil/models/modelica/Fluorouracil_Blesch2003_reference.json`
...
<img src="drugs/drug_fluorouracil/Fluorouracil_Blesch2003_reference/Fluorouracil_Blesch2003_reference.svg" alt="Fluorouracil_Blesch2003_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_fluorouracil/Fluorouracil_Blesch2003_reference/Fluorouracil_Blesch2003_reference_matlab.zip" download>Fluorouracil_Blesch2003_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_fluorouracil/Fluorouracil_Blesch2003_reference/Fluorouracil_Blesch2003_reference_cellml.zip" download>Fluorouracil_Blesch2003_reference_cellml.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
</tbody></table>
...
<sub>Template `PK_1C` · parameters `Fluorouracil_Blesch2003_reference_params.json` · controls `Fluorouracil_Blesch2003_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
