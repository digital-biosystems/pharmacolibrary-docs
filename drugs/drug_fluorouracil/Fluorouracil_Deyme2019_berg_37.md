...
## Model component
<dbs-pgx drug="fluorouracil" model-id="Fluorouracil_Deyme2019_berg_37" status="rejected" stale="false" population="patients with digestive cancers" measured-compound="fluorouracil" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| V3 (L) | `Q77` · V3 | 300 | L | 0.3 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row3:col19 | — | not captured |
| Q2 (L/h) | `Q30` · Q | 0.286 | L/h | 7.944444444444444e-08 | [l] / [h] | not captured | special_case (0.95) | Deyme_2019_table_4:row6:col19 | — | not captured |
| V2 (L) | `Q64` · V2 | 0.180 | L | 0.00017999999999999998 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row7:col19 | — | not captured |
| V1 (L) | `Q63` · V1 | 0.188 | L | 0.00018800000000000002 | [l] | not captured | exact (1.0) | Deyme_2019_table_4:row8:col19 | — | not captured |
...
- population split: 'berg (2015) [37]' subgroup of Deyme_2019 (paper reports 14 populations: bastian (2003) [26], beaty (2010) [31], berg (2015) [37], delord (2003) [25], fouadi (2006) [30], kimura (2010) [29], klein (2003) [38], klo (2006) [24], nikanjan (2015) [32], porta-oltra (2004) [34], poujol (2007) [27], terret (2000) [23], thompson (2008) [28], van kuijlenburg (2012) [36])
...
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Deyme_2019_table_4:row6:col19'] |
| C5_dimension_Q49 | pass | 1 / [time] | not captured | not captured | not captured | ['Bae_2026:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row8:col19'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row7:col19'] |
| C5_dimension_Q77 | pass | [length] ** 3 | not captured | not captured | not captured | ['Deyme_2019_table_4:row3:col19'] |
...
| C9_phys_window_Q63 | fail | volume within physiological range | 0.188 L | not captured | not captured | ['Deyme_2019_table_4:row8:col19'] |
| C9_phys_window_Q64 | fail | volume within physiological range | 0.18 L | not captured | not captured | ['Deyme_2019_table_4:row7:col19'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fluorouracil/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Deyme_2019` / `Deyme_2019::berg_37`)
