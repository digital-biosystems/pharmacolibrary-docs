...
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[q 1]` (0.04 vs not captured) and 5 more field(s) — a structural parameter, so the record is disputed.
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[q 1]` | 0.04 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[q 2]` | not captured | 0.09 | only_one_extracted |
| `gpt-oss:120b` | `parameters[v p1]` | not captured | 18.32 | only_one_extracted |
| `gpt-oss:120b` | `parameters[v p2].parameter_id` | Q61 | Q77 | mismatch |
| `gpt-oss:120b` | `parameters[θ tp]` | not captured | -1.73 | only_one_extracted |
| `gpt-oss:120b` | `parameters[σ].parameter_id` | Q316 | Q315 | mismatch |
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_methotrexate/Methotrexate_Wei2025_reference/Methotrexate_Wei2025_reference_matlab.zip" download>Methotrexate_Wei2025_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
...
---
<sub>Generated by `docs.py` (scholarv2) · extracted 2026-07-15 13:24 UTC</sub>
