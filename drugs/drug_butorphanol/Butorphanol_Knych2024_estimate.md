...
<img src="drugs/drug_butorphanol/Butorphanol_Knych2024_estimate/Butorphanol_Knych2024_estimate.svg" alt="Butorphanol_Knych2024_estimate diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_3C_enteral` · parameters `Butorphanol_Knych2024_estimate_params.json` · controls `Butorphanol_Knych2024_estimate_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
