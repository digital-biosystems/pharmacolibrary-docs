...
<sub>Template `PK_2C` · parameters `Butorphanol_Pypendop2021_reference_params.json` · controls `Butorphanol_Pypendop2021_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
