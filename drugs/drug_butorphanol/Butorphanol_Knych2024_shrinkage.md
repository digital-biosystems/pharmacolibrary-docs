...
|---|---|---|---|---|---|---|---|---|---|---|
| tvKa (1/h) | `Q49` · kabs | —(suppressed) | 1/h | — | 1/h | not captured | tv_prefix (0.95) | Knych_2024:other_prose | — | not captured |
| tvV/F (L/kg) | `Q76` · V/F | —(suppressed) | L/kg | — | L | not captured | tv_prefix (0.95) | Knych_2024:other_prose | — | not captured |
| tvV2/F (L/kg) | `Q82` · V2/F | —(suppressed) | L/kg | — | L | not captured | tv_prefix (0.95) | Knych_2024:other_prose | — | not captured |
| tvCl/F (mL/min/kg) | `Q27` · CL/F | —(suppressed) | mL/min/kg | — | L/h | not captured | tv_prefix (0.95) | Knych_2024:other_prose | — | not captured |
| V | `Q61` · V | —(suppressed) | not captured | — | L | not captured | exact (1.0) | Knych_2024:other_prose | — | not captured |
| V2 | `Q64` · V2 | —(suppressed) | not captured | — | L | not captured | exact (1.0) | Knych_2024:other_prose | — | not captured |
| Cl | `Q22` · CL | —(suppressed) | not captured | — | L/h | not captured | exact (1.0) | Knych_2024:other_prose | — | not captured |
| Cl2 | `Q30` · Q | —(suppressed) | not captured | — | L/h | not captured | special_case (0.95) | Knych_2024:other_prose | — | not captured |
...
<sub>Template `PK_3C_enteral` · parameters `Butorphanol_Knych2024_shrinkage_params.json` · controls `Butorphanol_Knych2024_shrinkage_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
