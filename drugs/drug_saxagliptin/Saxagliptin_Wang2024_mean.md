...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (ng/mL) | `Q32` · Cmax | 3716.88 | ng/mL | not captured | [ng] / [ml] | not captured | exact (1.0) | Tab11:row1:col1, Wang_2024_table_9:row0:col1 | — | not captured |
| Tmax (h) | `Q56` · tmax | 0.11 | h | 396.0 | [h] | not captured | exact (1.0) | Tab11:row2:col1 | — | not captured |
| AUC (ng*h/mL) | `Q88` · AUC | 585.04 | ng*h/mL | not captured | [[h] · [ng]] / [ml] | not captured | exact (1.0) | Tab11:row3:col1, Wang_2024_table_9:row1:col1 | — | not captured |
| t1/2Ka (h) | `Q95` · t1/2ka | 0.07 | h | 252.00000000000003 | [h] | not captured | exact (1.0) | Tab11:row4:col1 | — | not captured |
| t1/2a (h) | `Q59` · t1/2α | 0.06 | h | 216.0 | [h] | not captured | llm_corrected (0.6) | Tab11:row5:col1, Wang_2024_table_9:row2:col1 | — | not captured |
| t1/2β (h) | `Q60` · t1/2β | 0.36 | h | 1296.0 | [h] | not captured | exact (1.0) | Tab11:row6:col1, Wang_2024_table_9:row3:col1 | — | not captured |
| V (mL/kg) | `Q61` · V | 2307.24 | mL/kg | 0.16150679999999995 | [ml] / [kg] | not captured | exact (1.0) | Tab11:row7:col1 | — | not captured |
| V2 (mL/kg) | `Q64` · V2 | 18393.30 | mL/kg | 1.2875309999999998 | [ml] / [kg] | not captured | exact (1.0) | Tab11:row8:col1 | — | not captured |
| CL (mL/h/kg) | `Q22` · CL | 3245.80 | mL/h/kg | 6.311277777777779e-05 | [ml] / [[h] · [kg]] | not captured | exact (1.0) | Tab11:row9:col1 | — | not captured |
| CL2 (mL/h/kg) | `Q30` · Q | 17090.42 | mL/h/kg | 0.0003323137222222222 | [ml] / [[h] · [kg]] | not captured | special_case (0.95) | Tab11:row10:col1 | — | not captured |
| K12 (1/h) | `Q301` · k12 | 3.51 | not captured | not captured | not captured | not captured | exact (1.0) | Tab11:row11:col1, Wang_2024_table_9:row8:col1 | — | not captured |
| K21 (1/h) | `Q302` · k21 | 3.42 | not captured | not captured | not captured | not captured | exact (1.0) | Tab11:row12:col1, Wang_2024_table_9:row9:col1 | — | not captured |
