...
# elastase enzyme activity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Mota FAR; Pereira SAP; Araujo ARTS; Saraiva MLMFS et al. (2021). Molecules (Basel, Switzerland) 26
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | ionic liquids and ionic liquids active pharmaceutical ingredients | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q321]` | 229.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 289 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 0.47 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 208 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 201 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 248 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 239 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 194 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 239 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 176 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 233 | not captured | only_one_extracted |
