...
## Citation
Mathurkar S; Singh P; Kongara K; Chambers P et al. (2018). Animals : an open access journal from MDPI 8
...
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Mathurkar_2018:review'] |
...
| C9_phys_window_Q61 | pass | volume within physiological range | 84 L | not captured | not captured | ['Mathurkar_2018:review'] |
...
| T3_output_variable | not captured | pass | C_central (measured=sodium_salicylate) | central.C | not captured | output must be the measured/analyte compartment |
...
- scholar stages: `../../../knowledgebase/drugs/drug_sodium_salicylate/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Mathurkar_2018` / `Mathurkar_2018::reference`)
- model: `../../../knowledgebase/drugs/drug_sodium_salicylate/models/modelica/SodiumSalicylate_Mathurkar2018_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_sodium_salicylate/models/modelica/SodiumSalicylate_Mathurkar2018_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_sodium_salicylate/models/modelica/SodiumSalicylate_Mathurkar2018_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_sodium_salicylate/SodiumSalicylate_Mathurkar2018_reference/SodiumSalicylate_Mathurkar2018_reference_modelica.zip" download>SodiumSalicylate_Mathurkar2018_reference_modelica.zip</a> <span class="pk-size">(3.5 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_sodium_salicylate/SodiumSalicylate_Mathurkar2018_reference/SodiumSalicylate_Mathurkar2018_reference_matlab.zip" download>SodiumSalicylate_Mathurkar2018_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
