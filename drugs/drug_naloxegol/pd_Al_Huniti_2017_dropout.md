...
# time to discontinuation — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.5). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Al-Huniti N; Xu H; Zhou D; Aksenov S; Fox R; Bui KH et al. (2017). CPT: pharmacometrics & systems pharmacology 6
...
| `gpt-oss:120b` | `model_family` | linear | categorical | mismatch |
...
---
<sub>← back to [naloxegol](drugs/drug_naloxegol/)</sub>
