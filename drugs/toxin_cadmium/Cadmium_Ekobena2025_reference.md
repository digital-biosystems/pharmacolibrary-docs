...
## Model component
<dbs-pgx drug="cadmium" model-id="Cadmium_Ekobena2025_reference" status="extracted" stale="false" population="" measured-compound="cadmium" parameterization="apparent" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/toxins/toxin_cadmium/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Ekobena_2025` / `Ekobena_2025::reference`)
