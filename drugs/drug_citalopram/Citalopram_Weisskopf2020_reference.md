...
## Model component
<dbs-pgx drug="citalopram" model-id="Citalopram_Weisskopf2020_reference" status="extracted" stale="false" population="depressive patients during the perinatal period" measured-compound="escitalopram" parameterization="mechanistic" topology="parent_metabolite"></dbs-pgx>
