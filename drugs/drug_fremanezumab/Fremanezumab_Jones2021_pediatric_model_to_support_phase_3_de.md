...
| `gpt-oss:120b` | `parameters[f1: bioavailability]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[vof]` | not captured | 201.396 | only_one_extracted |
