...
|---|---|---|---|---|---|---|---|---|---|---|
| CL: central clearance (L/day) | `Q22` · CL | —(suppressed) | L/day | — | [l] / [d] | not captured | llm_confirmed (0.6) | pharmaceutics-13-00785-t001:row1:col2 | — | not captured |
| Vc: central volume of distribution (L) | `Q63` · V1 | —(suppressed) | L | — | [l] | not captured | llm_corrected (0.6) | pharmaceutics-13-00785-t001:row3:col2 | — | not captured |
| ka: absorption rate constant (1/day) | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | pharmaceutics-13-00785-t001:row5:col2 | — | not captured |
| Q: intercompartmental clearance (L/day) | `Q30` · Q | —(suppressed) | L/day | — | [l] / [d] | not captured | llm_confirmed (0.6) | pharmaceutics-13-00785-t001:row6:col2 | — | not captured |
| Vp: peripheral volume of distribution (L) | `Q64` · V2 | —(suppressed) | L | — | [l] | not captured | llm_corrected (0.6) | pharmaceutics-13-00785-t001:row7:col2 | — | not captured |
| theta_q319_weight_power | `Q900` · theta_q319_weight_power | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | pharmaceutics-13-00785-t001:row2:col2 | — | not captured |
| theta_q319_weight_power | `Q900` · theta_q319_weight_power | —(suppressed) | not captured | — | not captured | not captured | not captured (not captured) | pharmaceutics-13-00785-t001:row4:col2 | — | not captured |
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_2C_enteral` · parameters `Fremanezumab_Jones2021_pediatric_model_to_support_phase_3_de_params.json` · controls `Fremanezumab_Jones2021_pediatric_model_to_support_phase_3_de_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
