...
## Model component
<dbs-pgx drug="fentanyl" model-id="Fentanyl_Reed2024_dose_absorbed_mg" status="needs_review" stale="false" population="healthy adult horses" measured-compound="fentanyl" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- dropped unlinked row (NIL): 'LDF' — extend the ontology if this is a real PK parameter (source ['Reed_2024_table_3:row0:col2'])
- dropped unlinked row (NIL): 'MDF' — extend the ontology if this is a real PK parameter (source ['Reed_2024_table_3:row1:col2'])
- dropped unlinked row (NIL): 'HDF' — extend the ontology if this is a real PK parameter (source ['Reed_2024_table_3:row2:col2'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=fentanyl
- population split: 'dose absorbed (mg)' subgroup of Reed_2024 (paper reports 4 populations: dose absorbed (mg), estimate, fractional bioavailability (%), target dose(mg))
...
- scholar stages: `../../../knowledgebase/drugs/drug_fentanyl/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Reed_2024` / `Reed_2024::dose_absorbed_mg`)
- model: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/Fentanyl_Reed2024_dose_absorbed_mg.mo`
- deviation: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/Fentanyl_Reed2024_dose_absorbed_mg.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/Fentanyl_Reed2024_dose_absorbed_mg.json`
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_fentanyl/Fentanyl_Reed2024_dose_absorbed_mg/Fentanyl_Reed2024_dose_absorbed_mg_matlab.zip" download>Fentanyl_Reed2024_dose_absorbed_mg_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_fentanyl/Fentanyl_Reed2024_dose_absorbed_mg/Fentanyl_Reed2024_dose_absorbed_mg_matlab_simbio.zip" download>Fentanyl_Reed2024_dose_absorbed_mg_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
