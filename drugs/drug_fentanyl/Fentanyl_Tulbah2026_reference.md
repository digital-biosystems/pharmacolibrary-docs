...
## Citation
Tulbah Y; Aljamaan I et al. (2026). Frontiers in pharmacology 17
  ·  DOI: [10.3389/fphar.2026.1741851](https://doi.org/10.3389/fphar.2026.1741851)

## Model component
<dbs-pgx drug="fentanyl" model-id="Fentanyl_Tulbah2026_reference" status="curated_candidate" stale="false" population="" measured-compound="fentanyl" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL 1 | `Q22` · CL | 2.25 | L/min/70 kg | 3.7500000000000003e-05 | L/h | not captured | review (0.7) | Tulbah_2026:review | — | not captured |
| V 1 | `Q63` · V1 | 4.47 | L/70 kg | 0.00447 | L | not captured | review (0.7) | Tulbah_2026:review | — | not captured |
| V 2 | `Q64` · V2 | 26.6 | L/70kg | 0.026600000000000002 | L | not captured | review (0.7) | Tulbah_2026:review | — | not captured |
| Q 2 | `Q30` · Q | 3.2 | L/min/70 kg | 5.333333333333333e-05 | L/h | not captured | review (0.7) | Tulbah_2026:review | — | not captured |
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tulbah_2026:review'] |
| C5_dimension_Q30 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tulbah_2026:review'] |
| C5_dimension_Q63 | pass | [length] ** 3 | not captured | not captured | not captured | ['Tulbah_2026:review'] |
| C5_dimension_Q64 | pass | [length] ** 3 | not captured | not captured | not captured | ['Tulbah_2026:review'] |
| C6_cl_magnitude | pass | &lt;= 90.0 L/h | 2.25 | not captured | not captured | ['Tulbah_2026:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 135 L/h | not captured | not captured | ['Tulbah_2026:review'] |
| C9_phys_window_Q63 | pass | volume within physiological range | 4.47 L | not captured | not captured | ['Tulbah_2026:review'] |
| C9_phys_window_Q64 | pass | volume within physiological range | 26.6 L | not captured | not captured | ['Tulbah_2026:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fentanyl/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Tulbah_2026` / `Tulbah_2026::reference`)
- model: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/Fentanyl_Tulbah2026_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/Fentanyl_Tulbah2026_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/Fentanyl_Tulbah2026_reference.json`
...
<img src="drugs/drug_fentanyl/Fentanyl_Tulbah2026_reference/Fentanyl_Tulbah2026_reference.svg" alt="Fentanyl_Tulbah2026_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_fentanyl/Fentanyl_Tulbah2026_reference/Fentanyl_Tulbah2026_reference_modelica.zip" download>Fentanyl_Tulbah2026_reference_modelica.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_fentanyl/Fentanyl_Tulbah2026_reference/Fentanyl_Tulbah2026_reference_matlab.zip" download>Fentanyl_Tulbah2026_reference_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
<sub>Template `PK_2C` · parameters `Fentanyl_Tulbah2026_reference_params.json` · controls `Fentanyl_Tulbah2026_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
