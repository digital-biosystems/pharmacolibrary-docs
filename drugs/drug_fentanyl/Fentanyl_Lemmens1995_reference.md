...
## Citation
Lemmens HJ et al. (1995). Clinical pharmacokinetics 29
  ·  DOI: [10.2165/00003088-199529040-00003](https://doi.org/10.2165/00003088-199529040-00003)

## Model component
<dbs-pgx drug="fentanyl" model-id="Fentanyl_Lemmens1995_reference" status="needs_review" stale="false" population="unknown" measured-compound="fentanyl" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Remifentanil clearance | `Q22` · CL | 168.0 | L/h | 4.666666666666667e-05 | L/h | not captured | review (0.7) | Lemmens_1995:review | — | not captured |
| Fentanyl Vc | `Q63` · V1 | 17.0 | L | 0.017 | L | not captured | review (0.7) | Lemmens_1995:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fentanyl/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Lemmens_1995` / `Lemmens_1995::reference`)
