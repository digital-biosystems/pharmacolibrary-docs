...
# transcutaneous pCO2 — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.5). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | nalmefene | nalmefene or naloxone | mismatch |
| `gpt-oss:120b` | `model_family` | transduction | effect_compartment | mismatch |
