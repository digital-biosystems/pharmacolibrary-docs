...
Egan TD et al. (1995). Clinical pharmacokinetics 29
  ·  DOI: [10.2165/00003088-199529020-00003](https://doi.org/10.2165/00003088-199529020-00003)

## Model component
<dbs-pgx drug="fentanyl" model-id="Fentanyl_Egan1995_reference" status="rejected" stale="false" population="" measured-compound="fentanyl" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| mean central clearance | `Q22` · CL | —(suppressed) | ml/min/kg | — | L/h | not captured | review (0.7) | Egan_1995:review | — | not captured |
| Central | `Q61` · V | —(suppressed) | L | — | L | not captured | review (0.7) | Egan_1995:review | — | not captured |
| Peripheral 1 | `Q64` · V2 | —(suppressed) | L | — | L | not captured | review (0.7) | Egan_1995:review | — | not captured |
...
- built from REVIEW reference values (Egan_1995) — secondary source
...
- scholar stages: `../../../knowledgebase/drugs/drug_fentanyl/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Egan_1995` / `Egan_1995::reference`)
