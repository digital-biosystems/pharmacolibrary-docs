...
|---|---|---|---|---|---|---|---|---|---|---|
| Clearance | `Q22` · CL | 132.0 | L/h | 3.6666666666666666e-05 | L/h | not captured | review (0.7) | Langley_1988:review | — | not captured |
| Vd c | `Q61` · V | 76.0 | L | 0.076 | L | not captured | review (0.7) | Langley_1988:review | — | not captured |
...
- built from REVIEW reference values (Langley_1988) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Langley_1988:review'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Langley_1988:review'] |
| C6_cl_magnitude | fail | &lt;= 90.0 L/h | 132.0 | not captured | not captured | ['Langley_1988:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 132 L/h | not captured | not captured | ['Langley_1988:review'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 76 L | not captured | not captured | ['Langley_1988:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_fentanyl/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Langley_1988` / `Langley_1988::reference`)
