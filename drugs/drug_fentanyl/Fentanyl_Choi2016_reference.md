...
## Model component
<dbs-pgx drug="fentanyl" model-id="Fentanyl_Choi2016_reference" status="model_quarantined" stale="false" population="critically ill adults" measured-compound="fentanyl" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL = θ1 + θ2Wgtc + θ3SLDCHF | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | T2:row3:col4 | — | not captured |
| V1 | `Q63` · V1 | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | T2:row7:col1, T2:row7:col4 | — | not captured |
| V2 = θ4+ θ5Wgtc | `Q64` · V2 | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | T2:row8:col4 | — | not captured |
| Q | `Q30` · Q | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | T2:row11:col1, T2:row11:col4 | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/_needs_review/Fentanyl_Choi2016_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/_needs_review/Fentanyl_Choi2016_reference.deviation.json`
