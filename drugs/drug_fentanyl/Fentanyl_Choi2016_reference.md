...
## Model component
<dbs-pgx drug="fentanyl" model-id="Fentanyl_Choi2016_reference" status="not_modelled" stale="false" population="critically ill adults" measured-compound="fentanyl" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_fentanyl/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Choi_2016` / `Choi_2016::critically ill adults`)
