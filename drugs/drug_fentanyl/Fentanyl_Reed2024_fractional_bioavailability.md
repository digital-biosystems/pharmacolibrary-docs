...
## Model component
<dbs-pgx drug="fentanyl" model-id="Fentanyl_Reed2024_fractional_bioavailability" status="needs_review" stale="false" population="healthy adult horses" measured-compound="fentanyl" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| clearance | `Q22` · CL | 0.651 | L/h/kg | 1.2658333333333334e-05 | L/h | not captured | review_gapfill (0.7) | Cavallaro_2026:review | — | not captured |
...
- dropped unlinked row (NIL): 'LDF' — extend the ontology if this is a real PK parameter (source ['Reed_2024_table_3:row0:col3'])
- dropped unlinked row (NIL): 'MDF' — extend the ontology if this is a real PK parameter (source ['Reed_2024_table_3:row1:col3'])
- dropped unlinked row (NIL): 'HDF' — extend the ontology if this is a real PK parameter (source ['Reed_2024_table_3:row2:col3'])
- apparent-ness (ontology-grounded): parameterization=mechanistic, measured_compound=fentanyl
- population split: 'fractional bioavailability (%)' subgroup of Reed_2024 (paper reports 4 populations: dose absorbed (mg), estimate, fractional bioavailability (%), target dose(mg))
...
- scholar stages: `../../../knowledgebase/drugs/drug_fentanyl/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Reed_2024` / `Reed_2024::fractional_bioavailability`)
- model: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/Fentanyl_Reed2024_fractional_bioavailability.mo`
- deviation: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/Fentanyl_Reed2024_fractional_bioavailability.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_fentanyl/models/modelica/Fentanyl_Reed2024_fractional_bioavailability.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_fentanyl/Fentanyl_Reed2024_fractional_bioavailability/Fentanyl_Reed2024_fractional_bioavailability_modelica.zip" download>Fentanyl_Reed2024_fractional_bioavailability_modelica.zip</a> <span class="pk-size">(3.8 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><a href="drugs/drug_fentanyl/Fentanyl_Reed2024_fractional_bioavailability/Fentanyl_Reed2024_fractional_bioavailability_fmi.zip" download>Fentanyl_Reed2024_fractional_bioavailability_fmi.zip</a> <span class="pk-size">(4.1 kB)</span><br><a href="models/fmu/PK_1C.fmu" download>PK_1C.fmu</a> <span class="pk-size">(1.3 MB, shared)</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_fentanyl/Fentanyl_Reed2024_fractional_bioavailability/Fentanyl_Reed2024_fractional_bioavailability_matlab.zip" download>Fentanyl_Reed2024_fractional_bioavailability_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_fentanyl/Fentanyl_Reed2024_fractional_bioavailability/Fentanyl_Reed2024_fractional_bioavailability_matlab_simbio.zip" download>Fentanyl_Reed2024_fractional_bioavailability_matlab_simbio.zip</a> <span class="pk-size">(2.8 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_fentanyl/Fentanyl_Reed2024_fractional_bioavailability/Fentanyl_Reed2024_fractional_bioavailability_sbml.zip" download>Fentanyl_Reed2024_fractional_bioavailability_sbml.zip</a> <span class="pk-size">(2.5 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_fentanyl/Fentanyl_Reed2024_fractional_bioavailability/Fentanyl_Reed2024_fractional_bioavailability_cellml.zip" download>Fentanyl_Reed2024_fractional_bioavailability_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_fentanyl/Fentanyl_Reed2024_fractional_bioavailability/Fentanyl_Reed2024_fractional_bioavailability.svg" alt="Fentanyl_Reed2024_fractional_bioavailability diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>

<div class="pk-tab-mark" data-tab="Simulation"></div>

<dbs-fmusim paramsurl="drugs/drug_fentanyl/Fentanyl_Reed2024_fractional_bioavailability/Fentanyl_Reed2024_fractional_bioavailability_params.json" metaurl="assets/fmu/PK_1C.vr.json" wasmurl="assets/fmu/PK_1C.js" controlsurl="drugs/drug_fentanyl/Fentanyl_Reed2024_fractional_bioavailability/Fentanyl_Reed2024_fractional_bioavailability_sim_controls.json"></dbs-fmusim>

<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C` · parameters `Fentanyl_Reed2024_fractional_bioavailability_params.json` · controls `Fentanyl_Reed2024_fractional_bioavailability_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
