...
# CYP2D6 — PGx  <span class="pk-badge pk-badge--orange">needs review</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.143). The first reading is what the record holds.">cross-check: disputed</span>
...
- **paper:** `Frederiksen_2023_3`
- **gene:** CYP2D6
- **mechanism:** metabolism
- **applies to:** pk
- **target:** `Q27` CL/F
- **effect (θ / form):** NM=294.0, PM=17.0, UM=12.0
...
| `gpt-oss:120b` | `theta[NM]` | 294.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `theta[PM]` | 17.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `theta[UM]` | 12.0 | not captured | only_one_extracted |
...
---
<sub>← back to [brexpiprazole](drugs/drug_brexpiprazole/)</sub>
