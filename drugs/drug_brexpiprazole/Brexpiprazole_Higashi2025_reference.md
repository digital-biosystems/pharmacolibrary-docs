...
## Model component
<dbs-pgx drug="brexpiprazole" model-id="Brexpiprazole_Higashi2025_reference" status="not_modelled" stale="false" population="Japanese healthy subjects and patients with schizophrenia" measured-compound="brexpiprazole" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Apparent clearance extensive metaboliser, CL/F (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | [l] / [h] | not captured | boundary (0.8) | tab_2:row7:col1 | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_brexpiprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Higashi_2025` / `Higashi_2025::Japanese healthy subjects and patients with schizophrenia`)
