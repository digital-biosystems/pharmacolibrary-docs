...
# cytotoxicity — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
## Citation
Pagels F; Almeida C; Vasconcelos V; Guedes AC et al. (2022). Marine drugs 20
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | Cyanobium sp. pigment extracts (carotenoids and phycobiliproteins) | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 140.69 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 180.93 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 115.37 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 79.41 | not captured | only_one_extracted |
