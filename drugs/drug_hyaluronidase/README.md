...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-19 12:36 | 31:51 | 0/0/0 | 6/4/0 | 0/0/0 | 1,246,998/18,963 | ollama / qwen3.8:27b-mtp-q8_0 | 76 | 6/70 | 75/1 | 0 |
...
| <span class="pk-badge pk-badge--green">extracted</span> | [Grabowska_2023](drugs/drug_hyaluronidase/pd_Grabowska_2023_unknown.md) | Grabowska K et al., Antihyaluronidase and Antioxidant Poten…, Molecules (Basel, Switzerla… (2023) | [10.3390/molecules28030982](https://doi.org/10.3390/molecules28030982) |
...
| <span class="pk-badge pk-badge--red">rejected</span> | [Fayad_2017](drugs/drug_hyaluronidase/pd_Fayad_2017_HAL.md) | Fayad S et al., Macroalga Padina pavonica water extract…, Journal of chromatography. A (2017) | [10.1016/j.chroma.2017.03.033](https://doi.org/10.1016/j.chroma.2017.03.033) |
...
<sub>queue written 2026-09-19T12:27:25.129606+00:00</sub>
...
| popPK | Antczak_2026 | irrelevant | 0 | 0 | The paper describes the generation of degron-tagged mouse models for mRNA metabolism proteins and does not study hyaluronidase pharmacokinetics. |
...
| PGx | Brüggemann_2019 | not_relevant | 0 | 0 | The paper investigates the genome decay and virulence factors (including hyaluronidase) of the bacterium Staphylococcus saccharolyticus, not the pharmacogenomics of a hyaluronidase drug. |
...
| popPK | Desai_2026 | irrelevant | 0 | 0 | The paper investigates stroma-mediated resistance in lung cancer models and does not study hyaluronidase pharmacokinetics. |
...
| popPK | Digiovanni_2026 | irrelevant | 0 | 0 | The paper focuses on IRAK1 inhibitors in lung cancer and does not study hyaluronidase pharmacokinetics. |
...
| popPK | Fatima_2021 | irrelevant | 0 | 0 | The study investigates the anticancer effects of neomenthol, using hyaluronidase only as a target enzyme for inhibition assays rather than as a subject drug for pharmacokinetic analysis. |
...
| popPK | Ferreira_2016 | irrelevant | 0 | 0 | The study characterizes spider venom components and their antimicrobial/cytotoxic activities, with no pharmacokinetic data for hyaluronidase. |
...
| popPK | González-Correa_2025 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of hydrochlorothiazide (HCTZ) and the effects of a probiotic, not hyaluronidase. |
...
| popPK | Gu_2026 | irrelevant | 0 | 0 | The paper focuses on the mechanism of LOXL4-driven matrix stiffening and T cell exhaustion in lung cancer, with no mention of hyaluronidase or pharmacokinetic parameters. |
...
| popPK | Han_2025 | irrelevant | 0 | 0 | The paper is a review of the pharmacological effects of wedelolactone, not a pharmacokinetic study of hyaluronidase. |
...
| PGx | Harrison_2007 | not_relevant | 0 | 0 | The paper describes the molecular biology and sequence conservation of snake venom hyaluronidases, not the pharmacogenomics of a therapeutic hyaluronidase drug. |
| popPK | Heide_2025 | irrelevant | 0 | 0 | The paper focuses on NNMT inhibition in cancer-associated fibroblasts and does not involve hyaluronidase or report any pharmacokinetic parameters for it. |
...
| PGx | Jose_2009 | not_relevant | 0 | 0 | The paper is a review on bioanalytical methods and mentions hyaluronidase only as a target for inhibitor development, without reporting any pharmacogenomic effects on PK or PD parameters. |
| popPK | Jung_2026 | irrelevant | 2 | 0 | The study focuses on the pharmacokinetics of the antibody-drug conjugate ALT-P7, with hyaluronidase (berahyaluronidase alfa) serving only as a co-administered excipient to facilitate absorption, and no quantitative PK parameters for hyaluronidase itself are reported. |
...
| popPK | Kirschbrown_2019 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of pertuzumab and trastuzumab, with hyaluronidase (rHuPH20) serving only as an excipient to facilitate subcutaneous absorption, and no PK parameters for hyaluronidase itself are reported. |
...
| popPK | Lagache_2026 | irrelevant | 0 | 0 | The paper is a spatial proteomics study on breast cancer where hyaluronidase is used only as a reagent for tissue dissociation, not as a subject drug for pharmacokinetic analysis. |
...
| popPK | Lebang_2026 | irrelevant | 0 | 0 | The paper is a review of Clerodendrum plants for metabolic syndrome and mentions hyaluronidase only as an enzyme inhibited in an in-vitro assay, not as a subject drug for PK analysis. |
...
| popPK | Li_2024_2 | irrelevant | 0 | 0 | The study reports population pharmacokinetic parameters for intravenous immunoglobulin G (IVIG), not hyaluronidase. |
...
| popPK | Luo_2021 | irrelevant | 0 | 0 | The study reports population pharmacokinetic parameters for daratumumab, not hyaluronidase (which is only mentioned as a co-formulated excipient/enzyme). |
...
| popPK | Mahomed_2022 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for monoclonal antibodies (VRC07-523LS and PGT121), not for the drug hyaluronidase. |
...
| popPK | Mahomed_2025 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for broadly neutralizing antibodies (bNAbs) where hyaluronidase is used as a delivery enhancer, not as the subject drug. |
...
| popPK | Mahomed_2025_2 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of the antibody CAP256V2LS, and hyaluronidase is only mentioned as a co-administered formulation component (ENHANZE) rather than the subject drug. |
...
| popPK | Mahomed_2026 | irrelevant | 0 | 0 | The study reports pharmacokinetic parameters for HIV monoclonal antibodies (PGDM1400LS, VRC07-523LS, PGT121.414.LS), not hyaluronidase, which is only mentioned as not being used for administration. |
...
| popPK | Michel_2014 | irrelevant | 0 | 0 | The paper is a phytochemical and in-vitro antioxidant study of Gaultheria procumbens extracts, where hyaluronidase is used only as an enzyme in an anti-inflammatory assay, not as the subject drug for pharmacokinetic analysis. |
...
| popPK | Newsome_2024 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of ocrelizumab, and hyaluronidase is only mentioned as a co-formulated permeation enhancer (ENHANZE) rather than the subject drug. |
...
| popPK | Ni_2024 | irrelevant | 0 | 0 | The paper is a computational study on drug target identification using knowledge graphs and does not involve hyaluronidase or pharmacokinetic parameters. |
...
| popPK | Nolan_2024 | irrelevant | 2 | 0 | The study focuses on the pharmacokinetics of antibodies co-administered with hyaluronidase, treating hyaluronidase as a delivery enhancer rather than the subject drug, and no specific PK parameters for hyaluronidase itself are reported. |
| popPK | Nolan_2026 | irrelevant | 1 | 0 | The study focuses on the pharmacokinetics of therapeutic antibodies using hyaluronidase (rHuPH20) as a delivery enabler, not as the subject drug, and does not report PK parameters for hyaluronidase itself. |
...
| popPK | Pang_2025 | irrelevant | 0 | 0 | The paper is a single-cell transcriptomic study of lamprey biology and Natterin protein function, containing no pharmacokinetic data for hyaluronidase. |
...
| PGx | ROGERS_1953 | not_relevant | 0 | 0 | The paper discusses bacterial genetics and hyaluronidase production in Staphylococcus aureus, not human pharmacogenomics or drug PK/PD. |
...
| popPK | Shah_2026 | irrelevant | 0 | 0 | The paper focuses on MBMA and QSP modeling for multiple myeloma treatment outcomes (neutropenia, ORR) and does not report pharmacokinetic parameters for hyaluronidase. |
...
| popPK | Siemiątkowska_2026 | irrelevant | 1 | 0 | The paper is a review of subcutaneous absorption models for antibody-based therapeutics, and hyaluronidase is only mentioned as a facilitator of delivery, not as the subject drug for PK parameter extraction. |
...
| popPK | Wang_2021 | irrelevant | 0 | 0 | The study reports population PK parameters for pertuzumab and trastuzumab, while hyaluronidase is only a co-administered excipient/enzyme in the formulation and not the subject drug. |
...
| popPK | Wang_2026 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of nivolumab, and hyaluronidase is only mentioned as a co-formulated enzyme for subcutaneous administration, not as the subject drug. |
...
| popPK | Załuski_2017 | irrelevant | 0 | 0 | The paper is a phytochemical study on plant extracts and their in-vitro inhibition of hyaluronidase activity, not a pharmacokinetic study of hyaluronidase as a drug. |
...
| popPK | Zhao_2025 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of nivolumab, with hyaluronidase serving only as a delivery enzyme (ENHANZE technology) rather than the subject drug. |
...
| PGx | Zhu_2026 | not_relevant | 0 | 0 | The paper reports protein engineering of a hyaluronidase enzyme for industrial production, not a pharmacogenomic study of a drug's PK/PD in humans. |
| popPK | van_2026 | irrelevant | 0 | 0 | The paper is a systematic review of pharmacokinetics for immunoglobulins (IgG), and hyaluronidase is only mentioned as an excipient in facilitated subcutaneous immunoglobulin formulations, not as the subject drug. |
