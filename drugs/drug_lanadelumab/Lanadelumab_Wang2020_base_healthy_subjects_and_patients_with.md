...
## Model component
<dbs-pgx drug="lanadelumab" model-id="Lanadelumab_Wang2020_base_healthy_subjects_and_patients_with" status="not_reviewed" stale="false" population="healthy subjects and patients with hereditary angioedema" measured-compound="" parameterization="" topology=""></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_lanadelumab/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Wang_2020` / `Wang_2020::base::healthy subjects and patients with hereditary angioedema`)
