...
## Model component
<dbs-pgx drug="lanadelumab" model-id="Lanadelumab_Wang2020_base" status="" stale="false" population="healthy subjects and patients with hereditary angioedema" measured-compound="lanadelumab" parameterization="apparent" topology="1C"></dbs-pgx>
...
| Ka (1/h) | `Q49` · kabs | —(suppressed) | hour | — | [h] | not captured | exact (1.0) | Wang_2020_table_S7:row0:col1 | — | not captured |
