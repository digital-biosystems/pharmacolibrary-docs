...
# DPP3 activity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | Procizumab | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q41]` | 2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q41]` | 2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q41]` | 2 | not captured | only_one_extracted |
...
---
<sub>← back to [fibrinogen, human](drugs/drug_fibrinogen_human/)</sub>
