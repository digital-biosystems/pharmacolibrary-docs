...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-18 01:12 | 32:13 | 0/0/0 | 2/3/0 | 0/0/0 | 913,854/14,528 | ollama / qwen3.8:27b-mtp-q8_0 | 42 | 6/36 | 40/2 | 0 |
...
| <span class="pk-badge pk-badge--red">rejected</span> | [Rothman_2025](drugs/drug_becaplermin/pd_Rothman_2025_TPR.md) | Rothman AMK et al., Positioning Imatinib for Pulmonary Arte…, American journal of respira… (2025) | [10.1164/rccm.202410-1929oc](https://doi.org/10.1164/rccm.202410-1929oc) |
...
<sub>queue written 2026-09-18T01:06:30.966483+00:00</sub>
...
| popPK | Calvo_2026 | irrelevant | 0 | 0 | The paper is a study on diffuse midline glioma combination therapy and does not involve becaplermin or report any pharmacokinetic parameters. |
...
| popPK | Carmona_2026 | irrelevant | 0 | 0 | The paper is an in-vitro study on equine tendon inflammation and platelet-rich plasma, and does not involve becaplermin or pharmacokinetic parameters. |
...
| popPK | Chae_2020 | irrelevant | 0 | 0 | The paper is a tutorial on dynamical systems theory and QSP modeling concepts, and does not contain any pharmacokinetic data or parameters for becaplermin. |
...
| popPK | Feldmann_2021 | irrelevant | 0 | 0 | The paper focuses on the structural modification of PDGFRα-Fc for HCMV inhibition and does not report pharmacokinetic parameters for becaplermin. |
...
| popPK | Liu_2024 | irrelevant | 0 | 0 | The paper focuses on the cellular hierarchy and therapeutic targets (CDK6) in diffuse hemispheric glioma and does not involve becaplermin or pharmacokinetic parameters. |
...
| popPK | Manshadi_2026 | irrelevant | 0 | 0 | The paper is a computational modeling study on tumor angiogenesis involving anti-VEGF agents (Bevacizumab, Ranibizumab, Brolucizumab) and does not involve the drug becaplermin or report its pharmacokinetic parameters. |
...
| popPK | Möbus_2025 | irrelevant | 0 | 0 | The paper is an in-vitro transcriptomic study on endothelial cells exposed to bleomycin and TGF-beta, and does not report pharmacokinetic parameters for becaplermin. |
...
| popPK | Schmitz_2015 | irrelevant | 0 | 0 | The study investigates cetuximab, not becaplermin, and focuses on DCE-CT imaging parameters rather than pharmacokinetic disposition parameters for the target drug. |
...
| popPK | Vantler_2010 | irrelevant | 0 | 0 | The paper investigates the mechanistic effects of PDGF-BB on cardiomyocytes and does not report any pharmacokinetic parameters for becaplermin. |
...
| popPK | Xia_2026 | irrelevant | 0 | 0 | The paper investigates the toxicological effects of cytarabine on the mouse testis and does not involve becaplermin or report any pharmacokinetic parameters. |
...
| popPK | Zhang_2025 | irrelevant | 0 | 0 | The paper studies a different drug (Ph-triazole) and only provides in-silico predicted PK parameters, not becaplermin. |
