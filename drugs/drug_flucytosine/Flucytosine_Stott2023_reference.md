...
## Model component
<dbs-pgx drug="flucytosine" model-id="Flucytosine_Stott2023_reference" status="not_modelled" stale="false" population="adults with HIV-associated cryptococcal meningoencephalitis" measured-compound="flucytosine" parameterization="apparent" topology="1C"></dbs-pgx>
...
| T1_cmax | reference | skipped | not captured | not captured | not captured | no simulated metric for this quantity (single reference sim) |
| T1_t_half_beta | reference | skipped | 14.5 | not captured | not captured | no simulated metric for this quantity (single reference sim) |
...
- scholar stages: `../../../knowledgebase/drugs/drug_flucytosine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Stott_2023` / `Stott_2023::adults with HIV-associated cryptococcal meningoencephalitis`)
