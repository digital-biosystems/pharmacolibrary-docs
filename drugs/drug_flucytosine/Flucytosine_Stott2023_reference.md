...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka (h -1 ) | `Q49` · kabs | —(suppressed) | h -1 | — | [1] / [h] | not captured | exact (1.0) | tab_0:row1:col1, tab_0:row1:col2, tab_0:row1:col3, tab_0:row1:col4 | — | not captured |
| CL/F (L/h) | `Q27` · CL/F | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | tab_0:row2:col1, tab_0:row2:col2, tab_0:row2:col3, tab_0:row2:col4 | — | not captured |
| V/F (L) | `Q76` · V/F | —(suppressed) | L | — | [l] | not captured | exact (1.0) | tab_0:row3:col1, tab_0:row3:col2, tab_0:row3:col3, tab_0:row3:col4 | — | not captured |
| K23 (h -1 ) | `Q48` · kcomp | —(suppressed) | h -1 | — | [1] / [h] | not captured | exact (1.0) | tab_0:row4:col1, tab_0:row4:col2, tab_0:row4:col3, tab_0:row4:col4 | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_flucytosine/models/modelica/Flucytosine_Stott2023_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_flucytosine/models/modelica/Flucytosine_Stott2023_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_flucytosine/models/modelica/Flucytosine_Stott2023_reference.json`
...
</div><figure class="pk-models-diagram"><img src="drugs/drug_flucytosine/Flucytosine_Stott2023_reference/Flucytosine_Stott2023_reference.svg" alt="Flucytosine_Stott2023_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C_enteral` · parameters `Flucytosine_Stott2023_reference_params.json` · controls `Flucytosine_Stott2023_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
