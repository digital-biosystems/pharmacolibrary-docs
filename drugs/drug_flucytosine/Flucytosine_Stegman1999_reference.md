...
**Second reading:** `gpt-oss:120b` read this paper differently on `screen.dose_compound` (5-fluorocytosine vs 5-FC) and 3 more field(s) — a structural parameter, so the record is disputed.
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.2 (1/5 fields) | 4 |

<details><summary>4 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `model.links` | [['5-fluorocytosine', '5-fluorouracil', 'metabolism'], ['5-fluorouracil', 'fluorinated nucleosides/nucleotides', 'metabolism']] | [['5-fc', '5-fu', 'metabolism'], ['5-fu', 'fnuc', 'metabolism']] | mismatch |
| `gpt-oss:120b` | `parameters[2]` | not captured | 0.0018 | only_one_extracted |
| `gpt-oss:120b` | `screen.dose_compound` | 5-fluorocytosine | 5-FC | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_flucytosine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Stegman_1999` / `Stegman_1999::reference`)
