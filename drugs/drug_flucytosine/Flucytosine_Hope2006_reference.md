...
## Model component
<dbs-pgx drug="flucytosine" model-id="Flucytosine_Hope2006_reference" status="not_modelled" stale="false" population="neutropenic CD1 mice with disseminated candidiasis" measured-compound="flucytosine" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_flucytosine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Hope_2006` / `Hope_2006::neutropenic CD1 mice with disseminated candidiasis`)
