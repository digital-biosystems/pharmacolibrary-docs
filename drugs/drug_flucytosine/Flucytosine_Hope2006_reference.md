...
## Model component
<dbs-pgx drug="flucytosine" model-id="Flucytosine_Hope2006_reference" status="extracted" stale="false" population="neutropenic CD1 mice with disseminated candidiasis" measured-compound="flucytosine" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
| clearance | `Q22` · CL | 0.021 | liter/h | not captured | liter/h | not captured | exact (1.0) | Hope_2006:other_prose | — | not captured |
