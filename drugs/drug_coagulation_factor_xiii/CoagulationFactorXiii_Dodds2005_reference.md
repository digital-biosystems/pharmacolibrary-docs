...
|---|---|---|---|---|---|---|---|---|---|---|
| VtA 2 | `Q63` · V1 | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | tab_0:row4:col1 | — | not captured |
| keA 2 | `Q47` · kel | —(suppressed) | not captured | — | not captured | not captured | llm (0.6) | tab_0:row7:col1 | — | not captured |
| Ka | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | tab_0:row10:col1 | — | not captured |
