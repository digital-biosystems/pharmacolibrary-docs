...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-16 13:26 | 5:41 | 1/0/0 | 0/1/0 | 0/0/0 | 50,143/2,012 | ollama / qwen3.8:27b-mtp-q8_0 | 19 | 7/12 | 18/1 | 0 |

## popPK records

| status | detail | citation | doi |
|---|---|---|---|
| <span class="pk-badge pk-badge--orange">built, not shipped</span><br><sub>blocking: model_quarantined: CLelim[central] left at base-class defaults</sub><br><sub>route_to: `scholar`</sub> | [Dodds_2005_reference](drugs/drug_coagulation_factor_xiii/CoagulationFactorXiii_Dodds2005_reference.md) | Dodds MG et al., Population pharmacokinetics of recombin…, The AAPS journal (2005) | [10.1208/aapsj070370](https://doi.org/10.1208/aapsj070370) |

## Pharmacodynamics (PD)

| status | detail | citation | doi |
|---|---|---|---|
| <span class="pk-badge pk-badge--red">rejected</span> | [Byrnes_2024](drugs/drug_coagulation_factor_xiii/pd_Byrnes_2024_FXIII_Act.md) | Byrnes JR et al., Reciprocal stabilization of coagulation…, Blood (2024) | [10.1182/blood.2023022042](https://doi.org/10.1182/blood.2023022042) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Byrnes_2024](drugs/drug_coagulation_factor_xiii/pd_Byrnes_2024_FXIII_Ag.md) | Byrnes JR et al., Reciprocal stabilization of coagulation…, Blood (2024) | [10.1182/blood.2023022042](https://doi.org/10.1182/blood.2023022042) |

## Coverage

- **PubMed hits:** 54100 matched, 53 returned
...
| popPK | Alesci_2023 | irrelevant | 0 | 0 | The study is a clinical correlation analysis of FXIII activity levels in systemic sclerosis patients, not a pharmacokinetic study, and reports no disposition parameters. |
...
| PGx | Ansani_2018 | not_relevant | 0 | 0 | The paper investigates the association between a genetic variant and a biomarker (FXIIIA levels) for disease prognosis, not the effect of a gene variant on the pharmacokinetics or pharmacodynamics of a specific drug. |
...
| popPK | Karaman_2021 | irrelevant | 0 | 0 | The paper is a clinical case study regarding the management of bleeding in a patient with Factor XIII deficiency and inhibitors, and it does not report any pharmacokinetic parameters or quantitative disposition data. |
...
| popPK | Kattula_2020 | irrelevant | 0 | 0 | The paper investigates the effect of a Factor XIII polymorphism on clot mass (hemostasis/mechanism) and does not report any pharmacokinetic parameters (CL, V, t1/2) for the drug. |
...
| popPK | Mezei_2015 | irrelevant | 0 | 0 | The paper is a genetic association study investigating the link between Factor XIII polymorphisms and coronary artery disease risk, not a pharmacokinetic study reporting quantitative disposition parameters like clearance or volume. |
...
| popPK | Nilsson_1972 | irrelevant | 0 | 0 | The provided evidence consists only of a title fragment regarding fibrin-stabilizing factor inhibitors, with no pharmacokinetic data or quantitative parameters for coagulation factor XIII. |
...
| PD | Oertel_2007 | not_relevant | 0 | 0 | The paper describes a laboratory assay for measuring FXIII concentration, not a pharmacodynamic study of a drug's effect on FXIII or a therapeutic response. |
...
| popPK | Ponce_2005 | irrelevant | 2 | 0 | The paper reports only a qualitative half-life range (5-7 days) without specific clearance, volume, or compartmental model parameters required for population PK extraction. |
...
| popPK | Sang_2024 | irrelevant | 0 | 0 | The paper is a mechanistic in-vitro study on platelet FXIII-A retention and release, not a pharmacokinetic study reporting disposition parameters like clearance or volume. |
...
| popPK | Ueyama_1978 | irrelevant | 0 | 0 | The paper is an in-vitro mechanistic study on fibroblast proliferation and does not report any pharmacokinetic parameters for coagulation_factor_xiii. |
...
| PD | Würtz_2012 | not_relevant | 0 | 0 | The paper is a review of aspirin pharmacogenetics and only mentions coagulation factor XIII as a gene of interest without providing any PD data or parameters. |
...
| popPK | Yamada_2024 | irrelevant | 0 | 0 | The study measures FXIII activity levels (a functional assay) in patients with hemorrhagic shock but does not report pharmacokinetic parameters such as clearance, volume of distribution, or half-life. |
...
| popPK | unknown_2015 | irrelevant | 0 | 0 | The provided evidence consists only of a conference title and contains no study data, pharmacokinetic parameters, or specific information regarding coagulation_factor_xiii. |
| PD | unknown_2015 | not_relevant | 0 | 0 | The provided text is only a header for a conference abstract collection and contains no specific data, models, or parameters for Factor XIII. |
...
| PD | unknown_2024 | not_relevant | 0 | 0 | The provided text is a placeholder for a PDF file and contains no scientific content, data, or parameters regarding coagulation factor XIII or any pharmacodynamic relationship. |

---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_coagulation_factor_xiii`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
