...
| Max. Elim. Rate — 95% Conf. interval | `Q66` · not captured | 3.17 | not captured | not captured | llm (not captured) | Tab1:row4:col5 |
| Conc. at haf max.elim — Value | `Q75` · not captured | 3.73 | not captured | not captured | llm (not captured) | Tab1:row5:col3 |
| Conc. at haf max.elim — SE | `Q75` · not captured | 0.310 | not captured | not captured | llm (not captured) | Tab1:row5:col4 |
| Conc. at haf max.elim — 95% Conf. interval | `Q75` · not captured | 3.12 | not captured | not captured | llm (not captured) | Tab1:row5:col5 |
| Conc. at haf max.elim | `Q75` · not captured | 4.33 | not captured | not captured | llm (not captured) | Tab1:row5:col6 |
| Central distrib vol — Value | `Q63` · not captured | 3.45 | not captured | not captured | llm (not captured) | Tab1:row6:col3 |
| Central distrib vol — SE | `Q63` · not captured | 0.594 | not captured | not captured | llm (not captured) | Tab1:row6:col4 |
| Central distrib vol — 95% Conf. interval | `Q63` · not captured | 2.28 | not captured | not captured | llm (not captured) | Tab1:row6:col5 |
| Central distrib vol | `Q63` · not captured | 4.61 | not captured | not captured | llm (not captured) | Tab1:row6:col6 |
| Central distrib vol — RSE (%) | `Q63` · not captured | 17.2 | not captured | not captured | llm (not captured) | Tab1:row6:col7 |
| Intercomp. clearance — Value | `Q358` · not captured | 0.932 | not captured | not captured | llm_corrected (not captured) | Tab1:row8:col3 |
| Intercomp. clearance — SE | `Q358` · not captured | 0.219 | not captured | not captured | llm_corrected (not captured) | Tab1:row8:col4 |
| Intercomp. clearance — 95% Conf. interval | `Q358` · not captured | 0.503 | not captured | not captured | llm_corrected (not captured) | Tab1:row8:col5 |
| Intercomp. clearance | `Q358` · not captured | 1.36 | not captured | not captured | llm_corrected (not captured) | Tab1:row8:col6 |
| Intercomp. clearance — RSE (%) | `Q22` · not captured | 23.5 | not captured | not captured | llm_confirmed (not captured) | Tab1:row8:col7 |
| Om_1 (CL + Vmax) — 95% Conf. interval | `Q900` · not captured | 0.0403 | CL + Vmax | not captured | llm (not captured) | Tab1:row10:col5 |
