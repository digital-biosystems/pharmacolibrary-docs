...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[0.33]` | not captured | 4.4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[0.75]` | not captured | 5.9 | only_one_extracted |
...
- scholar stages: `../../../knowledgebase/drugs/drug_chloramphenicol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Anderson_1983` / `Anderson_1983::reference`)
- model: `../../../knowledgebase/drugs/drug_chloramphenicol/models/modelica/_needs_review/Chloramphenicol_Anderson1983_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_chloramphenicol/models/modelica/_needs_review/Chloramphenicol_Anderson1983_reference.deviation.json`
