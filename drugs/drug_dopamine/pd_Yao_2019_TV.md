...
# tumor volume — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.588). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Yao QY; Li J; Chen R; Yao Y; Xue JS; Chen WJ; et al. et al. (2019). Acta pharmacologica Sinica 40
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model_family` | sigmoid_emax | disease_progression | mismatch |
| `gpt-oss:120b` | `parameters[Q317]` | not captured | 20.8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | not captured | 0.0065 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | not captured | 0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q61]` | not captured | 38 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q67]` | 0.0065 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q67]` | 0 | not captured | only_one_extracted |
