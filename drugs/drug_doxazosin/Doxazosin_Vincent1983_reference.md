...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (ml/h) | `Q22` · CL | —(suppressed) | ml/h | — | L/h | not captured | review_gapfill (0.7) | Aljaeid_2019:review | — | not captured |
| V | `Q61` · V | —(suppressed) | L 70kg-1 | — | L | not captured | review_gapfill (0.7) | unknown_2023:review | — | not captured |
| ka | `Q49` · kabs | —(suppressed) | h-1 | — | 1/h | not captured | review_gapfill (0.7) | unknown_2023:review | — | not captured |
