...
**Extraction notes:**
- no GROBID TEI available — transcribed from cached Vincent_1983_extracted.txt (0 record(s)); values are summary statistics, not a fitted model
- LLM region Vincent_1983:abstract: no JSON records returned
...
- scholar stages: `../../../knowledgebase/drugs/drug_doxazosin/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Vincent_1983` / `Vincent_1983::reference`)
