...
# blood pressure — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.429). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
not matched (stem Donnelly_1989_2)
...
| `gpt-oss:120b` | `parameters[Q75]` | not captured | 18.6 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q75]` | not captured | 17.9 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q75]` | not captured | 18.9 | only_one_extracted |
