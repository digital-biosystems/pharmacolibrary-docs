...
## Model component
<dbs-pgx drug="quinidine" model-id="Quinidine_Fattinger1991v2_s_e" status="extracted" stale="false" population="patients with arrhythmias" measured-compound="quinidine" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| average oral clearance | `Q27` · CL/F | 18.1 | 1 h-' | not captured | 1 h-' | not captured | boundary (0.8) | Fattinger_1991_2:results_prose | — | not captured |
| fraction of the total clearance due to renal elimination | `Q22` · CL | 31 | % | not captured | % | not captured | boundary (0.8) | Fattinger_1991_2:results_prose | — | not captured |
