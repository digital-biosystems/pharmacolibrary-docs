...
| theta_q79_category | `Q900` · theta_q79_category | 12.6 | not captured | not captured | not captured | 1.8 | not captured (not captured) | Fattinger_1991_2_table_p4_1:row1:col1, Fattinger_1991_2_table_p4_1:row1:col2 | — | not captured |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `screen.dose_compound` | quinidine | quinidine sulphate and quinidine bisulphate | mismatch |
...
- scholar stages: `../../../knowledgebase/drugs/drug_quinidine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Fattinger_1991_2` / `Fattinger_1991_2::reference`)
