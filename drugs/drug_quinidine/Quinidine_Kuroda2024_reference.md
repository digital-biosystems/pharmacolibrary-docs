...
> ## <span class="pk-badge pk-badge--orange">built, not shipped</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.452). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.452 (14/31 fields) | 17 |

<details><summary>17 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `model.bioavailability.theta` | 36.4 | 33.1 | mismatch |
| `gpt-oss:120b` | `parameters[cl2].rse_percent` | 74.9 | 15.2 | mismatch |
| `gpt-oss:120b` | `parameters[cl2].value` | 2.87 | 74.9 | mismatch |
| `gpt-oss:120b` | `parameters[cl].rse_percent` | 25.6 | 6.4 | mismatch |
| `gpt-oss:120b` | `parameters[cl].value` | 0.49 | 25.6 | mismatch |
| `gpt-oss:120b` | `parameters[f].rse_percent` | 33.1 | 2.9 | mismatch |
| `gpt-oss:120b` | `parameters[f].value` | 36.4 | 33.1 | mismatch |
| `gpt-oss:120b` | `parameters[kabs].rse_percent` | 94.3 | 24.5 | mismatch |
| `gpt-oss:120b` | `parameters[kabs].value` | 1.00 | 94.3 | mismatch |
| `gpt-oss:120b` | `parameters[v1].rse_percent` | 40.5 | 12.4 | mismatch |
| `gpt-oss:120b` | `parameters[v1].value` | 0.63 | 40.5 | mismatch |
| `gpt-oss:120b` | `parameters[v2].rse_percent` | 37.8 | 12.1 | mismatch |
| `gpt-oss:120b` | `parameters[v2].value` | 0.59 | 37.8 | mismatch |
| `gpt-oss:120b` | `parameters[v3].rse_percent` | 28.5 | 7.0 | mismatch |
| `gpt-oss:120b` | `parameters[v3].value` | 3.68 | 28.5 | mismatch |
| `gpt-oss:120b` | `screen.dose_compound` | quinidine | quinidine sulfate dihydrate | mismatch |
| `gpt-oss:120b` | `screen.primary_analyte` | quinidine | quinidine (base) | mismatch |
