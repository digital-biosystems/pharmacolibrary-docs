...
**What is wrong:** the record's volume and clearance describe an endogenous biomarker's turnover (uric acid, glucose, INR …), not the drug's pharmacokinetics; the engineer's deviations are not documented and quantified. Evidence: T0_analyte_identity — expected quinidine (or metabolite) — got calculated creatinine clearance; T6_deviations — got invented_absorption: not acceptable.

**Steps:**
1. Not a curation fix — fulltext limitation.
2. Nothing to curate on this record: it should not exist as a drug PK model.
3. The paper's science is a biomarker turnover model with a drug effect — see the PD record(s) of the same paper; a drug-effect model is the engineer's next template.
4. If the paper ALSO reports the drug's own PK, that is a separate record the scholar must extract with the drug as the analyte.
...
|---|---|---|---|---|---|---|
| T0_analyte_identity | not captured | fail | quinidine (or metabolite) | calculated creatinine clearance | not captured | disposition label(s) name a biomarker, not quinidine: 'calculated creatinine clearance' |
...
- scholar stages: `../../../knowledgebase/drugs/drug_quinidine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Verme_1992` / `Verme_1992::reference`)
- model: `../../../knowledgebase/drugs/drug_quinidine/models/modelica/Quinidine_Verme1992_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_quinidine/models/modelica/Quinidine_Verme1992_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_quinidine/models/modelica/Quinidine_Verme1992_reference.json`
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_quinidine/Quinidine_Verme1992_reference/Quinidine_Verme1992_reference_modelica.zip" download>Quinidine_Verme1992_reference_modelica.zip</a> <span class="pk-size">(4.0 kB)</span></td></tr>
<tr><td><b>FMI 2.0 (FMU)</b></td><td>parameters + fmpy driver (FMU below)</td><td><span class="pk-missing">not generated yet</span></td></tr>
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_quinidine/Quinidine_Verme1992_reference/Quinidine_Verme1992_reference_matlab.zip" download>Quinidine_Verme1992_reference_matlab.zip</a> <span class="pk-size">(3.5 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_quinidine/Quinidine_Verme1992_reference/Quinidine_Verme1992_reference_matlab_simbio.zip" download>Quinidine_Verme1992_reference_matlab_simbio.zip</a> <span class="pk-size">(2.9 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_quinidine/Quinidine_Verme1992_reference/Quinidine_Verme1992_reference_sbml.zip" download>Quinidine_Verme1992_reference_sbml.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_quinidine/Quinidine_Verme1992_reference/Quinidine_Verme1992_reference_cellml.zip" download>Quinidine_Verme1992_reference_cellml.zip</a> <span class="pk-size">(3.1 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C_enteral.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_quinidine/Quinidine_Verme1992_reference/Quinidine_Verme1992_reference.svg" alt="Quinidine_Verme1992_reference diagram"><figcaption>The structure OpenModelica draws for this model, with this record's parameter values in the component labels.</figcaption></figure></div>
