...
**Second reading:** `gpt-oss:120b` read this paper differently on `screen.primary_analyte` (protein C vs protein C concentrate) and 9 more field(s) — a structural parameter, so the record is disputed.
...
- population split: 'percentage relative standard error' subgroup of Li_2025_2 (paper reports 3 populations: percentage relative standard error, population estimate, standard error)
- gap-filled Q22 (CL) from Cojutti_2024's review values (primary lacked it)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `model.bioavailability.theta` | not captured | 0.79 | only_one_extracted |
| `gpt-oss:120b` | `parameters[bioavailability].value` | not captured | 0.79 | mismatch |
| `gpt-oss:120b` | `parameters[cl]` | 0.031 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[clearance]` | not captured | 7.14 | only_one_extracted |
| `gpt-oss:120b` | `parameters[effect_of_age_on_the_rate_of_endogenous_protein_c_production]` | not captured | 0.589 | only_one_extracted |
| `gpt-oss:120b` | `parameters[first-order absorption rate constant]` | not captured | 0.0379 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[volume of distribution]` | not captured | 60.7 | only_one_extracted |
...
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_protein_c/ProteinC_Li2025v2_percentage_relative_standard_error/ProteinC_Li2025v2_percentage_relative_standard_error_cellml.zip" download>ProteinC_Li2025v2_percentage_relative_standard_error_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
<p>Each archive holds the model source, a script that simulates it against the appropriate library, and a README describing both and how to run them.</p>
<p><b>FMI is two downloads.</b> The archive holds this record's parameters and its driver; the simulator itself is <code>PK_1C.fmu</code>, one compiled template shared by every model of this structure. Take the FMU once, keep it beside the script (or pass <code>--fmu PATH</code>). Running it reproduces the model-specific FMU exactly.</p>
</div><figure class="pk-models-diagram"><img src="drugs/drug_protein_c/ProteinC_Li2025v2_percentage_relative_standard_error/ProteinC_Li2025v2_percentage_relative_standard_error.svg" alt="ProteinC_Li2025v2_percentage_relative_standard_error diagram"><figcaption>Model diagram (Modelica) using Pharmacolibrary v25.09 components, rendered by OpenModelica 1.26.7.</figcaption></figure></div>
...
<sub>Runs this record's model in the browser as WebAssembly. Sliders start at the extracted values; the reference check compares the browser's peak against the FMPy result recorded when the record was built, and is withheld once a value has been edited. Template `PK_1C` · parameters `ProteinC_Li2025v2_percentage_relative_standard_error_params.json` · controls `ProteinC_Li2025v2_percentage_relative_standard_error_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
