...
|---|---|---|---|---|---|---|---|---|---|---|
| t½, hh | `Q57` · t1/2z | —(suppressed) | n = 3 | — | [n=3] | not captured | llm (0.6) | Li_2025_table_2:row1:col3 | — | not captured |
| CL, dL/kg/h | `Q22` · CL | —(suppressed) | n = 3 | — | [n=3] | not captured | llm_confirmed (0.6) | Li_2025_table_2:row2:col3 | — | not captured |
| Vdss, dL/kg | `Q65` · Vss | —(suppressed) | n = 3 | — | [n=3] | not captured | llm (0.6) | Li_2025_table_2:row5:col3 | — | not captured |
