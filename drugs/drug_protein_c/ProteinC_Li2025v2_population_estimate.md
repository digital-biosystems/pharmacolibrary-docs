...
| First-order absorption rate constant (1/h) | `Q49` · kabs | 0.0379 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | TB25050017-3:row13:col1 | — | not captured |
| Bioavailability | `Q40` · Fab | 0.79 | not captured | not captured | not captured | not captured | exact (1.0) | TB25050017-3:row14:col1 | — | not captured |
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[bioavailability].rse_percent` | not captured | 5.37 | mismatch |
| `gpt-oss:120b` | `parameters[first-order absorption rate constant].rse_percent` | not captured | 4.26 | mismatch |
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_protein_c/ProteinC_Li2025v2_population_estimate/ProteinC_Li2025v2_population_estimate_matlab.zip" download>ProteinC_Li2025v2_population_estimate_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
...
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_protein_c/ProteinC_Li2025v2_population_estimate/ProteinC_Li2025v2_population_estimate_sbml.zip" download>ProteinC_Li2025v2_population_estimate_sbml.zip</a> <span class="pk-size">(2.5 kB)</span></td></tr>
