...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-21 17:26 | 8:37 | 0/0/0 | 2/1/0 | 0/0/6 | 311,066/5,737 | ollama / qwen3.8:27b-mtp-q8_0 | 20 | 3/17 | 19/1 | 0 |
...
| excretion | bile duct | <sub>“…Cenobamate is 87.8% eliminated in the urine and 5.2% in the feces.[L10653]…”</sub> | prose |
| excretion | kidney | <sub>“…Cenobamate is 87.8% eliminated in the urine and 5.2% in the feces.[L10653]…”</sub> | prose |
...
<sub>queue written 2026-09-21T17:22:15.582808+00:00</sub>
...
| PGx | Bender_2025 | not_relevant | 0 | 0 | The paper reports a drug-drug interaction (Cenobamate increasing Brivaracetam levels) and explicitly states that no genetic testing was performed. |
...
| PGx | Cohen_2024 | not_relevant | 0 | 0 | The paper reports the enzyme-inducing potential of cenobamate on CYP3A substrates, not the effect of a gene variant on cenobamate's PK/PD. |
...
| PGx | Greene_2022 | not_relevant | 0 | 0 | The study evaluates the effect of cenobamate on the pharmacokinetics of CYP probe drugs (drug-drug interactions) in healthy subjects, not the effect of gene variants on cenobamate's pharmacokinetics or pharmacodynamics. |
| popPK | Henry_2025 | irrelevant | 0 | 0 | The paper is a meta-analysis of graphical reporting in clinical efficacy trials and contains no pharmacokinetic parameters for cenobamate. |
...
| PGx | Roberti_2021 | not_relevant | 0 | 0 | The paper is a general review of cenobamate pharmacology and does not report specific pharmacogenomic effects on PK or PD parameters. |
...
| popPK | Stoschus_2025 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of phenobarbital, with cenobamate mentioned only as a co-medication covariate. |
...
| PGx | Zaccara_2021 | not_relevant | 0 | 0 | The paper is a general review of cenobamate's pharmacokinetics, pharmacodynamics, and clinical efficacy, but it does not report any pharmacogenomic effects (gene variants/genotypes) on these parameters. |
| PGx | Zillgitt_2025 | not_relevant | 2 | 1 | The paper reports a pharmacogenomic effect (CYP2C19 polymorphism) on the pharmacokinetics of clobazam (specifically its metabolite N-desmethylclobazam), not cenobamate. |
| PGx | dOrsi_2026_2 | not_relevant | 0 | 0 | The text is a correction notice regarding missing acknowledgements and does not contain any pharmacogenomic data or PK/PD results. |
