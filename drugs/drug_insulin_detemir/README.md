...
|---|---|---|---|
| <span class="pk-badge pk-badge--green">extracted</span> | [Bilz_2018](drugs/drug_insulin_detemir/pd_Bilz_2018_GIR_AUC0_24.md) | Bilz S et al., Comparison of the dose-response pharmac…, PloS one (2018) | [10.1371/journal.pone.0202007](https://doi.org/10.1371/journal.pone.0202007) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Bilz_2018](drugs/drug_insulin_detemir/pd_Bilz_2018_GIR_AUC0_30.md) | Bilz S et al., Comparison of the dose-response pharmac…, PloS one (2018) | [10.1371/journal.pone.0202007](https://doi.org/10.1371/journal.pone.0202007) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Bilz_2018](drugs/drug_insulin_detemir/pd_Bilz_2018_GIR_AUC24_30.md) | Bilz S et al., Comparison of the dose-response pharmac…, PloS one (2018) | [10.1371/journal.pone.0202007](https://doi.org/10.1371/journal.pone.0202007) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Bilz_2018](drugs/drug_insulin_detemir/pd_Bilz_2018_GIR_max.md) | Bilz S et al., Comparison of the dose-response pharmac…, PloS one (2018) | [10.1371/journal.pone.0202007](https://doi.org/10.1371/journal.pone.0202007) |
| <span class="pk-badge pk-badge--green">extracted</span> | [Bilz_2018](drugs/drug_insulin_detemir/pd_Bilz_2018_tGIR_max.md) | Bilz S et al., Comparison of the dose-response pharmac…, PloS one (2018) | [10.1371/journal.pone.0202007](https://doi.org/10.1371/journal.pone.0202007) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Fink_2018](drugs/drug_insulin_detemir/pd_Fink_2018_EI.md) | Fink H et al., Pharmacodynamics and pharmacokinetics o…, Domestic animal endocrinolo… (2018) | [10.1016/j.domaniend.2018.03.007](https://doi.org/10.1016/j.domaniend.2018.03.007) |
| <span class="pk-badge pk-badge--red">rejected</span> | [Fink_2018](drugs/drug_insulin_detemir/pd_Fink_2018_GIR.md) | Fink H et al., Pharmacodynamics and pharmacokinetics o…, Domestic animal endocrinolo… (2018) | [10.1016/j.domaniend.2018.03.007](https://doi.org/10.1016/j.domaniend.2018.03.007) |
...
- **PubMed hits:** 119 matched, 52 returned
...
|---|---|---|---|---|---|---|
| `van_2019.pdf` | van Noorden B et al., A subcutaneous insulin pharmacokinetic…, Computer methods and progra… (2019) | popPK | 10 | [10.1016/j.cmpb.2019.06.007](https://doi.org/10.1016/j.cmpb.2019.06.007) | [31416537](https://pubmed.ncbi.nlm.nih.gov/31416537) | The paper describes a compartmental PK model for insulin detemir, but the specific numeric parameter values are not present in the provided evidence text. |
| `Jhee_2004.pdf` | Jhee SS et al., Similarity of insulin detemir pharmacok…, Journal of clinical pharmac… (2004) | popPK | 8 | [10.1177/0091270003262949](https://doi.org/10.1177/0091270003262949) | [14973299](https://pubmed.ncbi.nlm.nih.gov/14973299) | The study is a PK comparison of insulin detemir, but the provided text only describes the study design and qualitative results (linear dose-response) without listing specific numeric PK parameters like clearance, volume, or half-life. |
...
<sub>queue written 2026-09-12T04:29:27.914840+00:00</sub>
...
| popPK | Chang_2025 | irrelevant | 0 | 0 | The provided evidence contains only the paper title and no quantitative pharmacokinetic parameter values or model details for insulin_detemir. |
...
| popPK | Ellmerer_2003 | irrelevant | 2 | 0 | The study focuses on the novel insulin analog O346, with insulin detemir serving only as a comparator for which no quantitative PK parameters are reported. |
...
| popPK | Haahr_2016 | irrelevant | 0 | 0 | The study investigates insulin degludec/insulin aspart (IDegAsp) and insulin detemir is only mentioned as a washout/replacement insulin, not as the subject drug for PK parameter estimation. |
| popPK | Heise_2014 | irrelevant | 0 | 0 | The study investigates insulin degludec/insulin aspart (IDegAsp), not insulin detemir, which is only mentioned in the introduction as a comparator with unsuitable co-formulation properties. |
| popPK | Hemmingsen_2021 | irrelevant | 0 | 0 | This is a clinical systematic review focusing on efficacy and safety outcomes (HbA1c, hypoglycemia) rather than pharmacokinetic disposition parameters. |
...
| popPK | Kildemoes_2023 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics and pharmacodynamics of somapacitan (a long-acting growth hormone), and insulin detemir is only mentioned as a comparator for the albumin-binding technology without any PK parameters reported for it. |
...
| popPK | Kiss_2014 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of insulin degludec, not insulin detemir. |
...
| popPK | Lo_2018 | irrelevant | 0 | 0 | This is a systematic review of clinical efficacy and safety outcomes (HbA1c, BP, etc.) in diabetes and CKD, not a pharmacokinetic study reporting disposition parameters for insulin_detemir. |
...
| popPK | Muddather_2026 | irrelevant | 0 | 0 | The paper is a review on DPP-4 inhibitors in cancer and does not report pharmacokinetic parameters for insulin_detemir. |
...
| popPK | Petri_2015 | irrelevant | 0 | 0 | The study focuses on the pharmacokinetics of liraglutide, and insulin detemir is only mentioned as a co-administered agent in a referenced trial, with no PK parameters reported for it. |
...
| popPK | Plum-Mörschel_2023 | irrelevant | 0 | 0 | The study investigates insulin icodec, not insulin detemir, which is only mentioned as a background medication for participants. |
...
| popPK | Rendell_2013 | irrelevant | 1 | 0 | The paper is a review focused on insulin degludec, mentioning insulin detemir only as a structural comparator without providing specific quantitative PK parameters for detemir. |
...
| popPK | Sokolov_2023 | relevant | 8 | 2 | The paper develops a PK model for insulin_detemir, but the specific numeric parameter values are located in Table S1 (supplementary material) which is not included in the provided evidence. |
...
| popPK | Sävendahl_2020 | irrelevant | 0 | 0 | The study evaluates the efficacy of somapacitan (a growth hormone derivative) and does not report pharmacokinetic parameters for insulin_detemir. |
...
| popPK | Warnken_2010 | irrelevant | 0 | 0 | The study is an in-vitro mechanistic investigation of proliferative effects in lung fibroblasts and does not report pharmacokinetic disposition parameters for insulin_detemir. |
| popPK | Wong_2023 | irrelevant | 0 | 0 | The paper focuses on the discovery of albumin-binding macrocyclic peptides and does not report pharmacokinetic parameters for insulin_detemir. |
...
| popPK | Yang_2025 | irrelevant | 0 | 0 | The paper is a narrative review on real-world evidence and adherence for insulin therapy, containing no pharmacokinetic studies or quantitative disposition parameters for insulin_detemir. |
...
| popPK | van_2019 | relevant | 10 | 0 | The paper describes a compartmental PK model for insulin detemir, but the specific numeric parameter values are not present in the provided evidence text. |

---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_insulin_detemir`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
