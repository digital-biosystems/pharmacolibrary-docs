...
# Acinetobacter baumannii cfu — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.484). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q22]` | not captured | 0.855 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 23.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q320]` | not captured | 9.41 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q325]` | not captured | 0.895 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | 23.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | not captured | 2.12 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | not captured | 1.87 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q326]` | 39.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | 1.87 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | not captured | 39.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q335]` | not captured | -0.124 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q335]` | not captured | 0.895 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q335]` | not captured | -0.0523 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q46]` | not captured | 0.776 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q46]` | not captured | 0.895 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q83]` | not captured | 0.177 | only_one_extracted |
