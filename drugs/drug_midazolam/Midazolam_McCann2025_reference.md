...
## Model component
<dbs-pgx drug="midazolam" model-id="Midazolam_McCann2025_reference" status="needs_review" stale="false" population="children with and without obesity" measured-compound="midazolam" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (L/h/70 kg) | `Q22` · CL | —(suppressed) | L/h/70 kg | — | [l] / [[h] · [70kg]] | not captured | exact (1.0) | cts70247-tbl-0002:row2:col1, cts70247-tbl-0002:row2:col3, cts70247-tbl-0002:row2:col4, cts70247-tbl-0002:row2:col5 | — | not captured |
| V1 (L/70 kg) | `Q63` · V1 | —(suppressed) | L/70 kg | — | [l] / [70kg] | not captured | exact (1.0) | cts70247-tbl-0002:row3:col1, cts70247-tbl-0002:row3:col3, cts70247-tbl-0002:row3:col4, cts70247-tbl-0002:row3:col5 | — | not captured |
| Q (L/h/70 kg) | `Q30` · Q | —(suppressed) | L/h/70 kg | — | [l] / [[h] · [70kg]] | not captured | exact (1.0) | cts70247-tbl-0002:row4:col1, cts70247-tbl-0002:row4:col3, cts70247-tbl-0002:row4:col4, cts70247-tbl-0002:row4:col5 | — | not captured |
| V2 (L/70 kg) | `Q64` · V2 | —(suppressed) | L/70 kg | — | [l] / [70kg] | not captured | exact (1.0) | cts70247-tbl-0002:row5:col1, cts70247-tbl-0002:row5:col3, cts70247-tbl-0002:row5:col4, cts70247-tbl-0002:row5:col5 | — | not captured |
