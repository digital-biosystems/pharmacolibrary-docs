...
# GSRS diarrhea score — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | linerixibat | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q320]` | 5.55 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 3.03 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 11.9 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | 0.135 | not captured | only_one_extracted |
