...
## Model component
<dbs-pgx drug="vinblastine" model-id="Vinblastine_Zhou1990_estimated_parameters_cls_l_kg" status="extracted" stale="false" population="rats" measured-compound="vinblastine, vincristine" parameterization="mechanistic" topology="1C"></dbs-pgx>
