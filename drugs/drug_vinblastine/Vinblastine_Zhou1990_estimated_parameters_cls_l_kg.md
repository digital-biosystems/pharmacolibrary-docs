...
<img src="drugs/drug_vinblastine/Vinblastine_Zhou1990_estimated_parameters_cls_l_kg/Vinblastine_Zhou1990_estimated_parameters_cls_l_kg.svg" alt="Vinblastine_Zhou1990_estimated_parameters_cls_l_kg diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<sub>Template `PK_1C` · parameters `Vinblastine_Zhou1990_estimated_parameters_cls_l_kg_params.json` · controls `Vinblastine_Zhou1990_estimated_parameters_cls_l_kg_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
