...
## Model component
<dbs-pgx drug="vinblastine" model-id="Vinblastine_Zhou1990_estimated_parameters_cls_l_kg" status="model_quarantined" stale="false" population="rats" measured-compound="vinblastine, vincristine" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| VLB | `Q352` · Vnorm | —(suppressed) | l/kg | — | [l] / [kg] | not captured | llm (0.6) | Zhou_1990_table_1:row0:col5, Zhou_1990_table_1:row0:col6 | — | not captured |
| VCR | `Q61` · V | —(suppressed) | l/kg | — | [l] / [kg] | not captured | llm (0.6) | Zhou_1990_table_1:row1:col5, Zhou_1990_table_1:row1:col6 | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_vinblastine/models/modelica/_needs_review/Vinblastine_Zhou1990_estimated_parameters_cls_l_kg.mo`
- deviation: `../../../knowledgebase/drugs/drug_vinblastine/models/modelica/_needs_review/Vinblastine_Zhou1990_estimated_parameters_cls_l_kg.deviation.json`
