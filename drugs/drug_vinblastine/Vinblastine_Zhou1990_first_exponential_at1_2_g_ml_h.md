...
<sub>Template `PK_1C` · parameters `Vinblastine_Zhou1990_first_exponential_at1_2_g_ml_h_params.json` · controls `Vinblastine_Zhou1990_first_exponential_at1_2_g_ml_h_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
