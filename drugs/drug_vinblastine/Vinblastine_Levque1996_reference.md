...
- scholar stages: `../../../knowledgebase/drugs/drug_vinblastine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Levêque_1996` / `Levêque_1996::reference`)
- model: `../../../knowledgebase/drugs/drug_vinblastine/models/modelica/Vinblastine_Levque1996_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_vinblastine/models/modelica/Vinblastine_Levque1996_reference.deviation.json`
- sim: `../../../knowledgebase/drugs/drug_vinblastine/models/modelica/Vinblastine_Levque1996_reference.json`
...
<sub>Template `PK_1C` · parameters `Vinblastine_Levque1996_reference_params.json` · controls `Vinblastine_Levque1996_reference_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
