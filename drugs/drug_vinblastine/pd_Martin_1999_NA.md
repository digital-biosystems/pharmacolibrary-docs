...
# paclitaxel accumulation — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Martin C; Berridge G; Mistry P; Higgins C; Charlton P; Callaghan R et al. (1999). British journal of pharmacology 128
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | XR9576 | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q329]` | 50.05 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q330]` | 50.05 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q331]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q331]` | 56.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q331]` | 3.9 | not captured | only_one_extracted |
...
---
<sub>← back to [vinblastine](drugs/drug_vinblastine/)</sub>
