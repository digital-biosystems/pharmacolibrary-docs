...
## Citation
Lim HC; Kim YG; Lim JH; Kim HS; Park H et al. (2008). Yonsei medical journal 49
  ·  DOI: [10.3349/ymj.2008.49.3.472](https://doi.org/10.3349/ymj.2008.49.3.472)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | itopride | not captured | mismatch |
...
---
<sub>← back to [itopride](drugs/drug_itopride/)</sub>
