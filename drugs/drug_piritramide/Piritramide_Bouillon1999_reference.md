...
Bouillon T; Kietzmann D; Port R; Meineke I; Hoeft A et al. (1999). Anesthesiology 90
  ·  DOI: [10.1097/00000542-199901000-00004](https://doi.org/10.1097/00000542-199901000-00004)
...
**Extraction notes:**
- no GROBID TEI available; abstract in Bouillon_1999_metadata.yaml carries no parameter-bearing sentence
...
- scholar stages: `../../../knowledgebase/drugs/drug_piritramide/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Bouillon_1999` / `Bouillon_1999::reference`)
