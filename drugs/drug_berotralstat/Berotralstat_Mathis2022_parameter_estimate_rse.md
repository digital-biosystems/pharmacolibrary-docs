...
<sub>Template `PK_1C_enteral` · parameters `Berotralstat_Mathis2022_parameter_estimate_rse_params.json` · controls `Berotralstat_Mathis2022_parameter_estimate_rse_sim_controls.json`. A slider marked *simulator value* is running on the template's own default because this record does not pin that parameter.</sub>
