...
> ## <span class="pk-badge pk-badge--orange">built, not shipped</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.786). The first reading is what the record holds.">cross-check: disputed</span>
...
## Model component
<dbs-pgx drug="tianeptine" model-id="Tianeptine_Szafarz2018_intravenous_1_mg_kg" status="model_quarantined" stale="false" population="rats" measured-compound="tianeptine" parameterization="apparent" topology="parent_metabolite"></dbs-pgx>
...
| λ z (h−1) | `Q47` · kel | 41.7 | h−1 | 0.011583333333333334 | [1] / [h] | not captured | space_fold (0.95) | Tab3:row5:col2, Tab3:row5:col4 | — | not captured |
| t 0.5λz (h) | `Q57` · t1/2z | 64.34 | h | 231624.0 | [h] | not captured | llm (0.6) | Tab3:row6:col2, Tab3:row6:col4 | — | not captured |
| V z(V z/F) (L/kg) | `Q61` · V | 40.25 | L/kg | 2.8175 | [l] / [kg] | not captured | space_fold (0.95) | Tab3:row7:col2, Tab3:row7:col4 | — | not captured |
| AUC0-inf (mg∙h/L) | `Q17` · AUC∞ | 19.44 | mg∙h/L | not captured | [[h] · [mg]] / [l] | not captured | exact (1.0) | Tab3:row8:col2, Tab3:row8:col4 | — | not captured |
| CL/(CL/F) (L/h/kg) | `Q27` · CL/F | 21.39 | L/h/kg | 0.0004159166666666667 | [l] / [[h] · [kg]] | not captured | llm_confirmed (0.6) | Tab3:row9:col2, Tab3:row9:col4 | — | not captured |
| V ss (L/kg) | `Q65` · Vss | 55.64 | L/kg | 3.8948 | [l] / [kg] | not captured | space_fold (0.95) | Tab3:row10:col2 | — | not captured |
| MRT (h) | `Q53` · MRT | 32.64 | h | 117504.0 | [h] | not captured | exact (1.0) | Tab3:row11:col2, Tab3:row11:col4 | — | not captured |
...
| `gpt-oss:120b` | `parameters[c o/c max]` | not captured | 23.64 | only_one_extracted |
...
| C5_dimension_Q17 | pass | [mass] * [time] / [length] ** 3 | not captured | not captured | not captured | ['Tab3:row8:col2', 'Tab3:row8:col4'] |
| C5_dimension_Q27 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Tab3:row9:col2', 'Tab3:row9:col4'] |
| C5_dimension_Q47 | pass | 1 / [time] | not captured | not captured | not captured | ['Tab3:row5:col2', 'Tab3:row5:col4'] |
| C5_dimension_Q53 | pass | [time] | not captured | not captured | not captured | ['Tab3:row11:col2', 'Tab3:row11:col4'] |
| C5_dimension_Q56 | pass | [time] | not captured | not captured | not captured | ['Tab3:row4:col4'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Tab3:row6:col2', 'Tab3:row6:col4'] |
| C5_dimension_Q61 | pass | [length] ** 3 | not captured | not captured | not captured | ['Tab3:row7:col2', 'Tab3:row7:col4'] |
| C5_dimension_Q65 | pass | [length] ** 3 | not captured | not captured | not captured | ['Tab3:row10:col2'] |
| C7_apparent_coherence | pass | not captured | not captured | not captured | not captured | not captured |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q27 | pass | clearance within physiological range | 1.5e+03 L/h | not captured | not captured | ['Tab3:row9:col2', 'Tab3:row9:col4'] |
| C9_phys_window_Q61 | pass | volume within physiological range | 2.82e+03 L | not captured | not captured | ['Tab3:row7:col2', 'Tab3:row7:col4'] |
| C9_phys_window_Q65 | pass | volume within physiological range | 3.89e+03 L | not captured | not captured | ['Tab3:row10:col2'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_tianeptine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Szafarz_2018` / `Szafarz_2018::intravenous_1_mg_kg`)
- model: `../../../knowledgebase/drugs/drug_tianeptine/models/modelica/_needs_review/Tianeptine_Szafarz2018_intravenous_1_mg_kg.mo`
- deviation: `../../../knowledgebase/drugs/drug_tianeptine/models/modelica/_needs_review/Tianeptine_Szafarz2018_intravenous_1_mg_kg.deviation.json`
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_tianeptine/Tianeptine_Szafarz2018_intravenous_1_mg_kg/Tianeptine_Szafarz2018_intravenous_1_mg_kg_matlab.zip" download>Tianeptine_Szafarz2018_intravenous_1_mg_kg_matlab.zip</a> <span class="pk-size">(3.3 kB)</span></td></tr>
<tr><td><b>MATLAB (SimBiology)</b></td><td><code>.sbproj</code> + driver</td><td><a href="drugs/drug_tianeptine/Tianeptine_Szafarz2018_intravenous_1_mg_kg/Tianeptine_Szafarz2018_intravenous_1_mg_kg_matlab_simbio.zip" download>Tianeptine_Szafarz2018_intravenous_1_mg_kg_matlab_simbio.zip</a> <span class="pk-size">(2.7 kB)</span></td></tr>
<tr><td><b>SBML</b></td><td><code>.xml</code> (L3V2) + Python driver</td><td><a href="drugs/drug_tianeptine/Tianeptine_Szafarz2018_intravenous_1_mg_kg/Tianeptine_Szafarz2018_intravenous_1_mg_kg_sbml.zip" download>Tianeptine_Szafarz2018_intravenous_1_mg_kg_sbml.zip</a> <span class="pk-size">(2.5 kB)</span></td></tr>
<tr><td><b>CellML</b></td><td><code>.cellml</code> + Python driver</td><td><a href="drugs/drug_tianeptine/Tianeptine_Szafarz2018_intravenous_1_mg_kg/Tianeptine_Szafarz2018_intravenous_1_mg_kg_cellml.zip" download>Tianeptine_Szafarz2018_intravenous_1_mg_kg_cellml.zip</a> <span class="pk-size">(3.0 kB)</span></td></tr>
</tbody></table>
