...
## Model component
<dbs-pgx drug="rolapitant" model-id="Rolapitant_Li2026_fosrolapitant" status="rejected" stale="false" population="Chinese subjects with impaired or normal liver function" measured-compound="fosrolapitant" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (ng/mL) | `Q32` · Cmax | —(suppressed) | ng/mL | — | [ng] / [ml] | not captured | exact (1.0) | T2:row2:col1, T2:row2:col2 | — | not captured |
| AUC0-t (h × ng/mL) | `Q19` · AUCt | —(suppressed) | h × ng/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | T2:row4:col1, T2:row4:col2 | — | not captured |
| AUC0−∞ (h × ng/mL) | `Q17` · AUC∞ | —(suppressed) | h × ng/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | T2:row5:col1, T2:row5:col2 | — | not captured |
| t1/2 (hour) | `Q57` · t1/2z | —(suppressed) | hour | — | [h] | not captured | exact (1.0) | T2:row6:col1, T2:row6:col2 | — | not captured |
| V (L) | `Q61` · V | —(suppressed) | L | — | [l] | not captured | exact (1.0) | T2:row7:col1, T2:row7:col2 | — | not captured |
| CL (L/h) | `Q22` · CL | —(suppressed) | L/h | — | [l] / [h] | not captured | exact (1.0) | T2:row8:col1, T2:row8:col2 | — | not captured |
