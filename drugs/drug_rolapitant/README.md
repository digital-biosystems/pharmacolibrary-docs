...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-18 13:36 | 3:04 | 1/4/0 | 0/0/0 | 0/0/0 | 50,232/4,348 | ollama / qwen3.8:27b-mtp-q8_0 | 5 | 0/5 | 5/0 | 0 |
...
- **records:** 9  ·  extracted 0  ·  needs_review 1  ·  rejected 8  ·  stale 0
...
<sub>queue written 2026-09-18T13:34:10.657069+00:00</sub>

## Screened and excluded

| domain | paper | verdict | relevance | extractability | reason |
|---|---|---|---|---|---|
| PGx | Barbour_2017 | not_relevant | 0 | 0 | The paper analyzes safety outcomes (adverse events) regarding drug-drug interactions with CYP2D6/BCRP substrates, but does not report pharmacogenomic effects on rolapitant's PK or PD parameters. |
...
| PGx | Rapoport_2017 | not_relevant | 0 | 0 | The paper reviews clinical pharmacology and efficacy in specific tumor/age populations but does not report pharmacogenomic effects (gene variants) on PK or PD parameters. |
...
| PGx | Wang_2019_3 | not_relevant | 0 | 0 | The study evaluates drug-drug interactions (CYP inhibition) and uses genotyping only for subject selection/exclusion, but does not report pharmacogenomic effects on PK/PD parameters. |
