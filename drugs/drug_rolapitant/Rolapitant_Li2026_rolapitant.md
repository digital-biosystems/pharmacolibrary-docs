...
## Model component
<dbs-pgx drug="rolapitant" model-id="Rolapitant_Li2026_rolapitant" status="rejected" stale="false" population="Chinese subjects with impaired or normal liver function" measured-compound="fosrolapitant" parameterization="mechanistic" topology="general_linear"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax (ng/mL) | `Q32` · Cmax | —(suppressed) | ng/mL | — | [ng] / [ml] | not captured | exact (1.0) | T2:row2:col3, T2:row2:col4 | — | not captured |
| AUC0-t (h × ng/mL) | `Q19` · AUCt | —(suppressed) | h × ng/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | T2:row4:col3, T2:row4:col4 | — | not captured |
| AUC0−∞ (h × ng/mL) | `Q17` · AUC∞ | —(suppressed) | h × ng/mL | — | [[h] · [ng]] / [ml] | not captured | exact (1.0) | T2:row5:col3, T2:row5:col4 | — | not captured |
| t1/2 (hour) | `Q57` · t1/2z | —(suppressed) | hour | — | [h] | not captured | exact (1.0) | T2:row6:col3, T2:row6:col4 | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_rolapitant/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Li_2026` / `Li_2026::rolapitant`)
