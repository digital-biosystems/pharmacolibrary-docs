...
| `gpt-oss:120b` | `parameters[apparent volume of distribution]` | 136 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[clearance]` | 121 | not captured | only_one_extracted |
