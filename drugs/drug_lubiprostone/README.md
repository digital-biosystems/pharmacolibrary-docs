...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-11 11:26 | 4:56 | 0/0/0 | 1/0/0 | 0/0/0 | 56,949/2,067 | ollama / qwen3.8:27b-mtp-q8_0 | 3 | 0/0 | 2/1 | 0 |
...
|---|---|---|---|---|---|
| popPK | Adams_2021 | irrelevant | 2 | 1 | The study reports bioequivalence metrics (AUC ratios) for a metabolite (M3) and notes that parent drug PK data were limited, without providing standard disposition parameters like clearance, volume, or half-life for lubiprostone. |
| PD | Adams_2021 | not_relevant | 2 | 1 | The paper reports group-level efficacy (SBM counts) and PK bioequivalence ratios, but does not provide individual-level concentration-effect data or numeric PD parameters (e.g., Emax, EC50) for an exposure-response analysis. |
...
| popPK | Cremonini_2012 | irrelevant | 0 | 0 | The paper is a narrative review focused on rifaximin for IBS, and lubiprostone is only mentioned as a comparator/approved drug without any pharmacokinetic data. |
...
| popPK | Fei_2009 | irrelevant | 0 | 0 | The paper is an in-vitro mechanistic study of chloride secretion in guinea pig intestine and does not report pharmacokinetic parameters. |
| popPK | Fei_2010 | irrelevant | 0 | 0 | The study is a mechanistic investigation of chloride secretion and fecal output in animals, reporting no pharmacokinetic parameters such as clearance, volume, or half-life for lubiprostone. |
| PGx | Leppert_2016 | not_relevant | 0 | 0 | The paper focuses on naloxegol and only mentions lubiprostone as a class of prokinetics without reporting any pharmacogenomic data for it. |
...
| PD | Raschi_2014 | not_relevant | 2 | 1 | The text is a review article summarizing regulatory and safety aspects without presenting specific numeric PD parameters or exposure-response curves. |
...
| PD | Sanger_2008 | not_relevant | 1 | 0 | The text is a review discussing the development of drugs for GI disorders and mentions lubiprostone only as a recently approved ClC-2 channel activator without providing any specific pharmacodynamic data, exposure-response relationships, or numeric parameters. |
| popPK | Vazquez_2011 | irrelevant | 0 | 0 | The paper is a review of linaclotide, and lubiprostone is mentioned only as a comparator with side effects, with no PK parameters reported. |
...
| popPK | Zhang_2020 | irrelevant | 0 | 0 | The paper is a pharmacodynamic meta-analysis focusing on bowel movement frequency, not a pharmacokinetic study reporting disposition parameters for lubiprostone. |

---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_lubiprostone`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
