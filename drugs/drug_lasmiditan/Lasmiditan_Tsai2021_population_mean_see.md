...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `kabs`, `CL/F`, `V2/F`, `Q/F`</sub>
...
## Model component
<dbs-pgx drug="lasmiditan" model-id="Lasmiditan_Tsai2021_population_mean_see" status="model_quarantined" stale="false" population="pediatric patients with migraine" measured-compound="lasmiditan" parameterization="apparent" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Ka, 1/h | `Q49` · kabs | 0.295 | %SEE | not captured | [s] · [%] · [ee] | not captured | llm_confirmed (0.6) | Tab3:row1:col1 | — | not captured |
| CL/F, L/h | `Q27` · CL/F | 107 | %SEE | not captured | [s] · [%] · [ee] | not captured | llm_confirmed (0.6) | Tab3:row2:col1 | — | not captured |
| V2/F, L | `Q82` · V2/F | 127 | %SEE | not captured | [s] · [%] · [ee] | not captured | llm_confirmed (0.6) | Tab3:row3:col1 | — | not captured |
| Q/F, L/h | `Q69` · Q/F | 21.2 | %SEE | not captured | [s] · [%] · [ee] | not captured | llm_confirmed (0.6) | Tab3:row4:col1 | — | not captured |
| V3/F, L | `Q78` · V3/F | 172 | %SEE | not captured | [s] · [%] · [ee] | not captured | llm_confirmed (0.6) | Tab3:row5:col1 | — | not captured |
| theta_cl_f_body_weight | `Q900` · theta_cl_f_body_weight | 0.877 | %SEE | not captured | not captured | not captured | not captured (not captured) | Tab3:row8:col1 | — | not captured |
| theta_v2_f_body_weight | `Q900` · theta_v2_f_body_weight | 1.15 | %SEE | not captured | not captured | not captured | not captured (not captured) | Tab3:row9:col1 | — | not captured |
...
- model: `../../../knowledgebase/drugs/drug_lasmiditan/models/modelica/_needs_review/Lasmiditan_Tsai2021_population_mean_see.mo`
- deviation: `../../../knowledgebase/drugs/drug_lasmiditan/models/modelica/_needs_review/Lasmiditan_Tsai2021_population_mean_see.deviation.json`
