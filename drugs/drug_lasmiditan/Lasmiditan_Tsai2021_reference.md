...
> ⚙️ **Pipeline limitation — scholar.** a reported unit is missing from the conversion table, so the parameter reached the engineer without an SI value<br><sub>evidence: `MTT`, `theta_cl_f_body_weight`, `theta_v2_f_body_weight`</sub>
...
- scholar stages: `../../../knowledgebase/drugs/drug_lasmiditan/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Tsai_2021` / `Tsai_2021::reference`)
- model: `../../../knowledgebase/drugs/drug_lasmiditan/models/modelica/_needs_review/Lasmiditan_Tsai2021_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_lasmiditan/models/modelica/_needs_review/Lasmiditan_Tsai2021_reference.deviation.json`
