...
- scholar stages: `../../../knowledgebase/drugs/drug_atenolol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Wójcicki_2003` / `Wójcicki_2003::obese subjects with normolipaemia or hyperlipidaemia and healthy lean volunteers`)
