<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;C07A&quot;,&quot;href&quot;:&quot;atc/C07A.md&quot;},{&quot;label&quot;:&quot;atenolol&quot;,&quot;href&quot;:&quot;drugs/drug_atenolol/&quot;},{&quot;label&quot;:&quot;Kir_2025 \u00b7 malnourished and non-malnourished rats&quot;}]"></div>
...
## Model component
<dbs-pgx drug="atenolol" model-id="Atenolol_Kir2025_reference" status="not_modelled" stale="false" population="malnourished and non-malnourished rats" measured-compound="atenolol" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| CL (mL/min/kg) Total clearance | `Q22` · CL | —(suppressed) | mL/min/kg | — | L/h | not captured | boundary (0.8) | Kir_2025:other_prose | — | not captured |
| k 01 C (mg/min/kg) Apparent zero-order absorption rate constant 1 (t = 0-120 min) | `Q49` · kabs | —(suppressed) | mg/min/kg | — | mg/min/kg | not captured | boundary (0.8) | Kir_2025:other_prose | — | not captured |
| V ss (L/kg) d Volume of distribution at steady-state | `Q61` · V | —(suppressed) | L/kg | — | L | not captured | boundary (0.8) | Kir_2025:other_prose | — | not captured |
...
| T1_cmax | reference | skipped | 25.0 | not captured | not captured | no simulated metric for this quantity (single reference sim) |
| T1_cmax | reference | skipped | 22.8 | not captured | not captured | no simulated metric for this quantity (single reference sim) |
| T1_cmax | reference | skipped | 14.3 | not captured | not captured | no simulated metric for this quantity (single reference sim) |
| T1_cmax | reference | skipped | 20.6 | not captured | not captured | no simulated metric for this quantity (single reference sim) |
| T1_tmax | reference | skipped | 300 | not captured | not captured | no simulated metric for this quantity (single reference sim) |
| T1_tmax | reference | skipped | 135 | not captured | not captured | no simulated metric for this quantity (single reference sim) |
| T1_tmax | reference | skipped | 110 | not captured | not captured | no simulated metric for this quantity (single reference sim) |
...
- scholar stages: `../../../knowledgebase/drugs/drug_atenolol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Kir_2025` / `Kir_2025::malnourished and non-malnourished rats`)
...
<img src="drugs/drug_atenolol/Atenolol_Kir2025_reference/Atenolol_Kir2025_reference.svg" alt="Atenolol_Kir2025_reference diagram" style="max-width:100%;height:auto;background:#fff;border-radius:6px;padding:8px">
...
<tr><td><b>Modelica</b></td><td><code>.mo</code> + Modelica script</td><td><a href="drugs/drug_atenolol/Atenolol_Kir2025_reference/Atenolol_Kir2025_reference_modelica.zip" download>Atenolol_Kir2025_reference_modelica.zip</a> <span class="pk-size">(3.8 kB)</span></td></tr>
...
<tr><td><b>MATLAB (pure)</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_atenolol/Atenolol_Kir2025_reference/Atenolol_Kir2025_reference_matlab.zip" download>Atenolol_Kir2025_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
