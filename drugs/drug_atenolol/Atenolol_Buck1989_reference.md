...
Buck ML; Wiest D; Gillette PC; Trippel D; Krull J; O'Neal W et al. (1989). Clinical pharmacology and therapeutics 46
  ·  DOI: [10.1038/clpt.1989.198](https://doi.org/10.1038/clpt.1989.198)
...
- scholar stages: `../../../knowledgebase/drugs/drug_atenolol/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Buck_1989` / `Buck_1989::reference`)
