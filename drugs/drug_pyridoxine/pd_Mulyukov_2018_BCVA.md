...
# best corrected visual acuity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.39). The first reading is what the record holds.">cross-check: disputed</span>
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.39 (16/41 fields) | 25 |
...
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 0.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 0.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 0.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 2.0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 0.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 0.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 24.6 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 24.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q30]` | not captured | 22.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q364]` | not captured | 0.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q364]` | not captured | 0.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 9.4 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 10.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 9.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 12.6 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 7.9 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 7.2 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | 7.1 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q38]` | not captured | -10.9 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q54]` | not captured | 0.3 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q54]` | not captured | 0.5 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q54]` | not captured | 0.3 | only_one_extracted |
...
---
<sub>← back to [Pyridoxine](drugs/drug_pyridoxine/)</sub>
