...
## Model component
<dbs-pgx drug="meloxicam" model-id="Meloxicam_Meineke2003_reference" status="not_modelled" stale="false" population="rheumatoid arthritis patients" measured-compound="meloxicam" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_meloxicam/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Meineke_2003` / `Meineke_2003::rheumatoid arthritis patients`)
