...
## Citation
Meineke I; Türck D et al. (2003). British journal of clinical pharmacology 55
...
|---|---|---|---|---|---|---|---|---|---|---|
| population clearance for the mean female subject | `Q22` · CL | —(suppressed) | l h -1 | — | L/h | not captured | boundary (0.8) | Meineke_2003:other_prose | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_meloxicam/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Meineke_2003` / `Meineke_2003::reference`)
- model: `../../../knowledgebase/drugs/drug_meloxicam/models/modelica/_needs_review/Meloxicam_Meineke2003_reference.mo`
- deviation: `../../../knowledgebase/drugs/drug_meloxicam/models/modelica/_needs_review/Meloxicam_Meineke2003_reference.deviation.json`
