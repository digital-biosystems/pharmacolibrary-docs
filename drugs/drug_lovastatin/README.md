...
|---|---|---|---|---|---|---|---|---|---|---|
| not captured | not captured | 1/0/0 | 0/0/0 | 0/0/0 | not captured | not captured | 16 | 2/0 | 3/0 | 0 |
...
---
<sub>Generated by `docs.py` (scholarv2) from `knowledgebase/drugs/drug_lovastatin`. Every value traces to an artifact field; `not captured` = absent from the KB.</sub>
