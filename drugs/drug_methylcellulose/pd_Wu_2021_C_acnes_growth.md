...
## Citation
Wu GX; Wang YW; Wu CS; Lin YH; Hung CH; Huang HH; et al. et al. (2021). Molecules (Basel, Switzerland) 26
  ·  DOI: [10.3390/molecules26185723](https://doi.org/10.3390/molecules26185723)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | farnesol | not captured | mismatch |
