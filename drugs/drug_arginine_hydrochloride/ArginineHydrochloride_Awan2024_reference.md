...
|---|---|---|---|---|---|---|---|---|---|---|
| clearance rate (CL) | `Q22` · CL | 1.0 | mL/day | 1.1574074074074074e-11 | L/h | not captured | review (0.7) | Awan_2024:review | — | not captured |
| V (derived from CL·t½/ln2) | `Q61` · V | 0.0117 | L | 1.1685829831200604e-05 | L | not captured | review (0.7) | Awan_2024:review | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_arginine_hydrochloride/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Awan_2024` / `Awan_2024::reference`)
