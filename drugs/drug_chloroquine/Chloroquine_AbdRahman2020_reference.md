...
## Model component
<dbs-pgx drug="chloroquine" model-id="Chloroquine_AbdRahman2020_reference" status="not_modelled" stale="false" population="24 healthy subjects with induced blood-stage P. vivax malaria" measured-compound="chloroquine" parameterization="apparent" topology="parent_metabolite"></dbs-pgx>
...
- scholar stages: `../../../knowledgebase/drugs/drug_chloroquine/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Abd-Rahman_2020` / `Abd-Rahman_2020::24 healthy subjects with induced blood-stage P. vivax malaria`)
