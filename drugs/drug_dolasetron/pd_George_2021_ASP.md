...
# ASP+ intracellular accumulation — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--orange" title="re-read by gpt-oss:120b (?, agreement 0.0). The first reading is what the record holds.">cross-check: partial</span>
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | ondansetron | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q322]` | 3.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 31.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 85.4 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 24.5 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 0.1 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 5.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | 1.6 | not captured | only_one_extracted |
...
---
<sub>← back to [dolasetron](drugs/drug_dolasetron/)</sub>
