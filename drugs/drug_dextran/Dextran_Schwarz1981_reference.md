...
|---|---|---|---|---|---|---|---|---|---|---|
| mean cumulative asymptotic elimination of dextran in the urine | `Q91` · Ae | 75 | % | not captured | [%] | not captured | llm (0.6) | Schwarz_1981:abstract | — | not captured |
| mean renal clearance | `Q26` · CLR | 137 | ml/min | 2.2833333333333332e-06 | [ml] / [min] | not captured | llm_confirmed (0.6) | Schwarz_1981:abstract | — | not captured |
| mean total clearance | `Q22` · CL | 187 | ml/min | 3.1166666666666663e-06 | [ml] / [min] | not captured | llm_confirmed (0.6) | Schwarz_1981:abstract | — | not captured |
| terminal half-life of dextran 60 (Macrodex) | `Q57` · t1/2z | 24 | h | 86400.0 | [h] | not captured | llm (0.6) | Schwarz_1981:abstract | — | not captured |
...
- covariate category for t1/2β from footnote/prose kept as documentation only (['Schwarz_1981:abstract'])
- unit_dimension_mismatch: 'mean cumulative asymptotic elimination of dextran in the urine' → Q91 (unit 'dimensionless' vs ontology '[mass]') — route to review
...
**Extraction notes:**
- no GROBID TEI available — transcribed from abstract in Schwarz_1981_metadata.yaml (5 record(s)); values are summary statistics, not a fitted model
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Schwarz_1981:abstract'] |
| C5_dimension_Q26 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Schwarz_1981:abstract'] |
| C5_dimension_Q57 | pass | [time] | not captured | not captured | not captured | ['Schwarz_1981:abstract'] |
| C5_dimension_Q91 | fail | dimensionless | % | not captured | not captured | ['Schwarz_1981:abstract'] |
| C6_cl_magnitude | fail | &lt;= 90.0 L/h | 187.0 | not captured | not captured | ['Schwarz_1981:abstract'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 11.2 L/h | not captured | not captured | ['Schwarz_1981:abstract'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_dextran/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Schwarz_1981` / `Schwarz_1981::reference`)
