...
- scholar stages: `../../../knowledgebase/drugs/drug_dextran/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Schwarz_1981` / `Schwarz_1981::healthy volunteers`)
