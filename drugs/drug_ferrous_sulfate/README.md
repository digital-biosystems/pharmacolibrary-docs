...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-19 00:05 | 16:56 | 0/0/0 | 0/0/0 | 0/0/0 | 364,254/7,741 | ollama / qwen3.8:27b-mtp-q8_0 | 15 | 3/12 | 15/0 | 0 |
...
<sub>queue written 2026-09-19T00:03:36.248738+00:00</sub>
...
| popPK | Allen_2021 | irrelevant | 0 | 0 | The study investigates the pharmacokinetics of ferric maltol, not ferrous sulfate, which is only mentioned as a comparator class in the introduction. |
...
| popPK | Dainty_2003 | irrelevant | 4 | 2 | The study focuses on iron absorption estimation using a single-compartment model but does not report standard population PK parameters (CL, V, Q, ka) for ferrous sulfate as a drug, and specific numeric PK values are not clearly presented in the text. |
...
| popPK | Qasem_2022 | irrelevant | 0 | 0 | The paper is a phytochemical and biological activity study of chamomile essential oils and honey, where ferrous sulfate is used only as a reagent in an in-vitro antioxidant assay, not as a subject drug for pharmacokinetic analysis. |
...
| popPK | Sena_2024 | irrelevant | 0 | 0 | The paper is a phytochemical and pharmacological study of Tetradenia riparia extracts, and ferrous sulfate is only mentioned as a unit of measurement for the FRAP antioxidant assay, not as a subject drug for PK analysis. |
...
| popPK | Stanoiu_2025 | irrelevant | 0 | 0 | The paper is a study on Inonotus obliquus delivery systems and does not report pharmacokinetic parameters for ferrous sulfate, which is only mentioned as a reagent. |
...
| popPK | Zarif_2025 | irrelevant | 0 | 0 | The study focuses on atorvastatin pharmacokinetics and delivery, not ferrous sulfate. |
...
| popPK | Zhuo_2014 | irrelevant | 2 | 0 | The study focuses on ferrous glycinate as the subject drug with ferrous sulfate serving only as a comparator, and no specific quantitative PK parameter values for ferrous sulfate are provided in the evidence. |
| popPK | de_2025 | irrelevant | 0 | 0 | The paper focuses on the formulation and in vitro characterization of a nanoemulsion for trans-dehydrocrotonin, not the pharmacokinetics of ferrous sulfate. |
...
| popPK | unknown_2016 | irrelevant | 0 | 0 | The paper discusses G-CSF, BCR-ABL, and other oncology topics, but contains no data or mention of ferrous sulfate pharmacokinetics. |
