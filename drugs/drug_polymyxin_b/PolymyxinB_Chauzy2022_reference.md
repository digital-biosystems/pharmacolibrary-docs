<div class="pk-crumbs" data-crumbs="[{&quot;label&quot;:&quot;Drugs&quot;,&quot;href&quot;:&quot;README.md&quot;},{&quot;label&quot;:&quot;A07A&quot;,&quot;href&quot;:&quot;atc/A07A.md&quot;},{&quot;label&quot;:&quot;polymyxin B&quot;,&quot;href&quot;:&quot;drugs/drug_polymyxin_b/&quot;},{&quot;label&quot;:&quot;Chauzy_2022 \u00b7 neutropenic mice&quot;}]"></div>
...
## Model component
<dbs-pgx drug="polymyxin B" model-id="PolymyxinB_Chauzy2022_reference" status="not_modelled" stale="false" population="neutropenic mice" measured-compound="polymyxin B" parameterization="mechanistic" topology="2C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Maximum absorption rate | `Q49` · kabs | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | T1:row1:col2 | — | not captured |
| Clearance | `Q22` · CL | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | T1:row3:col2 | — | not captured |
| Distribution volume of the central compartment | `Q63` · V1 | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | T1:row4:col2 | — | not captured |
| Distribution volume of the peripheral compartment | `Q64` · V2 | —(suppressed) | not captured | — | not captured | not captured | llm_confirmed (0.6) | T1:row5:col2 | — | not captured |
| Intercompartmental clearance | `Q30` · Q | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | T1:row6:col2 | — | not captured |
| Fraction unbound | `Q46` · fu | —(suppressed) | not captured | — | not captured | not captured | exact (1.0) | T1:row7:col2 | — | not captured |
...
- scholar stages: `../../../knowledgebase/drugs/drug_polymyxin_b/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Chauzy_2022` / `Chauzy_2022::neutropenic mice`)
