...
# serum creatinine — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.286). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Hanafin PO; Mahadevan R; Rao GG; Zavascki AP; Sandri AM; Kwa A; et al. et al. (2025). Clinical pharmacology and therapeutics 118
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | polymyxin B | polymyxin B (unbound) | mismatch |
| `gpt-oss:120b` | `model_family` | indirect_response_i | transduction | mismatch |
| `gpt-oss:120b` | `parameters[Q318]` | not captured | 1.24 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q322]` | not captured | 2.77 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q327]` | not captured | 0.08 | only_one_extracted |
