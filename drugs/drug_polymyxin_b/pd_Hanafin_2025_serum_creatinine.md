...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | unbound polymyxin B | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q327]` | 0.08 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q362]` | 47.94 | not captured | only_one_extracted |
