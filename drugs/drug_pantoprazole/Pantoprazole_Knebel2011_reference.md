...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[clearance]` | 6.5 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[volume of distribution]` | 226.0 | not captured | only_one_extracted |
...
<tr><td><b>MATLAB &amp; GNU Octave</b></td><td><code>.m</code> ODE function + driver</td><td><a href="drugs/drug_pantoprazole/Pantoprazole_Knebel2011_reference/Pantoprazole_Knebel2011_reference_matlab.zip" download>Pantoprazole_Knebel2011_reference_matlab.zip</a> <span class="pk-size">(3.4 kB)</span></td></tr>
