...
|---|---|---|---|---|---|---|---|---|---|---|
| Cmax_CLO [ng/ml] | `Q32` · Cmax | 11 | not captured | not captured | not captured | not captured | llm (0.6) | Grafeneder_2024_table_3:row3:col7 | — | not captured |
...
| AUClast_CLO [ng/ml·min] | `Q74` · AUClast | 1686 | not captured | not captured | not captured | not captured | llm (0.6) | Grafeneder_2024_table_3:row6:col7 | — | not captured |
| t1/2 [min] | `Q57` · t1/2z | 124 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | Grafeneder_2024_table_3:row13:col7 | — | not captured |
| Clearance [ml/min] | `Q22` · CL | 790 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | Grafeneder_2024_table_3:row14:col7 | — | not captured |
| VD [ml] | `Q61` · V | 40609 | not captured | not captured | not captured | not captured | llm_confirmed (0.6) | Grafeneder_2024_table_3:row15:col7 | — | not captured |
