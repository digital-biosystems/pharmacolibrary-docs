...
**What is wrong:** the simulated model does not reproduce a value the paper reports; the engineer did not exercise the covariate scenarios this record defines. Evidence: T1_t_half_beta — expected 2.0 — got 12.462113259103496 — ratio 6.2311; T2_covariates_not_exercised
...
> ⚠️ **STALE** — review status `needs_review` (reviewed 2026-09-17 15:08:54.676814+00:00) predates the upstream re-run (2026-09-18 06:14:23.574963+00:00). Current validate status: `extracted`.
...
## Model component
<dbs-pgx drug="pantoprazole" model-id="Pantoprazole_Pettersen2009_reference" status="extracted" stale="true" population="paediatric intensive care patients" measured-compound="pantoprazole" parameterization="mechanistic" topology="2C"></dbs-pgx>
