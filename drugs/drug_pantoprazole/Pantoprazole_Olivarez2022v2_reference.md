...
> ⚠️ **STALE** — review status `needs_review` (reviewed 2026-09-17 15:08:54.660001+00:00) predates the upstream re-run (2026-09-18 06:13:43.456668+00:00). Current validate status: `needs_review`.

## Citation
Olivarez JD; Mulon PY; Ebner LS; Cremerius H; Cantrell C; Rahn R; et al. et al. (2022). Frontiers in veterinary science 9
  ·  DOI: [10.3389/fvets.2022.1101461](https://doi.org/10.3389/fvets.2022.1101461)

## Model component
<dbs-pgx drug="pantoprazole" model-id="Pantoprazole_Olivarez2022v2_reference" status="needs_review" stale="true" population="neonatal calves" measured-compound="pantoprazole" parameterization="mechanistic" topology="1C"></dbs-pgx>
...
|---|---|---|---|---|---|---|---|---|---|---|
| Cl | `Q22` · CL | 199.9 | mL/h/kg | 3.886944444444445e-06 | L/h | not captured | review (0.7) | Olivarez_2022_2:review | — | not captured |
| Vz/F | `Q76` · V/F | 0.55 | L/kg | 0.0385 | L | not captured | review (0.7) | Olivarez_2022_2:review | — | not captured |
...
- built from REVIEW reference values (Olivarez_2022_2) — secondary source
...
| C5_dimension_Q22 | pass | [length] ** 3 / [time] | not captured | not captured | not captured | ['Olivarez_2022_2:review'] |
| C5_dimension_Q76 | pass | [length] ** 3 | not captured | not captured | not captured | ['Olivarez_2022_2:review'] |
| C6_cl_magnitude | fail | &lt;= 90.0 L/h | 199.9 | not captured | not captured | ['Olivarez_2022_2:review'] |
| C8_topology | pass | not captured | not captured | not captured | not captured | not captured |
| C9_phys_window_Q22 | pass | clearance within physiological range | 14 L/h | not captured | not captured | ['Olivarez_2022_2:review'] |
| C9_phys_window_Q76 | pass | volume within physiological range | 38.5 L | not captured | not captured | ['Olivarez_2022_2:review'] |
...
- scholar stages: `../../../knowledgebase/drugs/drug_pantoprazole/papers/_screenv2.yaml`, `_locatev2.yaml`, `_transcribev2.yaml`, `_interpretv2.yaml`, `_validatev2.yaml`, `_reviewv2.yaml` (keys `Olivarez_2022_2` / `Olivarez_2022_2::reference`)
