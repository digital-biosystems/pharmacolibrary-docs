...
**Why:** split column '735' is a table statistic/structure column, not a study population (mis-split estimate table).
**Second reading:** `gpt-oss:120b` read this paper differently on `parameters[auc 0-n].parameter_id` (Q88 vs Q19) — a structural parameter, so the record is disputed.
...
|---|---|---|---|---|---|---|---|---|---|---|
| AUC 0-N (mg/l h) | `Q88` · AUC | 735 | mg/l h | not captured | [mg] / [[h] · [l]] | not captured | llm_confirmed (0.6) | tab_0:row0:col1 | — | not captured |
| C max (mg/l) | `Q32` · Cmax | 271 | mg/l | not captured | [mg] / [l] | not captured | space_fold (0.95) | tab_0:row1:col1 | — | not captured |
| t 0.5, terminal (h) | `Q57` · t1/2z | 2.15 | h | 7740.0 | [h] | not captured | llm (0.6) | tab_0:row2:col1 | — | not captured |
| V ss (l) | `Q65` · Vss | 36.7 | l | 0.0367 | [l] | not captured | space_fold (0.95) | tab_0:row3:col1 | — | not captured |
| Cl tot (ml/min) | `Q22` · CL | 385 | ml/min | 6.4166666666666665e-06 | [ml] / [min] | not captured | space_fold (0.95) | tab_0:row4:col1 | — | not captured |
| Dose eliminated with urine (%) | `Q44` · fe | 26.6 | not captured | not captured | not captured | not captured | llm (0.6) | tab_0:row5:col1 | — | not captured |
