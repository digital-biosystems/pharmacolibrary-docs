...
| `gpt-oss:120b` | `parameters[Q1]` | 11.00 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | not captured | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 4.74 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q321]` | 2.53 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q321]` | 10.36 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q358]` | 0.69 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 5.03 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 3.40 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q49]` | 12.81 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q66]` | 1.00 | not captured | only_one_extracted |
