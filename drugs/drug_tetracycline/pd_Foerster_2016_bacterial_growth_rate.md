...
## Citation
Foerster S; Unemo M; Hathaway LJ; Low N; Althaus CL et al. (2016). BMC microbiology 16
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | antimicrobial | not captured | mismatch |
...
| `gpt-oss:120b` | `parameters[Q47]` | -9.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q47]` | -0.1 | not captured | only_one_extracted |
