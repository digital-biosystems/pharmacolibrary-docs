...
# hluc+ activity — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.0). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Köse S; Müller E; Gommeringer P; Nettelbeck DM; Ungerechts G; Hartig JS et al. (2026). Nucleic acids research 54
  ·  DOI: [10.1093/nar/gkag426](https://doi.org/10.1093/nar/gkag426)
...
|---|---|---|---|---|
| `gpt-oss:120b` | `driver_compound` | tetracycline | not captured | mismatch |
