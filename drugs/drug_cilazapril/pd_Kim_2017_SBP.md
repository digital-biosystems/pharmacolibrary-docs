...
# systolic blood pressure — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.619). The first reading is what the record holds.">cross-check: disputed</span>
...
| `gpt-oss:120b` | `parameters[Q312]` | 3.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | 5.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | 36.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | 1.25 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | 35.6 | not captured | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q324]` | 82.3 | not captured | only_one_extracted |
