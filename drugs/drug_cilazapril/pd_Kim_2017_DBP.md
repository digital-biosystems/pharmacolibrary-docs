...
# diastolic blood pressure — PD  <span class="pk-badge pk-badge--red">rejected</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.619). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Kim CO; Jeon S; Han S; Hong T; Park MS; Yoon YR; Yim DS et al. (2017). Translational and clinical pharmacology 25
...
|---|---|---|---|
| `gpt-oss:120b` | not confirmed | 0.619 (26/42 fields) | 16 |

<details><summary>16 field(s) a reader read differently</summary>

| second reader | field | first reading | second reading | agreement |
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 0.40 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 0.69 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 5.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 36.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 82.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q312]` | 35.6 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q314]` | 1.25 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q316]` | 0.063 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q316]` | 6.2 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q317]` | 6.27 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q317]` | 6.8 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 3.3 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 131.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q324]` | 2.0 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | 0.40 | not captured | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q328]` | 0.69 | not captured | only_one_extracted |
...
---
<sub>← back to [cilazapril](drugs/drug_cilazapril/)</sub>
