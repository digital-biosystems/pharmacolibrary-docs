...
# systolic blood pressure — PD  <span class="pk-badge pk-badge--green">extracted</span> <span class="pk-badge pk-badge--red" title="re-read by gpt-oss:120b (not confirmed, agreement 0.333). The first reading is what the record holds.">cross-check: disputed</span>
...
## Citation
Waterfall JF et al. (1989). British journal of clinical pharmacology 27 Suppl 2
...
|---|---|---|---|---|
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 0.8 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 1.7 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 6.0 | only_one_extracted |
| `gpt-oss:120b` | `parameters[Q100]` | not captured | 40.0 | only_one_extracted |
...
| `gpt-oss:120b` | `parameters[Q322]` | 40.0 | not captured | only_one_extracted |
